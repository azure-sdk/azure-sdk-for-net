...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    internal partial class RedisCacheAccessPolicyAssignmentList
    {
        ...
        {
            Value = new ChangeTrackingList<RedisCacheAccessPolicyAssignmentSetData>();
        }
        ...
        internal RedisCacheAccessPolicyAssignmentList(IReadOnlyList<RedisCacheAccessPolicyAssignmentSetData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        /// <summary> List of access policies assignments (with properties) of a Redis cache. </summary>
        public IReadOnlyList<RedisCacheAccessPolicyAssignmentSetData> Value { get; }
