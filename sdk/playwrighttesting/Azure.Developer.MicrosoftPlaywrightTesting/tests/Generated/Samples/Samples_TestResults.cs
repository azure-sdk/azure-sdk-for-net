...
runId = "2fd2f304-11f5-4102-af0d-e345b0c7a104",
shardId = "1",
...
runId = "2fd2f304-11f5-4102-af0d-e345b0c7a104",
shardId = "1",
accountId = "eastasia_a56bbc94-fbb7-4c20-9b17-981067e4580a",
suiteId = "3dd73f57a76177b79e47c6e948989a31837b5fde",
...
artifactsPath = "4c57e3a2-8a9c-4659-91f3-30ff4115f187",
            ...
            Response response = client.UploadBatch("eastasia_a56bbc94-fbb7-4c20-9b17-981067e4580a", content);
...
artifactsPath = "4c57e3a2-8a9c-4659-91f3-30ff4115f187",
            ...
            Response response = await client.UploadBatchAsync("eastasia_a56bbc94-fbb7-4c20-9b17-981067e4580a", content);
        ...
        public void Example_TestResults_UploadBatch_TestResultsUploadBatch_Convenience()
        {
            ...
            Response response = client.UploadBatch("eastasia_a56bbc94-fbb7-4c20-9b17-981067e4580a", new TestResultDetails[]
            {
new TestResultDetails(
    "4c57e3a2-8a9c-4659-91f3-30ff4115f187",
    "216f18b4-7fd4-3292-2fbe-b1630c317160",
    "4c57e3a2-8a9c-4659-91f3-30ff4115f187",
    "2fd2f304-11f5-4102-af0d-e345b0c7a104",
    "1",
...
ArtifactsPath = "4c57e3a2-8a9c-4659-91f3-30ff4115f187",
        ...
        public async Task Example_TestResults_UploadBatch_TestResultsUploadBatch_Convenience_Async()
        {
            ...
            Response response = await client.UploadBatchAsync("eastasia_a56bbc94-fbb7-4c20-9b17-981067e4580a", new TestResultDetails[]
            {
new TestResultDetails(
    "4c57e3a2-8a9c-4659-91f3-30ff4115f187",
    "216f18b4-7fd4-3292-2fbe-b1630c317160",
...
ArtifactsPath = "4c57e3a2-8a9c-4659-91f3-30ff4115f187",
        ...
        public void Example_TestResultDetails_GetTestResultDetails_TestResultsListTestResults()
        {
            ...
            foreach (BinaryData item in client.GetTestResultDetails("eastasia_a56bbc94-fbb7-4c20-9b17-981067e4580a", null, 0, null, "status eq 'Passed'", null))
            {
                ...
                Console.WriteLine(result.GetProperty("result").GetProperty("status").ToString());
                Console.WriteLine(result.GetProperty("result").GetProperty("durationInMs").ToString());
                Console.WriteLine(result.GetProperty("result").GetProperty("startTime").ToString());
            }
        }
