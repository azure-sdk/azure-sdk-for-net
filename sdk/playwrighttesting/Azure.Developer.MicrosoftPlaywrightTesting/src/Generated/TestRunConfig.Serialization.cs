...
namespace Azure.Developer.MicrosoftPlaywrightTesting
{
    public partial class TestRunConfig : IUtf8JsonSerializable, IJsonModel<TestRunConfig>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteStringValue(TimeoutInMs, "P");
            ...
            if (Optional.IsDefined(ReporterPackageVersion))
            {
                writer.WritePropertyName("reporterPackageVersion"u8);
                writer.WriteStringValue(ReporterPackageVersion);
            }
        ...
        internal static TestRunConfig DeserializeTestRunConfig(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            TimeSpan timeoutInMs = default;
            string testType = default;
            TestSdkLanguage testSdkLanguage = default;
            string reporterPackageVersion = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    timeoutInMs = property.Value.GetTimeSpan("P");
                    continue;
                }
                ...
                if (property.NameEquals("reporterPackageVersion"u8))
                {
                    reporterPackageVersion = property.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
