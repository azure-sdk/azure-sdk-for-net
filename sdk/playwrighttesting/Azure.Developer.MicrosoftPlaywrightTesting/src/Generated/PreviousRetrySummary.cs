...
namespace Azure.Developer.MicrosoftPlaywrightTesting
{
    ...
    public partial class PreviousRetrySummary
    {
        ...
        public PreviousRetrySummary(string testExecutionId, int retryCount, TestStatus status, TimeSpan duration, DateTimeOffset startTime, IEnumerable<AttachmentKind> attachmentsMetadata)
        {
        ...
        internal PreviousRetrySummary(string testExecutionId, int retryCount, TestStatus status, TimeSpan duration, DateTimeOffset startTime, IList<AttachmentKind> attachmentsMetadata, string artifactsPath, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TestExecutionId = testExecutionId;
            RetryCount = retryCount;
            Status = status;
        ...
        public IList<AttachmentKind> AttachmentsMetadata { get; }
