...
namespace Azure.Developer.MicrosoftPlaywrightTesting
{
    ...
    public partial class TestRun
    {
        ...
        public TestRun(DateTimeOffset startTime, bool cloudReportingEnabled)
        {
            StartTime = startTime;
        ...
        internal TestRun(string testRunId, string displayName, DateTimeOffset startTime, string creatorId, string creatorName, CloudRunSummary cloudRunSummary, CloudReportingSummary cloudReportSummary, CiConfig ciConfig, TestRunConfig testRunConfig, TestResultsUrl testResultsUrl, bool cloudRunEnabled, bool cloudReportingEnabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TestRunId = testRunId;
        ...
        /// <summary> Identifier of the test run. </summary>
        public string TestRunId { get; }
        /// <summary> Display name of the test run, unicode characters allowed. </summary>
        public string DisplayName { get; set; }
        /// <summary> Start time of the test run -RFC 3339 literal format. </summary>
        public DateTimeOffset StartTime { get; set; }
        /// <summary> Creator's identifier. </summary>
        ...
        /// <summary> Must be set to true when Customers want to use Reporting Feature. </summary>
