...
namespace Azure.Developer.MicrosoftPlaywrightTesting
{
    ...
    public partial class Accounts
    {
        ...
        /// <summary> Gets remote browsers corresponding to given account id and redirects the client for running MPT tests. Authorization required is Bearer JWT Access token provided by EntraID or MPT Service. </summary>
        /// <param name="accountId"> The account id. </param>
        ...
        /// <summary>
        /// [Protocol Method] Gets remote browsers corresponding to given account id and redirects the client for running MPT tests. Authorization required is Bearer JWT Access token provided by EntraID or MPT Service.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
