...
namespace Azure.Developer.MicrosoftPlaywrightTesting
{
    ...
    public partial class Accounts
    {
        ...
        /// <summary> Get details of the Azure resource mapped to an account for the given accountId. Authorization required is Bearer JWT Access token provided by EntraID. </summary>
        ...
        /// <summary>
        /// [Protocol Method] Get details of the Azure resource mapped to an account for the given accountId. Authorization required is Bearer JWT Access token provided by EntraID.
        /// <list type="bullet">
        /// <item>
        /// <description>
        ...
        /// <summary> Gets remote browsers corresponding to given accountId and redirects the client for running MPT tests. Authorization required is Bearer JWT Access token provided by EntraID or MPT Service. </summary>
        /// <param name="accountId"> The account id. </param>
        ...
        /// <summary>
        /// [Protocol Method] Gets remote browsers corresponding to given accountId and redirects the client for running MPT tests. Authorization required is Bearer JWT Access token provided by EntraID or MPT Service.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
