...
namespace Azure.Developer.MicrosoftPlaywrightTesting
{
    ...
    public partial class TestRunConfig
    {
        ...
        public TestRunConfig(TimeSpan timeoutInMs, TestSdkLanguage testSdkLanguage)
        {
        ...
        /// <param name="workers"> Number of worker instances. </param>
        ...
        /// <param name="testSdkLanguage"> Programming language used for the test SDK. Supported languages are 'JavaScript', 'TypeScript', 'Csharp'. </param>
        /// <param name="reporterPackageVersion"> Version of the reporter package. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal TestRunConfig(int? retryCount, int? repeatEach, int? workers, TestFramework testFramework, ShardDetails shardDetails, TimeSpan timeoutInMs, string testType, TestSdkLanguage testSdkLanguage, string reporterPackageVersion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ...
            TestType = testType;
            TestSdkLanguage = testSdkLanguage;
            ReporterPackageVersion = reporterPackageVersion;
        ...
        public TimeSpan TimeoutInMs { get; set; }
