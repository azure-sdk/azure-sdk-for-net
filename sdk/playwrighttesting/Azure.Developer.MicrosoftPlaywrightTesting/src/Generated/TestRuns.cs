...
namespace Azure.Developer.MicrosoftPlaywrightTesting
{
    ...
    public partial class TestRuns
    {
        ...
        /// <summary> Gets a testrun. </summary>
        /// <param name="accountId"> The account id. </param>
        /// <param name="testRunId"> Identifier of the test run. </param>
        ...
        /// <summary>
        /// [Protocol Method] Gets a testrun.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <param name="accountId"> The account id. </param>
        /// <param name="testRunId"> Identifier of the test run. </param>
        /// <param name="shardId"> Shard Id for the shard- indexed 0,1,2. </param>
        /// <param name="summary"> Summary of the test run shard. </param>
        /// <param name="workers"> number of workers used by playwright client. </param>
        ...
        public virtual async Task<Response> UpdateShardExecutionStatusAsync(string accountId, string testRunId, int shardId, UpdateShardExecutionSummary summary, int workers, bool? uploadCompleted = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(accountId, nameof(accountId));
            Argument.AssertNotNullOrEmpty(testRunId, nameof(testRunId));
            Argument.AssertNotNull(summary, nameof(summary));

            UpdateShardExecutionStatusRequest updateShardExecutionStatusRequest = new UpdateShardExecutionStatusRequest(shardId, summary, workers, uploadCompleted, null);
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        public virtual Response UpdateShardExecutionStatus(string accountId, string testRunId, int shardId, UpdateShardExecutionSummary summary, int workers, bool? uploadCompleted = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(accountId, nameof(accountId));
            Argument.AssertNotNullOrEmpty(testRunId, nameof(testRunId));
            Argument.AssertNotNull(summary, nameof(summary));
        ...
        /// <summary> Get TestRun summary for an Odata filter. </summary>
        /// <param name="accountId"> The account id. </param>
        ...
        /// <summary>
        /// [Protocol Method] Get TestRun summary for an Odata filter.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <summary> Get TestRun metadata for an Odata filter. </summary>
        /// <param name="accountId"> The account id. </param>
        /// <param name="top"> The number of result items to return. </param>
        /// <param name="skip"> The number of result items to skip. </param>
        /// <param name="maxpagesize"> The maximum number of result items per page. </param>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="accountId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="accountId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/TestRuns.xml" path="doc/members/member[@name='ComputeMetadataAsync(string,int?,int?,int?,string,CancellationToken)']/*" />
        public virtual async Task<Response<TestRunsMetadata>> ComputeMetadataAsync(string accountId, int? top = null, int? skip = null, int? maxpagesize = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(accountId, nameof(accountId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await ComputeMetadataAsync(accountId, top, skip, maxpagesize, filter, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="accountId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="accountId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/TestRuns.xml" path="doc/members/member[@name='ComputeMetadata(string,int?,int?,int?,string,CancellationToken)']/*" />
        public virtual Response<TestRunsMetadata> ComputeMetadata(string accountId, int? top = null, int? skip = null, int? maxpagesize = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(accountId, nameof(accountId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = ComputeMetadata(accountId, top, skip, maxpagesize, filter, context);
            return Response.FromValue(TestRunsMetadata.FromResponse(response), response);
        }

        /// <summary>
        /// [Protocol Method] Get TestRun metadata for an Odata filter.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ComputeMetadataAsync(string,int?,int?,int?,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/TestRuns.xml" path="doc/members/member[@name='ComputeMetadataAsync(string,int?,int?,int?,string,RequestContext)']/*" />
        public virtual async Task<Response> ComputeMetadataAsync(string accountId, int? top, int? skip, int? maxpagesize, string filter, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(accountId, nameof(accountId));
            ...
            try
            {
                using HttpMessage message = CreateComputeMetadataRequest(accountId, top, skip, maxpagesize, filter, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ComputeMetadata(string,int?,int?,int?,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/TestRuns.xml" path="doc/members/member[@name='ComputeMetadata(string,int?,int?,int?,string,RequestContext)']/*" />
        public virtual Response ComputeMetadata(string accountId, int? top, int? skip, int? maxpagesize, string filter, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(accountId, nameof(accountId));
        ...
        internal HttpMessage CreateComputeMetadataRequest(string accountId, int? top, int? skip, int? maxpagesize, string filter, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Post;
