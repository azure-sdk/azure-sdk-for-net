...
namespace Azure.Developer.MicrosoftPlaywrightTesting
{
    ...
    internal partial class UpdateShardExecutionStatusRequest
    {
        ...
        internal UpdateShardExecutionStatusRequest(int shardId, UpdateShardExecutionSummary summary, int workers)
        {
        ...
        internal UpdateShardExecutionStatusRequest(int shardId, UpdateShardExecutionSummary summary, int workers, bool? uploadCompleted, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ShardId = shardId;
            Summary = summary;
            Workers = workers;
        ...
        /// <summary> Shard Id for the shard- indexed 0,1,2. </summary>
