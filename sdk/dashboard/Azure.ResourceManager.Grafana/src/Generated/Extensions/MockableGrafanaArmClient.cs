...
namespace Azure.ResourceManager.Grafana.Mocking
{
    ...
    public partial class MockableGrafanaArmClient : ArmResource
    {
        ...
        public virtual GrafanaPrivateLinkResourceDataResource GetGrafanaPrivateLinkResourceDataResource(ResourceIdentifier id)
        {
            GrafanaPrivateLinkResourceDataResource.ValidateResourceId(id);
            return new GrafanaPrivateLinkResourceDataResource(Client, id);
        }
