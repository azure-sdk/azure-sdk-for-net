...
namespace Azure.ResourceManager.Grafana
{
    ...
    public static partial class GrafanaExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="GrafanaPrivateLinkResourceDataResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="GrafanaPrivateLinkResourceDataResource.CreateResourceIdentifier" /> to create a <see cref="GrafanaPrivateLinkResourceDataResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableGrafanaArmClient.GetGrafanaPrivateLinkResourceDataResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        /// <returns> Returns a <see cref="GrafanaPrivateLinkResourceDataResource"/> object. </returns>
        public static GrafanaPrivateLinkResourceDataResource GetGrafanaPrivateLinkResourceDataResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableGrafanaArmClient(client).GetGrafanaPrivateLinkResourceDataResource(id);
        }
