...
namespace Azure.ResourceManager.Grafana.Models
{
    internal partial class GrafanaPrivateLinkResourceListResult : IUtf8JsonSerializable, IJsonModel<GrafanaPrivateLinkResourceListResult>
    {
        ...
        internal static GrafanaPrivateLinkResourceListResult DeserializeGrafanaPrivateLinkResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<GrafanaPrivateLinkResourceDataData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<GrafanaPrivateLinkResourceDataData> array = new List<GrafanaPrivateLinkResourceDataData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(GrafanaPrivateLinkResourceDataData.DeserializeGrafanaPrivateLinkResourceDataData(item, options));
                    }
                    value = array;
                    continue;
                }
        ...
        GrafanaPrivateLinkResourceListResult IPersistableModel<GrafanaPrivateLinkResourceListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GrafanaPrivateLinkResourceListResult>)this).GetFormatFromOptions(options) : options.Format;
