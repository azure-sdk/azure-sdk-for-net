...
namespace Azure.ResourceManager.Grafana.Models
{
    internal partial class GrafanaIntegrations : IUtf8JsonSerializable, IJsonModel<GrafanaIntegrations>
    {
        ...
        internal static GrafanaIntegrations DeserializeGrafanaIntegrations(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<AzureMonitorWorkspaceIntegration> azureMonitorWorkspaceIntegrations = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("azureMonitorWorkspaceIntegrations"u8))
                {
                    ...
                    {
                        array.Add(AzureMonitorWorkspaceIntegration.DeserializeAzureMonitorWorkspaceIntegration(item, options));
                    }
            ...
            return new GrafanaIntegrations(azureMonitorWorkspaceIntegrations ?? new ChangeTrackingList<AzureMonitorWorkspaceIntegration>(), serializedAdditionalRawData);
        }
