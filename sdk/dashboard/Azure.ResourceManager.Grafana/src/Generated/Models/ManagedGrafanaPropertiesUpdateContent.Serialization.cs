...
{
    public partial class ManagedGrafanaPropertiesUpdateContent : IUtf8JsonSerializable, IJsonModel<ManagedGrafanaPropertiesUpdateContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedGrafanaPropertiesUpdateContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ManagedGrafanaPropertiesUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedGrafanaPropertiesUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedGrafanaPropertiesUpdateContent)} does not support writing '{format}' format.");
            }
        ...
        ManagedGrafanaPropertiesUpdateContent IJsonModel<ManagedGrafanaPropertiesUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedGrafanaPropertiesUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedGrafanaPropertiesUpdateContent)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeManagedGrafanaPropertiesUpdateContent(document.RootElement, options);
        }

        internal static ManagedGrafanaPropertiesUpdateContent DeserializeManagedGrafanaPropertiesUpdateContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ManagedGrafanaPropertiesUpdateContent(
                zoneRedundancy,
                apiKey,
        ...
        BinaryData IPersistableModel<ManagedGrafanaPropertiesUpdateContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedGrafanaPropertiesUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ManagedGrafanaPropertiesUpdateContent)} does not support writing '{options.Format}' format.");
            }
        }

        ManagedGrafanaPropertiesUpdateContent IPersistableModel<ManagedGrafanaPropertiesUpdateContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedGrafanaPropertiesUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ManagedGrafanaPropertiesUpdateContent)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ManagedGrafanaPropertiesUpdateContent>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
