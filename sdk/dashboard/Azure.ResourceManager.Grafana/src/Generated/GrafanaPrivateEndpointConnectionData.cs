...
namespace Azure.ResourceManager.Grafana
{
    ...
    public partial class GrafanaPrivateEndpointConnectionData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GrafanaPrivateEndpointConnectionData"/>. </summary>
        ...
        internal GrafanaPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SubResource privateEndpoint, GrafanaPrivateLinkServiceConnectionState privateLinkServiceConnectionState, IList<string> groupIds, GrafanaPrivateEndpointConnectionProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public GrafanaPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState { get; set; }
        /// <summary> The private endpoint connection group ids. </summary>
        public IList<string> GroupIds { get; }
        /// <summary> The provisioning state of the private endpoint connection resource. </summary>
        public GrafanaPrivateEndpointConnectionProvisioningState? ProvisioningState { get; set; }
    }
}
