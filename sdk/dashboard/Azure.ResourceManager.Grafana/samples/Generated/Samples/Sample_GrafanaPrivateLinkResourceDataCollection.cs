...
{
    public partial class Sample_GrafanaPrivateLinkResourceDataCollection
    {
        [Test]
        ...
        public async Task Get_PrivateLinkResourcesGet()
        {
            ...
            // get the collection of this GrafanaPrivateLinkResourceDataResource
            GrafanaPrivateLinkResourceDataCollection collection = managedGrafana.GetAllGrafanaPrivateLinkResourceData();

            // invoke the operation
            string privateLinkResourceName = "grafana";
            GrafanaPrivateLinkResourceDataResource result = await collection.GetAsync(privateLinkResourceName);
        ...
        public async Task GetAll_PrivateLinkResourcesList()
        {
            ...
            await foreach (GrafanaPrivateLinkResourceDataResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                GrafanaPrivateLinkResourceDataData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_PrivateLinkResourcesGet()
        {
            ...
            // invoke the operation
            string privateLinkResourceName = "grafana";
            NullableResponse<GrafanaPrivateLinkResourceDataResource> response = await collection.GetIfExistsAsync(privateLinkResourceName);
            GrafanaPrivateLinkResourceDataResource result = response.HasValue ? response.Value : null;
