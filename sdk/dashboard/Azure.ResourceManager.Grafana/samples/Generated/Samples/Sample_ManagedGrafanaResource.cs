...
namespace Azure.ResourceManager.Grafana.Samples
{
    public partial class Sample_ManagedGrafanaResource
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Refresh_ManagedPrivateEndpointRefresh()
        {
            // Generated from example definition: 2024-10-01/ManagedPrivateEndpoints_Refresh.json
            // this example is just showing the usage of "ManagedGrafanas_Refresh" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            await managedGrafana.RefreshAsync(WaitUntil.Completed);
