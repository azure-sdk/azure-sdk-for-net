...
namespace Azure.ResourceManager.Dashboard.Samples
{
    public partial class Sample_DashboardPrivateEndpointConnectionCollection
    {
        ...
        {
            // Generated from example definition: specification/dashboard/resource-manager/Microsoft.Dashboard/preview/2022-10-01-preview/examples/PrivateEndpointConnections_Get.json
        ...
        public async Task GetIfExists_PrivateEndpointConnectionsGet()
        {
            ...
            // invoke the operation
            string privateEndpointConnectionName = "myConnection";
            NullableResponse<DashboardPrivateEndpointConnectionResource> response = await collection.GetIfExistsAsync(privateEndpointConnectionName);
        ...
        {
            // Generated from example definition: specification/dashboard/resource-manager/Microsoft.Dashboard/preview/2022-10-01-preview/examples/PrivateEndpointConnections_Approve.json
            ...
            ArmOperation<DashboardPrivateEndpointConnectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, privateEndpointConnectionName, data);
        ...
        {
            // Generated from example definition: specification/dashboard/resource-manager/Microsoft.Dashboard/preview/2022-10-01-preview/examples/PrivateEndpointConnections_List.json
