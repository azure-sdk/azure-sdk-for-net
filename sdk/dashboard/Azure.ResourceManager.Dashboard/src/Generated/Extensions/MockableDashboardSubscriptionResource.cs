...
namespace Azure.ResourceManager.Dashboard.Mocking
{
    ...
    public partial class MockableDashboardSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableDashboardSubscriptionResource"/> class for mocking. </summary>
        protected MockableDashboardSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableDashboardSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableDashboardSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
