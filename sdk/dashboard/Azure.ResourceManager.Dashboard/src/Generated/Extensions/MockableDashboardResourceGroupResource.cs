...
namespace Azure.ResourceManager.Dashboard.Mocking
{
    ...
    public partial class MockableDashboardResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableDashboardResourceGroupResource"/> class for mocking. </summary>
        protected MockableDashboardResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableDashboardResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableDashboardResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
