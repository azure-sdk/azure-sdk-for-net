...
namespace Azure.ResourceManager.Dashboard.Models
{
    ...
    public partial class ManagedGrafanaProperties
    {
        ...
        public ManagedGrafanaProperties()
        {
            ...
            PrivateEndpointConnections = new ChangeTrackingList<DashboardPrivateEndpointConnectionData>();
        ...
        internal ManagedGrafanaProperties(ProvisioningState? provisioningState, string grafanaVersion, string endpoint, PublicNetworkAccess? publicNetworkAccess, ZoneRedundancy? zoneRedundancy, ApiKey? apiKey, DeterministicOutboundIP? deterministicOutboundIP, IReadOnlyList<string> outboundIPs, IReadOnlyList<DashboardPrivateEndpointConnectionData> privateEndpointConnections, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope, GrafanaIntegrations grafanaIntegrations, EnterpriseConfigurations enterpriseConfigurations, GrafanaConfigurations grafanaConfigurations, IDictionary<string, GrafanaPlugin> grafanaPlugins, string grafanaMajorVersion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public IReadOnlyList<DashboardPrivateEndpointConnectionData> PrivateEndpointConnections { get; }
