...
namespace Azure.ResourceManager.Dashboard.Models
{
    ...
    public partial class DashboardPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DashboardPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal DashboardPrivateLinkServiceConnectionState(DashboardPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
        ...
        public DashboardPrivateEndpointServiceConnectionStatus? Status { get; set; }
