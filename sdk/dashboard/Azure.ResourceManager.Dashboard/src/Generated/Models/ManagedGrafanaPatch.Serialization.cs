...
namespace Azure.ResourceManager.Dashboard.Models
{
    public partial class ManagedGrafanaPatch : IUtf8JsonSerializable, IJsonModel<ManagedGrafanaPatch>
    {
        ...
        internal static ManagedGrafanaPatch DeserializeManagedGrafanaPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ManagedGrafanaPropertiesUpdateParameters properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ManagedGrafanaPropertiesUpdateParameters.DeserializeManagedGrafanaPropertiesUpdateParameters(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
