...
namespace Azure.ResourceManager.Dashboard.Models
{
    ...
    public partial class ManagedGrafanaPatch
    {
        ...
        internal ManagedGrafanaPatch(ResourceSku sku, ManagedServiceIdentity identity, IDictionary<string, string> tags, ManagedGrafanaPropertiesUpdateParameters properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sku = sku;
            Identity = identity;
            Tags = tags;
