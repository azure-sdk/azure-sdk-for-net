...
namespace Azure.ResourceManager.Dashboard
{
    ...
    public partial class DashboardPrivateEndpointConnectionCollection : ArmCollection, IEnumerable<DashboardPrivateEndpointConnectionResource>, IAsyncEnumerable<DashboardPrivateEndpointConnectionResource>
    {
        ...
        public virtual AsyncPageable<DashboardPrivateEndpointConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DashboardPrivateEndpointConnectionResource(Client, DashboardPrivateEndpointConnectionData.DeserializeDashboardPrivateEndpointConnectionData(e)), _dashboardPrivateEndpointConnectionPrivateEndpointConnectionsClientDiagnostics, Pipeline, "DashboardPrivateEndpointConnectionCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DashboardPrivateEndpointConnectionResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _dashboardPrivateEndpointConnectionPrivateEndpointConnectionsRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _dashboardPrivateEndpointConnectionPrivateEndpointConnectionsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DashboardPrivateEndpointConnectionResource(Client, DashboardPrivateEndpointConnectionData.DeserializeDashboardPrivateEndpointConnectionData(e)), _dashboardPrivateEndpointConnectionPrivateEndpointConnectionsClientDiagnostics, Pipeline, "DashboardPrivateEndpointConnectionCollection.GetAll", "value", "nextLink", cancellationToken);
        }
