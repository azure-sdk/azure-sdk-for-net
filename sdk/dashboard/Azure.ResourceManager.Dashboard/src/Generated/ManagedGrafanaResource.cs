...
namespace Azure.ResourceManager.Dashboard
{
    ...
    public partial class ManagedGrafanaResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _enterpriseDetailsClientDiagnostics;
        private readonly EnterpriseDetailsRestOperations _enterpriseDetailsRestClient;
        ...
        internal ManagedGrafanaResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _enterpriseDetailsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Dashboard", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _enterpriseDetailsRestClient = new EnterpriseDetailsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
            _managedPrivateEndpointModelManagedPrivateEndpointsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Dashboard", ManagedPrivateEndpointModelResource.ResourceType.Namespace, Diagnostics);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>EnterpriseDetails_Post</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<EnterpriseDetails>> PostEnterpriseDetailAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _enterpriseDetailsClientDiagnostics.CreateScope("ManagedGrafanaResource.PostEnterpriseDetail");
            scope.Start();
            try
            {
                var response = await _enterpriseDetailsRestClient.PostAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<EnterpriseDetails> PostEnterpriseDetail(CancellationToken cancellationToken = default)
        {
            using var scope = _enterpriseDetailsClientDiagnostics.CreateScope("ManagedGrafanaResource.PostEnterpriseDetail");
            scope.Start();
            try
            {
                var response = _enterpriseDetailsRestClient.Post(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
