...
namespace Azure.ResourceManager.Dashboard.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Dashboard.ManagedGrafanaData"/>. </summary>
        ...
        /// <returns> A new <see cref="Dashboard.ManagedGrafanaData"/> instance for mocking. </returns>
        ...
        /// <param name="azureMonitorWorkspaceIntegrations"> GrafanaIntegrations is a bundled observability experience (e.g. pre-configured data source, tailored Grafana dashboards, alerting defaults) for common monitoring scenarios. </param>
        ...
        public static ManagedGrafanaProperties ManagedGrafanaProperties(ProvisioningState? provisioningState = null, string grafanaVersion = null, string endpoint = null, PublicNetworkAccess? publicNetworkAccess = null, ZoneRedundancy? zoneRedundancy = null, ApiKey? apiKey = null, DeterministicOutboundIP? deterministicOutboundIP = null, IEnumerable<string> outboundIPs = null, IEnumerable<DashboardPrivateEndpointConnectionData> privateEndpointConnections = null, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = null, IEnumerable<AzureMonitorWorkspaceIntegration> azureMonitorWorkspaceIntegrations = null, EnterpriseConfigurations enterpriseConfigurations = null, Smtp grafanaConfigurationsSmtp = null, IDictionary<string, GrafanaPlugin> grafanaPlugins = null, string grafanaMajorVersion = null)
        {
            outboundIPs ??= new List<string>();
            privateEndpointConnections ??= new List<DashboardPrivateEndpointConnectionData>();
            azureMonitorWorkspaceIntegrations ??= new List<AzureMonitorWorkspaceIntegration>();
            ...
            return new ManagedGrafanaProperties(
                ...
                azureMonitorWorkspaceIntegrations != null ? new GrafanaIntegrations(azureMonitorWorkspaceIntegrations?.ToList(), serializedAdditionalRawData: null) : null,
                enterpriseConfigurations,
        ...
        /// <summary> Initializes a new instance of <see cref="Dashboard.DashboardPrivateEndpointConnectionData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Dashboard.DashboardPrivateEndpointConnectionData"/> instance for mocking. </returns>
        public static DashboardPrivateEndpointConnectionData DashboardPrivateEndpointConnectionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier privateEndpointId = null, DashboardPrivateLinkServiceConnectionState connectionState = null, IEnumerable<string> groupIds = null, DashboardPrivateEndpointConnectionProvisioningState? provisioningState = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Dashboard.DashboardPrivateLinkResourceData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Dashboard.DashboardPrivateLinkResourceData"/> instance for mocking. </returns>
        public static DashboardPrivateLinkResourceData DashboardPrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ProvisioningState? provisioningState = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            requiredMembers ??= new List<string>();
            requiredZoneNames ??= new List<string>();

            return new DashboardPrivateLinkResourceData(
                id,
                name,
                resourceType,
                systemData,
        ...
        /// <summary> Initializes a new instance of <see cref="Dashboard.ManagedPrivateEndpointModelData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Dashboard.ManagedPrivateEndpointModelData"/> instance for mocking. </returns>
