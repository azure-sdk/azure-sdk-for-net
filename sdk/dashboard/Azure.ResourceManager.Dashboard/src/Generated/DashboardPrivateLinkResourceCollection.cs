...
namespace Azure.ResourceManager.Dashboard
{
    ...
    public partial class DashboardPrivateLinkResourceCollection : ArmCollection, IEnumerable<DashboardPrivateLinkResource>, IAsyncEnumerable<DashboardPrivateLinkResource>
    {
        ...
        public virtual AsyncPageable<DashboardPrivateLinkResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DashboardPrivateLinkResource(Client, DashboardPrivateLinkResourceData.DeserializeDashboardPrivateLinkResourceData(e)), _dashboardPrivateLinkResourcePrivateLinkResourcesClientDiagnostics, Pipeline, "DashboardPrivateLinkResourceCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DashboardPrivateLinkResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _dashboardPrivateLinkResourcePrivateLinkResourcesRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _dashboardPrivateLinkResourcePrivateLinkResourcesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DashboardPrivateLinkResource(Client, DashboardPrivateLinkResourceData.DeserializeDashboardPrivateLinkResourceData(e)), _dashboardPrivateLinkResourcePrivateLinkResourcesClientDiagnostics, Pipeline, "DashboardPrivateLinkResourceCollection.GetAll", "value", "nextLink", cancellationToken);
        }
