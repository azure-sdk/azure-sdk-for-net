namespace Azure.ResourceManager.StorageCache
{
    ...
    public partial class AutoImportJobData : Azure.ResourceManager.Models.TrackedResourceData, System.ClientModel.Primitives.IJsonModel<Azure.ResourceManager.StorageCache.AutoImportJobData>, System.ClientModel.Primitives.IPersistableModel<Azure.ResourceManager.StorageCache.AutoImportJobData>
    {
        ...
        public int? Deletions { get { throw null; } }
        public bool? EnableDeletions { get { throw null; } set { } }
        public int? ImportedDirectoriesPropertiesStatusBlobSyncEventsImportedDirectories { get { throw null; } }
        public int? ImportedDirectoriesPropertiesStatusImportedDirectories { get { throw null; } }
        public int? ImportedFilesPropertiesStatusBlobSyncEventsImportedFiles { get { throw null; } }
        public int? ImportedFilesPropertiesStatusImportedFiles { get { throw null; } }
        public int? ImportedSymlinksPropertiesStatusBlobSyncEventsImportedSymlinks { get { throw null; } }
        public int? ImportedSymlinksPropertiesStatusImportedSymlinks { get { throw null; } }
        ...
        public int? PreexistingDirectoriesPropertiesStatusBlobSyncEventsPreexistingDirectories { get { throw null; } }
        public int? PreexistingDirectoriesPropertiesStatusPreexistingDirectories { get { throw null; } }
        public int? PreexistingFilesPropertiesStatusBlobSyncEventsPreexistingFiles { get { throw null; } }
        public int? PreexistingFilesPropertiesStatusPreexistingFiles { get { throw null; } }
        public int? PreexistingSymlinksPropertiesStatusBlobSyncEventsPreexistingSymlinks { get { throw null; } }
        public int? PreexistingSymlinksPropertiesStatusPreexistingSymlinks { get { throw null; } }
        ...
        public int? RateOfBlobImportPropertiesStatusBlobSyncEventsRateOfBlobImport { get { throw null; } }
        public int? RateOfBlobImportPropertiesStatusRateOfBlobImport { get { throw null; } }
        public int? RateOfBlobWalk { get { throw null; } }
        ...
        public int? TotalBlobsImportedPropertiesStatusBlobSyncEventsTotalBlobsImported { get { throw null; } }
        public int? TotalBlobsImportedPropertiesStatusTotalBlobsImported { get { throw null; } }
        public int? TotalBlobsWalked { get { throw null; } }
        public int? TotalConflictsPropertiesStatusBlobSyncEventsTotalConflicts { get { throw null; } }
        public int? TotalConflictsPropertiesStatusTotalConflicts { get { throw null; } }
        public int? TotalErrorsPropertiesStatusBlobSyncEventsTotalErrors { get { throw null; } }
        public int? TotalErrorsPropertiesStatusTotalErrors { get { throw null; } }
        protected override void JsonModelWriteCore(System.Text.Json.Utf8JsonWriter writer, System.ClientModel.Primitives.ModelReaderWriterOptions options) { }
...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public static partial class ArmStorageCacheModelFactory
    {
        ...
        public static Azure.ResourceManager.StorageCache.AutoImportJobData AutoImportJobData(Azure.Core.ResourceIdentifier id = null, string name = null, Azure.Core.ResourceType resourceType = default(Azure.Core.ResourceType), Azure.ResourceManager.Models.SystemData systemData = null, System.Collections.Generic.IDictionary<string, string> tags = null, Azure.Core.AzureLocation location = default(Azure.Core.AzureLocation), Azure.ResourceManager.StorageCache.Models.AutoImportJobPropertiesProvisioningState? provisioningState = default(Azure.ResourceManager.StorageCache.Models.AutoImportJobPropertiesProvisioningState?), Azure.ResourceManager.StorageCache.Models.AutoImportJobPropertiesAdminStatus? adminStatus = default(Azure.ResourceManager.StorageCache.Models.AutoImportJobPropertiesAdminStatus?), System.Collections.Generic.IEnumerable<string> autoImportPrefixes = null, Azure.ResourceManager.StorageCache.Models.ConflictResolutionMode? conflictResolutionMode = default(Azure.ResourceManager.StorageCache.Models.ConflictResolutionMode?), bool? enableDeletions = default(bool?), int? maximumErrors = default(int?), Azure.ResourceManager.StorageCache.Models.AutoImportJobState? state = default(Azure.ResourceManager.StorageCache.Models.AutoImportJobState?), System.DateTimeOffset? scanStartOn = default(System.DateTimeOffset?), System.DateTimeOffset? scanEndOn = default(System.DateTimeOffset?), int? totalBlobsWalked = default(int?), int? rateOfBlobWalk = default(int?), int? totalBlobsImportedPropertiesStatusTotalBlobsImported = default(int?), int? rateOfBlobImportPropertiesStatusRateOfBlobImport = default(int?), int? importedFilesPropertiesStatusImportedFiles = default(int?), int? importedDirectoriesPropertiesStatusImportedDirectories = default(int?), int? importedSymlinksPropertiesStatusImportedSymlinks = default(int?), int? preexistingFilesPropertiesStatusPreexistingFiles = default(int?), int? preexistingDirectoriesPropertiesStatusPreexistingDirectories = default(int?), int? preexistingSymlinksPropertiesStatusPreexistingSymlinks = default(int?), int? totalErrorsPropertiesStatusTotalErrors = default(int?), int? totalConflictsPropertiesStatusTotalConflicts = default(int?), int? importedFilesPropertiesStatusBlobSyncEventsImportedFiles = default(int?), int? importedDirectoriesPropertiesStatusBlobSyncEventsImportedDirectories = default(int?), int? importedSymlinksPropertiesStatusBlobSyncEventsImportedSymlinks = default(int?), int? preexistingFilesPropertiesStatusBlobSyncEventsPreexistingFiles = default(int?), int? preexistingDirectoriesPropertiesStatusBlobSyncEventsPreexistingDirectories = default(int?), int? preexistingSymlinksPropertiesStatusBlobSyncEventsPreexistingSymlinks = default(int?), int? totalBlobsImportedPropertiesStatusBlobSyncEventsTotalBlobsImported = default(int?), int? rateOfBlobImportPropertiesStatusBlobSyncEventsRateOfBlobImport = default(int?), int? totalErrorsPropertiesStatusBlobSyncEventsTotalErrors = default(int?), int? totalConflictsPropertiesStatusBlobSyncEventsTotalConflicts = default(int?), int? deletions = default(int?), System.DateTimeOffset? lastChangeFeedEventConsumedOn = default(System.DateTimeOffset?), System.DateTimeOffset? lastTimeFullySynchronized = default(System.DateTimeOffset?)) { throw null; }
