...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public static partial class ArmStorageCacheModelFactory
    {
        ...
        public static AutoImportJobData AutoImportJobData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AutoImportJobPropertiesProvisioningState? provisioningState = null, AutoImportJobPropertiesAdminStatus? adminStatus = null, IEnumerable<string> autoImportPrefixes = null, ConflictResolutionMode? conflictResolutionMode = null, bool? enableDeletions = null, int? maximumErrors = null, AutoImportJobState? state = null, DateTimeOffset? scanStartOn = null, DateTimeOffset? scanEndOn = null, int? totalBlobsWalked = null, int? rateOfBlobWalk = null, int? totalBlobsImportedPropertiesStatusTotalBlobsImported = null, int? rateOfBlobImportPropertiesStatusRateOfBlobImport = null, int? importedFilesPropertiesStatusImportedFiles = null, int? importedDirectoriesPropertiesStatusImportedDirectories = null, int? importedSymlinksPropertiesStatusImportedSymlinks = null, int? preexistingFilesPropertiesStatusPreexistingFiles = null, int? preexistingDirectoriesPropertiesStatusPreexistingDirectories = null, int? preexistingSymlinksPropertiesStatusPreexistingSymlinks = null, int? totalErrorsPropertiesStatusTotalErrors = null, int? totalConflictsPropertiesStatusTotalConflicts = null, int? importedFilesPropertiesStatusBlobSyncEventsImportedFiles = null, int? importedDirectoriesPropertiesStatusBlobSyncEventsImportedDirectories = null, int? importedSymlinksPropertiesStatusBlobSyncEventsImportedSymlinks = null, int? preexistingFilesPropertiesStatusBlobSyncEventsPreexistingFiles = null, int? preexistingDirectoriesPropertiesStatusBlobSyncEventsPreexistingDirectories = null, int? preexistingSymlinksPropertiesStatusBlobSyncEventsPreexistingSymlinks = null, int? totalBlobsImportedPropertiesStatusBlobSyncEventsTotalBlobsImported = null, int? rateOfBlobImportPropertiesStatusBlobSyncEventsRateOfBlobImport = null, int? totalErrorsPropertiesStatusBlobSyncEventsTotalErrors = null, int? totalConflictsPropertiesStatusBlobSyncEventsTotalConflicts = null, int? deletions = null, DateTimeOffset? lastChangeFeedEventConsumedOn = null, DateTimeOffset? lastTimeFullySynchronized = null)
        {
            tags ??= new Dictionary<string, string>();
