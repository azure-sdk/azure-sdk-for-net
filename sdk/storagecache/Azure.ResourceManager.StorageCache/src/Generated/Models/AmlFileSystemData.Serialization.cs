            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("mgsAddress"u8))
                        {
                            mgsAddress = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("mountCommand"u8))
                        {
                            mountCommand = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("lustreVersion"u8))
                        {
                            lustreVersion = property0.Value.GetString();
                            continue;
                        }
