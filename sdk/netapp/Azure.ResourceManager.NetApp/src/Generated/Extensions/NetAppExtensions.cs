...
namespace Azure.ResourceManager.NetApp
{
    ...
    public static partial class NetAppExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="NetAppAccountBackupVaultBackupResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="NetAppAccountBackupVaultBackupResource.CreateResourceIdentifier" /> to create a <see cref="NetAppAccountBackupVaultBackupResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableNetAppArmClient.GetNetAppAccountBackupVaultBackupResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        /// <returns> Returns a <see cref="NetAppAccountBackupVaultBackupResource"/> object. </returns>
        public static NetAppAccountBackupVaultBackupResource GetNetAppAccountBackupVaultBackupResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableNetAppArmClient(client).GetNetAppAccountBackupVaultBackupResource(id);
        }
