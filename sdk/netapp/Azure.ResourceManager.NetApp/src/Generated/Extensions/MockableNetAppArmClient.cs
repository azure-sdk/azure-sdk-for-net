...
namespace Azure.ResourceManager.NetApp.Mocking
{
    ...
    public partial class MockableNetAppArmClient : ArmResource
    {
        ...
        public virtual NetAppAccountBackupVaultBackupResource GetNetAppAccountBackupVaultBackupResource(ResourceIdentifier id)
        {
            NetAppAccountBackupVaultBackupResource.ValidateResourceId(id);
            return new NetAppAccountBackupVaultBackupResource(Client, id);
        }
