...
["Tag1"] = "Value1",
        ...
        public async Task MigrateBackupsBackupsUnderAccount_BackupsUnderAccountMigrate()
        {
            ...
            // invoke the operation
            BackupsMigrationRequest body = new BackupsMigrationRequest("/subscriptions/D633CC2E-722B-4AE1-B636-BBD9E4C60ED9/resourceGroups/myRG/providers/Microsoft.NetApp/netAppAccounts/account1/backupVaults/backupVault1");
            await netAppAccount.MigrateBackupsBackupsUnderAccountAsync(WaitUntil.Completed, body);
