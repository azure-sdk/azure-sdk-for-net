...
{
    public partial class Sample_NetAppAccountBackupVaultBackupCollection
    {
        // Backups_List
        ...
        public async Task GetAll_BackupsList()
        {
            ...
            // get the collection of this NetAppAccountBackupVaultBackupResource
            NetAppAccountBackupVaultBackupCollection collection = backupVault.GetNetAppAccountBackupVaultBackups();

            // invoke the operation and iterate over the result
            await foreach (NetAppAccountBackupVaultBackupResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_BackupsUnderBackupVaultGet()
        {
            ...
            NetAppAccountBackupVaultBackupResource result = await collection.GetAsync(backupName);
        ...
        public async Task GetIfExists_BackupsUnderBackupVaultGet()
        {
            ...
            // invoke the operation
            string backupName = "backup1";
            NullableResponse<NetAppAccountBackupVaultBackupResource> response = await collection.GetIfExistsAsync(backupName);
            NetAppAccountBackupVaultBackupResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_BackupsUnderBackupVaultCreate()
        {
            ...
            // invoke the operation
            string backupName = "backup1";
            NetAppBackupData data = new NetAppBackupData("/subscriptions/D633CC2E-722B-4AE1-B636-BBD9E4C60ED9/resourceGroups/myRG/providers/Microsoft.NetApp/netAppAccounts/account1/capacityPool/pool1/volumes/volume1")
            {
                Label = "myLabel",
            };
            ArmOperation<NetAppAccountBackupVaultBackupResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, backupName, data);
