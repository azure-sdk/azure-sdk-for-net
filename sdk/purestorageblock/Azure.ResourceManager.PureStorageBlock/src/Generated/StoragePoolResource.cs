...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class StoragePoolResource : ArmResource
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<HealthResult>> GetHealthStatusAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<HealthResult> GetHealthStatus(CancellationToken cancellationToken = default)
        {
            using var scope = _storagePoolClientDiagnostics.CreateScope("StoragePoolResource.GetHealthStatus");
            scope.Start();
            try
