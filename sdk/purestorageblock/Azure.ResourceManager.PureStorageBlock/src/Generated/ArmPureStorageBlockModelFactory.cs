...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    public static partial class ArmPureStorageBlockModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.HealthResult"/>. </summary>
        /// <param name="health"> Health metrics. </param>
        /// <param name="alerts"> List of health alerts. </param>
        /// <returns> A new <see cref="Models.HealthResult"/> instance for mocking. </returns>
        public static HealthResult HealthResult(HealthDetails health = null, IEnumerable<Alert> alerts = null)
        {
            alerts ??= new List<Alert>();

            return new HealthResult(health, alerts?.ToList(), serializedAdditionalRawData: null);
        }
