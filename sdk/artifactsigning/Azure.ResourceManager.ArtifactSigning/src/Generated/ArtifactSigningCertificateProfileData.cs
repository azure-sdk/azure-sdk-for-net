...
namespace Azure.ResourceManager.ArtifactSigning
{
    ...
    public partial class ArtifactSigningCertificateProfileData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ArtifactSigningCertificateProfileData"/>. </summary>
        ...
        public IReadOnlyList<ArtifactSigningCertificate> Certificates
        {
            get
            {
                if (Properties is null)
