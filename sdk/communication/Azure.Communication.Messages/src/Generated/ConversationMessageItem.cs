...
namespace Azure.Communication.Messages
{
    ...
    public partial class ConversationMessageItem
    {
        ...
        internal ConversationMessageItem(long? sequenceId, ConversationMessageContent message, string senderDisplayName, string senderCommunicationIdentifier, DateTimeOffset createdOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
