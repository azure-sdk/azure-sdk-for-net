...
namespace Azure.Communication.Messages
{
    ...
    public partial class ConversationManagementClient
    {
        ...
        /// <summary> Initializes a new instance of ConversationManagementClient for mocking. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ConversationManagementClient(Uri endpoint, AzureKeyCredential credential, CommunicationMessagesClientOptions options)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> or <paramref name="resource"/> is null. </exception>
        ...
        /// <include file="Docs/ConversationManagementClient.xml" path="doc/members/member[@name='CreateAsync(string,Conversation,CancellationToken)']/*" />
        public virtual async Task<Response<Conversation>> CreateAsync(string conversationId, Conversation resource, CancellationToken cancellationToken = default)
        {
            ...
            Response response = await CreateAsync(conversationId, content, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> or <paramref name="resource"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationManagementClient.xml" path="doc/members/member[@name='Create(string,Conversation,CancellationToken)']/*" />
        public virtual Response<Conversation> Create(string conversationId, Conversation resource, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNull(resource, nameof(resource));
            ...
            using RequestContent content = resource.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = Create(conversationId, content, context);
            return Response.FromValue(Conversation.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateAsync(string,Conversation,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/ConversationManagementClient.xml" path="doc/members/member[@name='CreateAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateAsync(string conversationId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("ConversationManagementClient.Create");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCreateRequest(conversationId, content, context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Create(string,Conversation,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationManagementClient.xml" path="doc/members/member[@name='Create(string,RequestContent,RequestContext)']/*" />
        public virtual Response Create(string conversationId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationManagementClient.xml" path="doc/members/member[@name='AnalyzeAsync(string,CancellationToken)']/*" />
        public virtual async Task<Response<GetConversationMessagesAnalysisResult>> AnalyzeAsync(string conversationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await AnalyzeAsync(conversationId, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationManagementClient.xml" path="doc/members/member[@name='Analyze(string,CancellationToken)']/*" />
        public virtual Response<GetConversationMessagesAnalysisResult> Analyze(string conversationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = Analyze(conversationId, context);
            return Response.FromValue(GetConversationMessagesAnalysisResult.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AnalyzeAsync(string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationManagementClient.xml" path="doc/members/member[@name='AnalyzeAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> AnalyzeAsync(string conversationId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));

            using var scope = ClientDiagnostics.CreateScope("ConversationManagementClient.Analyze");
            scope.Start();
            try
            {
                using HttpMessage message = CreateAnalyzeRequest(conversationId, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Analyze(string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationManagementClient.xml" path="doc/members/member[@name='Analyze(string,RequestContext)']/*" />
        public virtual Response Analyze(string conversationId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
        ...
        /// <param name="participant"> The participant user ID. </param>
        ...
        public virtual AsyncPageable<Conversation> GetConversationsAsync(int? maxpagesize = null, string participant = null, Guid? channelId = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConversationsRequest(pageSizeHint, participant, channelId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConversationsNextPageRequest(nextLink, pageSizeHint, participant, channelId, context);
        ...
        public virtual Pageable<Conversation> GetConversations(int? maxpagesize = null, string participant = null, Guid? channelId = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConversationsRequest(pageSizeHint, participant, channelId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConversationsNextPageRequest(nextLink, pageSizeHint, participant, channelId, context);
        ...
        public virtual AsyncPageable<BinaryData> GetConversationsAsync(int? maxpagesize, string participant, Guid? channelId, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConversationsRequest(pageSizeHint, participant, channelId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConversationsNextPageRequest(nextLink, pageSizeHint, participant, channelId, context);
        ...
        public virtual Pageable<BinaryData> GetConversations(int? maxpagesize, string participant, Guid? channelId, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConversationsRequest(pageSizeHint, participant, channelId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConversationsNextPageRequest(nextLink, pageSizeHint, participant, channelId, context);
        ...
        public virtual AsyncPageable<ConversationMessageItem> GetMessagesAsync(string conversationId, int? maxpagesize = null, string participant = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));

            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetMessagesRequest(conversationId, pageSizeHint, participant, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetMessagesNextPageRequest(nextLink, conversationId, pageSizeHint, participant, context);
        ...
        public virtual Pageable<ConversationMessageItem> GetMessages(string conversationId, int? maxpagesize = null, string participant = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
        ...
        public virtual AsyncPageable<BinaryData> GetMessagesAsync(string conversationId, int? maxpagesize, string participant, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
        ...
        public virtual Pageable<BinaryData> GetMessages(string conversationId, int? maxpagesize, string participant, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
        ...
        internal HttpMessage CreateCreateRequest(string conversationId, RequestContent content, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetConversationsRequest(int? maxpagesize, string participant, Guid? channelId, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            if (participant != null)
            {
                uri.AppendQuery("participant", participant, true);
            }
            if (channelId != null)
            {
        ...
        internal HttpMessage CreateGetMessagesRequest(string conversationId, int? maxpagesize, string participant, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateAnalyzeRequest(string conversationId, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        internal HttpMessage CreateGetConversationsNextPageRequest(string nextLink, int? maxpagesize, string participant, Guid? channelId, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateGetMessagesNextPageRequest(string nextLink, string conversationId, int? maxpagesize, string participant, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
