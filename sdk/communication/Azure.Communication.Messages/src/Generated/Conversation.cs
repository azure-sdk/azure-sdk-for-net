...
namespace Azure.Communication.Messages
{
    ...
    public partial class Conversation
    {
        ...
        internal Conversation(string conversationId, string topic, IList<string> deliveryChannelIds, OutboundDeliveryStrategyKind? outboundDeliveryStrategy, IList<Participant> participants, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
