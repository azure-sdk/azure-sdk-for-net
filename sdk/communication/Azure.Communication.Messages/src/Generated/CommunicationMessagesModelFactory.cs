...
namespace Azure.Communication.Messages
{
    ...
    public static partial class CommunicationMessagesModelFactory
    {
        ...
        public static Conversation Conversation(string conversationId = null, string topic = null, IEnumerable<string> deliveryChannelIds = null, OutboundDeliveryStrategyKind? outboundDeliveryStrategy = null, IEnumerable<Participant> participants = null)
        {
        ...
        public static ConversationMessageItem ConversationMessageItem(long? sequenceId = null, ConversationMessageContent message = null, string senderDisplayName = null, string senderCommunicationIdentifier = null, DateTimeOffset createdOn = default)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Messages.RemoveParticipantsRequest"/>. </summary>
        /// <param name="participantIds"> The participant IDs to remove. </param>
        /// <returns> A new <see cref="Messages.RemoveParticipantsRequest"/> instance for mocking. </returns>
        public static RemoveParticipantsRequest RemoveParticipantsRequest(IEnumerable<string> participantIds = null)
        {
            participantIds ??= new List<string>();

            return new RemoveParticipantsRequest(participantIds?.ToList(), serializedAdditionalRawData: null);
        }
