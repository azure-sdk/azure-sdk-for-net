...
namespace Azure.Communication.JobRouter
{
    ...
    internal partial class UnknownJobMatchingMode : JobMatchingMode
    {
        ...
        internal UnknownJobMatchingMode(JobMatchingModeKind jobMatchingModeKind, JobMatchingModeKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(jobMatchingModeKind, kind, serializedAdditionalRawData)
        {
        }
