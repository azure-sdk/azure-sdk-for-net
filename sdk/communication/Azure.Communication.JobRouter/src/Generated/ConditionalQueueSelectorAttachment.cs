...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ConditionalQueueSelectorAttachment : QueueSelectorAttachment
    {
        ...
        internal ConditionalQueueSelectorAttachment(QueueSelectorAttachmentKind queueSelectorAttachmentKind, RouterRule condition, IEnumerable<RouterQueueSelector> queueSelectors) : base(queueSelectorAttachmentKind)
        {
        ...
        /// </param>
        /// <param name="queueSelectors"> The queue selectors to attach. </param>
        internal ConditionalQueueSelectorAttachment(QueueSelectorAttachmentKind queueSelectorAttachmentKind, QueueSelectorAttachmentKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, RouterRule condition, IList<RouterQueueSelector> queueSelectors) : base(queueSelectorAttachmentKind, kind, serializedAdditionalRawData)
        {
            Condition = condition;
