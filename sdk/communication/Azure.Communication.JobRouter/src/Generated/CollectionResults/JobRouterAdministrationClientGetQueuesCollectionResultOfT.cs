...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterAdministrationClientGetQueuesCollectionResultOfT : Pageable<RouterQueue>
    {
        ...
        public JobRouterAdministrationClientGetQueuesCollectionResultOfT(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
