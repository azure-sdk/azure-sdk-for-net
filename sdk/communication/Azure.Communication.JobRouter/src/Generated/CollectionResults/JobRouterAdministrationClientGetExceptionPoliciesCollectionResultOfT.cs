...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterAdministrationClientGetExceptionPoliciesCollectionResultOfT : Pageable<ExceptionPolicy>
    {
        ...
        public JobRouterAdministrationClientGetExceptionPoliciesCollectionResultOfT(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
