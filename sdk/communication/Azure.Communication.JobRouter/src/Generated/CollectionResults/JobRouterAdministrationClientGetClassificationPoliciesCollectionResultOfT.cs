...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterAdministrationClientGetClassificationPoliciesCollectionResultOfT : Pageable<ClassificationPolicy>
    {
        ...
        public JobRouterAdministrationClientGetClassificationPoliciesCollectionResultOfT(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterAdministrationClientGetClassificationPoliciesCollectionResultOfT as an enumerable collection. </summary>
