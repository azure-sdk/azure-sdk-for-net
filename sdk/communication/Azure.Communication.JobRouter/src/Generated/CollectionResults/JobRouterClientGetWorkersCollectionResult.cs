...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterClientGetWorkersCollectionResult : Pageable<BinaryData>
    {
        ...
        public JobRouterClientGetWorkersCollectionResult(JobRouterClient client, int? maxpagesize, string state, string channelId, string queueId, bool? hasCapacity, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
