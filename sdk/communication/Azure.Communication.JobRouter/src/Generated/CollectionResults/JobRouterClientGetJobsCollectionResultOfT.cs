...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterClientGetJobsCollectionResultOfT : Pageable<RouterJob>
    {
        ...
        public JobRouterClientGetJobsCollectionResultOfT(JobRouterClient client, int? maxpagesize, string status, string queueId, string channelId, string classificationPolicyId, DateTimeOffset? scheduledBefore, DateTimeOffset? scheduledAfter, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
