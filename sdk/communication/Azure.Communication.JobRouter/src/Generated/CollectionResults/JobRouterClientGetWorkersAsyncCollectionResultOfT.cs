...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterClientGetWorkersAsyncCollectionResultOfT : AsyncPageable<RouterWorker>
    {
        ...
        public JobRouterClientGetWorkersAsyncCollectionResultOfT(JobRouterClient client, int? maxpagesize, string state, string channelId, string queueId, bool? hasCapacity, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
