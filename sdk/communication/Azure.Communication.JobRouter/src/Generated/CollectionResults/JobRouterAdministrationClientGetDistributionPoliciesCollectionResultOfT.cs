...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterAdministrationClientGetDistributionPoliciesCollectionResultOfT : Pageable<DistributionPolicy>
    {
        ...
        public JobRouterAdministrationClientGetDistributionPoliciesCollectionResultOfT(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
