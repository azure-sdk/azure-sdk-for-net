...
{
    internal partial class JobRouterClientGetWorkersCollectionResultOfT : Pageable<RouterWorker>
    {
        ...
        /// <summary> Initializes a new instance of JobRouterClientGetWorkersCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public JobRouterClientGetWorkersCollectionResultOfT(JobRouterClient client, int? maxpagesize, string state, string channelId, string queueId, bool? hasCapacity, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterClientGetWorkersCollectionResultOfT as an enumerable collection. </summary>
