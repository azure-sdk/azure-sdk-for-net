...
{
    internal partial class JobRouterAdministrationClientGetClassificationPoliciesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of JobRouterAdministrationClientGetClassificationPoliciesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public JobRouterAdministrationClientGetClassificationPoliciesAsyncCollectionResult(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterAdministrationClientGetClassificationPoliciesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of JobRouterAdministrationClientGetClassificationPoliciesAsyncCollectionResult as an enumerable collection. </returns>
