...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterClientGetWorkersAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public JobRouterClientGetWorkersAsyncCollectionResult(JobRouterClient client, int? maxpagesize, string state, string channelId, string queueId, bool? hasCapacity, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterClientGetWorkersAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of JobRouterClientGetWorkersAsyncCollectionResult as an enumerable collection. </returns>
