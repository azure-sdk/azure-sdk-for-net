...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ReclassifyExceptionAction : ExceptionAction
    {
        ...
        internal ReclassifyExceptionAction(ExceptionActionKind exceptionActionKind) : base(exceptionActionKind)
        {
        ...
        internal ReclassifyExceptionAction(string id, ExceptionActionKind exceptionActionKind, ExceptionActionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string classificationPolicyId, IDictionary<string, BinaryData> labelsToUpsert) : base(id, exceptionActionKind, kind, serializedAdditionalRawData)
        {
