...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ConditionalWorkerSelectorAttachment : WorkerSelectorAttachment
    {
        ...
        internal ConditionalWorkerSelectorAttachment(WorkerSelectorAttachmentKind workerSelectorAttachmentKind, RouterRule condition, IEnumerable<RouterWorkerSelector> workerSelectors) : base(workerSelectorAttachmentKind)
        {
        ...
        /// </param>
        /// <param name="workerSelectors"> The worker selectors to attach. </param>
        internal ConditionalWorkerSelectorAttachment(WorkerSelectorAttachmentKind workerSelectorAttachmentKind, WorkerSelectorAttachmentKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, RouterRule condition, IList<RouterWorkerSelector> workerSelectors) : base(workerSelectorAttachmentKind, kind, serializedAdditionalRawData)
        {
            Condition = condition;
