...
namespace Azure.ResourceManager.Communication
{
    ...
    public partial class CommunicationServiceResourceCollection : ArmCollection, IEnumerable<CommunicationServiceResource>, IAsyncEnumerable<CommunicationServiceResource>
    {
        ...
        public virtual async Task<ArmOperation<CommunicationServiceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string communicationServiceName, CommunicationServiceResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _communicationServiceResourceCommunicationServicesRestClient.CreateOrUpdateAsync(Guid.Parse(_subscriptionId), _resourceGroupName, communicationServiceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new CommunicationArmOperation<CommunicationServiceResource>(new CommunicationServiceResourceOperationSource(Client), _communicationServiceResourceCommunicationServicesClientDiagnostics, Pipeline, _communicationServiceResourceCommunicationServicesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(_subscriptionId), _resourceGroupName, communicationServiceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<CommunicationServiceResource> CreateOrUpdate(WaitUntil waitUntil, string communicationServiceName, CommunicationServiceResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _communicationServiceResourceCommunicationServicesRestClient.CreateOrUpdate(Guid.Parse(_subscriptionId), _resourceGroupName, communicationServiceName, data, cancellationToken);
                var operation = new CommunicationArmOperation<CommunicationServiceResource>(new CommunicationServiceResourceOperationSource(Client), _communicationServiceResourceCommunicationServicesClientDiagnostics, Pipeline, _communicationServiceResourceCommunicationServicesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(_subscriptionId), _resourceGroupName, communicationServiceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<CommunicationServiceResource>> GetAsync(string communicationServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _communicationServiceResourceCommunicationServicesRestClient.GetAsync(Guid.Parse(_subscriptionId), _resourceGroupName, communicationServiceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CommunicationServiceResource> Get(string communicationServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _communicationServiceResourceCommunicationServicesRestClient.Get(Guid.Parse(_subscriptionId), _resourceGroupName, communicationServiceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new CommunicationServiceResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _communicationServiceResourceCommunicationServicesRestClient.CreateListByResourceGroupRequest(Guid.Parse(_subscriptionId), _resourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _communicationServiceResourceCommunicationServicesRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Guid.Parse(_subscriptionId), _resourceGroupName);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string communicationServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _communicationServiceResourceCommunicationServicesRestClient.GetAsync(Guid.Parse(_subscriptionId), _resourceGroupName, communicationServiceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string communicationServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _communicationServiceResourceCommunicationServicesRestClient.Get(Guid.Parse(_subscriptionId), _resourceGroupName, communicationServiceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
