...
namespace Azure.ResourceManager.Communication
{
    ...
    /// Each <see cref="EmailServiceResource" /> in the collection will belong to the same instance of <see cref="TenantResource" />.
    /// To get an <see cref="EmailServiceResourceCollection" /> instance call the GetEmailServiceResources method from an instance of <see cref="TenantResource" />.
    /// </summary>
    public partial class EmailServiceResourceCollection : ArmCollection, IEnumerable<EmailServiceResource>, IAsyncEnumerable<EmailServiceResource>
    {
        ...
        internal EmailServiceResourceCollection(ArmClient client, ResourceIdentifier id, Guid subscriptionId, string resourceGroupName) : base(client, id)
        {
        ...
        public virtual async Task<ArmOperation<EmailServiceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string emailServiceName, EmailServiceResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _emailServiceResourceEmailServicesRestClient.CreateOrUpdateAsync(Guid.Parse(_subscriptionId), _resourceGroupName, emailServiceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new CommunicationArmOperation<EmailServiceResource>(new EmailServiceResourceOperationSource(Client), _emailServiceResourceEmailServicesClientDiagnostics, Pipeline, _emailServiceResourceEmailServicesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(_subscriptionId), _resourceGroupName, emailServiceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<EmailServiceResource> CreateOrUpdate(WaitUntil waitUntil, string emailServiceName, EmailServiceResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _emailServiceResourceEmailServicesRestClient.CreateOrUpdate(Guid.Parse(_subscriptionId), _resourceGroupName, emailServiceName, data, cancellationToken);
                var operation = new CommunicationArmOperation<EmailServiceResource>(new EmailServiceResourceOperationSource(Client), _emailServiceResourceEmailServicesClientDiagnostics, Pipeline, _emailServiceResourceEmailServicesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(_subscriptionId), _resourceGroupName, emailServiceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<EmailServiceResource>> GetAsync(string emailServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _emailServiceResourceEmailServicesRestClient.GetAsync(Guid.Parse(_subscriptionId), _resourceGroupName, emailServiceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<EmailServiceResource> Get(string emailServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _emailServiceResourceEmailServicesRestClient.Get(Guid.Parse(_subscriptionId), _resourceGroupName, emailServiceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new EmailServiceResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _emailServiceResourceEmailServicesRestClient.CreateListByResourceGroupRequest(Guid.Parse(_subscriptionId), _resourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _emailServiceResourceEmailServicesRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Guid.Parse(_subscriptionId), _resourceGroupName);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string emailServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _emailServiceResourceEmailServicesRestClient.GetAsync(Guid.Parse(_subscriptionId), _resourceGroupName, emailServiceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string emailServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _emailServiceResourceEmailServicesRestClient.Get(Guid.Parse(_subscriptionId), _resourceGroupName, emailServiceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
