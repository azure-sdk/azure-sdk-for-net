...
namespace Azure.ResourceManager.Communication
{
    ...
    internal partial class TenantResourceExtensionClient : ArmResource
    {
        ...
        public virtual async Task<Response<CommunicationNameAvailabilityResult>> CheckCommunicationNameAvailabilityAsync(CommunicationServiceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await CommunicationServiceResourceCommunicationServicesRestClient.CheckNameAvailabilityAsync(Guid.Parse(_subscriptionId), content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<CommunicationNameAvailabilityResult> CheckCommunicationNameAvailability(CommunicationServiceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = CommunicationServiceResourceCommunicationServicesRestClient.CheckNameAvailability(Guid.Parse(_subscriptionId), content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CommunicationServiceResourceCommunicationServicesRestClient.CreateListBySubscriptionRequest(Guid.Parse(_subscriptionId));
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CommunicationServiceResourceCommunicationServicesRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Guid.Parse(_subscriptionId));
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EmailServiceResourceEmailServicesRestClient.CreateListBySubscriptionRequest(Guid.Parse(_subscriptionId));
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => EmailServiceResourceEmailServicesRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Guid.Parse(_subscriptionId));
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EmailServiceResourceEmailServicesRestClient.CreateListVerifiedExchangeOnlineDomainsRequest(Guid.Parse(_subscriptionId));
