...
namespace Azure.ResourceManager.Dell.Storage.Models
{
    ...
    public partial class DellFileSystemPatch
    {
        ...
        internal DellFileSystemPatch(ManagedServiceIdentityUpdate identity, IDictionary<string, string> tags, FileSystemResourceUpdateProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Tags = tags;
