...
namespace Azure.ResourceManager.Dell.Models
{
    ...
    public partial class MarketplaceDetails
    {
        ...
        internal MarketplaceDetails(string marketplaceSubscriptionId, string planId, string offerId, string publisherId, string privateOfferId, string planName, MarketplaceSubscriptionStatus? marketplaceSubscriptionStatus, string endDate, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
