...
namespace Azure.ResourceManager.Dell.Models
{
    ...
    public partial class FileSystemResourceProperties
    {
        ...
        internal FileSystemResourceProperties(Capacity capacity, MarketplaceDetails marketplace, ProvisioningState? provisioningState, string delegatedSubnetId, string delegatedSubnetCidr, UserDetails user, string fileSystemId, string smartConnectFqdn, string dellReferenceNumber, EncryptionProperties encryption, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Capacity = capacity;
            Marketplace = marketplace;
