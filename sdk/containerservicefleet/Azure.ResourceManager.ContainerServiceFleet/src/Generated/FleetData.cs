...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    ...
    public partial class FleetData : TrackedResourceData
    {
        ...
        internal FleetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, FleetProvisioningState? provisioningState, FleetHubProfile hubProfile, FleetStatus status, string etag, Models.ManagedServiceIdentity identity, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
