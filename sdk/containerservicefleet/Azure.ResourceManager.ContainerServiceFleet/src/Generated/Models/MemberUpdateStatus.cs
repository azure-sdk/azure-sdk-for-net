...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    public partial class MemberUpdateStatus
    {
        ...
        internal MemberUpdateStatus(UpdateStatus status, string name, string clusterResourceId, string operationId, string message, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Name = name;
