...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    ...
    public partial class FleetMemberData : ResourceData
    {
        ...
        internal FleetMemberData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier clusterResourceId, string group, FleetMemberProvisioningState? provisioningState, FleetMemberStatus status, string etag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
