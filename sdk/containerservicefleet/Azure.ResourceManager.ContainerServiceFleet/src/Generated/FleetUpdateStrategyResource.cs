...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    ...
    public partial class FleetUpdateStrategyResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>FleetUpdateStrategy_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-03-01</description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerServiceFleetArmOperation(_fleetUpdateStrategyClientDiagnostics, Pipeline, _fleetUpdateStrategyRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch).Request, response, OperationFinalStateVia.Location);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>FleetUpdateStrategy_CreateOrUpdate</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-03-01</description>
