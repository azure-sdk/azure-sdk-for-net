...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    ...
    public partial class UpdateRunData : ResourceData
    {
        ...
        internal UpdateRunData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, UpdateRunProvisioningState? provisioningState, ResourceIdentifier updateStrategyId, UpdateRunStrategy strategy, ManagedClusterUpdate managedClusterUpdate, UpdateRunStatus status, ResourceIdentifier autoUpgradeProfileId, string etag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
