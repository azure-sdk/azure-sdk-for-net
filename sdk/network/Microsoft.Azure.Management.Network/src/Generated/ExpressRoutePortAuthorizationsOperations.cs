...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class ExpressRoutePortAuthorizationsOperations : IServiceOperations<NetworkManagementClient>, IExpressRoutePortAuthorizationsOperations
    {
        ...
        /// </param>
        public async Task<AzureOperationHeaderResponse<ExpressRoutePortAuthorizationsDeleteHeaders>> DeleteWithHttpMessagesAsync(string resourceGroupName, string expressRoutePortName, string authorizationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationHeaderResponse<ExpressRoutePortAuthorizationsDeleteHeaders> _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, expressRoutePortName, authorizationName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationHeaderResponse<ExpressRoutePortAuthorizationsDeleteHeaders>> BeginDeleteWithHttpMessagesAsync(string resourceGroupName, string expressRoutePortName, string authorizationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
            ...
            // Create Result
            var _result = new AzureOperationHeaderResponse<ExpressRoutePortAuthorizationsDeleteHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<ExpressRoutePortAuthorizationsDeleteHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
