...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class FirewallPolicyDeploymentsOperationsExtensions
    {
            ...
            {
                return operations.DeployAsync(resourceGroupName, firewallPolicyName).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<FirewallPolicyDeploymentsDeployHeaders> DeployAsync(this IFirewallPolicyDeploymentsOperations operations, string resourceGroupName, string firewallPolicyName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginDeployAsync(resourceGroupName, firewallPolicyName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<FirewallPolicyDeploymentsDeployHeaders> BeginDeployAsync(this IFirewallPolicyDeploymentsOperations operations, string resourceGroupName, string firewallPolicyName, CancellationToken cancellationToken = default(CancellationToken))
            {
