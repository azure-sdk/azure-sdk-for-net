...
namespace Microsoft.Azure.Management.Network
{
    ...
    public partial interface INetworkManagementClient : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionActiveSession>,GetActiveSessionsHeaders>> GetActiveSessionsWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Returns the list of session state after disconnecting the specified
        /// active sessions.
        /// </summary>
        /// <param name='resourceGroupName'>
        /// The name of the resource group.
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionSessionState>,DisconnectActiveSessionsHeaders>> DisconnectActiveSessionsWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, SessionIds sessionIds, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionActiveSession>,GetActiveSessionsHeaders>> BeginGetActiveSessionsWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionSessionState>,DisconnectActiveSessionsHeaders>> BeginDisconnectActiveSessionsWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, SessionIds sessionIds, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionActiveSession>,GetActiveSessionsHeaders>> GetActiveSessionsNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionSessionState>,DisconnectActiveSessionsHeaders>> DisconnectActiveSessionsNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionActiveSession>,GetActiveSessionsHeaders>> BeginGetActiveSessionsNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionSessionState>,DisconnectActiveSessionsHeaders>> BeginDisconnectActiveSessionsNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
