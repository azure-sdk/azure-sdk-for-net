...
namespace Microsoft.Azure.Management.Network
{
    ...
    public partial interface INetworkManagementClient : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionSessionState>>> BeginDisconnectActiveSessionsWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, SessionIds sessionIds, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<BastionSessionState>>> BeginDisconnectActiveSessionsNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
