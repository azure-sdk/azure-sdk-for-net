...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class PublicIPAddressesOperationsExtensions
    {
            ...
            /// The name of the cloud service.
            /// </param>
            public static IPage<PublicIPAddress> ListCloudServicePublicIPAddress(this IPublicIPAddressesOperations operations, string resourceGroupName, string cloudServiceName)
            {
                return operations.ListCloudServicePublicIPAddressAsync(resourceGroupName, cloudServiceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PublicIPAddress>> ListCloudServicePublicIPAddressAsync(this IPublicIPAddressesOperations operations, string resourceGroupName, string cloudServiceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListCloudServicePublicIPAddressWithHttpMessagesAsync(resourceGroupName, cloudServiceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The IP configuration name.
            /// </param>
            public static IPage<PublicIPAddress> ListCloudServiceRoleInstancePublicIPAddress(this IPublicIPAddressesOperations operations, string resourceGroupName, string cloudServiceName, string roleInstanceName, string networkInterfaceName, string ipConfigurationName)
            {
                return operations.ListCloudServiceRoleInstancePublicIPAddressAsync(resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, ipConfigurationName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PublicIPAddress>> ListCloudServiceRoleInstancePublicIPAddressAsync(this IPublicIPAddressesOperations operations, string resourceGroupName, string cloudServiceName, string roleInstanceName, string networkInterfaceName, string ipConfigurationName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListCloudServiceRoleInstancePublicIPAddressWithHttpMessagesAsync(resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, ipConfigurationName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The name of the public IP Address.
            /// </param>
            public static PublicIPAddress GetCloudServiceRoleInstancePublicIPAddress(this IPublicIPAddressesOperations operations, string resourceGroupName, string cloudServiceName, string roleInstanceName, string networkInterfaceName, string ipConfigurationName, string publicIpAddressName)
            {
                return operations.GetCloudServiceRoleInstancePublicIPAddressAsync(resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, ipConfigurationName, publicIpAddressName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PublicIPAddress> GetCloudServiceRoleInstancePublicIPAddressAsync(this IPublicIPAddressesOperations operations, string resourceGroupName, string cloudServiceName, string roleInstanceName, string networkInterfaceName, string ipConfigurationName, string publicIpAddressName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetCloudServiceRoleInstancePublicIPAddressWithHttpMessagesAsync(resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, ipConfigurationName, publicIpAddressName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static IPage<PublicIPAddress> ListCloudServicePublicIPAddressNext(this IPublicIPAddressesOperations operations, string nextPageLink)
            {
                return operations.ListCloudServicePublicIPAddressNextAsync(nextPageLink).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PublicIPAddress>> ListCloudServicePublicIPAddressNextAsync(this IPublicIPAddressesOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListCloudServicePublicIPAddressNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static IPage<PublicIPAddress> ListCloudServiceRoleInstancePublicIPAddressNext(this IPublicIPAddressesOperations operations, string nextPageLink)
            {
                return operations.ListCloudServiceRoleInstancePublicIPAddressNextAsync(nextPageLink).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PublicIPAddress>> ListCloudServiceRoleInstancePublicIPAddressNextAsync(this IPublicIPAddressesOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListCloudServiceRoleInstancePublicIPAddressNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
