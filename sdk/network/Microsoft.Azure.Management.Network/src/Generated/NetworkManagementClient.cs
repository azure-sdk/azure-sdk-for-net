...
namespace Microsoft.Azure.Management.Network
{
    ...
    public partial class NetworkManagementClient : ServiceClient<NetworkManagementClient>, INetworkManagementClient, IAzureClient
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<SetSessionRecordingSasUrlResponse,SetSessionRecordingSasUrlHeaders>> SetSessionRecordingSasUrlWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, string sasurl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<SetSessionRecordingSasUrlResponse,SetSessionRecordingSasUrlHeaders> _response = await BeginSetSessionRecordingSasUrlWithHttpMessagesAsync(resourceGroupName, bastionHostName, sasurl, customHeaders, cancellationToken).ConfigureAwait(false);
            return await this.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<string,GetSessionRecordingSasUrlHeaders>> GetSessionRecordingSasUrlWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<string,GetSessionRecordingSasUrlHeaders> _response = await BeginGetSessionRecordingSasUrlWithHttpMessagesAsync(resourceGroupName, bastionHostName, customHeaders, cancellationToken).ConfigureAwait(false);
            return await this.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<SetSessionRecordingSasUrlResponse,SetSessionRecordingSasUrlHeaders>> BeginSetSessionRecordingSasUrlWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, string sasurl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.SubscriptionId");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("bastionHostName", bastionHostName);
                tracingParameters.Add("apiVersion", apiVersion);
                tracingParameters.Add("sasurl", sasurl);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginSetSessionRecordingSasUrl", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}/setSessionRecordingSasUrl").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{bastionHostName}", System.Uri.EscapeDataString(bastionHostName));
            List<string> _queryParameters = new List<string>();
            ...
            if(sasurl != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(sasurl, SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType =System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
            ...
            // Create Result
            var _result = new AzureOperationResponse<SetSessionRecordingSasUrlResponse,SetSessionRecordingSasUrlHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<SetSessionRecordingSasUrlResponse>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<SetSessionRecordingSasUrlHeaders>(JsonSerializer.Create(DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<string,GetSessionRecordingSasUrlHeaders>> BeginGetSessionRecordingSasUrlWithHttpMessagesAsync(string resourceGroupName, string bastionHostName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.SubscriptionId");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("apiVersion", apiVersion);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginGetSessionRecordingSasUrl", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}/getSessionRecordingSasUrl").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{bastionHostName}", System.Uri.EscapeDataString(bastionHostName));
            List<string> _queryParameters = new List<string>();
            ...
            // Create Result
            var _result = new AzureOperationResponse<string,GetSessionRecordingSasUrlHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<GetSessionRecordingSasUrlHeaders>(JsonSerializer.Create(DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
