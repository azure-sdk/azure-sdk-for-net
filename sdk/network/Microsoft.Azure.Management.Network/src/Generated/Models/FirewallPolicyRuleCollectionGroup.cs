...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class FirewallPolicyRuleCollectionGroup : SubResource
    {
        ...
        /// <param name="ruleCollectionGroupSize">A read-only string that
        /// represents the size of the
        /// FirewallPolicyRuleCollectionGroupProperties in MB. (ex
        /// 1.2MB)</param>
        ...
        public FirewallPolicyRuleCollectionGroup(string id = default(string), string ruleCollectionGroupSize = default(string), int? priority = default(int?), IList<FirewallPolicyRuleCollection> ruleCollections = default(IList<FirewallPolicyRuleCollection>), string provisioningState = default(string), string name = default(string), string etag = default(string), string type = default(string))
            : base(id)
        {
            RuleCollectionGroupSize = ruleCollectionGroupSize;
            Priority = priority;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.ruleCollectionGroupSize")]
        public string RuleCollectionGroupSize { get; private set; }
