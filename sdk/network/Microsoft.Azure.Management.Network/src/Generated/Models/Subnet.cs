...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class Subnet : SubResource
    {
        ...
        /// <param name="sharingScope">Set this property to Tenant to allow
        /// sharing subnet with other subscriptions in your AAD tenant. This
        /// property can only be set if defaultOutboundAccess is set to false,
        /// both properties can only be set if subnet is empty. Possible values
        /// include: 'Tenant', 'DelegatedServices'</param>
        ...
        /// <summary>
        /// Gets or sets set this property to Tenant to allow sharing subnet
        /// with other subscriptions in your AAD tenant. This property can only
        /// be set if defaultOutboundAccess is set to false, both properties
        /// can only be set if subnet is empty. Possible values include:
        /// 'Tenant', 'DelegatedServices'
        /// </summary>
        [JsonProperty(PropertyName = "properties.sharingScope")]
