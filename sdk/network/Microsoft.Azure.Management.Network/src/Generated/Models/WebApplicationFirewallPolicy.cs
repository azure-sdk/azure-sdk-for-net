...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class WebApplicationFirewallPolicy : Resource
    {
        ...
        /// <summary>
        /// Gets a collection of references to application gateway for
        /// containers.
        /// </summary>
        [JsonProperty(PropertyName = "properties.applicationGatewayForContainers")]
        public IList<ApplicationGatewayForContainersReferenceDefinition> ApplicationGatewayForContainers { get; private set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element2 in ApplicationGatewayForContainers)
                {
                    if (element2 != null)
                    {
                        element2.Validate();
