...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ServiceEndpointPropertiesFormat
    {
        ...
        /// <param name="networkIdentifier">Public IP Address Resource as
        /// network identifier.</param>
        ...
        public ServiceEndpointPropertiesFormat(string service = default(string), PublicIPAddress networkIdentifier = default(PublicIPAddress), IList<string> locations = default(IList<string>), string provisioningState = default(string))
        {
            Service = service;
        ...
        /// <summary>
        /// Gets or sets public IP Address Resource as network identifier.
        /// </summary>
        [JsonProperty(PropertyName = "networkIdentifier")]
        public PublicIPAddress NetworkIdentifier { get; set; }
