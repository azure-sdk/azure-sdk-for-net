...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ServiceEndpointPropertiesFormat
    {
        ...
        /// <param name="networkIdentifier">A public IP as network
        ...
        public ServiceEndpointPropertiesFormat(string service = default(string), string networkIdentifier = default(string), IList<string> locations = default(IList<string>), string provisioningState = default(string))
        {
            Service = service;
        ...
        /// <summary>
        /// Gets or sets a public IP as network identification.
        /// </summary>
