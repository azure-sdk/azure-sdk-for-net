...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_FlowLogCollection
    {
        ...
        public async Task CreateOrUpdate_CreateOrUpdateFlowLog()
        {
            ...
            {
                Identity = new ResultIdentityObjectForUserAssigned()
                {
                    ResourceIdentityType = ResourceIdentityType.UserAssigned,
                    UserAssignedIdentities =
{
["/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/id1"] = new UserAssignedIdentity(),
["/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/id2"] = new UserAssignedIdentity(),
},
                },
