...
{
    public partial class Sample_RoutingRuleCollection
    {
        // List routing rules
        ...
        public async Task GetAll_ListRoutingRules()
        {
            ...
            // get the collection of this RoutingRuleResource
            RoutingRuleCollection collection = routingRuleCollection.GetRoutingRules();

            // invoke the operation and iterate over the result
            await foreach (RoutingRuleResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                RoutingRuleData resourceData = item.Data;
        ...
        public async Task Get_GetsRoutingRule()
        {
            ...
            RoutingRuleResource result = await collection.GetAsync(ruleName);
        ...
        public async Task GetIfExists_GetsRoutingRule()
        {
            ...
            // invoke the operation
            string ruleName = "SampleRoutingRule";
            NullableResponse<RoutingRuleResource> response = await collection.GetIfExistsAsync(ruleName);
            RoutingRuleResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_CreateADefaultRoutingRule()
        {
            ...
            ArmOperation<RoutingRuleResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, ruleName, data);
