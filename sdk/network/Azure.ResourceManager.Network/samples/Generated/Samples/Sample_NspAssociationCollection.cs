...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_NspAssociationCollection
    {
        ...
        public async Task CreateOrUpdate_NspAssociationPut()
        {
            ...
            ArmOperation<NspAssociationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, associationName, data);
        ...
        public async Task GetIfExists_NspAssociationGet()
        {
            ...
            // invoke the operation
            string associationName = "association1";
            NullableResponse<NspAssociationResource> response = await collection.GetIfExistsAsync(associationName);
