...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_NspLinkCollection
    {
        ...
        public async Task CreateOrUpdate_NspLinksPut()
        {
            ...
            ArmOperation<NspLinkResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, linkName, data);
        ...
        public async Task GetIfExists_NspLinksGet()
        {
            ...
            // invoke the operation
            string linkName = "link1";
            NullableResponse<NspLinkResource> response = await collection.GetIfExistsAsync(linkName);
