...
namespace Azure.ResourceManager.Network.Samples
{
    ...
    {
        // Deploy FirewallPolicy draft
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task DeployFirewallPoliciesDraft_DeployFirewallPolicyDraft()
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2023-06-01/examples/FirewallPolicyDeployDraft.json
            // this example is just showing the usage of "FirewallPoliciesDrafts_Deploy" operation, for the dependent resources, they will have to be created separately.
            ...
            ArmOperation<FirewallPolicyDraft> lro = await firewallPolicy.DeployFirewallPoliciesDraftAsync(WaitUntil.Completed);
            FirewallPolicyDraft result = lro.Value;
