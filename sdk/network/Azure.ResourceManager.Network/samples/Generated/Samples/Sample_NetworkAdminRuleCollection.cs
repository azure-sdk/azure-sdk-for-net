...
{
    public partial class Sample_NetworkAdminRuleCollection
    {
        ...
        public async Task GetAll_ListSecurityAdminRules()
        {
            ...
            // get the collection of this NetworkAdminRuleResource
            NetworkAdminRuleCollection collection = adminRuleGroup.GetNetworkAdminRules();

            // invoke the operation and iterate over the result
            await foreach (NetworkAdminRuleResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                NetworkAdminRuleData resourceData = item.Data;
        ...
        public async Task Get_GetsSecurityAdminRule()
        {
            ...
            NetworkAdminRuleResource result = await collection.GetAsync(ruleName);
        ...
        public async Task GetIfExists_GetsSecurityAdminRule()
        {
            ...
            // invoke the operation
            string ruleName = "SampleAdminRule";
            NullableResponse<NetworkAdminRuleResource> response = await collection.GetIfExistsAsync(ruleName);
            NetworkAdminRuleResource result = response.HasValue ? response.Value : null;
...
"22"
            ...
            ArmOperation<NetworkAdminRuleResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, ruleName, data);
