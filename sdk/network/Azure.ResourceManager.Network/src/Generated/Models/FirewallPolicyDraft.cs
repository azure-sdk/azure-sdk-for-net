...
{
    /// <summary> FirewallPolicy Draft Object. </summary>
    public partial class FirewallPolicyDraft
    {
        /// <summary> Initializes a new instance of FirewallPolicyDraft. </summary>
        ...
        internal FirewallPolicyDraft(AzureFirewallThreatIntelMode? threatIntelMode, FirewallPolicyThreatIntelWhitelist threatIntelWhitelist, FirewallPolicyInsights insights, FirewallPolicySnat snat, FirewallPolicySQL sql, DnsSettings dnsSettings, FirewallPolicyExplicitProxy explicitProxy, FirewallPolicyIntrusionDetection intrusionDetection)
        {
