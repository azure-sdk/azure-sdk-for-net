...
namespace Azure.ResourceManager.Network
{
    public partial class FirewallPolicyRuleCollectionGroupData : IUtf8JsonSerializable
    {
        ...
        internal static FirewallPolicyRuleCollectionGroupData DeserializeFirewallPolicyRuleCollectionGroupData(JsonElement element)
        {
            ...
            Optional<string> ruleCollectionGroupSize = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    {
                        if (property0.NameEquals("ruleCollectionGroupSize"u8))
                        {
                            ruleCollectionGroupSize = property0.Value.GetString();
                            continue;
                        }
            ...
            return new FirewallPolicyRuleCollectionGroupData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), ruleCollectionGroupSize.Value, Optional.ToNullable(priority), Optional.ToList(ruleCollections), Optional.ToNullable(provisioningState));
        }
    }
}
