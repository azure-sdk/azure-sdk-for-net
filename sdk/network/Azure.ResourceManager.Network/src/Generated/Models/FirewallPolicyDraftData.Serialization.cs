...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallPolicyDraftData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FirewallPolicyDraftData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FirewallPolicyDraftData)} does not support '{format}' format.");
            }
        ...
        internal static FirewallPolicyDraftData DeserializeFirewallPolicyDraftData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FirewallPolicyDraftData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), serializedAdditionalRawData, basePolicy, Optional.ToNullable(threatIntelMode), threatIntelWhitelist.Value, insights.Value, snat.Value, sql.Value, dnsSettings.Value, explicitProxy.Value, intrusionDetection.Value);
        }
        ...
        BinaryData IPersistableModel<FirewallPolicyDraftData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FirewallPolicyDraftData)} does not support '{options.Format}' format.");
            }
        }
