...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualApplianceIPConfigurationProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
