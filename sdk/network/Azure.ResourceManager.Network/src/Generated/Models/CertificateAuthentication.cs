...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CertificateAuthentication
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CertificateAuthentication"/>. </summary>
        /// <param name="outboundAuthCertificate"> Outbound authentication certificate. </param>
        /// <param name="inboundAuthCertificateSubjectName"> Inbound authentication certificate subject name. </param>
        /// <param name="inboundAuthCertificateChain"> Inbound authentication certificate chain. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal CertificateAuthentication(string outboundAuthCertificate, string inboundAuthCertificateSubjectName, IList<string> inboundAuthCertificateChain, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Outbound authentication certificate. </summary>
        ...
        /// <summary> Inbound authentication certificate chain. </summary>
