...
{
    /// <summary> Possible profile values. </summary>
    public readonly partial struct FirewallPolicyIntrusionDetectionProfileType : IEquatable<FirewallPolicyIntrusionDetectionProfileType>
    {
        ...
        /// <summary> Low. </summary>
        public static FirewallPolicyIntrusionDetectionProfileType Low { get; } = new FirewallPolicyIntrusionDetectionProfileType(LowValue);
        /// <summary> Balanced. </summary>
        public static FirewallPolicyIntrusionDetectionProfileType Balanced { get; } = new FirewallPolicyIntrusionDetectionProfileType(BalancedValue);
        /// <summary> High. </summary>
        public static FirewallPolicyIntrusionDetectionProfileType High { get; } = new FirewallPolicyIntrusionDetectionProfileType(HighValue);
