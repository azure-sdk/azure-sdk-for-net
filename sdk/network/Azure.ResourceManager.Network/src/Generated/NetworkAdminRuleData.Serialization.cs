...
{
    public partial class NetworkAdminRuleData : IUtf8JsonSerializable, IJsonModel<NetworkAdminRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkAdminRuleData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<NetworkAdminRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkAdminRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkAdminRuleData)} does not support writing '{format}' format.");
            }
        ...
        NetworkAdminRuleData IJsonModel<NetworkAdminRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkAdminRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkAdminRuleData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeNetworkAdminRuleData(document.RootElement, options);
        }

        internal static NetworkAdminRuleData DeserializeNetworkAdminRuleData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetworkAdminRuleData(
                id,
                name,
                type0,
                systemData,
        ...
        BinaryData IPersistableModel<NetworkAdminRuleData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkAdminRuleData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkAdminRuleData)} does not support writing '{options.Format}' format.");
            }
        }

        NetworkAdminRuleData IPersistableModel<NetworkAdminRuleData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkAdminRuleData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkAdminRuleData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<NetworkAdminRuleData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
