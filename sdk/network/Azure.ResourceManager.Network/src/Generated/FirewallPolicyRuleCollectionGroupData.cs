...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicyRuleCollectionGroupData : NetworkResourceData
    {
        ...
        internal FirewallPolicyRuleCollectionGroupData(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, string ruleCollectionGroupSize, int? priority, IList<FirewallPolicyRuleCollectionInfo> ruleCollections, NetworkProvisioningState? provisioningState) : base(id, name, resourceType)
        {
            ETag = etag;
        ...
        public string RuleCollectionGroupSize { get; }
