...
{
    /// <summary>
    /// A class representing the NetworkAdminRule data model.
    /// Network admin rule.
    /// </summary>
    public partial class NetworkAdminRuleData : BaseAdminRule
    {
        /// <summary> Initializes a new instance of <see cref="NetworkAdminRuleData"/>. </summary>
        ...
        public NetworkAdminRuleData(SecurityConfigurationRuleProtocol protocol, SecurityConfigurationRuleAccess access, int priority, SecurityConfigurationRuleDirection direction)
        {
            Protocol = protocol;
        ...
        internal NetworkAdminRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AdminRuleKind kind, string commonResourceType, IDictionary<string, BinaryData> serializedAdditionalRawData, string description, SecurityConfigurationRuleProtocol protocol, IList<AddressPrefixItem> sources, IList<AddressPrefixItem> destinations, IList<string> sourcePortRanges, IList<string> destinationPortRanges, SecurityConfigurationRuleAccess access, int priority, SecurityConfigurationRuleDirection direction, NetworkProvisioningState? provisioningState, Guid? resourceGuid) : base(id, name, resourceType, systemData, kind, commonResourceType, serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="NetworkAdminRuleData"/> for deserialization. </summary>
        internal NetworkAdminRuleData()
        {
        }
