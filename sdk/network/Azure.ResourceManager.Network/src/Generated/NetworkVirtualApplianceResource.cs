...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkVirtualApplianceResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<NetworkVirtualApplianceInstanceId>> GetBootDiagnosticLogsAsync(WaitUntil waitUntil, NetworkVirtualApplianceBootDiagnosticContent content = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="content"> Specifies a virtual machine instance ID from the Network Virtual Appliance VM instances. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<NetworkVirtualApplianceInstanceId> GetBootDiagnosticLogs(WaitUntil waitUntil, NetworkVirtualApplianceBootDiagnosticContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = _networkVirtualApplianceClientDiagnostics.CreateScope("NetworkVirtualApplianceResource.GetBootDiagnosticLogs");
            scope.Start();
            try
