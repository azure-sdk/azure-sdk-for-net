...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public static partial class ArmNetworkModelFactory
    {
        ...
        public static FlowLogData FlowLogData(ResourceIdentifier id = null, string name = null, ResourceType? resourceType = null, AzureLocation? location = null, IDictionary<string, string> tags = null, ETag? etag = null, ResultIdentityObjectForUserAssigned identity = null, ResourceIdentifier targetResourceId = null, Guid? targetResourceGuid = null, ResourceIdentifier storageId = null, bool? enabled = null, RetentionPolicyParameters retentionPolicy = null, FlowLogProperties format = null, TrafficAnalyticsConfigurationProperties trafficAnalyticsConfiguration = null, NetworkProvisioningState? provisioningState = null)
        {
            tags ??= new Dictionary<string, string>();

            return new FlowLogData(id, name, resourceType, location, tags, etag, identity, targetResourceId, targetResourceGuid, storageId, enabled, retentionPolicy, format, trafficAnalyticsConfiguration != null ? new TrafficAnalyticsProperties(trafficAnalyticsConfiguration) : null, provisioningState);
        }
        ...
        /// <param name="retentionPolicy"> Parameters that define the retention policy for flow log. </param>
        /// <param name="format"> Parameters that define the flow log format. </param>
        /// <returns> A new <see cref="Models.FlowLogInformationResponse"/> instance for mocking. </returns>
        public static FlowLogInformationResponse FlowLogInformationResponse(ResourceIdentifier targetResourceId = null, TrafficAnalyticsConfigurationProperties trafficAnalyticsConfiguration = null, ResultIdentityObjectForUserAssigned identity = null, ResourceIdentifier storageId = null, bool enabled = default, RetentionPolicyParameters retentionPolicy = null, FlowLogProperties format = null)
        {
            return new FlowLogInformationResponse(targetResourceId, trafficAnalyticsConfiguration != null ? new TrafficAnalyticsProperties(trafficAnalyticsConfiguration) : null, identity, storageId, enabled, retentionPolicy, format);
        }
