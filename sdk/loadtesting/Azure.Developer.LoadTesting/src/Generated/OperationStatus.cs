...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class OperationStatus
    {
        ...
        internal OperationStatus(OperationState status, OperationKind kind, ResponseError error, string id, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Kind = kind;
            Error = error;
