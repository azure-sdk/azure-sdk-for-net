...
namespace Azure.Developer.LoadTesting
{
    public partial class LoadTestRun : IUtf8JsonSerializable, IJsonModel<LoadTestRun>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(Insights))
            {
        ...
        internal static LoadTestRun DeserializeLoadTestRun(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            TestRunInsights insights = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("insights"u8))
                {
                    ...
                    insights = TestRunInsights.DeserializeTestRunInsights(property.Value, options);
                    continue;
                }
