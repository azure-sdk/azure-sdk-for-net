...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OptionalLoadTestConfig>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OptionalLoadTestConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OptionalLoadTestConfig)} does not support '{format}' format.");
            }
        ...
        internal static OptionalLoadTestConfig DeserializeOptionalLoadTestConfig(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<int> requestsPerSecond = default;
            Optional<int> maxResponseTimeInMs = default;
            ...
            return new OptionalLoadTestConfig(endpointUrl.Value, Optional.ToNullable(requestsPerSecond), Optional.ToNullable(maxResponseTimeInMs), Optional.ToNullable(virtualUsers), Optional.ToNullable(rampUpTime), Optional.ToNullable(duration), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<OptionalLoadTestConfig>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OptionalLoadTestConfig)} does not support '{options.Format}' format.");
            }
        }
