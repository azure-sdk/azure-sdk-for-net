...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadTestConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LoadTestConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LoadTestConfiguration)} does not support '{format}' format.");
            }
        ...
        internal static LoadTestConfiguration DeserializeLoadTestConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new LoadTestConfiguration(Optional.ToNullable(engineInstances), Optional.ToNullable(splitAllCSVs), Optional.ToNullable(quickStartTest), optionalLoadTestConfig.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<LoadTestConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LoadTestConfiguration)} does not support '{options.Format}' format.");
            }
        }
