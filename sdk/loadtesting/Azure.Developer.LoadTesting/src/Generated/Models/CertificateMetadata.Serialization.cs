...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CertificateMetadata>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CertificateMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CertificateMetadata)} does not support '{format}' format.");
            }
        ...
        internal static CertificateMetadata DeserializeCertificateMetadata(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CertificateMetadata(value.Value, Optional.ToNullable(type), name.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CertificateMetadata>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CertificateMetadata)} does not support '{options.Format}' format.");
            }
        }
