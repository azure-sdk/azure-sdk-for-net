...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TestRunFileInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TestRunFileInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TestRunFileInfo)} does not support '{format}' format.");
            }
        ...
        internal static TestRunFileInfo DeserializeTestRunFileInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new TestRunFileInfo(fileName, url.Value, Optional.ToNullable(fileType), Optional.ToNullable(expireDateTime), Optional.ToNullable(validationStatus), validationFailureDetails.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TestRunFileInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TestRunFileInfo)} does not support '{options.Format}' format.");
            }
        }
