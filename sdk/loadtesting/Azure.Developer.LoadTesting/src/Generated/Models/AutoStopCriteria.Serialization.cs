...
namespace Azure.Developer.LoadTesting.Models
{
    public partial class AutoStopCriteria : IUtf8JsonSerializable, IJsonModel<AutoStopCriteria>
    {
        ...
        internal static AutoStopCriteria DeserializeAutoStopCriteria(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<bool> autoStopDisabled = default;
            Optional<float> errorRate = default;
            Optional<int> errorRateTimeWindowInSeconds = default;
            ...
            return new AutoStopCriteria(Optional.ToNullable(autoStopDisabled), Optional.ToNullable(errorRate), Optional.ToNullable(errorRateTimeWindowInSeconds), serializedAdditionalRawData);
        }
