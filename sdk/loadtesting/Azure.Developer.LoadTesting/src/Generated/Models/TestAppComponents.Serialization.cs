...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TestAppComponents>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TestAppComponents>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TestAppComponents)} does not support '{format}' format.");
            }
        ...
        internal static TestAppComponents DeserializeTestAppComponents(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new TestAppComponents(components, testId.Value, Optional.ToNullable(createdDateTime), createdBy.Value, Optional.ToNullable(lastModifiedDateTime), lastModifiedBy.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TestAppComponents>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TestAppComponents)} does not support '{options.Format}' format.");
            }
        }
