...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class TestRunFileInfo
    {
        ...
        internal TestRunFileInfo(string fileName, Uri url, FileType? fileType, DateTimeOffset? expireDateTime, FileStatus? validationStatus, string validationFailureDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileName = fileName;
            Url = url;
            FileType = fileType;
