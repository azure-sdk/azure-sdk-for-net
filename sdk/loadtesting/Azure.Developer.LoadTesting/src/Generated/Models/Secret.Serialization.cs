...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Secret>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<Secret>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Secret)} does not support '{format}' format.");
            }
        ...
        internal static Secret DeserializeSecret(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Secret(value.Value, Optional.ToNullable(type), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<Secret>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Secret)} does not support '{options.Format}' format.");
            }
        }
