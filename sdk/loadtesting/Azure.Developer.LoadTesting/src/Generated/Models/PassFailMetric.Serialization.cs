...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PassFailMetric>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PassFailMetric>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PassFailMetric)} does not support '{format}' format.");
            }
        ...
        internal static PassFailMetric DeserializePassFailMetric(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PassFailMetric(Optional.ToNullable(clientMetric), Optional.ToNullable(aggregate), condition.Value, requestName.Value, Optional.ToNullable(value), Optional.ToNullable(action), Optional.ToNullable(actualValue), Optional.ToNullable(result), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PassFailMetric>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PassFailMetric)} does not support '{options.Format}' format.");
            }
        }
