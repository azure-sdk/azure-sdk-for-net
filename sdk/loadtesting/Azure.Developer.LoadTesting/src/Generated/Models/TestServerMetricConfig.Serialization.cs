...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TestServerMetricConfig>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TestServerMetricConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TestServerMetricConfig)} does not support '{format}' format.");
            }
        ...
        internal static TestServerMetricConfig DeserializeTestServerMetricConfig(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new TestServerMetricConfig(testId.Value, metrics, Optional.ToNullable(createdDateTime), createdBy.Value, Optional.ToNullable(lastModifiedDateTime), lastModifiedBy.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TestServerMetricConfig>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TestServerMetricConfig)} does not support '{options.Format}' format.");
            }
        }
