...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppComponent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AppComponent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppComponent)} does not support '{format}' format.");
            }
        ...
        internal static AppComponent DeserializeAppComponent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AppComponent(resourceId, resourceName, resourceType, displayName.Value, resourceGroup.Value, subscriptionId.Value, kind.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AppComponent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppComponent)} does not support '{options.Format}' format.");
            }
        }
