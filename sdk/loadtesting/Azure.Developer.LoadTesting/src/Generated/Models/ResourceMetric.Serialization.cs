...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceMetric>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceMetric>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceMetric)} does not support '{format}' format.");
            }
        ...
        internal static ResourceMetric DeserializeResourceMetric(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceMetric(id.Value, resourceId, metricNamespace, displayDescription.Value, name, aggregation, unit.Value, resourceType, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ResourceMetric>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceMetric)} does not support '{options.Format}' format.");
            }
        }
