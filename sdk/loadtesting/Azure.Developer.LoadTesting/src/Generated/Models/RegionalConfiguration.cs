...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class RegionalConfiguration
    {
        ...
        /// </param>
        public RegionalConfiguration(AzureLocation region)
        {
            Region = region;
        }
        ...
        /// <param name="loadPercentage">  The percentage of load to be distributed in specified region. Supported values are in range of 1-99. </param>
        /// <param name="region">
        /// Azure region name.
        /// The region name should of format accepted by ARM, and should be a region supported by Azure Load Testing. For example, East US should be passed as "eastus".
        /// The region name must match one of the strings in the "Name" column returned from running the "az account list-locations -o table" Azure CLI command.
        ...
        internal RegionalConfiguration(int? engineInstances, int? loadPercentage, AzureLocation region, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary>  The percentage of load to be distributed in specified region. Supported values are in range of 1-99. </summary>
