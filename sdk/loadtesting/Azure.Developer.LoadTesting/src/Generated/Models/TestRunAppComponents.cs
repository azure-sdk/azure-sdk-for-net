...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class TestRunAppComponents
    {
        ...
        internal TestRunAppComponents(IReadOnlyDictionary<string, AppComponent> components, string testRunId, DateTimeOffset? createdDateTime, string createdBy, DateTimeOffset? lastModifiedDateTime, string lastModifiedBy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Components = components;
            TestRunId = testRunId;
