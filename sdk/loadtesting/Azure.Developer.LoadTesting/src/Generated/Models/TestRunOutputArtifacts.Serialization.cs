...
namespace Azure.Developer.LoadTesting.Models
{
    public partial class TestRunOutputArtifacts : IUtf8JsonSerializable, IJsonModel<TestRunOutputArtifacts>
    {
        ...
        internal static TestRunOutputArtifacts DeserializeTestRunOutputArtifacts(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<TestRunFileInfo> resultFileInfo = default;
            Optional<TestRunFileInfo> logsFileInfo = default;
            Optional<ArtifactsContainerInfo> artifactsContainerInfo = default;
            ...
            return new TestRunOutputArtifacts(resultFileInfo.Value, logsFileInfo.Value, artifactsContainerInfo.Value, serializedAdditionalRawData);
        }
