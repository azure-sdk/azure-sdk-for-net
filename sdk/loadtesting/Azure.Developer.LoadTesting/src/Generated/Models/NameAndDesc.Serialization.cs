...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NameAndDesc>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NameAndDesc>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NameAndDesc)} does not support '{format}' format.");
            }
        ...
        internal static NameAndDesc DeserializeNameAndDesc(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NameAndDesc(description.Value, name.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<NameAndDesc>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NameAndDesc)} does not support '{options.Format}' format.");
            }
        }
