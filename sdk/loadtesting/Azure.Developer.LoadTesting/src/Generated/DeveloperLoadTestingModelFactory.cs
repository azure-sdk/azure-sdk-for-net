...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public static partial class DeveloperLoadTestingModelFactory
    {
        ...
        public static Test Test(PassFailCriteria passFailCriteria = null, AutoStopCriteria autoStopCriteria = null, IReadOnlyDictionary<string, Secret> secrets = null, CertificateMetadata certificate = null, IReadOnlyDictionary<string, string> environmentVariables = null, LoadTestConfiguration loadTestConfiguration = null, string baselineTestRunId = null, TestInputArtifacts inputArtifacts = null, string testId = null, string description = null, string displayName = null, string subnetId = null, TestKind? kind = null, bool? publicIPDisabled = null, string keyvaultReferenceIdentityType = null, string keyvaultReferenceIdentityId = null, DateTimeOffset? createdDateTime = null, string createdBy = null, DateTimeOffset? lastModifiedDateTime = null, string lastModifiedBy = null)
        {
            ...
            return new Test(passFailCriteria, autoStopCriteria, secrets, certificate, environmentVariables, loadTestConfiguration, baselineTestRunId, inputArtifacts, testId, description, displayName, subnetId, kind, publicIPDisabled, keyvaultReferenceIdentityType, keyvaultReferenceIdentityId, createdDateTime, createdBy, lastModifiedDateTime, lastModifiedBy, serializedAdditionalRawData: null);
        }
        ...
        {
            return new PassFailMetric(clientMetric, aggregate, condition, requestName, value, action, actualValue, result, serializedAdditionalRawData: null);
        }
        ...
        {
            return new LoadTestConfiguration(engineInstances, splitAllCSVs, quickStartTest, optionalLoadTestConfig, serializedAdditionalRawData: null);
        }
        ...
        {
            return new OptionalLoadTestConfig(endpointUrl, requestsPerSecond, maxResponseTimeInMs, virtualUsers, rampUpTime, duration, serializedAdditionalRawData: null);
        }
        ...
        public static TestInputArtifacts TestInputArtifacts(TestFileInfo configFileInfo = null, TestFileInfo testScriptFileInfo = null, TestFileInfo userPropFileInfo = null, TestFileInfo inputArtifactsZipFileInfo = null, TestFileInfo urlTestConfigFileInfo = null, IEnumerable<TestFileInfo> additionalFileInfo = null)
        {
            ...
            return new TestInputArtifacts(configFileInfo, testScriptFileInfo, userPropFileInfo, inputArtifactsZipFileInfo, urlTestConfigFileInfo, additionalFileInfo?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        {
            return new TestFileInfo(fileName, url, fileType, expireDateTime, validationStatus, validationFailureDetails, serializedAdditionalRawData: null);
        }
        ...
        public static TestAppComponents TestAppComponents(IReadOnlyDictionary<string, AppComponent> components = null, string testId = null, DateTimeOffset? createdDateTime = null, string createdBy = null, DateTimeOffset? lastModifiedDateTime = null, string lastModifiedBy = null)
        {
            ...
            return new TestAppComponents(components, testId, createdDateTime, createdBy, lastModifiedDateTime, lastModifiedBy, serializedAdditionalRawData: null);
        }
        ...
        {
            return new AppComponent(resourceId, resourceName, resourceType, displayName, resourceGroup, subscriptionId, kind, serializedAdditionalRawData: null);
        }
        ...
        public static TestServerMetricConfig TestServerMetricConfig(string testId = null, IReadOnlyDictionary<string, ResourceMetric> metrics = null, DateTimeOffset? createdDateTime = null, string createdBy = null, DateTimeOffset? lastModifiedDateTime = null, string lastModifiedBy = null)
        {
            ...
            return new TestServerMetricConfig(testId, metrics, createdDateTime, createdBy, lastModifiedDateTime, lastModifiedBy, serializedAdditionalRawData: null);
        }
        ...
        {
            return new ResourceMetric(id, resourceId, metricNamespace, displayDescription, name, aggregation, unit, resourceType, serializedAdditionalRawData: null);
        }
        ...
        public static TestRun TestRun(string testRunId = null, PassFailCriteria passFailCriteria = null, AutoStopCriteria autoStopCriteria = null, IReadOnlyDictionary<string, Secret> secrets = null, CertificateMetadata certificate = null, IReadOnlyDictionary<string, string> environmentVariables = null, IEnumerable<ErrorDetails> errorDetails = null, IReadOnlyDictionary<string, TestRunStatistics> testRunStatistics = null, LoadTestConfiguration loadTestConfiguration = null, TestRunArtifacts testArtifacts = null, PFTestResult? testResult = null, int? virtualUsers = null, string displayName = null, string testId = null, string description = null, Status? status = null, DateTimeOffset? startDateTime = null, DateTimeOffset? endDateTime = null, DateTimeOffset? executedDateTime = null, string portalUrl = null, long? duration = null, string subnetId = null, TestKind? kind = null, bool? publicIPDisabled = null, DateTimeOffset? createdDateTime = null, string createdBy = null, DateTimeOffset? lastModifiedDateTime = null, string lastModifiedBy = null)
        {
            ...
            return new TestRun(testRunId, passFailCriteria, autoStopCriteria, secrets, certificate, environmentVariables, errorDetails?.ToList(), testRunStatistics, loadTestConfiguration, testArtifacts, testResult, virtualUsers, displayName, testId, description, status, startDateTime, endDateTime, executedDateTime, portalUrl, duration, subnetId, kind, publicIPDisabled, createdDateTime, createdBy, lastModifiedDateTime, lastModifiedBy, serializedAdditionalRawData: null);
        }
        ...
        {
            return new TestRunStatistics(transaction, sampleCount, errorCount, errorPct, meanResTime, medianResTime, maxResTime, minResTime, pct1ResTime, pct2ResTime, pct3ResTime, throughput, receivedKBytesPerSec, sentKBytesPerSec, serializedAdditionalRawData: null);
        }
        ...
        public static TestRunInputArtifacts TestRunInputArtifacts(TestRunFileInfo configFileInfo = null, TestRunFileInfo testScriptFileInfo = null, TestRunFileInfo userPropFileInfo = null, TestRunFileInfo inputArtifactsZipFileInfo = null, TestRunFileInfo urlTestConfigFileInfo = null, IEnumerable<TestRunFileInfo> additionalFileInfo = null)
        {
            ...
            return new TestRunInputArtifacts(configFileInfo, testScriptFileInfo, userPropFileInfo, inputArtifactsZipFileInfo, urlTestConfigFileInfo, additionalFileInfo?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        {
            return new TestRunFileInfo(fileName, url, fileType, expireDateTime, validationStatus, validationFailureDetails, serializedAdditionalRawData: null);
        }
        ...
        public static TestRunOutputArtifacts TestRunOutputArtifacts(TestRunFileInfo resultFileInfo = null, TestRunFileInfo logsFileInfo = null, ArtifactsContainerInfo artifactsContainerInfo = null)
        {
            return new TestRunOutputArtifacts(resultFileInfo, logsFileInfo, artifactsContainerInfo, serializedAdditionalRawData: null);
        }
        ...
        public static TestRunAppComponents TestRunAppComponents(IReadOnlyDictionary<string, AppComponent> components = null, string testRunId = null, DateTimeOffset? createdDateTime = null, string createdBy = null, DateTimeOffset? lastModifiedDateTime = null, string lastModifiedBy = null)
        {
            ...
            return new TestRunAppComponents(components, testRunId, createdDateTime, createdBy, lastModifiedDateTime, lastModifiedBy, serializedAdditionalRawData: null);
        }
        ...
        public static TestRunServerMetricConfig TestRunServerMetricConfig(string testRunId = null, IReadOnlyDictionary<string, ResourceMetric> metrics = null, DateTimeOffset? createdDateTime = null, string createdBy = null, DateTimeOffset? lastModifiedDateTime = null, string lastModifiedBy = null)
        {
            ...
            return new TestRunServerMetricConfig(testRunId, metrics, createdDateTime, createdBy, lastModifiedDateTime, lastModifiedBy, serializedAdditionalRawData: null);
        }
        ...
        public static MetricDefinition MetricDefinition(IEnumerable<NameAndDesc> dimensions = null, string description = null, string name = null, string @namespace = null, AggregationType? primaryAggregationType = null, IEnumerable<string> supportedAggregationTypes = null, MetricUnit? unit = null, IEnumerable<MetricAvailability> metricAvailabilities = null)
        {
            ...
            return new MetricDefinition(dimensions?.ToList(), description, name, @namespace, primaryAggregationType, supportedAggregationTypes?.ToList(), unit, metricAvailabilities?.ToList(), serializedAdditionalRawData: null);
        }
