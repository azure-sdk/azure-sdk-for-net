...
namespace Azure.Developer.LoadTesting
{
    ...
    public static partial class DeveloperLoadTestingModelFactory
    {
        ...
        public static TestRunInsights TestRunInsights(IReadOnlyDictionary<string, TestRunInsightColumn> columns = null, IEnumerable<IDictionary<string, string>> rows = null)
        {
            columns ??= new Dictionary<string, TestRunInsightColumn>();
            rows ??= new List<IDictionary<string, string>>();

            return new TestRunInsights(columns, rows?.ToList(), serializedAdditionalRawData: null);
        }
