...
namespace Azure.Developer.LoadTesting
{
    ...
    public static partial class DeveloperLoadTestingModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LoadTesting.Trigger"/>. </summary>
        ...
        /// <param name="lastModifiedDateTime"> The last Modified datetime(RFC 3339 literal format). </param>
        /// <param name="lastModifiedBy"> The user that last modified. </param>
        /// <returns> A new <see cref="LoadTesting.Trigger"/> instance for mocking. </returns>
        public static Trigger Trigger(string triggerId = null, string displayName = null, string description = null, string kind = null, TriggerState? state = null, StateDetails stateDetails = null, DateTimeOffset? createdDateTime = null, string createdBy = null, DateTimeOffset? lastModifiedDateTime = null, string lastModifiedBy = null)
        {
        ...
        public static OperationStatus OperationStatus(OperationState status = default, OperationKind kind = default, ResponseError error = null, string id = null)
        {
            return new OperationStatus(status, kind, error, id, serializedAdditionalRawData: null);
        }
