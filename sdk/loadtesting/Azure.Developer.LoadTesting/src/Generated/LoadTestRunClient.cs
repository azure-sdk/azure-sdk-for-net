...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class LoadTestRunClient
    {
        ...
        /// <include file="Docs/LoadTestRunClient.xml" path="doc/members/member[@name='GetMetricDimensionValuesAsync(string,string,string,string,string,Interval?,CancellationToken)']/*" />
        public virtual AsyncPageable<DimensionValueList> GetMetricDimensionValuesAsync(string testRunId, string name, string metricName, string metricNamespace, string timespan, Interval? interval = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(testRunId, nameof(testRunId));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="testRunId"/>, <paramref name="name"/>, <paramref name="metricName"/>, <paramref name="metricNamespace"/> or <paramref name="timespan"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="testRunId"/> or <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LoadTestRunClient.xml" path="doc/members/member[@name='GetMetricDimensionValues(string,string,string,string,string,Interval?,CancellationToken)']/*" />
        public virtual Pageable<DimensionValueList> GetMetricDimensionValues(string testRunId, string name, string metricName, string metricNamespace, string timespan, Interval? interval = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(testRunId, nameof(testRunId));
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            Argument.AssertNotNull(metricName, nameof(metricName));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetMetricDimensionValuesAsync(string,string,string,string,string,Interval?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetMetricDimensionValues(string,string,string,string,string,Interval?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ArgumentException"> <paramref name="testRunId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LoadTestRunClient.xml" path="doc/members/member[@name='GetMetricsAsync(string,string,string,string,MetricRequestPayload,string,Interval?,CancellationToken)']/*" />
        public virtual AsyncPageable<TimeSeriesElement> GetMetricsAsync(string testRunId, string metricName, string metricNamespace, string timespan, MetricRequestPayload body = null, string aggregation = null, Interval? interval = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(testRunId, nameof(testRunId));
            Argument.AssertNotNull(metricName, nameof(metricName));
            Argument.AssertNotNull(metricNamespace, nameof(metricNamespace));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="testRunId"/>, <paramref name="metricName"/>, <paramref name="metricNamespace"/> or <paramref name="timespan"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="testRunId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LoadTestRunClient.xml" path="doc/members/member[@name='GetMetrics(string,string,string,string,MetricRequestPayload,string,Interval?,CancellationToken)']/*" />
        public virtual Pageable<TimeSeriesElement> GetMetrics(string testRunId, string metricName, string metricNamespace, string timespan, MetricRequestPayload body = null, string aggregation = null, Interval? interval = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(testRunId, nameof(testRunId));
            Argument.AssertNotNull(metricName, nameof(metricName));
            Argument.AssertNotNull(metricNamespace, nameof(metricNamespace));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetMetricsAsync(string,string,string,string,MetricRequestPayload,string,Interval?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetMetrics(string,string,string,string,MetricRequestPayload,string,Interval?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
