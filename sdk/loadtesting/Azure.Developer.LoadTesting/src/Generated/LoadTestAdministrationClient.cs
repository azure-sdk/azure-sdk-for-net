...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class LoadTestAdministrationClient
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="triggerId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="triggerId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<Trigger>> GetTriggerAsync(string triggerId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(triggerId, nameof(triggerId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetTriggerAsync(triggerId, context).ConfigureAwait(false);
            return Response.FromValue(Trigger.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="triggerId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="triggerId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<Trigger> GetTrigger(string triggerId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(triggerId, nameof(triggerId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AsyncPageable<Trigger> GetTriggersAsync(string testIds = null, TriggerState? states = null, DateTimeOffset? lastModifiedStartTime = null, DateTimeOffset? lastModifiedEndTime = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Trigger.DeserializeTrigger(e), ClientDiagnostics, _pipeline, "LoadTestAdministrationClient.GetTriggers", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <param name="maxpagesize"> Number of results in response. Default page size is 50. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Pageable<Trigger> GetTriggers(string testIds = null, TriggerState? states = null, DateTimeOffset? lastModifiedStartTime = null, DateTimeOffset? lastModifiedEndTime = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetTriggersRequest(testIds, states?.ToString(), lastModifiedStartTime, lastModifiedEndTime, pageSizeHint, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetTriggersNextPageRequest(nextLink, testIds, states?.ToString(), lastModifiedStartTime, lastModifiedEndTime, pageSizeHint, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Trigger.DeserializeTrigger(e), ClientDiagnostics, _pipeline, "LoadTestAdministrationClient.GetTriggers", "value", "nextLink", maxpagesize, context);
        }
