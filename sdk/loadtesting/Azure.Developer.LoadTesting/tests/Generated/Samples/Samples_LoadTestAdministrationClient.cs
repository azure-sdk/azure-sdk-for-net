...
"/subscriptions/10000000-0000-0000-0000-000000000000/resourceGroups/samplerg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/sampleresourcename"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Test_GetTests_GetAllLoadTests()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Test_GetTests_GetAllLoadTests_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Test_GetTests_GetAllLoadTests_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Test_GetTests_GetAllLoadTests_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);
        ...
        public void Example_TestProfile_GetTestProfiles_GetAllTestProfilesForTheSpecifiedFilters()
        {
            ...
            foreach (BinaryData item in client.GetTestProfiles(null, DateTimeOffset.Parse("2024-05-01T16:00:46.072Z"), DateTimeOffset.Parse("2024-05-01T16:50:46.072Z"), null, "12346-abcd-6789", null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("testProfileId").ToString());
            }
        ...
        public async Task Example_TestProfile_GetTestProfiles_GetAllTestProfilesForTheSpecifiedFilters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetTestProfilesAsync(null, DateTimeOffset.Parse("2024-05-01T16:00:46.072Z"), DateTimeOffset.Parse("2024-05-01T16:50:46.072Z"), null, "12346-abcd-6789", null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("testProfileId").ToString());
            }
