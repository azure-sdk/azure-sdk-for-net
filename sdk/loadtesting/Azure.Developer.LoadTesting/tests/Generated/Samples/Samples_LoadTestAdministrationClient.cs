...
namespace Azure.Developer.LoadTesting.Samples
{
    public partial class Samples_LoadTestAdministrationClient
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Test_GetTests_ShortVersion()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);

            foreach (BinaryData item in client.GetTests(null, null, null, null, null, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("testId").ToString());
            }
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Test_GetTests_ShortVersion_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);

            await foreach (BinaryData item in client.GetTestsAsync(null, null, null, null, null, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("testId").ToString());
            }
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Test_GetTests_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);

            foreach (Test item in client.GetTests())
            {
            }
        }
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Test_GetTests_ShortVersion_Convenience_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);

            await foreach (Test item in client.GetTestsAsync())
            {
            }
        }
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Test_GetTests_AllParameters()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);

            foreach (BinaryData item in client.GetTests("<orderby>", "<search>", DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"), DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"), 1234, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("clientMetric").ToString());
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("aggregate").ToString());
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Test_GetTests_AllParameters_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);

            await foreach (BinaryData item in client.GetTestsAsync("<orderby>", "<search>", DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"), DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"), 1234, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("clientMetric").ToString());
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("aggregate").ToString());
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Test_GetTests_AllParameters_Convenience()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);

            foreach (Test item in client.GetTests(orderby: "<orderby>", search: "<search>", lastModifiedStartTime: DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"), lastModifiedEndTime: DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"), maxpagesize: 1234))
            {
            }
        }
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Test_GetTests_AllParameters_Convenience_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestAdministrationClient client = new LoadTestAdministrationClient(endpoint, credential);

            await foreach (Test item in client.GetTestsAsync(orderby: "<orderby>", search: "<search>", lastModifiedStartTime: DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"), lastModifiedEndTime: DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"), maxpagesize: 1234))
            {
            }
        }
    }
