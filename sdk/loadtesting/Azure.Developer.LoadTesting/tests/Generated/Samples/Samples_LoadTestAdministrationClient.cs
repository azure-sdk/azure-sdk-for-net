...
region = "<region>",
        ...
        public void Example_Test_GetTests_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetTests("<orderby>", "<search>", DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), 1234, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("clientMetric").ToString());
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("aggregate").ToString());
        ...
        public async Task Example_Test_GetTests_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetTestsAsync("<orderby>", "<search>", DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), 1234, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("clientMetric").ToString());
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("aggregate").ToString());
        ...
        public void Example_Test_GetTests_AllParameters_Convenience()
        {
            ...
            foreach (Test item in client.GetTests(orderby: "<orderby>", search: "<search>", lastModifiedStartTime: DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), lastModifiedEndTime: DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), maxpagesize: 1234))
            {
            }
        }
        ...
        public async Task Example_Test_GetTests_AllParameters_Convenience_Async()
        {
            ...
            await foreach (Test item in client.GetTestsAsync(orderby: "<orderby>", search: "<search>", lastModifiedStartTime: DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), lastModifiedEndTime: DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), maxpagesize: 1234))
            {
            }
        }
    }
