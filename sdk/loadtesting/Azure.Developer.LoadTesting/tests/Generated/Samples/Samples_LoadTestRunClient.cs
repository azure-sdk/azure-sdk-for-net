...
namespace Azure.Developer.LoadTesting.Samples
{
    public class Samples_LoadTestRunClient
    {
        ...
        public void Example_GetMetricDimensionValues()
        {
            ...
            foreach (var item in client.GetMetricDimensionValues("<testRunId>", "<name>", "<metricName>", "<metricNamespace>", "<timespan>", "<interval>", new RequestContext()))
            {
        ...
        public async Task Example_GetMetricDimensionValues_Async()
        {
            ...
            await foreach (var item in client.GetMetricDimensionValuesAsync("<testRunId>", "<name>", "<metricName>", "<metricNamespace>", "<timespan>", "<interval>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("value")[0].ToString());
            }
        ...
        public async Task Example_GetMetricDimensionValues_Convenience_Async()
        {
            ...
            await foreach (var item in client.GetMetricDimensionValuesAsync("<testRunId>", "<name>", "<metricName>", "<metricNamespace>", "<timespan>", null))
            {
            }
        }
        ...
        public void Example_GetMetrics()
        {
            ...
            foreach (var item in client.GetMetrics("<testRunId>", "<metricName>", "<metricNamespace>", "<timespan>", RequestContent.Create(data), "<aggregation>", "<interval>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.ToString());
            }
        ...
        public async Task Example_GetMetrics_Async()
        {
            ...
            await foreach (var item in client.GetMetricsAsync("<testRunId>", "<metricName>", "<metricNamespace>", "<timespan>", RequestContent.Create(data), "<aggregation>", "<interval>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.ToString());
            }
            ...
            Values =
{
            ...
            await foreach (var item in client.GetMetricsAsync("<testRunId>", "<metricName>", "<metricNamespace>", "<timespan>", body, "<aggregation>", null))
            {
            }
        }
