...
Values = {"<values>"},
        ...
        public void Example_TestRun_GetTestRuns_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetTestRuns("<orderby>", "<search>", "<testId>", DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), "<status>", 1234, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("testRunId").ToString());
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("clientMetric").ToString());
        ...
        public async Task Example_TestRun_GetTestRuns_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetTestRunsAsync("<orderby>", "<search>", "<testId>", DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), "<status>", 1234, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("testRunId").ToString());
                Console.WriteLine(result.GetProperty("passFailCriteria").GetProperty("passFailMetrics").GetProperty("<key>").GetProperty("clientMetric").ToString());
        ...
        public void Example_TestRun_GetTestRuns_AllParameters_Convenience()
        {
            ...
            foreach (TestRun item in client.GetTestRuns(orderby: "<orderby>", search: "<search>", testId: "<testId>", executionFrom: DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), executionTo: DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), status: "<status>", maxpagesize: 1234))
            {
            }
        }
        ...
        public async Task Example_TestRun_GetTestRuns_AllParameters_Convenience_Async()
        {
            ...
            await foreach (TestRun item in client.GetTestRunsAsync(orderby: "<orderby>", search: "<search>", testId: "<testId>", executionFrom: DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), executionTo: DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), status: "<status>", maxpagesize: 1234))
            {
            }
        }
    }
