...
"HTTP Request"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_TestRun_GetTestRuns_ListTestRuns()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestRunClient client = new LoadTestRunClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_TestRun_GetTestRuns_ListTestRuns_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestRunClient client = new LoadTestRunClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_TestRun_GetTestRuns_ListTestRuns_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestRunClient client = new LoadTestRunClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_TestRun_GetTestRuns_ListTestRuns_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            LoadTestRunClient client = new LoadTestRunClient(endpoint, credential);
