...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    public partial class CheckQuotaAvailabilityResponse : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CheckQuotaAvailabilityResponse"/>. </summary>
        internal CheckQuotaAvailabilityResponse()
        {
        }
        ...
        internal CheckQuotaAvailabilityResponse(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isAvailable, string availabilityStatus, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
