...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    public partial class EndpointDependency
    {
        ...
        internal EndpointDependency(string domainName)
        {
        ...
        internal EndpointDependency(string domainName, string description, IReadOnlyList<EndpointDetail> endpointDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DomainName = domainName;
