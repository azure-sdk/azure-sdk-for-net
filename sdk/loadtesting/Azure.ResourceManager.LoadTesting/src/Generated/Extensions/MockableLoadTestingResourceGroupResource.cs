...
namespace Azure.ResourceManager.LoadTesting.Mocking
{
    ...
    public partial class MockableLoadTestingResourceGroupResource : ArmResource
    {
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<LoadTestResource>> GetLoadTestResourceAsync(string loadTestName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="loadTestName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<LoadTestResource> GetLoadTestResource(string loadTestName, CancellationToken cancellationToken = default)
        {
