...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    /// <summary> The QuestionAnswering sub-client. </summary>
    public partial class QuestionAnswering
    {
        ...
        /// <summary> Initializes a new instance of QuestionAnswering for mocking. </summary>
        protected QuestionAnswering()
        {
        }
        ...
        internal QuestionAnswering(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// <include file="Docs/QuestionAnswering.xml" path="doc/members/member[@name='GetAnswersAsync(string,string,AnswersOptions,CancellationToken)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="projectName"/>, <paramref name="deploymentName"/> or <paramref name="knowledgeBaseQueryOptions"/> is null. </exception>
        /// <include file="Docs/QuestionAnswering.xml" path="doc/members/member[@name='GetAnswers(string,string,AnswersOptions,CancellationToken)']/*" />
        ...
        /// <include file="Docs/QuestionAnswering.xml" path="doc/members/member[@name='GetAnswersAsync(string,string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> GetAnswersAsync(string projectName, string deploymentName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("QuestionAnswering.GetAnswers");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/QuestionAnswering.xml" path="doc/members/member[@name='GetAnswers(string,string,RequestContent,RequestContext)']/*" />
        ...
        /// <include file="Docs/QuestionAnswering.xml" path="doc/members/member[@name='GetAnswersFromTextAsync(AnswersFromTextOptions,CancellationToken)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="textQueryOptions"/> is null. </exception>
        /// <include file="Docs/QuestionAnswering.xml" path="doc/members/member[@name='GetAnswersFromText(AnswersFromTextOptions,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/QuestionAnswering.xml" path="doc/members/member[@name='GetAnswersFromTextAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> GetAnswersFromTextAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("QuestionAnswering.GetAnswersFromText");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/QuestionAnswering.xml" path="doc/members/member[@name='GetAnswersFromText(RequestContent,RequestContext)']/*" />
