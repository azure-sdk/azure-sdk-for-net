...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class SingleLabelClassificationEvaluationSummary
    {
        ...
        internal SingleLabelClassificationEvaluationSummary(IReadOnlyDictionary<string, TextAuthoringConfusionMatrixRow> confusionMatrix, IReadOnlyDictionary<string, SingleLabelClassEvaluationSummary> classes, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
