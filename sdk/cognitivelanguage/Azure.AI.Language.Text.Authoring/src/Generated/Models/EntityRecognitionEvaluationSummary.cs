...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class EntityRecognitionEvaluationSummary
    {
        ...
        internal EntityRecognitionEvaluationSummary(IReadOnlyDictionary<string, TextAuthoringConfusionMatrixRow> confusionMatrix, IReadOnlyDictionary<string, TextAuthoringEntityEvaluationSummary> entities, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
        ...
        internal EntityRecognitionEvaluationSummary(IReadOnlyDictionary<string, TextAuthoringConfusionMatrixRow> confusionMatrix, IReadOnlyDictionary<string, TextAuthoringEntityEvaluationSummary> entities, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConfusionMatrix = confusionMatrix;
            Entities = entities;
            MicroF1 = microF1;
        ...
        public IReadOnlyDictionary<string, TextAuthoringEntityEvaluationSummary> Entities { get; }
