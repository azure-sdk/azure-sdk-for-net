...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class CustomHealthcareDocumentEvaluationResult : TextAuthoringDocumentEvaluationResult
    {
        ...
        /// <param name="customHealthcareResult"> Represents the evaluation prediction for entity recognition. </param>
        internal CustomHealthcareDocumentEvaluationResult(TextAuthoringProjectKind projectKind, string location, string language, IDictionary<string, BinaryData> serializedAdditionalRawData, DocumentHealthcareEvaluationResult customHealthcareResult) : base(projectKind, location, language, serializedAdditionalRawData)
        {
            CustomHealthcareResult = customHealthcareResult;
        }
