...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class TextAuthoringEntityEvaluationSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringEntityEvaluationSummary"/>. </summary>
        ...
        internal TextAuthoringEntityEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        internal TextAuthoringEntityEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringEntityEvaluationSummary"/> for deserialization. </summary>
        internal TextAuthoringEntityEvaluationSummary()
        {
        }
