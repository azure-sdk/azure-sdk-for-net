...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    /// Please note <see cref="TextAuthoringDocumentEvaluationResult"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    /// </summary>
    public abstract partial class TextAuthoringDocumentEvaluationResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringDocumentEvaluationResult"/>. </summary>
        ...
        protected TextAuthoringDocumentEvaluationResult(string location, string language)
        {
        ...
        internal TextAuthoringDocumentEvaluationResult(TextAuthoringProjectKind projectKind, string location, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringDocumentEvaluationResult"/> for deserialization. </summary>
        internal TextAuthoringDocumentEvaluationResult()
        {
        }
