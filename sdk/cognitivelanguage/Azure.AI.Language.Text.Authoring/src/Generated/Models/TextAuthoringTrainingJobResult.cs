...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class TextAuthoringTrainingJobResult
    {
        ...
        internal TextAuthoringTrainingJobResult(string modelLabel, string trainingConfigVersion, TextAuthoringSubTrainingOperationState trainingStatus)
        {
        ...
        internal TextAuthoringTrainingJobResult(string modelLabel, string trainingConfigVersion, TextAuthoringSubTrainingOperationState trainingStatus, TextAuthoringSubTrainingOperationState evaluationStatus, DateTimeOffset? estimatedEndOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
            TrainingStatus = trainingStatus;
        ...
        public TextAuthoringSubTrainingOperationState TrainingStatus { get; }
        /// <summary> Represents model evaluation status. </summary>
        public TextAuthoringSubTrainingOperationState EvaluationStatus { get; }
