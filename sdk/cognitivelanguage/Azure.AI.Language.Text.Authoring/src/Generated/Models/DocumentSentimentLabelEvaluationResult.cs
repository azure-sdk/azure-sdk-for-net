...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class DocumentSentimentLabelEvaluationResult
    {
        ...
        internal DocumentSentimentLabelEvaluationResult(TextAuthoringSentiment category, int offset, int length)
        {
            Category = category;
            Offset = offset;
            Length = length;
        ...
        internal DocumentSentimentLabelEvaluationResult(TextAuthoringSentiment category, int offset, int length, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Offset = offset;
            Length = length;
