...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class SpanSentimentEvaluationSummary
    {
        ...
        internal SpanSentimentEvaluationSummary(IReadOnlyDictionary<string, TextAuthoringConfusionMatrixRow> confusionMatrix, IReadOnlyDictionary<string, SentimentEvaluationSummary> sentiments, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
