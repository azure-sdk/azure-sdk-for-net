...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetAssignedResourceDeploymentsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetAssignedResourceDeploymentsAsyncCollectionResult(TextAnalysisAuthoringClient client, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
