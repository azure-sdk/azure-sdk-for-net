...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetTrainingConfigVersionsCollectionResultOfT : Pageable<TextAuthoringTrainingConfigVersion>
    {
        ...
        public TextAnalysisAuthoringClientGetTrainingConfigVersionsCollectionResultOfT(TextAnalysisAuthoringClient client, string projectKind, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
