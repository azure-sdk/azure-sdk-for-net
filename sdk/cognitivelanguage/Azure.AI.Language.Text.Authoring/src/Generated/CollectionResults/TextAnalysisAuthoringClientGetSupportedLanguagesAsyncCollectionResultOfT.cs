...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetSupportedLanguagesAsyncCollectionResultOfT : AsyncPageable<TextAuthoringSupportedLanguage>
    {
        ...
        public TextAnalysisAuthoringClientGetSupportedLanguagesAsyncCollectionResultOfT(TextAnalysisAuthoringClient client, string projectKind, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
