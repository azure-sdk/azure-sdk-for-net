...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResult : Pageable<BinaryData>
    {
        ...
        public TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResult(TextAuthoringTrainedModel client, string projectName, string trainedModelLabel, string stringIndexType, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
