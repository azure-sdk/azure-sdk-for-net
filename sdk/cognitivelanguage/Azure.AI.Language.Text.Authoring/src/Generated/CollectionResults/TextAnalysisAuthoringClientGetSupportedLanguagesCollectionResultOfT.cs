...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetSupportedLanguagesCollectionResultOfT : Pageable<TextAuthoringSupportedLanguage>
    {
        ...
        public TextAnalysisAuthoringClientGetSupportedLanguagesCollectionResultOfT(TextAnalysisAuthoringClient client, string projectKind, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
