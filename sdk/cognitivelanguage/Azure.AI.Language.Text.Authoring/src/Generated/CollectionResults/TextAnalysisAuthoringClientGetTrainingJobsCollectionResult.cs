...
{
    internal partial class TextAnalysisAuthoringClientGetTrainingJobsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of TextAnalysisAuthoringClientGetTrainingJobsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public TextAnalysisAuthoringClientGetTrainingJobsCollectionResult(TextAnalysisAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TextAnalysisAuthoringClientGetTrainingJobsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TextAnalysisAuthoringClientGetTrainingJobsCollectionResult as an enumerable collection. </returns>
