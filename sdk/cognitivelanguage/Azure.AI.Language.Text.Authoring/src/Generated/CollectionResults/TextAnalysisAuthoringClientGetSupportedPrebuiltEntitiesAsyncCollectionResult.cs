...
{
    internal partial class TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResult(TextAnalysisAuthoringClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
        ...
        /// <returns> The pages of TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResult as an enumerable collection. </returns>
