...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetTrainedModelsCollectionResultOfT : Pageable<TextAuthoringProjectTrainedModel>
    {
        ...
        public TextAnalysisAuthoringClientGetTrainedModelsCollectionResultOfT(TextAnalysisAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
