...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResultOfT : AsyncPageable<TextAuthoringPrebuiltEntity>
    {
        ...
        public TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResultOfT(TextAnalysisAuthoringClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
