...
{
    internal partial class TextAnalysisAuthoringClientGetAssignedResourceDeploymentsAsyncCollectionResultOfT : AsyncPageable<TextAuthoringAssignedProjectDeploymentsMetadata>
    {
        ...
        public TextAnalysisAuthoringClientGetAssignedResourceDeploymentsAsyncCollectionResultOfT(TextAnalysisAuthoringClient client, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <returns> The pages of TextAnalysisAuthoringClientGetAssignedResourceDeploymentsAsyncCollectionResultOfT as an enumerable collection. </returns>
