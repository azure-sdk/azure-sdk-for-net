...
{
    internal partial class TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult(TextAnalysisAuthoringClient client, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult as an enumerable collection. </returns>
