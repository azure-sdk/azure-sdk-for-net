...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetExportedModelsAsyncCollectionResultOfT : AsyncPageable<TextAuthoringExportedTrainedModel>
    {
        ...
        public TextAnalysisAuthoringClientGetExportedModelsAsyncCollectionResultOfT(TextAnalysisAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
