...
{
    internal partial class TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResultOfT : Pageable<TextAuthoringDocumentEvalResult>
    {
        ...
        /// <summary> Initializes a new instance of TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResultOfT(TextAuthoringTrainedModel client, string projectName, string trainedModelLabel, string stringIndexType, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<TextAuthoringDocumentEvalResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
