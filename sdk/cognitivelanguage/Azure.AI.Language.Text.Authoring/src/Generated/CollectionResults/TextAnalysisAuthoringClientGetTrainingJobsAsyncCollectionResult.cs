...
{
    internal partial class TextAnalysisAuthoringClientGetTrainingJobsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of TextAnalysisAuthoringClientGetTrainingJobsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public TextAnalysisAuthoringClientGetTrainingJobsAsyncCollectionResult(TextAnalysisAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TextAnalysisAuthoringClientGetTrainingJobsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TextAnalysisAuthoringClientGetTrainingJobsAsyncCollectionResult as an enumerable collection. </returns>
