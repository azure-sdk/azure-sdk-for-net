...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesCollectionResult : Pageable<BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesCollectionResult(TextAnalysisAuthoringClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
