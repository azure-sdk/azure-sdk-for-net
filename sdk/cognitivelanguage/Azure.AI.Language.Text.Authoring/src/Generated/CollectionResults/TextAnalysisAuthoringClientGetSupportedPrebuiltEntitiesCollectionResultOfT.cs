...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesCollectionResultOfT : Pageable<TextAuthoringPrebuiltEntity>
    {
        ...
        public TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesCollectionResultOfT(TextAnalysisAuthoringClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
