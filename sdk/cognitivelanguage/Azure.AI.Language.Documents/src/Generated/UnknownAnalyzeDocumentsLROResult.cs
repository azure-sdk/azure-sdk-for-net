...
namespace Azure.AI.Language.Documents
{
    ...
    internal partial class UnknownAnalyzeDocumentsLROResult : AnalyzeDocumentsLROResult
    {
        ...
        internal UnknownAnalyzeDocumentsLROResult(DateTimeOffset lastUpdateDateTime, DocumentActionState status, string taskName, AnalyzeDocumentsLROResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(lastUpdateDateTime, status, taskName, kind, serializedAdditionalRawData)
        {
        }
