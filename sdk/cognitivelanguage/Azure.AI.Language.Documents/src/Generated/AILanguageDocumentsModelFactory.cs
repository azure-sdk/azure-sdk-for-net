...
namespace Azure.AI.Language.Documents
{
    ...
    public static partial class AILanguageDocumentsModelFactory
    {
        ...
        public static AnalyzeDocumentsOperationInput AnalyzeDocumentsOperationInput(string displayName = null, MultiLanguageDocumentInput documentsInput = null, IEnumerable<AnalyzeDocumentsOperationAction> actions = null, float? cancelAfter = null)
        {
            actions ??= new List<AnalyzeDocumentsOperationAction>();

            return new AnalyzeDocumentsOperationInput(displayName, documentsInput, actions?.ToList(), cancelAfter, serializedAdditionalRawData: null);
        }
