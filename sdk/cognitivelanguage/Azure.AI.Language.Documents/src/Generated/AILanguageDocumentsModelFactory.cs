...
namespace Azure.AI.Language.Documents
{
    ...
    public static partial class AILanguageDocumentsModelFactory
    {
        ...
        /// The available derived classes include <see cref="Documents.AbstractiveSummarizationLROResult"/>, <see cref="Documents.ExtractiveSummarizationLROResult"/> and <see cref="Documents.PiiEntityRecognitionLROResult"/>.
        /// </param>
        ...
        {
            return new UnknownAnalyzeDocumentsLROResult(lastUpdateDateTime, status, taskName, kind == null ? default : new AnalyzeDocumentsLROResultsKind(kind), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Documents.PiiEntityRecognitionLROResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="taskName"> task name. </param>
        /// <param name="results"> The list of pii document results. </param>
        /// <returns> A new <see cref="Documents.PiiEntityRecognitionLROResult"/> instance for mocking. </returns>
        public static PiiEntityRecognitionLROResult PiiEntityRecognitionLROResult(DateTimeOffset lastUpdateDateTime = default, DocumentActionState status = default, string taskName = null, AnalyzeDocumentsResult results = null)
        {
            return new PiiEntityRecognitionLROResult(
                lastUpdateDateTime,
                status,
                taskName,
                AnalyzeDocumentsLROResultsKind.PiiEntityRecognitionLROResults,
                serializedAdditionalRawData: null,
                results);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Documents.ExtractiveSummarizationLROResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="taskName"> task name. </param>
        /// <param name="results"> Results of the document task. </param>
        /// <returns> A new <see cref="Documents.ExtractiveSummarizationLROResult"/> instance for mocking. </returns>
        public static ExtractiveSummarizationLROResult ExtractiveSummarizationLROResult(DateTimeOffset lastUpdateDateTime = default, DocumentActionState status = default, string taskName = null, AnalyzeDocumentsResult results = null)
        {
            return new ExtractiveSummarizationLROResult(
                lastUpdateDateTime,
                status,
                taskName,
                AnalyzeDocumentsLROResultsKind.ExtractiveSummarizationLROResults,
                serializedAdditionalRawData: null,
                results);
        }

        /// <summary> Initializes a new instance of <see cref="Documents.AbstractiveSummarizationLROResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="taskName"> task name. </param>
        /// <param name="results"> Results of the task. </param>
        /// <returns> A new <see cref="Documents.AbstractiveSummarizationLROResult"/> instance for mocking. </returns>
        public static AbstractiveSummarizationLROResult AbstractiveSummarizationLROResult(DateTimeOffset lastUpdateDateTime = default, DocumentActionState status = default, string taskName = null, AbstractiveSummarizationResult results = null)
        {
            return new AbstractiveSummarizationLROResult(
                lastUpdateDateTime,
                status,
                taskName,
                AnalyzeDocumentsLROResultsKind.AbstractiveSummarizationLROResults,
                serializedAdditionalRawData: null,
                results);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Documents.AnalyzeDocumentJobsInput"/>. </summary>
        ...
        /// <returns> A new <see cref="Documents.AnalyzeDocumentJobsInput"/> instance for mocking. </returns>
        public static AnalyzeDocumentJobsInput AnalyzeDocumentJobsInput(string displayName = null, MultiLanguageDocumentInput analysisInput = null, IEnumerable<AnalyzeDocumentsOperationAction> tasks = null, string defaultLanguage = null)
        {
            tasks ??= new List<AnalyzeDocumentsOperationAction>();

            return new AnalyzeDocumentJobsInput(displayName, analysisInput, tasks?.ToList(), defaultLanguage, serializedAdditionalRawData: null);
        }
