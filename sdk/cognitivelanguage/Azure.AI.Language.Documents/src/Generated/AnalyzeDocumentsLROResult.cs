...
namespace Azure.AI.Language.Documents
{
    ...
    /// The available derived classes include <see cref="AbstractiveSummarizationLROResult"/>, <see cref="ExtractiveSummarizationLROResult"/> and <see cref="PiiEntityRecognitionLROResult"/>.
    /// </summary>
    public abstract partial class AnalyzeDocumentsLROResult
    {
        ...
        internal AnalyzeDocumentsLROResult(DateTimeOffset lastUpdateDateTime, DocumentActionState status, string taskName, AnalyzeDocumentsLROResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LastUpdateDateTime = lastUpdateDateTime;
            Status = status;
            TaskName = taskName;
        ...
        internal AnalyzeDocumentsLROResultsKind Kind { get; set; }
    }
}
