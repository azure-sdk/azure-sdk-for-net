...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class AbstractiveSummarizationLROResult : AnalyzeDocumentsLROResult
    {
        ...
        internal AbstractiveSummarizationLROResult(DateTimeOffset lastUpdateDateTime, DocumentActionState status, AbstractiveSummarizationResult results) : base(lastUpdateDateTime, status)
        {
