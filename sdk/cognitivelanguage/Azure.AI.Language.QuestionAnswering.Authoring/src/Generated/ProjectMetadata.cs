...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    ...
    public partial class ProjectMetadata
    {
        ...
        internal ProjectMetadata(string projectName, string description, string language, bool? multilingualResource, ProjectSettings settings, DateTimeOffset? createdDateTime, DateTimeOffset? lastModifiedDateTime, DateTimeOffset? lastDeployedDateTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public bool? MultilingualResource { get; }
