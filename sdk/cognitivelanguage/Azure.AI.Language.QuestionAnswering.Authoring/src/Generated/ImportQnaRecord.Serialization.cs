...
{
    public partial class ImportQnaRecord : IUtf8JsonSerializable, IJsonModel<ImportQnaRecord>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImportQnaRecord>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImportQnaRecord>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ImportQnaRecord IJsonModel<ImportQnaRecord>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImportQnaRecord>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ImportQnaRecord>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImportQnaRecord>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ImportQnaRecord IPersistableModel<ImportQnaRecord>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImportQnaRecord>)this).GetFormatFromOptions(options) : options.Format;
