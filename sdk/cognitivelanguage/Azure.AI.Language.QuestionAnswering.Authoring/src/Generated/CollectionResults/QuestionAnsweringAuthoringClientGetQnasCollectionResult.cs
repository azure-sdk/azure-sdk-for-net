...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetQnasCollectionResult : Pageable<BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetQnasCollectionResult(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, string source, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
