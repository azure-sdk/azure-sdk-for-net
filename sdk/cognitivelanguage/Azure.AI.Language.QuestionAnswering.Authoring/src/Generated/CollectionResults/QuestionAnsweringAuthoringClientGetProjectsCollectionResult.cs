...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetProjectsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of QuestionAnsweringAuthoringClientGetProjectsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public QuestionAnsweringAuthoringClientGetProjectsCollectionResult(QuestionAnsweringAuthoringClient client, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of QuestionAnsweringAuthoringClientGetProjectsCollectionResult as an enumerable collection. </summary>
