...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetSynonymsCollectionResultOfT : Pageable<WordAlterations>
    {
        ...
        public QuestionAnsweringAuthoringClientGetSynonymsCollectionResultOfT(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
