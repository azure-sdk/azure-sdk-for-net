...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetDeploymentsAsyncCollectionResultOfT : AsyncPageable<ProjectDeployment>
    {
        ...
        public QuestionAnsweringAuthoringClientGetDeploymentsAsyncCollectionResultOfT(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
