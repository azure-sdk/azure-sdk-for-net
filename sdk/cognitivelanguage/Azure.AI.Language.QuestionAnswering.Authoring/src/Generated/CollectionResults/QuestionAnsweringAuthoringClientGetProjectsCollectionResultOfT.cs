...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetProjectsCollectionResultOfT : Pageable<QuestionAnsweringProject>
    {
        ...
        public QuestionAnsweringAuthoringClientGetProjectsCollectionResultOfT(QuestionAnsweringAuthoringClient client, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
