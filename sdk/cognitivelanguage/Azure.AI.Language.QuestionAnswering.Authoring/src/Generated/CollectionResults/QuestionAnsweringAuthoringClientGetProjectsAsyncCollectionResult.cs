...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetProjectsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetProjectsAsyncCollectionResult(QuestionAnsweringAuthoringClient client, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
