...
{
    /// <summary> Project assets the needs to be imported. </summary>
    public partial class ImportJobOptions
    {
        ...
        internal ImportJobOptions(CreateProjectOptions metadata, Assets assets, string fileUri, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Metadata = metadata;
            Assets = assets;
            FileUri = fileUri;
