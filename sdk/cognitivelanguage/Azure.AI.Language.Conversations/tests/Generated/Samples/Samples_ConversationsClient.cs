...
namespace Azure.AI.Language.Conversations.Samples
{
    public partial class Samples_ConversationsClient
    {
        ...
        public void Example_Conversations_AnalyzeConversations_ShortVersion_Convenience()
        {
            ...
            Response<AnalyzeConversationTaskResult> response = client.AnalyzeConversations(AnalyzeConversationTaskKind.Conversation);
        }
        ...
        public async Task Example_Conversations_AnalyzeConversations_ShortVersion_Convenience_Async()
        {
            ...
            Response<AnalyzeConversationTaskResult> response = await client.AnalyzeConversationsAsync(AnalyzeConversationTaskKind.Conversation);
        }
...
kind = "ConversationalPIITask",
        ...
        public void Example_Conversations_AnalyzeConversationsSubmitJob_ShortVersion_Convenience()
        {
            ...
            MultiLanguageConversationAnalysisInput analysisInput = new MultiLanguageConversationAnalysisInput(new ConversationInput[]
            {
...
new TextConversationItem("<id>", "<participantId>", "<text>")
            ...
            Operation operation = client.AnalyzeConversationsSubmitJob(WaitUntil.Completed, analysisInput, new AnalyzeConversationJobTask[]
            {
...
new TextConversationItem("<id>", "<participantId>", "<text>")
            ...
            Operation operation = await client.AnalyzeConversationsSubmitJobAsync(WaitUntil.Completed, analysisInput, new AnalyzeConversationJobTask[]
            {
new AnalyzeConversationPiiTask()
            });
        }
