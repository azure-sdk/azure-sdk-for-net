...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public partial class BaseConversationalAITaskParameters
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BaseConversationalAITaskParameters"/>. </summary>
        /// <param name="projectName"> The name of the project to use. </param>
        /// <param name="deploymentName"> The name of the deployment to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="projectName"/> or <paramref name="deploymentName"/> is null. </exception>
        public BaseConversationalAITaskParameters(string projectName, string deploymentName)
        {
        ...
        internal BaseConversationalAITaskParameters(string projectName, string deploymentName, StringIndexType? stringIndexType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectName = projectName;
            DeploymentName = deploymentName;
        ...
        /// <summary> Initializes a new instance of <see cref="BaseConversationalAITaskParameters"/> for deserialization. </summary>
        internal BaseConversationalAITaskParameters()
        {
        }
