...
namespace Azure.AI.Language.Conversations.Models
{
    public partial class ConversationalAITask : IUtf8JsonSerializable, IJsonModel<ConversationalAITask>
    {
        ...
        internal static ConversationalAITask DeserializeConversationalAITask(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            BaseConversationalAITaskParameters parameters = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    analysisInput = ConversationalAIAnalysisOptions.DeserializeConversationalAIAnalysisOptions(property.Value, options);
                    continue;
                }
                if (property.NameEquals("parameters"u8))
                {
                    parameters = BaseConversationalAITaskParameters.DeserializeBaseConversationalAITaskParameters(property.Value, options);
                    continue;
                }
