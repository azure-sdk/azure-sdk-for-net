...
{
    /// <summary> The ConversationalAIEntity. </summary>
    public partial class ConversationalAIEntity
    {
        ...
        internal ConversationalAIEntity(string name, string text, float confidenceScore, int offset, int length, string conversationItemId, int conversationItemIndex)
        {
