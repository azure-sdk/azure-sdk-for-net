...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public partial class ConversationalAITask : AnalyzeConversationInput
    {
        ...
        public ConversationalAITask(ConversationalAIAnalysisOptions analysisInput, BaseConversationTaskParameters parameters)
        {
        ...
        /// <param name="analysisInput"> The input ConversationItem and its optional parameters. </param>
        /// <param name="parameters"> Input parameters necessary for a Conversation language understanding task. </param>
        internal ConversationalAITask(AnalyzeConversationInputKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, ConversationalAIAnalysisOptions analysisInput, BaseConversationTaskParameters parameters) : base(kind, serializedAdditionalRawData)
        {
            AnalysisInput = analysisInput;
            Parameters = parameters;
        }
        ...
        public BaseConversationTaskParameters Parameters { get; }
    }
}
