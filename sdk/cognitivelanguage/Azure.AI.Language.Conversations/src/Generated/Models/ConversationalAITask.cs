...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public partial class ConversationalAITask : AnalyzeConversationInput
    {
        ...
        public ConversationalAITask(ConversationalAIAnalysisOptions analysisInput, BaseConversationalAITaskParameters parameters)
        {
        ...
        /// <param name="analysisInput"> The input ConversationItem and its optional parameters. </param>
        /// <param name="parameters"> Input parameters necessary for a Conversation language understanding task. </param>
        internal ConversationalAITask(AnalyzeConversationInputKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, ConversationalAIAnalysisOptions analysisInput, BaseConversationalAITaskParameters parameters) : base(kind, serializedAdditionalRawData)
        {
            AnalysisInput = analysisInput;
            Parameters = parameters;
        }
        ...
        public ConversationalAIAnalysisOptions AnalysisInput { get; }
        /// <summary> Input parameters necessary for a Conversation language understanding task. </summary>
        public BaseConversationalAITaskParameters Parameters { get; }
    }
}
