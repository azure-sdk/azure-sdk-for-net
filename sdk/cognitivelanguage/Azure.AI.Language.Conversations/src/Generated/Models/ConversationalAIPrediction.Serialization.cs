...
{
    public partial class ConversationalAIPrediction : IUtf8JsonSerializable, IJsonModel<ConversationalAIPrediction>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConversationalAIPrediction>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ConversationalAIPrediction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIPrediction>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ConversationalAIPrediction IJsonModel<ConversationalAIPrediction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIPrediction>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ConversationalAIPrediction>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIPrediction>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ConversationalAIPrediction IPersistableModel<ConversationalAIPrediction>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIPrediction>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<ConversationalAIPrediction>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
