...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    internal partial class ConversationTaskContent
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationTaskContent"/>. </summary>
        /// <param name="projectName"> The name of the project to use. </param>
        /// <param name="deploymentName"> The name of the deployment to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="projectName"/> or <paramref name="deploymentName"/> is null. </exception>
        public ConversationTaskContent(string projectName, string deploymentName)
        {
        ...
        internal ConversationTaskContent(string projectName, string deploymentName, bool? verbose, bool? isLoggingEnabled, StringIndexType? stringIndexType, string directTarget, IDictionary<string, AnalysisConfig> targetProjectParameters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectName = projectName;
            DeploymentName = deploymentName;
            Verbose = verbose;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationTaskContent"/> for deserialization. </summary>
        internal ConversationTaskContent()
        {
        }
