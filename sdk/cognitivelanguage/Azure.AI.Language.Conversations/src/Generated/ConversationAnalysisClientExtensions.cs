...
{
    /// <summary> Extension methods to add <see cref="ConversationsClient"/>, <see cref="ConversationAnalysisClient"/>, <see cref="ConversationAuthoringClient"/> to client builder. </summary>
    public static partial class ConversationAnalysisClientExtensions
    {
        ...
        public static IAzureClientBuilder<ConversationsClient, ConversationsClientOptions> AddConversationsClient<TBuilder>(this TBuilder builder, AzureKeyCredential credential)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<ConversationsClient, ConversationsClientOptions>((options) => new ConversationsClient(credential, options));
        }

        /// <summary> Registers a <see cref="ConversationAnalysisClient"/> instance. </summary>
        /// <param name="builder"> The builder to register with. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        public static IAzureClientBuilder<ConversationAnalysisClient, ConversationsClientOptions> AddConversationAnalysisClient<TBuilder>(this TBuilder builder, AzureKeyCredential credential)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<ConversationAnalysisClient, ConversationsClientOptions>((options) => new ConversationAnalysisClient(credential, options));
        }
