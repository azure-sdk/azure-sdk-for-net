...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class ConversationsClient
    {
        ...
        /// <include file="Docs/ConversationsClient.xml" path="doc/members/member[@name='AnalyzeConversationsAsync(AnalyzeConversationTaskKind,CancellationToken)']/*" />
        public virtual async Task<Response<AnalyzeConversationTaskResult>> AnalyzeConversationsAsync(AnalyzeConversationTaskKind kind, CancellationToken cancellationToken = default)
        {
            AnalyzeConversationTask analyzeConversationTask = new Models.AnalyzeConversationTask(kind, null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await AnalyzeConversationsAsync(analyzeConversationTask.ToRequestContent(), context).ConfigureAwait(false);
        ...
        /// <param name="kind"> The base class of a conversation input task. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConversationsClient.xml" path="doc/members/member[@name='AnalyzeConversations(AnalyzeConversationTaskKind,CancellationToken)']/*" />
        public virtual Response<AnalyzeConversationTaskResult> AnalyzeConversations(AnalyzeConversationTaskKind kind, CancellationToken cancellationToken = default)
        {
            AnalyzeConversationTask analyzeConversationTask = new Models.AnalyzeConversationTask(kind, null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = AnalyzeConversations(analyzeConversationTask.ToRequestContent(), context);
            return Response.FromValue(AnalyzeConversationTaskResult.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AnalyzeConversationsAsync(AnalyzeConversationTaskKind,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AnalyzeConversations(AnalyzeConversationTaskKind,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <param name="tasks"> Set of tasks to execute on the input conversation. </param>
        ...
        /// <include file="Docs/ConversationsClient.xml" path="doc/members/member[@name='AnalyzeConversationsSubmitJobAsync(WaitUntil,MultiLanguageConversationAnalysisInput,IEnumerable{AnalyzeConversationJobTask},string,CancellationToken)']/*" />
        public virtual async Task<Operation> AnalyzeConversationsSubmitJobAsync(WaitUntil waitUntil, MultiLanguageConversationAnalysisInput analysisInput, IEnumerable<AnalyzeConversationJobTask> tasks, string displayName = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(analysisInput, nameof(analysisInput));
            Argument.AssertNotNull(tasks, nameof(tasks));

            AnalyzeConversationJobsInput analyzeConversationJobsInput = new AnalyzeConversationJobsInput(displayName, analysisInput, tasks.ToList(), null);
            RequestContext context = FromCancellationToken(cancellationToken);
            return await AnalyzeConversationsSubmitJobAsync(waitUntil, analyzeConversationJobsInput.ToRequestContent(), context).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="analysisInput"/> or <paramref name="tasks"/> is null. </exception>
        /// <include file="Docs/ConversationsClient.xml" path="doc/members/member[@name='AnalyzeConversationsSubmitJob(WaitUntil,MultiLanguageConversationAnalysisInput,IEnumerable{AnalyzeConversationJobTask},string,CancellationToken)']/*" />
        public virtual Operation AnalyzeConversationsSubmitJob(WaitUntil waitUntil, MultiLanguageConversationAnalysisInput analysisInput, IEnumerable<AnalyzeConversationJobTask> tasks, string displayName = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(analysisInput, nameof(analysisInput));
            Argument.AssertNotNull(tasks, nameof(tasks));
            ...
            AnalyzeConversationJobsInput analyzeConversationJobsInput = new AnalyzeConversationJobsInput(displayName, analysisInput, tasks.ToList(), null);
            RequestContext context = FromCancellationToken(cancellationToken);
            return AnalyzeConversationsSubmitJob(waitUntil, analyzeConversationJobsInput.ToRequestContent(), context);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AnalyzeConversationsSubmitJobAsync(WaitUntil,MultiLanguageConversationAnalysisInput,IEnumerable{AnalyzeConversationJobTask},string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AnalyzeConversationsSubmitJob(WaitUntil,MultiLanguageConversationAnalysisInput,IEnumerable{AnalyzeConversationJobTask},string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
