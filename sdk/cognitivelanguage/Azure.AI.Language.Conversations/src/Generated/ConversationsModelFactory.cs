...
namespace Azure.AI.Language.Conversations
{
    ...
    public static partial class ConversationsModelFactory
    {
        ...
        public static ConversationalAITask ConversationalAITask(ConversationalAIAnalysisOptions analysisInput = null, BaseConversationTaskParameters parameters = null)
        {
        ...
        public static TextConversationItem TextConversationItem(string id = null, string participantId = null, ParticipantRole? role = null, string language = null, InputModality? modality = null, string text = null)
        {
        ...
        public static TranscriptConversationItem TranscriptConversationItem(string id = null, string participantId = null, ParticipantRole? role = null, string language = null, InputModality? modality = null, string inverseTextNormalized = null, string maskedInverseTextNormalized = null, string text = null, string lexical = null, IEnumerable<WordLevelTiming> wordLevelTimings = null, ConversationItemLevelTiming conversationItemLevelTiming = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.BaseConversationTaskParameters"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.BaseConversationTaskParameters"/> instance for mocking. </returns>
        public static BaseConversationTaskParameters BaseConversationTaskParameters(string projectName = null, string deploymentName = null, StringIndexType? stringIndexType = null)
        {
            return new BaseConversationTaskParameters(projectName, deploymentName, stringIndexType, serializedAdditionalRawData: null);
        }
        ...
        public static ConversationLanguageUnderstandingActionContent ConversationLanguageUnderstandingActionContent(string projectName = null, string deploymentName = null, StringIndexType? stringIndexType = null, bool? verbose = null, bool? isLoggingEnabled = null, string directTarget = null, IDictionary<string, AnalysisConfig> targetProjectParameters = null)
        {
        ...
        public static ConversationItemRange ConversationItemRange(int offset = default, int length = default)
        {
            return new ConversationItemRange(offset, length, serializedAdditionalRawData: null);
        }
        ...
        public static ConversationalAIEntity ConversationalAIEntity(string name = null, string text = null, float confidenceScore = default, int offset = default, int length = default, string conversationItemId = null, int conversationItemIndex = default, IEnumerable<ResolutionBase> resolutions = null, IEnumerable<ConversationEntityExtraInformation> extraInformation = null)
        {
        ...
        /// The available derived classes include <see cref="Models.ConversationPrediction"/>, <see cref="Models.ConversationalAIPrediction"/> and <see cref="Models.OrchestrationPrediction"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ConversationalAIPrediction"/>. </summary>
        /// <param name="topIntent"> The intent with the highest score. </param>
        /// <param name="intents"> The intent classification results. </param>
        /// <param name="entities"> The entity extraction results. </param>
        /// <returns> A new <see cref="Models.ConversationalAIPrediction"/> instance for mocking. </returns>
        public static ConversationalAIPrediction ConversationalAIPrediction(string topIntent = null, IEnumerable<ConversationIntent> intents = null, IEnumerable<ConversationEntity> entities = null)
        {
            intents ??= new List<ConversationIntent>();
            entities ??= new List<ConversationEntity>();
