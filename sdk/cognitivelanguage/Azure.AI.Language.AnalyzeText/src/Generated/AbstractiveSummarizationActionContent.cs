...
namespace Azure.AI.Language.Text
{
    ...
    public partial class AbstractiveSummarizationActionContent
    {
        ...
        /// <param name="prompt"> (Optional) If provided, the query will be used to generate the summary. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal AbstractiveSummarizationActionContent(bool? loggingOptOut, string modelVersion, int? sentenceCount, StringIndexType? stringIndexType, SummaryLengthBucket? summaryLength, string prompt, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
