...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class Warning
    {
        ...
        internal Warning(string code, string message)
        {
        ...
        internal Warning(string code, string message, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
        ...
        /// <summary> Initializes a new instance of <see cref="Warning"/> for deserialization. </summary>
        internal Warning()
        {
        }
