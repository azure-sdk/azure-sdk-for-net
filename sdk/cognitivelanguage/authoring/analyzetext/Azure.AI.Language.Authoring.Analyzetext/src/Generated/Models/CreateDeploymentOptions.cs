...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class CreateDeploymentOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateDeploymentOptions"/>. </summary>
        ...
        public CreateDeploymentOptions(string trainedModelLabel)
        {
        ...
        internal CreateDeploymentOptions(string trainedModelLabel, IList<string> assignedResourceIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TrainedModelLabel = trainedModelLabel;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateDeploymentOptions"/> for deserialization. </summary>
        internal CreateDeploymentOptions()
        {
        }
