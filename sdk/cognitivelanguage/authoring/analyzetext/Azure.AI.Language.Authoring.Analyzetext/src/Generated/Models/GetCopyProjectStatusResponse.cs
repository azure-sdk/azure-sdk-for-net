...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetCopyProjectStatusResponse
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetCopyProjectStatusResponse"/>. </summary>
        ...
        internal GetCopyProjectStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        internal GetCopyProjectStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<Warning> warnings, IReadOnlyList<Error> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetCopyProjectStatusResponse"/> for deserialization. </summary>
        internal GetCopyProjectStatusResponse()
        {
        }
