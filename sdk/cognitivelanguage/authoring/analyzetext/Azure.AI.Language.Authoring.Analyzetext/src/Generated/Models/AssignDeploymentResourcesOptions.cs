...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class AssignDeploymentResourcesOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AssignDeploymentResourcesOptions"/>. </summary>
        ...
        public AssignDeploymentResourcesOptions(IEnumerable<ResourceMetadata> resourcesMetadata)
        {
        ...
        internal AssignDeploymentResourcesOptions(IList<ResourceMetadata> resourcesMetadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ResourcesMetadata = resourcesMetadata;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="AssignDeploymentResourcesOptions"/> for deserialization. </summary>
        internal AssignDeploymentResourcesOptions()
        {
        }
