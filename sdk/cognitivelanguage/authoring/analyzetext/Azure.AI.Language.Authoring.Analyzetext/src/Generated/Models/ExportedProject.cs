...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class ExportedProject
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="projectFileVersion"/> or <paramref name="createProjectOptions"/> is null. </exception>
        public ExportedProject(string projectFileVersion, StringIndexType stringIndexType, CreateProjectOptions createProjectOptions)
        {
            Argument.AssertNotNull(projectFileVersion, nameof(projectFileVersion));
            Argument.AssertNotNull(createProjectOptions, nameof(createProjectOptions));
        ...
        /// Please note <see cref="Models.ExportedProjectAssets"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        internal ExportedProject(string projectFileVersion, StringIndexType stringIndexType, CreateProjectOptions createProjectOptions, ExportedProjectAssets exportedProjectAssets, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectFileVersion = projectFileVersion;
            StringIndexType = stringIndexType;
            CreateProjectOptions = createProjectOptions;
            ExportedProjectAssets = exportedProjectAssets;
        ...
        public CreateProjectOptions CreateProjectOptions { get; }
        /// <summary>
        /// Represents the project assets.
        /// Please note <see cref="Models.ExportedProjectAssets"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="ExportedCustomAbstractiveSummarizationProjectAssets"/>, <see cref="ExportedCustomEntityRecognitionProjectAssets"/>, <see cref="ExportedCustomHealthcareProjectAssets"/>, <see cref="ExportedCustomMultiLabelClassificationProjectAssets"/>, <see cref="ExportedCustomSingleLabelClassificationProjectAssets"/> and <see cref="ExportedCustomTextSentimentProjectAssets"/>.
        /// </summary>
        public ExportedProjectAssets ExportedProjectAssets { get; set; }
    }
}
