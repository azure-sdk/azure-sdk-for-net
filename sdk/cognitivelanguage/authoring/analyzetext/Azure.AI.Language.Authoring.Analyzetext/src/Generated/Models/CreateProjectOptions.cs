...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class CreateProjectOptions
    {
        ...
        public CreateProjectOptions(ProjectKind projectKind, string storageInputContainerName, string projectName, string language)
        {
        ...
        internal CreateProjectOptions(ProjectKind projectKind, string storageInputContainerName, ProjectSettings projectSettings, string projectName, bool? multilingual, string description, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            StorageInputContainerName = storageInputContainerName;
