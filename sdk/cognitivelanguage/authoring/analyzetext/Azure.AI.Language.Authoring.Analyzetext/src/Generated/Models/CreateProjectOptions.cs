...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class CreateProjectOptions
    {
        ...
        internal CreateProjectOptions(ProjectKind projectKind, string storageInputContainerName, ProjectSettings settings, string projectName, bool? multilingual, string description, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            StorageInputContainerName = storageInputContainerName;
            Settings = settings;
