...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetExportedModelResponse
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportedModelResponse"/>. </summary>
        ...
        internal GetExportedModelResponse(string modelId, DateTimeOffset lastTrainedDateTime, DateTimeOffset lastExportedModelDateTime, DateTimeOffset modelExpirationDate, string modelTrainingConfigVersion)
        {
        ...
        internal GetExportedModelResponse(string modelId, DateTimeOffset lastTrainedDateTime, DateTimeOffset lastExportedModelDateTime, DateTimeOffset modelExpirationDate, string modelTrainingConfigVersion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelId = modelId;
            LastTrainedDateTime = lastTrainedDateTime;
            LastExportedModelDateTime = lastExportedModelDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportedModelResponse"/> for deserialization. </summary>
        internal GetExportedModelResponse()
        {
        }
