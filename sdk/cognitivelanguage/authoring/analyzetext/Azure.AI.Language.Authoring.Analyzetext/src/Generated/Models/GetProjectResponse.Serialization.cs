...
{
    public partial class GetProjectResponse : IUtf8JsonSerializable, IJsonModel<GetProjectResponse>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetProjectResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<GetProjectResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GetProjectResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetProjectResponse)} does not support writing '{format}' format.");
            }
        ...
        GetProjectResponse IJsonModel<GetProjectResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GetProjectResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetProjectResponse)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeGetProjectResponse(document.RootElement, options);
        }

        internal static GetProjectResponse DeserializeGetProjectResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<GetProjectResponse>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GetProjectResponse>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetProjectResponse)} does not support writing '{options.Format}' format.");
            }
        }

        GetProjectResponse IPersistableModel<GetProjectResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GetProjectResponse>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetProjectResponse)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<GetProjectResponse>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static GetProjectResponse FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeGetProjectResponse(document.RootElement);
        }
