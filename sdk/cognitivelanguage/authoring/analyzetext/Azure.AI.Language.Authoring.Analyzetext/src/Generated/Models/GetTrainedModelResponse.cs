...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetTrainedModelResponse
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetTrainedModelResponse"/>. </summary>
        ...
        internal GetTrainedModelResponse(string modelId, DateTimeOffset lastTrainedDateTime, int lastTrainingDurationInSeconds, DateTimeOffset modelExpirationDate, string modelTrainingConfigVersion, bool hasSnapshot)
        {
        ...
        internal GetTrainedModelResponse(string modelId, DateTimeOffset lastTrainedDateTime, int lastTrainingDurationInSeconds, DateTimeOffset modelExpirationDate, string modelTrainingConfigVersion, bool hasSnapshot, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelId = modelId;
            LastTrainedDateTime = lastTrainedDateTime;
            LastTrainingDurationInSeconds = lastTrainingDurationInSeconds;
        ...
        /// <summary> Initializes a new instance of <see cref="GetTrainedModelResponse"/> for deserialization. </summary>
        internal GetTrainedModelResponse()
        {
        }
