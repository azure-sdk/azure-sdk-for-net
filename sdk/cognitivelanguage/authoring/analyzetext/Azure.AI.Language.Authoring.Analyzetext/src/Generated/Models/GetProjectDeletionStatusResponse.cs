...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetProjectDeletionStatusResponse
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetProjectDeletionStatusResponse"/>. </summary>
        ...
        internal GetProjectDeletionStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        internal GetProjectDeletionStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<Warning> warnings, IReadOnlyList<Error> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetProjectDeletionStatusResponse"/> for deserialization. </summary>
        internal GetProjectDeletionStatusResponse()
        {
        }
