...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    /// resource.
    /// </summary>
    public partial class CopyProjectOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CopyProjectOptions"/>. </summary>
        ...
        public CopyProjectOptions(ProjectKind projectKind, string targetProjectName, string accessToken, DateTimeOffset expiresAt, string targetResourceId, string targetResourceRegion)
        {
        ...
        internal CopyProjectOptions(ProjectKind projectKind, string targetProjectName, string accessToken, DateTimeOffset expiresAt, string targetResourceId, string targetResourceRegion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            TargetProjectName = targetProjectName;
            AccessToken = accessToken;
        ...
        /// <summary> Initializes a new instance of <see cref="CopyProjectOptions"/> for deserialization. </summary>
        internal CopyProjectOptions()
        {
        }
