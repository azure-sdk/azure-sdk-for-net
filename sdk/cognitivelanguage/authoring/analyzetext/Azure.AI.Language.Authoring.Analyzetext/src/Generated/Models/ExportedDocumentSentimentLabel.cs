...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class ExportedDocumentSentimentLabel
    {
        ...
        internal ExportedDocumentSentimentLabel(Sentiment? category, int? offset, int? length, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Offset = offset;
            Length = length;
        ...
        public Sentiment? Category { get; set; }
