...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    internal partial class UnknownEvaluationSummary : EvaluationSummary
    {
        ...
        internal UnknownEvaluationSummary(ProjectKind projectKind, EvaluationOptions evaluationOptions, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(projectKind, evaluationOptions, serializedAdditionalRawData)
        {
        }
