...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetExportStatusResponse
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportStatusResponse"/>. </summary>
        ...
        internal GetExportStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        internal GetExportStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<Warning> warnings, IReadOnlyList<Error> errors, string resultUrl, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportStatusResponse"/> for deserialization. </summary>
        internal GetExportStatusResponse()
        {
        }
