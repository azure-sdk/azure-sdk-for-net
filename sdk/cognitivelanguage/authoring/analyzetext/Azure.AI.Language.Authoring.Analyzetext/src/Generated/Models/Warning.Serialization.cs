...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    public partial class Warning : IUtf8JsonSerializable, IJsonModel<Warning>
    {
        ...
        internal static Warning DeserializeWarning(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Warning(code, message, serializedAdditionalRawData);
        }
        ...
        internal static Warning FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeWarning(document.RootElement);
        }
