...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class EvaluationJobResult
    {
        ...
        internal EvaluationJobResult(EvaluationOptions evaluationOptions, string modelLabel, string trainingConfigVersion, int percentComplete)
        {
        ...
        internal EvaluationJobResult(EvaluationOptions evaluationOptions, string modelLabel, string trainingConfigVersion, int percentComplete, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EvaluationOptions = evaluationOptions;
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
