...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class EvaluationOptions
    {
        ...
        internal EvaluationOptions(EvaluationKind? kind, int? trainingSplitPercentage, int? testingSplitPercentage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
