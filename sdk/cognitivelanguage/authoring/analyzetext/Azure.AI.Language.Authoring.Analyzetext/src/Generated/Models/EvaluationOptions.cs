...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class EvaluationOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="EvaluationOptions"/>. </summary>
        public EvaluationOptions()
        {
        }

        /// <summary> Initializes a new instance of <see cref="EvaluationOptions"/>. </summary>
        /// <param name="evaluationKind">
        ...
        internal EvaluationOptions(EvaluationKind? evaluationKind, int? trainingSplitPercentage, int? testingSplitPercentage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
