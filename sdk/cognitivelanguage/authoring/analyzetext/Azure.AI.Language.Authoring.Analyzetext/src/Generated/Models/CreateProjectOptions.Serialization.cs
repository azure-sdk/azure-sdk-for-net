...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    public partial class CreateProjectOptions : IUtf8JsonSerializable, IJsonModel<CreateProjectOptions>
    {
        ...
        void IJsonModel<CreateProjectOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProjectSettings))
            {
                writer.WritePropertyName("projectSettings"u8);
                writer.WriteObjectValue(ProjectSettings, options);
            }
        ...
        internal static CreateProjectOptions DeserializeCreateProjectOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("projectSettings"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    projectSettings = ProjectSettings.DeserializeProjectSettings(property.Value, options);
                    continue;
                }
