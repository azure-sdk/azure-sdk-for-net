...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetDeploymentStatusResponse
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetDeploymentStatusResponse"/>. </summary>
        ...
        internal GetDeploymentStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        internal GetDeploymentStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<Warning> warnings, IReadOnlyList<Error> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetDeploymentStatusResponse"/> for deserialization. </summary>
        internal GetDeploymentStatusResponse()
        {
        }
