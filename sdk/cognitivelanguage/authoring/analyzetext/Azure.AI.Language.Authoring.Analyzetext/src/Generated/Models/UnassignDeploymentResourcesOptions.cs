...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class UnassignDeploymentResourcesOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="UnassignDeploymentResourcesOptions"/>. </summary>
        ...
        public UnassignDeploymentResourcesOptions(IEnumerable<string> assignedResourceIds)
        {
        ...
        internal UnassignDeploymentResourcesOptions(IList<string> assignedResourceIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AssignedResourceIds = assignedResourceIds;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="UnassignDeploymentResourcesOptions"/> for deserialization. </summary>
        internal UnassignDeploymentResourcesOptions()
        {
        }
