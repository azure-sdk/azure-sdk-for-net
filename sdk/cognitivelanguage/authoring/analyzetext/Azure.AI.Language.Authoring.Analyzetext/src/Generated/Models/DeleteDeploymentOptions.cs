...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class DeleteDeploymentOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DeleteDeploymentOptions"/>. </summary>
        public DeleteDeploymentOptions()
        {
        ...
        internal DeleteDeploymentOptions(IList<string> assignedResourceIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
