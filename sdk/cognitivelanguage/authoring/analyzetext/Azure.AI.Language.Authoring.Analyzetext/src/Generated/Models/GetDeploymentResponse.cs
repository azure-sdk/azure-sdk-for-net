...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetDeploymentResponse
    {
        ...
        internal GetDeploymentResponse(string modelId, DateTimeOffset lastTrainedDateTime, DateTimeOffset lastDeployedDateTime, DateTimeOffset deploymentExpirationDate, string modelTrainingConfigVersion, IEnumerable<DeploymentResource> assignedResources)
        {
        ...
        internal GetDeploymentResponse(string modelId, DateTimeOffset lastTrainedDateTime, DateTimeOffset lastDeployedDateTime, DateTimeOffset deploymentExpirationDate, string modelTrainingConfigVersion, IReadOnlyList<DeploymentResource> assignedResources, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelId = modelId;
            LastTrainedDateTime = lastTrainedDateTime;
            LastDeployedDateTime = lastDeployedDateTime;
