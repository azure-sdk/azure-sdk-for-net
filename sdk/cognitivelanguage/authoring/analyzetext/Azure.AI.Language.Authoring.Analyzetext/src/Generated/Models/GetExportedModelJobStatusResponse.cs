...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetExportedModelJobStatusResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportedModelJobStatusResponse"/>. </summary>
        ...
        internal GetExportedModelJobStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        internal GetExportedModelJobStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<Warning> warnings, IReadOnlyList<Error> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportedModelJobStatusResponse"/> for deserialization. </summary>
        internal GetExportedModelJobStatusResponse()
        {
        }
