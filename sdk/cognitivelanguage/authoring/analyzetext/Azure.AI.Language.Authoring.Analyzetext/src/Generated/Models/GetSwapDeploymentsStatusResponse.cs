...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class GetSwapDeploymentsStatusResponse
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetSwapDeploymentsStatusResponse"/>. </summary>
        ...
        internal GetSwapDeploymentsStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        internal GetSwapDeploymentsStatusResponse(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<Warning> warnings, IReadOnlyList<Error> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetSwapDeploymentsStatusResponse"/> for deserialization. </summary>
        internal GetSwapDeploymentsStatusResponse()
        {
        }
