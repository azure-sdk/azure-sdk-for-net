...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class DocumentSentimentLabelEvaluationResult
    {
        ...
        internal DocumentSentimentLabelEvaluationResult(Sentiment category, int offset, int length)
        {
            Category = category;
            Offset = offset;
            Length = length;
        ...
        internal DocumentSentimentLabelEvaluationResult(Sentiment category, int offset, int length, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Offset = offset;
            Length = length;
