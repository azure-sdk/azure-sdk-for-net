...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class TrainingJobOptions
    {
        ...
        public TrainingJobOptions(string modelLabel, string trainingConfigVersion)
        {
        ...
        internal TrainingJobOptions(string modelLabel, string trainingConfigVersion, EvaluationOptions evaluationOptions, DataGenerationSettings dataGenerationSettings, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
