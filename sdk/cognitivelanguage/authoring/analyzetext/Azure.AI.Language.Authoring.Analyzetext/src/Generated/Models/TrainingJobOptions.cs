...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class TrainingJobOptions
    {
        ...
        internal TrainingJobOptions(string modelLabel, string trainingConfigVersion, EvaluationOptions evaluationOptions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
