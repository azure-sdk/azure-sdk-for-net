...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class ExportedModelOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ExportedModelOptions"/>. </summary>
        ...
        internal ExportedModelOptions(string trainedModelLabel, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TrainedModelLabel = trainedModelLabel;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="ExportedModelOptions"/> for deserialization. </summary>
        internal ExportedModelOptions()
        {
        }
