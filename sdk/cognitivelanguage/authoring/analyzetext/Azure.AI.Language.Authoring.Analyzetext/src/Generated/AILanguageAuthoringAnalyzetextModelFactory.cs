...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public static partial class AILanguageAuthoringAnalyzetextModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetProjectResponse"/>. </summary>
        /// <param name="createdDateTime"> Represents the project creation datetime. </param>
        /// <param name="lastModifiedDateTime"> Represents the project last modification datetime. </param>
        /// <param name="lastTrainedDateTime"> Represents the project last training datetime. </param>
        /// <param name="lastDeployedDateTime"> Represents the project last deployment datetime. </param>
        ...
        /// use "en" for English, "en-gb" for English (UK), "es" for Spanish etc.
        /// </param>
        /// <returns> A new <see cref="Models.GetProjectResponse"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.CreateProjectOptions"/>. </summary>
        /// <param name="projectKind"> The project kind. </param>
        /// <param name="storageInputContainerName"> The storage container name. </param>
        ...
        /// use "en" for English, "en-gb" for English (UK), "es" for Spanish etc.
        /// </param>
        /// <returns> A new <see cref="Models.CreateProjectOptions"/> instance for mocking. </returns>
        public static CreateProjectOptions CreateProjectOptions(ProjectKind projectKind = default, string storageInputContainerName = null, ProjectSettings projectSettings = null, string projectName = null, bool? multilingual = null, string description = null, string language = null)
        {
        ...
        /// </param>
        /// <param name="createProjectOptions"> Represents the project metadata. </param>
        /// <param name="exportedProjectAssets">
        ...
        public static ExportedProject ExportedProject(string projectFileVersion = null, StringIndexType stringIndexType = default, CreateProjectOptions createProjectOptions = null, ExportedProjectAssets exportedProjectAssets = null)
        {
            return new ExportedProject(projectFileVersion, stringIndexType, createProjectOptions, exportedProjectAssets, serializedAdditionalRawData: null);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Models.TrainingJobOptions"/>. </summary>
        ...
        /// as 20.
        /// </param>
        /// <returns> A new <see cref="Models.TrainingJobOptions"/> instance for mocking. </returns>
        public static TrainingJobOptions TrainingJobOptions(string modelLabel = null, string trainingConfigVersion = null, EvaluationOptions evaluationOptions = null)
        {
            return new TrainingJobOptions(modelLabel, trainingConfigVersion, evaluationOptions, serializedAdditionalRawData: null);
        }
        ...
        public static TrainingJobState TrainingJobState(string jobId = null, DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null, TrainingJobResult result = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetCopyProjectStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetCopyProjectStatusResponse"/> instance for mocking. </returns>
        public static GetCopyProjectStatusResponse GetCopyProjectStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetDeploymentResponse"/>. </summary>
        /// <param name="modelId"> Represents deployment modelId. </param>
        /// <param name="lastTrainedDateTime"> Represents deployment last trained time. </param>
        /// <param name="lastDeployedDateTime"> Represents deployment last deployed time. </param>
        /// <param name="deploymentExpirationDate"> Represents deployment expiration date in the runtime. </param>
        /// <param name="modelTrainingConfigVersion"> Represents model training config version. </param>
        /// <param name="assignedResources"> Represents the metadata of the assigned Azure resources. </param>
        /// <returns> A new <see cref="Models.GetDeploymentResponse"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.CreateDeploymentOptions"/>. </summary>
        ...
        /// </param>
        /// <returns> A new <see cref="Models.CreateDeploymentOptions"/> instance for mocking. </returns>
        public static CreateDeploymentOptions CreateDeploymentOptions(string trainedModelLabel = null, IEnumerable<string> assignedResourceIds = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetDeploymentDeleteFromResourcesStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetDeploymentDeleteFromResourcesStatusResponse"/> instance for mocking. </returns>
        public static GetDeploymentDeleteFromResourcesStatusResponse GetDeploymentDeleteFromResourcesStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetDeploymentStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetDeploymentStatusResponse"/> instance for mocking. </returns>
        public static GetDeploymentStatusResponse GetDeploymentStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetSwapDeploymentsStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetSwapDeploymentsStatusResponse"/> instance for mocking. </returns>
        public static GetSwapDeploymentsStatusResponse GetSwapDeploymentsStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetExportStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        ...
        /// <returns> A new <see cref="Models.GetExportStatusResponse"/> instance for mocking. </returns>
        public static GetExportStatusResponse GetExportStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null, string resultUrl = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetExportedModelResponse"/>. </summary>
        /// <param name="modelId"> The model ID. </param>
        /// <param name="lastTrainedDateTime"> The last trained date time of the model. </param>
        /// <param name="lastExportedModelDateTime"> The last exported date time of the model. </param>
        /// <param name="modelExpirationDate"> The model expiration date. </param>
        /// <param name="modelTrainingConfigVersion"> The model training config version. </param>
        /// <returns> A new <see cref="Models.GetExportedModelResponse"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetExportedModelJobStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetExportedModelJobStatusResponse"/> instance for mocking. </returns>
        public static GetExportedModelJobStatusResponse GetExportedModelJobStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetImportStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetImportStatusResponse"/> instance for mocking. </returns>
        public static GetImportStatusResponse GetImportStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetTrainedModelResponse"/>. </summary>
        /// <param name="modelId"> The model ID. </param>
        /// <param name="lastTrainedDateTime"> The last trained date time of the model. </param>
        /// <param name="lastTrainingDurationInSeconds"> The duration of the model's last training request in seconds. </param>
        /// <param name="modelExpirationDate"> The model expiration date. </param>
        /// <param name="modelTrainingConfigVersion"> The model training config version. </param>
        /// <param name="hasSnapshot"> The flag to indicate if the trained model has a snapshot ready. </param>
        /// <returns> A new <see cref="Models.GetTrainedModelResponse"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetEvaluationStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        ...
        /// <returns> A new <see cref="Models.GetEvaluationStatusResponse"/> instance for mocking. </returns>
        public static GetEvaluationStatusResponse GetEvaluationStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null, EvaluationJobResult result = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetLoadSnapshotStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetLoadSnapshotStatusResponse"/> instance for mocking. </returns>
        public static GetLoadSnapshotStatusResponse GetLoadSnapshotStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetAssignDeploymentResourcesStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetAssignDeploymentResourcesStatusResponse"/> instance for mocking. </returns>
        public static GetAssignDeploymentResourcesStatusResponse GetAssignDeploymentResourcesStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetUnassignDeploymentResourcesStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetUnassignDeploymentResourcesStatusResponse"/> instance for mocking. </returns>
        public static GetUnassignDeploymentResourcesStatusResponse GetUnassignDeploymentResourcesStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetTrainingStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        ...
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <param name="result"> Represents training tasks detailed result. </param>
        /// <returns> A new <see cref="Models.GetTrainingStatusResponse"/> instance for mocking. </returns>
        public static GetTrainingStatusResponse GetTrainingStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null, TrainingJobResult result = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.GetProjectDeletionStatusResponse"/>. </summary>
        /// <param name="createdDateTime"> The creation date time of the job. </param>
        /// <param name="lastUpdatedDateTime"> The last date time the job was updated. </param>
        /// <param name="expirationDateTime"> The expiration date time of the job. </param>
        /// <param name="status"> The job status. </param>
        /// <param name="warnings"> The warnings that were encountered while executing the job. </param>
        /// <param name="errors"> The errors encountered while executing the job. </param>
        /// <returns> A new <see cref="Models.GetProjectDeletionStatusResponse"/> instance for mocking. </returns>
        public static GetProjectDeletionStatusResponse GetProjectDeletionStatusResponse(DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, DateTimeOffset? expirationDateTime = null, JobStatus status = default, IEnumerable<Warning> warnings = null, IEnumerable<Error> errors = null)
        {
            warnings ??= new List<Warning>();
            errors ??= new List<Error>();
