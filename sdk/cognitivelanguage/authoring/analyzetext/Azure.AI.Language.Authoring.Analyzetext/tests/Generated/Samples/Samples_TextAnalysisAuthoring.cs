...
namespace Azure.AI.Language.Authoring.Analyzetext.Samples
{
    public partial class Samples_TextAnalysisAuthoring
    {
        ...
        public void Example_TextAnalysisAuthoringProjectMetadata_GetProject_ShortVersion_Convenience()
        {
            ...
            Response<GetProjectResponse> response = client.GetProject("<projectName>");
        }
        ...
        public async Task Example_TextAnalysisAuthoringProjectMetadata_GetProject_ShortVersion_Convenience_Async()
        {
            ...
            Response<GetProjectResponse> response = await client.GetProjectAsync("<projectName>");
        }
        ...
        public void Example_TextAnalysisAuthoring_CopyProjectAuthorization_ShortVersion_Convenience()
        {
            ...
            Response<CopyProjectOptions> response = client.CopyProjectAuthorization("<projectName>", ProjectKind.CustomSingleLabelClassification);
        }
        ...
        public async Task Example_TextAnalysisAuthoring_CopyProjectAuthorization_ShortVersion_Convenience_Async()
        {
            ...
            Response<CopyProjectOptions> response = await client.CopyProjectAuthorizationAsync("<projectName>", ProjectKind.CustomSingleLabelClassification);
        }
        ...
        public void Example_TextAnalysisAuthoring_CopyProjectAuthorization_AllParameters_Convenience()
        {
            ...
            Response<CopyProjectOptions> response = client.CopyProjectAuthorization("<projectName>", ProjectKind.CustomSingleLabelClassification, storageInputContainerName: "<storageInputContainerName>", allowOverwrite: true);
        }
        ...
        public async Task Example_TextAnalysisAuthoring_CopyProjectAuthorization_AllParameters_Convenience_Async()
        {
            ...
            Response<CopyProjectOptions> response = await client.CopyProjectAuthorizationAsync("<projectName>", ProjectKind.CustomSingleLabelClassification, storageInputContainerName: "<storageInputContainerName>", allowOverwrite: true);
        }
        ...
        public void Example_TextAnalysisAuthoring_Import_ShortVersion_Convenience()
        {
            ...
            ExportedProject body = new ExportedProject("<projectFileVersion>", StringIndexType.Utf16CodeUnit, new CreateProjectOptions(ProjectKind.CustomSingleLabelClassification, "<storageInputContainerName>", "<projectName>", "<language>"));
...
Dataset = "<dataset>",
        ...
        public void Example_TextAnalysisAuthoring_Train_ShortVersion_Convenience()
        {
            ...
            TrainingJobOptions body = new TrainingJobOptions("<modelLabel>", "<trainingConfigVersion>");
        ...
        public void Example_TextAnalysisAuthoring_DeployProject_ShortVersion_Convenience()
        {
            ...
            CreateDeploymentOptions body = new CreateDeploymentOptions("<trainedModelLabel>");
            Operation<DeployProjectResponseAcceptedResponseErrorResponse> operation = client.DeployProject(WaitUntil.Completed, "<projectName>", "<deploymentName>", body);
        ...
        public async Task Example_TextAnalysisAuthoring_DeployProject_ShortVersion_Convenience_Async()
        {
            ...
            CreateDeploymentOptions body = new CreateDeploymentOptions("<trainedModelLabel>");
            Operation<DeployProjectResponseAcceptedResponseErrorResponse> operation = await client.DeployProjectAsync(WaitUntil.Completed, "<projectName>", "<deploymentName>", body);
            DeployProjectResponseAcceptedResponseErrorResponse responseData = operation.Value;
        }
...
"<assignedResourceIds>"
        ...
        public void Example_TextAnalysisAuthoring_SwapDeployments_ShortVersion_Convenience()
        {
            ...
            SwapDeploymentsOptions body = new SwapDeploymentsOptions("<firstDeploymentName>", "<secondDeploymentName>");
        ...
        public void Example_TextAnalysisAuthoring_CreateOrUpdateExportedModel_ShortVersion()
        {
            ...
            Operation<BinaryData> operation = client.CreateOrUpdateExportedModel(WaitUntil.Completed, "<projectName>", "<exportedModelName>", content);
            BinaryData responseData = operation.Value;
        ...
        public async Task Example_TextAnalysisAuthoring_CreateOrUpdateExportedModel_ShortVersion_Async()
        {
            ...
            Operation<BinaryData> operation = await client.CreateOrUpdateExportedModelAsync(WaitUntil.Completed, "<projectName>", "<exportedModelName>", content);
            BinaryData responseData = operation.Value;
        ...
        public void Example_TextAnalysisAuthoring_CreateOrUpdateExportedModel_ShortVersion_Convenience()
        {
            ...
            ExportedModelOptions body = new ExportedModelOptions("<trainedModelLabel>");
            Operation<CreateOrUpdateExportedModelResponseAcceptedResponseErrorResponse> operation = client.CreateOrUpdateExportedModel(WaitUntil.Completed, "<projectName>", "<exportedModelName>", body);
        ...
        public async Task Example_TextAnalysisAuthoring_CreateOrUpdateExportedModel_ShortVersion_Convenience_Async()
        {
            ...
            ExportedModelOptions body = new ExportedModelOptions("<trainedModelLabel>");
            Operation<CreateOrUpdateExportedModelResponseAcceptedResponseErrorResponse> operation = await client.CreateOrUpdateExportedModelAsync(WaitUntil.Completed, "<projectName>", "<exportedModelName>", body);
            CreateOrUpdateExportedModelResponseAcceptedResponseErrorResponse responseData = operation.Value;
        }
...
"<assignedResourceIds>"
        ...
        public void Example_TextAnalysisAuthoring_UnassignDeploymentResources_ShortVersion_Convenience()
        {
            ...
            UnassignDeploymentResourcesOptions body = new UnassignDeploymentResourcesOptions(new string[] { "<assignedResourceIds>" });
