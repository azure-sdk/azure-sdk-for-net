...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringProjectMetadata
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringProjectMetadata"/>. </summary>
        ...
        public ConversationalAnalysisAuthoringProjectMetadata(DateTimeOffset createdDateTime, DateTimeOffset lastModifiedDateTime, ConversationalAnalysisAuthoringProjectKind projectKind, string projectName, string language)
        {
        ...
        internal ConversationalAnalysisAuthoringProjectMetadata(DateTimeOffset createdDateTime, DateTimeOffset lastModifiedDateTime, DateTimeOffset? lastTrainedDateTime, DateTimeOffset? lastDeployedDateTime, ConversationalAnalysisAuthoringProjectKind projectKind, ConversationalAnalysisAuthoringProjectSettings settings, string storageInputContainerName, string projectName, bool? multilingual, string description, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            LastModifiedDateTime = lastModifiedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringProjectMetadata"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringProjectMetadata()
        {
        }
        ...
        public DateTimeOffset? LastTrainedDateTime { get; set; }
        /// <summary> Represents the project last deployed datetime. </summary>
        public DateTimeOffset? LastDeployedDateTime { get; set; }
        /// <summary> Represents the project kind. </summary>
        public ConversationalAnalysisAuthoringProjectKind ProjectKind { get; set; }
        /// <summary> The project settings. </summary>
        public ConversationalAnalysisAuthoringProjectSettings Settings { get; set; }
