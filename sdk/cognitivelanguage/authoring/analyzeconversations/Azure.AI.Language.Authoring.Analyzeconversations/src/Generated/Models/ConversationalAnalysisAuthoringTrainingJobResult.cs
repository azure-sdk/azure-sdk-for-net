...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringTrainingJobResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringTrainingJobResult"/>. </summary>
        ...
        internal ConversationalAnalysisAuthoringTrainingJobResult(string modelLabel, string trainingConfigVersion, ConversationalAnalysisAuthoringSubTrainingJobState trainingStatus)
        {
        ...
        internal ConversationalAnalysisAuthoringTrainingJobResult(string modelLabel, string trainingConfigVersion, ConversationalAnalysisAuthoringTrainingMode? trainingMode, ConversationalAnalysisAuthoringSubTrainingJobState trainingStatus, ConversationalAnalysisAuthoringSubTrainingJobState evaluationStatus, DateTimeOffset? estimatedEndDateTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringTrainingJobResult"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringTrainingJobResult()
        {
        }
        ...
        public ConversationalAnalysisAuthoringTrainingMode? TrainingMode { get; }
        /// <summary> Represents the model training status. </summary>
        public ConversationalAnalysisAuthoringSubTrainingJobState TrainingStatus { get; }
        /// <summary> Represents model evaluation status. </summary>
        public ConversationalAnalysisAuthoringSubTrainingJobState EvaluationStatus { get; }
