...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringOrchestrationExportedUtterance
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringOrchestrationExportedUtterance"/>. </summary>
        ...
        public ConversationalAnalysisAuthoringOrchestrationExportedUtterance(string text, string intent)
        {
        ...
        internal ConversationalAnalysisAuthoringOrchestrationExportedUtterance(string text, string language, string intent, string dataset, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Language = language;
            Intent = intent;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringOrchestrationExportedUtterance"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringOrchestrationExportedUtterance()
        {
        }
