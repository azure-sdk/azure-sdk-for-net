...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringEvaluationOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringEvaluationOptions"/>. </summary>
        public ConversationalAnalysisAuthoringEvaluationOptions()
        {
        }
        ...
        internal ConversationalAnalysisAuthoringEvaluationOptions(ConversationalAnalysisAuthoringEvaluationKind? kind, int? trainingSplitPercentage, int? testingSplitPercentage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
