...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringProjectTrainedModel
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringProjectTrainedModel"/>. </summary>
        ...
        internal ConversationalAnalysisAuthoringProjectTrainedModel(string modelId, DateTimeOffset lastTrainedDateTime, int lastTrainingDurationInSeconds, DateTimeOffset modelExpirationDate, string modelTrainingConfigVersion, bool hasSnapshot)
        {
        ...
        internal ConversationalAnalysisAuthoringProjectTrainedModel(string label, string modelId, DateTimeOffset lastTrainedDateTime, int lastTrainingDurationInSeconds, DateTimeOffset modelExpirationDate, string modelTrainingConfigVersion, bool hasSnapshot, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Label = label;
            ModelId = modelId;
            LastTrainedDateTime = lastTrainedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringProjectTrainedModel"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringProjectTrainedModel()
        {
        }
