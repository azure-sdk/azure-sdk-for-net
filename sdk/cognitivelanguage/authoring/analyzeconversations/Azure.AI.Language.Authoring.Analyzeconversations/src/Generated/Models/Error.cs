...
{
    /// <summary> Represents the definition of an error that occurred. </summary>
    public partial class Error
    {
        ...
        internal Error(ErrorCode code, string message, string target, IReadOnlyList<Error> details, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        /// <summary> The target that caused the error, if applicable. </summary>
