...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    /// </summary>
    public partial class ConversationalAnalysisAuthoringExportedEntityRegexExpression
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringExportedEntityRegexExpression"/>. </summary>
        public ConversationalAnalysisAuthoringExportedEntityRegexExpression()
        {
        }
        ...
        internal ConversationalAnalysisAuthoringExportedEntityRegexExpression(string regexKey, string language, string regexPattern, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RegexKey = regexKey;
            Language = language;
