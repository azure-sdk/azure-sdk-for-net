...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringCreateDeploymentOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringCreateDeploymentOptions"/>. </summary>
        ...
        public ConversationalAnalysisAuthoringCreateDeploymentOptions(string trainedModelLabel)
        {
        ...
        internal ConversationalAnalysisAuthoringCreateDeploymentOptions(string trainedModelLabel, IList<string> assignedResourceIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TrainedModelLabel = trainedModelLabel;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringCreateDeploymentOptions"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringCreateDeploymentOptions()
        {
        }
