...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringResourceMetadata
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringResourceMetadata"/>. </summary>
        ...
        public ConversationalAnalysisAuthoringResourceMetadata(string azureResourceId, string customDomain, string region)
        {
        ...
        internal ConversationalAnalysisAuthoringResourceMetadata(string azureResourceId, string customDomain, string region, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AzureResourceId = azureResourceId;
            CustomDomain = customDomain;
            Region = region;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringResourceMetadata"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringResourceMetadata()
        {
        }
