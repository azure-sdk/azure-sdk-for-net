...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringEntityEvaluationSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringEntityEvaluationSummary"/>. </summary>
        ...
        internal ConversationalAnalysisAuthoringEntityEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        internal ConversationalAnalysisAuthoringEntityEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringEntityEvaluationSummary"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringEntityEvaluationSummary()
        {
        }
