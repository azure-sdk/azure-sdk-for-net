...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    /// resource.
    /// </summary>
    public partial class ConversationalAnalysisAuthoringCopyProjectOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringCopyProjectOptions"/>. </summary>
        ...
        public ConversationalAnalysisAuthoringCopyProjectOptions(ConversationalAnalysisAuthoringProjectKind projectKind, string targetProjectName, string accessToken, DateTimeOffset expiresAt, string targetResourceId, string targetResourceRegion)
        {
        ...
        internal ConversationalAnalysisAuthoringCopyProjectOptions(ConversationalAnalysisAuthoringProjectKind projectKind, string targetProjectName, string accessToken, DateTimeOffset expiresAt, string targetResourceId, string targetResourceRegion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            TargetProjectName = targetProjectName;
            AccessToken = accessToken;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringCopyProjectOptions"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringCopyProjectOptions()
        {
        }
