...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    public partial class ConversationalAnalysisAuthoringIntentsEvaluationSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringIntentsEvaluationSummary"/>. </summary>
        ...
        internal ConversationalAnalysisAuthoringIntentsEvaluationSummary(ConversationalAnalysisAuthoringConfusionMatrix confusionMatrix, IReadOnlyDictionary<string, ConversationalAnalysisAuthoringIntentEvaluationSummary> intents, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringIntentsEvaluationSummary"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringIntentsEvaluationSummary()
        {
        }
        ...
        public IReadOnlyDictionary<string, ConversationalAnalysisAuthoringIntentEvaluationSummary> Intents { get; }
