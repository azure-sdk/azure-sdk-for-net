...
namespace Azure.AI.Language.Authoring.Analyzeconversations.Models
{
    ...
    /// utterance.
    /// </summary>
    public partial class ConversationalAnalysisAuthoringUtteranceIntentsEvaluationResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringUtteranceIntentsEvaluationResult"/>. </summary>
        ...
        internal ConversationalAnalysisAuthoringUtteranceIntentsEvaluationResult(string expectedIntent, string predictedIntent)
        {
        ...
        internal ConversationalAnalysisAuthoringUtteranceIntentsEvaluationResult(string expectedIntent, string predictedIntent, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ExpectedIntent = expectedIntent;
            PredictedIntent = predictedIntent;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringUtteranceIntentsEvaluationResult"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringUtteranceIntentsEvaluationResult()
        {
        }
