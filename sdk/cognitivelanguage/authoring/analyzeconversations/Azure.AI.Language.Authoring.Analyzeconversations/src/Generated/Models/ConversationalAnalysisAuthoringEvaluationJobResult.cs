...
{
    /// <summary> The ConversationalAnalysisAuthoringEvaluationJobResult. </summary>
    public partial class ConversationalAnalysisAuthoringEvaluationJobResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringEvaluationJobResult"/>. </summary>
        ...
        internal ConversationalAnalysisAuthoringEvaluationJobResult(ConversationalAnalysisAuthoringEvaluationOptions evaluationOptions, string modelLabel, string trainingConfigVersion, double percentComplete)
        {
        ...
        internal ConversationalAnalysisAuthoringEvaluationJobResult(ConversationalAnalysisAuthoringEvaluationOptions evaluationOptions, string modelLabel, string trainingConfigVersion, double percentComplete, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EvaluationOptions = evaluationOptions;
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationalAnalysisAuthoringEvaluationJobResult"/> for deserialization. </summary>
        internal ConversationalAnalysisAuthoringEvaluationJobResult()
        {
        }

        /// <summary> Represents the options used running the evaluation. </summary>
        public ConversationalAnalysisAuthoringEvaluationOptions EvaluationOptions { get; }
