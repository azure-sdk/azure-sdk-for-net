...
namespace Azure.AI.Language.Conversations.Authoring.Samples
{
    public partial class Samples_ConversationAuthoringDeploymentResources
    {
        ...
        public void Example_AnalyzeConversationAuthoringDeploymentResourcesJobState_GetAssignDeploymentResourcesStatus_ShortVersion()
        {
            ...
            ConversationAuthoringDeploymentResources client = new AuthoringClient(endpoint, credential).GetConversationAuthoringDeploymentResourcesClient(apiVersion: "2024-11-15-preview");
