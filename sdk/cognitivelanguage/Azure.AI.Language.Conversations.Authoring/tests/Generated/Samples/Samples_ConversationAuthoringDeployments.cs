...
namespace Azure.AI.Language.Conversations.Authoring.Samples
{
    public partial class Samples_ConversationAuthoringDeployments
    {
        ...
        public void Example_AnalyzeConversationAuthoringProjectDeployment_GetDeployment_ShortVersion()
        {
            ...
            ConversationAuthoringDeployments client = new AuthoringClient(endpoint, credential).GetConversationAuthoringDeploymentsClient(apiVersion: "2024-11-15-preview");
