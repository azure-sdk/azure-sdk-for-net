...
namespace Azure.AI.Language.Conversations.Authoring.Samples
{
    public partial class Samples_ConversationAuthoringExportedModels
    {
        ...
        public void Example_AnalyzeConversationAuthoringExportedTrainedModel_GetExportedModel_ShortVersion()
        {
            ...
            ConversationAuthoringExportedModels client = new AuthoringClient(endpoint, credential).GetConversationAuthoringExportedModelsClient(apiVersion: "2024-11-15-preview");
