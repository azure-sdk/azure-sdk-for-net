...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class ProjectMetadata
    {
        ...
        internal ProjectMetadata(DateTimeOffset createdOn, DateTimeOffset lastModifiedOn, DateTimeOffset? lastTrainedOn, DateTimeOffset? lastDeployedOn, AnalyzeConversationAuthoringProjectKind projectKind, AnalyzeConversationAuthoringProjectSettings settings, string storageInputContainerName, string projectName, bool? multilingual, string description, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedOn = createdOn;
            LastModifiedOn = lastModifiedOn;
        ...
        public AnalyzeConversationAuthoringProjectSettings Settings { get; }
