...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class CreateProjectDetails
    {
        ...
        internal CreateProjectDetails(AnalyzeConversationAuthoringProjectKind projectKind, AnalyzeConversationAuthoringProjectSettings settings, string storageInputContainerName, string projectName, bool? multilingual, string description, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            Settings = settings;
        ...
        public AnalyzeConversationAuthoringProjectSettings Settings { get; set; }
