...
namespace Azure.Health.Insights.PatientTimeline
{
    ...
    public partial class PatientTimelinePatientResult
    {
        ...
        internal PatientTimelinePatientResult(string patientId, IEnumerable<FhirR4Extendible> inferences)
        {
        ...
        internal PatientTimelinePatientResult(string patientId, IReadOnlyList<FhirR4Extendible> inferences, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PatientId = patientId;
