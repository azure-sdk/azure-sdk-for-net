...
namespace Azure.Health.Insights.PatientTimeline
{
    ...
    public partial class Range : Element
    {
        ...
        internal Range(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, Quantity low, Quantity high) : base(id, extension, serializedAdditionalRawData)
        {
            Low = low;
            High = high;
        }
