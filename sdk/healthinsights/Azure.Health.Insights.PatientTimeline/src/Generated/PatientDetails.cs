...
namespace Azure.Health.Insights.PatientTimeline
{
    ...
    public partial class PatientDetails
    {
        ...
        internal PatientDetails(PatientDetailsSex? sex, DateTimeOffset? birthDate, IList<FhirR4Resource> clinicalInfo, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sex = sex;
            BirthDate = birthDate;
        ...
        public PatientDetailsSex? Sex { get; set; }
