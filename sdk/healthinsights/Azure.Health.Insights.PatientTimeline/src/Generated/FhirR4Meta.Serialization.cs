...
namespace Azure.Health.Insights.PatientTimeline
{
    public partial class FhirR4Meta : IUtf8JsonSerializable, IJsonModel<FhirR4Meta>
    {
        ...
        void IJsonModel<FhirR4Meta>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FhirR4Meta)} does not support '{format}' format.");
            }
        ...
        internal static FhirR4Meta DeserializeFhirR4Meta(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IList<FhirR4Coding>> security = default;
            Optional<IList<FhirR4Coding>> tag = default;
            ...
            return new FhirR4Meta(versionId.Value, lastUpdated.Value, source.Value, Optional.ToList(profile), Optional.ToList(security), Optional.ToList(tag), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<FhirR4Meta>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FhirR4Meta)} does not support '{options.Format}' format.");
            }
        }
