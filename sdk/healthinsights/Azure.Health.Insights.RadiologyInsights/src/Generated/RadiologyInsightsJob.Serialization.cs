...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiologyInsightsJob>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RadiologyInsightsJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobData))
            {
                ...
                writer.WriteObjectValue<RadiologyInsightsData>(JobData, options);
            }
            if (options.Format != "W" && Optional.IsDefined(Result))
            {
                writer.WritePropertyName("result"u8);
                writer.WriteObjectValue<RadiologyInsightsInferenceResult>(Result, options);
            }
            if (options.Format != "W")
            {
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<RadiologyInsightsJob>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
