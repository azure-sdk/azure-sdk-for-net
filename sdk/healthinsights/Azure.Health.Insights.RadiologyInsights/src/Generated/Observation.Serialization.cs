...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Observation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<Observation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Observation)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Observation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Observation)} does not support '{options.Format}' format.");
            }
        }
