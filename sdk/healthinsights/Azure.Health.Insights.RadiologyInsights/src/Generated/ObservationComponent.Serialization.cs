...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ObservationComponent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ObservationComponent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ObservationComponent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ObservationComponent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ObservationComponent)} does not support '{options.Format}' format.");
            }
        }
