...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class Narrative : Element
    {
        ...
        /// <param name="status"> generated, extensions, additional, empty. </param>
        /// <param name="div"> xhtml. </param>
        internal Narrative(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, string status, string div) : base(id, extension, serializedAdditionalRawData)
        {
            Status = status;
            Div = div;
        }

        /// <summary> Initializes a new instance of <see cref="Narrative"/> for deserialization. </summary>
        internal Narrative()
        {
        }
