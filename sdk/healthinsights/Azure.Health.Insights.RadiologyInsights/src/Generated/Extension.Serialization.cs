...
namespace Azure.Health.Insights.RadiologyInsights
{
    public partial class Extension : IUtf8JsonSerializable, IJsonModel<Extension>
    {
        ...
        void IJsonModel<Extension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RadiologyInsights.Extension)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Extension>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RadiologyInsights.Extension)} does not support '{options.Format}' format.");
            }
        }
