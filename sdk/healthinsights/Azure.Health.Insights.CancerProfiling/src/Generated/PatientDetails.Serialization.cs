...
namespace Azure.Health.Insights.CancerProfiling
{
    public partial class PatientDetails : IUtf8JsonSerializable, IJsonModel<PatientDetails>
    {
        ...
        internal static PatientDetails DeserializePatientDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<PatientDetailsSex> sex = default;
            Optional<DateTimeOffset> birthDate = default;
            Optional<IList<FhirR4Resource>> clinicalInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sex"u8))
                {
                    ...
                    sex = new PatientDetailsSex(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("clinicalInfo"u8))
                {
                    ...
                    {
                        array.Add(FhirR4Resource.DeserializeFhirR4Resource(item));
                    }
                    clinicalInfo = array;
                    continue;
                }
            ...
            return new PatientDetails(Optional.ToNullable(sex), Optional.ToNullable(birthDate), Optional.ToList(clinicalInfo), serializedAdditionalRawData);
        }
