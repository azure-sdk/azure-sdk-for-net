...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4ContactDetail>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FhirR4ContactDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FhirR4ContactDetail)} does not support '{format}' format.");
            }
        ...
        internal static FhirR4ContactDetail DeserializeFhirR4ContactDetail(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IList<FhirR4ContactPoint>> telecom = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("telecom"u8))
                {
                    ...
                    {
                        array.Add(FhirR4ContactPoint.DeserializeFhirR4ContactPoint(item));
                    }
                    telecom = array;
                    continue;
                }
            ...
            return new FhirR4ContactDetail(id.Value, Optional.ToList(extension), serializedAdditionalRawData, name.Value, Optional.ToList(telecom));
        }
        ...
        BinaryData IPersistableModel<FhirR4ContactDetail>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FhirR4ContactDetail)} does not support '{options.Format}' format.");
            }
        }
