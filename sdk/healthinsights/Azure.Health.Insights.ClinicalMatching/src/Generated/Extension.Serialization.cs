...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class Extension : IUtf8JsonSerializable, IJsonModel<Extension>
    {
        ...
        void IJsonModel<Extension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClinicalMatching.Extension)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Extension>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClinicalMatching.Extension)} does not support '{options.Format}' format.");
            }
        }
