...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class ContactPoint
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ContactPoint"/>. </summary>
        public ContactPoint()
        {
        }
        ...
        internal ContactPoint(ContactPointSystem? system, string value, ContactPointUse? use, int? rank, Period period, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            System = system;
            Value = value;
            Use = use;
