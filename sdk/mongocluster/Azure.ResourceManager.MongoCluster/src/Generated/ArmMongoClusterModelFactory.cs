...
namespace Azure.ResourceManager.MongoCluster.Models
{
    ...
    public static partial class ArmMongoClusterModelFactory
    {
        ...
        public static ConnectionString ConnectionString(string uri = null, string description = null, string name = null)
        {
            return new ConnectionString(uri, description, name, serializedAdditionalRawData: null);
        }
