...
namespace Azure.ResourceManager.MongoCluster.Samples
{
    public partial class Sample_MongoClusterResource
    {
        ...
        // Disables public network access on a Mongo Cluster resource with a private endpoint connection with Data API.
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Update_DisablesPublicNetworkAccessOnAMongoClusterResourceWithAPrivateEndpointConnectionWithDataAPI()
        {
