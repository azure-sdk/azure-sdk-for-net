...
namespace Azure.AI.Vision.ImageAnalysis
{
    ...
    public partial class ImageAnalysisResult
    {
        ...
        internal ImageAnalysisResult(ImageMetadataApiModel metadata, string modelVersion)
        {
        ...
        internal ImageAnalysisResult(AdultResult adultResult, CaptionResult captionResult, ImagePredictionResult customModelResult, DenseCaptionsResult denseCaptionsResult, ImageMetadataApiModel metadata, string modelVersion, ObjectsResult objectsResult, PeopleResult peopleResult, ReadResult readResult, SmartCropsResult smartCropsResult, TagsResult tagsResult)
        {
        ...
        /// <summary> An AdultResult for the immage. </summary>
        public AdultResult AdultResult { get; }
        ...
        public ImagePredictionResult CustomModelResult { get; }
        ...
        public ImageMetadataApiModel Metadata { get; }
        /// <summary> The model used for the analysis. </summary>
