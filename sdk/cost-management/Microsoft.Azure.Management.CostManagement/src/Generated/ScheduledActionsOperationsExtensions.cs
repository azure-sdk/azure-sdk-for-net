...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    public static partial class ScheduledActionsOperationsExtensions
    {
            ...
            /// </param>
            /// <param name='ifMatch'>
            /// ETag of the Entity. Not required when creating an entity. Optional when
            /// updating an entity and can be specified to achieve optimistic concurrency.
            /// </param>
            public static ScheduledAction CreateOrUpdate(this IScheduledActionsOperations operations, string name, ScheduledAction scheduledAction, string ifMatch = default(string))
            {
                return operations.CreateOrUpdateAsync(name, scheduledAction, ifMatch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ScheduledAction> CreateOrUpdateAsync(this IScheduledActionsOperations operations, string name, ScheduledAction scheduledAction, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(name, scheduledAction, ifMatch, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// updating an entity and can be specified to achieve optimistic concurrency.
            /// </param>
            public static ScheduledAction CreateOrUpdateByScope(this IScheduledActionsOperations operations, string scope, string name, ScheduledAction scheduledAction, string ifMatch = default(string))
            {
                return operations.CreateOrUpdateByScopeAsync(scope, name, scheduledAction, ifMatch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ScheduledAction> CreateOrUpdateByScopeAsync(this IScheduledActionsOperations operations, string scope, string name, ScheduledAction scheduledAction, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateByScopeWithHttpMessagesAsync(scope, name, scheduledAction, ifMatch, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
