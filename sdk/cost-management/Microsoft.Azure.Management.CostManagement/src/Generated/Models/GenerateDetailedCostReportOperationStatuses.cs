...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class GenerateDetailedCostReportOperationStatuses
    {
        ...
        /// report.</param>
        public GenerateDetailedCostReportOperationStatuses(string id = default(string), string name = default(string), Status status = default(Status), string startTime = default(string), string endTime = default(string), string type = default(string), ErrorDetails error = default(ErrorDetails), System.DateTime? expiryTime = default(System.DateTime?), System.DateTime? validTill = default(System.DateTime?), string downloadUrl = default(string))
        {
            Id = id;
            Name = name;
            Status = status;
