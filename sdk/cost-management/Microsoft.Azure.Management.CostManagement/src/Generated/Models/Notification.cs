...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class Notification
    {
        ...
        public Notification(bool enabled, string operatorProperty, double threshold, IList<string> contactEmails, IList<string> contactRoles = default(IList<string>), IList<string> contactGroups = default(IList<string>), string thresholdType = default(string), string locale = default(string))
        {
            Enabled = enabled;
