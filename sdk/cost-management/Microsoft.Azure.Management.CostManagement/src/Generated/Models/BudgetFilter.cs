...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class BudgetFilter
    {
        ...
        ///
        /// Supported for CategoryType(s): Cost.</param>
        public BudgetFilter(IList<BudgetFilterProperties> and = default(IList<BudgetFilterProperties>), BudgetComparisonExpression dimensions = default(BudgetComparisonExpression), BudgetComparisonExpression tags = default(BudgetComparisonExpression))
        {
            And = and;
