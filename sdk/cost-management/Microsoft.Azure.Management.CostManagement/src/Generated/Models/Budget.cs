...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class Budget : CostManagementProxyResource
    {
        ...
        public Budget(double amount, string timeGrain, BudgetTimePeriod timePeriod, string id = default(string), string name = default(string), string type = default(string), string eTag = default(string), BudgetFilter filter = default(BudgetFilter), CurrentSpend currentSpend = default(CurrentSpend), IDictionary<string, Notification> notifications = default(IDictionary<string, Notification>), ForecastSpend forecastSpend = default(ForecastSpend))
