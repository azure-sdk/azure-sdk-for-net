...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonPostActionResponseForDeviceROCommands>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CommonPostActionResponseForDeviceROCommands>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonPostActionResponseForDeviceROCommands)} does not support '{format}' format.");
            }
        ...
        internal static CommonPostActionResponseForDeviceROCommands DeserializeCommonPostActionResponseForDeviceROCommands(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CommonPostActionResponseForDeviceROCommands(error.Value, serializedAdditionalRawData, Optional.ToNullable(configurationState), outputUrl.Value);
        }
        ...
        BinaryData IPersistableModel<CommonPostActionResponseForDeviceROCommands>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonPostActionResponseForDeviceROCommands)} does not support '{options.Format}' format.");
            }
        }
