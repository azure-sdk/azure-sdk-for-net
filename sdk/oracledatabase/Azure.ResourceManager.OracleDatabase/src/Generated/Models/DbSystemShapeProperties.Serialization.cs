...
{
    public partial class DbSystemShapeProperties : IUtf8JsonSerializable, IJsonModel<DbSystemShapeProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DbSystemShapeProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<DbSystemShapeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DbSystemShapeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DbSystemShapeProperties)} does not support writing '{format}' format.");
            }
        ...
        DbSystemShapeProperties IJsonModel<DbSystemShapeProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DbSystemShapeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DbSystemShapeProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeDbSystemShapeProperties(document.RootElement, options);
        }

        internal static DbSystemShapeProperties DeserializeDbSystemShapeProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<DbSystemShapeProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DbSystemShapeProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DbSystemShapeProperties)} does not support writing '{options.Format}' format.");
            }
        }

        DbSystemShapeProperties IPersistableModel<DbSystemShapeProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DbSystemShapeProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DbSystemShapeProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<DbSystemShapeProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
