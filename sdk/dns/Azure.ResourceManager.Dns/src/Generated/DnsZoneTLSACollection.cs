...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsZoneTLSACollection : ArmCollection, IEnumerable<DnsZoneTLSAResource>, IAsyncEnumerable<DnsZoneTLSAResource>
    {
        ...
        public virtual AsyncPageable<DnsZoneTLSAResource> GetAllAsync(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DnsZoneTLSAResource(Client, DnsRecordData.DeserializeDnsRecordData(e)), _dnsZoneTlsDnsARecordInfoSetsClientDiagnostics, Pipeline, "DnsZoneTLSACollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DnsZoneTLSAResource> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _dnsZoneTlsDnsARecordInfoSetsRestClient.CreateListByTypeRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "TLSA".ToDnsRecordType(), top, recordsetnamesuffix);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _dnsZoneTlsDnsARecordInfoSetsRestClient.CreateListByTypeNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "TLSA".ToDnsRecordType(), top, recordsetnamesuffix);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DnsZoneTLSAResource(Client, DnsRecordData.DeserializeDnsRecordData(e)), _dnsZoneTlsDnsARecordInfoSetsClientDiagnostics, Pipeline, "DnsZoneTLSACollection.GetAll", "value", "nextLink", cancellationToken);
        }
