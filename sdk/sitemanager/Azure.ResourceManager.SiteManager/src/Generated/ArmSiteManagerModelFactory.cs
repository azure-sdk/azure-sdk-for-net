...
namespace Azure.ResourceManager.SiteManager.Models
{
    ...
    public static partial class ArmSiteManagerModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ArmResourceUpdatedResponseSite"/>. </summary>
        /// <param name="body"> The body type of the operation request or response. </param>
        /// <returns> A new <see cref="Models.ArmResourceUpdatedResponseSite"/> instance for mocking. </returns>
        public static ArmResourceUpdatedResponseSite ArmResourceUpdatedResponseSite(SiteData body = null)
        {
            return new ArmResourceUpdatedResponseSite(body, serializedAdditionalRawData: null);
        }
    }
}
