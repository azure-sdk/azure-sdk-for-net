...
namespace Azure.ResourceManager.SiteManager
{
    ...
    public static partial class SiteManagerExtensions
    {
        ...
        public static async Task<ArmOperation<ArmResourceUpdatedResponseSite>> CreateOrUpdateSitesByServiceGroupAsync(this TenantResource tenantResource, WaitUntil waitUntil, string servicegroupName, string siteName, SiteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tenantResource, nameof(tenantResource));
        ...
        /// <exception cref="ArgumentException"> <paramref name="servicegroupName"/> or <paramref name="siteName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantResource"/>, <paramref name="servicegroupName"/>, <paramref name="siteName"/> or <paramref name="data"/> is null. </exception>
        public static ArmOperation<ArmResourceUpdatedResponseSite> CreateOrUpdateSitesByServiceGroup(this TenantResource tenantResource, WaitUntil waitUntil, string servicegroupName, string siteName, SiteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tenantResource, nameof(tenantResource));
