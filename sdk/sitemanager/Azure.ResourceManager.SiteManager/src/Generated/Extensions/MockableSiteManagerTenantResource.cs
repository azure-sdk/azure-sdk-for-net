...
namespace Azure.ResourceManager.SiteManager.Mocking
{
    ...
    public partial class MockableSiteManagerTenantResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ArmResourceUpdatedResponseSite>> CreateOrUpdateSitesByServiceGroupAsync(WaitUntil waitUntil, string servicegroupName, string siteName, SiteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(servicegroupName, nameof(servicegroupName));
            Argument.AssertNotNullOrEmpty(siteName, nameof(siteName));
            ...
            try
            {
                ...
                var operation = new SiteManagerArmOperation<ArmResourceUpdatedResponseSite>(new ArmResourceUpdatedResponseSiteOperationSource(), SitesByServiceGroupClientDiagnostics, Pipeline, SitesByServiceGroupRestClient.CreateCreateOrUpdateRequest(servicegroupName, siteName, data).Request, response, OperationFinalStateVia.OriginalUri);
        ...
        /// <exception cref="ArgumentException"> <paramref name="servicegroupName"/> or <paramref name="siteName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="servicegroupName"/>, <paramref name="siteName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ArmResourceUpdatedResponseSite> CreateOrUpdateSitesByServiceGroup(WaitUntil waitUntil, string servicegroupName, string siteName, SiteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(servicegroupName, nameof(servicegroupName));
            Argument.AssertNotNullOrEmpty(siteName, nameof(siteName));
            Argument.AssertNotNull(data, nameof(data));
