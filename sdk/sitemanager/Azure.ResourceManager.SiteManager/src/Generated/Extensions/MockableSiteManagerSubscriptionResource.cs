...
namespace Azure.ResourceManager.SiteManager.Mocking
{
    ...
    public partial class MockableSiteManagerSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of SubscriptionSiteResources in the SubscriptionResource. </summary>
        ...
        public virtual SubscriptionSiteCollection GetSubscriptionSites()
        {
            return GetCachedClient(client => new SubscriptionSiteCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<SubscriptionSiteResource>> GetSubscriptionSiteAsync(string siteName, CancellationToken cancellationToken = default)
        {
            return await GetSubscriptionSites().GetAsync(siteName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="siteName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<SubscriptionSiteResource> GetSubscriptionSite(string siteName, CancellationToken cancellationToken = default)
        {
            return GetSubscriptionSites().Get(siteName, cancellationToken);
        }
    }
}
