...
namespace Azure.ResourceManager.Edge
{
    ...
    public partial class UpdateResource : ArmResource
    {
        ...
        {
            _updateClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Edge", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EdgeArmOperation(response);
