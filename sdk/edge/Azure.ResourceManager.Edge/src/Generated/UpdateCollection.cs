...
namespace Azure.ResourceManager.Edge
{
    ...
    /// Each <see cref="UpdateResource" /> in the collection will belong to the same instance of <see cref="ArmResource" />.
    /// To get an <see cref="UpdateCollection" /> instance call the GetUpdates method from an instance of <see cref="ArmResource" />.
    /// </summary>
    public partial class UpdateCollection : ArmCollection, IEnumerable<UpdateResource>, IAsyncEnumerable<UpdateResource>
    {
        ...
        {
            _updateClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Edge", UpdateResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<UpdateResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string updateName, UpdateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _updateRestClient.CreateOrModifyAsync(Id, updateName, data, cancellationToken).ConfigureAwait(false);
                var operation = new EdgeArmOperation<UpdateResource>(new UpdateOperationSource(Client), _updateClientDiagnostics, Pipeline, _updateRestClient.CreateCreateOrModifyRequest(Id, updateName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<UpdateResource> CreateOrUpdate(WaitUntil waitUntil, string updateName, UpdateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _updateRestClient.CreateOrModify(Id, updateName, data, cancellationToken);
                var operation = new EdgeArmOperation<UpdateResource>(new UpdateOperationSource(Client), _updateClientDiagnostics, Pipeline, _updateRestClient.CreateCreateOrModifyRequest(Id, updateName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<UpdateResource>> GetAsync(string updateName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _updateRestClient.GetAsync(Id, updateName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<UpdateResource> Get(string updateName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _updateRestClient.Get(Id, updateName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new UpdateResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _updateRestClient.CreateListRequest(Id);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _updateRestClient.CreateListNextPageRequest(nextLink, Id);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string updateName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _updateRestClient.GetAsync(Id, updateName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string updateName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _updateRestClient.Get(Id, updateName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
