...
namespace Azure.ResourceManager.ManagedOps.Models
{
    ...
    public partial class AzureMonitorInformation
    {
        ...
        internal AzureMonitorInformation(ResourceIdentifier dcrId, EnablementStatus enablementStatus)
        {
            DcrId = dcrId;
        ...
        internal AzureMonitorInformation(ResourceIdentifier dcrId, EnablementStatus enablementStatus, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DcrId = dcrId;
            EnablementStatus = enablementStatus;
