...
namespace Azure.ResourceManager._ManagedOps
{
    ...
    public partial class ManagedOpData : ResourceData, IJsonModel<ManagedOpData>
    {
        ...
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeManagedOpData(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(ManagedOpData)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal static ManagedOpData FromResponse(Response response)
        {
            ...
            return DeserializeManagedOpData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<ManagedOpData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedOpData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ManagedOpData IJsonModel<ManagedOpData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ManagedOpData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedOpData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ManagedOpData DeserializeManagedOpData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ManagedOpsProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ManagedOpsProperties.DeserializeManagedOpsProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
