...
{
    public partial class Sample_EHNamespaceCollection
    {
        ...
        public async Task GetAll_NamespaceListByResourceGroup()
        {
            ...
            // get the collection of this EHNamespaceResource
            EHNamespaceCollection collection = resourceGroupResource.GetEHNamespaces();

            // invoke the operation and iterate over the result
            await foreach (EHNamespaceResource item in collection.GetAllAsync())
            {
...
UserAssignedIdentity = "/subscriptions/SampleSubscription/resourceGroups/ResurceGroupSample/providers/Microsoft.ManagedIdentity/userAssignedIdentities/ud1",
            ...
            ArmOperation<EHNamespaceResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, namespaceName, data);
            EHNamespaceResource result = lro.Value;
        ...
        public async Task Get_NameSpaceGet()
        {
            ...
            // invoke the operation
            string namespaceName = "NamespaceSample";
            EHNamespaceResource result = await collection.GetAsync(namespaceName);
        ...
        public async Task GetIfExists_NameSpaceGet()
        {
            ...
            // invoke the operation
            string namespaceName = "NamespaceSample";
            NullableResponse<EHNamespaceResource> response = await collection.GetIfExistsAsync(namespaceName);
            EHNamespaceResource result = response.HasValue ? response.Value : null;
