...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public readonly partial struct Type : IEquatable<Type>
    {
        ...
        private const string MetadataReplicationValue = "MetadataReplication";

        /// <summary> MetadataReplication. </summary>
        public static Type MetadataReplication { get; } = new Type(MetadataReplicationValue);
