...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class KeyVaultProperties
    {
        ...
        internal KeyVaultProperties(string keyName, Uri keyVaultUri, string keyVersion, UserAssignedIdentityProperties identity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
