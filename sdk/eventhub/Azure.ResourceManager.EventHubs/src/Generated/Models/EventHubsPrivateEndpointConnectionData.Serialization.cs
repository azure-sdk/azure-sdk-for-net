...
namespace Azure.ResourceManager.EventHubs
{
    public partial class EventHubsPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static EventHubsPrivateEndpointConnectionData DeserializeEventHubsPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new EventHubsPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToList(groupId), Optional.ToNullable(provisioningState), Optional.ToNullable(location));
        }
    }
}
