...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class ClusterSku
    {
        ...
        internal ClusterSku(ClusterSkuName name, int? capacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Capacity = capacity;
        ...
        /// <summary> Initializes a new instance of <see cref="ClusterSku"/> for deserialization. </summary>
        internal ClusterSku()
        {
        }
