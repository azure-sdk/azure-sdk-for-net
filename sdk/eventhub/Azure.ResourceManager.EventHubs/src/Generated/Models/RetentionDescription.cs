...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class RetentionDescription
    {
        ...
        /// <param name="retentionTimeInHours"> Number of hours to retain the events for this Event Hub. If cleanupPolicy is Compact the returned value of this property is Long.MaxValue. </param>
        /// <param name="minCompactionLagInMins"> The minimum time a message will remain ineligible for compaction in the log. Only applicable for logs that are being compacted. </param>
        ...
        internal RetentionDescription(CleanupPolicyRetentionDescription? cleanupPolicy, long? retentionTimeInHours, long? minCompactionLagInMins, int? tombstoneRetentionTimeInHours, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Number of hours to retain the events for this Event Hub. If cleanupPolicy is Compact the returned value of this property is Long.MaxValue. </summary>
        public long? RetentionTimeInHours { get; set; }
        /// <summary> The minimum time a message will remain ineligible for compaction in the log. Only applicable for logs that are being compacted. </summary>
        public long? MinCompactionLagInMins { get; set; }
