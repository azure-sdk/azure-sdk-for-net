...
{
    public partial class NetworkRuleSetData : IUtf8JsonSerializable, IJsonModel<NetworkRuleSetData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkRuleSetData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<NetworkRuleSetData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkRuleSetData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkRuleSetData)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(VirtualNetworkRules))
            {
                ...
                {
                    writer.WriteObjectValue<NWRuleSetVirtualNetworkRules>(item, options);
                }
            ...
            if (Optional.IsCollectionDefined(IPRules))
            {
                ...
                {
                    writer.WriteObjectValue<NWRuleSetIPRules>(item, options);
                }
                writer.WriteEndArray();
            }
        ...
        NetworkRuleSetData IJsonModel<NetworkRuleSetData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkRuleSetData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkRuleSetData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeNetworkRuleSetData(document.RootElement, options);
        }

        internal static NetworkRuleSetData DeserializeNetworkRuleSetData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            PublicNetworkAccessFlag? publicNetworkAccess = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("virtualNetworkRules"u8))
                        {
                            ...
                            {
                                array.Add(NWRuleSetVirtualNetworkRules.DeserializeNWRuleSetVirtualNetworkRules(item, options));
                            }
                        ...
                        if (property0.NameEquals("ipRules"u8))
                        {
                            ...
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(NWRuleSetIPRules.DeserializeNWRuleSetIPRules(item, options));
                            }
                            ipRules = array;
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TrustedServiceAccessEnabled) || hasPropertyOverride)
            {
        ...
        BinaryData IPersistableModel<NetworkRuleSetData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkRuleSetData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkRuleSetData)} does not support writing '{options.Format}' format.");
            }
        }

        NetworkRuleSetData IPersistableModel<NetworkRuleSetData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkRuleSetData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkRuleSetData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<NetworkRuleSetData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
