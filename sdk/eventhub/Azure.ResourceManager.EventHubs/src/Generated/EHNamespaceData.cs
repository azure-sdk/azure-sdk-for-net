...
{
    /// <summary>
    /// A class representing the EHNamespace data model.
    /// Single Namespace item in List or Get Operation
    /// </summary>
    public partial class EHNamespaceData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="EHNamespaceData"/>. </summary>
        /// <param name="location"> The location. </param>
        public EHNamespaceData(AzureLocation location) : base(location)
        {
        ...
        internal EHNamespaceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, EventHubsSku sku, ManagedServiceIdentity identity, EventHubsTlsVersion? minimumTlsVersion, string provisioningState, string status, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string serviceBusEndpoint, string clusterArmId, string metricId, bool? isAutoInflateEnabled, EventHubsPublicNetworkAccess? publicNetworkAccess, int? maximumThroughputUnits, bool? kafkaEnabled, bool? zoneRedundant, Encryption encryption, IList<EventHubsPrivateEndpointConnectionData> privateEndpointConnections, bool? disableLocalAuth, string alternateName, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Sku = sku;
            Identity = identity;
        ...
        /// <summary> Initializes a new instance of <see cref="EHNamespaceData"/> for deserialization. </summary>
        internal EHNamespaceData()
        {
        }
