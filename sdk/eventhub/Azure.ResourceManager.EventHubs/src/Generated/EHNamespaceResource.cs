...
{
    /// <summary>
    /// A Class representing an EHNamespace along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct an <see cref="EHNamespaceResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetEHNamespaceResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetEHNamespace method.
    /// </summary>
    public partial class EHNamespaceResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="EHNamespaceResource"/> instance. </summary>
        ...
        private readonly ClientDiagnostics _ehNamespaceNamespacesClientDiagnostics;
        private readonly NamespacesRestOperations _ehNamespaceNamespacesRestClient;
        ...
        /// <summary> Initializes a new instance of the <see cref="EHNamespaceResource"/> class for mocking. </summary>
        protected EHNamespaceResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EHNamespaceResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal EHNamespaceResource(ArmClient client, EHNamespaceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal EHNamespaceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _ehNamespaceNamespacesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventHubs", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string ehNamespaceNamespacesApiVersion);
            _ehNamespaceNamespacesRestClient = new NamespacesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, ehNamespaceNamespacesApiVersion);
        ...
        /// <summary> Gets an object representing a NetworkRuleSetResource along with the instance operations that can be performed on it in the EHNamespace. </summary>
        /// <returns> Returns a <see cref="NetworkRuleSetResource"/> object. </returns>
        public virtual NetworkRuleSetResource GetNetworkRuleSet()
        {
            return new NetworkRuleSetResource(Client, Id.AppendChildResource("networkRuleSets", "default"));
        }

        /// <summary> Gets a collection of EventHubsNamespaceAuthorizationRuleResources in the EHNamespace. </summary>
        ...
        /// <summary> Gets a collection of EventHubsPrivateEndpointConnectionResources in the EHNamespace. </summary>
        ...
        /// <summary> Gets a collection of EventHubsDisasterRecoveryResources in the EHNamespace. </summary>
        ...
        /// <summary> Gets a collection of EventHubResources in the EHNamespace. </summary>
        ...
        /// <summary> Gets a collection of EventHubsSchemaGroupResources in the EHNamespace. </summary>
        ...
        /// <summary> Gets a collection of EventHubsApplicationGroupResources in the EHNamespace. </summary>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<EHNamespaceResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _ehNamespaceNamespacesClientDiagnostics.CreateScope("EHNamespaceResource.Get");
            scope.Start();
            try
            {
                var response = await _ehNamespaceNamespacesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new EHNamespaceResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<EHNamespaceResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _ehNamespaceNamespacesClientDiagnostics.CreateScope("EHNamespaceResource.Get");
            scope.Start();
            try
            {
                var response = _ehNamespaceNamespacesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new EHNamespaceResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _ehNamespaceNamespacesClientDiagnostics.CreateScope("EHNamespaceResource.Delete");
            scope.Start();
            try
            {
                var response = await _ehNamespaceNamespacesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new EventHubsArmOperation(_ehNamespaceNamespacesClientDiagnostics, Pipeline, _ehNamespaceNamespacesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _ehNamespaceNamespacesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new EventHubsArmOperation(_ehNamespaceNamespacesClientDiagnostics, Pipeline, _ehNamespaceNamespacesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<EHNamespaceResource>> UpdateAsync(EHNamespaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _ehNamespaceNamespacesClientDiagnostics.CreateScope("EHNamespaceResource.Update");
            scope.Start();
            try
            {
                var response = await _ehNamespaceNamespacesRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new EHNamespaceResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<EHNamespaceResource> Update(EHNamespaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _ehNamespaceNamespacesRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken);
                return Response.FromValue(new EHNamespaceResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<EventHubsPrivateLinkResource> GetPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, EventHubsPrivateLinkResource.DeserializeEventHubsPrivateLinkResource, _privateLinkResourcesClientDiagnostics, Pipeline, "EHNamespaceResource.GetPrivateLinkResources", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _privateLinkResourcesRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, EventHubsPrivateLinkResource.DeserializeEventHubsPrivateLinkResource, _privateLinkResourcesClientDiagnostics, Pipeline, "EHNamespaceResource.GetPrivateLinkResources", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<EventHubsNetworkSecurityPerimeterConfiguration> GetNetworkSecurityPerimeterConfigurationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, EventHubsNetworkSecurityPerimeterConfiguration.DeserializeEventHubsNetworkSecurityPerimeterConfiguration, _networkSecurityPerimeterConfigurationClientDiagnostics, Pipeline, "EHNamespaceResource.GetNetworkSecurityPerimeterConfigurations", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _networkSecurityPerimeterConfigurationRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, EventHubsNetworkSecurityPerimeterConfiguration.DeserializeEventHubsNetworkSecurityPerimeterConfiguration, _networkSecurityPerimeterConfigurationClientDiagnostics, Pipeline, "EHNamespaceResource.GetNetworkSecurityPerimeterConfigurations", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> CreateOrUpdateNetworkSecurityPerimeterConfigurationAsync(WaitUntil waitUntil, string resourceAssociationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _networkSecurityPerimeterConfigurationsClientDiagnostics.CreateScope("EHNamespaceResource.CreateOrUpdateNetworkSecurityPerimeterConfiguration");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<EHNamespaceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));

            using var scope = _ehNamespaceNamespacesClientDiagnostics.CreateScope("EHNamespaceResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _ehNamespaceNamespacesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new EHNamespaceResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new EHNamespaceData(current.Location);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<EHNamespaceResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _ehNamespaceNamespacesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new EHNamespaceResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<EHNamespaceResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));

            using var scope = _ehNamespaceNamespacesClientDiagnostics.CreateScope("EHNamespaceResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<EHNamespaceResource> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));
        ...
        public virtual async Task<Response<EHNamespaceResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));

            using var scope = _ehNamespaceNamespacesClientDiagnostics.CreateScope("EHNamespaceResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<EHNamespaceResource> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
