...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class ClusterData : TrackedResourceData
    {
        ...
        internal ClusterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ClusterSku sku, string createdAt, ProvisioningState? provisioningState, string updatedAt, string metricId, string status, bool? supportsScaling, UpgradePreferences upgradePreferences, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Sku = sku;
            CreatedAt = createdAt;
        ...
        [WirePath("properties.upgradePreferences")]
