...
namespace Azure.ResourceManager.EventHubs
{
    public partial class EHNamespaceData : IUtf8JsonSerializable, IJsonModel<EHNamespaceData>
    {
        ...
        void IJsonModel<EHNamespaceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EHNamespaceData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EHNamespaceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EHNamespaceData)} does not support '{options.Format}' format.");
            }
        }
