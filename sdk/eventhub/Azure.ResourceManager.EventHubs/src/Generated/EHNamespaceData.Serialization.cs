...
{
    public partial class EHNamespaceData : IUtf8JsonSerializable, IJsonModel<EHNamespaceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EHNamespaceData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<EHNamespaceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EHNamespaceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EHNamespaceData)} does not support writing '{format}' format.");
            }
        ...
        EHNamespaceData IJsonModel<EHNamespaceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EHNamespaceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EHNamespaceData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeEHNamespaceData(document.RootElement, options);
        }

        internal static EHNamespaceData DeserializeEHNamespaceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<EHNamespaceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EHNamespaceData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EHNamespaceData)} does not support writing '{options.Format}' format.");
            }
        }

        EHNamespaceData IPersistableModel<EHNamespaceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EHNamespaceData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EHNamespaceData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<EHNamespaceData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
