...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class ClusterResource : ArmResource
    {
        ...
        {
            _clusterClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventHubs", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EventHubsArmOperation(_clusterClientDiagnostics, Pipeline, _clusterRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<ClusterResource>> UpdateAsync(WaitUntil waitUntil, ClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _clusterRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var operation = new EventHubsArmOperation<ClusterResource>(new ClusterOperationSource(Client), _clusterClientDiagnostics, Pipeline, _clusterRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<ClusterResource> Update(WaitUntil waitUntil, ClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _clusterRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken);
                var operation = new EventHubsArmOperation<ClusterResource>(new ClusterOperationSource(Client), _clusterClientDiagnostics, Pipeline, _clusterRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _clusterRestClient.CreateListNamespacesRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => JsonSerializer.Deserialize<SubResource>(e.GetRawText()), _clusterClientDiagnostics, Pipeline, "ClusterResource.GetNamespaces", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _clusterRestClient.CreateListNamespacesRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => JsonSerializer.Deserialize<SubResource>(e.GetRawText()), _clusterClientDiagnostics, Pipeline, "ClusterResource.GetNamespaces", "value", null, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/clusters/{clusterName}/triggerUpgrade</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Clusters_TriggerUpgradePost</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-01-01</description>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> TriggerUpgradePostAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clusterClientDiagnostics.CreateScope("ClusterResource.TriggerUpgradePost");
            scope.Start();
            try
            {
                var response = await _clusterRestClient.TriggerUpgradePostAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response TriggerUpgradePost(CancellationToken cancellationToken = default)
        {
            using var scope = _clusterClientDiagnostics.CreateScope("ClusterResource.TriggerUpgradePost");
            scope.Start();
            try
            {
                var response = _clusterRestClient.TriggerUpgradePost(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<ClusterQuotaConfigurationProperties>> PatchConfigurationAsync(ClusterQuotaConfigurationProperties clusterQuotaConfigurationProperties, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _configurationClientDiagnostics.CreateScope("ClusterResource.PatchConfiguration");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _configurationClientDiagnostics.CreateScope("ClusterResource.GetConfiguration");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ClusterResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new ClusterData(current.Location);
