    ...
    public partial class ClusterData : IUtf8JsonSerializable, IJsonModel<ClusterData>
    {
        ...
        void IJsonModel<ClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Sku))
            {
                ...
                writer.WriteObjectValue<ClusterSku>(Sku, options);
            }
            ...
            if (Optional.IsDefined(UpgradePreferences))
            {
                ...
                writer.WriteObjectValue<UpgradePreferences>(UpgradePreferences, options);
            }
            writer.WriteEndObject();
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(CreatedAt), out propertyOverride);
            if (Optional.IsDefined(CreatedAt) || hasPropertyOverride)
            {
                ...
                {
                    if (CreatedAt.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{CreatedAt}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{CreatedAt}'");
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(UpdatedAt), out propertyOverride);
            if (Optional.IsDefined(UpdatedAt) || hasPropertyOverride)
            {
                ...
                {
                    if (UpdatedAt.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(UpgradePreferences), out propertyOverride);
            if (Optional.IsDefined(UpgradePreferences) || hasPropertyOverride)
            {
                builder.Append("    upgradePreferences: ");
                if (hasPropertyOverride)
                {
                    builder.AppendLine($"{propertyOverride}");
                }
                ...
                {
                    BicepSerializationHelpers.AppendChildObject(builder, UpgradePreferences, options, 4, false, "    upgradePreferences: ");
                }
            }
