...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class ClusterCollection : ArmCollection, IEnumerable<ClusterResource>, IAsyncEnumerable<ClusterResource>
    {
        ...
        {
            _clusterClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventHubs", ClusterResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ClusterResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string clusterName, ClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EventHubsArmOperation<ClusterResource>(new ClusterOperationSource(Client), _clusterClientDiagnostics, Pipeline, _clusterRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data).Request, response, OperationFinalStateVia.Location);
