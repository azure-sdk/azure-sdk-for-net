...
{
    public partial class CatalogCollection : IUtf8JsonSerializable, IJsonModel<CatalogCollection>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CatalogCollection>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CatalogCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CatalogCollection>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        CatalogCollection IJsonModel<CatalogCollection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CatalogCollection>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<CatalogCollection>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CatalogCollection>)this).GetFormatFromOptions(options) : options.Format;
        ...
        CatalogCollection IPersistableModel<CatalogCollection>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CatalogCollection>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<CatalogCollection>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
