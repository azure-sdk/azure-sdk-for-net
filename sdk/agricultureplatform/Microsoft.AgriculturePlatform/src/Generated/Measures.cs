...
namespace Microsoft.AgriculturePlatform
{
    ...
    public partial class Measures
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Measures"/>. </summary>
        internal Measures()
        {
        ...
        internal Measures(string unit, IReadOnlyList<double> value, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Unit = unit;
            Value = value;
