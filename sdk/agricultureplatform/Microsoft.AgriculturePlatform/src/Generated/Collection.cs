...
namespace Microsoft.AgriculturePlatform
{
    ...
    public partial class Collection
    {
        ...
        internal Collection(IList<Link> links, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string source, string name, string description, string createdBy, string modifiedBy, IDictionary<string, BinaryData> properties, string schemaId, string catalogId, string id, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Links = links;
            ETag = eTag;
            Status = status;
        ...
        /// <summary> Schema Foreign Key. </summary>
