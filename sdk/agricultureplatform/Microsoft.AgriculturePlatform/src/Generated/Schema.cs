...
namespace Microsoft.AgriculturePlatform
{
    ...
    public partial class Schema
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="schemaModel"/> is null. </exception>
        public Schema(IDictionary<string, BinaryData> schemaModel)
        {
            Argument.AssertNotNull(schemaModel, nameof(schemaModel));
        ...
        internal Schema(IList<Link> links, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string source, string name, string description, string createdBy, string modifiedBy, IDictionary<string, BinaryData> properties, IReadOnlyList<CatalogCollection> dependentCollections, IDictionary<string, BinaryData> schemaModel, string id, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Links = links;
            ETag = eTag;
            Status = status;
        ...
        /// <summary> Dependent Collections. </summary>
        public IReadOnlyList<CatalogCollection> DependentCollections { get; }
        /// <summary>
        /// Schema.
        /// <para>
        /// To assign an object to the value of this property use <see cref="BinaryData.FromObjectAsJson{T}(T, System.Text.Json.JsonSerializerOptions?)"/>.
        ...
        /// </para>
        /// </summary>
        public IDictionary<string, BinaryData> SchemaModel { get; }
        /// <summary> Id of the Schema. </summary>
