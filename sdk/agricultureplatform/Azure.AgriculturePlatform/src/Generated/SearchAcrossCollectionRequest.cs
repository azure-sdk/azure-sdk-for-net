...
{
    /// <summary> The SearchAcrossCollectionRequest. </summary>
    internal partial class SearchAcrossCollectionRequest
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SearchAcrossCollectionRequest"/>. </summary>
        internal SearchAcrossCollectionRequest()
        {
        ...
        internal SearchAcrossCollectionRequest(IReadOnlyList<string> ownerItemIds, IReadOnlyList<string> dataFilters, GeoJsonObject intersectsWithGeometry, IReadOnlyList<string> ids, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, IReadOnlyList<string> collectionIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
