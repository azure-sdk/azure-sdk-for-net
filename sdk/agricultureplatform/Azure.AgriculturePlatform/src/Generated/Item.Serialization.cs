...
{
    public partial class Item : IUtf8JsonSerializable, IJsonModel<Item>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Item>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<Item>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        Item IJsonModel<Item>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Item>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static Item DeserializeItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IDictionary<string, BinaryData> data = default;
            string ownerItemId = default;
            string catalogId = default;
            string collectionId = default;
            IList<Asset> assets = default;
            string id = default;
        ...
        BinaryData IPersistableModel<Item>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Item>)this).GetFormatFromOptions(options) : options.Format;
        ...
        Item IPersistableModel<Item>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Item>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static Item FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeItem(document.RootElement);
        }
