...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public static partial class ArmServiceLinkerModelFactory
    {
        ...
        public static DryrunResourceData DryrunResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DryrunParameters parameters = null, IEnumerable<DryrunPrerequisiteResult> prerequisiteResults = null, IEnumerable<DryrunOperationPreview> operationPreviews = null, string provisioningState = null)
        {
            ...
            return new DryrunResourceData(id, name, resourceType, systemData, parameters, prerequisiteResults?.ToList(), operationPreviews?.ToList(), provisioningState, serializedAdditionalRawData: null);
        }
        ...
        {
            return new DryrunOperationPreview(name, operationType, description, action, scope, serializedAdditionalRawData: null);
        }
        ...
        {
            return new LinkerResourceData(id, name, resourceType, systemData, targetService, authInfo, clientType, provisioningState, vnetSolution, secretStore, scope, publicNetworkSolution, configurationInfo, serializedAdditionalRawData: null);
        }
        ...
        {
            return new LinkerPatch(targetService, authInfo, clientType, provisioningState, vnetSolution, secretStore, scope, publicNetworkSolution, configurationInfo, serializedAdditionalRawData: null);
        }
        ...
        public static ConfigurationNameItem ConfigurationNameItem(string targetService = null, LinkerClientType? clientType = null, LinkerAuthType? authType = null, DaprProperties daprProperties = null, IEnumerable<ConfigurationName> names = null)
        {
            ...
            return new ConfigurationNameItem(targetService, clientType, authType, daprProperties, names?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        {
            return new CreateOrUpdateDryrunParameters(DryrunActionName.CreateOrUpdate, serializedAdditionalRawData: null, targetService, authInfo, clientType, provisioningState, vnetSolution, secretStore, scope, publicNetworkSolution, configurationInfo);
        }
