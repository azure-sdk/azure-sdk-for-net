...
namespace Azure.ResourceManager.ServiceLinker
{
    internal partial class LinkersRestOperations
    {
        ...
        internal HttpMessage CreateUpdateDryrunRequest(string resourceUri, string dryrunName, DryrunResourcePatch patch)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <exception cref="ArgumentException"> <paramref name="dryrunName"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response> UpdateDryrunAsync(string resourceUri, string dryrunName, DryrunResourcePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
            Argument.AssertNotNullOrEmpty(dryrunName, nameof(dryrunName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceUri"/>, <paramref name="dryrunName"/> or <paramref name="patch"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="dryrunName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response UpdateDryrun(string resourceUri, string dryrunName, DryrunResourcePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
            Argument.AssertNotNullOrEmpty(dryrunName, nameof(dryrunName));
            Argument.AssertNotNull(patch, nameof(patch));
