...
namespace Azure.ResourceManager.ServiceLinker
{
    ...
    public static partial class ServiceLinkerExtensions
    {
        ...
        {
            return GetArmResourceExtensionClient(armResource).GetLinkers();
        }
        ...
        {
            return await armResource.GetLinkers().GetAsync(linkerName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return armResource.GetLinkers().Get(linkerName, cancellationToken);
        }
