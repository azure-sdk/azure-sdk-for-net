...
namespace Azure.ResourceManager.ServiceLinker
{
    ...
    public static partial class ServiceLinkerExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableServiceLinkerArmClient.GetDryrunResources(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="scope"> The scope that the resource will apply against. </param>
        ...
        public static DryrunResourceCollection GetDryrunResources(this ArmClient client, ResourceIdentifier scope)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableServiceLinkerArmClient(client).GetDryrunResources(scope);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableServiceLinkerArmClient.GetDryrunResourceAsync(ResourceIdentifier,string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="scope"> The scope that the resource will apply against. </param>
        ...
        [ForwardsClientCalls]
        public static async Task<Response<DryrunResource>> GetDryrunResourceAsync(this ArmClient client, ResourceIdentifier scope, string dryrunName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(client, nameof(client));

            return await GetMockableServiceLinkerArmClient(client).GetDryrunResourceAsync(scope, dryrunName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableServiceLinkerArmClient.GetDryrunResource(ResourceIdentifier,string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="scope"> The scope that the resource will apply against. </param>
        ...
        /// <exception cref="ArgumentException"> <paramref name="dryrunName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public static Response<DryrunResource> GetDryrunResource(this ArmClient client, ResourceIdentifier scope, string dryrunName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableServiceLinkerArmClient(client).GetDryrunResource(scope, dryrunName, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableServiceLinkerResourceGroupResource.GetDryrunResourcesByLocation(CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public static AsyncPageable<DryrunResource> GetDryrunResourcesByLocationAsync(this ResourceGroupResource resourceGroupResource, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceGroupResource, nameof(resourceGroupResource));

            return GetMockableServiceLinkerResourceGroupResource(resourceGroupResource).GetDryrunResourcesByLocationAsync(cancellationToken);
        }
        ...
        public static Pageable<DryrunResource> GetDryrunResourcesByLocation(this ResourceGroupResource resourceGroupResource, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceGroupResource, nameof(resourceGroupResource));

            return GetMockableServiceLinkerResourceGroupResource(resourceGroupResource).GetDryrunResourcesByLocation(cancellationToken);
        }
