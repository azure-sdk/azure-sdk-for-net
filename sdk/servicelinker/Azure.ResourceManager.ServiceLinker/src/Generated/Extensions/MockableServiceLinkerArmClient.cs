...
namespace Azure.ResourceManager.ServiceLinker.Mocking
{
    ...
    public partial class MockableServiceLinkerArmClient : ArmResource
    {
        ...
        public virtual DryrunResourceCollection GetDryrunResources(ResourceIdentifier scope)
        {
            return new DryrunResourceCollection(Client, scope);
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DryrunResource>> GetDryrunResourceAsync(ResourceIdentifier scope, string dryrunName, CancellationToken cancellationToken = default)
        {
            return await GetDryrunResources(scope).GetAsync(dryrunName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="dryrunName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<DryrunResource> GetDryrunResource(ResourceIdentifier scope, string dryrunName, CancellationToken cancellationToken = default)
        {
            return GetDryrunResources(scope).Get(dryrunName, cancellationToken);
        }
