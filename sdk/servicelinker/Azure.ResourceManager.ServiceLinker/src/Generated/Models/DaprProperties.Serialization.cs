...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DaprProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DaprProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DaprProperties)} does not support '{format}' format.");
            }
        ...
        internal static DaprProperties DeserializeDaprProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DaprProperties(version.Value, componentType.Value, secretStoreComponent.Value, Optional.ToList(metadata), Optional.ToList(scopes), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DaprProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DaprProperties)} does not support '{options.Format}' format.");
            }
        }
