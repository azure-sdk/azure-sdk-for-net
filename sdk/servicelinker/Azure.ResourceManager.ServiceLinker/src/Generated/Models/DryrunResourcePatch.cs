...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class DryrunResourcePatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DryrunResourcePatch"/>. </summary>
        public DryrunResourcePatch()
        {
        ...
        internal DryrunResourcePatch(DryrunParameters parameters, IReadOnlyList<DryrunPrerequisiteResult> prerequisiteResults, IReadOnlyList<DryrunOperationPreview> operationPreviews, string provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
