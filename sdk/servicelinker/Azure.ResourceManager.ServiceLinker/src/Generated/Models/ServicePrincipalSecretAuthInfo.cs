...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class ServicePrincipalSecretAuthInfo : AuthBaseInfo
    {
        ...
        internal ServicePrincipalSecretAuthInfo(LinkerAuthType authType, IDictionary<string, BinaryData> serializedAdditionalRawData, string clientId, Guid principalId, string secret, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles, string userName) : base(authType, serializedAdditionalRawData)
        {
            ClientId = clientId;
            PrincipalId = principalId;
            Secret = secret;
