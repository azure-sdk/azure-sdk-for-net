...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationNameItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ConfigurationNameItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConfigurationNameItem)} does not support '{format}' format.");
            }
        ...
        internal static ConfigurationNameItem DeserializeConfigurationNameItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConfigurationNameItem(targetService.Value, Optional.ToNullable(clientType), Optional.ToNullable(authType), daprProperties.Value, Optional.ToList(names), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ConfigurationNameItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConfigurationNameItem)} does not support '{options.Format}' format.");
            }
        }
