...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserAccountAuthInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<UserAccountAuthInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UserAccountAuthInfo)} does not support '{format}' format.");
            }
        ...
        internal static UserAccountAuthInfo DeserializeUserAccountAuthInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UserAccountAuthInfo(authType, serializedAdditionalRawData, Optional.ToNullable(principalId), Optional.ToNullable(deleteOrUpdateBehavior), Optional.ToList(roles), userName.Value);
        }
        ...
        BinaryData IPersistableModel<UserAccountAuthInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UserAccountAuthInfo)} does not support '{options.Format}' format.");
            }
        }
