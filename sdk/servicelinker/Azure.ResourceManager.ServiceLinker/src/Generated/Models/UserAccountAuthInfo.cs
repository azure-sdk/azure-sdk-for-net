...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class UserAccountAuthInfo : AuthBaseInfo
    {
        ...
        internal UserAccountAuthInfo(LinkerAuthType authType, IDictionary<string, BinaryData> serializedAdditionalRawData, Guid? principalId, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles, string userName) : base(authType, serializedAdditionalRawData)
        {
