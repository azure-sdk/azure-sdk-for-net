...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class DaprProperties
    {
        ...
        internal DaprProperties(string version, string componentType, string secretStoreComponent, IList<DaprMetadata> metadata, IList<string> scopes, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Version = version;
