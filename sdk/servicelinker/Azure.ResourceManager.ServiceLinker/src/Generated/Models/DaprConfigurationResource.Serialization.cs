...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DaprConfigurationResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DaprConfigurationResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DaprConfigurationResource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DaprConfigurationResource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DaprConfigurationResource)} does not support '{options.Format}' format.");
            }
        }
