...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    public partial class ConfigurationInfo : IUtf8JsonSerializable, IJsonModel<ConfigurationInfo>
    {
        ...
        internal static ConfigurationInfo DeserializeConfigurationInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConfigurationInfo(Optional.ToNullable(deleteOrUpdateBehavior), Optional.ToNullable(action), Optional.ToDictionary(customizedKeys), daprProperties.Value, Optional.ToDictionary(additionalConfigurations), serializedAdditionalRawData);
        }
