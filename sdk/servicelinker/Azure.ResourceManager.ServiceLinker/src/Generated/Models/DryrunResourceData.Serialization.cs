...
namespace Azure.ResourceManager.ServiceLinker
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DryrunResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DryrunResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DryrunResourceData)} does not support '{format}' format.");
            }
        ...
        internal static DryrunResourceData DeserializeDryrunResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DryrunResourceData(id, name, type, systemData.Value, parameters.Value, Optional.ToList(prerequisiteResults), Optional.ToList(operationPreviews), provisioningState.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DryrunResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DryrunResourceData)} does not support '{options.Format}' format.");
            }
        }
