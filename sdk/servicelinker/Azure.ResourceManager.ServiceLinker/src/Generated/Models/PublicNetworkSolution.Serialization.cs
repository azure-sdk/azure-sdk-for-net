...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublicNetworkSolution>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PublicNetworkSolution>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PublicNetworkSolution)} does not support '{format}' format.");
            }
        ...
        internal static PublicNetworkSolution DeserializePublicNetworkSolution(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PublicNetworkSolution(Optional.ToNullable(deleteOrUpdateBehavior), Optional.ToNullable(action), firewallRules.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PublicNetworkSolution>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PublicNetworkSolution)} does not support '{options.Format}' format.");
            }
        }
