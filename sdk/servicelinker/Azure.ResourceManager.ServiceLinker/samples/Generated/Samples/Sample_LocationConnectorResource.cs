...
namespace Azure.ResourceManager.ServiceLinker.Samples
{
    public partial class Sample_LocationConnectorResource
    {
        ...
        public async Task GetDryrunResourcesByLocation_ConnectorDryrunList()
        {
            ...
            await foreach (DryrunResource item in resourceGroupResource.GetDryrunResourcesByLocationAsync())
            {
