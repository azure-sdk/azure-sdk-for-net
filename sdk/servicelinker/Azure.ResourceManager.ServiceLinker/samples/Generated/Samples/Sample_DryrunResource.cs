...
namespace Azure.ResourceManager.ServiceLinker.Samples
{
    public partial class Sample_DryrunResource
    {
        ...
        public async Task Get_GetDryrun()
        {
            ...
            DryrunResource dryrunResource = client.GetDryrunResource(dryrunResourceId);

            // invoke the operation
            DryrunResource result = await dryrunResource.GetAsync();
        ...
        public async Task Update_PatchDryrun()
        {
            ...
            // invoke the operation
            DryrunResourcePatch patch = new DryrunResourcePatch()
            {
            ...
            ArmOperation<DryrunResource> lro = await dryrunResource.UpdateAsync(WaitUntil.Completed, patch);
        ...
        public async Task Delete_DeleteDryrun()
        {
            ...
            // invoke the operation
            await dryrunResource.DeleteAsync(WaitUntil.Completed);
