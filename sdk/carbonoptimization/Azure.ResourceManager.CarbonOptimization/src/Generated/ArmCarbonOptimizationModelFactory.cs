...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public static partial class ArmCarbonOptimizationModelFactory
    {
        ...
        public static CarbonEmissionData CarbonEmissionData(string dataType = null, double latestMonthEmissions = default, double previousMonthEmissions = default, double? monthOverMonthEmissionsChangeRatio = null, double? monthlyEmissionsChangeValue = null)
        {
        ...
        public static CarbonEmissionOverallSummaryData CarbonEmissionOverallSummaryData(double latestMonthEmissions = default, double previousMonthEmissions = default, double? monthOverMonthEmissionsChangeRatio = null, double? monthlyEmissionsChangeValue = null)
        {
        ...
        public static CarbonEmissionMonthlySummaryData CarbonEmissionMonthlySummaryData(double latestMonthEmissions = default, double previousMonthEmissions = default, double? monthOverMonthEmissionsChangeRatio = null, double? monthlyEmissionsChangeValue = null, string date = null, double carbonIntensity = default)
        {
        ...
        public static CarbonEmissionTopItemsSummaryData CarbonEmissionTopItemsSummaryData(double latestMonthEmissions = default, double previousMonthEmissions = default, double? monthOverMonthEmissionsChangeRatio = null, double? monthlyEmissionsChangeValue = null, string itemName = null, CategoryTypeEnum categoryType = default)
        {
        ...
        public static ResourceGroupCarbonEmissionTopItemMonthlySummaryData ResourceGroupCarbonEmissionTopItemMonthlySummaryData(double latestMonthEmissions = default, double previousMonthEmissions = default, double? monthOverMonthEmissionsChangeRatio = null, double? monthlyEmissionsChangeValue = null, string itemName = null, CategoryTypeEnum categoryType = default, string date = null, string subscriptionId = null, string resourceGroupUri = null)
        {
        ...
        public static CarbonEmissionItemDetailData CarbonEmissionItemDetailData(double latestMonthEmissions = default, double previousMonthEmissions = default, double? monthOverMonthEmissionsChangeRatio = null, double? monthlyEmissionsChangeValue = null, string itemName = null, CategoryTypeEnum categoryType = default)
        {
