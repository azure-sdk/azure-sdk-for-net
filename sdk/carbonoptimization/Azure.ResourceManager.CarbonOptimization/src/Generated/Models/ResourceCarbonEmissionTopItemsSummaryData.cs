...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class ResourceCarbonEmissionTopItemsSummaryData : CarbonEmissionData
    {
        ...
        internal ResourceCarbonEmissionTopItemsSummaryData(double latestMonthEmissions, double previousMonthEmissions, string itemName, CategoryTypeEnum categoryType, string subscriptionId, string resourceGroup, string resourceId) : base(latestMonthEmissions, previousMonthEmissions)
        {
