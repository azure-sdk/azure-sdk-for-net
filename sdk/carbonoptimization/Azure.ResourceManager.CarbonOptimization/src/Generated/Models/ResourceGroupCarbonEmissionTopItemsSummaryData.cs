...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class ResourceGroupCarbonEmissionTopItemsSummaryData : CarbonEmissionData
    {
        ...
        internal ResourceGroupCarbonEmissionTopItemsSummaryData(double latestMonthEmissions, double previousMonthEmissions, string itemName, CategoryTypeEnum categoryType, string subscriptionId, string resourceGroupUri) : base(latestMonthEmissions, previousMonthEmissions)
        {
