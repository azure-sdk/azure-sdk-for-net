...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class ResourceGroupCarbonEmissionItemDetailData : CarbonEmissionData
    {
        ...
        internal ResourceGroupCarbonEmissionItemDetailData(double latestMonthEmissions, double previousMonthEmissions, string itemName, CategoryTypeEnum categoryType, string subscriptionId, string resourceGroupUri) : base(latestMonthEmissions, previousMonthEmissions)
        {
