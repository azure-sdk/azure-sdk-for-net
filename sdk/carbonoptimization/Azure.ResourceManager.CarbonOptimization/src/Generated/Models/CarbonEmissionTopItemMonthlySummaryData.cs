...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class CarbonEmissionTopItemMonthlySummaryData : CarbonEmissionData
    {
        ...
        internal CarbonEmissionTopItemMonthlySummaryData(double latestMonthEmissions, double previousMonthEmissions, string itemName, CategoryTypeEnum categoryType, string date) : base(latestMonthEmissions, previousMonthEmissions)
        {
