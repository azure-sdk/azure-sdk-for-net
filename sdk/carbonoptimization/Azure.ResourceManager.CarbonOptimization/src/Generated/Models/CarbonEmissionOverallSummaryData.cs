...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CarbonEmissionOverallSummaryData"/>. </summary>
        ...
        internal CarbonEmissionOverallSummaryData(double latestMonthEmissions, double previousMonthEmissions) : base(latestMonthEmissions, previousMonthEmissions)
        {
        ...
        internal CarbonEmissionOverallSummaryData(ResponseDataTypeEnum dataType, double latestMonthEmissions, double previousMonthEmissions, double? monthOverMonthEmissionsChangeRatio, double? monthlyEmissionsChangeValue, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(dataType, latestMonthEmissions, previousMonthEmissions, monthOverMonthEmissionsChangeRatio, monthlyEmissionsChangeValue, serializedAdditionalRawData)
        {
            DataType = dataType;
        }

        /// <summary> Initializes a new instance of <see cref="CarbonEmissionOverallSummaryData"/> for deserialization. </summary>
        internal CarbonEmissionOverallSummaryData()
        {
        }
    }
}
