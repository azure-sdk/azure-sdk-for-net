...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public abstract partial class CarbonEmissionData
    {
        ...
        protected CarbonEmissionData(double latestMonthEmissions, double previousMonthEmissions)
        {
        ...
        internal CarbonEmissionData(ResponseDataTypeEnum dataType, double latestMonthEmissions, double previousMonthEmissions, double? monthOverMonthEmissionsChangeRatio, double? monthlyEmissionsChangeValue, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DataType = dataType;
            LatestMonthEmissions = latestMonthEmissions;
            PreviousMonthEmissions = previousMonthEmissions;
