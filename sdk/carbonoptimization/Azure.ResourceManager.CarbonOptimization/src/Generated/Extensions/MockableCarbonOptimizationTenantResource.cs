...
namespace Azure.ResourceManager.CarbonOptimization.Mocking
{
    ...
    public partial class MockableCarbonOptimizationTenantResource : ArmResource
    {
        ...
        public virtual AsyncPageable<CarbonEmissionData> QueryCarbonEmissionReportsCarbonServicesAsync(QueryFilter queryParameters, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => CarbonEmissionData.DeserializeCarbonEmissionData(e), CarbonServiceClientDiagnostics, Pipeline, "MockableCarbonOptimizationTenantResource.QueryCarbonEmissionReportsCarbonServices", "value", null, cancellationToken);
        }
        ...
        public virtual Pageable<CarbonEmissionData> QueryCarbonEmissionReportsCarbonServices(QueryFilter queryParameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(queryParameters, nameof(queryParameters));

            HttpMessage FirstPageRequest(int? pageSizeHint) => CarbonServiceRestClient.CreateQueryCarbonEmissionReportsRequest(queryParameters);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => CarbonEmissionData.DeserializeCarbonEmissionData(e), CarbonServiceClientDiagnostics, Pipeline, "MockableCarbonOptimizationTenantResource.QueryCarbonEmissionReportsCarbonServices", "value", null, cancellationToken);
        }
