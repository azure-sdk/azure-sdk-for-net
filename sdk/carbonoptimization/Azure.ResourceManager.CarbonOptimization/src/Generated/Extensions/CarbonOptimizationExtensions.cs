...
namespace Azure.ResourceManager.CarbonOptimization
{
    ...
    public static partial class CarbonOptimizationExtensions
    {
        ...
        public static AsyncPageable<CarbonEmissionData> QueryCarbonEmissionReportsCarbonServicesAsync(this TenantResource tenantResource, QueryFilter queryParameters, CancellationToken cancellationToken = default)
        {
        ...
        public static Pageable<CarbonEmissionData> QueryCarbonEmissionReportsCarbonServices(this TenantResource tenantResource, QueryFilter queryParameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tenantResource, nameof(tenantResource));
