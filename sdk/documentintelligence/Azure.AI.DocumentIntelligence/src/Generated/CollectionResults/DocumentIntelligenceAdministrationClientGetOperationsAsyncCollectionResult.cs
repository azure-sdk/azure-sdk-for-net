...
namespace Azure.AI.DocumentIntelligence
{
    internal partial class DocumentIntelligenceAdministrationClientGetOperationsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DocumentIntelligenceAdministrationClientGetOperationsAsyncCollectionResult(DocumentIntelligenceAdministrationClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
