...
namespace Azure.AI.DocumentIntelligence
{
    internal partial class DocumentIntelligenceAdministrationClientGetClassifiersCollectionResultOfT : Pageable<DocumentClassifierDetails>
    {
        ...
        public DocumentIntelligenceAdministrationClientGetClassifiersCollectionResultOfT(DocumentIntelligenceAdministrationClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
