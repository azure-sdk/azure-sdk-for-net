...
namespace Azure.AI.DocumentIntelligence
{
    internal partial class DocumentIntelligenceClientGetAnalyzeBatchResultsCollectionResultOfT : Pageable<AnalyzeBatchOperationDetails>
    {
        ...
        public DocumentIntelligenceClientGetAnalyzeBatchResultsCollectionResultOfT(DocumentIntelligenceClient client, string modelId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _modelId = modelId;
            _context = context;
