...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public static partial class DocumentIntelligenceModelFactory
    {
        ...
        public static AnalyzeBatchDocumentsContent AnalyzeBatchDocumentsContent(BlobContentSource azureBlobSource = null, BlobFileListContentSource azureBlobFileListSource = null, Uri resultContainerUrl = null, string resultPrefix = null, bool? overwriteExisting = null)
        {
        ...
        public static AnalyzeBatchOperationDetail AnalyzeBatchOperationDetail(DocumentIntelligenceOperationStatus status = default, Uri sourceUrl = null, Uri resultUrl = null, DocumentIntelligenceError error = null)
        {
            return new AnalyzeBatchOperationDetail(status, sourceUrl, resultUrl, error, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="DocumentIntelligence.AnalyzeBatchOperation"/>. </summary>
        ...
        /// <returns> A new <see cref="DocumentIntelligence.AnalyzeBatchOperation"/> instance for mocking. </returns>
        public static AnalyzeBatchOperation AnalyzeBatchOperation(Guid? resultId = null, DocumentIntelligenceOperationStatus status = default, DateTimeOffset createdDateTime = default, DateTimeOffset lastUpdatedDateTime = default, int? percentCompleted = null, DocumentIntelligenceError error = null, AnalyzeBatchResult result = null)
        {
        ...
        public static ComposeDocumentModelContent ComposeDocumentModelContent(string modelId = null, string description = null, string classifierId = null, SplitMode? split = null, IDictionary<string, DocumentTypeDetails> documentTypes = null, IDictionary<string, string> tags = null)
        {
            documentTypes ??= new Dictionary<string, DocumentTypeDetails>();
            tags ??= new Dictionary<string, string>();
        ...
        public static BuildDocumentClassifierContent BuildDocumentClassifierContent(string classifierId = null, string description = null, string baseClassifierId = null, IDictionary<string, ClassifierDocumentTypeDetails> documentTypes = null, bool? allowOverwrite = null)
        {
            documentTypes ??= new Dictionary<string, ClassifierDocumentTypeDetails>();
