...
{
    internal partial class IntegrationServiceEnvironmentSkusRestOperations
    {
        ...
        /// <summary> Initializes a new instance of IntegrationServiceEnvironmentSkusRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public IntegrationServiceEnvironmentSkusRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        public async Task<Response<IntegrationServiceEnvironmentSkuList>> ListAsync(string subscriptionId, string integrationServiceEnvironmentName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        IntegrationServiceEnvironmentSkuList value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, ModelSerializationExtensions.JsonDocumentOptions, cancellationToken).ConfigureAwait(false);
                        value = IntegrationServiceEnvironmentSkuList.DeserializeIntegrationServiceEnvironmentSkuList(document.RootElement);
