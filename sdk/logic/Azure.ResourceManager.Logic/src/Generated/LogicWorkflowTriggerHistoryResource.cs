...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class LogicWorkflowTriggerHistoryResource : ArmResource
    {
        ...
        private readonly LogicWorkflowTriggerHistoryData _data;

        /// <summary> Gets the resource type for the operations. </summary>
        public static readonly ResourceType ResourceType = "Microsoft.Logic/workflows/triggers/histories";

        /// <summary> Initializes a new instance of the <see cref="LogicWorkflowTriggerHistoryResource"/> class for mocking. </summary>
        ...
        internal LogicWorkflowTriggerHistoryResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _logicWorkflowTriggerHistoryWorkflowTriggerHistoriesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Logic", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string logicWorkflowTriggerHistoryWorkflowTriggerHistoriesApiVersion);
        ...
        public virtual LogicWorkflowTriggerHistoryData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<LogicWorkflowTriggerHistoryResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _logicWorkflowTriggerHistoryWorkflowTriggerHistoriesClientDiagnostics.CreateScope("LogicWorkflowTriggerHistoryResource.Get");
            scope.Start();
            try
            {
                var response = await _logicWorkflowTriggerHistoryWorkflowTriggerHistoriesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<LogicWorkflowTriggerHistoryResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _logicWorkflowTriggerHistoryWorkflowTriggerHistoriesClientDiagnostics.CreateScope("LogicWorkflowTriggerHistoryResource.Get");
            scope.Start();
            try
            {
                var response = _logicWorkflowTriggerHistoryWorkflowTriggerHistoriesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new LogicWorkflowTriggerHistoryResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/triggers/{triggerName}/histories/{historyName}/resubmit</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
