...
namespace Azure.ResourceManager.Logic
{
    public partial class IntegrationAccountSessionData : IUtf8JsonSerializable, IJsonModel<IntegrationAccountSessionData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntegrationAccountSessionData)} does not support writing '{format}' format.");
            }
        ...
        IntegrationAccountSessionData IJsonModel<IntegrationAccountSessionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntegrationAccountSessionData)} does not support reading '{format}' format.");
            }
        ...
        IntegrationAccountSessionData IPersistableModel<IntegrationAccountSessionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntegrationAccountSessionData)} does not support reading '{options.Format}' format.");
            }
        }
