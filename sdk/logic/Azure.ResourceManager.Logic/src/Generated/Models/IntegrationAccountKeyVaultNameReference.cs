...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class IntegrationAccountKeyVaultNameReference : LogicResourceReference
    {
        ...
        internal IntegrationAccountKeyVaultNameReference(string id, string name, string resourceType, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
        }
    }
}
