...
Action = ElasticSanVirtualNetworkRuleAction.Allow,
        ...
        public async Task PreBackupVolume_VolumeGroupsPreBackupMaximumSetGen()
        {
            ...
            // invoke the operation
            VolumeNameList volumeNameList = new VolumeNameList(new string[] { "volume1" });
        ...
        public async Task PreRestoreVolume_VolumeGroupsPreRestoreMaximumSetGen()
        {
            ...
            // invoke the operation
            DiskSnapshotList diskSnapshotList = new DiskSnapshotList(new ResourceIdentifier[] { new ResourceIdentifier("/subscriptions/67B407F8-ED08-4144-B074-BA08FF4FB978/resourceGroups/rgelasticsan/providers/Microsoft.Compute/snapshots/disksnapshot1") });
