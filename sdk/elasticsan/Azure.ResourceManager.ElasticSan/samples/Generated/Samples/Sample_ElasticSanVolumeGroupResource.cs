...
Action = ElasticSanVirtualNetworkRuleAction.Allow,
        ...
        public async Task Delete_VolumeGroupsDeleteMaximumSetGen()
        {
            ...
            await elasticSanVolumeGroup.DeleteAsync(WaitUntil.Completed, purge: purge);
        ...
        public async Task Get_VolumeGroupsGetMaximumSetGen()
        {
            ...
            ElasticSanVolumeGroupResource result = await elasticSanVolumeGroup.GetAsync(xmsAccessSoftDeletedResources: xmsAccessSoftDeletedResources);
