...
{
    public partial class Sample_VolumeGroupCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_VolumeGroupsCreateMaximumSetGen()
        {
            ...
            // get the collection of this VolumeGroupResource
            VolumeGroupCollection collection = elasticSan.GetVolumeGroups();

            // invoke the operation
            string volumeGroupName = "volumegroupname";
            VolumeGroupData data = new VolumeGroupData();
            await collection.CreateOrUpdateAsync(WaitUntil.Completed, volumeGroupName, data);
        ...
        public async Task Get_VolumeGroupsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string volumeGroupName = "volumegroupname";
            VolumeGroupResource result = await collection.GetAsync(volumeGroupName);
        ...
        public async Task GetAll_VolumeGroupsListByElasticSanMaximumSetGen()
        {
            ...
            await foreach (VolumeGroupResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                VolumeGroupData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_VolumeGroupsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string volumeGroupName = "volumegroupname";
            NullableResponse<VolumeGroupResource> response = await collection.GetIfExistsAsync(volumeGroupName);
            VolumeGroupResource result = response.HasValue ? response.Value : null;
