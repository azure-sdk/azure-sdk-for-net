...
namespace Azure.ResourceManager.ElasticSan.Mocking
{
    ...
    public partial class MockableElasticSanSubscriptionResource : ArmResource
    {
        ...
        private ClientDiagnostics _skusOperationGroupClientDiagnostics;
        private SkusOperationGroupRestOperations _skusOperationGroupRestClient;
        ...
        private ClientDiagnostics SkusOperationGroupClientDiagnostics => _skusOperationGroupClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.ElasticSan", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        private SkusOperationGroupRestOperations SkusOperationGroupRestClient => _skusOperationGroupRestClient ??= new SkusOperationGroupRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
        ...
        public virtual AsyncPageable<ElasticSanSkuInformation> GetSkusOperationGroupsAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => SkusOperationGroupRestClient.CreateListRequest(Id.SubscriptionId, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => SkusOperationGroupRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, filter);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => ElasticSanSkuInformation.DeserializeElasticSanSkuInformation(e), SkusOperationGroupClientDiagnostics, Pipeline, "MockableElasticSanSubscriptionResource.GetSkusOperationGroups", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ElasticSanSkuInformation> GetSkusOperationGroups(string filter = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => SkusOperationGroupRestClient.CreateListRequest(Id.SubscriptionId, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => SkusOperationGroupRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, filter);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => ElasticSanSkuInformation.DeserializeElasticSanSkuInformation(e), SkusOperationGroupClientDiagnostics, Pipeline, "MockableElasticSanSubscriptionResource.GetSkusOperationGroups", "value", "nextLink", cancellationToken);
        }
    }
}
