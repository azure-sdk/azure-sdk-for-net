...
namespace Azure.ResourceManager.ElasticSan
{
    ...
    public partial class VolumeData : ResourceData
    {
        ...
        internal VolumeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string volumeId, SourceCreationContent creationData, long sizeGiB, IscsiTargetInfo storageTarget, ManagedByInfo managedBy, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            VolumeId = volumeId;
        ...
        public SourceCreationContent CreationData { get; set; }
