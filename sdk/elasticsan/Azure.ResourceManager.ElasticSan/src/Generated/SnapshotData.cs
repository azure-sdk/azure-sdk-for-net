...
namespace Azure.ResourceManager.ElasticSan
{
    ...
    public partial class SnapshotData : ResourceData
    {
        ...
        public SnapshotData(SnapshotCreationContent creationData)
        {
        ...
        internal SnapshotData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SnapshotCreationContent creationData, ProvisioningState? provisioningState, long? sourceVolumeSizeGiB, string volumeName, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            CreationData = creationData;
        ...
        internal SnapshotCreationContent CreationData { get; set; }
        ...
        public string CreationDataSourceId
        {
            ...
            set => CreationData = new SnapshotCreationContent(value);
        }
