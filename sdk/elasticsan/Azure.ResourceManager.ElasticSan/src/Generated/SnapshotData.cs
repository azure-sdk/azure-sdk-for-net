...
namespace Azure.ResourceManager.ElasticSan
{
    ...
    public partial class SnapshotData : ResourceData
    {
        ...
        internal SnapshotData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SnapshotCreationData creationData, ElasticSanProvisioningState? provisioningState, long? sourceVolumeSizeGiB, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
