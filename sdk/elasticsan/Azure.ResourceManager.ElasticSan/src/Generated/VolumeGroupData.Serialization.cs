...
{
    public partial class VolumeGroupData : IUtf8JsonSerializable, IJsonModel<VolumeGroupData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VolumeGroupData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeGroupData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        VolumeGroupData IJsonModel<VolumeGroupData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeGroupData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static VolumeGroupData DeserializeVolumeGroupData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            StorageTargetType? protocolType = default;
            EncryptionType? encryption = default;
            Models.EncryptionProperties encryptionProperties = default;
        ...
        BinaryData IPersistableModel<VolumeGroupData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeGroupData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        VolumeGroupData IPersistableModel<VolumeGroupData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeGroupData>)this).GetFormatFromOptions(options) : options.Format;
