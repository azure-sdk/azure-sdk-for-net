...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    public partial class SnapshotCreateOrUpdateContent : ResourceData
    {
        ...
        public SnapshotCreateOrUpdateContent()
        {
        ...
        internal SnapshotCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SnapshotCreationData creationData, ElasticSanProvisioningState? provisioningState, long? sourceVolumeSizeGiB, string volumeName, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
