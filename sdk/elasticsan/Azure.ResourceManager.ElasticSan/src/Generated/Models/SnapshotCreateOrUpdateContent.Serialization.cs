...
{
    public partial class SnapshotCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static SnapshotCreateOrUpdateContent DeserializeSnapshotCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new SnapshotCreateOrUpdateContent(id, name, type, systemData.Value, creationData.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(sourceVolumeSizeGiB), volumeName.Value, Optional.ToDictionary(tags));
        }
    }
}
