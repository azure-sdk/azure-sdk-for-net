...
namespace Azure.ResourceManager.ElasticSan.Models
{
    public partial class SnapshotCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static SnapshotCreateOrUpdateContent DeserializeSnapshotCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new SnapshotCreateOrUpdateContent(id, name, type, systemData.Value, creationData, Optional.ToNullable(provisioningState), Optional.ToNullable(sourceVolumeSizeGiB), Optional.ToDictionary(tags));
        }
    }
}
