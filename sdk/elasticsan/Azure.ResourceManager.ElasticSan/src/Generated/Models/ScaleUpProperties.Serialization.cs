...
namespace Azure.ResourceManager.ElasticSan.Models
{
    public partial class ScaleUpProperties : IUtf8JsonSerializable, IJsonModel<ScaleUpProperties>
    {
        ...
        void IJsonModel<ScaleUpProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxScaleUpTiB))
            {
                writer.WritePropertyName("maxScaleUpTiB"u8);
                writer.WriteNumberValue(MaxScaleUpTiB.Value);
            }
        ...
        internal static ScaleUpProperties DeserializeScaleUpProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            long? maxScaleUpTiB = default;
            PolicyEnforcement? policyEnforcement = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("maxScaleUpTiB"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    maxScaleUpTiB = property.Value.GetInt64();
                    continue;
                }
                if (property.NameEquals("policyEnforcement"u8))
                {
                    ...
                    policyEnforcement = new PolicyEnforcement(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ScaleUpProperties(unusedSizeTiB, increaseCapacityUnitByTiB, maxScaleUpTiB, policyEnforcement, serializedAdditionalRawData);
        }
