...
namespace Azure.ResourceManager.ElasticSan.Models
{
    public partial class ElasticSanVolumeCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static ElasticSanVolumeCreateOrUpdateContent DeserializeElasticSanVolumeCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new ElasticSanVolumeCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToNullable(volumeId), creationData.Value, sizeGiB, storageTarget.Value, Optional.ToDictionary(tags));
        }
    }
}
