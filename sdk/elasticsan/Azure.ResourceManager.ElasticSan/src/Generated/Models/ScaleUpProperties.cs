...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    public partial class ScaleUpProperties
    {
        ...
        /// <param name="maxScaleUpTiB"> Maximum scale up size on Elastic San appliance in TiB. </param>
        /// <param name="policyEnforcement"> Enable or Disable scale up setting on Elastic San Appliance. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal ScaleUpProperties(long? unusedSizeTiB, long? increaseCapacityUnitByTiB, long? maxScaleUpTiB, PolicyEnforcement? policyEnforcement, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UnusedSizeTiB = unusedSizeTiB;
            IncreaseCapacityUnitByTiB = increaseCapacityUnitByTiB;
            MaxScaleUpTiB = maxScaleUpTiB;
        ...
        public long? MaxScaleUpTiB { get; set; }
