...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    public partial class ElasticSanVolumeCreateOrUpdateContent : ResourceData
    {
        /// <summary> Initializes a new instance of ElasticSanVolumeCreateOrUpdateContent. </summary>
        ...
        internal ElasticSanVolumeCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Guid? volumeId, ElasticSanVolumeDataSourceInfo creationData, long sizeGiB, IscsiTargetInfo storageTarget, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
            VolumeId = volumeId;
