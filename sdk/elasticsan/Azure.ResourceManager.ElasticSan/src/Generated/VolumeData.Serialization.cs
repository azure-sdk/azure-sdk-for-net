...
{
    public partial class VolumeData : IUtf8JsonSerializable, IJsonModel<VolumeData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VolumeData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        VolumeData IJsonModel<VolumeData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static VolumeData DeserializeVolumeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            SourceCreationContent creationData = default;
        ...
        BinaryData IPersistableModel<VolumeData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        VolumeData IPersistableModel<VolumeData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeData>)this).GetFormatFromOptions(options) : options.Format;
