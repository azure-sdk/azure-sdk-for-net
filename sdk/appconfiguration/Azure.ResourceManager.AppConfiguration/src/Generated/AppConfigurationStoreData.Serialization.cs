...
namespace Azure.ResourceManager.AppConfiguration
{
    public partial class AppConfigurationStoreData : IUtf8JsonSerializable, IJsonModel<AppConfigurationStoreData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RevisionRetentionPeriodInSeconds), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    revisionRetentionPeriodInSeconds: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    revisionRetentionPeriodInSeconds: ");
                    builder.AppendLine($"'{RevisionRetentionPeriodInSeconds.Value.ToString()}'");
                }
            }
