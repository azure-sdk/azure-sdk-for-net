...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class AppConfigurationStoreData : TrackedResourceData
    {
        ...
        /// <param name="revisionRetentionPeriodInSeconds"> The amount of time in seconds to retain new key value revisions. Defaults to 604800 (7 days) for Free SKU stores and 2592000 (30 days) for Standard SKU stores. </param>
        ...
        /// <summary> The amount of time in seconds to retain new key value revisions. Defaults to 604800 (7 days) for Free SKU stores and 2592000 (30 days) for Standard SKU stores. </summary>
