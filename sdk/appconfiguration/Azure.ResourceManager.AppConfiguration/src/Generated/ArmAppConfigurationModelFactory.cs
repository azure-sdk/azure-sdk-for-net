...
namespace Azure.ResourceManager.AppConfiguration.Models
{
    ...
    public static partial class ArmAppConfigurationModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AppConfiguration.ExperimentationData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="AppConfiguration.ExperimentationData"/> instance for mocking. </returns>
        public static ExperimentationData ExperimentationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string managedResourceGroupName = null, string onlineExperimentationWorkspaceResourceId = null, string storageAccountResourceId = null, AppConfigurationProvisioningState? provisioningState = null)
        {
