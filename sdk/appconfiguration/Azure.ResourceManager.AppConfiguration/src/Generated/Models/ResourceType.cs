...
namespace Azure.ResourceManager.AppConfiguration.Models
{
    ...
    internal readonly partial struct ResourceType : IEquatable<ResourceType>
    {
        ...
        private const string KvValue = "Kv";
        private const string SnapshotValue = "Snapshot";

        /// <summary> Kv. </summary>
        public static ResourceType Kv { get; } = new ResourceType(KvValue);
        /// <summary> Snapshot. </summary>
        public static ResourceType Snapshot { get; } = new ResourceType(SnapshotValue);
