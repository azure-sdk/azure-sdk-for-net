...
{
    public partial class ScalingPlanPooledSchedulePutData : IUtf8JsonSerializable, IJsonModel<ScalingPlanPooledSchedulePutData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPooledSchedulePutData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ScalingPlanPooledSchedulePutData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePutData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScalingPlanPooledSchedulePutData)} does not support writing '{format}' format.");
            }
        ...
        ScalingPlanPooledSchedulePutData IJsonModel<ScalingPlanPooledSchedulePutData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePutData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScalingPlanPooledSchedulePutData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeScalingPlanPooledSchedulePutData(document.RootElement, options);
        }

        internal static ScalingPlanPooledSchedulePutData DeserializeScalingPlanPooledSchedulePutData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ScalingPlanPooledSchedulePutData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePutData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScalingPlanPooledSchedulePutData)} does not support writing '{options.Format}' format.");
            }
        }

        ScalingPlanPooledSchedulePutData IPersistableModel<ScalingPlanPooledSchedulePutData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePutData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScalingPlanPooledSchedulePutData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ScalingPlanPooledSchedulePutData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
