...
{
    public partial class ScalingPlanPersonalSchedulePatchProperties : IUtf8JsonSerializable, IJsonModel<ScalingPlanPersonalSchedulePatchProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPersonalSchedulePatchProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPersonalSchedulePatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ScalingPlanPersonalSchedulePatchProperties IJsonModel<ScalingPlanPersonalSchedulePatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPersonalSchedulePatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ScalingPlanPersonalSchedulePatchProperties DeserializeScalingPlanPersonalSchedulePatchProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("rampUpAutoStartHosts"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampUpAutoStartHosts = new StartupBehavior(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("rampUpStartVMOnConnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampUpStartVmOnConnect = new SetStartVmOnConnect(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("rampUpActionOnDisconnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampUpActionOnDisconnect = new SessionHandlingOperation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("rampUpMinutesToWaitOnDisconnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampUpMinutesToWaitOnDisconnect = property.Value.GetInt32();
                    continue;
                }
                if (property.NameEquals("rampUpActionOnLogoff"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampUpActionOnLogoff = new SessionHandlingOperation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("rampUpMinutesToWaitOnLogoff"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampUpMinutesToWaitOnLogoff = property.Value.GetInt32();
                    continue;
                }
                ...
                if (property.NameEquals("peakStartVMOnConnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    peakStartVmOnConnect = new SetStartVmOnConnect(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("peakActionOnDisconnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    peakActionOnDisconnect = new SessionHandlingOperation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("peakMinutesToWaitOnDisconnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    peakMinutesToWaitOnDisconnect = property.Value.GetInt32();
                    continue;
                }
                if (property.NameEquals("peakActionOnLogoff"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    peakActionOnLogoff = new SessionHandlingOperation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("peakMinutesToWaitOnLogoff"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    peakMinutesToWaitOnLogoff = property.Value.GetInt32();
                    continue;
                }
                ...
                if (property.NameEquals("rampDownStartVMOnConnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampDownStartVmOnConnect = new SetStartVmOnConnect(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("rampDownActionOnDisconnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampDownActionOnDisconnect = new SessionHandlingOperation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("rampDownMinutesToWaitOnDisconnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampDownMinutesToWaitOnDisconnect = property.Value.GetInt32();
                    continue;
                }
                if (property.NameEquals("rampDownActionOnLogoff"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampDownActionOnLogoff = new SessionHandlingOperation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("rampDownMinutesToWaitOnLogoff"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rampDownMinutesToWaitOnLogoff = property.Value.GetInt32();
                    continue;
                }
                ...
                if (property.NameEquals("offPeakStartVMOnConnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    offPeakStartVmOnConnect = new SetStartVmOnConnect(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("offPeakActionOnDisconnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    offPeakActionOnDisconnect = new SessionHandlingOperation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("offPeakMinutesToWaitOnDisconnect"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    offPeakMinutesToWaitOnDisconnect = property.Value.GetInt32();
                    continue;
                }
                if (property.NameEquals("offPeakActionOnLogoff"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    offPeakActionOnLogoff = new SessionHandlingOperation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("offPeakMinutesToWaitOnLogoff"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    offPeakMinutesToWaitOnLogoff = property.Value.GetInt32();
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<ScalingPlanPersonalSchedulePatchProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPersonalSchedulePatchProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ScalingPlanPersonalSchedulePatchProperties IPersistableModel<ScalingPlanPersonalSchedulePatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPersonalSchedulePatchProperties>)this).GetFormatFromOptions(options) : options.Format;
