...
{
    public partial class StartMenuItemProperties : IUtf8JsonSerializable, IJsonModel<StartMenuItemProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StartMenuItemProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<StartMenuItemProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        StartMenuItemProperties IJsonModel<StartMenuItemProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StartMenuItemProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static StartMenuItemProperties DeserializeStartMenuItemProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            {
                if (property.NameEquals("appAlias"u8))
                {
                    appAlias = property.Value.GetString();
                    continue;
                }
        ...
        BinaryData IPersistableModel<StartMenuItemProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StartMenuItemProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        StartMenuItemProperties IPersistableModel<StartMenuItemProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StartMenuItemProperties>)this).GetFormatFromOptions(options) : options.Format;
