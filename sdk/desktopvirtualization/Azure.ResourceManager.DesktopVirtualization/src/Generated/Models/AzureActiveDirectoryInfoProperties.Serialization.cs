...
{
    internal partial class AzureActiveDirectoryInfoProperties : IUtf8JsonSerializable, IJsonModel<AzureActiveDirectoryInfoProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureActiveDirectoryInfoProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureActiveDirectoryInfoProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureActiveDirectoryInfoProperties IJsonModel<AzureActiveDirectoryInfoProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureActiveDirectoryInfoProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AzureActiveDirectoryInfoProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureActiveDirectoryInfoProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureActiveDirectoryInfoProperties IPersistableModel<AzureActiveDirectoryInfoProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureActiveDirectoryInfoProperties>)this).GetFormatFromOptions(options) : options.Format;
