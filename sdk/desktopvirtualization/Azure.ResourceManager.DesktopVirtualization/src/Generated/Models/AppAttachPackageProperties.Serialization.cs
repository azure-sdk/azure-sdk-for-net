...
{
    public partial class AppAttachPackageProperties : IUtf8JsonSerializable
    {
        ...
        internal static AppAttachPackageProperties DeserializeAppAttachPackageProperties(JsonElement element)
        {
            ...
            return new AppAttachPackageProperties(Optional.ToNullable(provisioningState), image.Value, Optional.ToList(hostPoolReferences), keyVaultURL.Value, Optional.ToNullable(failHealthCheckOnStagingFailure));
        }
    }
}
