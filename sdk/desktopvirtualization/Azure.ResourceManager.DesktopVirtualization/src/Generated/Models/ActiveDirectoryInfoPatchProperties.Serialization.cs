...
{
    internal partial class ActiveDirectoryInfoPatchProperties : IUtf8JsonSerializable, IJsonModel<ActiveDirectoryInfoPatchProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActiveDirectoryInfoPatchProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveDirectoryInfoPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ActiveDirectoryInfoPatchProperties IJsonModel<ActiveDirectoryInfoPatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveDirectoryInfoPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ActiveDirectoryInfoPatchProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveDirectoryInfoPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ActiveDirectoryInfoPatchProperties IPersistableModel<ActiveDirectoryInfoPatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveDirectoryInfoPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
