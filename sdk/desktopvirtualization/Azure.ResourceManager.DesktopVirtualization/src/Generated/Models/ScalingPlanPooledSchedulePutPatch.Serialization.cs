...
{
    public partial class ScalingPlanPooledSchedulePutPatch : IUtf8JsonSerializable, IJsonModel<ScalingPlanPooledSchedulePutPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPooledSchedulePutPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ScalingPlanPooledSchedulePutPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePutPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScalingPlanPooledSchedulePutPatch)} does not support writing '{format}' format.");
            }
        ...
        ScalingPlanPooledSchedulePutPatch IJsonModel<ScalingPlanPooledSchedulePutPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePutPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScalingPlanPooledSchedulePutPatch)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeScalingPlanPooledSchedulePutPatch(document.RootElement, options);
        }

        internal static ScalingPlanPooledSchedulePutPatch DeserializeScalingPlanPooledSchedulePutPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ScalingPlanPooledSchedulePutPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePutPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScalingPlanPooledSchedulePutPatch)} does not support writing '{options.Format}' format.");
            }
        }

        ScalingPlanPooledSchedulePutPatch IPersistableModel<ScalingPlanPooledSchedulePutPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePutPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScalingPlanPooledSchedulePutPatch)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ScalingPlanPooledSchedulePutPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
