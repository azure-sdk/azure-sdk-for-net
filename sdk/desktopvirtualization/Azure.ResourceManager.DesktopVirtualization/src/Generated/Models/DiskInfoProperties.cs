...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class DiskInfoProperties
    {
        ...
        internal DiskInfoProperties(ManagedDiskProperties managedDisk, DiffDiskProperties diffDiskSettings, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        {
            get => ManagedDisk is null ? default : ManagedDisk.VirtualMachineDiskType;
            set
            {
                if (ManagedDisk is null)
                    ManagedDisk = new ManagedDiskProperties();
                ManagedDisk.VirtualMachineDiskType = value;
            }
        }
