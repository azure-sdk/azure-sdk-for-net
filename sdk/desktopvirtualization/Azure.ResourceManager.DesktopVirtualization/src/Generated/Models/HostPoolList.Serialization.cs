...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HostPoolList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HostPoolList)} does not support writing '{format}' format.");
            }
        ...
        HostPoolList IJsonModel<HostPoolList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HostPoolList)} does not support reading '{format}' format.");
            }
        ...
        internal static HostPoolList DeserializeHostPoolList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HostPoolList(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<HostPoolList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HostPoolList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        HostPoolList IPersistableModel<HostPoolList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HostPoolList)} does not support reading '{options.Format}' format.");
            }
        }
