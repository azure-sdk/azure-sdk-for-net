...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    public partial class SessionHostConfigurationPatch : IUtf8JsonSerializable, IJsonModel<SessionHostConfigurationPatch>
    {
        ...
        internal static SessionHostConfigurationPatch DeserializeSessionHostConfigurationPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            SessionHostConfigurationPatchProperties properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = SessionHostConfigurationPatchProperties.DeserializeSessionHostConfigurationPatchProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new SessionHostConfigurationPatch(properties, serializedAdditionalRawData);
        }
