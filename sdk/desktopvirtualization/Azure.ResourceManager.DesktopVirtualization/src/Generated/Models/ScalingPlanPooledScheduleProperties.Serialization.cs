...
{
    public partial class ScalingPlanPooledScheduleProperties : IUtf8JsonSerializable, IJsonModel<ScalingPlanPooledScheduleProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPooledScheduleProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ScalingPlanPooledScheduleProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledScheduleProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ScalingPlanPooledScheduleProperties IJsonModel<ScalingPlanPooledScheduleProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledScheduleProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ScalingPlanPooledScheduleProperties DeserializeScalingPlanPooledScheduleProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ScalingPlanPooledScheduleProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledScheduleProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ScalingPlanPooledScheduleProperties IPersistableModel<ScalingPlanPooledScheduleProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledScheduleProperties>)this).GetFormatFromOptions(options) : options.Format;
