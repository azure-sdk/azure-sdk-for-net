...
{
    internal partial class ActiveSessionHostConfigurationList : IUtf8JsonSerializable, IJsonModel<ActiveSessionHostConfigurationList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActiveSessionHostConfigurationList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveSessionHostConfigurationList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ActiveSessionHostConfigurationList IJsonModel<ActiveSessionHostConfigurationList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveSessionHostConfigurationList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ActiveSessionHostConfigurationList DeserializeActiveSessionHostConfigurationList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ActiveSessionHostConfigurationData> value = default;
            ...
            return new ActiveSessionHostConfigurationList(value ?? new ChangeTrackingList<ActiveSessionHostConfigurationData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ActiveSessionHostConfigurationList>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveSessionHostConfigurationList>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ActiveSessionHostConfigurationList IPersistableModel<ActiveSessionHostConfigurationList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveSessionHostConfigurationList>)this).GetFormatFromOptions(options) : options.Format;
