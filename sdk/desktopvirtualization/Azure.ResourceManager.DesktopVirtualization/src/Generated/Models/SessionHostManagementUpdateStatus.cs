...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class SessionHostManagementUpdateStatus
    {
        ...
        internal SessionHostManagementUpdateStatus(string status)
        {
        ...
        internal SessionHostManagementUpdateStatus(string id, string name, string status, float? percentComplete, DateTimeOffset? startOn, DateTimeOffset? endOn, ResponseError error, string correlationId, SessionHostManagementOperationProgress progress, DateTimeOffset? scheduledOn, SessionHostManagementData sessionHostManagement, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Status = status;
