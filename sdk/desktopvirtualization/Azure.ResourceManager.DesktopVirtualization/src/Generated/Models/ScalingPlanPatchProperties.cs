...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class ScalingPlanPatchProperties
    {
        ...
        internal ScalingPlanPatchProperties(string description, string friendlyName, string timeZone, string exclusionTag, IList<ScalingSchedule> schedules, IList<ScalingHostPoolReference> hostPoolReferences, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
