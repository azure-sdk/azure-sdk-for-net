...
{
    public partial class ScalingPlanPooledSchedulePatchProperties : IUtf8JsonSerializable, IJsonModel<ScalingPlanPooledSchedulePatchProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPooledSchedulePatchProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ScalingPlanPooledSchedulePatchProperties IJsonModel<ScalingPlanPooledSchedulePatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ScalingPlanPooledSchedulePatchProperties DeserializeScalingPlanPooledSchedulePatchProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ScalingPlanPooledSchedulePatchProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePatchProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ScalingPlanPooledSchedulePatchProperties IPersistableModel<ScalingPlanPooledSchedulePatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ScalingPlanPooledSchedulePatchProperties>)this).GetFormatFromOptions(options) : options.Format;
