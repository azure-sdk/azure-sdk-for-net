...
{
    public partial class ExpandMsixImageProperties : IUtf8JsonSerializable, IJsonModel<ExpandMsixImageProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpandMsixImageProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExpandMsixImageProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ExpandMsixImageProperties IJsonModel<ExpandMsixImageProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExpandMsixImageProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ExpandMsixImageProperties DeserializeExpandMsixImageProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ExpandMsixImageProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExpandMsixImageProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ExpandMsixImageProperties IPersistableModel<ExpandMsixImageProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExpandMsixImageProperties>)this).GetFormatFromOptions(options) : options.Format;
