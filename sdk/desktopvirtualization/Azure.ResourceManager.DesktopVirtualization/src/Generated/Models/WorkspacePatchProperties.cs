...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class WorkspacePatchProperties
    {
        ...
        internal WorkspacePatchProperties(string description, string friendlyName, IList<string> applicationGroupReferences, DesktopVirtualizationPublicNetworkAccess? publicNetworkAccess, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
