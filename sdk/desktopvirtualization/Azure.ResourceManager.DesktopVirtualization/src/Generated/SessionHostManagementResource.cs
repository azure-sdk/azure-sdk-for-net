...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class SessionHostManagementResource : ArmResource
    {
        ...
        private readonly ControlSessionHostProvisioningRestOperations _controlSessionHostProvisioningRestClient;
        ...
        private readonly ClientDiagnostics _sessionHostProvisioningStatusesClientDiagnostics;
        private readonly SessionHostProvisioningStatusesRestOperations _sessionHostProvisioningStatusesRestClient;
        ...
        internal SessionHostManagementResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _controlSessionHostProvisioningClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DesktopVirtualization", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _controlSessionHostProvisioningRestClient = new ControlSessionHostProvisioningRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
            ...
            _sessionHostProvisioningStatusesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DesktopVirtualization", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _sessionHostProvisioningStatusesRestClient = new SessionHostProvisioningStatusesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
#if DEBUG
        ...
        /// </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="hostPoolProvisioningControlParameter"> Object containing control action for hostpool provisioning. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="hostPoolProvisioningControlParameter"/> is null. </exception>
        public virtual async Task<ArmOperation> PostControlSessionHostProvisioningAsync(WaitUntil waitUntil, HostPoolProvisioningControlParameter hostPoolProvisioningControlParameter, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(hostPoolProvisioningControlParameter, nameof(hostPoolProvisioningControlParameter));

            using var scope = _controlSessionHostProvisioningClientDiagnostics.CreateScope("SessionHostManagementResource.PostControlSessionHostProvisioning");
            scope.Start();
            try
            {
                var response = await _controlSessionHostProvisioningRestClient.PostAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, hostPoolProvisioningControlParameter, cancellationToken).ConfigureAwait(false);
                var operation = new DesktopVirtualizationArmOperation(_controlSessionHostProvisioningClientDiagnostics, Pipeline, _controlSessionHostProvisioningRestClient.CreatePostRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, hostPoolProvisioningControlParameter).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="hostPoolProvisioningControlParameter"/> is null. </exception>
        public virtual ArmOperation PostControlSessionHostProvisioning(WaitUntil waitUntil, HostPoolProvisioningControlParameter hostPoolProvisioningControlParameter, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(hostPoolProvisioningControlParameter, nameof(hostPoolProvisioningControlParameter));
            ...
            try
            {
                var response = _controlSessionHostProvisioningRestClient.Post(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, hostPoolProvisioningControlParameter, cancellationToken);
                var operation = new DesktopVirtualizationArmOperation(_controlSessionHostProvisioningClientDiagnostics, Pipeline, _controlSessionHostProvisioningRestClient.CreatePostRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, hostPoolProvisioningControlParameter).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SessionHostProvisioningStatuses_Get</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-03-01-preview</description>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<SessionHostManagementProvisioningStatus>> GetSessionHostProvisioningStatusAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _sessionHostProvisioningStatusesClientDiagnostics.CreateScope("SessionHostManagementResource.GetSessionHostProvisioningStatus");
            scope.Start();
            try
            {
                var response = await _sessionHostProvisioningStatusesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SessionHostManagementProvisioningStatus> GetSessionHostProvisioningStatus(CancellationToken cancellationToken = default)
        {
            using var scope = _sessionHostProvisioningStatusesClientDiagnostics.CreateScope("SessionHostManagementResource.GetSessionHostProvisioningStatus");
            scope.Start();
            try
            {
                var response = _sessionHostProvisioningStatusesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
