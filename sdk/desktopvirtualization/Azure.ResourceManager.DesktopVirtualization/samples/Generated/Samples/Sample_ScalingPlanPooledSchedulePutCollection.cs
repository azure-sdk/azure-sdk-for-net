...
{
    public partial class Sample_ScalingPlanPooledSchedulePutCollection
    {
        ...
        public async Task Get_ScalingPlanPooledSchedulesGet()
        {
            ...
            // get the collection of this ScalingPlanPooledSchedulePutResource
            ScalingPlanPooledSchedulePutCollection collection = scalingPlan.GetScalingPlanPooledSchedulePuts();

            // invoke the operation
            string scalingPlanScheduleName = "scalingPlanScheduleWeekdays1";
            ScalingPlanPooledSchedulePutResource result = await collection.GetAsync(scalingPlanScheduleName);
        ...
        public async Task GetIfExists_ScalingPlanPooledSchedulesGet()
        {
            ...
            // invoke the operation
            string scalingPlanScheduleName = "scalingPlanScheduleWeekdays1";
            NullableResponse<ScalingPlanPooledSchedulePutResource> response = await collection.GetIfExistsAsync(scalingPlanScheduleName);
            ScalingPlanPooledSchedulePutResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_ScalingPlanPooledSchedulesCreate()
        {
            ...
            // invoke the operation
            string scalingPlanScheduleName = "scalingPlanScheduleWeekdays1";
            ScalingPlanPooledSchedulePutData data = new ScalingPlanPooledSchedulePutData()
            {
                DaysOfWeek =
{
DesktopVirtualizationDayOfWeek.Monday,DesktopVirtualizationDayOfWeek.Tuesday,DesktopVirtualizationDayOfWeek.Wednesday,DesktopVirtualizationDayOfWeek.Thursday,DesktopVirtualizationDayOfWeek.Friday
            ...
            ArmOperation<ScalingPlanPooledSchedulePutResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, scalingPlanScheduleName, data);
            ScalingPlanPooledSchedulePutResource result = lro.Value;
        ...
        public async Task GetAll_ScalingPlanPooledSchedulesList()
        {
            ...
            int? initialSkip = 0;
            await foreach (ScalingPlanPooledSchedulePutResource item in collection.GetAllAsync(pageSize: pageSize, isDescending: isDescending, initialSkip: initialSkip))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ScalingPlanPooledSchedulePutData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
