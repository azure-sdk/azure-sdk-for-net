...
namespace Azure.ResourceManager.DesktopVirtualization.Samples
{
    public partial class Sample_ScalingPlanPooledScheduleCollection
    {
        ...
        public async Task CreateOrUpdate_ScalingPlanPooledScheduleCreateUsingCreateDelete()
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/ScalingPlanPooledSchedule_CreateUsingCreateDelete.json
            ...
            ScalingPlanPooledScheduleData data = new ScalingPlanPooledScheduleData(
                new DesktopVirtualizationDayOfWeek[] { DesktopVirtualizationDayOfWeek.Monday, DesktopVirtualizationDayOfWeek.Tuesday, DesktopVirtualizationDayOfWeek.Wednesday, DesktopVirtualizationDayOfWeek.Thursday, DesktopVirtualizationDayOfWeek.Friday },
                new ScalingActionTime(6, 0),
                80,
                new ScalingActionTime(8, 0),
                new ScalingActionTime(18, 0),
                50,
                new ScalingActionTime(20, 0))
            {
                ScalingMethod = ScalingMethod.CreateDeletePowerManage,
                CreateDelete = new CreateDeleteProperties
                {
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/ScalingPlanPooledSchedule_Create.json
            // this example is just showing the usage of "ScalingPlanPooledSchedules_Create" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/ScalingPlanPooledSchedule_Get.json
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/ScalingPlanPooledSchedule_List.json
