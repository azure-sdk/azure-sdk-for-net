...
namespace Azure.ResourceManager.DesktopVirtualization.Samples
{
    public partial class Sample_SessionHostManagementResource
    {
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/SessionHostManagements_Get.json
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/SessionHostManagements_Update.json
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/SessionHostManagements_Create.json
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/SessionHostManagements_UpdateSessionHosts_Post.json
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/SessionHostManagements_ControlSessionHostUpdate_Post.json
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task PostControlSessionHostProvisioning_ControlSessionHostProvisioningPost()
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/SessionHostManagements_ControlSessionHostProvisioning_Post.json
            // this example is just showing the usage of "ControlSessionHostProvisioning_Post" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            HostPoolProvisioningControlParameter hostPoolProvisioningControlParameter = new HostPoolProvisioningControlParameter(HostPoolProvisioningAction.Cancel)
            {
                CancelMessage = "Cancel host pool provisioning",
            };
            await sessionHostManagement.PostControlSessionHostProvisioningAsync(WaitUntil.Completed, hostPoolProvisioningControlParameter);
        ...
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/SessionHostManagements_UpdateStatus_Get.json
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetSessionHostProvisioningStatus_SessionHostProvisioningStatusesGet()
        {
            // Generated from example definition: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/SessionHostManagements_SessionHostProvisioningStatuses_Get.json
            // this example is just showing the usage of "SessionHostProvisioningStatuses_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            SessionHostManagementProvisioningStatus result = await sessionHostManagement.GetSessionHostProvisioningStatusAsync();
