...
namespace Azure.ResourceManager.MachineLearning.Samples
{
    public partial class Sample_WorkspaceConnectionDeploymentResource
    {
        ...
        public async Task Update_CreateAzureOpenAIConnectionDeployment()
        {
            ...
            // invoke the operation
            EndpointDeploymentResourcePropertiesBasicResourceData data = new EndpointDeploymentResourcePropertiesBasicResourceData(new EndpointDeploymentResourceProperties(new EndpointDeploymentModel()
            {
                Format = "OpenAI",
