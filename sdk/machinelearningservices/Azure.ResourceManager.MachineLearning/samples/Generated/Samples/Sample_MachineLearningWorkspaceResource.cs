                    ...
                    Udr =
{
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetConnectionModels_ListConnectionModels()
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/preview/2024-07-01-preview/examples/Workspace/listConnectionModels.json
            // this example is just showing the usage of "Workspaces_ListConnectionModels" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation and iterate over the result
            await foreach (AccountModel item in machineLearningWorkspace.GetConnectionModelsAsync())
            {
                Console.WriteLine($"Succeeded: {item}");
            }
