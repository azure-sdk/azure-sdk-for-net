...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class RaiBlocklistItemPropertiesBasicResource : ArmResource
    {
        ...
        {
            _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MachineLearning", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistApiVersion);
        ...
        {
            using var scope = _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistClientDiagnostics.CreateScope("RaiBlocklistItemPropertiesBasicResource.Get");
            scope.Start();
            try
            {
                var response = await _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<RaiBlocklistItemPropertiesBasicResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new RaiBlocklistItemPropertiesBasicResource(Client, response.Value), response.GetRawResponse());
            }
