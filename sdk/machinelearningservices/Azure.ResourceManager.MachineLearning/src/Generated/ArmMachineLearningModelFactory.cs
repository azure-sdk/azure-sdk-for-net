...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public static partial class ArmMachineLearningModelFactory
    {
        ...
        /// The available derived classes include <see cref="FqdnOutboundRule"/>, <see cref="Models.PrivateEndpointOutboundRule"/> and <see cref="ServiceTagOutboundRule"/>.
        /// </param>
        ...
        public static MachineLearningWorkspaceConnectionProperties MachineLearningWorkspaceConnectionProperties(string authType = null, MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null)
        {
        ...
        public static EndpointDeploymentResourceProperties EndpointDeploymentResourceProperties(EndpointDeploymentModel model = null, string raiPolicyName = null, DeploymentModelVersionUpgradeOption? versionUpgradeOption = null, DefaultResourceProvisioningState? provisioningState = null)
        {
            return new EndpointDeploymentResourceProperties(model, raiPolicyName, versionUpgradeOption, serializedAdditionalRawData: null, provisioningState);
        }

        /// <summary> Initializes a new instance of <see cref="Models.AccountModel"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.AccountModel"/> instance for mocking. </returns>
        public static AccountModel AccountModel(string format = null, string name = null, string version = null, string source = null, CallRateLimit callRateLimit = null, DeploymentModel baseModel = null, bool? isDefaultVersion = null, IEnumerable<ModelSku> skus = null, int? maxCapacity = null, IReadOnlyDictionary<string, string> capabilities = null, IReadOnlyDictionary<string, string> finetuneCapabilities = null, ModelDeprecationInfo deprecation = null, ModelLifecycleStatus? lifecycleStatus = null, SystemData systemData = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.DeploymentModel"/>. </summary>
        /// <param name="format"> Deployment model format. </param>
        /// <param name="name"> Deployment model name. </param>
        /// <param name="version"> Optional. Deployment model version. If version is not specified, a default version will be assigned. The default version is different for different models and might change when there is new version available for a model. Default version for a model could be found from list models API. </param>
        /// <param name="source"> Optional. Deployment model source ARM resource ID. </param>
        /// <param name="callRateLimit"> The call rate limit Cognitive Services account. </param>
        /// <returns> A new <see cref="Models.DeploymentModel"/> instance for mocking. </returns>
        public static DeploymentModel DeploymentModel(string format = null, string name = null, string version = null, string source = null, CallRateLimit callRateLimit = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.CallRateLimit"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.CallRateLimit"/> instance for mocking. </returns>
        public static CallRateLimit CallRateLimit(float? count = null, float? renewalPeriod = null, IEnumerable<ThrottlingRule> rules = null)
        {
            rules ??= new List<ThrottlingRule>();

            return new CallRateLimit(count, renewalPeriod, rules?.ToList(), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.ThrottlingRule"/>. </summary>
        ...
        public static ThrottlingRule ThrottlingRule(string key = null, float? renewalPeriod = null, float? count = null, float? minCount = null, bool? dynamicThrottlingEnabled = null, IEnumerable<RequestMatchPattern> matchPatterns = null)
        {
            matchPatterns ??= new List<RequestMatchPattern>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.RequestMatchPattern"/>. </summary>
        /// <param name="path"></param>
        /// <param name="method"></param>
        /// <returns> A new <see cref="Models.RequestMatchPattern"/> instance for mocking. </returns>
        public static RequestMatchPattern RequestMatchPattern(string path = null, string method = null)
        {
            return new RequestMatchPattern(path, method, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.ModelSku"/>. </summary>
        ...
        public static ModelSku ModelSku(string name = null, IEnumerable<string> connectionIds = null, string usageName = null, DateTimeOffset? deprecationOn = null, CapacityConfig capacity = null, IEnumerable<CallRateLimit> rateLimits = null)
        {
            connectionIds ??= new List<string>();
            rateLimits ??= new List<CallRateLimit>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.CapacityConfig"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.CapacityConfig"/> instance for mocking. </returns>
        public static CapacityConfig CapacityConfig(int? minimum = null, int? maximum = null, int? step = null, int? @default = null, IEnumerable<int> allowedValues = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ModelDeprecationInfo"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ModelDeprecationInfo"/> instance for mocking. </returns>
        public static ModelDeprecationInfo ModelDeprecationInfo(string fineTune = null, string inference = null)
        {
            return new ModelDeprecationInfo(fineTune, inference, serializedAdditionalRawData: null);
        }
        ...
        /// The available derived classes include <see cref="Models.ContentSafetyEndpointResourceProperties"/>, <see cref="Models.OpenAIEndpointResourceProperties"/>, <see cref="Models.SpeechEndpointResourceProperties"/> and <see cref="Models.ManagedOnlineEndpointResourceProperties"/>.
        /// </param>
        ...
        public static EndpointResourceProperties EndpointResourceProperties(ResourceIdentifier associatedResourceId = null, string endpointType = null, Uri endpointUri = null, string failureReason = null, string name = null, DefaultResourceProvisioningState? provisioningState = null, bool? shouldCreateAiServicesEndpoint = null)
        {
        ...
        public static AadAuthTypeWorkspaceConnectionProperties AadAuthTypeWorkspaceConnectionProperties(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static AccessKeyAuthTypeWorkspaceConnectionProperties AccessKeyAuthTypeWorkspaceConnectionProperties(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, WorkspaceConnectionAccessKey credentials = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static AccountKeyAuthTypeWorkspaceConnectionProperties AccountKeyAuthTypeWorkspaceConnectionProperties(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, string credentialsKey = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static ApiKeyAuthWorkspaceConnectionProperties ApiKeyAuthWorkspaceConnectionProperties(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, string credentialsKey = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static ContentSafetyEndpointResourceProperties ContentSafetyEndpointResourceProperties(ResourceIdentifier associatedResourceId = null, Uri endpointUri = null, string failureReason = null, string name = null, DefaultResourceProvisioningState? provisioningState = null, bool? shouldCreateAiServicesEndpoint = null)
        {
        ...
        public static CustomKeysWorkspaceConnectionProperties CustomKeysWorkspaceConnectionProperties(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, IDictionary<string, string> credentialsKeys = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static MachineLearningManagedIdentityAuthTypeWorkspaceConnection MachineLearningManagedIdentityAuthTypeWorkspaceConnection(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, MachineLearningWorkspaceConnectionManagedIdentity credentials = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static ManagedOnlineEndpointResourceProperties ManagedOnlineEndpointResourceProperties(ResourceIdentifier associatedResourceId = null, Uri endpointUri = null, string failureReason = null, string name = null, DefaultResourceProvisioningState? provisioningState = null, bool? shouldCreateAiServicesEndpoint = null)
        {
        ...
        public static MachineLearningNoneAuthTypeWorkspaceConnection MachineLearningNoneAuthTypeWorkspaceConnection(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static OAuth2AuthTypeWorkspaceConnectionProperties OAuth2AuthTypeWorkspaceConnectionProperties(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, WorkspaceConnectionOAuth2 credentials = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static OpenAIEndpointResourceProperties OpenAIEndpointResourceProperties(ResourceIdentifier associatedResourceId = null, Uri endpointUri = null, string failureReason = null, string name = null, DefaultResourceProvisioningState? provisioningState = null, bool? shouldCreateAiServicesEndpoint = null)
        {
        ...
        public static MachineLearningPatAuthTypeWorkspaceConnection MachineLearningPatAuthTypeWorkspaceConnection(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, string credentialsPat = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static PrivateEndpointOutboundRule PrivateEndpointOutboundRule(OutboundRuleCategory? category = null, OutboundRuleStatus? status = null, PrivateEndpointDestination destination = null, string parentRuleName = null)
        {
        ...
        public static MachineLearningSasAuthTypeWorkspaceConnection MachineLearningSasAuthTypeWorkspaceConnection(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, string credentialsSas = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static ServicePrincipalAuthTypeWorkspaceConnectionProperties ServicePrincipalAuthTypeWorkspaceConnectionProperties(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, WorkspaceConnectionServicePrincipal credentials = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
        ...
        public static SpeechEndpointResourceProperties SpeechEndpointResourceProperties(ResourceIdentifier associatedResourceId = null, Uri endpointUri = null, string failureReason = null, string name = null, DefaultResourceProvisioningState? provisioningState = null, bool? shouldCreateAiServicesEndpoint = null)
        {
        ...
        public static MachineLearningUsernamePasswordAuthTypeWorkspaceConnection MachineLearningUsernamePasswordAuthTypeWorkspaceConnection(MachineLearningConnectionCategory? category = null, ResourceIdentifier createdByWorkspaceArmId = null, DateTimeOffset? expiryOn = null, ConnectionGroup? group = null, bool? isSharedToAll = null, IDictionary<string, string> metadata = null, IEnumerable<string> sharedUserList = null, string target = null, MachineLearningWorkspaceConnectionUsernamePassword credentials = null)
        {
            metadata ??= new Dictionary<string, string>();
            sharedUserList ??= new List<string>();
