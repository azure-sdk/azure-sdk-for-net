...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class RaiBlocklistItemPropertiesBasicResourceCollection : ArmCollection, IEnumerable<RaiBlocklistItemPropertiesBasicResource>, IAsyncEnumerable<RaiBlocklistItemPropertiesBasicResource>
    {
        ...
        private readonly ClientDiagnostics _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistClientDiagnostics;
        private readonly ConnectionRaiBlocklistRestOperations _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient;
        ...
        internal RaiBlocklistItemPropertiesBasicResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MachineLearning", RaiBlocklistItemPropertiesBasicResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(RaiBlocklistItemPropertiesBasicResource.ResourceType, out string raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistApiVersion);
            _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient = new ConnectionRaiBlocklistRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistApiVersion);
        ...
        public virtual async Task<Response<RaiBlocklistItemPropertiesBasicResource>> GetAsync(string raiBlocklistItemName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistClientDiagnostics.CreateScope("RaiBlocklistItemPropertiesBasicResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, raiBlocklistItemName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<RaiBlocklistItemPropertiesBasicResource> Get(string raiBlocklistItemName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, raiBlocklistItemName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new RaiBlocklistItemPropertiesBasicResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string raiBlocklistItemName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistClientDiagnostics.CreateScope("RaiBlocklistItemPropertiesBasicResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, raiBlocklistItemName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string raiBlocklistItemName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, raiBlocklistItemName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<RaiBlocklistItemPropertiesBasicResource>> GetIfExistsAsync(string raiBlocklistItemName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistClientDiagnostics.CreateScope("RaiBlocklistItemPropertiesBasicResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _raiBlocklistItemPropertiesBasicResourceConnectionRaiBlocklistRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, raiBlocklistItemName, cancellationToken: cancellationToken).ConfigureAwait(false);
