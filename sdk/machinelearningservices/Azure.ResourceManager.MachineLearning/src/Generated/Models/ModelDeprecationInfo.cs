...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class ModelDeprecationInfo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ModelDeprecationInfo"/>. </summary>
        internal ModelDeprecationInfo()
        {
        }
        ...
        internal ModelDeprecationInfo(string fineTune, string inference, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FineTune = fineTune;
            Inference = inference;
