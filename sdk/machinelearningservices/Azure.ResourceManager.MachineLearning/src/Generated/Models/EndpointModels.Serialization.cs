...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class EndpointModels : IUtf8JsonSerializable, IJsonModel<EndpointModels>
    {
        ...
        internal static EndpointModels DeserializeEndpointModels(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<AccountModel> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(AccountModel.DeserializeAccountModel(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new EndpointModels(nextLink, value ?? new ChangeTrackingList<AccountModel>(), serializedAdditionalRawData);
        }
