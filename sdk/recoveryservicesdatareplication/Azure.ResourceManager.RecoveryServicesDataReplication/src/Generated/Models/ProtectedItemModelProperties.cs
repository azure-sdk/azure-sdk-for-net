...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class ProtectedItemModelProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ProtectedItemModelProperties"/>. </summary>
        ...
        internal ProtectedItemModelProperties(string policyName, string replicationExtensionName, string correlationId, ProvisioningState? provisioningState, ProtectionState? protectionState, string protectionStateDescription, TestFailoverState? testFailoverState, string testFailoverStateDescription, ResynchronizationState? resynchronizationState, string fabricObjectId, string fabricObjectName, string sourceFabricProviderId, string targetFabricProviderId, string fabricId, string targetFabricId, string fabricAgentId, string targetFabricAgentId, bool? resyncRequired, DateTimeOffset? lastSuccessfulPlannedFailoverOn, DateTimeOffset? lastSuccessfulUnplannedFailoverOn, DateTimeOffset? lastSuccessfulTestFailoverOn, ProtectedItemJobProperties currentJob, IReadOnlyList<string> allowedJobs, ProtectedItemJobProperties lastFailedEnableProtectionJob, ProtectedItemJobProperties lastFailedPlannedFailoverJob, ProtectedItemJobProperties lastTestFailoverJob, HealthStatus? replicationHealth, IReadOnlyList<HealthErrorModel> healthErrors, ProtectedItemModelCustomProperties customProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PolicyName = policyName;
            ReplicationExtensionName = replicationExtensionName;
        ...
        /// <summary> Initializes a new instance of <see cref="ProtectedItemModelProperties"/> for deserialization. </summary>
        internal ProtectedItemModelProperties()
        {
        }
