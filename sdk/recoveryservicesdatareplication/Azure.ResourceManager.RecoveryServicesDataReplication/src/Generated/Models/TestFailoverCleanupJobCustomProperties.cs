...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class TestFailoverCleanupJobCustomProperties : DataReplicationJobCustomProperties
    {
        ...
        internal TestFailoverCleanupJobCustomProperties(string instanceType, JobModelCustomPropertiesAffectedObjectDetails affectedObjectDetails, IDictionary<string, BinaryData> serializedAdditionalRawData, string comments) : base(instanceType, affectedObjectDetails, serializedAdditionalRawData)
        {
            Comments = comments;
