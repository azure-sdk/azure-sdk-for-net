...
namespace Azure.ResourceManager.Recoveryservicesdatareplication.Models
{
    ...
    public partial class HyperVToAzStackHCIProtectedDiskProperties
    {
        ...
        internal HyperVToAzStackHCIProtectedDiskProperties(string storageContainerId, string storageContainerLocalPath, string sourceDiskId, string sourceDiskName, string seedDiskName, string testMigrateDiskName, string migrateDiskName, bool? isOSDisk, long? capacityInBytes, bool? isDynamic, string diskType)
        {
