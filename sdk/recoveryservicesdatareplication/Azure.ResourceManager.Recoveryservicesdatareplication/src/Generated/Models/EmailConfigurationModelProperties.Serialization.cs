...
{
    public partial class EmailConfigurationModelProperties : IUtf8JsonSerializable
    {
        ...
        internal static EmailConfigurationModelProperties DeserializeEmailConfigurationModelProperties(JsonElement element)
        {
            ...
            return new EmailConfigurationModelProperties(sendToOwners, Optional.ToList(customEmailAddresses), locale.Value);
        }
    }
}
