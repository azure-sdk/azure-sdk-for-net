...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class ProjectResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ServerCollectors_Get</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>VMwareCollectors_Get</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Projects_AssessmentOptions</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Projects_AssessmentOptionsList</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _projectRestClient.CreateAssessmentOptionsListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, Models.AssessmentOptions.DeserializeAssessmentOptions, _projectClientDiagnostics, Pipeline, "ProjectResource.AssessmentOptionsList", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _projectRestClient.CreateAssessmentOptionsListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, Models.AssessmentOptions.DeserializeAssessmentOptions, _projectClientDiagnostics, Pipeline, "ProjectResource.AssessmentOptionsList", "value", null, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Assessments_ListByProject</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessmentRestClient.CreateListByProjectRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new AssessmentResource(Client, AssessmentData.DeserializeAssessmentData(e)), _assessmentClientDiagnostics, Pipeline, "ProjectResource.GetAssessments", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessmentRestClient.CreateListByProjectRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => new AssessmentResource(Client, AssessmentData.DeserializeAssessmentData(e)), _assessmentClientDiagnostics, Pipeline, "ProjectResource.GetAssessments", "value", null, cancellationToken);
        }
    }
}
