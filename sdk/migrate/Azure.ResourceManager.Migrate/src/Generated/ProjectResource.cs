...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class ProjectResource : ArmResource
    {
        ...
        public virtual AsyncPageable<AssessmentOptions> AssessmentOptionsListAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, Models.AssessmentOptions.DeserializeAssessmentOptions, _projectClientDiagnostics, Pipeline, "ProjectResource.AssessmentOptionsList", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _projectRestClient.CreateAssessmentOptionsListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, Models.AssessmentOptions.DeserializeAssessmentOptions, _projectClientDiagnostics, Pipeline, "ProjectResource.AssessmentOptionsList", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<AssessmentResource> GetAssessmentsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new AssessmentResource(Client, AssessmentData.DeserializeAssessmentData(e)), _assessmentClientDiagnostics, Pipeline, "ProjectResource.GetAssessments", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessmentRestClient.CreateListByProjectRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new AssessmentResource(Client, AssessmentData.DeserializeAssessmentData(e)), _assessmentClientDiagnostics, Pipeline, "ProjectResource.GetAssessments", "value", null, cancellationToken);
        }
    }
}
