...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    public partial class Error
    {
        ...
        internal Error()
        {
            MessageParameters = new ChangeTrackingList<NameValuePair>();
        }
        ...
        internal Error(int? id, string code, string runAsAccountId, string applianceName, string message, string summaryMessage, string agentScenario, string possibleCauses, string recommendedAction, string severity, IReadOnlyList<NameValuePair> messageParameters, DateTimeOffset? updatedTimeStamp, string impactedAssessmentType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Code = code;
        ...
        public IReadOnlyList<NameValuePair> MessageParameters { get; }
