...
namespace Azure.ResourceManager.Migrate.Models
{
    public partial class AssessmentOptionsProperties
    {
        internal static AssessmentOptionsProperties DeserializeAssessmentOptionsProperties(JsonElement element)
        {
            ...
            {
                if (property.NameEquals("vmFamilies"u8))
                {
                ...
                if (property.NameEquals("reservedInstanceVmFamilies"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (property.NameEquals("reservedInstanceSupportedLocations"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (property.NameEquals("reservedInstanceSupportedCurrencies"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (property.NameEquals("reservedInstanceSupportedOffers"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
