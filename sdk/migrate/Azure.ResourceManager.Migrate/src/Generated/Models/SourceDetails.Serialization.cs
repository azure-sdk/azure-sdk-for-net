    ...
    public partial class SourceDetails : IUtf8JsonSerializable, IJsonModel<SourceDetails>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(SourceName))
            {
                ...
                writer.WriteStringValue(SourceName.Value.ToString());
            }
            if (options.Format != "W" && Optional.IsDefined(SourceType))
            {
        ...
        internal static SourceDetails DeserializeSourceDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AssessmentSource? sourceName = default;
            MigrateWorkloadType? sourceType = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sourceName"u8))
                {
                    ...
                    sourceName = new AssessmentSource(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("sourceType"u8))
                {
                    ...
                    sourceType = new MigrateWorkloadType(property.Value.GetString());
                    continue;
                }
            ...
            return new SourceDetails(sourceName, sourceType, platform, count, serializedAdditionalRawData);
        }
