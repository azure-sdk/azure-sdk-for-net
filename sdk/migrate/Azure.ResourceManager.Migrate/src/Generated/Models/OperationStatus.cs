...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    public partial class OperationStatus
    {
        ...
        internal OperationStatus(string id, string name, string status, string startTime, string endTime, OperationStatusError error, OperationStatusProperties properties)
        {
            Id = id;
            Name = name;
            Status = status;
