...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    public partial class MachineAssessmentOptionsOutboundEdgeGroup
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="targetLocations"/>, <paramref name="currencies"/>, <paramref name="savingsOptions"/>, <paramref name="licensingProgram"/>, <paramref name="azureVmFamilies"/>, <paramref name="azureVmFamilyCategories"/>, <paramref name="premiumDiskSupport"/>, <paramref name="ultraDiskSupport"/> or <paramref name="azureOfferCode"/> is null. </exception>
        internal MachineAssessmentOptionsOutboundEdgeGroup(IEnumerable<AzureLocation> targetLocations, IEnumerable<AzureCurrency> currencies, IEnumerable<SavingsOption> savingsOptions, IEnumerable<LicensingProgram> licensingProgram, IEnumerable<AzureVmFamily> azureVmFamilies, IEnumerable<VmFamilyCategoryItem> azureVmFamilyCategories, IEnumerable<PremiumDiskSupport> premiumDiskSupport, IEnumerable<UltraDiskSupport> ultraDiskSupport, IEnumerable<AzureOffer> azureOfferCode)
        {
