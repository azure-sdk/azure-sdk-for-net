...
{
    /// <summary> Summary properties class. </summary>
    public partial class SummaryProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SummaryProperties"/>. </summary>
        internal SummaryProperties()
        {
        ...
        internal SummaryProperties(SummaryType? summaryType, string summaryName, IReadOnlyList<SourceDetails> sources, IReadOnlyList<TargetDetails> targets, IReadOnlyList<TargetSourcePair> targetSourceMapping, IReadOnlyList<CostDetailsCommon> costComponents, IReadOnlyList<SavingsDetailsCommon> savingsComponents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
