...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class GroupCollection : ArmCollection, IEnumerable<GroupResource>, IAsyncEnumerable<GroupResource>
    {
        ...
        public virtual AsyncPageable<GroupResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new GroupResource(Client, GroupData.DeserializeGroupData(e)), _groupClientDiagnostics, Pipeline, "GroupCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _groupRestClient.CreateListByProjectRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new GroupResource(Client, GroupData.DeserializeGroupData(e)), _groupClientDiagnostics, Pipeline, "GroupCollection.GetAll", "value", null, cancellationToken);
        }
