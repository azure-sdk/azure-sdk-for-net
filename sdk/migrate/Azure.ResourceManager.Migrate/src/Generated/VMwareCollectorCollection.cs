...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class VMwareCollectorCollection : ArmCollection, IEnumerable<VMwareCollectorResource>, IAsyncEnumerable<VMwareCollectorResource>
    {
        ...
        public virtual AsyncPageable<VMwareCollectorResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new VMwareCollectorResource(Client, VMwareCollectorData.DeserializeVMwareCollectorData(e)), _vMwareCollectorClientDiagnostics, Pipeline, "VMwareCollectorCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _vMwareCollectorRestClient.CreateListByProjectRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new VMwareCollectorResource(Client, VMwareCollectorData.DeserializeVMwareCollectorData(e)), _vMwareCollectorClientDiagnostics, Pipeline, "VMwareCollectorCollection.GetAll", "value", null, cancellationToken);
        }
