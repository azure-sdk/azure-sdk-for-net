...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class VMwareCollectorCollection : ArmCollection, IEnumerable<VMwareCollectorResource>, IAsyncEnumerable<VMwareCollectorResource>
    {
        ...
        /// <description>VMwareCollectors_Create</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>VMwareCollectors_ListByProject</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _vMwareCollectorRestClient.CreateListByProjectRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new VMwareCollectorResource(Client, VMwareCollectorData.DeserializeVMwareCollectorData(e)), _vMwareCollectorClientDiagnostics, Pipeline, "VMwareCollectorCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _vMwareCollectorRestClient.CreateListByProjectRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => new VMwareCollectorResource(Client, VMwareCollectorData.DeserializeVMwareCollectorData(e)), _vMwareCollectorClientDiagnostics, Pipeline, "VMwareCollectorCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="vmWareCollectorName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="vmWareCollectorName"/> is null. </exception>
        public virtual async Task<NullableResponse<VMwareCollectorResource>> GetIfExistsAsync(string vmWareCollectorName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(vmWareCollectorName, nameof(vmWareCollectorName));

            using var scope = _vMwareCollectorClientDiagnostics.CreateScope("VMwareCollectorCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _vMwareCollectorRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, vmWareCollectorName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    return new NoValueResponse<VMwareCollectorResource>(response.GetRawResponse());
                return Response.FromValue(new VMwareCollectorResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="vmWareCollectorName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="vmWareCollectorName"/> is null. </exception>
        public virtual NullableResponse<VMwareCollectorResource> GetIfExists(string vmWareCollectorName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(vmWareCollectorName, nameof(vmWareCollectorName));
