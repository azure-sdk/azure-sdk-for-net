...
namespace Azure.ResourceManager.Migrate.Mocking
{
    ...
    public partial class MockableMigrateResourceGroupResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of CompoundAssessmentResources in the ResourceGroupResource. </summary>
        ...
        public virtual CompoundAssessmentCollection GetCompoundAssessments(string projectName)
        {
            return new CompoundAssessmentCollection(Client, Id, projectName);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="projectName"/> or <paramref name="compoundAssessmentName"/> is null. </exception>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<CompoundAssessmentResource>> GetCompoundAssessmentAsync(string projectName, string compoundAssessmentName, CancellationToken cancellationToken = default)
        {
            return await GetCompoundAssessments(projectName).GetAsync(compoundAssessmentName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="projectName"/> or <paramref name="compoundAssessmentName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<CompoundAssessmentResource> GetCompoundAssessment(string projectName, string compoundAssessmentName, CancellationToken cancellationToken = default)
        {
            return GetCompoundAssessments(projectName).Get(compoundAssessmentName, cancellationToken);
        }
    }
}
