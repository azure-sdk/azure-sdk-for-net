...
namespace Azure.ResourceManager.Migrate
{
    ...
    public static partial class MigrateExtensions
    {
        ...
        {
            return GetSubscriptionResourceExtensionClient(subscriptionResource).GetProjectsAsync(cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtensionClient(subscriptionResource).GetProjects(cancellationToken);
        }
    }
}
