...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class AssessedMachineCollection : ArmCollection, IEnumerable<AssessedMachineResource>, IAsyncEnumerable<AssessedMachineResource>
    {
        ...
        public virtual AsyncPageable<AssessedMachineResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new AssessedMachineResource(Client, AssessedMachineData.DeserializeAssessedMachineData(e)), _assessedMachineClientDiagnostics, Pipeline, "AssessedMachineCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<AssessedMachineResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessedMachineRestClient.CreateListByAssessmentRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _assessedMachineRestClient.CreateListByAssessmentNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new AssessedMachineResource(Client, AssessedMachineData.DeserializeAssessedMachineData(e)), _assessedMachineClientDiagnostics, Pipeline, "AssessedMachineCollection.GetAll", "value", "nextLink", cancellationToken);
        }
