...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class AssessedMachineCollection : ArmCollection, IEnumerable<AssessedMachineResource>, IAsyncEnumerable<AssessedMachineResource>
    {
        ...
        /// <description>AssessedMachines_Get</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AssessedMachines_ListByAssessment</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessedMachineRestClient.CreateListByAssessmentRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _assessedMachineRestClient.CreateListByAssessmentNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new AssessedMachineResource(Client, AssessedMachineData.DeserializeAssessedMachineData(e)), _assessedMachineClientDiagnostics, Pipeline, "AssessedMachineCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<AssessedMachineResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessedMachineRestClient.CreateListByAssessmentRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _assessedMachineRestClient.CreateListByAssessmentNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new AssessedMachineResource(Client, AssessedMachineData.DeserializeAssessedMachineData(e)), _assessedMachineClientDiagnostics, Pipeline, "AssessedMachineCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<NullableResponse<AssessedMachineResource>> GetIfExistsAsync(string assessedMachineName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _assessedMachineClientDiagnostics.CreateScope("AssessedMachineCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _assessedMachineRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, assessedMachineName, cancellationToken: cancellationToken).ConfigureAwait(false);
