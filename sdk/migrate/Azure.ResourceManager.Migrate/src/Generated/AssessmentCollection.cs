...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class AssessmentCollection : ArmCollection, IEnumerable<AssessmentResource>, IAsyncEnumerable<AssessmentResource>
    {
        ...
        public virtual AsyncPageable<AssessmentResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new AssessmentResource(Client, AssessmentData.DeserializeAssessmentData(e)), _assessmentClientDiagnostics, Pipeline, "AssessmentCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessmentRestClient.CreateListByGroupRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new AssessmentResource(Client, AssessmentData.DeserializeAssessmentData(e)), _assessmentClientDiagnostics, Pipeline, "AssessmentCollection.GetAll", "value", null, cancellationToken);
        }
