...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class AssessmentCollection : ArmCollection, IEnumerable<AssessmentResource>, IAsyncEnumerable<AssessmentResource>
    {
        ...
        /// <description>Assessments_Create</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Assessments_ListByGroup</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessmentRestClient.CreateListByGroupRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new AssessmentResource(Client, AssessmentData.DeserializeAssessmentData(e)), _assessmentClientDiagnostics, Pipeline, "AssessmentCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _assessmentRestClient.CreateListByGroupRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => new AssessmentResource(Client, AssessmentData.DeserializeAssessmentData(e)), _assessmentClientDiagnostics, Pipeline, "AssessmentCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<NullableResponse<AssessmentResource>> GetIfExistsAsync(string assessmentName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _assessmentClientDiagnostics.CreateScope("AssessmentCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _assessmentRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, assessmentName, cancellationToken: cancellationToken).ConfigureAwait(false);
