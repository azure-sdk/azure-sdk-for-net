...
namespace Azure.ResourceManager.Migrate.Samples
{
    public partial class Sample_HyperVCollectorCollection
    {
        ...
        public async Task GetAll_HyperVCollectorsListByProject()
        {
            // Generated from example definition: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/stable/2019-10-01/examples/HyperVCollectors_ListByProject.json
            // this example is just showing the usage of "HyperVCollectors_ListByProject" operation, for the dependent resources, they will have to be created separately.
            ...
            HyperVCollectorCollection collection = project.GetHyperVCollectors();
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_HyperVCollectorsGet()
        {
            // Generated from example definition: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/stable/2019-10-01/examples/HyperVCollectors_Get.json
            // this example is just showing the usage of "HyperVCollectors_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_HyperVCollectorsGet()
        {
            // Generated from example definition: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/stable/2019-10-01/examples/HyperVCollectors_Get.json
            // this example is just showing the usage of "HyperVCollectors_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_HyperVCollectorsCreate()
        {
