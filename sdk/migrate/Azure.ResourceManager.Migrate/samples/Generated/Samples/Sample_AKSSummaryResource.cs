...
{
    public partial class Sample_AKSSummaryResource
    {
        [Test]
        ...
        public async Task Get_AksSummaryOperationsGetMaximumSet()
        {
            ...
            // this example assumes you already have this AKSSummaryResource created on azure
            // for more information of creating AKSSummaryResource, please refer to the document of AKSSummaryResource
            ...
            ResourceIdentifier aksSummaryResourceId = AKSSummaryResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, projectName, assessmentName, summaryName);
            AKSSummaryResource aksSummary = client.GetAKSSummaryResource(aksSummaryResourceId);

            // invoke the operation
            AKSSummaryResource result = await aksSummary.GetAsync();
