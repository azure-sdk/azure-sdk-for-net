...
namespace Azure.ResourceManager.DurableTask
{
    ...
    public static partial class DurableTaskExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="SchedulerPrivateLinkResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableDurableTaskArmClient.GetSchedulerPrivateLinkResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static SchedulerPrivateLinkResource GetSchedulerPrivateLinkResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableDurableTaskArmClient(client).GetSchedulerPrivateLinkResource(id);
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableDurableTaskArmClient.GetPrivateEndpointConnectionResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static PrivateEndpointConnectionResource GetPrivateEndpointConnectionResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableDurableTaskArmClient(client).GetPrivateEndpointConnectionResource(id);
        }
