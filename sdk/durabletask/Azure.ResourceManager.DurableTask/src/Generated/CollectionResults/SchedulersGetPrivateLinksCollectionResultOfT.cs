...
{
    internal partial class SchedulersGetPrivateLinksCollectionResultOfT : Pageable<SchedulerPrivateLinkResourceData>
    {
        ...
        public override IEnumerable<Page<SchedulerPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
