...
namespace Azure.Search.Documents.Samples
{
    public partial class Samples_Indexes
    {
        ...
        public void Example_Indexes_Create_SearchServiceCreateIndex()
        {
            ...
            Documents.Indexes client = new SearchClient(endpoint, credential).GetIndexesClient();
...
new SearchField("descriptionEmbedding", default)
{
Key = false,
Retrievable = true,
Searchable = true,
...
new SearchField("descriptionEmbedding_notstored", default)
{
Key = false,
Retrievable = false,
Stored = false,
...
new SearchField("descriptionEmbedding_forBQ", default)
{
Key = false,
Retrievable = true,
Searchable = true,
...
new SearchField("nameEmbedding", default)
{
Key = false,
Retrievable = true,
Searchable = true,
...
Metric = VectorSearchAlgorithmMetric.Cosine,
        ...
        public void Example_Indexes_GetIndex_SearchServiceGetIndex()
        {
            ...
            Response response = client.GetIndex("hotels", (RequestContext)null);
        ...
        public async Task Example_Indexes_GetIndex_SearchServiceGetIndex_Async()
        {
            ...
            Response response = await client.GetIndexAsync("hotels", (RequestContext)null);
        ...
        public void Example_Indexes_GetStatistics_SearchServiceGetIndexStatistics()
        {
            ...
            Response response = client.GetStatistics("hotels", (RequestContext)null);
        ...
        public async Task Example_Indexes_GetStatistics_SearchServiceGetIndexStatistics_Async()
        {
            ...
            Response response = await client.GetStatisticsAsync("hotels", (RequestContext)null);
        ...
        public void Example_Indexes_GetStatistics_SearchServiceGetIndexStatistics_Convenience()
        {
            ...
            Response<Documents.Indexes.Models.SearchIndexStatistics> response = client.GetStatistics("hotels");
        }
        ...
        public async Task Example_Indexes_GetStatistics_SearchServiceGetIndexStatistics_Convenience_Async()
        {
            ...
            Response<Documents.Indexes.Models.SearchIndexStatistics> response = await client.GetStatisticsAsync("hotels");
        }
        ...
        public void Example_Indexes_Analyze_SearchServiceIndexAnalyze_Convenience()
        {
            ...
            Documents.Indexes.Models.AnalyzeTextOptions request = new Documents.Indexes.Models.AnalyzeTextOptions("Text to analyze");
        ...
        public void Example_Indexes_GetIndexes_SearchServiceListIndexes()
        {
            ...
            foreach (BinaryData item in client.GetIndexes("*", (RequestContext)null))
            {
        ...
        public async Task Example_Indexes_GetIndexes_SearchServiceListIndexes_Async()
        {
            ...
            await foreach (BinaryData item in client.GetIndexesAsync("*", (RequestContext)null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("name").ToString());
                Console.WriteLine(result.GetProperty("fields")[0].GetProperty("name").ToString());
