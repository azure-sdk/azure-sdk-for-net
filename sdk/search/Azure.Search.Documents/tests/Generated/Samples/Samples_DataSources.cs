...
namespace Azure.Search.Documents.Samples
{
    public partial class Samples_DataSources
    {
        ...
        public void Example_DataSources_CreateOrUpdate_SearchServiceCreateOrUpdateDataSource_Convenience()
        {
            ...
            Documents.Indexes.Models.SearchIndexerDataSourceConnection dataSource = new Documents.Indexes.Models.SearchIndexerDataSourceConnection("mydocdbdatasource", SearchIndexerDataSourceType.CosmosDb, new DataSourceCredentials
            {
                ConnectionString = "AccountEndpoint=https://myDocDbEndpoint.documents.azure.com;AccountKey=myDocDbAuthKey;Database=myDocDbDatabaseId",
            ...
            Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> response = client.CreateOrUpdate("mydatasource", dataSource);
        }
        ...
        public async Task Example_DataSources_CreateOrUpdate_SearchServiceCreateOrUpdateDataSource_Convenience_Async()
        {
            ...
            Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> response = await client.CreateOrUpdateAsync("mydatasource", dataSource);
        }
        ...
        public void Example_DataSources_GetDataSource_SearchServiceGetDataSource_Convenience()
        {
            ...
            Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> response = client.GetDataSource("mydatasource");
        }
        ...
        public async Task Example_DataSources_GetDataSource_SearchServiceGetDataSource_Convenience_Async()
        {
            ...
            Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> response = await client.GetDataSourceAsync("mydatasource");
        }
        ...
        public void Example_DataSources_Create_SearchServiceCreateDataSource_Convenience()
        {
            ...
            Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> response = client.Create(dataSource);
        }
        ...
        public async Task Example_DataSources_Create_SearchServiceCreateDataSource_Convenience_Async()
        {
            ...
            Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> response = await client.CreateAsync(dataSource);
        }
    }
}
