...
Name = "MyCustomWebApiSkill",
            ...
            {
                Description = "Extract entities, detect language and extract key-phrases",
                KnowledgeStore = new Documents.Indexes.Models.KnowledgeStore("DefaultEndpointsProtocol=https;AccountName=myStorage;AccountKey=myStorageKey;EndpointSuffix=core.windows.net", new Documents.Indexes.Models.KnowledgeStoreProjection[]
            {
new Documents.Indexes.Models.KnowledgeStoreProjection
{
Tables = {new Documents.Indexes.Models.KnowledgeStoreTableProjectionSelector("Reviews")
{
GeneratedKeyName = "ReviewId",
Source = "/document/Review",
Inputs = {},
}, new Documents.Indexes.Models.KnowledgeStoreTableProjectionSelector("Sentences")
{
GeneratedKeyName = "SentenceId",
Source = "/document/Review/Sentences/*",
Inputs = {},
}, new Documents.Indexes.Models.KnowledgeStoreTableProjectionSelector("KeyPhrases")
{
GeneratedKeyName = "KeyPhraseId",
Source = "/document/Review/Sentences/*/KeyPhrases",
Inputs = {},
}, new Documents.Indexes.Models.KnowledgeStoreTableProjectionSelector("Entities")
{
GeneratedKeyName = "EntityId",
Source = "/document/Review/Sentences/*/Entities/*",
Inputs = {},
...
new Documents.Indexes.Models.KnowledgeStoreProjection
{
Objects = {new Documents.Indexes.Models.KnowledgeStoreObjectProjectionSelector("Reviews")
{
GeneratedKeyName = "/document/Review/Id",
Source = "/document/Review",
}},
