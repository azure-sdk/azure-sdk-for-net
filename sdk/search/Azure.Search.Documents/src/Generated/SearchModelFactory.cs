...
namespace Azure.Search.Documents.Models
{
    ...
    public static partial class SearchModelFactory
    {
        ...
        public static QueryRewritesValuesDebugInfo QueryRewritesValuesDebugInfo(IEnumerable<string> rewrites = null)
        {
            rewrites ??= new List<string>();

            return new QueryRewritesValuesDebugInfo(rewrites?.ToList());
        }
