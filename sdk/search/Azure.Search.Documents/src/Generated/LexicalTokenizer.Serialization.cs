        ...
        internal static LexicalTokenizer DeserializeLexicalTokenizer(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("@odata.type", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "#Microsoft.Azure.Search.KeywordTokenizerV2": return Search.Documents.Indexes.Models.KeywordTokenizer.DeserializeKeywordTokenizer(element, options);
                    ...
                    case "#Microsoft.Azure.Search.PathHierarchyTokenizerV2": return Search.Documents.Indexes.Models.PathHierarchyTokenizer.DeserializePathHierarchyTokenizer(element, options);
                    case "#Microsoft.Azure.Search.PatternTokenizer": return PatternTokenizer.DeserializePatternTokenizer(element, options);
                    case "#Microsoft.Azure.Search.StandardTokenizerV2": return Search.Documents.Indexes.Models.LuceneStandardTokenizer.DeserializeLuceneStandardTokenizer(element, options);
