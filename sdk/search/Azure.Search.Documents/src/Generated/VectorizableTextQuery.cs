...
namespace Azure.Search.Documents
{
    ...
    internal partial class VectorizableTextQuery : VectorQuery
    {
        ...
        /// <param name="text"> The text to be vectorized to perform a vector search query. </param>
        internal VectorizableTextQuery(int? kNearestNeighbors, string fields, bool? exhaustive, double? oversampling, float? weight, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string text) : base(kNearestNeighbors, fields, exhaustive, oversampling, weight, kind, serializedAdditionalRawData)
        {
            Text = text;
        }
