...
namespace Azure.Search.Documents
{
    ...
    internal partial class VectorizableImageUrlQuery : VectorQuery
    {
        ...
        internal VectorizableImageUrlQuery(int? kNearestNeighbors, string fields, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string filterOverride, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string url) : base(kNearestNeighbors, fields, exhaustive, oversampling, weight, threshold, filterOverride, kind, serializedAdditionalRawData)
        {
            Url = url;
        }
