...
namespace Azure.Search.Documents
{
    ...
    public partial class DataSources
    {
        ...
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateOrUpdateAsync(string,SearchIndexerDataSourceConnection,MatchConditions,CancellationToken)']/*" />
        public virtual async Task<Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection>> CreateOrUpdateAsync(string dataSourceName, Documents.Indexes.Models.SearchIndexerDataSourceConnection dataSource, MatchConditions matchConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue(Documents.Indexes.Models.SearchIndexerDataSourceConnection.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="dataSourceName"/> or <paramref name="dataSource"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="dataSourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateOrUpdate(string,SearchIndexerDataSourceConnection,MatchConditions,CancellationToken)']/*" />
        public virtual Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> CreateOrUpdate(string dataSourceName, Documents.Indexes.Models.SearchIndexerDataSourceConnection dataSource, MatchConditions matchConditions = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            Argument.AssertNotNull(dataSource, nameof(dataSource));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrUpdateAsync(string,Documents.Indexes.Models.SearchIndexerDataSourceConnection,MatchConditions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrUpdate(string,Documents.Indexes.Models.SearchIndexerDataSourceConnection,MatchConditions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection>> GetDataSourceAsync(string dataSourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
        ...
        public virtual Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> GetDataSource(string dataSourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
        ...
        public virtual async Task<Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection>> CreateAsync(Documents.Indexes.Models.SearchIndexerDataSourceConnection dataSource, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(dataSource, nameof(dataSource));
        ...
        public virtual Response<Documents.Indexes.Models.SearchIndexerDataSourceConnection> Create(Documents.Indexes.Models.SearchIndexerDataSourceConnection dataSource, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(dataSource, nameof(dataSource));
