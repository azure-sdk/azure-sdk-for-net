...
{
    public partial class AzureOpenAIVectorizer : IUtf8JsonSerializable, IJsonModel<AzureOpenAIVectorizer>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureOpenAIVectorizer>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureOpenAIVectorizer>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureOpenAIVectorizer IJsonModel<AzureOpenAIVectorizer>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureOpenAIVectorizer>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AzureOpenAIVectorizer>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureOpenAIVectorizer>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureOpenAIVectorizer IPersistableModel<AzureOpenAIVectorizer>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureOpenAIVectorizer>)this).GetFormatFromOptions(options) : options.Format;
