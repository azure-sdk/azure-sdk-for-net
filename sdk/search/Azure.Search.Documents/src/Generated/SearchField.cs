...
namespace Azure.Search.Documents
{
    ...
    public partial class SearchField
    {
        ...
        internal SearchField(string name, SearchFieldDataType type, bool? key, bool? retrievable, bool? stored, bool? searchable, bool? filterable, bool? sortable, bool? facetable, LexicalAnalyzerName? analyzer, LexicalAnalyzerName? searchAnalyzer, LexicalAnalyzerName? indexAnalyzer, int? vectorSearchDimensions, string vectorSearchProfileName, VectorEncodingFormat? vectorEncodingFormat, IList<string> synonymMaps, IList<SearchField> fields, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Type = type;
            Key = key;
