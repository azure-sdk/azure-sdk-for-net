...
namespace Azure.Search.Documents
{
    ...
    public partial class TagScoringFunction : ScoringFunction
    {
        ...
        /// <param name="parameters"> Parameter values for the tag scoring function. </param>
        internal TagScoringFunction(string fieldName, double boost, ScoringFunctionInterpolation? interpolation, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, TagScoringParameters parameters) : base(fieldName, boost, interpolation, type, serializedAdditionalRawData)
        {
            Parameters = parameters;
        }
