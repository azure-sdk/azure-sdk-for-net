...
namespace Azure.Search.Documents
{
    ...
    public abstract partial class VectorSearchCompression
    {
        ...
        internal VectorSearchCompression(string compressionName, bool? rerankWithOriginalVectors, double? defaultOversampling, RescoringOptions rescoringOptions, int? truncationDimension, VectorSearchCompressionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CompressionName = compressionName;
