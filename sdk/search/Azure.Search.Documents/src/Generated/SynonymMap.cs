...
namespace Azure.Search.Documents
{
    ...
    public partial class SynonymMap
    {
        ...
        internal SynonymMap(string name, SynonymMapFormat format, string synonyms, SearchResourceEncryptionKey encryptionKey, string eTag, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Format = format;
            Synonyms = synonyms;
        ...
        public SynonymMapFormat Format { get; } = SynonymMapFormat.Solr;
