...
namespace Azure.Search.Documents
{
    ...
    public partial class Aliases
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="aliasName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="aliasName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Aliases.xml" path="doc/members/member[@name='GetAliasesOperationAsync(string,CancellationToken)']/*" />
        public virtual async Task<Response<SearchAlias>> GetAliasesOperationAsync(string aliasName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(aliasName, nameof(aliasName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetAliasesOperationAsync(aliasName, context).ConfigureAwait(false);
            return Response.FromValue(SearchAlias.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="aliasName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="aliasName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Aliases.xml" path="doc/members/member[@name='GetAliasesOperation(string,CancellationToken)']/*" />
        public virtual Response<SearchAlias> GetAliasesOperation(string aliasName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(aliasName, nameof(aliasName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = GetAliasesOperation(aliasName, context);
            return Response.FromValue(SearchAlias.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetAliasesOperationAsync(string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Aliases.xml" path="doc/members/member[@name='GetAliasesOperationAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> GetAliasesOperationAsync(string aliasName, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(aliasName, nameof(aliasName));

            using var scope = ClientDiagnostics.CreateScope("Aliases.GetAliasesOperation");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetAliasesOperationRequest(aliasName, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetAliasesOperation(string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Aliases.xml" path="doc/members/member[@name='GetAliasesOperation(string,RequestContext)']/*" />
        public virtual Response GetAliasesOperation(string aliasName, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(aliasName, nameof(aliasName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/Aliases.xml" path="doc/members/member[@name='GetAliasesOperationsAsync(CancellationToken)']/*" />
        public virtual AsyncPageable<SearchAlias> GetAliasesOperationsAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetAliasesOperationsRequest(context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => SearchAlias.DeserializeSearchAlias(e), ClientDiagnostics, _pipeline, "Aliases.GetAliasesOperations", "value", null, context);
        }

        /// <summary> Lists all aliases available for a search service. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/Aliases.xml" path="doc/members/member[@name='GetAliasesOperations(CancellationToken)']/*" />
        public virtual Pageable<SearchAlias> GetAliasesOperations(CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetAliasesOperationsRequest(context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => SearchAlias.DeserializeSearchAlias(e), ClientDiagnostics, _pipeline, "Aliases.GetAliasesOperations", "value", null, context);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetAliasesOperationsAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/Aliases.xml" path="doc/members/member[@name='GetAliasesOperationsAsync(RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetAliasesOperationsAsync(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetAliasesOperationsRequest(context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Aliases.GetAliasesOperations", "value", null, context);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetAliasesOperations(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/Aliases.xml" path="doc/members/member[@name='GetAliasesOperations(RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetAliasesOperations(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetAliasesOperationsRequest(context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Aliases.GetAliasesOperations", "value", null, context);
        }
        ...
        internal HttpMessage CreateGetAliasesOperationsRequest(RequestContext context)
        {
        ...
        internal HttpMessage CreateGetAliasesOperationRequest(string aliasName, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
