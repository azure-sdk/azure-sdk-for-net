...
namespace Azure.Search.Documents
{
    ...
    public partial class AzureMachineLearningParameters
    {
        ...
        internal AzureMachineLearningParameters(Uri scoringUri, string authenticationKey, string resourceId, TimeSpan? timeout, string region, AIStudioModelCatalogName? modelName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ScoringUri = scoringUri;
