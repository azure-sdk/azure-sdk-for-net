...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    /// Lucene.
    /// </summary>
    public partial class PathHierarchyTokenizer : Search.Documents.LexicalTokenizer
    {
        ...
        internal PathHierarchyTokenizer(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, string delimiter, string replacement, int? maxTokenLength, bool? reverseTokenOrder, int? numberOfTokensToSkip) : base(odataType, name, serializedAdditionalRawData)
        {
            Delimiter = delimiter;
