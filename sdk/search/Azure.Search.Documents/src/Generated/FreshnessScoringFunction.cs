...
namespace Azure.Search.Documents
{
    ...
    public partial class FreshnessScoringFunction : ScoringFunction
    {
        ...
        /// <param name="parameters"> Parameter values for the freshness scoring function. </param>
        internal FreshnessScoringFunction(string fieldName, double boost, ScoringFunctionInterpolation? interpolation, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, FreshnessScoringParameters parameters) : base(fieldName, boost, interpolation, type, serializedAdditionalRawData)
        {
            Parameters = parameters;
        }
