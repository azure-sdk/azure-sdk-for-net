...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class IndexerState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Documents.Indexes.Models.IndexerState"/>. </summary>
        ...
        internal IndexerState(Search.Documents.IndexingMode? mode, string allDocsInitialChangeTrackingState, string allDocsFinalChangeTrackingState, string resetDocsInitialChangeTrackingState, string resetDocsFinalChangeTrackingState, IReadOnlyList<string> resetDocumentKeys, IReadOnlyList<string> resetDataSourceDocumentIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Mode = mode;
        ...
        public Search.Documents.IndexingMode? Mode { get; }
        /// <summary>
        /// The list of document keys that have been reset. The document key is the
        /// document's unique identifier for the data in the search index. The indexer will
        /// prioritize selectively re-ingesting these keys.
