...
namespace Azure.Search.Documents
{
    ...
    public partial class SearchResourceEncryptionKey
    {
        ...
        internal SearchResourceEncryptionKey(string keyName, string keyVersion, string vaultUri, AzureActiveDirectoryApplicationCredentials accessCredentials, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
            KeyVersion = keyVersion;
            VaultUri = vaultUri;
