...
namespace Azure.Search.Documents
{
    public partial class SearchIndexerSkillset : IUtf8JsonSerializable, IJsonModel<SearchIndexerSkillset>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CognitiveServices))
            {
                writer.WritePropertyName("cognitiveServices"u8);
                writer.WriteObjectValue(CognitiveServices, options);
            }
            if (Optional.IsDefined(KnowledgeStore))
            {
                writer.WritePropertyName("knowledgeStore"u8);
                writer.WriteObjectValue<Documents.Indexes.Models.KnowledgeStore>(KnowledgeStore, options);
            }
            if (Optional.IsDefined(IndexProjections))
            {
                writer.WritePropertyName("indexProjections"u8);
                writer.WriteObjectValue(IndexProjections, options);
            }
        ...
        internal static SearchIndexerSkillset DeserializeSearchIndexerSkillset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Documents.Indexes.Models.KnowledgeStore knowledgeStore = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("knowledgeStore"u8))
                {
                    ...
                    knowledgeStore = Documents.Indexes.Models.KnowledgeStore.DeserializeKnowledgeStore(property.Value, options);
                    continue;
                }
