...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class PiiDetectionSkill : SearchIndexerSkill
    {
        ...
        internal PiiDetectionSkill(string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, string defaultLanguageCode, double? minimumPrecision, PiiDetectionSkillMaskingMode? maskingMode, string mask, string modelVersion, IList<string> piiCategories, string domain) : base(oDataType, name, description, context, inputs, outputs)
        {
