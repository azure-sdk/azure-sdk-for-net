...
{
    public partial class TextVector : IUtf8JsonSerializable
    {
        ...
        internal static TextVector DeserializeTextVector(JsonElement element)
        {
            ...
            return new TextVector(kind, Optional.ToNullable(k), fields.Value, Optional.ToNullable(exhaustive), text.Value);
        }
    }
}
