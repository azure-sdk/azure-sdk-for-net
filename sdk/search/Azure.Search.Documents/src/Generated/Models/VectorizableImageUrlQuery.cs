...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class VectorizableImageUrlQuery : VectorQuery
    {
        ...
        internal VectorizableImageUrlQuery(VectorQueryKind kind, int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string url) : base(kind, kNearestNeighborsCount, fieldsRaw, exhaustive, oversampling, weight, threshold)
        {
            Url = url;
            Kind = kind;
        }
