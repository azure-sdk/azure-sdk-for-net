...
namespace Azure.Search.Documents.Models
{
    ...
    public readonly partial struct VectorFilterMode : IEquatable<VectorFilterMode>
    {
        ...
        /// <summary> The search data will be filtered after the vector search query is performed. </summary>
        public static VectorFilterMode PostFilter { get; } = new VectorFilterMode(PostFilterValue);
        /// <summary> The search data will be filtered before the vector search query is performed. </summary>
