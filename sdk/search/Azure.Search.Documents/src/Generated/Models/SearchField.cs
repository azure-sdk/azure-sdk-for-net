...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchField
    {
        ...
        /// <param name="vectorSearchProfile"> The name of the vector search profile that specifies the algorithm and vectorizer to use when searching the vector field. </param>
