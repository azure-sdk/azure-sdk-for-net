...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class TextVector : SearchQueryVector
    {
        /// <summary> Initializes a new instance of TextVector. </summary>
        public TextVector()
        {
            Kind = "text";
        }
        ...
        internal TextVector(string kind, int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive, string text) : base(kind, kNearestNeighborsCount, fieldsRaw, exhaustive)
        {
            Text = text;
            Kind = kind ?? "text";
        }
