...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class AzureOpenAIEmbeddingSkill : SearchIndexerSkill
    {
        ...
        /// <param name="authResourceId"> This value should be the application ID created for the Azure Open AI resource when it was registered with Azure Active Directory. When specified, the skill connects to the Azure Open AI resource using a managed ID (either system or user-assigned) of the search service and the access token of the resource, using this value as the resource id for creating the scope of the access token. </param>
        ...
        /// <summary> This value should be the application ID created for the Azure Open AI resource when it was registered with Azure Active Directory. When specified, the skill connects to the Azure Open AI resource using a managed ID (either system or user-assigned) of the search service and the access token of the resource, using this value as the resource id for creating the scope of the access token. </summary>
