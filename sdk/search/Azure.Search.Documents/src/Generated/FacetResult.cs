...
namespace Azure.Search.Documents
{
    ...
    internal partial class FacetResult
    {
        ...
        internal FacetResult(long? count, IReadOnlyDictionary<string, IList<FacetResult>> facets, long? sum, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            Count = count;
            Facets = facets;
            Sum = sum;
