...
namespace Azure.Search.Documents
{
    ...
    internal abstract partial class VectorQuery
    {
        ...
        internal VectorQuery(int? kNearestNeighbors, string fields, bool? exhaustive, double? oversampling, float? weight, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
