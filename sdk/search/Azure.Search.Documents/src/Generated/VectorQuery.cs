...
namespace Azure.Search.Documents
{
    ...
    /// </summary>
    internal abstract partial class VectorQuery
    {
        /// <summary>
        ...
        internal VectorQuery(int? kNearestNeighbors, string fields, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string filterOverride, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public int? KNearestNeighbors { get; set; }
        /// <summary>
        /// Vector Fields of type Collection(Edm.Single) to be included in the vector
        /// searched.
        /// </summary>
