...
namespace Azure.Search.Documents
{
    ...
    /// <summary> Client that can be used to manage and query indexes and documents, as well as manage other resources, on a search service. </summary>
    public partial class SearchClient
    {
        ...
        private Documents.Indexes _cachedIndexes;
        ...
        public virtual Documents.Indexes GetIndexesClient()
        {
            return Volatile.Read(ref _cachedIndexes) ?? Interlocked.CompareExchange(ref _cachedIndexes, new Documents.Indexes(ClientDiagnostics, _pipeline, _keyCredential, _tokenCredential, _endpoint, _apiVersion), null) ?? _cachedIndexes;
        }
