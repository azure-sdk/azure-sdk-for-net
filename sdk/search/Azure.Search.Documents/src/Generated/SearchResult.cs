...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class SearchResult
    {
        ...
        internal SearchResult(double score, double? rerankerScore, IReadOnlyDictionary<string, IList<string>> highlights, IReadOnlyList<QueryCaptionResult> captions, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            Score = score;
