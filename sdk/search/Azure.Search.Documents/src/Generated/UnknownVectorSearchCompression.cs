...
namespace Azure.Search.Documents
{
    ...
    internal partial class UnknownVectorSearchCompression : VectorSearchCompression
    {
        ...
        internal UnknownVectorSearchCompression(string compressionName, bool? rerankWithOriginalVectors, double? defaultOversampling, VectorSearchCompressionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(compressionName, rerankWithOriginalVectors, defaultOversampling, kind, serializedAdditionalRawData)
        {
        }
