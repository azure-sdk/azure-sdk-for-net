...
namespace Azure.Search.Documents
{
    ...
    internal partial class UnknownVectorSearchCompression : VectorSearchCompression
    {
        ...
        internal UnknownVectorSearchCompression(string compressionName, bool? rerankWithOriginalVectors, double? defaultOversampling, RescoringOptions rescoringOptions, int? truncationDimension, VectorSearchCompressionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(compressionName, rerankWithOriginalVectors, defaultOversampling, rescoringOptions, truncationDimension, kind, serializedAdditionalRawData)
        {
        }
