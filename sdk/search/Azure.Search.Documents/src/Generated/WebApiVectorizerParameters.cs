...
namespace Azure.Search.Documents
{
    ...
    public partial class WebApiVectorizerParameters
    {
        ...
        internal WebApiVectorizerParameters(Uri url, IDictionary<string, string> httpHeaders, string httpMethod, TimeSpan? timeout, string authResourceId, SearchIndexerDataIdentity authIdentity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Url = url;
