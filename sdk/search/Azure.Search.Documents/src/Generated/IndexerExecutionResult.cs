...
namespace Azure.Search.Documents
{
    ...
    public partial class IndexerExecutionResult
    {
        ...
        internal IndexerExecutionResult(IndexerExecutionStatus status, IndexerExecutionStatusDetail? statusDetail, Search.Documents.Indexes.Models.IndexerState currentState, string errorMessage, DateTimeOffset? startTime, DateTimeOffset? endTime, IReadOnlyList<SearchIndexerError> errors, IReadOnlyList<SearchIndexerWarning> warnings, int itemCount, int failedItemCount, string initialTrackingState, string finalTrackingState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
        ...
        public Search.Documents.Indexes.Models.IndexerState CurrentState { get; }
