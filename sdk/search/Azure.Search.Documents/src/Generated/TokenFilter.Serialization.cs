        ...
        internal static TokenFilter DeserializeTokenFilter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("@odata.type", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "#Microsoft.Azure.Search.EdgeNGramTokenFilterV2": return Search.Documents.Indexes.Models.EdgeNGramTokenFilter.DeserializeEdgeNGramTokenFilter(element, options);
                    ...
                    case "#Microsoft.Azure.Search.NGramTokenFilterV2": return Search.Documents.Indexes.Models.NGramTokenFilter.DeserializeNGramTokenFilter(element, options);
