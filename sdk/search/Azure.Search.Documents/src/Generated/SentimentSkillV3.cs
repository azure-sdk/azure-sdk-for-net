...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    /// document-level.
    /// </summary>
    internal partial class SentimentSkillV3 : Search.Documents.SearchIndexerSkill
    {
        /// <summary> Initializes a new instance of <see cref="Documents.Indexes.Models.SentimentSkillV3"/>. </summary>
        /// <param name="inputs">
        ...
        public SentimentSkillV3(IEnumerable<Search.Documents.InputFieldMappingEntry> inputs, IEnumerable<OutputFieldMappingEntry> outputs) : base(inputs, outputs)
        {
        ...
        /// <param name="includeOpinionMining">
        ...
        /// </param>
        internal SentimentSkillV3(string odataType, string name, string description, string context, IList<Search.Documents.InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, IDictionary<string, BinaryData> serializedAdditionalRawData, string defaultLanguageCode, bool? includeOpinionMining, string modelVersion) : base(odataType, name, description, context, inputs, outputs, serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Documents.Indexes.Models.SentimentSkillV3"/> for deserialization. </summary>
        internal SentimentSkillV3()
        {
        }
