...
namespace Azure.Search.Documents
{
    ...
    public partial class Indexers
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="indexerName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="indexerName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Indexers.xml" path="doc/members/member[@name='ResetDocsAsync(string,ResetDocumentOptions,bool?,CancellationToken)']/*" />
        public virtual async Task<Response> ResetDocsAsync(string indexerName, ResetDocumentOptions keysOrIds = null, bool? overwrite = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexerName, nameof(indexerName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="indexerName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="indexerName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Indexers.xml" path="doc/members/member[@name='ResetDocs(string,ResetDocumentOptions,bool?,CancellationToken)']/*" />
        public virtual Response ResetDocs(string indexerName, ResetDocumentOptions keysOrIds = null, bool? overwrite = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexerName, nameof(indexerName));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ResetDocsAsync(string,ResetDocumentOptions,bool?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ResetDocs(string,ResetDocumentOptions,bool?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
