...
namespace Azure.Search.Documents
{
    ...
    public partial class CustomAnalyzer : LexicalAnalyzer
    {
        ...
        /// </param>
        internal CustomAnalyzer(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, LexicalTokenizerName tokenizer, IList<TokenFilterName> tokenFilters, IList<CharFilterName> charFilters) : base(odataType, name, serializedAdditionalRawData)
        {
            Tokenizer = tokenizer;
