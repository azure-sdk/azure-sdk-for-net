...
namespace Azure.Search.Documents
{
    ...
    public partial class BM25SimilarityAlgorithm : SimilarityAlgorithm
    {
        ...
        /// </param>
        internal BM25SimilarityAlgorithm(string odataType, IDictionary<string, BinaryData> serializedAdditionalRawData, double? k1, double? b) : base(odataType, serializedAdditionalRawData)
        {
            K1 = k1;
            B = b;
        }
