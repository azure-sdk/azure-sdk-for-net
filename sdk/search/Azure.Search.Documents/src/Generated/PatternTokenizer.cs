...
namespace Azure.Search.Documents
{
    ...
    public partial class PatternTokenizer : LexicalTokenizer
    {
        ...
        /// </param>
        internal PatternTokenizer(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, string pattern, Search.Documents.Indexes.Models.RegexFlag? flags, int? group) : base(odataType, name, serializedAdditionalRawData)
        {
            Pattern = pattern;
            Flags = flags;
            Group = group;
