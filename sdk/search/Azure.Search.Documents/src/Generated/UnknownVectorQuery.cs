...
namespace Azure.Search.Documents
{
    ...
    internal partial class UnknownVectorQuery : VectorQuery
    {
        ...
        internal UnknownVectorQuery(int? kNearestNeighbors, string fields, bool? exhaustive, double? oversampling, float? weight, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(kNearestNeighbors, fields, exhaustive, oversampling, weight, kind, serializedAdditionalRawData)
        {
        }
