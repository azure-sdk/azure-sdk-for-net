...
{
    public partial class AnalyzeTextOptions : IUtf8JsonSerializable, IJsonModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        Search.Documents.Indexes.Models.AnalyzeTextOptions IJsonModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>)this).GetFormatFromOptions(options) : options.Format;
        ...
        Search.Documents.Indexes.Models.AnalyzeTextOptions IPersistableModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<Search.Documents.Indexes.Models.AnalyzeTextOptions>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<Search.Documents.Indexes.Models.AnalyzeTextOptions>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
