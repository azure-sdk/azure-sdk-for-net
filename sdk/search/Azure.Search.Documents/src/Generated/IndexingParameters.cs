...
namespace Azure.Search.Documents
{
    ...
    public partial class IndexingParameters
    {
        ...
        /// </param>
        /// <param name="maxFailedItemsPerBatch">
        ...
        internal IndexingParameters(int? batchSize, int? maxFailedItems, int? maxFailedItemsPerBatch, IndexingParametersConfiguration configuration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            BatchSize = batchSize;
