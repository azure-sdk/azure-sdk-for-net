...
namespace Azure.Search.Documents
{
    ...
    internal partial class Indexes
    {
        ...
        public virtual async Task<Response<Documents.Indexes.Models.SearchIndexStatistics>> GetStatisticsAsync(string indexName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexName, nameof(indexName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetStatisticsAsync(indexName, context).ConfigureAwait(false);
            return Response.FromValue(Documents.Indexes.Models.SearchIndexStatistics.FromResponse(response), response);
        }
        ...
        public virtual Response<Documents.Indexes.Models.SearchIndexStatistics> GetStatistics(string indexName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexName, nameof(indexName));
        ...
        public virtual async Task<Response<AnalyzeResult>> AnalyzeAsync(string indexName, Documents.Indexes.Models.AnalyzeTextOptions request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexName, nameof(indexName));
        ...
        public virtual Response<AnalyzeResult> Analyze(string indexName, Documents.Indexes.Models.AnalyzeTextOptions request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexName, nameof(indexName));
            Argument.AssertNotNull(request, nameof(request));
