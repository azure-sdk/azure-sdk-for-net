...
namespace Azure.Search.Documents
{
    ...
    internal partial class Indexes
    {
        ...
        public virtual async Task<Response<Search.Documents.Indexes.Models.SearchIndexStatistics>> GetStatisticsAsync(string indexName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexName, nameof(indexName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetStatisticsAsync(indexName, context).ConfigureAwait(false);
            return Response.FromValue(Search.Documents.Indexes.Models.SearchIndexStatistics.FromResponse(response), response);
        }
        ...
        public virtual Response<Search.Documents.Indexes.Models.SearchIndexStatistics> GetStatistics(string indexName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexName, nameof(indexName));
        ...
        /// <exception cref="ArgumentException"> <paramref name="indexName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Indexes.xml" path="doc/members/member[@name='AnalyzeAsync(string,AnalyzeTextOptions,CancellationToken)']/*" />
        public virtual async Task<Response<AnalyzeResult>> AnalyzeAsync(string indexName, Search.Documents.Indexes.Models.AnalyzeTextOptions request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexName, nameof(indexName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="indexName"/> or <paramref name="request"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="indexName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Indexes.xml" path="doc/members/member[@name='Analyze(string,AnalyzeTextOptions,CancellationToken)']/*" />
        public virtual Response<AnalyzeResult> Analyze(string indexName, Search.Documents.Indexes.Models.AnalyzeTextOptions request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexName, nameof(indexName));
            Argument.AssertNotNull(request, nameof(request));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AnalyzeAsync(string,Documents.Indexes.Models.AnalyzeTextOptions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Analyze(string,Documents.Indexes.Models.AnalyzeTextOptions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
