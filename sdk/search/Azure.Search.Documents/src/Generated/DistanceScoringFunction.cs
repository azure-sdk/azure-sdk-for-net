...
namespace Azure.Search.Documents
{
    ...
    public partial class DistanceScoringFunction : ScoringFunction
    {
        ...
        /// <param name="parameters"> Parameter values for the distance scoring function. </param>
        internal DistanceScoringFunction(string fieldName, double boost, ScoringFunctionInterpolation? interpolation, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, DistanceScoringParameters parameters) : base(fieldName, boost, interpolation, type, serializedAdditionalRawData)
        {
            Parameters = parameters;
        }
