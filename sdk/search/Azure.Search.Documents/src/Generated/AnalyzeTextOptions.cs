...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class AnalyzeTextOptions
    {
        ...
        internal AnalyzeTextOptions(string text, Documents.LexicalAnalyzerName? analyzerName, LexicalTokenizerName? tokenizerName, IList<TokenFilterName> tokenFilters, IList<string> charFilters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
