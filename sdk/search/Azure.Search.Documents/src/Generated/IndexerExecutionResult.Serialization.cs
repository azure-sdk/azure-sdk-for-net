    ...
    public partial class IndexerExecutionResult : IUtf8JsonSerializable, IJsonModel<IndexerExecutionResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(CurrentState))
            {
                ...
                writer.WriteObjectValue<Search.Documents.Indexes.Models.IndexerState>(CurrentState, options);
            }
        ...
        internal static IndexerExecutionResult DeserializeIndexerExecutionResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Search.Documents.Indexes.Models.IndexerState currentState = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    status = new IndexerExecutionStatus(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("currentState"u8))
                {
                    ...
                    currentState = Search.Documents.Indexes.Models.IndexerState.DeserializeIndexerState(property.Value, options);
                    continue;
                }
