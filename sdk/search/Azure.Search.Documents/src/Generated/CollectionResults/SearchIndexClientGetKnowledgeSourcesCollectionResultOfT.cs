...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetKnowledgeSourcesCollectionResultOfT : Pageable<KnowledgeSource>
    {
        ...
        public SearchIndexClientGetKnowledgeSourcesCollectionResultOfT(SearchIndexClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
