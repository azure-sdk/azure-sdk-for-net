...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetAliasesCollectionResultOfT : Pageable<SearchAlias>
    {
        ...
        /// <summary> Initializes a new instance of SearchIndexClientGetAliasesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SearchIndexClientGetAliasesCollectionResultOfT(SearchIndexClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetAliasesCollectionResultOfT as an enumerable collection. </summary>
