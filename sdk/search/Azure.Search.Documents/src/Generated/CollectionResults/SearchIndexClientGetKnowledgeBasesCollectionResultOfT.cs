...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetKnowledgeBasesCollectionResultOfT : Pageable<KnowledgeBase>
    {
        ...
        public SearchIndexClientGetKnowledgeBasesCollectionResultOfT(SearchIndexClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetKnowledgeBasesCollectionResultOfT as an enumerable collection. </summary>
