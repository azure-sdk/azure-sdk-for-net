...
{
    internal partial class SearchIndexClientGetAliasesCollectionResult : Pageable<BinaryData>
    {
        private readonly SearchIndexClient _client;
        private readonly RequestContext _context;
        private readonly string _scope;

        /// <summary> Initializes a new instance of SearchIndexClientGetAliasesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public SearchIndexClientGetAliasesCollectionResult(SearchIndexClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetAliasesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SearchIndexClientGetAliasesCollectionResult as an enumerable collection. </returns>
