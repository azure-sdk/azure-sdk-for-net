...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetKnowledgeSourcesCollectionResult : Pageable<BinaryData>
    {
        ...
        public SearchIndexClientGetKnowledgeSourcesCollectionResult(SearchIndexClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
