...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetAliasesAsyncCollectionResultOfT : AsyncPageable<SearchAlias>
    {
        ...
        public SearchIndexClientGetAliasesAsyncCollectionResultOfT(SearchIndexClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
