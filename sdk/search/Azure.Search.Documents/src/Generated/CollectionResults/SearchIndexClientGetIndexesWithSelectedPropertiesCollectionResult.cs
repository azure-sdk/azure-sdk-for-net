...
{
    internal partial class SearchIndexClientGetIndexesWithSelectedPropertiesCollectionResult : Pageable<BinaryData>
    {
        ...
        public SearchIndexClientGetIndexesWithSelectedPropertiesCollectionResult(SearchIndexClient client, IEnumerable<string> @select, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _select = @select;
            _context = context;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetIndexesWithSelectedPropertiesCollectionResult as an enumerable collection. </summary>
