...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetIndexesWithSelectedPropertiesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public SearchIndexClientGetIndexesWithSelectedPropertiesAsyncCollectionResult(SearchIndexClient client, IEnumerable<string> @select, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _select = @select;
            _context = context;
