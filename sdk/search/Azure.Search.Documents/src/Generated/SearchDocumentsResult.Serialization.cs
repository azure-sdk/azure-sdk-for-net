...
namespace Azure.Search.Documents.Models
{
    internal partial class SearchDocumentsResult : IUtf8JsonSerializable, IJsonModel<SearchDocumentsResult>
    {
        ...
        internal static SearchDocumentsResult DeserializeSearchDocumentsResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyDictionary<string, IList<Search.Documents.FacetResult>> searchFacets = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("@search.facets"u8))
                {
                    ...
                    Dictionary<string, IList<Search.Documents.FacetResult>> dictionary = new Dictionary<string, IList<Search.Documents.FacetResult>>();
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            List<Search.Documents.FacetResult> array = new List<Search.Documents.FacetResult>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(Search.Documents.FacetResult.DeserializeFacetResult(item, options));
                            }
            ...
            return new SearchDocumentsResult(
                odataCount,
                searchCoverage,
                searchFacets ?? new ChangeTrackingDictionary<string, IList<Search.Documents.FacetResult>>(),
