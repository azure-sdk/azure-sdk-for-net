...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class KnowledgeStore
    {
        ...
        internal KnowledgeStore(string storageConnectionString, IList<Search.Documents.Indexes.Models.KnowledgeStoreProjection> projections, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StorageConnectionString = storageConnectionString;
