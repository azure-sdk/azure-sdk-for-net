...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class KnowledgeStore
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Documents.Indexes.Models.KnowledgeStore"/>. </summary>
        ...
        public KnowledgeStore(string storageConnectionString, IEnumerable<Search.Documents.Indexes.Models.KnowledgeStoreProjection> projections)
        {
        ...
        internal KnowledgeStore(string storageConnectionString, IList<Search.Documents.Indexes.Models.KnowledgeStoreProjection> projections, Search.Documents.SearchIndexerDataIdentity identity, SearchIndexerKnowledgeStoreParameters parameters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StorageConnectionString = storageConnectionString;
        ...
        /// <summary> Initializes a new instance of <see cref="Documents.Indexes.Models.KnowledgeStore"/> for deserialization. </summary>
        ...
        public IList<Search.Documents.Indexes.Models.KnowledgeStoreProjection> Projections { get; }
        /// <summary>
        /// The user-assigned managed identity used for connections to Azure Storage when
        /// writing knowledge store projections. If the connection string indicates an
        /// identity (ResourceId) and it's not specified, the system-assigned managed
