...
namespace Azure.Search.Documents
{
    ...
    public partial class SearchServiceCounters
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="documentCount"/>, <paramref name="indexesCount"/>, <paramref name="indexersCount"/>, <paramref name="dataSourcesCount"/>, <paramref name="storageSize"/>, <paramref name="synonymMaps"/>, <paramref name="skillsetCount"/> or <paramref name="vectorIndexSize"/> is null. </exception>
        internal SearchServiceCounters(Documents.Indexes.Models.SearchResourceCounter documentCount, Documents.Indexes.Models.SearchResourceCounter indexesCount, Documents.Indexes.Models.SearchResourceCounter indexersCount, Documents.Indexes.Models.SearchResourceCounter dataSourcesCount, Documents.Indexes.Models.SearchResourceCounter storageSize, Documents.Indexes.Models.SearchResourceCounter synonymMaps, Documents.Indexes.Models.SearchResourceCounter skillsetCount, Documents.Indexes.Models.SearchResourceCounter vectorIndexSize)
        {
        ...
        internal SearchServiceCounters(Documents.Indexes.Models.SearchResourceCounter documentCount, Documents.Indexes.Models.SearchResourceCounter indexesCount, Documents.Indexes.Models.SearchResourceCounter indexersCount, Documents.Indexes.Models.SearchResourceCounter dataSourcesCount, Documents.Indexes.Models.SearchResourceCounter storageSize, Documents.Indexes.Models.SearchResourceCounter synonymMaps, Documents.Indexes.Models.SearchResourceCounter skillsetCount, Documents.Indexes.Models.SearchResourceCounter vectorIndexSize, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DocumentCount = documentCount;
            IndexesCount = indexesCount;
            IndexersCount = indexersCount;
        ...
        public Documents.Indexes.Models.SearchResourceCounter DocumentCount { get; }
        /// <summary> Total number of indexes. </summary>
        public Documents.Indexes.Models.SearchResourceCounter IndexesCount { get; }
        /// <summary> Total number of indexers. </summary>
        public Documents.Indexes.Models.SearchResourceCounter IndexersCount { get; }
        /// <summary> Total number of data sources. </summary>
        public Documents.Indexes.Models.SearchResourceCounter DataSourcesCount { get; }
        /// <summary> Total size of used storage in bytes. </summary>
        public Documents.Indexes.Models.SearchResourceCounter StorageSize { get; }
        /// <summary> Total number of synonym maps. </summary>
        public Documents.Indexes.Models.SearchResourceCounter SynonymMaps { get; }
        /// <summary> Total number of skillsets. </summary>
        public Documents.Indexes.Models.SearchResourceCounter SkillsetCount { get; }
        /// <summary> Total memory consumption of all vector indexes within the service, in bytes. </summary>
        public Documents.Indexes.Models.SearchResourceCounter VectorIndexSize { get; }
    }
}
