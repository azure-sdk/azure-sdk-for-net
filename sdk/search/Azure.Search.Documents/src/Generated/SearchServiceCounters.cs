...
namespace Azure.Search.Documents
{
    ...
    public partial class SearchServiceCounters
    {
        ...
        internal SearchServiceCounters(Search.Documents.Indexes.Models.SearchResourceCounter documentCounter, Search.Documents.Indexes.Models.SearchResourceCounter indexCounter, Search.Documents.Indexes.Models.SearchResourceCounter indexerCounter, Search.Documents.Indexes.Models.SearchResourceCounter dataSourceCounter, Search.Documents.Indexes.Models.SearchResourceCounter storageSizeCounter, Search.Documents.Indexes.Models.SearchResourceCounter synonymMapCounter, Search.Documents.Indexes.Models.SearchResourceCounter skillsetCounter, Search.Documents.Indexes.Models.SearchResourceCounter vectorIndexSizeCounter)
        {
        ...
        internal SearchServiceCounters(Search.Documents.Indexes.Models.SearchResourceCounter documentCounter, Search.Documents.Indexes.Models.SearchResourceCounter indexCounter, Search.Documents.Indexes.Models.SearchResourceCounter indexerCounter, Search.Documents.Indexes.Models.SearchResourceCounter dataSourceCounter, Search.Documents.Indexes.Models.SearchResourceCounter storageSizeCounter, Search.Documents.Indexes.Models.SearchResourceCounter synonymMapCounter, Search.Documents.Indexes.Models.SearchResourceCounter skillsetCounter, Search.Documents.Indexes.Models.SearchResourceCounter vectorIndexSizeCounter, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DocumentCounter = documentCounter;
            IndexCounter = indexCounter;
            IndexerCounter = indexerCounter;
