...
namespace Azure.Search.Documents
{
    ...
    public partial class PatternAnalyzer : LexicalAnalyzer
    {
        ...
        internal PatternAnalyzer(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, bool? lowercase, string pattern, Documents.Indexes.Models.RegexFlag? flags, IList<string> stopwords) : base(odataType, name, serializedAdditionalRawData)
        {
            Lowercase = lowercase;
            Pattern = pattern;
            Flags = flags;
        ...
        public Documents.Indexes.Models.RegexFlag? Flags { get; set; }
