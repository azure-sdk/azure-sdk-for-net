        ...
        internal static UnknownScoringFunction DeserializeUnknownScoringFunction(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("interpolation"u8))
                {
                    ...
                    interpolation = new ScoringFunctionInterpolation(property.Value.GetString());
                    continue;
                }
            ...
            return new UnknownScoringFunction(fieldName, boost, interpolation, type, serializedAdditionalRawData);
        }
