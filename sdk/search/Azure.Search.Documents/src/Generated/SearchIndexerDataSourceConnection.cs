...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchIndexerDataSourceConnection
    {
        ...
        public SearchIndexerDataSourceConnection(string name, SearchIndexerDataSourceType type, Documents.DataSourceCredentials credentialsInternal, SearchIndexerDataContainer container)
        {
        ...
        /// Please note <see cref="Documents.DataChangeDetectionPolicy"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        /// Please note <see cref="Documents.DataDeletionDetectionPolicy"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        internal SearchIndexerDataSourceConnection(string name, string description, SearchIndexerDataSourceType type, Documents.DataSourceCredentials credentialsInternal, SearchIndexerDataContainer container, Documents.DataChangeDetectionPolicy dataChangeDetectionPolicy, Documents.DataDeletionDetectionPolicy dataDeletionDetectionPolicy, string etag, Documents.SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
        ...
        /// The available derived classes include <see cref="HighWaterMarkChangeDetectionPolicy"/> and <see cref="SqlIntegratedChangeTrackingPolicy"/>.
        /// </summary>
        public Documents.DataChangeDetectionPolicy DataChangeDetectionPolicy { get; set; }
        /// <summary>
        /// The data deletion detection policy for the datasource.
        /// Please note <see cref="Documents.DataDeletionDetectionPolicy"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="SoftDeleteColumnDeletionDetectionPolicy"/>.
        /// </summary>
        public Documents.DataDeletionDetectionPolicy DataDeletionDetectionPolicy { get; set; }
        /// <summary>
        /// A description of an encryption key that you create in Azure Key Vault. This key
        /// is used to provide an additional level of encryption-at-rest for your
        /// datasource definition when you want full assurance that no one, not even
        ...
        /// created on or after January 1, 2019.
        /// </summary>
        public Documents.SearchResourceEncryptionKey EncryptionKey { get; set; }
    }
}
