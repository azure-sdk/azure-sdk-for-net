...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchIndexerDataSourceConnection
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Documents.Indexes.Models.SearchIndexerDataSourceConnection"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/>, <paramref name="credentialsInternal"/> or <paramref name="container"/> is null. </exception>
        public SearchIndexerDataSourceConnection(string name, SearchIndexerDataSourceType type, Search.Documents.DataSourceCredentials credentialsInternal, SearchIndexerDataContainer container)
        {
            Argument.AssertNotNull(name, nameof(name));
            Argument.AssertNotNull(credentialsInternal, nameof(credentialsInternal));
        ...
        /// Please note <see cref="Search.Documents.SearchIndexerDataIdentity"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        /// Please note <see cref="Search.Documents.DataChangeDetectionPolicy"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        /// Please note <see cref="Search.Documents.DataDeletionDetectionPolicy"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        internal SearchIndexerDataSourceConnection(string name, string description, SearchIndexerDataSourceType type, Search.Documents.DataSourceCredentials credentialsInternal, SearchIndexerDataContainer container, Search.Documents.SearchIndexerDataIdentity identity, Search.Documents.DataChangeDetectionPolicy dataChangeDetectionPolicy, Search.Documents.DataDeletionDetectionPolicy dataDeletionDetectionPolicy, string etag, Search.Documents.SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="Documents.Indexes.Models.SearchIndexerDataSourceConnection"/> for deserialization. </summary>
        ...
        /// The available derived classes include <see cref="SearchIndexerDataNoneIdentity"/> and <see cref="SearchIndexerDataUserAssignedIdentity"/>.
        /// </summary>
        public Search.Documents.SearchIndexerDataIdentity Identity { get; set; }
        /// <summary>
        /// The data change detection policy for the datasource.
        /// Please note <see cref="Search.Documents.DataChangeDetectionPolicy"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="HighWaterMarkChangeDetectionPolicy"/> and <see cref="SqlIntegratedChangeTrackingPolicy"/>.
        /// </summary>
        public Search.Documents.DataChangeDetectionPolicy DataChangeDetectionPolicy { get; set; }
        /// <summary>
        /// The data deletion detection policy for the datasource.
        /// Please note <see cref="Search.Documents.DataDeletionDetectionPolicy"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="NativeBlobSoftDeleteDeletionDetectionPolicy"/> and <see cref="SoftDeleteColumnDeletionDetectionPolicy"/>.
        /// </summary>
        public Search.Documents.DataDeletionDetectionPolicy DataDeletionDetectionPolicy { get; set; }
        /// <summary>
        /// A description of an encryption key that you create in Azure Key Vault. This key
        /// is used to provide an additional level of encryption-at-rest for your
        /// datasource definition when you want full assurance that no one, not even
        ...
        /// created on or after January 1, 2019.
        /// </summary>
        public Search.Documents.SearchResourceEncryptionKey EncryptionKey { get; set; }
    }
}
