...
namespace Azure.Search.Documents
{
    internal partial class KnowledgeRetrievalRestClient
    {
        ...
        internal HttpMessage CreateRetrieveRequest(KnowledgeAgentRetrievalRequest retrievalRequest)
        {
        ...
        public async Task<Response<KnowledgeAgentRetrievalResponse>> RetrieveAsync(KnowledgeAgentRetrievalRequest retrievalRequest, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateRetrieveRequest(retrievalRequest);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="retrievalRequest"/> is null. </exception>
        public Response<KnowledgeAgentRetrievalResponse> Retrieve(KnowledgeAgentRetrievalRequest retrievalRequest, CancellationToken cancellationToken = default)
        {
            if (retrievalRequest == null)
            {
                throw new ArgumentNullException(nameof(retrievalRequest));
