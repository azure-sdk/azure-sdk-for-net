...
namespace Azure.ResourceManager.Search.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetUsagesBySubscription_GetQuotaUsagesList()
        {
            ...
            await foreach (QuotaUsageResult item in subscriptionResource.GetUsagesBySubscriptionAsync())
            {
        ...
        public async Task UsageBySubscriptionSku_GetQuotaUsage()
        {
            ...
            QuotaUsageResult result = await subscriptionResource.UsageBySubscriptionSkuAsync();
