...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SearchServiceData : TrackedResourceData
    {
        ...
        /// <param name="location"> The location. </param>
        /// <param name="sku"> The SKU of the search service, which determines billing rate and capacity limits. This property is required when creating a new search service. </param>
