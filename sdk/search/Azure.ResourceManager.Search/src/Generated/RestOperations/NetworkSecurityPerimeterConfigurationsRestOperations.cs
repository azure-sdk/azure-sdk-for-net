...
namespace Azure.ResourceManager.Search
{
    internal partial class NetworkSecurityPerimeterConfigurationsRestOperations
    {
        ...
        public async Task<Response<NetworkSecurityPerimeterConfigurationData>> GetAsync(string subscriptionId, string resourceGroupName, string searchServiceName, string nspConfigName, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentNullException(nameof(nspConfigName));
            }
            if (nspConfigName.Length == 0)
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(nspConfigName));
            }
