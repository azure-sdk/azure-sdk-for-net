...
namespace Azure.ResourceManager.Search.Models
{
    internal partial class NetworkSecurityPerimeterConfigurationListResult : IUtf8JsonSerializable, IJsonModel<NetworkSecurityPerimeterConfigurationListResult>
    {
        ...
        void IJsonModel<NetworkSecurityPerimeterConfigurationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkSecurityPerimeterConfigurationListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && !(Value is ChangeTrackingList<NetworkSecurityPerimeterConfigurationData> collection && collection.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<NetworkSecurityPerimeterConfigurationListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkSecurityPerimeterConfigurationListResult)} does not support '{options.Format}' format.");
            }
        }
