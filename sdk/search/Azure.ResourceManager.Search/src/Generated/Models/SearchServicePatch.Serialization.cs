...
namespace Azure.ResourceManager.Search.Models
{
    public partial class SearchServicePatch : IUtf8JsonSerializable, IJsonModel<SearchServicePatch>
    {
        ...
        internal static SearchServicePatch DeserializeSearchServicePatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IList<SearchDisabledDataExfiltrationOption>> disabledDataExfiltrationOptions = default;
            ...
            return new SearchServicePatch(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, sku.Value, identity, Optional.ToNullable(replicaCount), Optional.ToNullable(partitionCount), Optional.ToNullable(hostingMode), Optional.ToNullable(publicNetworkAccess), Optional.ToNullable(status), statusDetails.Value, Optional.ToNullable(provisioningState), networkRuleSet.Value, Optional.ToList(disabledDataExfiltrationOptions), encryptionWithCmk.Value, Optional.ToNullable(disableLocalAuth), authOptions.Value, Optional.ToNullable(semanticSearch), Optional.ToList(privateEndpointConnections), Optional.ToList(sharedPrivateLinkResources), Optional.ToNullable(eTag), serializedAdditionalRawData);
        }
