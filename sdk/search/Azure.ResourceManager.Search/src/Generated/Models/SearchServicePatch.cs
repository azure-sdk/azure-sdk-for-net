...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchServicePatch : TrackedResourceData
    {
        ...
        /// <param name="location"> The location. </param>
        /// <param name="searchSku"> The SKU of the search service, which determines the billing rate and capacity limits. This property is required when creating a new search service. </param>
