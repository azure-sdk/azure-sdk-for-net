...
{
    internal partial class SearchServiceNetworkRuleSet : IUtf8JsonSerializable, IJsonModel<SearchServiceNetworkRuleSet>
    {
        ...
        internal static SearchServiceNetworkRuleSet DeserializeSearchServiceNetworkRuleSet(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SearchServiceNetworkRuleSet(ipRules ?? new ChangeTrackingList<SearchServiceIPRule>(), serializedAdditionalRawData);
        }
