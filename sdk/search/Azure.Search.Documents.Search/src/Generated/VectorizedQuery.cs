...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class VectorizedQuery : VectorQuery
    {
        ...
        /// <param name="vector"> The vector representation of a search query. </param>
        internal VectorizedQuery(int? k, string fields, bool? exhaustive, double? oversampling, float? weight, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<float> vector) : base(k, fields, exhaustive, oversampling, weight, kind, serializedAdditionalRawData)
        {
            Vector = vector;
        }
