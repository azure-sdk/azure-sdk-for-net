...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class AutocompleteRequest
    {
        ...
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="search"/> or <paramref name="suggesterName"/> is null. </exception>
        ...
        internal AutocompleteRequest(string search, AutocompleteMode? autocompleteMode, string filter, bool? fuzzy, string highlightPostTag, string highlightPreTag, double? minimumCoverage, string searchFields, string suggesterName, int? top, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Search = search;
