...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class VectorizableImageBinaryQuery : VectorQuery
    {
        ...
        /// search query.
        /// </param>
        internal VectorizableImageBinaryQuery(int? k, string fields, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string filterOverride, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string base64Image) : base(k, fields, exhaustive, oversampling, weight, threshold, filterOverride, kind, serializedAdditionalRawData)
        {
