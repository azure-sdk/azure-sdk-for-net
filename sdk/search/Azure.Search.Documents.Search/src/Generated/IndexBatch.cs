...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class IndexBatch
    {
        ...
        /// <param name="value"> The actions in the batch. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        public IndexBatch(IEnumerable<IndexAction> value)
        {
        ...
        internal IndexBatch(IList<IndexAction> value, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
        ...
        public IList<IndexAction> Value { get; }
    }
}
