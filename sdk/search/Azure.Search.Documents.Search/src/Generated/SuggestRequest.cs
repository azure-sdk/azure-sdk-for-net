...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class SuggestRequest
    {
        ...
        internal SuggestRequest(string filter, bool? fuzzy, string highlightPostTag, string highlightPreTag, double? minimumCoverage, string orderby, string search, string searchFields, string select, string suggesterName, int? top, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Filter = filter;
            Fuzzy = fuzzy;
