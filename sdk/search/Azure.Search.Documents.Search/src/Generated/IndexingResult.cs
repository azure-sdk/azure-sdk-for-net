...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class IndexingResult
    {
        ...
        internal IndexingResult(string key, bool status, int statusCode)
        {
        ...
        internal IndexingResult(string key, string errorMessage, bool status, int statusCode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Key = key;
