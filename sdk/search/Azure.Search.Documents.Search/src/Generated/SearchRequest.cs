...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class SearchRequest
    {
        ...
        internal SearchRequest(bool? count, IList<string> facets, string filter, string highlight, string highlightPostTag, string highlightPreTag, double? minimumCoverage, string orderby, QueryType? queryType, ScoringStatistics? scoringStatistics, string sessionId, IList<string> scoringParameters, string scoringProfile, QueryDebugMode? debug, string search, string searchFields, SearchMode? searchMode, QueryLanguage? queryLanguage, QuerySpellerType? speller, string select, int? skip, int? top, string semanticConfiguration, SemanticErrorMode? semanticErrorHandling, int? semanticMaxWaitInMilliseconds, string semanticQuery, QueryAnswerType? answers, QueryCaptionType? captions, QueryRewritesType? queryRewrites, string semanticFields, IList<VectorQuery> vectorQueries, VectorFilterMode? vectorFilterMode, HybridSearch hybridSearch, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Count = count;
            Facets = facets;
            Filter = filter;
