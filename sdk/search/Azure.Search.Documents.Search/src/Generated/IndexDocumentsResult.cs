...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class IndexDocumentsResult
    {
        ...
        internal IndexDocumentsResult(IEnumerable<IndexingResult> value)
        {
        ...
        internal IndexDocumentsResult(IReadOnlyList<IndexingResult> value, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
        ...
        public IReadOnlyList<IndexingResult> Value { get; }
    }
}
