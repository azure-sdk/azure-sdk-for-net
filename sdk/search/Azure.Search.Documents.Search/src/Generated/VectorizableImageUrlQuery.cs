...
namespace Azure.Search.Documents.Search
{
    ...
    public partial class VectorizableImageUrlQuery : VectorQuery
    {
        ...
        internal VectorizableImageUrlQuery(int? k, string fields, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string filterOverride, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string url) : base(k, fields, exhaustive, oversampling, weight, threshold, filterOverride, kind, serializedAdditionalRawData)
        {
            Url = url;
        }
