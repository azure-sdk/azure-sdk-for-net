    ...
    public partial class SearchRequest : IUtf8JsonSerializable, IJsonModel<SearchRequest>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Count))
            {
                ...
                writer.WriteBooleanValue(Count.Value);
            }
            ...
            if (Optional.IsDefined(Highlight))
            {
        ...
        internal static SearchRequest DeserializeSearchRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("scoringStatistics"u8))
                {
                    ...
                    scoringStatistics = new ScoringStatistics(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("searchMode"u8))
                {
                    ...
                    searchMode = new SearchMode(property.Value.GetString());
                    continue;
                }
