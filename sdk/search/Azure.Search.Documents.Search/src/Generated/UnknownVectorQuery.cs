...
namespace Azure.Search.Documents.Search
{
    ...
    internal partial class UnknownVectorQuery : VectorQuery
    {
        ...
        internal UnknownVectorQuery(int? k, string fields, bool? exhaustive, double? oversampling, float? weight, VectorQueryKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(k, fields, exhaustive, oversampling, weight, kind, serializedAdditionalRawData)
        {
        }
