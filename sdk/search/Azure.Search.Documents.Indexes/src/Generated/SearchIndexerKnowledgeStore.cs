...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchIndexerKnowledgeStore
    {
        ...
        internal SearchIndexerKnowledgeStore(string storageConnectionString, IList<SearchIndexerKnowledgeStoreProjection> projections, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StorageConnectionString = storageConnectionString;
