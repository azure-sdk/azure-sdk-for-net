...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class PhoneticTokenFilter : TokenFilter
    {
        ...
        /// </param>
        internal PhoneticTokenFilter(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, PhoneticEncoder? encoder, bool? replace) : base(odataType, name, serializedAdditionalRawData)
        {
            Encoder = encoder;
            Replace = replace;
        }
