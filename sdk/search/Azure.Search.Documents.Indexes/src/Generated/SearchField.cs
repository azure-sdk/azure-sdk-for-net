...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchField
    {
        ...
        /// <param name="vectorSearchProfile">
        /// The name of the vector search profile that specifies the algorithm and
        /// vectorizer to use when searching the vector field.
        /// </param>
        /// <param name="vectorEncoding"> The encoding format to interpret the field contents. </param>
        /// <param name="synonymMaps">
        ...
        internal SearchField(string name, SearchFieldDataType type, bool? key, bool? retrievable, bool? stored, bool? searchable, bool? filterable, bool? sortable, bool? facetable, LexicalAnalyzerName? analyzer, LexicalAnalyzerName? searchAnalyzer, LexicalAnalyzerName? indexAnalyzer, LexicalNormalizerName? normalizer, int? dimensions, string vectorSearchProfile, VectorEncodingFormat? vectorEncoding, IList<string> synonymMaps, IList<SearchField> fields, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Type = type;
            Key = key;
        ...
        public VectorEncodingFormat? VectorEncoding { get; set; }
        /// <summary>
        /// A list of the names of synonym maps to associate with this field. This option
        /// can be used only with searchable fields. Currently only one synonym map per
        /// field is supported. Assigning a synonym map to a field ensures that query terms
