...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchClient
    {
        ...
        {
            return Volatile.Read(ref _cachedIndexes) ?? Interlocked.CompareExchange(ref _cachedIndexes, new Indexes(ClientDiagnostics, _pipeline, _keyCredential, _tokenCredential, _endpoint, _apiVersion), null) ?? _cachedIndexes;
        }
