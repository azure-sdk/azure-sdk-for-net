...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchIndexer
    {
        ...
        /// fields in the index.
        /// </param>
        /// <param name="outputFieldMappings">
        /// Output field mappings are applied after enrichment and immediately before
        /// indexing.
        /// </param>
        /// <param name="disabled"> A value indicating whether the indexer is disabled. Default is false. </param>
        ...
        internal SearchIndexer(string name, string description, string dataSourceName, string skillsetName, string targetIndexName, IndexingSchedule schedule, IndexingParameters parameters, IList<FieldMapping> fieldMappings, IList<FieldMapping> outputFieldMappings, bool? disabled, string eTag, SearchResourceEncryptionKey encryptionKey, SearchIndexerCache cache, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
