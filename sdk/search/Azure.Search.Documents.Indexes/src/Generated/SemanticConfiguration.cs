...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SemanticConfiguration
    {
        ...
        internal SemanticConfiguration(string name, SemanticPrioritizedFields prioritizedFields, bool? flightingOptIn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            PrioritizedFields = prioritizedFields;
