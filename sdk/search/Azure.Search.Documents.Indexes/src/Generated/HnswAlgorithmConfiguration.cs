...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class HnswAlgorithmConfiguration : VectorSearchAlgorithmConfiguration
    {
        ...
        internal HnswAlgorithmConfiguration(string name, VectorSearchAlgorithmKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, HnswParameters hnswParameters) : base(name, kind, serializedAdditionalRawData)
        {
