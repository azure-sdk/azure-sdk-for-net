...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class PIIDetectionSkill : SearchIndexerSkill
    {
        ...
        /// </param>
        internal PIIDetectionSkill(string odataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, IDictionary<string, BinaryData> serializedAdditionalRawData, string defaultLanguageCode, double? minimumPrecision, PIIDetectionSkillMaskingMode? maskingMode, string maskingCharacter, string modelVersion, IList<string> piiCategories, string domain) : base(odataType, name, description, context, inputs, outputs, serializedAdditionalRawData)
        {
