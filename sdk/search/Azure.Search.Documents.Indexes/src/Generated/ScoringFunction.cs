...
namespace Azure.Search.Documents.Indexes
{
    ...
    public abstract partial class ScoringFunction
    {
        ...
        protected ScoringFunction(string fieldName, double boost)
        {
        ...
        internal ScoringFunction(string fieldName, double boost, ScoringFunctionInterpolation? interpolation, string type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FieldName = fieldName;
            Boost = boost;
