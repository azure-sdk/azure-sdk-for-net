...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchResourceEncryptionKey
    {
        ...
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="keyVaultKeyName"/> or <paramref name="keyVaultUri"/> is null. </exception>
        ...
        internal SearchResourceEncryptionKey(string keyVaultKeyName, string keyVaultKeyVersion, string keyVaultUri, AzureActiveDirectoryApplicationCredentials accessCredentials, SearchIndexerDataIdentity identity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyVaultKeyName = keyVaultKeyName;
