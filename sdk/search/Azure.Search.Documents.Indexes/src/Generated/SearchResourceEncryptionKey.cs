...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchResourceEncryptionKey
    {
        ...
        internal SearchResourceEncryptionKey(string keyVaultKeyName, string keyVaultKeyVersion, string keyVaultUri, AzureActiveDirectoryApplicationCredentials accessCredentials, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyVaultKeyName = keyVaultKeyName;
            KeyVaultKeyVersion = keyVaultKeyVersion;
            KeyVaultUri = keyVaultUri;
