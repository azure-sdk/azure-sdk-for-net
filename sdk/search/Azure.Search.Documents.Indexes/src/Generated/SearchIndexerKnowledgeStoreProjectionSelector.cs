...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchIndexerKnowledgeStoreProjectionSelector
    {
        ...
        internal SearchIndexerKnowledgeStoreProjectionSelector(string referenceKeyName, string generatedKeyName, string source, string sourceContext, IList<InputFieldMappingEntry> inputs, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
