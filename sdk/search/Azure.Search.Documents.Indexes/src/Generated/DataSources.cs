...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class DataSources
    {
        ...
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateOrUpdateAsync(string,SearchIndexerDataSource,MatchConditions,CancellationToken)']/*" />
        public virtual async Task<Response<SearchIndexerDataSource>> CreateOrUpdateAsync(string dataSourceName, SearchIndexerDataSource dataSource, MatchConditions matchConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            Response response = await CreateOrUpdateAsync(dataSourceName, content, matchConditions, context).ConfigureAwait(false);
            return Response.FromValue(SearchIndexerDataSource.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="dataSourceName"/> or <paramref name="dataSource"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="dataSourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateOrUpdate(string,SearchIndexerDataSource,MatchConditions,CancellationToken)']/*" />
        public virtual Response<SearchIndexerDataSource> CreateOrUpdate(string dataSourceName, SearchIndexerDataSource dataSource, MatchConditions matchConditions = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            Argument.AssertNotNull(dataSource, nameof(dataSource));
            ...
            using RequestContent content = dataSource.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = CreateOrUpdate(dataSourceName, content, matchConditions, context);
            return Response.FromValue(SearchIndexerDataSource.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrUpdateAsync(string,SearchIndexerDataSource,MatchConditions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateOrUpdateAsync(string,RequestContent,MatchConditions,RequestContext)']/*" />
        public virtual async Task<Response> CreateOrUpdateAsync(string dataSourceName, RequestContent content, MatchConditions matchConditions = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            ...
            try
            {
                using HttpMessage message = CreateCreateOrUpdateRequest(dataSourceName, content, matchConditions, context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrUpdate(string,SearchIndexerDataSource,MatchConditions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateOrUpdate(string,RequestContent,MatchConditions,RequestContext)']/*" />
        public virtual Response CreateOrUpdate(string dataSourceName, RequestContent content, MatchConditions matchConditions = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<Response<SearchIndexerDataSource>> GetDataSourceAsync(string dataSourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
        ...
        public virtual Response<SearchIndexerDataSource> GetDataSource(string dataSourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
        ...
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateAsync(SearchIndexerDataSource,CancellationToken)']/*" />
        public virtual async Task<Response<SearchIndexerDataSource>> CreateAsync(SearchIndexerDataSource dataSource, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(dataSource, nameof(dataSource));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dataSource"/> is null. </exception>
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='Create(SearchIndexerDataSource,CancellationToken)']/*" />
        public virtual Response<SearchIndexerDataSource> Create(SearchIndexerDataSource dataSource, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(dataSource, nameof(dataSource));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateAsync(SearchIndexerDataSource,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Create(SearchIndexerDataSource,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string dataSourceName, RequestContent content, MatchConditions matchConditions, RequestContext context)
        {
