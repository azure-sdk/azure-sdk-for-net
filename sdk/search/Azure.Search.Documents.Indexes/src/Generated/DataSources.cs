...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class DataSources
    {
        ...
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateOrUpdateAsync(string,SearchIndexerDataSource,bool?,MatchConditions,CancellationToken)']/*" />
        public virtual async Task<Response<SearchIndexerDataSource>> CreateOrUpdateAsync(string dataSourceName, SearchIndexerDataSource dataSource, bool? skipIndexerResetRequirementForCache = null, MatchConditions matchConditions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="dataSourceName"/> or <paramref name="dataSource"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="dataSourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/DataSources.xml" path="doc/members/member[@name='CreateOrUpdate(string,SearchIndexerDataSource,bool?,MatchConditions,CancellationToken)']/*" />
        public virtual Response<SearchIndexerDataSource> CreateOrUpdate(string dataSourceName, SearchIndexerDataSource dataSource, bool? skipIndexerResetRequirementForCache = null, MatchConditions matchConditions = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            Argument.AssertNotNull(dataSource, nameof(dataSource));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrUpdateAsync(string,SearchIndexerDataSource,bool?,MatchConditions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrUpdate(string,SearchIndexerDataSource,bool?,MatchConditions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
