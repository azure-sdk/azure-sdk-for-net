...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class WebApiVectorizerParameters
    {
        ...
        internal WebApiVectorizerParameters(Uri uri, IDictionary<string, string> httpHeaders, string httpMethod, TimeSpan? timeout, string authResourceId, SearchIndexerDataIdentity authIdentity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uri = uri;
