...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class ScalarQuantizationCompression : VectorSearchCompression
    {
        ...
        internal ScalarQuantizationCompression(string name, bool? rerankWithOriginalVectors, double? defaultOversampling, RescoringOptions rescoringOptions, int? truncationDimension, VectorSearchCompressionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, ScalarQuantizationParameters scalarQuantizationParameters) : base(name, rerankWithOriginalVectors, defaultOversampling, rescoringOptions, truncationDimension, kind, serializedAdditionalRawData)
        {
