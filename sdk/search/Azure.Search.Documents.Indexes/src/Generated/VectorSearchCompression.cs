...
namespace Azure.Search.Documents.Indexes
{
    ...
    public abstract partial class VectorSearchCompression
    {
        ...
        internal VectorSearchCompression(string name, bool? rerankWithOriginalVectors, double? defaultOversampling, VectorSearchCompressionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
