...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class CommonGramTokenFilter : TokenFilter
    {
        ...
        /// </param>
        internal CommonGramTokenFilter(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<string> commonWords, bool? ignoreCase, bool? queryMode) : base(odataType, name, serializedAdditionalRawData)
        {
