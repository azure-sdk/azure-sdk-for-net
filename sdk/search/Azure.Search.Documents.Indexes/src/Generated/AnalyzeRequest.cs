...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class AnalyzeRequest
    {
        ...
        internal AnalyzeRequest(string text, LexicalAnalyzerName? analyzer, LexicalTokenizerName? tokenizer, IList<TokenFilterName> tokenFilters, IList<CharFilterName> charFilters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Analyzer = analyzer;
            Tokenizer = tokenizer;
