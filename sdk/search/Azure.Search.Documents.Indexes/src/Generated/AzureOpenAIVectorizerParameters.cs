...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class AzureOpenAIVectorizerParameters
    {
        ...
        internal AzureOpenAIVectorizerParameters(Uri resourceUri, string deploymentId, string apiKey, SearchIndexerDataIdentity authIdentity, AzureOpenAIModelName? modelName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
