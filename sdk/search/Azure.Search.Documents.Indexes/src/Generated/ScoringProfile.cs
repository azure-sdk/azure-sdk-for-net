...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class ScoringProfile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ScoringProfile"/>. </summary>
        /// <param name="name"> The name of the scoring profile. </param>
        /// <param name="text"> Parameters that boost scoring based on text matches in certain index fields. </param>
        ...
        /// </param>
        /// <param name="functionAggregation">
        ...
        internal ScoringProfile(string name, TextWeights text, IList<ScoringFunction> functions, ScoringFunctionAggregation? functionAggregation, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Text = text;
            Functions = functions;
