...
{
    public partial class AMLParameters : IUtf8JsonSerializable, IJsonModel<AMLParameters>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AMLParameters>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AMLParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AMLParameters>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AMLParameters IJsonModel<AMLParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AMLParameters>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AMLParameters>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AMLParameters>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AMLParameters IPersistableModel<AMLParameters>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AMLParameters>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AMLParameters>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
