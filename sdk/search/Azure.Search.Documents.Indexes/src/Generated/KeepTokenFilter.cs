...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class KeepTokenFilter : TokenFilter
    {
        ...
        /// <param name="keepWords"> The list of words to keep. </param>
        /// <param name="keepWordsCase"> A value indicating whether to lower case all words first. Default is false. </param>
        internal KeepTokenFilter(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<string> keepWords, bool? keepWordsCase) : base(odataType, name, serializedAdditionalRawData)
        {
            KeepWords = keepWords;
            KeepWordsCase = keepWordsCase;
        }
