...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class IndexerExecutionResult
    {
        ...
        internal IndexerExecutionResult(IndexerExecutionStatus status, IEnumerable<SearchIndexerError> errors, IEnumerable<SearchIndexerWarning> warnings, int itemsProcessed, int itemsFailed)
        {
        ...
        internal IndexerExecutionResult(IndexerExecutionStatus status, string errorMessage, DateTimeOffset? startTime, DateTimeOffset? endTime, IReadOnlyList<SearchIndexerError> errors, IReadOnlyList<SearchIndexerWarning> warnings, int itemsProcessed, int itemsFailed, string initialTrackingState, string finalTrackingState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
