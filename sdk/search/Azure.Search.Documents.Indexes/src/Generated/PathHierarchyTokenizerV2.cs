...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class PathHierarchyTokenizerV2 : LexicalTokenizer
    {
        ...
        internal PathHierarchyTokenizerV2(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, string delimiter, string replacement, int? maxTokenLength, bool? reverse, int? skip) : base(odataType, name, serializedAdditionalRawData)
        {
            Delimiter = delimiter;
