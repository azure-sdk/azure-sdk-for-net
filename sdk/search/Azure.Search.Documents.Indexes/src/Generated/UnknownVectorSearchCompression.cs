...
namespace Azure.Search.Documents.Indexes
{
    ...
    internal partial class UnknownVectorSearchCompression : VectorSearchCompression
    {
        ...
        internal UnknownVectorSearchCompression(string name, bool? rerankWithOriginalVectors, double? defaultOversampling, VectorSearchCompressionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(name, rerankWithOriginalVectors, defaultOversampling, kind, serializedAdditionalRawData)
        {
        }
