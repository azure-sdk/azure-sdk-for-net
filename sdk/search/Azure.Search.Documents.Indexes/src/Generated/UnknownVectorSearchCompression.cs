...
namespace Azure.Search.Documents.Indexes
{
    ...
    internal partial class UnknownVectorSearchCompression : VectorSearchCompression
    {
        ...
        internal UnknownVectorSearchCompression(string name, bool? rerankWithOriginalVectors, double? defaultOversampling, RescoringOptions rescoringOptions, int? truncationDimension, VectorSearchCompressionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(name, rerankWithOriginalVectors, defaultOversampling, rescoringOptions, truncationDimension, kind, serializedAdditionalRawData)
        {
        }
