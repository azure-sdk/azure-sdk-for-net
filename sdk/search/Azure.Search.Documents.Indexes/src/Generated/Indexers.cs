...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class Indexers
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="indexerName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Indexers.xml" path="doc/members/member[@name='CreateOrUpdateAsync(string,SearchIndexer,MatchConditions,CancellationToken)']/*" />
        public virtual async Task<Response<SearchIndexer>> CreateOrUpdateAsync(string indexerName, SearchIndexer indexer, MatchConditions matchConditions = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexerName, nameof(indexerName));
            ...
            Response response = await CreateOrUpdateAsync(indexerName, content, matchConditions, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="indexerName"/> or <paramref name="indexer"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="indexerName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Indexers.xml" path="doc/members/member[@name='CreateOrUpdate(string,SearchIndexer,MatchConditions,CancellationToken)']/*" />
        public virtual Response<SearchIndexer> CreateOrUpdate(string indexerName, SearchIndexer indexer, MatchConditions matchConditions = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(indexerName, nameof(indexerName));
            Argument.AssertNotNull(indexer, nameof(indexer));
            ...
            using RequestContent content = indexer.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = CreateOrUpdate(indexerName, content, matchConditions, context);
            return Response.FromValue(SearchIndexer.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrUpdateAsync(string,SearchIndexer,MatchConditions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Indexers.xml" path="doc/members/member[@name='CreateOrUpdateAsync(string,RequestContent,MatchConditions,RequestContext)']/*" />
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrUpdate(string,SearchIndexer,MatchConditions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Indexers.xml" path="doc/members/member[@name='CreateOrUpdate(string,RequestContent,MatchConditions,RequestContext)']/*" />
