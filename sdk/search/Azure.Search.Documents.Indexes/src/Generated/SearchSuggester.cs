...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchSuggester
    {
        ...
        internal SearchSuggester(string name, SearchSuggesterSearchMode searchMode, IList<string> sourceFields, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
