...
namespace Azure.ResourceManager.Hardwaresecuritymodules.Models
{
    ...
    public partial class RestoreResult
    {
        ...
        internal RestoreResult(BackupRestoreOperationStatus? status, string statusDetails, ResponseError error, DateTimeOffset? startOn, DateTimeOffset? endOn, string jobId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
