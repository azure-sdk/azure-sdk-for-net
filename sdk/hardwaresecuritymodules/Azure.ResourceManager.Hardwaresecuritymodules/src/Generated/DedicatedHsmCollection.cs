...
namespace Azure.ResourceManager.Hardwaresecuritymodules
{
    ...
    public partial class DedicatedHsmCollection : ArmCollection, IEnumerable<DedicatedHsmResource>, IAsyncEnumerable<DedicatedHsmResource>
    {
        ...
        public virtual async Task<ArmOperation> CreateOrUpdateAsync(WaitUntil waitUntil, string name, DedicatedHsmData data, CancellationToken cancellationToken = default)
        {
