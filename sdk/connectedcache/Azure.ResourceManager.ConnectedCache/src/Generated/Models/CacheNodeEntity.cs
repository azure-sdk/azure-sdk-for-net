...
namespace Azure.ResourceManager.ConnectedCache.Models
{
    ...
    public partial class CacheNodeEntity
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CacheNodeEntity"/>. </summary>
        ...
        internal CacheNodeEntity(string fullyQualifiedResourceId, string customerId, string customerName, string ipAddress, string customerIndex, string cacheNodeId, string cacheNodeName, int? customerAsn, bool? isEnabled, int? maxAllowableEgressInMbps, float? maxAllowableProbability, string xCid, bool? isEnterpriseManaged, string createAsyncOperationId, string deleteAsyncOperationId, string clientTenantId, string category, int? releaseVersion, DateTimeOffset? lastSyncWithAzureTimestamp, DateTimeOffset? lastUpdatedTimestamp, int? synchWithAzureAttemptsCount, string containerConfigurations, IList<string> cidrCsv, DateTimeOffset? cidrCsvLastUpdateOn, DateTimeOffset? bgpCidrCsvLastUpdateOn, DateTimeOffset? bgpLastReportedOn, string bgpReviewStateText, BgpReviewStateEnum? bgpReviewState, string bgpReviewFeedback, int? bgpNumberOfTimesUpdated, int? bgpNumberOfRecords, int? bgpCidrBlocksCount, int? bgpAddressSpace, bool? shouldMigrate, int? bgpFileBytesTruncated, int? cidrSelectionType, bool? isFrozen, int? reviewState, string reviewStateText, string reviewFeedback, ConfigurationState? configurationState, string configurationStateText, int? addressSpace, int? workerConnections, DateTimeOffset? workerConnectionsLastUpdatedOn, int? containerResyncTrigger, string imageUri, string fullyQualifiedDomainName, AutoUpdateRingType? autoUpdateRingType, int? autoUpdateRequestedWeek, int? autoUpdateRequestedDay, string autoUpdateRequestedTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ...
            CidrCsv = cidrCsv;
            CidrCsvLastUpdateOn = cidrCsvLastUpdateOn;
            BgpCidrCsvLastUpdateOn = bgpCidrCsvLastUpdateOn;
        ...
        public DateTimeOffset? CidrCsvLastUpdateOn { get; }
        /// <summary> Cache node resource last Bgp Cidr Csv update timestamp. </summary>
        public DateTimeOffset? BgpCidrCsvLastUpdateOn { get; }
        ...
        public BgpReviewStateEnum? BgpReviewState { get; }
        ...
        /// <summary> Customer requested week of month for mcc install of auto update cycle. </summary>
        public int? AutoUpdateRequestedWeek { get; set; }
        /// <summary> Customer requested day of week for mcc install of auto update cycle. </summary>
