...
#pragma warning disable SA1649 // File name should match first type name
    internal class ConnectedCacheArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ConnectedCacheArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ConnectedCacheArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ConnectedCacheArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
