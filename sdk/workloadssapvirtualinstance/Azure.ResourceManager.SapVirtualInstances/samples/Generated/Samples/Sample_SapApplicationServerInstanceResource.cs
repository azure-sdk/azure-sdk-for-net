...
["tag1"] = "value1"
        ...
        public async Task Start_StartTheSAPApplicationServerInstance()
        {
            ...
            ArmOperation<OperationStatusResult> lro = await sapApplicationServerInstance.StartAsync(WaitUntil.Completed, content);
        ...
        public async Task Stop_StopTheSAPApplicationServerInstance()
        {
            ...
            ArmOperation<OperationStatusResult> lro = await sapApplicationServerInstance.StopAsync(WaitUntil.Completed, content);
            OperationStatusResult result = lro.Value;
