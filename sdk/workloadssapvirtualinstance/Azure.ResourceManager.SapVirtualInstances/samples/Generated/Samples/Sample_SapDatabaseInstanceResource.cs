...
["key1"] = "value1"
        ...
        public async Task Start_StartTheDatabaseInstanceOfTheSAPSystem()
        {
            ...
            ArmOperation<OperationStatusResult> lro = await sapDatabaseInstance.StartAsync(WaitUntil.Completed, content);
        ...
        public async Task Stop_StopTheDatabaseInstanceOfTheSAPSystem()
        {
            ...
            ArmOperation<OperationStatusResult> lro = await sapDatabaseInstance.StopAsync(WaitUntil.Completed, content);
            OperationStatusResult result = lro.Value;
