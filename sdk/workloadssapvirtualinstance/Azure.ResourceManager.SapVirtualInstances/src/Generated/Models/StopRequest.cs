...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class StopRequest
    {
        ...
        /// <summary> Initializes a new instance of <see cref="StopRequest"/>. </summary>
        public StopRequest()
        {
        }
        ...
        internal StopRequest(long? softStopTimeoutSeconds, bool? deallocateVm, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
