...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class LinuxConfiguration : OSConfiguration
    {
        ...
        internal LinuxConfiguration(OSType osType, IDictionary<string, BinaryData> serializedAdditionalRawData, bool? disablePasswordAuthentication, SshConfiguration ssh, SshKeyPair sshKeyPair) : base(osType, serializedAdditionalRawData)
        {
