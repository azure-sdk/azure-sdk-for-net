...
namespace Azure.ResourceManager.SapVirtualInstances.Mocking
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="MockableSapVirtualInstancesArmClient"/> class for mocking. </summary>
        protected MockableSapVirtualInstancesArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableSapVirtualInstancesArmClient"/> class. </summary>
