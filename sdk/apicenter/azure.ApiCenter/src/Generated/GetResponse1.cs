...
namespace azure.ApiCenter
{
    ...
    public partial class GetResponse1
    {
        ...
        internal GetResponse1(string title, ApiKind kind)
        {
        ...
        internal GetResponse1(string title, string summary, string description, ApiKind kind, LifecycleStage? lifecycleStage, TermsOfService termsOfService, License license, IReadOnlyList<ExternalDocumentation> externalDocumentation, IReadOnlyList<Contact> contacts, ApiCustomProperties customProperties, DateTimeOffset? lastUpdated, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Summary = summary;
