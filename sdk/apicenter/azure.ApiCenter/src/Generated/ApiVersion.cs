...
{
    /// <summary> API version resource model. </summary>
    public partial class ApiVersion
    {
        ...
        internal ApiVersion(string name, string title, LifecycleStage lifecycleStage)
        {
        ...
        internal ApiVersion(string name, string title, LifecycleStage lifecycleStage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Title = title;
            LifecycleStage = lifecycleStage;
        ...
        /// <summary> Initializes a new instance of <see cref="ApiVersion"/> for deserialization. </summary>
        internal ApiVersion()
        {
        }
