...
namespace azure.ApiCenter
{
    ...
    public partial class GetResponse
    {
        ...
        internal GetResponse(string title, EnvironmentKind kind)
        {
        ...
        internal GetResponse(string title, EnvironmentKind kind, string description, EnvironmentServer server, EnvironmentOnboardingModel onboarding, EnvironmentCustomProperties customProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Kind = kind;
