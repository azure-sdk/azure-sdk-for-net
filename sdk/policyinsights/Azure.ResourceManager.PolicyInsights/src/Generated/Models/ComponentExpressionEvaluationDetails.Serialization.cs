...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        internal static ComponentExpressionEvaluationDetails DeserializeComponentExpressionEvaluationDetails(JsonElement element)
        {
            ...
            return new ComponentExpressionEvaluationDetails(result.Value, expression.Value, expressionKind.Value, path.Value, expressionValue.Value, targetValue.Value, @operator.Value);
        }
    }
}
