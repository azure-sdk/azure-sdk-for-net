...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        internal static ComponentPolicyState DeserializeComponentPolicyState(JsonElement element)
        {
            ...
            Optional<ComponentPolicyEvaluationDetails> policyEvaluationDetails = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("policyEvaluationDetails"u8))
                {
                    ...
                    policyEvaluationDetails = ComponentPolicyEvaluationDetails.DeserializeComponentPolicyEvaluationDetails(property.Value);
                    continue;
                }
