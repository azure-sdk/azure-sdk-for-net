...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ScopeMapResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="RegistryResource"/> using the GetScopeMaps method.
    /// </summary>
    public partial class ScopeMapResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ScopeMapResource for mocking. </summary>
        protected ScopeMapResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ScopeMapResource"/> class. </summary>
        ...
        internal ScopeMapResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _scopeMapsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerRegistry", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scopeMaps/{scopeMapName}";
        ...
        {
            using DiagnosticScope scope = _scopeMapsClientDiagnostics.CreateScope("ScopeMapResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _scopeMapsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<ScopeMapResource>> UpdateAsync(WaitUntil waitUntil, ScopeMapPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _scopeMapsClientDiagnostics.CreateScope("ScopeMapResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _scopeMapsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ScopeMapPatch.ToRequestContent(patch), context);
        ...
        {
            using DiagnosticScope scope = _scopeMapsClientDiagnostics.CreateScope("ScopeMapResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _scopeMapsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ContainerRegistryArmOperation operation = new ContainerRegistryArmOperation(_scopeMapsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
