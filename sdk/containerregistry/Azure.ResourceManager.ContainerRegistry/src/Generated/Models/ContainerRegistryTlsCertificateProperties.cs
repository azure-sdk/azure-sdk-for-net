...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTlsCertificateProperties
    {
        ...
        internal ContainerRegistryTlsCertificateProperties(ContainerRegistryCertificateType? @type, string location, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Location = location;
