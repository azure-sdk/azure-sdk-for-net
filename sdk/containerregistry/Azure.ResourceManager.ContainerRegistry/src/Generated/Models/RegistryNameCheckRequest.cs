...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class RegistryNameCheckRequest
    {
        ...
        internal RegistryNameCheckRequest(string name, ContainerRegistryResourceType @type, string resourceGroupName, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Type = @type;
