...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class ArchivesGetAllAsyncCollectionResultOfT : AsyncPageable<ArchiveData>
    {
        ...
        /// <summary> Initializes a new instance of ArchivesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Archives client used to send requests. </param>
        ...
        public ArchivesGetAllAsyncCollectionResultOfT(Archives client, Guid subscriptionId, string resourceGroupName, string registryName, string packageType, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ArchivesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<Page<ArchiveData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ArchiveData>.FromValues((IReadOnlyList<ArchiveData>)result.Value, nextPage?.AbsoluteUri, response);
