...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class PipelineRunsGetAllCollectionResultOfT : Pageable<PipelineRunData>
    {
        ...
        /// <summary> Initializes a new instance of PipelineRunsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PipelineRunsGetAllCollectionResultOfT(PipelineRuns client, Guid subscriptionId, string resourceGroupName, string registryName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PipelineRunsGetAllCollectionResultOfT as an enumerable collection. </summary>
