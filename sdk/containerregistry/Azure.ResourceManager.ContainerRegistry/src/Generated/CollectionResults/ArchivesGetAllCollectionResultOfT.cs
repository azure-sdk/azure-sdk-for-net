...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class ArchivesGetAllCollectionResultOfT : Pageable<ArchiveData>
    {
        ...
        /// <summary> Initializes a new instance of ArchivesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ArchivesGetAllCollectionResultOfT(Archives client, Guid subscriptionId, string resourceGroupName, string registryName, string packageType, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ArchivesGetAllCollectionResultOfT as an enumerable collection. </summary>
