...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class ContainerRegistryData : IUtf8JsonSerializable, IJsonModel<ContainerRegistryData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(NetworkRuleBypassAllowedForTasks), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    networkRuleBypassAllowedForTasks: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    networkRuleBypassAllowedForTasks: ");
                    var boolValue = NetworkRuleBypassAllowedForTasks.Value == true ? "true" : "false";
                    builder.AppendLine($"{boolValue}");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(MetadataSearch), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    metadataSearch: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    metadataSearch: ");
                    builder.AppendLine($"'{MetadataSearch.Value.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RoleAssignmentMode), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    roleAssignmentMode: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    roleAssignmentMode: ");
                    builder.AppendLine($"'{RoleAssignmentMode.Value.ToString()}'");
                }
            }
