...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        public static ContainerRegistryKeyVaultProperties ContainerRegistryKeyVaultProperties(string keyIdentifier = default, string versionedKeyIdentifier = default, string identity = default, bool? keyRotationEnabled = default, DateTimeOffset? lastKeyRotationTimestamp = default)
        {
        ...
        public static RegistryPatch RegistryPatch(IdentityProperties identity = default, IDictionary<string, string> tags = default, ContainerRegistrySku sku = default, bool? adminUserEnabled = default, ContainerRegistryNetworkRuleSet networkRuleSet = default, ContainerRegistryPolicies policies = default, ContainerRegistryEncryption encryption = default, bool? dataEndpointEnabled = default, RegionalEndpoints? regionalEndpoints = default, EndpointProtocol? endpointProtocol = default, ContainerRegistryPublicNetworkAccess? publicNetworkAccess = default, ContainerRegistryNetworkRuleBypassOption? networkRuleBypassOptions = default, bool? networkRuleBypassAllowedForTasks = default, bool? anonymousPullEnabled = default, MetadataSearch? metadataSearch = default, ContainerRegistryRoleAssignmentMode? roleAssignmentMode = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static RegistryUsageListResult RegistryUsageListResult(IEnumerable<ContainerRegistryUsage> value = default)
        {
        ...
        public static ContainerRegistryNameAvailableResult ContainerRegistryNameAvailableResult(string availableLoginServerName = default, bool? nameAvailable = default, string reason = default, string message = default)
        {
            return new ContainerRegistryNameAvailableResult(availableLoginServerName, nameAvailable, reason, message, additionalBinaryDataProperties: null);
        }
        ...
        public static CredentialSetProperties CredentialSetProperties(string loginServer = default, IEnumerable<ContainerRegistryAuthCredential> authCredentials = default, DateTimeOffset? createdOn = default, ContainerRegistryProvisioningState? provisioningState = default)
        {
        ...
        public static ContainerRegistryTlsCertificateProperties ContainerRegistryTlsCertificateProperties(ContainerRegistryCertificateType? @type = default, string location = default)
        {
            return new ContainerRegistryTlsCertificateProperties(@type, location, additionalBinaryDataProperties: null);
        }
        ...
        public static ImportPipelineProperties ImportPipelineProperties(ImportPipelineSourceProperties source = default, ContainerRegistryTriggerStatus? sourceTriggerStatus = default, IEnumerable<PipelineOptions> options = default, ContainerRegistryProvisioningState? provisioningState = default)
        {
            options ??= new ChangeTrackingList<PipelineOptions>();
        ...
        public static WebhookPatch WebhookPatch(IDictionary<string, string> tags = default, string serviceUri = default, IDictionary<string, string> customHeaders = default, ContainerRegistryWebhookStatus? status = default, string scope = default, IEnumerable<ContainerRegistryWebhookAction> actions = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        {
            return new ContainerRegistryNameAvailabilityContent(name, default, default, default, additionalBinaryDataProperties: null);
        }
        ...
        {
            return new ContainerRegistryNameAvailableResult(default, default, reason, message, additionalBinaryDataProperties: null);
        }
    }
}
