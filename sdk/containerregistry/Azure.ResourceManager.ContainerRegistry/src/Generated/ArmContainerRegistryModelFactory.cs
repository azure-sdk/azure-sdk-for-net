...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        public static ConnectedRegistryStatusDetail ConnectedRegistryStatusDetail(string @type = default, string code = default, string description = default, DateTimeOffset? timestamp = default, string correlationId = default)
        {
