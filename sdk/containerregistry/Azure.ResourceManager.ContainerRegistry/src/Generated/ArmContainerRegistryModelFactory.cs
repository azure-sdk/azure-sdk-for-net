...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        public static ArchiveProperties ArchiveProperties(ArchivePackageSourceProperties packageSource = default, string publishedVersion = default, string repositoryEndpointPrefix = default, string repositoryEndpoint = default, ProvisioningState? provisioningState = default)
        {
        ...
        public static ArchiveVersionProperties ArchiveVersionProperties(ProvisioningState? provisioningState = default, string archiveVersionErrorMessage = default)
        {
        ...
        public static ExportPipelineProperties ExportPipelineProperties(ExportPipelineTargetProperties target = default, IEnumerable<PipelineOptions> options = default, ProvisioningState? provisioningState = default)
        {
        ...
        public static ImportPipelineProperties ImportPipelineProperties(ImportPipelineSourceProperties source = default, TriggerStatus? sourceTriggerStatus = default, IEnumerable<PipelineOptions> options = default, ProvisioningState? provisioningState = default)
        {
            options ??= new ChangeTrackingList<PipelineOptions>();
        ...
        public static PipelineRunProperties PipelineRunProperties(ProvisioningState? provisioningState = default, PipelineRunRequest request = default, PipelineRunResponse response = default, string forceUpdateTag = default)
        {
