...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        public static RegistryProperties RegistryProperties(string loginServer = default, DateTimeOffset? createdOn = default, ContainerRegistryProvisioningState? provisioningState = default, Status status = default, bool? adminUserEnabled = default, NetworkRuleSet networkRuleSet = default, Policies policies = default, EncryptionProperty encryption = default, bool? dataEndpointEnabled = default, IEnumerable<string> dataEndpointHostNames = default, RegionalEndpoints? regionalEndpoints = default, IEnumerable<string> regionalEndpointHostNames = default, EndpointProtocol? endpointProtocol = default, IEnumerable<ContainerRegistryPrivateEndpointConnectionData> privateEndpointConnections = default, PublicNetworkAccess? publicNetworkAccess = default, NetworkRuleBypassOptions? networkRuleBypassOptions = default, bool? networkRuleBypassAllowedForTasks = default, ZoneRedundancy? zoneRedundancy = default, bool? anonymousPullEnabled = default, MetadataSearch? metadataSearch = default, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = default, RoleAssignmentMode? roleAssignmentMode = default)
        {
        ...
        public static SoftDeletePolicy SoftDeletePolicy(int? retentionDays = default, DateTimeOffset? lastUpdatedOn = default, PolicyStatus? status = default)
        {
        ...
        public static RegistryPatch RegistryPatch(IdentityProperties identity = default, IDictionary<string, string> tags = default, ContainerRegistrySku sku = default, bool? adminUserEnabled = default, NetworkRuleSet networkRuleSet = default, Policies policies = default, EncryptionProperty encryption = default, bool? dataEndpointEnabled = default, RegionalEndpoints? regionalEndpoints = default, EndpointProtocol? endpointProtocol = default, PublicNetworkAccess? publicNetworkAccess = default, NetworkRuleBypassOptions? networkRuleBypassOptions = default, bool? networkRuleBypassAllowedForTasks = default, bool? anonymousPullEnabled = default, MetadataSearch? metadataSearch = default, RoleAssignmentMode? roleAssignmentMode = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();

            return new RegistryPatch(identity, tags, sku, adminUserEnabled is null && networkRuleSet is null && policies is null && encryption is null && dataEndpointEnabled is null && regionalEndpoints is null && endpointProtocol is null && publicNetworkAccess is null && networkRuleBypassOptions is null && networkRuleBypassAllowedForTasks is null && anonymousPullEnabled is null && metadataSearch is null && roleAssignmentMode is null ? default : new RegistryPropertiesUpdateParameters(
                adminUserEnabled,
                networkRuleSet,
                policies,
                encryption,
        ...
        public static ImportImageParameters ImportImageParameters(ContainerRegistryImportSource source = default, IEnumerable<string> targetTags = default, IEnumerable<string> untaggedTargetRepositories = default, ImportMode? mode = default)
        {
        ...
        public static ContainerRegistryImportSource ContainerRegistryImportSource(string resourceId = default, Uri registryUri = default, ImportSourceCredentials credentials = default, string sourceImage = default)
        {
        ...
        public static RegistryNameCheckRequest RegistryNameCheckRequest(string name = default, ContainerRegistryResourceType @type = default, string resourceGroupName = default, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = default)
        {
            return new RegistryNameCheckRequest(name, @type, resourceGroupName, autoGeneratedDomainNameLabelScope, additionalBinaryDataProperties: null);
        }
        ...
        public static RegistryNameStatus RegistryNameStatus(string availableLoginServerName = default, bool? nameAvailable = default, string reason = default, string message = default)
        {
            return new RegistryNameStatus(availableLoginServerName, nameAvailable, reason, message, additionalBinaryDataProperties: null);
        }
        ...
        public static ArchiveData ArchiveData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ArchiveProperties properties = default)
        {
        ...
        public static ArchiveVersionData ArchiveVersionData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ArchiveVersionProperties properties = default)
        {
        ...
        public static CacheRuleData CacheRuleData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, CacheRuleProperties properties = default, IdentityProperties identity = default)
        {
        ...
        public static CacheRuleProperties CacheRuleProperties(string credentialSetResourceId = default, string sourceRepository = default, string targetRepository = default, DateTimeOffset? createdOn = default, ContainerRegistryProvisioningState? provisioningState = default)
        {
        ...
        public static CredentialSetProperties CredentialSetProperties(string loginServer = default, IEnumerable<AuthCredential> authCredentials = default, DateTimeOffset? createdOn = default, ContainerRegistryProvisioningState? provisioningState = default)
        {
        ...
        public static ConnectedRegistryProperties ConnectedRegistryProperties(ContainerRegistryProvisioningState? provisioningState = default, ConnectedRegistryMode mode = default, string version = default, ConnectedRegistryConnectionState? connectionState = default, DateTimeOffset? lastActivityOn = default, ConnectedRegistryActivationStatus? activationStatus = default, ConnectedRegistryParent parent = default, IEnumerable<string> clientTokenIds = default, ConnectedRegistryLoginServer loginServer = default, ConnectedRegistryLogging logging = default, IEnumerable<ConnectedRegistryStatusDetail> statusDetails = default, IEnumerable<string> notificationsList = default, GarbageCollectionProperties garbageCollection = default, RegistrySyncResult registrySyncResult = default)
        {
        ...
        public static ConnectedRegistryLoginServer ConnectedRegistryLoginServer(string host = default, TlsProperties tls = default)
        {
        ...
        public static ConnectedRegistryStatusDetail ConnectedRegistryStatusDetail(string @type = default, string code = default, string description = default, DateTimeOffset? timestamp = default, Guid? correlationId = default)
        {
        ...
        public static ReplicationProperties ReplicationProperties(ContainerRegistryProvisioningState? provisioningState = default, Status status = default, bool? regionEndpointEnabled = default, ZoneRedundancy? zoneRedundancy = default)
        {
        ...
        public static TokenProperties TokenProperties(DateTimeOffset? createdOn = default, ContainerRegistryProvisioningState? provisioningState = default, string scopeMapId = default, TokenCredentialsProperties credentials = default, TokenStatus? status = default)
        {
        ...
        public static ImportPipelineProperties ImportPipelineProperties(ImportPipelineSourceProperties source = default, TriggerStatus? sourceTriggerStatus = default, IEnumerable<PipelineOptions> options = default, ContainerRegistryProvisioningState? provisioningState = default)
        {
            options ??= new ChangeTrackingList<PipelineOptions>();

            return new ImportPipelineProperties(source, sourceTriggerStatus is null ? default : new PipelineTriggerProperties(new PipelineSourceTriggerProperties(sourceTriggerStatus.Value, null), null), options.ToList(), provisioningState, additionalBinaryDataProperties: null);
        }
        ...
        public static WebhookProperties WebhookProperties(WebhookStatus? status = default, string scope = default, IEnumerable<WebhookAction> actions = default, ContainerRegistryProvisioningState? provisioningState = default)
        {
        ...
        /// <returns> A new <see cref="Models.ContainerRegistryImportSource"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static ContainerRegistryImportSource ContainerRegistryImportSource(ResourceIdentifier resourceId, string registryAddress, Models.ContainerRegistryImportSourceCredentials credentials, string sourceImage)
        {
