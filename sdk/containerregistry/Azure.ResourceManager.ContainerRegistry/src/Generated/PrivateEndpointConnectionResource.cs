...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="RegistryResource"/> using the GetPrivateEndpointConnections method.
    /// </summary>
    public partial class PrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal PrivateEndpointConnectionResource(ArmClient client, ContainerRegistryPrivateEndpointConnectionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<PrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, ContainerRegistryPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<PrivateEndpointConnectionResource> Update(WaitUntil waitUntil, ContainerRegistryPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
