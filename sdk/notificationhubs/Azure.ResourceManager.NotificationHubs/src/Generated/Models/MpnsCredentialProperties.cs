...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class MpnsCredentialProperties
    {
        ...
        internal MpnsCredentialProperties(string mpnsCertificate, string certificateKey, string thumbprint, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MpnsCertificate = mpnsCertificate;
            CertificateKey = certificateKey;
            Thumbprint = thumbprint;
