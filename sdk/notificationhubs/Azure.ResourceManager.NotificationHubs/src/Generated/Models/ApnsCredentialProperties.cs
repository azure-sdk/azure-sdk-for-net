...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class ApnsCredentialProperties
    {
        ...
        internal ApnsCredentialProperties(string apnsCertificate, string certificateKey, string endpoint, string thumbprint, string keyId, string appName, string appId, string token, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
