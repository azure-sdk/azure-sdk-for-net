...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class WnsCredentialProperties
    {
        ...
        internal WnsCredentialProperties(string packageSid, string secretKey, string windowsLiveEndpoint, string certificateKey, string wnsCertificate, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
