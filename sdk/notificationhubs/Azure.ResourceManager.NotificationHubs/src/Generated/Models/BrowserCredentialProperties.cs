...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class BrowserCredentialProperties
    {
        ...
        internal BrowserCredentialProperties(string subject, string vapidPrivateKey, string vapidPublicKey, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Subject = subject;
            VapidPrivateKey = vapidPrivateKey;
            VapidPublicKey = vapidPublicKey;
