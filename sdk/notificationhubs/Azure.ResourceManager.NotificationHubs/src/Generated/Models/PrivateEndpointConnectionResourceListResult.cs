...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    {
        /// <summary> Initializes a new instance of PrivateEndpointConnectionResourceListResult. </summary>
        internal PrivateEndpointConnectionResourceListResult()
        {
            Value = new ChangeTrackingList<PrivateEndpointConnectionResource>();
        }
        ...
        internal PrivateEndpointConnectionResourceListResult(IReadOnlyList<PrivateEndpointConnectionResource> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<PrivateEndpointConnectionResource> Value { get; }
