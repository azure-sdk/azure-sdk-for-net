...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class BaiduCredentialProperties
    {
        ...
        internal BaiduCredentialProperties(string baiduApiKey, string baiduEndPoint, string baiduSecretKey, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            BaiduApiKey = baiduApiKey;
            BaiduEndPoint = baiduEndPoint;
            BaiduSecretKey = baiduSecretKey;
