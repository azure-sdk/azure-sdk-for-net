...
{
    public partial class Sample_NamespaceNotificationHubAuthorizationRuleCollection
    {
        ...
        public async Task CreateOrUpdate_NotificationHubsCreateOrUpdateAuthorizationRule()
        {
            ...
            // get the collection of this NamespaceNotificationHubAuthorizationRuleResource
            NamespaceNotificationHubAuthorizationRuleCollection collection = notificationHub.GetNamespaceNotificationHubAuthorizationRules();
...
AuthorizationRuleAccessRight.Listen,AuthorizationRuleAccessRight.Send
            ...
            ArmOperation<NamespaceNotificationHubAuthorizationRuleResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, authorizationRuleName, data);
        ...
        public async Task Get_NotificationHubsGetAuthorizationRule()
        {
            ...
            NamespaceNotificationHubAuthorizationRuleResource result = await collection.GetAsync(authorizationRuleName);
        ...
        public async Task GetIfExists_NotificationHubsGetAuthorizationRule()
        {
            ...
            // invoke the operation
            string authorizationRuleName = "DefaultListenSharedAccessSignature";
            NullableResponse<NamespaceNotificationHubAuthorizationRuleResource> response = await collection.GetIfExistsAsync(authorizationRuleName);
            NamespaceNotificationHubAuthorizationRuleResource result = response.HasValue ? response.Value : null;
        ...
        {
            // Generated from example definition: specification/notificationhubs/resource-manager/Microsoft.NotificationHubs/stable/2023-09-01/examples/NotificationHubs/AuthorizationRuleList.json
            ...
            await foreach (NamespaceNotificationHubAuthorizationRuleResource item in collection.GetAllAsync())
            {
