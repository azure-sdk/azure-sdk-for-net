...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    public partial class ResourceListKeys
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ResourceListKeys"/>. </summary>
        ...
        internal ResourceListKeys(string primaryConnectionString, string secondaryConnectionString, string primaryKey, string secondaryKey, string keyName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
