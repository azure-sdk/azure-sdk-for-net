        ...
        internal static PnsCredentials DeserializePnsCredentials(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("admCredential"u8))
                {
                    ...
                    admCredential = AdmCredential.DeserializeAdmCredential(property.Value, options);
                    continue;
                }
                if (property.NameEquals("apnsCredential"u8))
                {
                    ...
                    apnsCredential = ApnsCredential.DeserializeApnsCredential(property.Value, options);
                    continue;
                }
                if (property.NameEquals("baiduCredential"u8))
                {
                    ...
                    baiduCredential = BaiduCredential.DeserializeBaiduCredential(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("gcmCredential"u8))
                {
                    ...
                    gcmCredential = GcmCredential.DeserializeGcmCredential(property.Value, options);
                    continue;
                }
                if (property.NameEquals("mpnsCredential"u8))
                {
                    ...
                    mpnsCredential = MpnsCredential.DeserializeMpnsCredential(property.Value, options);
                    continue;
                }
                if (property.NameEquals("wnsCredential"u8))
                {
                    ...
                    wnsCredential = WnsCredential.DeserializeWnsCredential(property.Value, options);
                    continue;
                }
