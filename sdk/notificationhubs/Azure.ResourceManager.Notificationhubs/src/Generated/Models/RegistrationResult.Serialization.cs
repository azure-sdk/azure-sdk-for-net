...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegistrationResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegistrationResult)} does not support writing '{format}' format.");
            }
        ...
        RegistrationResult IJsonModel<RegistrationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegistrationResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RegistrationResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RegistrationResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RegistrationResult IPersistableModel<RegistrationResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RegistrationResult)} does not support reading '{options.Format}' format.");
            }
        }
