...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    public partial class NotificationHubResourcePatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="NotificationHubResourcePatch"/>. </summary>
        public NotificationHubResourcePatch()
        {
        ...
        internal NotificationHubResourcePatch(string name, string registrationTtl, IReadOnlyList<SharedAccessAuthorizationRuleProperties> authorizationRules, ApnsCredential apnsCredential, WnsCredential wnsCredential, GcmCredential gcmCredential, MpnsCredential mpnsCredential, AdmCredential admCredential, BaiduCredential baiduCredential, BrowserCredential browserCredential, XiaomiCredential xiaomiCredential, FcmV1Credential fcmV1Credential, long? dailyMaxActiveDevices, NotificationhubsSku sku, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
