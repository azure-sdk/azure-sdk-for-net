...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    public partial class CheckAvailabilityResult : ResourceData
    {
        /// <summary>
        ...
        internal CheckAvailabilityResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isAvailiable, string location, IReadOnlyDictionary<string, string> tags, NotificationhubsSku sku, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public NotificationhubsSku Sku { get; }
    }
}
