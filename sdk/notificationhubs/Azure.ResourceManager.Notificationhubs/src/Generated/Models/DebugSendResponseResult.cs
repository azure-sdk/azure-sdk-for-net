...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    public partial class DebugSendResponseResult : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DebugSendResponseResult"/>. </summary>
        internal DebugSendResponseResult()
        {
        ...
        internal DebugSendResponseResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, long? success, long? failure, IReadOnlyList<RegistrationResult> results, string location, IReadOnlyDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Success = success;
            Failure = failure;
            Results = results;
