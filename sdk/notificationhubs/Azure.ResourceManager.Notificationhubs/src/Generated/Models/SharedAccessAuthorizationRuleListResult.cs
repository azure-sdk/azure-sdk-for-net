...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    internal partial class SharedAccessAuthorizationRuleListResult
    {
        ...
        internal SharedAccessAuthorizationRuleListResult(IEnumerable<SharedAccessAuthorizationRuleResourceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal SharedAccessAuthorizationRuleListResult(IReadOnlyList<SharedAccessAuthorizationRuleResourceData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
