...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    internal partial class NotificationHubListResult
    {
        ...
        internal NotificationHubListResult(IEnumerable<NotificationHubResourceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal NotificationHubListResult(IReadOnlyList<NotificationHubResourceData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
