...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    public partial class WnsCredential
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WnsCredential"/>. </summary>
        ...
        internal WnsCredential(string packageSid, string secretKey, string windowsLiveEndpoint, string certificateKey, string wnsCertificate, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
