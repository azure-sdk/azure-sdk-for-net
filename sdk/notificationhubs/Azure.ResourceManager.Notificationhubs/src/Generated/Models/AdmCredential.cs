...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    public partial class AdmCredential
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AdmCredential"/>. </summary>
        ...
        public AdmCredential(string clientId, string clientSecret, string authTokenUri)
        {
        ...
        internal AdmCredential(string clientId, string clientSecret, string authTokenUri, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ClientId = clientId;
            ClientSecret = clientSecret;
            AuthTokenUri = authTokenUri;
        ...
        /// <summary> Initializes a new instance of <see cref="AdmCredential"/> for deserialization. </summary>
        internal AdmCredential()
        {
        }
