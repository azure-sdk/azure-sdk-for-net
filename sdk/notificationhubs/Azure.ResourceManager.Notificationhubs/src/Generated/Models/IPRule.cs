...
namespace Azure.ResourceManager.Notificationhubs.Models
{
    ...
    public partial class IPRule
    {
        ...
        public IPRule(string ipMask, IEnumerable<AccessRight> rights)
        {
        ...
        internal IPRule(string ipMask, IList<AccessRight> rights, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IPMask = ipMask;
            Rights = rights;
