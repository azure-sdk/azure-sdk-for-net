...
namespace Azure.ResourceManager.Notificationhubs
{
    ...
    public partial class NotificationHubResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _notificationHubResourceClientDiagnostics;
        private readonly NotificationHubResourcesRestOperations _notificationHubResourceRestClient;
        ...
        {
            _notificationHubResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Notificationhubs", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string notificationHubResourceApiVersion);
            _notificationHubResourceRestClient = new NotificationHubResourcesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, notificationHubResourceApiVersion);
#if DEBUG
        ...
        {
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.Get");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NotificationHubResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _notificationHubResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new NotificationHubResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.Delete");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var uri = _notificationHubResourceRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _notificationHubResourceRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var uri = _notificationHubResourceRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new NotificationhubsArmOperation(response, rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<NotificationHubResource>> UpdateAsync(NotificationHubResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.Update");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new NotificationHubResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<NotificationHubResource> Update(NotificationHubResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _notificationHubResourceRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken);
                return Response.FromValue(new NotificationHubResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<DebugSendResponseResult>> DebugSendAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.DebugSend");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.DebugSendAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DebugSendResponseResult> DebugSend(CancellationToken cancellationToken = default)
        {
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.DebugSend");
            scope.Start();
            try
            {
                var response = _notificationHubResourceRestClient.DebugSend(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.GetPnsCredentials");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.GetPnsCredentialsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<PnsCredentialsResource> GetPnsCredentials(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _notificationHubResourceRestClient.GetPnsCredentials(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<NotificationHubResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _notificationHubResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                ...
                else
                {
                    ...
                    var patch = new NotificationHubResourcePatch();
        ...
        public virtual Response<NotificationHubResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _notificationHubResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                    return Response.FromValue(new NotificationHubResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<NotificationHubResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<NotificationHubResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
