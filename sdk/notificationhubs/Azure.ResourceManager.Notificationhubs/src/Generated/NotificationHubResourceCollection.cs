...
namespace Azure.ResourceManager.Notificationhubs
{
    ...
    public partial class NotificationHubResourceCollection : ArmCollection, IEnumerable<NotificationHubResource>, IAsyncEnumerable<NotificationHubResource>
    {
        ...
        {
            _notificationHubResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Notificationhubs", NotificationHubResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(NotificationHubResource.ResourceType, out string notificationHubResourceApiVersion);
        ...
        public virtual async Task<ArmOperation<NotificationHubResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string notificationHubName, NotificationHubResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(notificationHubName, nameof(notificationHubName));
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, data, cancellationToken).ConfigureAwait(false);
                var uri = _notificationHubResourceRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, data);
        ...
        /// <exception cref="ArgumentException"> <paramref name="notificationHubName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="notificationHubName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<NotificationHubResource> CreateOrUpdate(WaitUntil waitUntil, string notificationHubName, NotificationHubResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(notificationHubName, nameof(notificationHubName));
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _notificationHubResourceRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, data, cancellationToken);
                var uri = _notificationHubResourceRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new NotificationhubsArmOperation<NotificationHubResource>(Response.FromValue(new NotificationHubResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<NotificationHubResource>> GetAsync(string notificationHubName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NotificationHubResource> Get(string notificationHubName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _notificationHubResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new NotificationHubResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _notificationHubResourceRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skipToken, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _notificationHubResourceRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skipToken, top);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string notificationHubName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string notificationHubName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _notificationHubResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<NotificationHubResource>> GetIfExistsAsync(string notificationHubName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationHubResourceClientDiagnostics.CreateScope("NotificationHubResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _notificationHubResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, notificationHubName, cancellationToken: cancellationToken).ConfigureAwait(false);
