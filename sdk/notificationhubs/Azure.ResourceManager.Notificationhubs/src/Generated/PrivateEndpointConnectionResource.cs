...
namespace Azure.ResourceManager.Notificationhubs
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="NamespaceResource"/> using the GetPrivateEndpointConnectionResource method.
    /// </summary>
    public partial class PrivateEndpointConnectionResource : ArmResource
    {
        ...
        {
            _privateEndpointConnectionResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Notificationhubs", ResourceType.Namespace, Diagnostics);
        ...
        {
            using var scope = _privateEndpointConnectionResourceClientDiagnostics.CreateScope("PrivateEndpointConnectionResource.Get");
            scope.Start();
            try
            {
                var response = await _privateEndpointConnectionResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<PrivateEndpointConnectionResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateEndpointConnectionResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new PrivateEndpointConnectionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _privateEndpointConnectionResourceClientDiagnostics.CreateScope("PrivateEndpointConnectionResource.Delete");
            scope.Start();
            try
            {
                var response = await _privateEndpointConnectionResourceRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new NotificationhubsArmOperation(_privateEndpointConnectionResourceClientDiagnostics, Pipeline, _privateEndpointConnectionResourceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateEndpointConnectionResourceRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new NotificationhubsArmOperation(_privateEndpointConnectionResourceClientDiagnostics, Pipeline, _privateEndpointConnectionResourceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<PrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, PrivateEndpointConnectionResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _privateEndpointConnectionResourceClientDiagnostics.CreateScope("PrivateEndpointConnectionResource.Update");
            scope.Start();
            try
            {
                var response = await _privateEndpointConnectionResourceRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var operation = new NotificationhubsArmOperation<PrivateEndpointConnectionResource>(new PrivateEndpointConnectionResourceOperationSource(Client), _privateEndpointConnectionResourceClientDiagnostics, Pipeline, _privateEndpointConnectionResourceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<PrivateEndpointConnectionResource> Update(WaitUntil waitUntil, PrivateEndpointConnectionResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateEndpointConnectionResourceRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new NotificationhubsArmOperation<PrivateEndpointConnectionResource>(new PrivateEndpointConnectionResourceOperationSource(Client), _privateEndpointConnectionResourceClientDiagnostics, Pipeline, _privateEndpointConnectionResourceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
