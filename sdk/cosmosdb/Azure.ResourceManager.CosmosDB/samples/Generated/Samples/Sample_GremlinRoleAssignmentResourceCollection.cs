...
{
    public partial class Sample_GremlinRoleAssignmentResourceCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_CosmosDBGremlinRoleAssignmentCreateUpdate()
        {
            ...
            // get the collection of this GremlinRoleAssignmentResource
            GremlinRoleAssignmentResourceCollection collection = cosmosDBAccount.GetGremlinRoleAssignmentResources();
            ...
            ArmOperation<GremlinRoleAssignmentResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, roleAssignmentId, data);
        ...
        public async Task Get_CosmosDBGremlinRoleAssignmentGet()
        {
            ...
            // invoke the operation
            string roleAssignmentId = "myRoleAssignmentId";
            GremlinRoleAssignmentResource result = await collection.GetAsync(roleAssignmentId);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetAll_CosmosDBGremlinRoleAssignmentList()
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2025-05-01-preview/examples/gremlinrbac/CosmosDBGremlinRoleAssignmentList.json
            // this example is just showing the usage of "GremlinResources_ListGremlinRoleAssignments" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (GremlinRoleAssignmentResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                GremlinRoleAssignmentResourceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_CosmosDBGremlinRoleAssignmentGet()
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2025-05-01-preview/examples/gremlinrbac/CosmosDBGremlinRoleAssignmentGet.json
            // this example is just showing the usage of "GremlinResources_GetGremlinRoleAssignment" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_CosmosDBGremlinRoleAssignmentGet()
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2025-05-01-preview/examples/gremlinrbac/CosmosDBGremlinRoleAssignmentGet.json
            // this example is just showing the usage of "GremlinResources_GetGremlinRoleAssignment" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string roleAssignmentId = "myRoleAssignmentId";
            NullableResponse<GremlinRoleAssignmentResource> response = await collection.GetIfExistsAsync(roleAssignmentId);
            GremlinRoleAssignmentResource result = response.HasValue ? response.Value : null;
