...
namespace Azure.ResourceManager.CosmosDB.Samples
{
    public partial class Sample_CosmosDBSqlContainerResource
    {
        ...
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2025-04-15/examples/CosmosDBSqlContainerGet.json
        ...
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2025-04-15/examples/CosmosDBSqlContainerDelete.json
        ...
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2025-04-15/examples/CosmosDBSqlContainerCreateUpdate.json
...
Query = "SELECT VALUE LOWER(c.name) FROM c",
                ...
                FullTextPolicy = new FullTextPolicy
                {
                    ...
                    FullTextPaths = { new FullTextPath("/ftPath1", "en-US"), new FullTextPath("/ftPath2", "en-GB"), new FullTextPath("/ftPath3", "en") },
                },
            })
            {
        ...
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2025-04-15/examples/CosmosDBSqlContainerBackupInformation.json
