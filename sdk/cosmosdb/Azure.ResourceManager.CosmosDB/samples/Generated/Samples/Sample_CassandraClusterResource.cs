...
["status"] = "",
        ...
        // CosmosDBManagedCassandraAsyncCommand
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task InvokeAsyncCommand_CosmosDBManagedCassandraAsyncCommand()
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2024-05-15-preview/examples/CosmosDBManagedCassandraAsyncCommand.json
            // this example is just showing the usage of "CassandraClusters_InvokeAsyncCommand" operation, for the dependent resources, they will have to be created separately.
...
["status"] = "",
            ...
            ArmOperation<CassandraClusterCommand> lro = await cassandraCluster.InvokeAsyncCommandAsync(WaitUntil.Completed, body);
            CassandraClusterCommand result = lro.Value;
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAsyncCommand_CosmosDBManagedCassandraCommandResult()
        {
            ...
            // this example is just showing the usage of "CassandraClusters_GetAsyncCommand" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (CassandraClusterCommand item in cassandraCluster.GetAsyncCommandAsync(commandId))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task RestoreBackup_CosmosDBManagedCassandraRestore()
        {
            ...
            // invoke the operation
            string backupId = "251722270182703";
