...
{
    /// <summary>
    /// A class representing the MongoMIRoleDefinitionResource data model.
    /// Parameters to create and update an Azure Cosmos DB MongoMI Role Definition.
    /// </summary>
    public partial class MongoMIRoleDefinitionResourceData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="MongoMIRoleDefinitionResourceData"/>. </summary>
        public MongoMIRoleDefinitionResourceData()
        {
        ...
        internal MongoMIRoleDefinitionResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string idPropertiesId, string roleName, CosmosDBSqlRoleDefinitionType? typePropertiesType, IList<string> assignableScopes, IList<Permission> permissions, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
