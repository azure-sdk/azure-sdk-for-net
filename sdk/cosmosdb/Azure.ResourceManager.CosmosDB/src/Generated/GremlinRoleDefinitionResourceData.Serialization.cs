...
{
    public partial class GremlinRoleDefinitionResourceData : IUtf8JsonSerializable, IJsonModel<GremlinRoleDefinitionResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GremlinRoleDefinitionResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GremlinRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        GremlinRoleDefinitionResourceData IJsonModel<GremlinRoleDefinitionResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GremlinRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static GremlinRoleDefinitionResourceData DeserializeGremlinRoleDefinitionResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<GremlinRoleDefinitionResourceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GremlinRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        GremlinRoleDefinitionResourceData IPersistableModel<GremlinRoleDefinitionResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GremlinRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
