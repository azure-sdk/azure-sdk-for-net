...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapacityModeChangeTransitionState>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CapacityModeTransitionStatus) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(CurrentCapacityMode) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(PreviousCapacityMode) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(CapacityModeTransitionBeginTimestamp) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(CapacityModeTransitionEndTimestamp) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(CapacityModeLastSuccessfulTransitionEndTimestamp) || hasPropertyOverride)
            {
