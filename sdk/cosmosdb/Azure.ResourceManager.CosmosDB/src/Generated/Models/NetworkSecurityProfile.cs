...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class NetworkSecurityProfile
    {
        ...
        internal NetworkSecurityProfile(string name, int? accessRulesVersion, IList<AccessRule> accessRules, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
