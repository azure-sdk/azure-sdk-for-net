...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ProvisioningIssueProperties
    {
        ...
        /// <param name="suggestedResourceIds"> Fully qualified resource IDs of resources that can be associated to the same perimeter to remediate the issue. </param>
        ...
        /// <summary> Fully qualified resource IDs of resources that can be associated to the same perimeter to remediate the issue. </summary>
