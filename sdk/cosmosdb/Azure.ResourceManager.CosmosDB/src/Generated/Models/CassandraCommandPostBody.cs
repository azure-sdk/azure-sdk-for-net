...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraCommandPostBody
    {
        ...
        internal CassandraCommandPostBody(string command, BinaryData arguments, string host, bool? cassandraStopStart, bool? readWrite, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Command = command;
            Arguments = arguments;
            Host = host;
