...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class NetworkSecurityPerimeterConfigurationPropertiesProfile
    {
        ...
        internal NetworkSecurityPerimeterConfigurationPropertiesProfile(string name, int? accessRulesVersion, IReadOnlyList<NspAccessRule> accessRules, int? diagnosticSettingsVersion, IReadOnlyList<string> enabledLogCategories, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
