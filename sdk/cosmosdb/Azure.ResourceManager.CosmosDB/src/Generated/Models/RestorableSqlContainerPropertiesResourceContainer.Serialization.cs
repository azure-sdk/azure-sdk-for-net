...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableSqlContainerPropertiesResourceContainer>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static RestorableSqlContainerPropertiesResourceContainer DeserializeRestorableSqlContainerPropertiesResourceContainer(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("materializedViews"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(MaterializedViews), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  materializedViews: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    if (MaterializedViews.Any())
                    {
                        builder.Append("  materializedViews: ");
                        builder.AppendLine("[");
                        foreach (var item in MaterializedViews)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 4, true, "  materializedViews: ");
                        }
                        builder.AppendLine("  ]");
                    }
                }
