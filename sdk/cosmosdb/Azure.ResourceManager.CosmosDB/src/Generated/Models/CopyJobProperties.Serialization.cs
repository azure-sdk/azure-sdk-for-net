...
{
    public partial class CopyJobProperties : IUtf8JsonSerializable, IJsonModel<CopyJobProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CopyJobProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CopyJobProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        CopyJobProperties IJsonModel<CopyJobProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CopyJobProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static CopyJobProperties DeserializeCopyJobProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    jobProperties = BaseCopyJobProperties.DeserializeBaseCopyJobProperties(property.Value, options);
                    continue;
                }
                if (property.NameEquals("status"u8))
                {
                    ...
                    status = new CopyJobStatus(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("mode"u8))
                {
                    ...
                    mode = new CopyJobMode(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(JobProperties), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  jobProperties: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(JobProperties))
                {
                    builder.Append("  jobProperties: ");
                    BicepSerializationHelpers.AppendChildObject(builder, JobProperties, options, 2, false, "  jobProperties: ");
                }
            }
        ...
        BinaryData IPersistableModel<CopyJobProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CopyJobProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        CopyJobProperties IPersistableModel<CopyJobProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CopyJobProperties>)this).GetFormatFromOptions(options) : options.Format;
