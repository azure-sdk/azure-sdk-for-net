...
{
    public partial class MongoMIRoleDefinitionResourceData : IUtf8JsonSerializable, IJsonModel<MongoMIRoleDefinitionResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoMIRoleDefinitionResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MongoMIRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MongoMIRoleDefinitionResourceData IJsonModel<MongoMIRoleDefinitionResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MongoMIRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static MongoMIRoleDefinitionResourceData DeserializeMongoMIRoleDefinitionResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MongoMIRoleDefinitionResourceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MongoMIRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MongoMIRoleDefinitionResourceData IPersistableModel<MongoMIRoleDefinitionResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MongoMIRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
