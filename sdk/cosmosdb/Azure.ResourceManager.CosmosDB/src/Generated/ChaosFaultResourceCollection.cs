...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class ChaosFaultResourceCollection : ArmCollection, IEnumerable<ChaosFaultResource>, IAsyncEnumerable<ChaosFaultResource>
    {
        ...
        public virtual AsyncPageable<ChaosFaultResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new ChaosFaultResource(Client, ChaosFaultResourceData.DeserializeChaosFaultResourceData(e)), _chaosFaultResourceChaosFaultClientDiagnostics, Pipeline, "ChaosFaultResourceCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _chaosFaultResourceChaosFaultRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => new ChaosFaultResource(Client, ChaosFaultResourceData.DeserializeChaosFaultResourceData(e)), _chaosFaultResourceChaosFaultClientDiagnostics, Pipeline, "ChaosFaultResourceCollection.GetAll", "value", null, cancellationToken);
        }
