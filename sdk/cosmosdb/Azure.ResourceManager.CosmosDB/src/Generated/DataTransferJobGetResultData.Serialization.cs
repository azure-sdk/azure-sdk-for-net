...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataTransferJobGetResultData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<DataTransferJobGetResultData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataTransferJobGetResultData)} does not support writing '{format}' format.");
            }
        ...
        DataTransferJobGetResultData IJsonModel<DataTransferJobGetResultData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataTransferJobGetResultData)} does not support reading '{format}' format.");
            }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("error"u8))
                        {
                            ...
                            error = ErrorResponseAutoGenerated.DeserializeErrorResponseAutoGenerated(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<DataTransferJobGetResultData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataTransferJobGetResultData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataTransferJobGetResultData IPersistableModel<DataTransferJobGetResultData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataTransferJobGetResultData)} does not support reading '{options.Format}' format.");
            }
        }
