...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class GremlinDatabaseData : IUtf8JsonSerializable, IJsonModel<GremlinDatabaseData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GremlinDatabaseData)} does not support writing '{format}' format.");
            }
        ...
        GremlinDatabaseData IJsonModel<GremlinDatabaseData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GremlinDatabaseData)} does not support reading '{format}' format.");
            }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("resource"u8))
                        {
                            ...
                            resource = ExtendedGremlinDatabaseResourceInfo.DeserializeExtendedGremlinDatabaseResourceInfo(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("options"u8))
                        {
                            ...
                            options0 = GremlinDatabasePropertiesConfig.DeserializeGremlinDatabasePropertiesConfig(property0.Value, options);
                            continue;
                        }
                    }
                    continue;
        ...
        BinaryData IPersistableModel<GremlinDatabaseData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GremlinDatabaseData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        GremlinDatabaseData IPersistableModel<GremlinDatabaseData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GremlinDatabaseData)} does not support reading '{options.Format}' format.");
            }
        }
