...
{
    public partial class CassandraRoleDefinitionResourceData : IUtf8JsonSerializable, IJsonModel<CassandraRoleDefinitionResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraRoleDefinitionResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CassandraRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        CassandraRoleDefinitionResourceData IJsonModel<CassandraRoleDefinitionResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CassandraRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static CassandraRoleDefinitionResourceData DeserializeCassandraRoleDefinitionResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<CassandraRoleDefinitionResourceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CassandraRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        CassandraRoleDefinitionResourceData IPersistableModel<CassandraRoleDefinitionResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CassandraRoleDefinitionResourceData>)this).GetFormatFromOptions(options) : options.Format;
