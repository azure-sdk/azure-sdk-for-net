...
namespace Microsoft.LoadTestService.Mocking
{
    ...
    public partial class MockableMicrosoftLoadTestServiceSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableMicrosoftLoadTestServiceSubscriptionResource"/> class for mocking. </summary>
        protected MockableMicrosoftLoadTestServiceSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableMicrosoftLoadTestServiceSubscriptionResource"/> class. </summary>
