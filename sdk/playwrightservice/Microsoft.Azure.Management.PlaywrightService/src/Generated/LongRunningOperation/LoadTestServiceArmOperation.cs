...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal LoadTestServiceArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal LoadTestServiceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "LoadTestServiceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
