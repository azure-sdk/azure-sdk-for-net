...
namespace Azure.ResourceManager.DatabaseWatcher.Models
{
    ...
    public partial class DatabaseWatcherPatch
    {
        ...
        internal DatabaseWatcherPatch(DatabaseWatcherManagedServiceIdentity identity, IDictionary<string, string> tags, WatcherUpdateProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Tags = tags;
