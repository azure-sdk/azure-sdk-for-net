...
namespace Azure.AI.Translation.Document
{
    ...
    public partial class TranslationTarget
    {
        ...
        internal TranslationTarget(Uri targetUri, string categoryId, string languageCode, IList<TranslationGlossary> glossaries, TranslationStorageSource? translationStorageSource, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetUri = targetUri;
