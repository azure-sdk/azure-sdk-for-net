...
namespace Azure.AI.Translation.Document
{
    ...
    public partial class SingleDocumentTranslationClient
    {
        ...
        /// </param>
        /// <param name="translateQuery"> Specifies the input string is designed to be submitted to a GPT model for translation. </param>
        ...
        public virtual async Task<Response<BinaryData>> TranslateAsync(string targetLanguage, DocumentTranslateContent documentTranslateContent, string sourceLanguage = null, string category = null, bool? allowFallback = null, bool? translateQuery = null, bool? translateTextWithinImage = null, CancellationToken cancellationToken = default)
        {
            ...
            Response response = await TranslateAsync(targetLanguage, content, content.ContentType, sourceLanguage, category, allowFallback, translateQuery, translateTextWithinImage, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="targetLanguage"/> or <paramref name="documentTranslateContent"/> is null. </exception>
        /// <remarks> Use this API to submit a single translation request to the Document Translation Service. </remarks>
        public virtual Response<BinaryData> Translate(string targetLanguage, DocumentTranslateContent documentTranslateContent, string sourceLanguage = null, string category = null, bool? allowFallback = null, bool? translateQuery = null, bool? translateTextWithinImage = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(targetLanguage, nameof(targetLanguage));
            Argument.AssertNotNull(documentTranslateContent, nameof(documentTranslateContent));
            ...
            using MultipartFormDataRequestContent content = documentTranslateContent.ToMultipartRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = Translate(targetLanguage, content, content.ContentType, sourceLanguage, category, allowFallback, translateQuery, translateTextWithinImage, context);
            return Response.FromValue(response.Content, response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="TranslateAsync(string,DocumentTranslateContent,string,string,bool?,bool?,bool?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response> TranslateAsync(string targetLanguage, RequestContent content, string contentType, string sourceLanguage = null, string category = null, bool? allowFallback = null, bool? translateQuery = null, bool? translateTextWithinImage = null, RequestContext context = null)
        {
            Argument.AssertNotNull(targetLanguage, nameof(targetLanguage));
            ...
            try
            {
                using HttpMessage message = CreateTranslateRequest(targetLanguage, content, contentType, sourceLanguage, category, allowFallback, translateQuery, translateTextWithinImage, context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Translate(string,DocumentTranslateContent,string,string,bool?,bool?,bool?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual Response Translate(string targetLanguage, RequestContent content, string contentType, string sourceLanguage = null, string category = null, bool? allowFallback = null, bool? translateQuery = null, bool? translateTextWithinImage = null, RequestContext context = null)
        {
            Argument.AssertNotNull(targetLanguage, nameof(targetLanguage));
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateTranslateRequest(string targetLanguage, RequestContent content, string contentType, string sourceLanguage, string category, bool? allowFallback, bool? translateQuery, bool? translateTextWithinImage, RequestContext context)
        {
            ...
            {
                uri.AppendQuery("translateQuery", translateQuery.Value, true);
            }
