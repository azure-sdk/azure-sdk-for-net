...
namespace Azure.AI.Translation.Document
{
    ...
    public partial class TranslationGlossary
    {
        ...
        internal TranslationGlossary(Uri glossaryUri, string format, string formatVersion, TranslationStorageSource? translationStorageSource, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GlossaryUri = glossaryUri;
            Format = format;
