...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class TextTranslationClient
    {
        ...
        /// <include file="Docs/TextTranslationClient.xml" path="doc/members/member[@name='TranslateAsync(IEnumerable{TranslateBodyDetails},string,CancellationToken)']/*" />
        public virtual async Task<Response<IReadOnlyList<TranslatedTextItem>>> TranslateAsync(IEnumerable<TranslateBodyDetails> body, string clientTraceId = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <include file="Docs/TextTranslationClient.xml" path="doc/members/member[@name='Translate(IEnumerable{TranslateBodyDetails},string,CancellationToken)']/*" />
        public virtual Response<IReadOnlyList<TranslatedTextItem>> Translate(IEnumerable<TranslateBodyDetails> body, string clientTraceId = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="TranslateAsync(IEnumerable{TranslateBodyDetails},string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Translate(IEnumerable{TranslateBodyDetails},string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
