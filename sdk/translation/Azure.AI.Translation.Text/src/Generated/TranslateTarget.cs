...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class TranslateTarget
    {
        ...
        internal TranslateTarget(IList<string> language, string script, ProfanityAction? profanityAction, ProfanityMarker? profanityMarker, string deploymentNameModel, bool? allowFallback, string grade, string tone, string gender, string adaptiveDatasetId, IList<ReferenceSentencePair> referenceTextPairs, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Language = language;
            Script = script;
