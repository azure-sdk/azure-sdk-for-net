...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class TranslateTarget
    {
        ...
        public TranslateTarget(IEnumerable<string> language)
        {
            Argument.AssertNotNull(language, nameof(language));

            Language = language.ToList();
            AdaptiveDatasetIds = new ChangeTrackingList<string>();
        ...
        /// </param>
        /// <param name="deploymentNameModel">
        ...
        /// <param name="tone"> Desired tone of target translation. Default is 'informal'. </param>
        /// <param name="gender"> Desired gender of target translation. </param>
        /// <param name="adaptiveDatasetIds"> Reference dataset ID having sentence pair to generate adaptive customized translation. </param>
        /// <param name="referenceTextPairs"> Reference sentence pairs to generate adaptive results. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal TranslateTarget(IList<string> language, string script, ProfanityAction? profanityAction, ProfanityMarker? profanityMarker, string deploymentNameModel, bool? allowFallback, string grade, string tone, string gender, IList<string> adaptiveDatasetIds, IList<ReferenceSentencePair> referenceTextPairs, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Language = language;
            Script = script;
            ...
            Tone = tone;
            Gender = gender;
            AdaptiveDatasetIds = adaptiveDatasetIds;
        ...
        ///
        /// </summary>
        public string DeploymentNameModel { get; set; }
        /// <summary>
        /// In the case where a custom system is being used, specifies that the service is allowed to fall back to a
        /// general system when a custom system doesn't exist.
        /// In the case where a Large Language Model is being used, specifies that the service is allowed to fall
        ...
        /// <summary> Desired tone of target translation. Default is 'informal'. </summary>
        ...
        public IList<string> AdaptiveDatasetIds { get; }
