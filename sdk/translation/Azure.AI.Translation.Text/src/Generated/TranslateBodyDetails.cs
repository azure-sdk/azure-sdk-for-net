...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class TranslateBodyDetails
    {
        ...
        public TranslateBodyDetails(string text, IEnumerable<TranslateTarget> targets)
        {
        ...
        internal TranslateBodyDetails(string text, string script, string language, TextType? textType, IList<TranslateTarget> targets, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Script = script;
            Language = language;
