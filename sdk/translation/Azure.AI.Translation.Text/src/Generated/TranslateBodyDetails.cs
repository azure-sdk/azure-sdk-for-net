...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class TranslateBodyDetails
    {
        ...
        internal TranslateBodyDetails(string text, string script, string language, TextType? textType, TranslateTarget targets, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Script = script;
            Language = language;
        ...
        public TranslateTarget Targets { get; }
    }
}
