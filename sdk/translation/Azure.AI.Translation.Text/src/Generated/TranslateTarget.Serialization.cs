...
namespace Azure.AI.Translation.Text
{
    public partial class TranslateTarget : IUtf8JsonSerializable, IJsonModel<TranslateTarget>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeploymentNameModel))
            {
                writer.WritePropertyName("deploymentNameModel"u8);
                writer.WriteStringValue(DeploymentNameModel);
            }
            ...
            if (Optional.IsCollectionDefined(AdaptiveDatasetIds))
            {
                writer.WritePropertyName("adaptiveDatasetIds"u8);
                writer.WriteStartArray();
                foreach (var item in AdaptiveDatasetIds)
                {
                    writer.WriteStringValue(item);
                }
                writer.WriteEndArray();
        ...
        internal static TranslateTarget DeserializeTranslateTarget(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("deploymentNameModel"u8))
                {
                    deploymentNameModel = property.Value.GetString();
                    continue;
                }
                ...
                if (property.NameEquals("adaptiveDatasetIds"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
