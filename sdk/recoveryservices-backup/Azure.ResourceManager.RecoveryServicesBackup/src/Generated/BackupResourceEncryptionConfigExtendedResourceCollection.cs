    ...
    public partial class BackupResourceEncryptionConfigExtendedResourceCollection : ArmCollection
    {
        ...
        public virtual async Task<ArmOperation> CreateOrUpdateAsync(WaitUntil waitUntil, string vaultName, BackupResourceEncryptionConfigExtendedResourceCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _backupResourceEncryptionConfigExtendedResourceBackupResourceEncryptionConfigsRestClient.CreateUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, vaultName, content);
        ...
        public virtual async Task<NullableResponse<BackupResourceEncryptionConfigExtendedResource>> GetIfExistsAsync(string vaultName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _backupResourceEncryptionConfigExtendedResourceBackupResourceEncryptionConfigsClientDiagnostics.CreateScope("BackupResourceEncryptionConfigExtendedResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _backupResourceEncryptionConfigExtendedResourceBackupResourceEncryptionConfigsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, vaultName, cancellationToken: cancellationToken).ConfigureAwait(false);
