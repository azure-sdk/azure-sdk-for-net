...
{
    public partial class AzureFileshareProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureFileshareProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFileshareProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureFileshareProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureFileshareProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureFileshareProtectedItem)} does not support writing '{format}' format.");
            }
        ...
        AzureFileshareProtectedItem IJsonModel<AzureFileshareProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureFileshareProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureFileshareProtectedItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureFileshareProtectedItem(document.RootElement, options);
        }

        internal static AzureFileshareProtectedItem DeserializeAzureFileshareProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AzureFileshareProtectedItemExtendedInfo extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = AzureFileshareProtectedItemExtendedInfo.DeserializeAzureFileshareProtectedItemExtendedInfo(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<AzureFileshareProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureFileshareProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureFileshareProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        AzureFileshareProtectedItem IPersistableModel<AzureFileshareProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureFileshareProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureFileshareProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureFileshareProtectedItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
