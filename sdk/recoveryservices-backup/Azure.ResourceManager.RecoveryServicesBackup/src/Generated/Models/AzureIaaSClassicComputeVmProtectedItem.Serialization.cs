...
{
    public partial class AzureIaaSClassicComputeVmProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureIaaSClassicComputeVmProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureIaaSClassicComputeVmProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureIaaSClassicComputeVmProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureIaaSClassicComputeVmProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureIaaSClassicComputeVmProtectedItem)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        AzureIaaSClassicComputeVmProtectedItem IJsonModel<AzureIaaSClassicComputeVmProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureIaaSClassicComputeVmProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureIaaSClassicComputeVmProtectedItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureIaaSClassicComputeVmProtectedItem(document.RootElement, options);
        }

        internal static AzureIaaSClassicComputeVmProtectedItem DeserializeAzureIaaSClassicComputeVmProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureIaaSClassicComputeVmProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureIaaSClassicComputeVmProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureIaaSClassicComputeVmProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        AzureIaaSClassicComputeVmProtectedItem IPersistableModel<AzureIaaSClassicComputeVmProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureIaaSClassicComputeVmProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureIaaSClassicComputeVmProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureIaaSClassicComputeVmProtectedItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
