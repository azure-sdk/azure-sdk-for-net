...
{
    public partial class AzureVmWorkloadProtectedItemExtendedInfo : IUtf8JsonSerializable, IJsonModel<AzureVmWorkloadProtectedItemExtendedInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureVmWorkloadProtectedItemExtendedInfo>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureVmWorkloadProtectedItemExtendedInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadProtectedItemExtendedInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadProtectedItemExtendedInfo)} does not support writing '{format}' format.");
            }
        ...
        AzureVmWorkloadProtectedItemExtendedInfo IJsonModel<AzureVmWorkloadProtectedItemExtendedInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadProtectedItemExtendedInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadProtectedItemExtendedInfo)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureVmWorkloadProtectedItemExtendedInfo(document.RootElement, options);
        }

        internal static AzureVmWorkloadProtectedItemExtendedInfo DeserializeAzureVmWorkloadProtectedItemExtendedInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AzureVmWorkloadProtectedItemExtendedInfo(
                oldestRecoveryPoint,
        ...
        BinaryData IPersistableModel<AzureVmWorkloadProtectedItemExtendedInfo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadProtectedItemExtendedInfo>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadProtectedItemExtendedInfo)} does not support writing '{options.Format}' format.");
            }
        }

        AzureVmWorkloadProtectedItemExtendedInfo IPersistableModel<AzureVmWorkloadProtectedItemExtendedInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadProtectedItemExtendedInfo>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadProtectedItemExtendedInfo)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureVmWorkloadProtectedItemExtendedInfo>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
