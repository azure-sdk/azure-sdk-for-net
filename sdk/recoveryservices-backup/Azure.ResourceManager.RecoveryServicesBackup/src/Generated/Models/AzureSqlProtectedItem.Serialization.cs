...
{
    public partial class AzureSqlProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureSqlProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSqlProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureSqlProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureSqlProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureSqlProtectedItem)} does not support writing '{format}' format.");
            }
        ...
        AzureSqlProtectedItem IJsonModel<AzureSqlProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureSqlProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureSqlProtectedItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureSqlProtectedItem(document.RootElement, options);
        }

        internal static AzureSqlProtectedItem DeserializeAzureSqlProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AzureSqlProtectedItemExtendedInfo extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = AzureSqlProtectedItemExtendedInfo.DeserializeAzureSqlProtectedItemExtendedInfo(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<AzureSqlProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureSqlProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureSqlProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        AzureSqlProtectedItem IPersistableModel<AzureSqlProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureSqlProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureSqlProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureSqlProtectedItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
