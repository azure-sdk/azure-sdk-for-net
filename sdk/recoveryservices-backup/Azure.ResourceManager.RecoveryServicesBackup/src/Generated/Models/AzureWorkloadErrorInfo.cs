...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureWorkloadErrorInfo
    {
        ...
        internal AzureWorkloadErrorInfo(int? errorCode, string errorString, string errorTitle, IReadOnlyList<string> recommendations, string additionalDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
