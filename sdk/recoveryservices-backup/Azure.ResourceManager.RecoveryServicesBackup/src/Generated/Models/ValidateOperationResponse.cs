...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    internal partial class ValidateOperationResponse
    {
        ...
        {
            ValidationResults = new ChangeTrackingList<ResponseError>();
        }

        /// <summary> Initializes a new instance of <see cref="ValidateOperationResponse"/>. </summary>
        /// <param name="validationResults"> Gets the validation result. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal ValidateOperationResponse(IReadOnlyList<ResponseError> validationResults, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public IReadOnlyList<ResponseError> ValidationResults { get; }
    }
}
