...
{
    public partial class SnapshotRestoreParameters : IUtf8JsonSerializable
    {
        ...
        internal static SnapshotRestoreParameters DeserializeSnapshotRestoreParameters(JsonElement element)
        {
            ...
            return new SnapshotRestoreParameters(Optional.ToNullable(skipAttachAndMount), logPointInTimeForDBRecovery.Value);
        }
    }
}
