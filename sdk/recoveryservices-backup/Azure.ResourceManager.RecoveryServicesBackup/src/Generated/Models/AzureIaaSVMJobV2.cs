...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureIaaSVMJobV2 : Job
    {
        ...
        internal AzureIaaSVMJobV2(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<JobSupportedAction> actionsInfo, string containerName, TimeSpan? duration, IReadOnlyList<AzureIaaSVMErrorInfo> errorDetails, string virtualMachineVersion, AzureIaaSVMJobExtendedInfo extendedInfo) : base(entityFriendlyName, backupManagementType, operation, status, startOn, endOn, activityId, jobType, serializedAdditionalRawData)
        {
