...
{
    public partial class AzureWorkloadOracleRestoreRequest : IUtf8JsonSerializable, IJsonModel<AzureWorkloadOracleRestoreRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureWorkloadOracleRestoreRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureWorkloadOracleRestoreRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadOracleRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWorkloadOracleRestoreRequest)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        AzureWorkloadOracleRestoreRequest IJsonModel<AzureWorkloadOracleRestoreRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadOracleRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWorkloadOracleRestoreRequest)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureWorkloadOracleRestoreRequest(document.RootElement, options);
        }

        internal static AzureWorkloadOracleRestoreRequest DeserializeAzureWorkloadOracleRestoreRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string objectType = "AzureWorkloadOracleRestoreRequest";
            ...
            return new AzureWorkloadOracleRestoreRequest(
                objectType,
        ...
        BinaryData IPersistableModel<AzureWorkloadOracleRestoreRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadOracleRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureWorkloadOracleRestoreRequest)} does not support writing '{options.Format}' format.");
            }
        }

        AzureWorkloadOracleRestoreRequest IPersistableModel<AzureWorkloadOracleRestoreRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadOracleRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureWorkloadOracleRestoreRequest)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureWorkloadOracleRestoreRequest>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
