...
{
    public partial class NameInfo : IUtf8JsonSerializable, IJsonModel<NameInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NameInfo>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NameInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        NameInfo IJsonModel<NameInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NameInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NameInfo DeserializeNameInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NameInfo(value, localizedValue, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<NameInfo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NameInfo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        NameInfo IPersistableModel<NameInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NameInfo>)this).GetFormatFromOptions(options) : options.Format;
