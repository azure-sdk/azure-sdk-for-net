...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureIaaSVMJob : Job
    {
        ...
        internal AzureIaaSVMJob(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, IDictionary<string, BinaryData> serializedAdditionalRawData, TimeSpan? duration, IReadOnlyList<JobSupportedAction> actionsInfo, IReadOnlyList<AzureIaaSVMErrorInfo> errorDetails, string virtualMachineVersion, AzureIaaSVMJobExtendedInfo extendedInfo, string containerName, bool? isUserTriggered) : base(entityFriendlyName, backupManagementType, operation, status, startOn, endOn, activityId, jobType, serializedAdditionalRawData)
        {
            Duration = duration;
        ...
        public IReadOnlyList<AzureIaaSVMErrorInfo> ErrorDetails { get; }
