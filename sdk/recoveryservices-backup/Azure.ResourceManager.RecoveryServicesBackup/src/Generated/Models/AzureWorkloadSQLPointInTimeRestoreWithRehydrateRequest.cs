...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadSQLPointInTimeRestoreWithRehydrateRequest"/>. </summary>
        ...
        /// <param name="pointInOn"> PointInTime value. </param>
        /// <param name="recoveryPointRehydrationInfo"> RP Rehydration Info. </param>
        internal AzureWorkloadSQLPointInTimeRestoreWithRehydrateRequest(string objectType, IList<string> resourceGuardOperationRequests, IDictionary<string, BinaryData> serializedAdditionalRawData, RecoveryType? recoveryType, string sourceResourceId, IDictionary<string, string> propertyBag, TargetRestoreInfo targetInfo, RecoveryMode? recoveryMode, string targetResourceGroupName, UserAssignedManagedIdentityDetails userAssignedManagedIdentityDetails, SnapshotRestoreParameters snapshotRestoreParameters, string targetVirtualMachineId, bool? shouldUseAlternateTargetLocation, bool? isNonRecoverable, IList<SQLDataDirectoryMapping> alternateDirectoryPaths, DateTimeOffset? pointInOn, RecoveryPointRehydrationInfo recoveryPointRehydrationInfo) : base(objectType, resourceGuardOperationRequests, serializedAdditionalRawData, recoveryType, sourceResourceId, propertyBag, targetInfo, recoveryMode, targetResourceGroupName, userAssignedManagedIdentityDetails, snapshotRestoreParameters, targetVirtualMachineId, shouldUseAlternateTargetLocation, isNonRecoverable, alternateDirectoryPaths, pointInOn)
        {
