...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    internal partial class ProtectionIntentResourceList : ResourceList
    {
        ...
        {
            Value = new ChangeTrackingList<ProtectionIntentResource>();
        }
        ...
        internal ProtectionIntentResourceList(string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<ProtectionIntentResource> value) : base(nextLink, serializedAdditionalRawData)
        {
            Value = value;
        }

        /// <summary> List of resources. </summary>
        public IReadOnlyList<ProtectionIntentResource> Value { get; }
    }
}
