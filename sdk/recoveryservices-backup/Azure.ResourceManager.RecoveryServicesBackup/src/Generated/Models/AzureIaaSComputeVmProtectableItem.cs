...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureIaaSComputeVmProtectableItem"/>. </summary>
        internal AzureIaaSComputeVmProtectableItem()
        {
        ...
        internal AzureIaaSComputeVmProtectableItem(string backupManagementType, string workloadType, string protectableItemType, string friendlyName, ProtectionStatus? protectionState, IDictionary<string, BinaryData> serializedAdditionalRawData, string virtualMachineId, string virtualMachineVersion, string resourceGroup) : base(backupManagementType, workloadType, protectableItemType, friendlyName, protectionState, serializedAdditionalRawData, virtualMachineId, virtualMachineVersion, resourceGroup)
        {
