...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    internal partial class ProtectedItemResourceList : ResourceList
    {
        ...
        internal ProtectedItemResourceList(string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<ProtectedItemResourceData> value) : base(nextLink, serializedAdditionalRawData)
        {
            Value = value;
        }
