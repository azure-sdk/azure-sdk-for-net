...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class PreValidateEnableBackupResponse
    {
        ...
        internal PreValidateEnableBackupResponse(ValidationStatus? status, string errorCode, string errorMessage, string recommendation, string containerName, string protectedItemName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            ErrorCode = errorCode;
