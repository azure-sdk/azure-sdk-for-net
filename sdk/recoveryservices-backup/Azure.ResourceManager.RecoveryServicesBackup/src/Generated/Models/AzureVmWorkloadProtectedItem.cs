...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// The available derived classes include <see cref="AzureVmWorkloadSAPAseDatabaseProtectedItem"/>, <see cref="AzureVmWorkloadSAPHanaDatabaseProtectedItem"/>, <see cref="AzureVmWorkloadSAPHanaDBInstanceProtectedItem"/>, <see cref="AzureVmWorkloadSQLDatabaseProtectedItem"/> and <see cref="AzureVmWorkloadSQLInstanceProtectedItem"/>.
    /// </summary>
    public partial class AzureVmWorkloadProtectedItem : ProtectedItem
    {
        /// <summary> Initializes a new instance of <see cref="AzureVmWorkloadProtectedItem"/>. </summary>
        ...
        internal AzureVmWorkloadProtectedItem(string protectedItemType, BackupManagementType? backupManagementType, DataSourceType? workloadType, string containerName, string sourceResourceId, string policyId, DateTimeOffset? lastRecoveryPoint, string backupSetName, CreateMode? createMode, DateTimeOffset? deferredDeleteTimeInUTC, bool? isScheduledForDeferredDelete, string deferredDeleteTimeRemaining, bool? isDeferredDeleteScheduleUpcoming, bool? isRehydrate, IList<string> resourceGuardOperationRequests, bool? isArchiveEnabled, string policyName, int? softDeleteRetentionPeriodInDays, string vaultId, SourceSideScanInfo sourceSideScanInfo, IDictionary<string, BinaryData> serializedAdditionalRawData, string friendlyName, string serverName, string parentName, string parentType, string protectionStatus, ProtectionState? protectionState, LastBackupStatus? lastBackupStatus, DateTimeOffset? lastBackupOn, ResponseError lastBackupErrorDetail, string protectedItemDataSourceId, ProtectedItemHealthStatus? protectedItemHealthStatus, AzureVmWorkloadProtectedItemExtendedInfo extendedInfo, IDictionary<string, KPIResourceHealthDetails> kpisHealths, IList<DistributedNodesInfo> nodesList) : base(protectedItemType, backupManagementType, workloadType, containerName, sourceResourceId, policyId, lastRecoveryPoint, backupSetName, createMode, deferredDeleteTimeInUTC, isScheduledForDeferredDelete, deferredDeleteTimeRemaining, isDeferredDeleteScheduleUpcoming, isRehydrate, resourceGuardOperationRequests, isArchiveEnabled, policyName, softDeleteRetentionPeriodInDays, vaultId, sourceSideScanInfo, serializedAdditionalRawData)
        {
        ...
        public ResponseError LastBackupErrorDetail { get; set; }
