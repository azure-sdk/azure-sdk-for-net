...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VaultJob : Job
    {
        ...
        internal VaultJob(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, IDictionary<string, BinaryData> serializedAdditionalRawData, TimeSpan? duration, IReadOnlyList<JobSupportedAction> actionsInfo, IReadOnlyList<VaultJobErrorInfo> errorDetails, VaultJobExtendedInfo extendedInfo) : base(entityFriendlyName, backupManagementType, operation, status, startOn, endOn, activityId, jobType, serializedAdditionalRawData)
        {
            Duration = duration;
        ...
        public IReadOnlyList<VaultJobErrorInfo> ErrorDetails { get; }
        ...
        public IReadOnlyDictionary<string, string> ExtendedInfoPropertyBag
        {
            get => ExtendedInfo?.PropertyBag;
        }
    }
}
