...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdentityBasedRestoreDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IdentityBasedRestoreDetails)} does not support writing '{format}' format.");
            }
        ...
        IdentityBasedRestoreDetails IJsonModel<IdentityBasedRestoreDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IdentityBasedRestoreDetails)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IdentityBasedRestoreDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IdentityBasedRestoreDetails)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        IdentityBasedRestoreDetails IPersistableModel<IdentityBasedRestoreDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IdentityBasedRestoreDetails)} does not support reading '{options.Format}' format.");
            }
        }
