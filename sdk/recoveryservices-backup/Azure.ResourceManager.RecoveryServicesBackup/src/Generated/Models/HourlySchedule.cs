...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class HourlySchedule
    {
        ...
        internal HourlySchedule(int? interval, DateTimeOffset? scheduleWindowStartOn, int? scheduleWindowDuration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Interval = interval;
