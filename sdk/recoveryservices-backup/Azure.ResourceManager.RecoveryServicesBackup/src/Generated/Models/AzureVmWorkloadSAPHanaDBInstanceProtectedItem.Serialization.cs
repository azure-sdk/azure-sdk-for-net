...
{
    public partial class AzureVmWorkloadSAPHanaDBInstanceProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDBInstanceProtectedItem)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        AzureVmWorkloadSAPHanaDBInstanceProtectedItem IJsonModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDBInstanceProtectedItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureVmWorkloadSAPHanaDBInstanceProtectedItem(document.RootElement, options);
        }

        internal static AzureVmWorkloadSAPHanaDBInstanceProtectedItem DeserializeAzureVmWorkloadSAPHanaDBInstanceProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDBInstanceProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        AzureVmWorkloadSAPHanaDBInstanceProtectedItem IPersistableModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDBInstanceProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureVmWorkloadSAPHanaDBInstanceProtectedItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
