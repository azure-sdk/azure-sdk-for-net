...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureIaaSClassicComputeVmContainer"/>. </summary>
        ...
        internal AzureIaaSClassicComputeVmContainer(string friendlyName, BackupManagementType? backupManagementType, string registrationStatus, string healthStatus, ProtectableContainerType containerType, string protectableObjectType, IDictionary<string, BinaryData> serializedAdditionalRawData, string virtualMachineId, string virtualMachineVersion, string resourceGroup) : base(friendlyName, backupManagementType, registrationStatus, healthStatus, containerType, protectableObjectType, serializedAdditionalRawData, virtualMachineId, virtualMachineVersion, resourceGroup)
        {
