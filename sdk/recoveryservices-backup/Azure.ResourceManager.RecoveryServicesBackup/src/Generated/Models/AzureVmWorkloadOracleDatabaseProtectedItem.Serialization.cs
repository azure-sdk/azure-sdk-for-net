...
{
    public partial class AzureVmWorkloadOracleDatabaseProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureVmWorkloadOracleDatabaseProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureVmWorkloadOracleDatabaseProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureVmWorkloadOracleDatabaseProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadOracleDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadOracleDatabaseProtectedItem)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        AzureVmWorkloadOracleDatabaseProtectedItem IJsonModel<AzureVmWorkloadOracleDatabaseProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadOracleDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadOracleDatabaseProtectedItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureVmWorkloadOracleDatabaseProtectedItem(document.RootElement, options);
        }

        internal static AzureVmWorkloadOracleDatabaseProtectedItem DeserializeAzureVmWorkloadOracleDatabaseProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            DataSourceTypeAutoGenerated3? workloadType = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("workloadType"u8))
                {
                    ...
                    workloadType = new DataSourceTypeAutoGenerated3(property.Value.GetString());
                    continue;
                }
        ...
        BinaryData IPersistableModel<AzureVmWorkloadOracleDatabaseProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadOracleDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadOracleDatabaseProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        AzureVmWorkloadOracleDatabaseProtectedItem IPersistableModel<AzureVmWorkloadOracleDatabaseProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadOracleDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadOracleDatabaseProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureVmWorkloadOracleDatabaseProtectedItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
