...
{
    public partial class BackupStatusResponse : IUtf8JsonSerializable, IJsonModel<BackupStatusResponse>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupStatusResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<BackupStatusResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BackupStatusResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BackupStatusResponse)} does not support writing '{format}' format.");
            }
        ...
        BackupStatusResponse IJsonModel<BackupStatusResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BackupStatusResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BackupStatusResponse)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeBackupStatusResponse(document.RootElement, options);
        }

        internal static BackupStatusResponse DeserializeBackupStatusResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BackupStatusResponse>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BackupStatusResponse>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BackupStatusResponse)} does not support writing '{options.Format}' format.");
            }
        }

        BackupStatusResponse IPersistableModel<BackupStatusResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BackupStatusResponse>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BackupStatusResponse)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<BackupStatusResponse>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
