...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureStorageJob : Job
    {
        ...
        internal AzureStorageJob(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, IDictionary<string, BinaryData> serializedAdditionalRawData, TimeSpan? duration, IReadOnlyList<JobSupportedAction> actionsInfo, IReadOnlyList<AzureStorageErrorInfo> errorDetails, string storageAccountName, string storageAccountVersion, AzureStorageJobExtendedInfo extendedInfo, bool? isUserTriggered) : base(entityFriendlyName, backupManagementType, operation, status, startOn, endOn, activityId, jobType, serializedAdditionalRawData)
        {
            Duration = duration;
        ...
        public IReadOnlyList<AzureStorageErrorInfo> ErrorDetails { get; }
