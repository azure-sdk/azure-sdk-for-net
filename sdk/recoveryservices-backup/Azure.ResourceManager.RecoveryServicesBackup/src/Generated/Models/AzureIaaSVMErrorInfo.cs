...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureIaaSVMErrorInfo
    {
        ...
        internal AzureIaaSVMErrorInfo(int? errorCode, string errorTitle, string errorString, IReadOnlyList<string> recommendations, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
