...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class ExportJobsOperationResultInfo : OperationResultInfoBase
    {
        ...
        internal ExportJobsOperationResultInfo(string objectType, IDictionary<string, BinaryData> serializedAdditionalRawData, string blobUri, string blobSasKey, string excelFileBlobUri, string excelFileBlobSasKey) : base(objectType, serializedAdditionalRawData)
        {
            BlobUri = blobUri;
