...
{
    public partial class AzureWorkloadSAPHanaRecoveryPoint : IUtf8JsonSerializable, IJsonModel<AzureWorkloadSAPHanaRecoveryPoint>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureWorkloadSAPHanaRecoveryPoint>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureWorkloadSAPHanaRecoveryPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSAPHanaRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWorkloadSAPHanaRecoveryPoint)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        AzureWorkloadSAPHanaRecoveryPoint IJsonModel<AzureWorkloadSAPHanaRecoveryPoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSAPHanaRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWorkloadSAPHanaRecoveryPoint)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureWorkloadSAPHanaRecoveryPoint(document.RootElement, options);
        }

        internal static AzureWorkloadSAPHanaRecoveryPoint DeserializeAzureWorkloadSAPHanaRecoveryPoint(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureWorkloadSAPHanaRecoveryPoint>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSAPHanaRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureWorkloadSAPHanaRecoveryPoint)} does not support writing '{options.Format}' format.");
            }
        }

        AzureWorkloadSAPHanaRecoveryPoint IPersistableModel<AzureWorkloadSAPHanaRecoveryPoint>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSAPHanaRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureWorkloadSAPHanaRecoveryPoint)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureWorkloadSAPHanaRecoveryPoint>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
