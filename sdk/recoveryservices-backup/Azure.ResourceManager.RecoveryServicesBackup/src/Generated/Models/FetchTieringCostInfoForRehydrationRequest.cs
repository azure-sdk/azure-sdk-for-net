...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class FetchTieringCostInfoForRehydrationRequest : FetchTieringCostInfoContent
    {
        ...
        /// <param name="recoveryPointId"> ID of the backup copy for rehydration cost info needs to be fetched. </param>
        /// <param name="rehydrationPriority"> Rehydration Priority. </param>
        internal FetchTieringCostInfoForRehydrationRequest(RecoveryPointTierType sourceTierType, RecoveryPointTierType targetTierType, string objectType, string containerName, string protectedItemName, string recoveryPointId, RehydrationPriority rehydrationPriority) : base(sourceTierType, targetTierType, objectType)
        {
            ContainerName = containerName;
            ProtectedItemName = protectedItemName;
            RecoveryPointId = recoveryPointId;
