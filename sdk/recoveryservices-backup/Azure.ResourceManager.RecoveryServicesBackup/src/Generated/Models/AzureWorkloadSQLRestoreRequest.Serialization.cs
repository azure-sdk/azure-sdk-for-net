...
{
    public partial class AzureWorkloadSQLRestoreRequest : IUtf8JsonSerializable, IJsonModel<AzureWorkloadSQLRestoreRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureWorkloadSQLRestoreRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureWorkloadSQLRestoreRequest IJsonModel<AzureWorkloadSQLRestoreRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AzureWorkloadSQLRestoreRequest DeserializeAzureWorkloadSQLRestoreRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureWorkloadSQLRestoreRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureWorkloadSQLRestoreRequest IPersistableModel<AzureWorkloadSQLRestoreRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
