...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VaultJobErrorInfo
    {
        ...
        internal VaultJobErrorInfo(int? errorCode, string errorString, IReadOnlyList<string> recommendations, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
