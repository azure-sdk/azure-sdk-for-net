...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class BackupRequest : IUtf8JsonSerializable, IJsonModel<BackupRequest>
    {
        ...
        internal static BackupRequest DeserializeBackupRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("objectType", out JsonElement discriminator))
            {
                ...
                {
                    case "AzureFileShareBackupRequest": return AzureFileShareBackupRequest.DeserializeAzureFileShareBackupRequest(element, options);
                    case "AzureWorkloadBackupRequest": return AzureWorkloadBackupRequest.DeserializeAzureWorkloadBackupRequest(element, options);
                    case "IaasVMBackupRequest": return IaasVmBackupRequest.DeserializeIaasVmBackupRequest(element, options);
                }
            }
