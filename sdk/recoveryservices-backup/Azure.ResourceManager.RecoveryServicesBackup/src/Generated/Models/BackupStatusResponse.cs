...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class BackupStatusResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BackupStatusResponse"/>. </summary>
        ...
        internal BackupStatusResponse(ProtectionStatus? protectionStatus, string vaultId, FabricName? fabricName, string containerName, string protectedItemName, string errorCode, string errorMessage, string policyName, string registrationStatus, int? protectedItemsCount, AcquireStorageAccountLock? acquireStorageAccountLock, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
