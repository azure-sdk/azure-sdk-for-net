...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVmRecoveryPoint : RecoveryPoint
    {
        ...
        /// </param>
        internal IaasVmRecoveryPoint(string objectType, ThreatStatus? threatStatus, IReadOnlyList<ThreatInfo> threatInfo, IDictionary<string, BinaryData> serializedAdditionalRawData, string recoveryPointType, DateTimeOffset? recoveryPointOn, string recoveryPointAdditionalInfo, string sourceVmStorageType, bool? isSourceVmEncrypted, KeyAndSecretDetails keyAndSecret, bool? isInstantIlrSessionActive, IReadOnlyList<RecoveryPointTierInformationV2> recoveryPointTierDetails, bool? isManagedVirtualMachine, string virtualMachineSize, bool? originalStorageAccountOption, string osType, RecoveryPointDiskConfiguration recoveryPointDiskConfiguration, IReadOnlyList<string> zones, IReadOnlyDictionary<string, RecoveryPointMoveReadinessInfo> recoveryPointMoveReadinessInfo, string securityType, RecoveryPointProperties recoveryPointProperties, bool? isPrivateAccessEnabledOnAnyDisk, ExtendedLocation extendedLocation) : base(objectType, threatStatus, threatInfo, serializedAdditionalRawData)
        {
