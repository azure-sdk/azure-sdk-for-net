...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class ProtectionPolicy : IUtf8JsonSerializable, IJsonModel<ProtectionPolicy>
    {
        ...
        internal static ProtectionPolicy DeserializeProtectionPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("backupManagementType", out JsonElement discriminator))
            {
                ...
                {
                    case "AzureIaasVM": return AzureIaaSVMProtectionPolicy.DeserializeAzureIaaSVMProtectionPolicy(element, options);
                    case "AzureSql": return AzureSqlProtectionPolicy.DeserializeAzureSqlProtectionPolicy(element, options);
                    case "AzureStorage": return AzureFileShareProtectionPolicy.DeserializeAzureFileShareProtectionPolicy(element, options);
                    case "AzureWorkload": return AzureVmWorkloadProtectionPolicy.DeserializeAzureVmWorkloadProtectionPolicy(element, options);
