...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureVmResourceFeatureSupportRequest : FeatureSupportContent
    {
        ...
        internal AzureVmResourceFeatureSupportRequest(string featureType, IDictionary<string, BinaryData> serializedAdditionalRawData, string vmSize, string vmSku) : base(featureType, serializedAdditionalRawData)
        {
            VmSize = vmSize;
            VmSku = vmSku;
