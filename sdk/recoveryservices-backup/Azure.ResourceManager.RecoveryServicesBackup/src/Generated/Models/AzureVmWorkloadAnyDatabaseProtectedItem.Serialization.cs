...
{
    public partial class AzureVmWorkloadAnyDatabaseProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureVmWorkloadAnyDatabaseProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureVmWorkloadAnyDatabaseProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureVmWorkloadAnyDatabaseProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadAnyDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadAnyDatabaseProtectedItem)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        AzureVmWorkloadAnyDatabaseProtectedItem IJsonModel<AzureVmWorkloadAnyDatabaseProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadAnyDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadAnyDatabaseProtectedItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureVmWorkloadAnyDatabaseProtectedItem(document.RootElement, options);
        }

        internal static AzureVmWorkloadAnyDatabaseProtectedItem DeserializeAzureVmWorkloadAnyDatabaseProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureVmWorkloadAnyDatabaseProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadAnyDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadAnyDatabaseProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        AzureVmWorkloadAnyDatabaseProtectedItem IPersistableModel<AzureVmWorkloadAnyDatabaseProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadAnyDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadAnyDatabaseProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureVmWorkloadAnyDatabaseProtectedItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
