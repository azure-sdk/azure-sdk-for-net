...
{
    public partial class AzureWorkloadSQLRestoreWithRehydrateRequest : IUtf8JsonSerializable, IJsonModel<AzureWorkloadSQLRestoreWithRehydrateRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureWorkloadSQLRestoreWithRehydrateRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureWorkloadSQLRestoreWithRehydrateRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLRestoreWithRehydrateRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWorkloadSQLRestoreWithRehydrateRequest)} does not support writing '{format}' format.");
            }
        ...
        AzureWorkloadSQLRestoreWithRehydrateRequest IJsonModel<AzureWorkloadSQLRestoreWithRehydrateRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLRestoreWithRehydrateRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWorkloadSQLRestoreWithRehydrateRequest)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureWorkloadSQLRestoreWithRehydrateRequest(document.RootElement, options);
        }

        internal static AzureWorkloadSQLRestoreWithRehydrateRequest DeserializeAzureWorkloadSQLRestoreWithRehydrateRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureWorkloadSQLRestoreWithRehydrateRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLRestoreWithRehydrateRequest>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureWorkloadSQLRestoreWithRehydrateRequest)} does not support writing '{options.Format}' format.");
            }
        }

        AzureWorkloadSQLRestoreWithRehydrateRequest IPersistableModel<AzureWorkloadSQLRestoreWithRehydrateRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLRestoreWithRehydrateRequest>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureWorkloadSQLRestoreWithRehydrateRequest)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureWorkloadSQLRestoreWithRehydrateRequest>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
