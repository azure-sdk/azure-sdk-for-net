        ...
        internal static OperationStatus DeserializeOperationStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("error"u8))
                {
                    ...
                    error = OperationStatusError.DeserializeOperationStatusError(property.Value, options);
                    continue;
                }
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = OperationStatusExtendedInfo.DeserializeOperationStatusExtendedInfo(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
