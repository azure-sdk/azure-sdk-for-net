...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureIaaSVMJobExtendedInfo
    {
        ...
        internal AzureIaaSVMJobExtendedInfo(IReadOnlyList<AzureIaaSVMJobTaskDetails> tasksList, IReadOnlyDictionary<string, string> propertyBag, IReadOnlyDictionary<string, string> internalPropertyBag, double? progressPercentage, string estimatedRemainingDuration, string dynamicErrorMessage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TasksList = tasksList;
        ...
        public IReadOnlyList<AzureIaaSVMJobTaskDetails> TasksList { get; }
        ...
        public IReadOnlyDictionary<string, string> InternalPropertyBag { get; }
