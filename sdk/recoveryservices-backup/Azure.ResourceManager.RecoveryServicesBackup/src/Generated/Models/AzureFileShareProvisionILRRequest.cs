...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureFileShareProvisionILRRequest : ILRRequest
    {
        ...
        internal AzureFileShareProvisionILRRequest(string objectType, IDictionary<string, BinaryData> serializedAdditionalRawData, string recoveryPointId, string sourceResourceId) : base(objectType, serializedAdditionalRawData)
        {
