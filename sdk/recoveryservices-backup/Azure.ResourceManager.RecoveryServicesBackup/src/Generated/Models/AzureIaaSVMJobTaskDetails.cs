...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureIaaSVMJobTaskDetails
    {
        ...
        internal AzureIaaSVMJobTaskDetails(string taskId, DateTimeOffset? startOn, DateTimeOffset? endOn, string instanceId, TimeSpan? duration, string status, double? progressPercentage, string taskExecutionDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TaskId = taskId;
            StartOn = startOn;
            EndOn = endOn;
