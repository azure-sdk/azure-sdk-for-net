...
{
    public partial class AzureVmWorkloadSAPHanaDatabaseProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDatabaseProtectedItem)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        AzureVmWorkloadSAPHanaDatabaseProtectedItem IJsonModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDatabaseProtectedItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureVmWorkloadSAPHanaDatabaseProtectedItem(document.RootElement, options);
        }

        internal static AzureVmWorkloadSAPHanaDatabaseProtectedItem DeserializeAzureVmWorkloadSAPHanaDatabaseProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDatabaseProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        AzureVmWorkloadSAPHanaDatabaseProtectedItem IPersistableModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDatabaseProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureVmWorkloadSAPHanaDatabaseProtectedItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
