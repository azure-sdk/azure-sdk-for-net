...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class OperationStatusJobsExtendedInfo : OperationStatusExtendedInfo
    {
        ...
        internal OperationStatusJobsExtendedInfo(string objectType, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<string> jobIds, IReadOnlyDictionary<string, string> failedJobsError) : base(objectType, serializedAdditionalRawData)
        {
            JobIds = jobIds;
