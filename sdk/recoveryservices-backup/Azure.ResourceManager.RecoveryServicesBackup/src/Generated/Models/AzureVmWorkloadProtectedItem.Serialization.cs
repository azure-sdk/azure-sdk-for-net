...
{
    public partial class AzureVmWorkloadProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureVmWorkloadProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureVmWorkloadProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureVmWorkloadProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadProtectedItem)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsDefined(LastBackupErrorDetail))
            {
                ...
                ((IJsonModel<ResponseError>)LastBackupErrorDetail).Write(writer, options);
            }
        ...
        AzureVmWorkloadProtectedItem IJsonModel<AzureVmWorkloadProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadProtectedItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureVmWorkloadProtectedItem(document.RootElement, options);
        }

        internal static AzureVmWorkloadProtectedItem DeserializeAzureVmWorkloadProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureVmWorkloadProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        AzureVmWorkloadProtectedItem IPersistableModel<AzureVmWorkloadProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureVmWorkloadProtectedItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
