...
{
    public partial class AzureWorkloadSQLPointInTimeRecoveryPoint : IUtf8JsonSerializable, IJsonModel<AzureWorkloadSQLPointInTimeRecoveryPoint>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureWorkloadSQLPointInTimeRecoveryPoint>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLPointInTimeRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureWorkloadSQLPointInTimeRecoveryPoint IJsonModel<AzureWorkloadSQLPointInTimeRecoveryPoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLPointInTimeRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AzureWorkloadSQLPointInTimeRecoveryPoint DeserializeAzureWorkloadSQLPointInTimeRecoveryPoint(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = AzureWorkloadSQLRecoveryPointExtendedInfo.DeserializeAzureWorkloadSQLRecoveryPointExtendedInfo(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<AzureWorkloadSQLPointInTimeRecoveryPoint>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLPointInTimeRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureWorkloadSQLPointInTimeRecoveryPoint IPersistableModel<AzureWorkloadSQLPointInTimeRecoveryPoint>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadSQLPointInTimeRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
