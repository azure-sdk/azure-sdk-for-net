...
{
    public partial class BackupResourceVaultConfig : IUtf8JsonSerializable, IJsonModel<BackupResourceVaultConfig>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupResourceVaultConfig>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BackupResourceVaultConfig>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BackupResourceVaultConfig IJsonModel<BackupResourceVaultConfig>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BackupResourceVaultConfig>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static BackupResourceVaultConfig DeserializeBackupResourceVaultConfig(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BackupResourceVaultConfig>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BackupResourceVaultConfig>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BackupResourceVaultConfig IPersistableModel<BackupResourceVaultConfig>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BackupResourceVaultConfig>)this).GetFormatFromOptions(options) : options.Format;
