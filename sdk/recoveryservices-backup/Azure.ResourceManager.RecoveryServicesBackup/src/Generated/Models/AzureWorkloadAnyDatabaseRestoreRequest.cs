...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// Please note <see cref="AzureWorkloadAnyDatabaseRestoreRequest"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="AzureWorkloadAnyDatabasePointInTimeRestoreRequest"/>, <see cref="AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest"/> and <see cref="AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest"/>.
    /// </summary>
    public partial class AzureWorkloadAnyDatabaseRestoreRequest : WorkloadRestoreContent
    {
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadAnyDatabaseRestoreRequest"/>. </summary>
        public AzureWorkloadAnyDatabaseRestoreRequest()
        {
            ObjectType = "AzureWorkloadAnyDatabaseRestoreRequest";
        }
