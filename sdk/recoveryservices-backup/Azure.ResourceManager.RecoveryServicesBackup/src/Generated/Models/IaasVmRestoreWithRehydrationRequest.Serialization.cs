...
{
    public partial class IaasVmRestoreWithRehydrationRequest : IUtf8JsonSerializable
    {
        ...
        internal static IaasVmRestoreWithRehydrationRequest DeserializeIaasVmRestoreWithRehydrationRequest(JsonElement element)
        {
