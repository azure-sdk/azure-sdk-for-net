...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVmILRRegistrationRequest : ILRRequest
    {
        ...
        internal IaasVmILRRegistrationRequest(string objectType, IDictionary<string, BinaryData> serializedAdditionalRawData, string recoveryPointId, string virtualMachineId, string initiatorName, bool? renewExistingRegistration) : base(objectType, serializedAdditionalRawData)
        {
