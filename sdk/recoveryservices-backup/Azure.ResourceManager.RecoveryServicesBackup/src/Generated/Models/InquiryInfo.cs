...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class InquiryInfo
    {
        ...
        internal InquiryInfo(string status, ResponseError errorDetail, IList<WorkloadInquiryDetails> inquiryDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
