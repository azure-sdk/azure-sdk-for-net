...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class InquiryValidation
    {
        ...
        internal InquiryValidation(string status, ResponseError errorDetail, string additionalDetail, BinaryData protectableItemCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
