...
{
    public partial class AzureVmWorkloadSQLInstanceProtectedItem : IUtf8JsonSerializable, IJsonModel<AzureVmWorkloadSQLInstanceProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureVmWorkloadSQLInstanceProtectedItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSQLInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsCollectionDefined(ChildDBNames))
            {
                ...
                foreach (var item in ChildDBNames)
                {
        ...
        AzureVmWorkloadSQLInstanceProtectedItem IJsonModel<AzureVmWorkloadSQLInstanceProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSQLInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AzureVmWorkloadSQLInstanceProtectedItem DeserializeAzureVmWorkloadSQLInstanceProtectedItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            {
                if (property.NameEquals("childDBNames"u8))
                {
                ...
                if (property.NameEquals("instanceProtectionReadiness"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    instanceProtectionReadiness = new InstanceProtectionReadiness(property.Value.GetString());
                    continue;
                }
        ...
        BinaryData IPersistableModel<AzureVmWorkloadSQLInstanceProtectedItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSQLInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureVmWorkloadSQLInstanceProtectedItem IPersistableModel<AzureVmWorkloadSQLInstanceProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSQLInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
