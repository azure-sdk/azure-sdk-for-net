...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class DistributedNodesInfo
    {
        ...
        internal DistributedNodesInfo(string nodeName, string status, ResponseError errorDetail, string sourceResourceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NodeName = nodeName;
            Status = status;
