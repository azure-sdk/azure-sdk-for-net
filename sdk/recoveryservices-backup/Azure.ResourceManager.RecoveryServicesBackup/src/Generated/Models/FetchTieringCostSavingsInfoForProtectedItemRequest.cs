...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class FetchTieringCostSavingsInfoForProtectedItemRequest : FetchTieringCostInfoContent
    {
        ...
        /// <param name="containerName"> Name of the protected item container. </param>
        /// <param name="protectedItemName"> Name of the protectedItemName. </param>
        internal FetchTieringCostSavingsInfoForProtectedItemRequest(RecoveryPointTierType sourceTierType, RecoveryPointTierType targetTierType, string objectType, string containerName, string protectedItemName) : base(sourceTierType, targetTierType, objectType)
        {
            ContainerName = containerName;
            ProtectedItemName = protectedItemName;
