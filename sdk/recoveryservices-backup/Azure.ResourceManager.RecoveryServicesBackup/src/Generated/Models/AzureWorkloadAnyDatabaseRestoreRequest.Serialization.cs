...
{
    public partial class AzureWorkloadAnyDatabaseRestoreRequest : IUtf8JsonSerializable, IJsonModel<AzureWorkloadAnyDatabaseRestoreRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureWorkloadAnyDatabaseRestoreRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureWorkloadAnyDatabaseRestoreRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadAnyDatabaseRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWorkloadAnyDatabaseRestoreRequest)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        AzureWorkloadAnyDatabaseRestoreRequest IJsonModel<AzureWorkloadAnyDatabaseRestoreRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadAnyDatabaseRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWorkloadAnyDatabaseRestoreRequest)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureWorkloadAnyDatabaseRestoreRequest(document.RootElement, options);
        }

        internal static AzureWorkloadAnyDatabaseRestoreRequest DeserializeAzureWorkloadAnyDatabaseRestoreRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string objectType = "AzureWorkloadAnyDatabaseRestoreRequest";
            ...
            return new AzureWorkloadAnyDatabaseRestoreRequest(
                objectType,
        ...
        BinaryData IPersistableModel<AzureWorkloadAnyDatabaseRestoreRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadAnyDatabaseRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureWorkloadAnyDatabaseRestoreRequest)} does not support writing '{options.Format}' format.");
            }
        }

        AzureWorkloadAnyDatabaseRestoreRequest IPersistableModel<AzureWorkloadAnyDatabaseRestoreRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureWorkloadAnyDatabaseRestoreRequest>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureWorkloadAnyDatabaseRestoreRequest)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AzureWorkloadAnyDatabaseRestoreRequest>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
