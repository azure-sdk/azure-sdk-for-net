...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class ILRRequestResource : TrackedResourceData
    {
        ...
        internal ILRRequestResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string etag, ILRRequest properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
        ...
        /// <summary> Initializes a new instance of <see cref="ILRRequestResource"/> for deserialization. </summary>
        internal ILRRequestResource()
        {
        }
