...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// Please note <see cref="AzureWorkloadAnyDatabasePointInTimeRestoreRequest"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest"/>.
    /// </summary>
    public partial class AzureWorkloadAnyDatabasePointInTimeRestoreRequest : AzureWorkloadAnyDatabaseRestoreRequest
    {
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadAnyDatabasePointInTimeRestoreRequest"/>. </summary>
        public AzureWorkloadAnyDatabasePointInTimeRestoreRequest()
        {
            ObjectType = "AzureWorkloadAnyDatabasePointInTimeRestoreRequest";
        }
