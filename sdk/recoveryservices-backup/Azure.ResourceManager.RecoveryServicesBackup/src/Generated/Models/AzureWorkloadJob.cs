...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadJob"/>. </summary>
        internal AzureWorkloadJob()
        {
        ...
        internal AzureWorkloadJob(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, IDictionary<string, BinaryData> serializedAdditionalRawData, string workloadType, TimeSpan? duration, IReadOnlyList<JobSupportedAction> actionsInfo, IReadOnlyList<AzureWorkloadErrorInfo> errorDetails, AzureWorkloadJobExtendedInfo extendedInfo) : base(entityFriendlyName, backupManagementType, operation, status, startOn, endOn, activityId, jobType, serializedAdditionalRawData)
        {
        ...
        public IReadOnlyList<JobSupportedAction> ActionsInfo { get; }
        /// <summary> Error details on execution of this job. </summary>
        public IReadOnlyList<AzureWorkloadErrorInfo> ErrorDetails { get; }
        /// <summary> Additional information about the job. </summary>
        public AzureWorkloadJobExtendedInfo ExtendedInfo { get; }
    }
}
