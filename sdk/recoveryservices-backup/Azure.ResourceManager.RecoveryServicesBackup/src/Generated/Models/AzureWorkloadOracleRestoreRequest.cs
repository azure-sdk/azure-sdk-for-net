...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// Please note <see cref="AzureWorkloadOracleRestoreRequest"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="AzureWorkloadOraclePointInTimeRestoreRequest"/>, <see cref="AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest"/> and <see cref="AzureWorkloadOracleRestoreWithRehydrateRequest"/>.
    /// </summary>
    public partial class AzureWorkloadOracleRestoreRequest : WorkloadRestoreContent
    {
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadOracleRestoreRequest"/>. </summary>
        public AzureWorkloadOracleRestoreRequest()
        {
            ObjectType = "AzureWorkloadOracleRestoreRequest";
        }
