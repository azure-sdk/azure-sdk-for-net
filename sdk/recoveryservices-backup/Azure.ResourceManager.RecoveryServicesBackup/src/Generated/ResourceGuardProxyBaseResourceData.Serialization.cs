...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGuardProxyBaseResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceGuardProxyBaseResourceData)} does not support writing '{format}' format.");
            }
        ...
        ResourceGuardProxyBaseResourceData IJsonModel<ResourceGuardProxyBaseResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceGuardProxyBaseResourceData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceGuardProxyBaseResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceGuardProxyBaseResourceData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ResourceGuardProxyBaseResourceData IPersistableModel<ResourceGuardProxyBaseResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceGuardProxyBaseResourceData)} does not support reading '{options.Format}' format.");
            }
        }
