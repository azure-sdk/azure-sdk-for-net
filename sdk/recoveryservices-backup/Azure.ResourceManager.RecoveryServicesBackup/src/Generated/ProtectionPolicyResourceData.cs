...
{
    /// <summary>
    /// A class representing the ProtectionPolicyResource data model.
    ...
    public partial class ProtectionPolicyResourceData : TrackedResourceData
    {
        ...
        internal ProtectionPolicyResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ProtectionPolicy properties, string etag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="ProtectionPolicyResourceData"/> for deserialization. </summary>
        internal ProtectionPolicyResourceData()
        {
        }
