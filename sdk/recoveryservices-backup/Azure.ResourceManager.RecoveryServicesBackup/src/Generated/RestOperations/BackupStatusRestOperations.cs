...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class BackupStatusRestOperations
    {
        ...
        internal RequestUriBuilder CreateGetRequestUri(string azureRegion, string subscriptionId, BackupStatusContent content)
        {
        ...
        internal HttpMessage CreateGetRequest(string azureRegion, string subscriptionId, BackupStatusContent content)
        {
        ...
        public async Task<Response<BackupStatusResponse>> GetAsync(string azureRegion, string subscriptionId, BackupStatusContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(azureRegion, nameof(azureRegion));
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(content, nameof(content));

            using var message = CreateGetRequest(azureRegion, subscriptionId, content);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="azureRegion"/>, <paramref name="subscriptionId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="azureRegion"/> or <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<BackupStatusResponse> Get(string azureRegion, string subscriptionId, BackupStatusContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(azureRegion, nameof(azureRegion));
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(content, nameof(content));
