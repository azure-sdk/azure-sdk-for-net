...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class BackupsRestOperations
    {
        ...
        internal RequestUriBuilder CreateTriggerRequestUri(string subscriptionId, string resourceGroupName, string vaultName, string fabricName, string containerName, string protectedItemName, BackupRequestResource backupRequestResource)
        {
