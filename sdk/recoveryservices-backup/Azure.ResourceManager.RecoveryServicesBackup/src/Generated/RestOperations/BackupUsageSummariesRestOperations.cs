...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class BackupUsageSummariesRestOperations
    {
        ...
        public async Task<Response<BackupManagementUsageList>> ListAsync(string vaultName, string resourceGroupName, string subscriptionId, string filter = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="vaultName"/>, <paramref name="resourceGroupName"/> or <paramref name="subscriptionId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="vaultName"/>, <paramref name="resourceGroupName"/> or <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<BackupManagementUsageList> List(string vaultName, string resourceGroupName, string subscriptionId, string filter = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(vaultName, nameof(vaultName));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
        ...
        /// <exception cref="ArgumentException"> <paramref name="vaultName"/>, <paramref name="resourceGroupName"/> or <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<BackupManagementUsageList>> ListNextPageAsync(string nextLink, string vaultName, string resourceGroupName, string subscriptionId, string filter = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/>, <paramref name="vaultName"/>, <paramref name="resourceGroupName"/> or <paramref name="subscriptionId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="vaultName"/>, <paramref name="resourceGroupName"/> or <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<BackupManagementUsageList> ListNextPage(string nextLink, string vaultName, string resourceGroupName, string subscriptionId, string filter = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(nextLink, nameof(nextLink));
            Argument.AssertNotNullOrEmpty(vaultName, nameof(vaultName));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
