...
{
    /// <summary>
    /// A class representing the JobResource data model.
    /// Defines workload agnostic properties for a job.
    /// </summary>
    public partial class JobResourceData : ResourceData
    {
        /// <summary>
        ...
        internal JobResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Job properties, IReadOnlyDictionary<string, string> tags, string location, string etag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
