...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public static partial class RecoveryServicesBackupExtensions
    {
        ...
        public static async Task<ArmOperation<TieringCostInfo>> PostFetchTieringCostAsync(this ResourceGroupResource resourceGroupResource, WaitUntil waitUntil, string vaultName, FetchTieringCostInfoContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetResourceGroupResourceExtensionClient(resourceGroupResource).PostFetchTieringCostAsync(waitUntil, vaultName, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static ArmOperation<TieringCostInfo> PostFetchTieringCost(this ResourceGroupResource resourceGroupResource, WaitUntil waitUntil, string vaultName, FetchTieringCostInfoContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetResourceGroupResourceExtensionClient(resourceGroupResource).PostFetchTieringCost(waitUntil, vaultName, content, cancellationToken);
        }
        ...
        public static async Task<Response<TieringCostInfo>> GetGetTieringCostOperationResultAsync(this ResourceGroupResource resourceGroupResource, string vaultName, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            return await GetResourceGroupResourceExtensionClient(resourceGroupResource).GetGetTieringCostOperationResultAsync(vaultName, operationId, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<TieringCostInfo> GetGetTieringCostOperationResult(this ResourceGroupResource resourceGroupResource, string vaultName, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            return GetResourceGroupResourceExtensionClient(resourceGroupResource).GetGetTieringCostOperationResult(vaultName, operationId, cancellationToken);
        }
        ...
        public static async Task<Response<OperationStatus>> GetTieringCostOperationStatuAsync(this ResourceGroupResource resourceGroupResource, string vaultName, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            return await GetResourceGroupResourceExtensionClient(resourceGroupResource).GetTieringCostOperationStatuAsync(vaultName, operationId, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<OperationStatus> GetTieringCostOperationStatu(this ResourceGroupResource resourceGroupResource, string vaultName, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            return GetResourceGroupResourceExtensionClient(resourceGroupResource).GetTieringCostOperationStatu(vaultName, operationId, cancellationToken);
        }
