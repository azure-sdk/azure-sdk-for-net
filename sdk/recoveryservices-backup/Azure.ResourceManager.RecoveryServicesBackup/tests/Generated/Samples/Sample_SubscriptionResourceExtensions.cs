...
namespace Azure.ResourceManager.RecoveryServicesBackup.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetBackupStatu_GetAzureVirtualMachineBackupStatus()
        {
            ...
            BackupStatusResponse result = await subscriptionResource.GetBackupStatuAsync(azureRegion, content);
        ...
        public async Task ValidateProtectionIntent_ValidateEnableProtectionOnAzureVm()
        {
            ...
            // this example is just showing the usage of "ProtectionIntentOperationGroup_Validate" operation, for the dependent resources, they will have to be created separately.
