...
namespace Microsoft.Azure.Management.Avs
{
    ...
    public partial class AvsClient : ServiceClient<AvsClient>, IAvsClient, IAzureClient
    {
        ...
        private void Initialize()
        {
            ...
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<WorkloadNetworkDhcpEntityUpdate>("dhcpType"));
            DeserializationSettings.Converters.Add(new PolymorphicDeserializeJsonConverter<WorkloadNetworkDhcpEntityUpdate>("dhcpType"));
            CustomInitialize();
