...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class CloudLinksDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CloudLinksDeleteHeaders class.
        /// </summary>
        public CloudLinksDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public CloudLinksDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
