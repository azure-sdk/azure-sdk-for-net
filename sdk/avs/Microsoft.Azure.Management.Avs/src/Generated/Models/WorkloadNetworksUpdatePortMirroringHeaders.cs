...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdatePortMirroring operation.
    /// </summary>
    public partial class WorkloadNetworksUpdatePortMirroringHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksUpdatePortMirroringHeaders class.
        /// </summary>
        public WorkloadNetworksUpdatePortMirroringHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksUpdatePortMirroringHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
