...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class PlacementPoliciesDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PlacementPoliciesDeleteHeaders
        /// class.
        /// </summary>
        public PlacementPoliciesDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public PlacementPoliciesDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
