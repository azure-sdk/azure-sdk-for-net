...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the WorkloadNetworkVMGroupUpdate
        /// class.
        /// </summary>
        ...
        public WorkloadNetworkVMGroupUpdate(string displayName = default(string), IList<string> members = default(IList<string>), string status = default(string), string provisioningState = default(string), long? revision = default(long?))
        {
