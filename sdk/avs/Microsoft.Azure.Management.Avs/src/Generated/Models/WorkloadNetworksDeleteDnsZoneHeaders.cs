...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteDnsZone operation.
    /// </summary>
    public partial class WorkloadNetworksDeleteDnsZoneHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksDeleteDnsZoneHeaders class.
        /// </summary>
        public WorkloadNetworksDeleteDnsZoneHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksDeleteDnsZoneHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
