...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateDhcp operation.
    /// </summary>
    public partial class WorkloadNetworksUpdateDhcpHeaders
    {
        /// <summary>
        /// Initializes a new instance of the WorkloadNetworksUpdateDhcpHeaders
        /// class.
        /// </summary>
        public WorkloadNetworksUpdateDhcpHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksUpdateDhcpHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
