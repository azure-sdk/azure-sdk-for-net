...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class PrivateCloudsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PrivateCloudsDeleteHeaders class.
        /// </summary>
        public PrivateCloudsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public PrivateCloudsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
