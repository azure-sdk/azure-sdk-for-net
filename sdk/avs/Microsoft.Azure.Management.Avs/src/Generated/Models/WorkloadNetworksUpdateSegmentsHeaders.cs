...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateSegments operation.
    /// </summary>
    public partial class WorkloadNetworksUpdateSegmentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksUpdateSegmentsHeaders class.
        /// </summary>
        ...
        /// status.</param>
        public WorkloadNetworksUpdateSegmentsHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
