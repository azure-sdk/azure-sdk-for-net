...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    public partial class AzureResourceManagerCommonTypesSku
    {
        ...
        /// AzureResourceManagerCommonTypesSku class.
        /// </summary>
        ...
        public AzureResourceManagerCommonTypesSku(string name = default(string), SkuTier? tier = default(SkuTier?), string size = default(string), string family = default(string), int? capacity = default(int?))
        {
            Name = name;
            Tier = tier;
            Size = size;
