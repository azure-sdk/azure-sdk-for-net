...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class AuthorizationsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the AuthorizationsDeleteHeaders
        /// class.
        /// </summary>
        public AuthorizationsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public AuthorizationsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
