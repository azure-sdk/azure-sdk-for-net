...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteDnsService operation.
    /// </summary>
    public partial class WorkloadNetworksDeleteDnsServiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksDeleteDnsServiceHeaders class.
        /// </summary>
        public WorkloadNetworksDeleteDnsServiceHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksDeleteDnsServiceHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
