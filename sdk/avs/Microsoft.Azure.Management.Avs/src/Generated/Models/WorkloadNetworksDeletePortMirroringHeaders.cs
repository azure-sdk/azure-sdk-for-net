...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for DeletePortMirroring operation.
    /// </summary>
    public partial class WorkloadNetworksDeletePortMirroringHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksDeletePortMirroringHeaders class.
        /// </summary>
        public WorkloadNetworksDeletePortMirroringHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksDeletePortMirroringHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
