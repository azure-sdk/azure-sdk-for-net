...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateVMGroup operation.
    /// </summary>
    public partial class WorkloadNetworksUpdateVMGroupHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksUpdateVMGroupHeaders class.
        /// </summary>
        public WorkloadNetworksUpdateVMGroupHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksUpdateVMGroupHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
