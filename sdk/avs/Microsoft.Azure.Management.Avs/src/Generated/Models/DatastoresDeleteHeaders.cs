...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class DatastoresDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DatastoresDeleteHeaders class.
        /// </summary>
        public DatastoresDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DatastoresDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
