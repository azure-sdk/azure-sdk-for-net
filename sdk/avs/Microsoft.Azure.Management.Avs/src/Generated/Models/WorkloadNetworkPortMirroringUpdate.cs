...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    public partial class WorkloadNetworkPortMirroringUpdate
    {
        ...
        /// WorkloadNetworkPortMirroringUpdate class.
        /// </summary>
        ...
        public WorkloadNetworkPortMirroringUpdate(string displayName = default(string), string direction = default(string), string source = default(string), string destination = default(string), string status = default(string), string provisioningState = default(string), long? revision = default(long?))
        {
