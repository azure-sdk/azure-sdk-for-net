...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteSegment operation.
    /// </summary>
    public partial class WorkloadNetworksDeleteSegmentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksDeleteSegmentHeaders class.
        /// </summary>
        public WorkloadNetworksDeleteSegmentHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksDeleteSegmentHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
