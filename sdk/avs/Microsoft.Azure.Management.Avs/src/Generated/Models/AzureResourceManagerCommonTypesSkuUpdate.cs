...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    public partial class AzureResourceManagerCommonTypesSkuUpdate
    {
        ...
        /// AzureResourceManagerCommonTypesSkuUpdate class.
        /// </summary>
        ...
        public AzureResourceManagerCommonTypesSkuUpdate(string name = default(string), SkuTier? tier = default(SkuTier?), string size = default(string), string family = default(string), int? capacity = default(int?))
        {
            Name = name;
            Tier = tier;
            Size = size;
