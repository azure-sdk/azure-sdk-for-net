...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class PrivateCloudsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PrivateCloudsUpdateHeaders class.
        /// </summary>
        public PrivateCloudsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public PrivateCloudsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
