...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateDnsService operation.
    /// </summary>
    public partial class WorkloadNetworksUpdateDnsServiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksUpdateDnsServiceHeaders class.
        /// </summary>
        public WorkloadNetworksUpdateDnsServiceHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksUpdateDnsServiceHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
