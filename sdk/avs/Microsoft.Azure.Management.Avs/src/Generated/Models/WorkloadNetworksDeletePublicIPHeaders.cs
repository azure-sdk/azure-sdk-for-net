...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for DeletePublicIP operation.
    /// </summary>
    public partial class WorkloadNetworksDeletePublicIPHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksDeletePublicIPHeaders class.
        /// </summary>
        public WorkloadNetworksDeletePublicIPHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksDeletePublicIPHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
