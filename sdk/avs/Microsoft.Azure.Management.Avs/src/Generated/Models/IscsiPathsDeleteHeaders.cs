...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class IscsiPathsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the IscsiPathsDeleteHeaders class.
        /// </summary>
        public IscsiPathsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public IscsiPathsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
