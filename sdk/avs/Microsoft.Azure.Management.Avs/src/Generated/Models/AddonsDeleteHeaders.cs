...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class AddonsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the AddonsDeleteHeaders class.
        /// </summary>
        public AddonsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public AddonsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
