...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateDnsZone operation.
    /// </summary>
    public partial class WorkloadNetworksUpdateDnsZoneHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksUpdateDnsZoneHeaders class.
        /// </summary>
        public WorkloadNetworksUpdateDnsZoneHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksUpdateDnsZoneHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
