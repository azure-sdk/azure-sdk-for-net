...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class GlobalReachConnectionsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GlobalReachConnectionsDeleteHeaders class.
        /// </summary>
        public GlobalReachConnectionsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GlobalReachConnectionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
