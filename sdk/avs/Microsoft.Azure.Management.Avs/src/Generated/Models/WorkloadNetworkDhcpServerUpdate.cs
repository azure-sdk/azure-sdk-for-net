...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    public partial class WorkloadNetworkDhcpServerUpdate : WorkloadNetworkDhcpEntityUpdate
    {
        ...
        public WorkloadNetworkDhcpServerUpdate(string displayName = default(string), long? revision = default(long?), string serverAddress = default(string), long? leaseTime = default(long?))
