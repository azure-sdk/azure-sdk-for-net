...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    public partial class ClusterUpdate
    {
        ...
        public ClusterUpdate(AzureResourceManagerCommonTypesSku sku = default(AzureResourceManagerCommonTypesSku), int? clusterSize = default(int?), IList<string> hosts = default(IList<string>))
        {
            Sku = sku;
