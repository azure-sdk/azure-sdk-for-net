...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for RestrictMovement operation.
    /// </summary>
    public partial class VirtualMachinesRestrictMovementHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachinesRestrictMovementHeaders class.
        /// </summary>
        public VirtualMachinesRestrictMovementHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesRestrictMovementHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
