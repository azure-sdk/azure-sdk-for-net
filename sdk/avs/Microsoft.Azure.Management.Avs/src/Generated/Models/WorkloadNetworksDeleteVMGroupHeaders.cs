...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteVMGroup operation.
    /// </summary>
    public partial class WorkloadNetworksDeleteVMGroupHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// WorkloadNetworksDeleteVMGroupHeaders class.
        /// </summary>
        public WorkloadNetworksDeleteVMGroupHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksDeleteVMGroupHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
