...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the WorkloadNetworkDnsZoneUpdate
        /// class.
        /// </summary>
        ...
        public WorkloadNetworkDnsZoneUpdate(string displayName = default(string), IList<string> domain = default(IList<string>), IList<string> dnsServerIps = default(IList<string>), string sourceIp = default(string), long? dnsServices = default(long?), string provisioningState = default(string), long? revision = default(long?))
        {
