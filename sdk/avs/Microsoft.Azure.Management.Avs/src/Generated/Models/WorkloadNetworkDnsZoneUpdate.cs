...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    public partial class WorkloadNetworkDnsZoneUpdate
    {
        ...
        public WorkloadNetworkDnsZoneUpdate(string displayName = default(string), IList<string> domain = default(IList<string>), IList<string> dnsServerIps = default(IList<string>), string sourceIp = default(string), int? dnsServices = default(int?), string provisioningState = default(string), long? revision = default(long?))
        {
