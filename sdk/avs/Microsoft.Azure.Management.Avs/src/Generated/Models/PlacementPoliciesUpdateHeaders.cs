...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class PlacementPoliciesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PlacementPoliciesUpdateHeaders
        /// class.
        /// </summary>
        public PlacementPoliciesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public PlacementPoliciesUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
