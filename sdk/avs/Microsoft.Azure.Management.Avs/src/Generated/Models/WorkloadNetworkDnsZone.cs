...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    public partial class WorkloadNetworkDnsZone : ProxyResource
    {
        ...
        public WorkloadNetworkDnsZone(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string displayName = default(string), IList<string> domain = default(IList<string>), IList<string> dnsServerIps = default(IList<string>), string sourceIp = default(string), int? dnsServices = default(int?), string provisioningState = default(string), long? revision = default(long?))
