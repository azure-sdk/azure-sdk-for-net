...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteDhcp operation.
    /// </summary>
    public partial class WorkloadNetworksDeleteDhcpHeaders
    {
        /// <summary>
        /// Initializes a new instance of the WorkloadNetworksDeleteDhcpHeaders
        /// class.
        /// </summary>
        public WorkloadNetworksDeleteDhcpHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public WorkloadNetworksDeleteDhcpHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
