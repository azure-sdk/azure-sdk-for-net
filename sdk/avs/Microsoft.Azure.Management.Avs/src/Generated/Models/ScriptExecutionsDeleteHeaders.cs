...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// </summary>
    public partial class ScriptExecutionsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ScriptExecutionsDeleteHeaders
        /// class.
        /// </summary>
        public ScriptExecutionsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public ScriptExecutionsDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
