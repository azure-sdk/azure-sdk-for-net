...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for RotateNsxtPassword operation.
    /// </summary>
    public partial class PrivateCloudsRotateNsxtPasswordHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PrivateCloudsRotateNsxtPasswordHeaders class.
        /// </summary>
        public PrivateCloudsRotateNsxtPasswordHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public PrivateCloudsRotateNsxtPasswordHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
