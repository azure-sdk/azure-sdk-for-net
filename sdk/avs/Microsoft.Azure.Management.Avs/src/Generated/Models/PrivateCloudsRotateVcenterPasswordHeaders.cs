...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    /// <summary>
    /// Defines headers for RotateVcenterPassword operation.
    /// </summary>
    public partial class PrivateCloudsRotateVcenterPasswordHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PrivateCloudsRotateVcenterPasswordHeaders class.
        /// </summary>
        public PrivateCloudsRotateVcenterPasswordHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public PrivateCloudsRotateVcenterPasswordHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
