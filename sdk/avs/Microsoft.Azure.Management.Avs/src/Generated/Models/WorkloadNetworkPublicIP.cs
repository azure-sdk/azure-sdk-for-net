...
namespace Microsoft.Azure.Management.Avs.Models
{
    ...
    public partial class WorkloadNetworkPublicIP : ProxyResource
    {
        ...
        public WorkloadNetworkPublicIP(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string displayName = default(string), long? numberOfPublicIPs = default(long?), string publicIPBlock = default(string), string provisioningState = default(string))
