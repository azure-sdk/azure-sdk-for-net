...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class PrivateCloudResource : ArmResource
    {
        ...
        internal PrivateCloudResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workloadNetworksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Avs", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _workloadNetworksRestClient = new WorkloadNetworksRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
#if DEBUG
        ...
        /// <summary> Gets a collection of WorkloadNetworkResources in the PrivateCloud. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<WorkloadNetworkResource>> GetWorkloadNetworkAsync(string workloadNetworkName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="workloadNetworkName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<WorkloadNetworkResource> GetWorkloadNetwork(string workloadNetworkName, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Gets a collection of IscsiPathResources in the PrivateCloud. </summary>
        /// <returns> An object representing collection of IscsiPathResources and their operations over a IscsiPathResource. </returns>
        public virtual IscsiPathCollection GetIscsiPaths()
        {
            return GetCachedClient(client => new IscsiPathCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<IscsiPathResource>> GetIscsiPathAsync(string iscsiPathName, CancellationToken cancellationToken = default)
        {
            return await GetIscsiPaths().GetAsync(iscsiPathName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="iscsiPathName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<IscsiPathResource> GetIscsiPath(string iscsiPathName, CancellationToken cancellationToken = default)
        {
            return GetIscsiPaths().Get(iscsiPathName, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsServices/{dnsServiceId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{dnsServiceId}/{privateCloudName}</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<ArmOperation> DeleteDnsServiceWorkloadNetworkAsync(WaitUntil waitUntil, string dnsServiceId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dnsServiceId, nameof(dnsServiceId));

            using var scope = _workloadNetworksClientDiagnostics.CreateScope("PrivateCloudResource.DeleteDnsServiceWorkloadNetwork");
            scope.Start();
            try
            {
                var response = await _workloadNetworksRestClient.DeleteDnsServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, dnsServiceId, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeleteDnsServiceRequest(Id.SubscriptionId, Id.ResourceGroupName, dnsServiceId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <exception cref="ArgumentException"> <paramref name="dnsServiceId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="dnsServiceId"/> is null. </exception>
        public virtual ArmOperation DeleteDnsServiceWorkloadNetwork(WaitUntil waitUntil, string dnsServiceId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dnsServiceId, nameof(dnsServiceId));
            ...
            try
            {
                var response = _workloadNetworksRestClient.DeleteDnsService(Id.SubscriptionId, Id.ResourceGroupName, dnsServiceId, Id.Name, cancellationToken);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeleteDnsServiceRequest(Id.SubscriptionId, Id.ResourceGroupName, dnsServiceId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsZones/{dnsZoneId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{dnsZoneId}/{privateCloudName}</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<ArmOperation> DeleteDnsZoneWorkloadNetworkAsync(WaitUntil waitUntil, string dnsZoneId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dnsZoneId, nameof(dnsZoneId));

            using var scope = _workloadNetworksClientDiagnostics.CreateScope("PrivateCloudResource.DeleteDnsZoneWorkloadNetwork");
            scope.Start();
            try
            {
                var response = await _workloadNetworksRestClient.DeleteDnsZoneAsync(Id.SubscriptionId, Id.ResourceGroupName, dnsZoneId, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeleteDnsZoneRequest(Id.SubscriptionId, Id.ResourceGroupName, dnsZoneId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <exception cref="ArgumentException"> <paramref name="dnsZoneId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="dnsZoneId"/> is null. </exception>
        public virtual ArmOperation DeleteDnsZoneWorkloadNetwork(WaitUntil waitUntil, string dnsZoneId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dnsZoneId, nameof(dnsZoneId));
            ...
            try
            {
                var response = _workloadNetworksRestClient.DeleteDnsZone(Id.SubscriptionId, Id.ResourceGroupName, dnsZoneId, Id.Name, cancellationToken);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeleteDnsZoneRequest(Id.SubscriptionId, Id.ResourceGroupName, dnsZoneId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/portMirroringProfiles/{portMirroringId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{portMirroringId}/{privateCloudName}</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<ArmOperation> DeletePortMirroringWorkloadNetworkAsync(WaitUntil waitUntil, string portMirroringId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(portMirroringId, nameof(portMirroringId));

            using var scope = _workloadNetworksClientDiagnostics.CreateScope("PrivateCloudResource.DeletePortMirroringWorkloadNetwork");
            scope.Start();
            try
            {
                var response = await _workloadNetworksRestClient.DeletePortMirroringAsync(Id.SubscriptionId, Id.ResourceGroupName, portMirroringId, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeletePortMirroringRequest(Id.SubscriptionId, Id.ResourceGroupName, portMirroringId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <exception cref="ArgumentException"> <paramref name="portMirroringId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="portMirroringId"/> is null. </exception>
        public virtual ArmOperation DeletePortMirroringWorkloadNetwork(WaitUntil waitUntil, string portMirroringId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(portMirroringId, nameof(portMirroringId));
            ...
            try
            {
                var response = _workloadNetworksRestClient.DeletePortMirroring(Id.SubscriptionId, Id.ResourceGroupName, portMirroringId, Id.Name, cancellationToken);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeletePortMirroringRequest(Id.SubscriptionId, Id.ResourceGroupName, portMirroringId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/publicIPs/{publicIPId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{publicIPId}/{privateCloudName}</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<ArmOperation> DeletePublicIPWorkloadNetworkAsync(WaitUntil waitUntil, string publicIPId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(publicIPId, nameof(publicIPId));

            using var scope = _workloadNetworksClientDiagnostics.CreateScope("PrivateCloudResource.DeletePublicIPWorkloadNetwork");
            scope.Start();
            try
            {
                var response = await _workloadNetworksRestClient.DeletePublicIPAsync(Id.SubscriptionId, Id.ResourceGroupName, publicIPId, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeletePublicIPRequest(Id.SubscriptionId, Id.ResourceGroupName, publicIPId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <exception cref="ArgumentException"> <paramref name="publicIPId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="publicIPId"/> is null. </exception>
        public virtual ArmOperation DeletePublicIPWorkloadNetwork(WaitUntil waitUntil, string publicIPId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(publicIPId, nameof(publicIPId));
            ...
            try
            {
                var response = _workloadNetworksRestClient.DeletePublicIP(Id.SubscriptionId, Id.ResourceGroupName, publicIPId, Id.Name, cancellationToken);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeletePublicIPRequest(Id.SubscriptionId, Id.ResourceGroupName, publicIPId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/vmGroups/{vmGroupId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{vmGroupId}/{privateCloudName}</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<ArmOperation> DeleteVmGroupWorkloadNetworkAsync(WaitUntil waitUntil, string vmGroupId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(vmGroupId, nameof(vmGroupId));

            using var scope = _workloadNetworksClientDiagnostics.CreateScope("PrivateCloudResource.DeleteVmGroupWorkloadNetwork");
            scope.Start();
            try
            {
                var response = await _workloadNetworksRestClient.DeleteVmGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, vmGroupId, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeleteVmGroupRequest(Id.SubscriptionId, Id.ResourceGroupName, vmGroupId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <exception cref="ArgumentException"> <paramref name="vmGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="vmGroupId"/> is null. </exception>
        public virtual ArmOperation DeleteVmGroupWorkloadNetwork(WaitUntil waitUntil, string vmGroupId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(vmGroupId, nameof(vmGroupId));
            ...
            try
            {
                var response = _workloadNetworksRestClient.DeleteVmGroup(Id.SubscriptionId, Id.ResourceGroupName, vmGroupId, Id.Name, cancellationToken);
                var operation = new AvsArmOperation(_workloadNetworksClientDiagnostics, Pipeline, _workloadNetworksRestClient.CreateDeleteVmGroupRequest(Id.SubscriptionId, Id.ResourceGroupName, vmGroupId, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
