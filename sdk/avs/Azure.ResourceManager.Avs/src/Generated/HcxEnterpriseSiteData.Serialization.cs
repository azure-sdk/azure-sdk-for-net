...
namespace Azure.ResourceManager.Avs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HcxEnterpriseSiteData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HcxEnterpriseSiteData)} does not support writing '{format}' format.");
            }
        ...
        HcxEnterpriseSiteData IJsonModel<HcxEnterpriseSiteData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HcxEnterpriseSiteData)} does not support reading '{format}' format.");
            }
        ...
        internal static HcxEnterpriseSiteData DeserializeHcxEnterpriseSiteData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            HcxEnterpriseSiteProperties properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = HcxEnterpriseSiteProperties.DeserializeHcxEnterpriseSiteProperties(property.Value, options);
                    continue;
                }
