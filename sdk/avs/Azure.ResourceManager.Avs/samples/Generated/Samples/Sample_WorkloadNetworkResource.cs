...
namespace Azure.ResourceManager.Avs.Samples
{
    public partial class Sample_WorkloadNetworkResource
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetDhcp_WorkloadNetworksListDhcp()
        {
            ...
            await foreach (WorkloadNetworkDhcpResource item in workloadNetwork.GetDhcpAsync())
            {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateDhcp_WorkloadNetworksCreateDhcp()
        {
            ...
            ArmOperation<WorkloadNetworkDhcpResource> lro = await workloadNetwork.CreateDhcpAsync(WaitUntil.Completed, dhcpId, data);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task UpdateDhcp_WorkloadNetworksUpdateDhcp()
        {
            ...
            string dhcpId = "dhcp1";
            WorkloadNetworkDhcpData data = new WorkloadNetworkDhcpData();
            ArmOperation<WorkloadNetworkDhcpResource> lro = await workloadNetwork.UpdateDhcpAsync(WaitUntil.Completed, dhcpId, data);
            WorkloadNetworkDhcpResource result = lro.Value;
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task DeleteDhcp_WorkloadNetworksDeleteDhcp()
        {
            ...
            // invoke the operation
            string dhcpId = "dhcp1";
            await workloadNetwork.DeleteDhcpAsync(WaitUntil.Completed, dhcpId);
