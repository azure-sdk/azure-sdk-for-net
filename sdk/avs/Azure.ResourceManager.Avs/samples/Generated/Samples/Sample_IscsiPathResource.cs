...
namespace Azure.ResourceManager.Avs.Samples
{
    public partial class Sample_IscsiPathResource
    {
        ...
        public async Task Get_IscsiPathsGet()
        {
            ...
            ResourceIdentifier iscsiPathResourceId = IscsiPathResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, privateCloudName, iscsiPathName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Update_IscsiPathsCreateOrUpdate()
        {
            ...
            ArmOperation<IscsiPathResource> lro = await iscsiPath.UpdateAsync(WaitUntil.Completed, data);
