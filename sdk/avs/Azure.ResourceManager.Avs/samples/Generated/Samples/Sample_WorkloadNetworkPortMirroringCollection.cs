...
{
    public partial class Sample_WorkloadNetworkPortMirroringCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_WorkloadNetworksCreatePortMirroring()
        {
            ...
            // get the collection of this WorkloadNetworkPortMirroringResource
            WorkloadNetworkPortMirroringCollection collection = workloadNetwork.GetWorkloadNetworkPortMirrorings();

            // invoke the operation
            string portMirroringId = "portMirroring1";
            WorkloadNetworkPortMirroringData data = new WorkloadNetworkPortMirroringData();
            ArmOperation<WorkloadNetworkPortMirroringResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, portMirroringId, data);
        ...
        public async Task Get_WorkloadNetworksGetPortMirroring()
        {
            ...
            // invoke the operation
            string portMirroringId = "portMirroring1";
            WorkloadNetworkPortMirroringResource result = await collection.GetAsync(portMirroringId);
        ...
        public async Task GetAll_WorkloadNetworksListPortMirroring()
        {
            ...
            await foreach (WorkloadNetworkPortMirroringResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                WorkloadNetworkPortMirroringData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_WorkloadNetworksGetPortMirroring()
        {
            ...
            // invoke the operation
            string portMirroringId = "portMirroring1";
            NullableResponse<WorkloadNetworkPortMirroringResource> response = await collection.GetIfExistsAsync(portMirroringId);
            WorkloadNetworkPortMirroringResource result = response.HasValue ? response.Value : null;
