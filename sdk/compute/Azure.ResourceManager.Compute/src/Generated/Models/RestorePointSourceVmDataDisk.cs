...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class RestorePointSourceVmDataDisk
    {
        ...
        internal RestorePointSourceVmDataDisk(int? lun, string name, CachingType? caching, int? diskSizeGB, VirtualMachineManagedDisk managedDisk, WritableSubResource diskRestorePoint, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Lun = lun;
            Name = name;
            Caching = caching;
