...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineRunCommandUpdate : ComputeResourcePatch
    {
        ...
        internal VirtualMachineRunCommandUpdate(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, VirtualMachineRunCommandScriptSource source, IList<RunCommandInputParameter> parameters, IList<RunCommandInputParameter> protectedParameters, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, Uri outputBlobUri, Uri errorBlobUri, string provisioningState, VirtualMachineRunCommandInstanceView instanceView) : base(tags, serializedAdditionalRawData)
        {
            Source = source;
