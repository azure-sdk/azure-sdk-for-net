...
{
    public partial class RedeployNotificationProfile : IUtf8JsonSerializable
    {
        ...
        internal static RedeployNotificationProfile DeserializeRedeployNotificationProfile(JsonElement element)
        {
            ...
            return new RedeployNotificationProfile(notBeforeTimeout.Value, Optional.ToNullable(enable));
        }
    }
}
