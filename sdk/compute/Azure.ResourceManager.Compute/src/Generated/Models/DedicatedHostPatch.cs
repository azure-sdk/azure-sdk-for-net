...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class DedicatedHostPatch : ComputeResourcePatch
    {
        ...
        internal DedicatedHostPatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, int? platformFaultDomain, bool? autoReplaceOnFailure, string hostId, IReadOnlyList<SubResource> virtualMachines, DedicatedHostLicenseType? licenseType, DateTimeOffset? provisioningOn, string provisioningState, DedicatedHostInstanceView instanceView, DateTimeOffset? timeCreated) : base(tags, serializedAdditionalRawData)
        {
