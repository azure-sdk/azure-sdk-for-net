...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryTargetExtendedLocation
    {
        ...
        internal GalleryTargetExtendedLocation(string name, GalleryExtendedLocation extendedLocation, int? extendedLocationReplicaCount, ImageStorageAccountType? galleryStorageAccountType, EncryptionImages encryption)
        {
            Name = name;
