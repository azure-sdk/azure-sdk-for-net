...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class AutomaticOSUpgradePolicy
    {
        ...
        /// <param name="osRollingUpgradeDeferral"> Indicates whether Auto OS Upgrade should undergo deferral. Deferred OS upgrades will send advanced notifications on a per-VM basis that an OS upgrade from rolling upgrades is incoming, via IMDS. The upgrade then defers until the upgrade is invoked via an InvokeUpgrade call. </param>
        ...
        /// <summary> Indicates whether Auto OS Upgrade should undergo deferral. Deferred OS upgrades will send advanced notifications on a per-VM basis that an OS upgrade from rolling upgrades is incoming, via IMDS. The upgrade then defers until the upgrade is invoked via an InvokeUpgrade call. </summary>
