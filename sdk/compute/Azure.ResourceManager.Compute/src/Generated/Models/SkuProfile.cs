...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class SkuProfile
    {
        ...
        /// <param name="allocationStrategy"> Species the allocation strategy for the virtual machine scale set based on which the VMs will be allocated. </param>
        ...
        /// <summary> Species the allocation strategy for the virtual machine scale set based on which the VMs will be allocated. </summary>
