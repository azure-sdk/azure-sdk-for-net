...
{
    public partial class RebootNotificationProfile : IUtf8JsonSerializable
    {
        ...
        internal static RebootNotificationProfile DeserializeRebootNotificationProfile(JsonElement element)
        {
            ...
            return new RebootNotificationProfile(notBeforeTimeout.Value, Optional.ToNullable(enable));
        }
    }
}
