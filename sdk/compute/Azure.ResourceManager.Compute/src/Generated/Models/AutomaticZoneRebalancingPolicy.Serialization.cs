...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class AutomaticZoneRebalancingPolicy : IUtf8JsonSerializable, IJsonModel<AutomaticZoneRebalancingPolicy>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutomaticExpansionPolicy))
            {
                writer.WritePropertyName("automaticExpansionPolicy"u8);
                writer.WriteObjectValue(AutomaticExpansionPolicy, options);
            }
        ...
        internal static AutomaticZoneRebalancingPolicy DeserializeAutomaticZoneRebalancingPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AutomaticExpansionPolicy automaticExpansionPolicy = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("automaticExpansionPolicy"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    automaticExpansionPolicy = AutomaticExpansionPolicy.DeserializeAutomaticExpansionPolicy(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new AutomaticZoneRebalancingPolicy(enabled, rebalanceStrategy, rebalanceBehavior, automaticExpansionPolicy, serializedAdditionalRawData);
        }
