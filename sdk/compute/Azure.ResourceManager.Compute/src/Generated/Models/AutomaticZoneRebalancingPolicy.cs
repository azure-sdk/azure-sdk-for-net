...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class AutomaticZoneRebalancingPolicy
    {
        ...
        /// <param name="automaticExpansionPolicy"> Optional property used for performing automatic expansion. If defined, the scale set will grow to minTargetZonalInstanceCount. Until then, automatic rebalancing will not take effect. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal AutomaticZoneRebalancingPolicy(bool? enabled, RebalanceStrategy? rebalanceStrategy, RebalanceBehavior? rebalanceBehavior, AutomaticExpansionPolicy automaticExpansionPolicy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
        ...
        /// <summary> Optional property used for performing automatic expansion. If defined, the scale set will grow to minTargetZonalInstanceCount. Until then, automatic rebalancing will not take effect. </summary>
        internal AutomaticExpansionPolicy AutomaticExpansionPolicy { get; set; }
        /// <summary> Specifies the minimum number of zonal VMs that will be gradually provisioned to the scale set. </summary>
        public int? AutomaticExpansionMinTargetZonalInstanceCount
        {
            get => AutomaticExpansionPolicy is null ? default : AutomaticExpansionPolicy.MinTargetZonalInstanceCount;
            set
            {
                if (AutomaticExpansionPolicy is null)
                    AutomaticExpansionPolicy = new AutomaticExpansionPolicy();
                AutomaticExpansionPolicy.MinTargetZonalInstanceCount = value;
            }
        }
    }
}
