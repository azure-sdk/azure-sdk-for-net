...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _softDeleteClientDiagnostics;
        private readonly SoftDeleteRestOperations _softDeleteRestClient;
        ...
        internal GalleryResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _softDeleteClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Compute", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _softDeleteRestClient = new SoftDeleteRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SoftDelete_ListSoftDeletedResourcesByArtifactName</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-03-03</description>
        ...
        public virtual AsyncPageable<GallerySoftDeletedResource> GetSoftDeletedResourcesByArtifactNameSoftDeletesAsync(string artifactType, string artifactName, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => _softDeleteRestClient.CreateListSoftDeletedResourcesByArtifactNameRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, artifactType, artifactName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _softDeleteRestClient.CreateListSoftDeletedResourcesByArtifactNameNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, artifactType, artifactName);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => GallerySoftDeletedResource.DeserializeGallerySoftDeletedResource(e), _softDeleteClientDiagnostics, Pipeline, "GalleryResource.GetSoftDeletedResourcesByArtifactNameSoftDeletes", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<GallerySoftDeletedResource> GetSoftDeletedResourcesByArtifactNameSoftDeletes(string artifactType, string artifactName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(artifactType, nameof(artifactType));
            Argument.AssertNotNullOrEmpty(artifactName, nameof(artifactName));
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => _softDeleteRestClient.CreateListSoftDeletedResourcesByArtifactNameRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, artifactType, artifactName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _softDeleteRestClient.CreateListSoftDeletedResourcesByArtifactNameNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, artifactType, artifactName);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => GallerySoftDeletedResource.DeserializeGallerySoftDeletedResource(e), _softDeleteClientDiagnostics, Pipeline, "GalleryResource.GetSoftDeletedResourcesByArtifactNameSoftDeletes", "value", "nextLink", cancellationToken);
        }
