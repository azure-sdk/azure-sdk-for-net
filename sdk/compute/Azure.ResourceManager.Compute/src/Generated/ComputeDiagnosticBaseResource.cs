...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class ComputeDiagnosticBaseResource : ArmResource
    {
        ...
        {
            _computeDiagnosticBaseSpotPlacementScoresClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Compute", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string computeDiagnosticBaseSpotPlacementScoresApiVersion);
        ...
        {
            using var scope = _computeDiagnosticBaseSpotPlacementScoresClientDiagnostics.CreateScope("ComputeDiagnosticBaseResource.Get");
            scope.Start();
            try
            {
                var response = await _computeDiagnosticBaseSpotPlacementScoresRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ComputeDiagnosticBaseResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _computeDiagnosticBaseSpotPlacementScoresRestClient.Get(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ComputeDiagnosticBaseResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SpotPlacementScores_Post</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-06-01</description>
        ...
        public virtual async Task<Response<SpotPlacementScoresResponse>> PostAsync(SpotPlacementScoresContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _computeDiagnosticBaseSpotPlacementScoresClientDiagnostics.CreateScope("ComputeDiagnosticBaseResource.Post");
            scope.Start();
            try
            {
                var response = await _computeDiagnosticBaseSpotPlacementScoresRestClient.PostAsync(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<SpotPlacementScoresResponse> Post(SpotPlacementScoresContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _computeDiagnosticBaseSpotPlacementScoresRestClient.Post(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
