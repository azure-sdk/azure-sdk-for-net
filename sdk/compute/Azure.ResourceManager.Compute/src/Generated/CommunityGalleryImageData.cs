...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class CommunityGalleryImageData : PirCommunityGalleryResourceData
    {
        ...
        /// <param name="osType"> This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. The possible values are: **Windows,** **Linux**. </param>
        ...
        /// <summary> This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. The possible values are: **Windows,** **Linux**. </summary>
