...
{
    public partial class ComputeDiagnosticBaseData : IUtf8JsonSerializable, IJsonModel<ComputeDiagnosticBaseData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeDiagnosticBaseData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ComputeDiagnosticBaseData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ComputeDiagnosticBaseData IJsonModel<ComputeDiagnosticBaseData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ComputeDiagnosticBaseData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ComputeDiagnosticBaseData DeserializeComputeDiagnosticBaseData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ComputeDiagnosticBaseData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ComputeDiagnosticBaseData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ComputeDiagnosticBaseData IPersistableModel<ComputeDiagnosticBaseData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ComputeDiagnosticBaseData>)this).GetFormatFromOptions(options) : options.Format;
