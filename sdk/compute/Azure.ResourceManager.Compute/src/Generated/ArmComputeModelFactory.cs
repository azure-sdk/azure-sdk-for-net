...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public static partial class ArmComputeModelFactory
    {
        ...
        {
            return new VirtualMachineDataDisk(lun, name, vhdUri != null ? new VirtualHardDisk(vhdUri, serializedAdditionalRawData: null) : null, imageUri != null ? new VirtualHardDisk(imageUri, serializedAdditionalRawData: null) : null, caching, writeAcceleratorEnabled, createOption, diskSizeGB, managedDisk, sourceResourceId != null ? ResourceManagerModelFactory.WritableSubResource(sourceResourceId) : null, toBeDetached, diskIopsReadWrite, diskMBpsReadWrite, detachOption, deleteOption, serializedAdditionalRawData: null);
        }
        ...
        {
            return new DataDisksToAttach(diskId, lun, caching, deleteOption, diskEncryptionSetId != null ? ResourceManagerModelFactory.WritableSubResource(diskEncryptionSetId) : null, writeAcceleratorEnabled, serializedAdditionalRawData: null);
        }
        ...
        /// <param name="identity"> The identity of the virtual machine, if configured. </param>
        /// <param name="zones"> The virtual machine zones. </param>
        /// <param name="placement"> Placement section specifies the user-defined constraints for virtual machine hardware placement.&lt;br&gt; Minimum api-version: 2024-03-01. </param>
