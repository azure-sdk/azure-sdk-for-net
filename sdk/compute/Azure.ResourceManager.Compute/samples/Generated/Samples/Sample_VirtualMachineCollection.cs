...
Id = new ResourceIdentifier("/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkInterfaces/{existing-nic-name}"),
        ...
        // Create a VM with ProxyAgent enabled and configured host endpoint access control.
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_CreateAVMWithProxyAgentEnabledAndConfiguredHostEndpointAccessControl()
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/ComputeRP/stable/2024-03-01/examples/virtualMachineExamples/VirtualMachine_Create_WithProxyAgentEnabledAndConfiguredAuthRules.json
            // this example is just showing the usage of "VirtualMachines_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
...
Id = new ResourceIdentifier("/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkInterfaces/{existing-nic-name}"),
                ...
                SecurityProfile = new SecurityProfile()
                {
                    ...
                    {
                        Enabled = true,
                        Imds = new ProxyAgentSettingsImds()
                        {
                            AccessControlProfile = new ProxyAgentSettingsImdsAccessControlProfile()
                            {
                                Mode = Mode.Enforce,
                                Rules =
{
["/metadata/identity"] = new RuleDefinition[]
{
new RuleDefinition()
{
Filters =
...
UserName = "testUser",
                        ...
                        Wireserver = new ProxyAgentSettingsWireserver()
                        {
                            AccessControlProfile = new ProxyAgentSettingsWireserverAccessControlProfile()
                            {
                                Mode = Mode.Audit,
                                Rules =
{
["/machine"] = new RuleDefinition[]
{
new RuleDefinition()
{
QueryParameters =
