...
namespace Azure.ResourceManager.Compute.Samples
{
    public partial class Sample_GalleryResource
    {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetSoftDeletedResourcesByArtifactNameSoftDeletes_ListSoftDeletedResourcesOfAnArtifactInTheGallery()
        {
            ...
            // this example is just showing the usage of "SoftDelete_ListSoftDeletedResourcesByArtifactName" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (GallerySoftDeletedResource item in gallery.GetSoftDeletedResourcesByArtifactNameSoftDeletesAsync(artifactType, artifactName))
            {
