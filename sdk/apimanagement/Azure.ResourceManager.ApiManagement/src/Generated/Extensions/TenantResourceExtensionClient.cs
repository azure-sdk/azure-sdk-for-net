...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    internal partial class TenantResourceExtensionClient : ArmResource
    {
        ...
        public virtual ApiManagementServiceCollection GetApiManagementServices(Guid subscriptionId, string resourceGroupName)
        {
            return new ApiManagementServiceCollection(Client, Id, subscriptionId, resourceGroupName);
        }
        ...
        public virtual AsyncPageable<ApiManagementDeletedServiceResource> GetApiManagementDeletedServicesAsync(Guid subscriptionId, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApiManagementDeletedServiceDeletedServicesRestClient.CreateListBySubscriptionRequest(subscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ApiManagementDeletedServiceDeletedServicesRestClient.CreateListBySubscriptionNextPageRequest(nextLink, subscriptionId);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ApiManagementDeletedServiceResource(Client, ApiManagementDeletedServiceData.DeserializeApiManagementDeletedServiceData(e)), ApiManagementDeletedServiceDeletedServicesClientDiagnostics, Pipeline, "TenantResourceExtensionClient.GetApiManagementDeletedServices", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ApiManagementDeletedServiceResource> GetApiManagementDeletedServices(Guid subscriptionId, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApiManagementDeletedServiceDeletedServicesRestClient.CreateListBySubscriptionRequest(subscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ApiManagementDeletedServiceDeletedServicesRestClient.CreateListBySubscriptionNextPageRequest(nextLink, subscriptionId);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApiManagementServiceRestClient.CreateListRequest(Guid.Parse(_subscriptionId));
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ApiManagementServiceRestClient.CreateListNextPageRequest(nextLink, Guid.Parse(_subscriptionId));
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ApiManagementServiceResource(Client, ApiManagementServiceData.DeserializeApiManagementServiceData(e)), ApiManagementServiceClientDiagnostics, Pipeline, "TenantResourceExtensionClient.GetApiManagementServices", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = ApiManagementServiceClientDiagnostics.CreateScope("TenantResourceExtensionClient.CheckApiManagementServiceNameAvailability");
            scope.Start();
            try
            {
                var response = await ApiManagementServiceRestClient.CheckNameAvailabilityAsync(Guid.Parse(_subscriptionId), content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ApiManagementServiceNameAvailabilityResult> CheckApiManagementServiceNameAvailability(ApiManagementServiceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = ApiManagementServiceRestClient.CheckNameAvailability(Guid.Parse(_subscriptionId), content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = ApiManagementServiceClientDiagnostics.CreateScope("TenantResourceExtensionClient.GetApiManagementServiceDomainOwnershipIdentifier");
            scope.Start();
            try
            {
                var response = await ApiManagementServiceRestClient.GetDomainOwnershipIdentifierAsync(Guid.Parse(_subscriptionId), cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ApiManagementServiceGetDomainOwnershipIdentifierResult> GetApiManagementServiceDomainOwnershipIdentifier(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = ApiManagementServiceRestClient.GetDomainOwnershipIdentifier(Guid.Parse(_subscriptionId), cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<ApiManagementSku> GetApiManagementSkusAsync(Guid subscriptionId, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApiManagementSkusRestClient.CreateListRequest(subscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ApiManagementSkusRestClient.CreateListNextPageRequest(nextLink, subscriptionId);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ApiManagementSku.DeserializeApiManagementSku, ApiManagementSkusClientDiagnostics, Pipeline, "TenantResourceExtensionClient.GetApiManagementSkus", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ApiManagementSku> GetApiManagementSkus(Guid subscriptionId, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApiManagementSkusRestClient.CreateListRequest(subscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ApiManagementSkusRestClient.CreateListNextPageRequest(nextLink, subscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ApiManagementSku.DeserializeApiManagementSku, ApiManagementSkusClientDiagnostics, Pipeline, "TenantResourceExtensionClient.GetApiManagementSkus", "value", "nextLink", cancellationToken);
        }
    }
}
