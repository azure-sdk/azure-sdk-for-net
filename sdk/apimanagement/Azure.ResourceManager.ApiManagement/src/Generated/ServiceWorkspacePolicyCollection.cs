...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspacePolicyCollection : ArmCollection, IEnumerable<ServiceWorkspacePolicyResource>, IAsyncEnumerable<ServiceWorkspacePolicyResource>
    {
        ...
        public virtual AsyncPageable<ServiceWorkspacePolicyResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new ServiceWorkspacePolicyResource(Client, PolicyContractData.DeserializePolicyContractData(e)), _serviceWorkspacePolicyWorkspacePolicyClientDiagnostics, Pipeline, "ServiceWorkspacePolicyCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceWorkspacePolicyWorkspacePolicyRestClient.CreateListByApiRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new ServiceWorkspacePolicyResource(Client, PolicyContractData.DeserializePolicyContractData(e)), _serviceWorkspacePolicyWorkspacePolicyClientDiagnostics, Pipeline, "ServiceWorkspacePolicyCollection.GetAll", "value", null, cancellationToken);
        }
