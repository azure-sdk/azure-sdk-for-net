...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementBackendData : ResourceData
    {
        ...
        internal ApiManagementBackendData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string title, string description, Uri resourceUri, BackendProperties properties, BackendCredentialsContract credentials, BackendProxyContract proxy, BackendTlsProperties tls, BackendCircuitBreaker circuitBreaker, BackendBaseParametersPool pool, BackendBaseParametersType? typePropertiesType, Uri uri, BackendProtocol? protocol) : base(id, name, resourceType, systemData)
        {
            Title = title;
        ...
        public BackendBaseParametersType? TypePropertiesType { get; set; }
