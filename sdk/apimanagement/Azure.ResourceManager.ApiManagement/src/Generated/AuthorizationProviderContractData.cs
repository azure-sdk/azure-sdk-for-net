...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationProviderContractData : ResourceData
    {
        ...
        internal AuthorizationProviderContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, string identityProvider, AuthorizationProviderOAuth2Settings oauth2, BinaryData credentials) : base(id, name, resourceType, systemData)
        {
        ...
        /// </para>
        /// </summary>
        public BinaryData Credentials { get; set; }
    }
}
