...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceGroupCollection : ArmCollection, IEnumerable<ServiceWorkspaceGroupResource>, IAsyncEnumerable<ServiceWorkspaceGroupResource>
    {
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string groupId, GroupCreateParameters groupCreateParameters, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceGroupWorkspaceGroupRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupId, groupCreateParameters, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ServiceWorkspaceGroupResource> CreateOrUpdate(WaitUntil waitUntil, string groupId, GroupCreateParameters groupCreateParameters, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceGroupWorkspaceGroupRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupId, groupCreateParameters, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<ServiceWorkspaceGroupResource>(Response.FromValue(new ServiceWorkspaceGroupResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ServiceWorkspaceGroupResource>> GetAsync(string groupId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceGroupWorkspaceGroupRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServiceWorkspaceGroupResource> Get(string groupId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceGroupWorkspaceGroupRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceWorkspaceGroupResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceWorkspaceGroupWorkspaceGroupRestClient.CreateListByServiceRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceWorkspaceGroupWorkspaceGroupRestClient.CreateListByServiceNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceWorkspaceGroupResource(Client, ApiManagementGroupData.DeserializeApiManagementGroupData(e)), _serviceWorkspaceGroupWorkspaceGroupClientDiagnostics, Pipeline, "ServiceWorkspaceGroupCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceWorkspaceGroupResource> GetAll(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceWorkspaceGroupWorkspaceGroupRestClient.CreateListByServiceRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceWorkspaceGroupWorkspaceGroupRestClient.CreateListByServiceNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceWorkspaceGroupResource(Client, ApiManagementGroupData.DeserializeApiManagementGroupData(e)), _serviceWorkspaceGroupWorkspaceGroupClientDiagnostics, Pipeline, "ServiceWorkspaceGroupCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string groupId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceGroupWorkspaceGroupRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string groupId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceGroupWorkspaceGroupRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
