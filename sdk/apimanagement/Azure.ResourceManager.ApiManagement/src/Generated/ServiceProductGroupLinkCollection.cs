...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceProductGroupLinkCollection : ArmCollection, IEnumerable<ServiceProductGroupLinkResource>, IAsyncEnumerable<ServiceProductGroupLinkResource>
    {
        ...
        public virtual async Task<ArmOperation<ServiceProductGroupLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string groupLinkId, ProductGroupLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceProductGroupLinkProductGroupLinkRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupLinkId, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ServiceProductGroupLinkResource> CreateOrUpdate(WaitUntil waitUntil, string groupLinkId, ProductGroupLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceProductGroupLinkProductGroupLinkRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupLinkId, data, cancellationToken);
                var operation = new ApiManagementArmOperation<ServiceProductGroupLinkResource>(Response.FromValue(new ServiceProductGroupLinkResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ServiceProductGroupLinkResource>> GetAsync(string groupLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceProductGroupLinkProductGroupLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupLinkId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServiceProductGroupLinkResource> Get(string groupLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceProductGroupLinkProductGroupLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupLinkId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceProductGroupLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceProductGroupLinkProductGroupLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceProductGroupLinkProductGroupLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceProductGroupLinkResource(Client, ProductGroupLinkContractData.DeserializeProductGroupLinkContractData(e)), _serviceProductGroupLinkProductGroupLinkClientDiagnostics, Pipeline, "ServiceProductGroupLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceProductGroupLinkResource> GetAll(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceProductGroupLinkProductGroupLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceProductGroupLinkProductGroupLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceProductGroupLinkResource(Client, ProductGroupLinkContractData.DeserializeProductGroupLinkContractData(e)), _serviceProductGroupLinkProductGroupLinkClientDiagnostics, Pipeline, "ServiceProductGroupLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string groupLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceProductGroupLinkProductGroupLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupLinkId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string groupLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceProductGroupLinkProductGroupLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, groupLinkId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
