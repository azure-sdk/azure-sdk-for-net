...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceTagApiLinkCollection : ArmCollection, IEnumerable<ServiceWorkspaceTagApiLinkResource>, IAsyncEnumerable<ServiceWorkspaceTagApiLinkResource>
    {
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceTagApiLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string apiLinkId, TagApiLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ServiceWorkspaceTagApiLinkResource> CreateOrUpdate(WaitUntil waitUntil, string apiLinkId, TagApiLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, data, cancellationToken);
                var operation = new ApiManagementArmOperation<ServiceWorkspaceTagApiLinkResource>(Response.FromValue(new ServiceWorkspaceTagApiLinkResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ServiceWorkspaceTagApiLinkResource>> GetAsync(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServiceWorkspaceTagApiLinkResource> Get(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceWorkspaceTagApiLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceWorkspaceTagApiLinkResource(Client, TagApiLinkContractData.DeserializeTagApiLinkContractData(e)), _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkClientDiagnostics, Pipeline, "ServiceWorkspaceTagApiLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceWorkspaceTagApiLinkResource> GetAll(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceWorkspaceTagApiLinkResource(Client, TagApiLinkContractData.DeserializeTagApiLinkContractData(e)), _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkClientDiagnostics, Pipeline, "ServiceWorkspaceTagApiLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceTagApiLinkWorkspaceTagApiLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
