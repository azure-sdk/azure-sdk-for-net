...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementPortalSignInSettingResource : ArmResource
    {
        ...
        public virtual async Task<Response<ApiManagementPortalSignInSettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _apiManagementPortalSignInSettingSignInSettingsRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ApiManagementPortalSignInSettingResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementPortalSignInSettingSignInSettingsRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ApiManagementPortalSignInSettingResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response> UpdateAsync(ETag ifMatch, ApiManagementPortalSignInSettingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _apiManagementPortalSignInSettingSignInSettingsRestClient.UpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, ifMatch, data, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Update(ETag ifMatch, ApiManagementPortalSignInSettingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementPortalSignInSettingSignInSettingsRestClient.Update(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, ifMatch, data, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<ArmOperation<ApiManagementPortalSignInSettingResource>> CreateOrUpdateAsync(WaitUntil waitUntil, ApiManagementPortalSignInSettingData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _apiManagementPortalSignInSettingSignInSettingsRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, data, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ApiManagementPortalSignInSettingResource> CreateOrUpdate(WaitUntil waitUntil, ApiManagementPortalSignInSettingData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementPortalSignInSettingSignInSettingsRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, data, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<ApiManagementPortalSignInSettingResource>(Response.FromValue(new ApiManagementPortalSignInSettingResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<bool>> GetEntityTagAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _apiManagementPortalSignInSettingSignInSettingsRestClient.GetEntityTagAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> GetEntityTag(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementPortalSignInSettingSignInSettingsRestClient.GetEntityTag(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
