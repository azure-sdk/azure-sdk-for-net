...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceTagApiLinkCollection : ArmCollection, IEnumerable<ServiceTagApiLinkResource>, IAsyncEnumerable<ServiceTagApiLinkResource>
    {
        ...
        public virtual async Task<ArmOperation<ServiceTagApiLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string apiLinkId, TagApiLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceTagApiLinkTagApiLinkRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ServiceTagApiLinkResource> CreateOrUpdate(WaitUntil waitUntil, string apiLinkId, TagApiLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceTagApiLinkTagApiLinkRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, data, cancellationToken);
                var operation = new ApiManagementArmOperation<ServiceTagApiLinkResource>(Response.FromValue(new ServiceTagApiLinkResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ServiceTagApiLinkResource>> GetAsync(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceTagApiLinkTagApiLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServiceTagApiLinkResource> Get(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceTagApiLinkTagApiLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceTagApiLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceTagApiLinkTagApiLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceTagApiLinkTagApiLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceTagApiLinkResource(Client, TagApiLinkContractData.DeserializeTagApiLinkContractData(e)), _serviceTagApiLinkTagApiLinkClientDiagnostics, Pipeline, "ServiceTagApiLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceTagApiLinkResource> GetAll(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceTagApiLinkTagApiLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceTagApiLinkTagApiLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceTagApiLinkResource(Client, TagApiLinkContractData.DeserializeTagApiLinkContractData(e)), _serviceTagApiLinkTagApiLinkClientDiagnostics, Pipeline, "ServiceTagApiLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceTagApiLinkTagApiLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceTagApiLinkTagApiLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
