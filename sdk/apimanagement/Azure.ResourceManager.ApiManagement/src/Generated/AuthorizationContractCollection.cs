...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationContractCollection : ArmCollection, IEnumerable<AuthorizationContractResource>, IAsyncEnumerable<AuthorizationContractResource>
    {
        ...
        public virtual async Task<ArmOperation<AuthorizationContractResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string authorizationId, AuthorizationContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationContractAuthorizationRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationId, data, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<AuthorizationContractResource> CreateOrUpdate(WaitUntil waitUntil, string authorizationId, AuthorizationContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationContractAuthorizationRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationId, data, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<AuthorizationContractResource>(Response.FromValue(new AuthorizationContractResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<AuthorizationContractResource>> GetAsync(string authorizationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationContractAuthorizationRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AuthorizationContractResource> Get(string authorizationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationContractAuthorizationRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AuthorizationContractResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _authorizationContractAuthorizationRestClient.CreateListByAuthorizationProviderRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _authorizationContractAuthorizationRestClient.CreateListByAuthorizationProviderNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string authorizationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationContractAuthorizationRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string authorizationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationContractAuthorizationRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
