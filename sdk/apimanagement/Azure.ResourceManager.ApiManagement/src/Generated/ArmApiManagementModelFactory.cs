...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public static partial class ArmApiManagementModelFactory
    {
        ...
        /// <param name="tenantId"> Tenant ID that the Authorization can be used within. </param>
        ...
        public static AuthorizationContractData AuthorizationContractData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AuthorizationType? authorizationType = null, OAuth2GrantType? oAuth2GrantType = null, IDictionary<string, string> parameters = null, Guid? tenantId = null, AuthorizationError error = null, string status = null)
        {
            parameters ??= new Dictionary<string, string>();

            return new AuthorizationContractData(id, name, resourceType, systemData, authorizationType, oAuth2GrantType, parameters, tenantId, error, status);
        }
