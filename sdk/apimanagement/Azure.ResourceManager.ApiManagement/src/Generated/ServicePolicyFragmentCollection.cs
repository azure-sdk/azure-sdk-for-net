...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServicePolicyFragmentCollection : ArmCollection, IEnumerable<ServicePolicyFragmentResource>, IAsyncEnumerable<ServicePolicyFragmentResource>
    {
        ...
        public virtual async Task<ArmOperation<ServicePolicyFragmentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string id, PolicyFragmentContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _servicePolicyFragmentPolicyFragmentRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, id, data, ifMatch, cancellationToken).ConfigureAwait(false);
                var operation = new ApiManagementArmOperation<ServicePolicyFragmentResource>(new ServicePolicyFragmentOperationSource(Client), _servicePolicyFragmentPolicyFragmentClientDiagnostics, Pipeline, _servicePolicyFragmentPolicyFragmentRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, id, data, ifMatch).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation<ServicePolicyFragmentResource> CreateOrUpdate(WaitUntil waitUntil, string id, PolicyFragmentContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _servicePolicyFragmentPolicyFragmentRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, id, data, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<ServicePolicyFragmentResource>(new ServicePolicyFragmentOperationSource(Client), _servicePolicyFragmentPolicyFragmentClientDiagnostics, Pipeline, _servicePolicyFragmentPolicyFragmentRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, id, data, ifMatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ServicePolicyFragmentResource>> GetAsync(string id, PolicyFragmentContentFormat? format = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _servicePolicyFragmentPolicyFragmentRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, id, format, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServicePolicyFragmentResource> Get(string id, PolicyFragmentContentFormat? format = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _servicePolicyFragmentPolicyFragmentRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, id, format, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServicePolicyFragmentResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _servicePolicyFragmentPolicyFragmentRestClient.CreateListByServiceRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, filter, orderBy, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _servicePolicyFragmentPolicyFragmentRestClient.CreateListByServiceNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, filter, orderBy, top, skip);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServicePolicyFragmentResource(Client, PolicyFragmentContractData.DeserializePolicyFragmentContractData(e)), _servicePolicyFragmentPolicyFragmentClientDiagnostics, Pipeline, "ServicePolicyFragmentCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServicePolicyFragmentResource> GetAll(string filter = null, string orderBy = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _servicePolicyFragmentPolicyFragmentRestClient.CreateListByServiceRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, filter, orderBy, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _servicePolicyFragmentPolicyFragmentRestClient.CreateListByServiceNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, filter, orderBy, top, skip);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServicePolicyFragmentResource(Client, PolicyFragmentContractData.DeserializePolicyFragmentContractData(e)), _servicePolicyFragmentPolicyFragmentClientDiagnostics, Pipeline, "ServicePolicyFragmentCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string id, PolicyFragmentContentFormat? format = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _servicePolicyFragmentPolicyFragmentRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, id, format, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string id, PolicyFragmentContentFormat? format = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _servicePolicyFragmentPolicyFragmentRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, id, format, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
