...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceTagProductLinkResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(Guid subscriptionId, string resourceGroupName, string serviceName, string workspaceId, string tagId, string productLinkId)
        {
        ...
        public virtual async Task<Response<ServiceWorkspaceTagProductLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceTagProductLinkWorkspaceTagProductLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServiceWorkspaceTagProductLinkResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceTagProductLinkWorkspaceTagProductLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceWorkspaceTagProductLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceTagProductLinkWorkspaceTagProductLinkRestClient.DeleteAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceTagProductLinkWorkspaceTagProductLinkRestClient.Delete(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new ApiManagementArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceTagProductLinkResource>> UpdateAsync(WaitUntil waitUntil, TagProductLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceTagProductLinkWorkspaceTagProductLinkRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ServiceWorkspaceTagProductLinkResource> Update(WaitUntil waitUntil, TagProductLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceTagProductLinkWorkspaceTagProductLinkRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new ApiManagementArmOperation<ServiceWorkspaceTagProductLinkResource>(Response.FromValue(new ServiceWorkspaceTagProductLinkResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
