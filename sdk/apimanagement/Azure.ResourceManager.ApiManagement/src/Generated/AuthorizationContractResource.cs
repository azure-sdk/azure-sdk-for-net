...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationContractResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(Guid subscriptionId, string resourceGroupName, string serviceName, string authorizationProviderId, string authorizationId)
        {
        ...
        public virtual async Task<Response<AuthorizationContractResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationContractAuthorizationRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AuthorizationContractResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationContractAuthorizationRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AuthorizationContractResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, ETag ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationContractAuthorizationRestClient.DeleteAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, ETag ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationContractAuthorizationRestClient.Delete(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<AuthorizationContractResource>> UpdateAsync(WaitUntil waitUntil, AuthorizationContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationContractAuthorizationRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<AuthorizationContractResource> Update(WaitUntil waitUntil, AuthorizationContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationContractAuthorizationRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<AuthorizationContractResource>(Response.FromValue(new AuthorizationContractResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response> ConfirmConsentCodeAsync(AuthorizationConfirmConsentCodeRequestContract authorizationConfirmConsentCodeRequestContract, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationContractAuthorizationRestClient.ConfirmConsentCodeAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationConfirmConsentCodeRequestContract, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response ConfirmConsentCode(AuthorizationConfirmConsentCodeRequestContract authorizationConfirmConsentCodeRequestContract, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationContractAuthorizationRestClient.ConfirmConsentCode(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationConfirmConsentCodeRequestContract, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<AuthorizationLoginResponseContract>> PostAuthorizationLoginLinkAsync(AuthorizationLoginRequestContract authorizationLoginRequestContract, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationLoginLinksRestClient.PostAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationLoginRequestContract, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<AuthorizationLoginResponseContract> PostAuthorizationLoginLink(AuthorizationLoginRequestContract authorizationLoginRequestContract, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationLoginLinksRestClient.Post(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationLoginRequestContract, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
