...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationContractData : ResourceData
    {
        ...
        internal AuthorizationContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AuthorizationType? authorizationType, OAuth2GrantType? oAuth2GrantType, IDictionary<string, string> parameters, Guid? tenantId, AuthorizationError error, string status) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Tenant ID that the Authorization can be used within. </summary>
