...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PortalConfigContractData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PortalConfigContractData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PortalConfigContractData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PortalConfigContractData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PortalConfigContractData)} does not support '{options.Format}' format.");
            }
        }
