...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceTagProductLinkCollection : ArmCollection, IEnumerable<ServiceTagProductLinkResource>, IAsyncEnumerable<ServiceTagProductLinkResource>
    {
        ...
        public virtual async Task<ArmOperation<ServiceTagProductLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string productLinkId, TagProductLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceTagProductLinkTagProductLinkRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, productLinkId, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ServiceTagProductLinkResource> CreateOrUpdate(WaitUntil waitUntil, string productLinkId, TagProductLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceTagProductLinkTagProductLinkRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, productLinkId, data, cancellationToken);
                var operation = new ApiManagementArmOperation<ServiceTagProductLinkResource>(Response.FromValue(new ServiceTagProductLinkResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ServiceTagProductLinkResource>> GetAsync(string productLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceTagProductLinkTagProductLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, productLinkId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServiceTagProductLinkResource> Get(string productLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceTagProductLinkTagProductLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, productLinkId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceTagProductLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceTagProductLinkTagProductLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceTagProductLinkTagProductLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceTagProductLinkResource(Client, TagProductLinkContractData.DeserializeTagProductLinkContractData(e)), _serviceTagProductLinkTagProductLinkClientDiagnostics, Pipeline, "ServiceTagProductLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceTagProductLinkResource> GetAll(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceTagProductLinkTagProductLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceTagProductLinkTagProductLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceTagProductLinkResource(Client, TagProductLinkContractData.DeserializeTagProductLinkContractData(e)), _serviceTagProductLinkTagProductLinkClientDiagnostics, Pipeline, "ServiceTagProductLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string productLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceTagProductLinkTagProductLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, productLinkId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string productLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceTagProductLinkTagProductLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, productLinkId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
