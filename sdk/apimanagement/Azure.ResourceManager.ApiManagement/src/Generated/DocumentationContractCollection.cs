...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class DocumentationContractCollection : ArmCollection, IEnumerable<DocumentationContractResource>, IAsyncEnumerable<DocumentationContractResource>
    {
        ...
        public virtual async Task<ArmOperation<DocumentationContractResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string documentationId, DocumentationContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _documentationContractDocumentationRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, documentationId, data, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<DocumentationContractResource> CreateOrUpdate(WaitUntil waitUntil, string documentationId, DocumentationContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _documentationContractDocumentationRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, documentationId, data, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<DocumentationContractResource>(Response.FromValue(new DocumentationContractResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<DocumentationContractResource>> GetAsync(string documentationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _documentationContractDocumentationRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, documentationId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DocumentationContractResource> Get(string documentationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _documentationContractDocumentationRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, documentationId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DocumentationContractResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _documentationContractDocumentationRestClient.CreateListByServiceRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _documentationContractDocumentationRestClient.CreateListByServiceNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, filter, top, skip);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string documentationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _documentationContractDocumentationRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, documentationId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string documentationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _documentationContractDocumentationRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, documentationId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
