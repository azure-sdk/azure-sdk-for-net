...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyFragmentContractData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PolicyFragmentContractData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PolicyFragmentContractData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PolicyFragmentContractData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PolicyFragmentContractData)} does not support '{options.Format}' format.");
            }
        }
