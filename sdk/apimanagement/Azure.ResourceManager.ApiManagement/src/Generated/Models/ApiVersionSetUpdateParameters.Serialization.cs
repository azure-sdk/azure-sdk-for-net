...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiVersionSetUpdateParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApiVersionSetUpdateParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiVersionSetUpdateParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApiVersionSetUpdateParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiVersionSetUpdateParameters)} does not support '{options.Format}' format.");
            }
        }
