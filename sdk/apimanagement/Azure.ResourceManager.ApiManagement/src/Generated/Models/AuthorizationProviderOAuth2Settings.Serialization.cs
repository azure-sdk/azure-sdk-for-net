...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizationProviderOAuth2Settings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AuthorizationProviderOAuth2Settings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AuthorizationProviderOAuth2Settings)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AuthorizationProviderOAuth2Settings>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AuthorizationProviderOAuth2Settings)} does not support '{options.Format}' format.");
            }
        }
