...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CircuitBreakerRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CircuitBreakerRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CircuitBreakerRule)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CircuitBreakerRule>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CircuitBreakerRule)} does not support '{options.Format}' format.");
            }
        }
