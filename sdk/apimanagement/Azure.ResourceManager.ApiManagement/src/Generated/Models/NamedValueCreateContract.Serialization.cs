...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamedValueCreateContract>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NamedValueCreateContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NamedValueCreateContract)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NamedValueCreateContract>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NamedValueCreateContract)} does not support '{options.Format}' format.");
            }
        }
