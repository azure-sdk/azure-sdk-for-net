...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizationLoginRequestContract>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AuthorizationLoginRequestContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AuthorizationLoginRequestContract)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AuthorizationLoginRequestContract>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AuthorizationLoginRequestContract)} does not support '{options.Format}' format.");
            }
        }
