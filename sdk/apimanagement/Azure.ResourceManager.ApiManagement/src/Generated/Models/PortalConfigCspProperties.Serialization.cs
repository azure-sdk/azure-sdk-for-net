...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PortalConfigCspProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PortalConfigCspProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PortalConfigCspProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PortalConfigCspProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PortalConfigCspProperties)} does not support '{options.Format}' format.");
            }
        }
