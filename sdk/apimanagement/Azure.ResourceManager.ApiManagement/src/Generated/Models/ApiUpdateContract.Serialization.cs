...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiUpdateContract>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApiUpdateContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiUpdateContract)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApiUpdateContract>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiUpdateContract)} does not support '{options.Format}' format.");
            }
        }
