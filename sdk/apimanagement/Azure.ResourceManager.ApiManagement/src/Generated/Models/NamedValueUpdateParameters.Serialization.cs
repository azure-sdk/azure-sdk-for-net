...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamedValueUpdateParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NamedValueUpdateParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NamedValueUpdateParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NamedValueUpdateParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NamedValueUpdateParameters)} does not support '{options.Format}' format.");
            }
        }
