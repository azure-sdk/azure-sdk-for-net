...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GroupCreateParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GroupCreateParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GroupCreateParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GroupCreateParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GroupCreateParameters)} does not support '{options.Format}' format.");
            }
        }
