...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductUpdateParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ProductUpdateParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProductUpdateParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ProductUpdateParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProductUpdateParameters)} does not support '{options.Format}' format.");
            }
        }
