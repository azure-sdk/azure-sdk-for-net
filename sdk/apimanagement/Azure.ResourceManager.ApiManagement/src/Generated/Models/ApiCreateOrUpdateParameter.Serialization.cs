...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiCreateOrUpdateParameter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApiCreateOrUpdateParameter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiCreateOrUpdateParameter)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApiCreateOrUpdateParameter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiCreateOrUpdateParameter)} does not support '{options.Format}' format.");
            }
        }
