...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class ResourceListResult : IUtf8JsonSerializable, IJsonModel<ResourceListResult>
    {
        ...
        internal static ResourceListResult DeserializeResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ResourceCollectionValueItem> value = default;
            long? count = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(ResourceCollectionValueItem.DeserializeResourceCollectionValueItem(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new ResourceListResult(value ?? new ChangeTrackingList<ResourceCollectionValueItem>(), count, nextLink, serializedAdditionalRawData);
        }
