...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayListDebugCredentialsContract>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GatewayListDebugCredentialsContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GatewayListDebugCredentialsContract)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GatewayListDebugCredentialsContract>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GatewayListDebugCredentialsContract)} does not support '{options.Format}' format.");
            }
        }
