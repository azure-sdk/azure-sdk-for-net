...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationUpdateContract>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OperationUpdateContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OperationUpdateContract)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OperationUpdateContract>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OperationUpdateContract)} does not support '{options.Format}' format.");
            }
        }
