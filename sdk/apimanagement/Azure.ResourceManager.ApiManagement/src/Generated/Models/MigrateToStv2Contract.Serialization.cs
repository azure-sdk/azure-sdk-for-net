...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateToStv2Contract>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MigrateToStv2Contract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateToStv2Contract)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MigrateToStv2Contract>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrateToStv2Contract)} does not support '{options.Format}' format.");
            }
        }
