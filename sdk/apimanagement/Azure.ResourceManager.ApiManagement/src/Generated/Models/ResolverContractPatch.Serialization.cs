...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResolverContractPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResolverContractPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResolverContractPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResolverContractPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResolverContractPatch)} does not support '{options.Format}' format.");
            }
        }
