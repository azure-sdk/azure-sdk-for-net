...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionUpdateParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SubscriptionUpdateParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SubscriptionUpdateParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SubscriptionUpdateParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SubscriptionUpdateParameters)} does not support '{options.Format}' format.");
            }
        }
