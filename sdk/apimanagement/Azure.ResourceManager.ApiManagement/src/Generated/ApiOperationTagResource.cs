...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiOperationTagResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(Guid subscriptionId, string resourceGroupName, string serviceName, string apiId, string operationId, string tagId)
        {
        ...
        public virtual async Task<Response<ApiOperationTagResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _apiOperationTagTagRestClient.GetByOperationAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ApiOperationTagResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiOperationTagTagRestClient.GetByOperation(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ApiOperationTagResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _apiOperationTagTagRestClient.DetachFromOperationAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiOperationTagTagRestClient.DetachFromOperation(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new ApiManagementArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<ApiOperationTagResource>> UpdateAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _apiOperationTagTagRestClient.AssignToOperationAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ApiOperationTagResource> Update(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiOperationTagTagRestClient.AssignToOperation(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new ApiManagementArmOperation<ApiOperationTagResource>(Response.FromValue(new ApiOperationTagResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<bool>> GetEntityStateByOperationAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _apiOperationTagTagRestClient.GetEntityStateByOperationAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> GetEntityStateByOperation(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiOperationTagTagRestClient.GetEntityStateByOperation(Guid.Parse(Id.Parent.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
