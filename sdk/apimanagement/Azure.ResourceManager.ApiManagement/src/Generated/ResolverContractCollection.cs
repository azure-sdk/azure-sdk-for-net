...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ResolverContractCollection : ArmCollection, IEnumerable<ResolverContractResource>, IAsyncEnumerable<ResolverContractResource>
    {
        ...
        public virtual async Task<ArmOperation<ResolverContractResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string resolverId, ResolverContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _resolverContractGraphQLApiResolverRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, resolverId, data, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ResolverContractResource> CreateOrUpdate(WaitUntil waitUntil, string resolverId, ResolverContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _resolverContractGraphQLApiResolverRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, resolverId, data, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<ResolverContractResource>(Response.FromValue(new ResolverContractResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ResolverContractResource>> GetAsync(string resolverId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _resolverContractGraphQLApiResolverRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, resolverId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ResolverContractResource> Get(string resolverId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _resolverContractGraphQLApiResolverRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, resolverId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ResolverContractResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _resolverContractGraphQLApiResolverRestClient.CreateListByApiRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _resolverContractGraphQLApiResolverRestClient.CreateListByApiNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string resolverId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _resolverContractGraphQLApiResolverRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, resolverId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string resolverId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _resolverContractGraphQLApiResolverRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, resolverId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
