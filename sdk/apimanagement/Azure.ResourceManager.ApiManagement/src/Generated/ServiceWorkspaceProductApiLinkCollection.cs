...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceProductApiLinkCollection : ArmCollection, IEnumerable<ServiceWorkspaceProductApiLinkResource>, IAsyncEnumerable<ServiceWorkspaceProductApiLinkResource>
    {
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceProductApiLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string apiLinkId, ProductApiLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ServiceWorkspaceProductApiLinkResource> CreateOrUpdate(WaitUntil waitUntil, string apiLinkId, ProductApiLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, data, cancellationToken);
                var operation = new ApiManagementArmOperation<ServiceWorkspaceProductApiLinkResource>(Response.FromValue(new ServiceWorkspaceProductApiLinkResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ServiceWorkspaceProductApiLinkResource>> GetAsync(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServiceWorkspaceProductApiLinkResource> Get(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceWorkspaceProductApiLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceWorkspaceProductApiLinkResource(Client, ProductApiLinkContractData.DeserializeProductApiLinkContractData(e)), _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkClientDiagnostics, Pipeline, "ServiceWorkspaceProductApiLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceWorkspaceProductApiLinkResource> GetAll(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.CreateListByProductRequest(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.CreateListByProductNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceWorkspaceProductApiLinkResource(Client, ProductApiLinkContractData.DeserializeProductApiLinkContractData(e)), _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkClientDiagnostics, Pipeline, "ServiceWorkspaceProductApiLinkCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string apiLinkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceWorkspaceProductApiLinkWorkspaceProductApiLinkRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, apiLinkId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
