...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizationProviderContractData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AuthorizationProviderContractData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AuthorizationProviderContractData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AuthorizationProviderContractData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AuthorizationProviderContractData)} does not support '{options.Format}' format.");
            }
        }
