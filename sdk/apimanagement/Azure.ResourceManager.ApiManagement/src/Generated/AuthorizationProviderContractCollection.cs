...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationProviderContractCollection : ArmCollection, IEnumerable<AuthorizationProviderContractResource>, IAsyncEnumerable<AuthorizationProviderContractResource>
    {
        ...
        public virtual async Task<ArmOperation<AuthorizationProviderContractResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string authorizationProviderId, AuthorizationProviderContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationProviderContractAuthorizationProviderRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, authorizationProviderId, data, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<AuthorizationProviderContractResource> CreateOrUpdate(WaitUntil waitUntil, string authorizationProviderId, AuthorizationProviderContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationProviderContractAuthorizationProviderRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, authorizationProviderId, data, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<AuthorizationProviderContractResource>(Response.FromValue(new AuthorizationProviderContractResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<AuthorizationProviderContractResource>> GetAsync(string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationProviderContractAuthorizationProviderRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, authorizationProviderId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AuthorizationProviderContractResource> Get(string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationProviderContractAuthorizationProviderRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, authorizationProviderId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AuthorizationProviderContractResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _authorizationProviderContractAuthorizationProviderRestClient.CreateListByServiceRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _authorizationProviderContractAuthorizationProviderRestClient.CreateListByServiceNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, filter, top, skip);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _authorizationProviderContractAuthorizationProviderRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, authorizationProviderId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _authorizationProviderContractAuthorizationProviderRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, authorizationProviderId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
