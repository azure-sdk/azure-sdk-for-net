...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    internal partial class SelectiveKeyRestoreDetailsInternal
    {
        ...
        internal SelectiveKeyRestoreDetailsInternal(OperationStatus? status, string statusDetails, KeyVaultErrorError error, string jobId, DateTimeOffset? startTime, DateTimeOffset? endTime)
        {
            Status = status;
