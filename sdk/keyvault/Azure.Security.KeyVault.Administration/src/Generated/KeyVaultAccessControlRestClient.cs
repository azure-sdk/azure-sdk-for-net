...
namespace Azure.Security.KeyVault.Administration
{
    ...
    /// <summary> The KeyVaultAccessControlRest service client. </summary>
    public partial class KeyVaultAccessControlRestClient
    {
        ...
        public KeyVaultAccessControlRestClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new AzureSecurityKeyVaultAdministrationClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public KeyVaultAccessControlRestClient(Uri endpoint, TokenCredential credential, AzureSecurityKeyVaultAdministrationClientOptions options)
        {
        ...
        internal virtual async Task<Response> DeleteRoleDefinitionAsync(string scope, string roleDefinitionName, RequestContext context)
        {
            ...
            using var scope0 = ClientDiagnostics.CreateScope("KeyVaultAccessControlRestClient.DeleteRoleDefinition");
            scope0.Start();
            try
            {
        ...
        internal virtual async Task<Response> CreateOrUpdateRoleDefinitionAsync(string scope, string roleDefinitionName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope0 = ClientDiagnostics.CreateScope("KeyVaultAccessControlRestClient.CreateOrUpdateRoleDefinition");
            scope0.Start();
            try
            {
        ...
        internal virtual async Task<Response> GetRoleDefinitionAsync(string scope, string roleDefinitionName, RequestContext context)
        {
            ...
            using var scope0 = ClientDiagnostics.CreateScope("KeyVaultAccessControlRestClient.GetRoleDefinition");
            scope0.Start();
            try
            {
        ...
        internal virtual async Task<Response> DeleteRoleAssignmentAsync(string scope, string roleAssignmentName, RequestContext context)
        {
            ...
            using var scope0 = ClientDiagnostics.CreateScope("KeyVaultAccessControlRestClient.DeleteRoleAssignment");
            scope0.Start();
            try
            {
        ...
        internal virtual async Task<Response> CreateRoleAssignmentAsync(string scope, string roleAssignmentName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope0 = ClientDiagnostics.CreateScope("KeyVaultAccessControlRestClient.CreateRoleAssignment");
            scope0.Start();
            try
            {
        ...
        internal virtual async Task<Response> GetRoleAssignmentAsync(string scope, string roleAssignmentName, RequestContext context)
        {
            ...
            using var scope0 = ClientDiagnostics.CreateScope("KeyVaultAccessControlRestClient.GetRoleAssignment");
            scope0.Start();
            try
            {
        ...
        internal virtual AsyncPageable<KeyVaultRoleDefinition> GetRoleDefinitionsAsync(string scope, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, KeyVaultRoleDefinition.DeserializeKeyVaultRoleDefinition, ClientDiagnostics, _pipeline, "KeyVaultAccessControlRestClient.GetRoleDefinitions", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<KeyVaultRoleDefinition> GetRoleDefinitions(string scope, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRoleDefinitionsRequest(scope, filter, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetRoleDefinitionsNextPageRequest(nextLink, scope, filter, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, KeyVaultRoleDefinition.DeserializeKeyVaultRoleDefinition, ClientDiagnostics, _pipeline, "KeyVaultAccessControlRestClient.GetRoleDefinitions", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<BinaryData> GetRoleDefinitionsAsync(string scope, string filter, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRoleDefinitionsRequest(scope, filter, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetRoleDefinitionsNextPageRequest(nextLink, scope, filter, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "KeyVaultAccessControlRestClient.GetRoleDefinitions", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<BinaryData> GetRoleDefinitions(string scope, string filter, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRoleDefinitionsRequest(scope, filter, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetRoleDefinitionsNextPageRequest(nextLink, scope, filter, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "KeyVaultAccessControlRestClient.GetRoleDefinitions", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<KeyVaultRoleAssignment> GetRoleAssignmentsAsync(string scope, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, KeyVaultRoleAssignment.DeserializeKeyVaultRoleAssignment, ClientDiagnostics, _pipeline, "KeyVaultAccessControlRestClient.GetRoleAssignments", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<KeyVaultRoleAssignment> GetRoleAssignments(string scope, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRoleAssignmentsRequest(scope, filter, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetRoleAssignmentsNextPageRequest(nextLink, scope, filter, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, KeyVaultRoleAssignment.DeserializeKeyVaultRoleAssignment, ClientDiagnostics, _pipeline, "KeyVaultAccessControlRestClient.GetRoleAssignments", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<BinaryData> GetRoleAssignmentsAsync(string scope, string filter, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRoleAssignmentsRequest(scope, filter, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetRoleAssignmentsNextPageRequest(nextLink, scope, filter, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "KeyVaultAccessControlRestClient.GetRoleAssignments", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<BinaryData> GetRoleAssignments(string scope, string filter, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRoleAssignmentsRequest(scope, filter, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetRoleAssignmentsNextPageRequest(nextLink, scope, filter, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "KeyVaultAccessControlRestClient.GetRoleAssignments", "value", "nextLink", context);
        }
