...
{
    /// <summary> Represents the settings used to configure a <see cref="KeyVaultRestClient"/> that can be loaded from an <see cref="IConfigurationSection"/>. </summary>
    [Experimental("SCME0002")]
    internal partial class KeyVaultRestClientSettings : ClientSettings
    {
