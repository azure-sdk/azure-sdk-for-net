...
namespace Azure.Security.KeyVault.Administration
{
    internal partial class KeyVaultAccessControlClientGetRoleDefinitionsAsyncCollectionResultOfT : AsyncPageable<KeyVaultRoleDefinition>
    {
        ...
        /// <param name="scope0"> The diagnostic scope name. </param>
        public KeyVaultAccessControlClientGetRoleDefinitionsAsyncCollectionResultOfT(KeyVaultAccessControlClient client, string scope, string filter, RequestContext context, string scope0) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _filter = filter;
