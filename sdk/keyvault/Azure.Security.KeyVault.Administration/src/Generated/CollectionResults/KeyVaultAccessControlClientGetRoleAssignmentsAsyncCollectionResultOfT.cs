...
namespace Azure.Security.KeyVault.Administration
{
    internal partial class KeyVaultAccessControlClientGetRoleAssignmentsAsyncCollectionResultOfT : AsyncPageable<KeyVaultRoleAssignment>
    {
        ...
        public KeyVaultAccessControlClientGetRoleAssignmentsAsyncCollectionResultOfT(KeyVaultAccessControlClient client, string scope, string filter, RequestContext context, string scope0) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _filter = filter;
