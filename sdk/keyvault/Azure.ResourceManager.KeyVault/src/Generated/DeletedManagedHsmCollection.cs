...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class DeletedManagedHsmCollection : ArmCollection, IEnumerable<DeletedManagedHsmResource>, IAsyncEnumerable<DeletedManagedHsmResource>
    {
        ...
        internal DeletedManagedHsmCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managedHsmsOperationGroupRestClient = new ManagedHsmsOperationGroup(_managedHsmsOperationGroupClientDiagnostics, Pipeline, Endpoint, deletedManagedHsmApiVersion ?? "2025-05-01");
        ...
        public virtual AsyncPageable<DeletedManagedHsmResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DeletedManagedHsmData, DeletedManagedHsmResource>(new ManagedHsmsOperationGroupGetDeletedManagedHsmsAsyncCollectionResultOfT(_managedHsmsOperationGroupRestClient, Guid.Parse(Id.SubscriptionId), context), data => new DeletedManagedHsmResource(Client, data));
        }
        ...
        public virtual Pageable<DeletedManagedHsmResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DeletedManagedHsmData, DeletedManagedHsmResource>(new ManagedHsmsOperationGroupGetDeletedManagedHsmsCollectionResultOfT(_managedHsmsOperationGroupRestClient, Guid.Parse(Id.SubscriptionId), context), data => new DeletedManagedHsmResource(Client, data));
        }
