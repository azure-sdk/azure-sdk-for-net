...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class DeletedKeyVaultCollection : ArmCollection, IEnumerable<DeletedKeyVaultResource>, IAsyncEnumerable<DeletedKeyVaultResource>
    {
        ...
        internal DeletedKeyVaultCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _vaultsOperationGroupRestClient = new VaultsOperationGroup(_vaultsOperationGroupClientDiagnostics, Pipeline, Endpoint, deletedKeyVaultApiVersion ?? "2025-05-01");
        ...
        public virtual AsyncPageable<DeletedKeyVaultResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DeletedKeyVaultData, DeletedKeyVaultResource>(new VaultsOperationGroupGetDeletedKeyVaultsAsyncCollectionResultOfT(_vaultsOperationGroupRestClient, Guid.Parse(Id.SubscriptionId), context), data => new DeletedKeyVaultResource(Client, data));
        }
        ...
        public virtual Pageable<DeletedKeyVaultResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DeletedKeyVaultData, DeletedKeyVaultResource>(new VaultsOperationGroupGetDeletedKeyVaultsCollectionResultOfT(_vaultsOperationGroupRestClient, Guid.Parse(Id.SubscriptionId), context), data => new DeletedKeyVaultResource(Client, data));
        }
