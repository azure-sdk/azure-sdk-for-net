...
namespace Azure.Messaging.WebPubSub
{
    ...
    public partial class WebPubSubClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetConnectionsInGroupsAsync(string hub, string group, int? maxpagesize = null, int? maxCount = null, string continuationToken = null, RequestContext context = null)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConnectionsInGroupsRequest(hub, group, maxpagesize, maxCount, continuationToken, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConnectionsInGroupsNextPageRequest(nextLink, hub, group, maxpagesize, maxCount, continuationToken, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "WebPubSubClient.GetConnectionsInGroups", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetConnectionsInGroups(string hub, string group, int? maxpagesize = null, int? maxCount = null, string continuationToken = null, RequestContext context = null)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConnectionsInGroupsRequest(hub, group, maxpagesize, maxCount, continuationToken, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConnectionsInGroupsNextPageRequest(nextLink, hub, group, maxpagesize, maxCount, continuationToken, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "WebPubSubClient.GetConnectionsInGroups", "value", "nextLink", context);
        }
