...
namespace Azure.ResourceManager.Automanage.Models
{
    public partial class ServicePrincipalProperties : IUtf8JsonSerializable, IJsonModel<ServicePrincipalProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(AuthorizationSet))
            {
                writer.WritePropertyName("authorizationSet"u8);
                writer.WriteBooleanValue(AuthorizationSet.Value);
            }
        ...
        internal static ServicePrincipalProperties DeserializeServicePrincipalProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("authorizationSet"u8))
                {
            ...
            return new ServicePrincipalProperties(servicePrincipalId, authorizationSet, serializedAdditionalRawData);
        }
