...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class VirtualMachineScaleSetExtension
    {
        ...
        internal VirtualMachineScaleSetExtension(ResourceIdentifier id, string name, string type, VirtualMachineScaleSetExtensionProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Type = type;
