...
namespace Azure.ResourceManager.ContainerService
{
    public partial class FleetMemberResource : IJsonModel<FleetMemberData>
    {
        ...
        BinaryData IPersistableModel<FleetMemberData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<FleetMemberData>(Data, options, AzureResourceManagerContainerServiceContext.Default);

        FleetMemberData IPersistableModel<FleetMemberData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<FleetMemberData>(data, options, AzureResourceManagerContainerServiceContext.Default);
