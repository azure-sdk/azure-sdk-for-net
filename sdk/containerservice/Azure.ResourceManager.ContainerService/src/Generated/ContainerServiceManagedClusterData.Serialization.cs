...
namespace Azure.ResourceManager.ContainerService
{
    public partial class ContainerServiceManagedClusterData : IUtf8JsonSerializable, IJsonModel<ContainerServiceManagedClusterData>
    {
        ...
        void IJsonModel<ContainerServiceManagedClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (EnableNamespaceResources.HasValue)
            {
        ...
        internal static ContainerServiceManagedClusterData DeserializeContainerServiceManagedClusterData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerServiceManagedClusterData(id, name, type, systemData.Value, tags ?? new ChangeTrackingDictionary<string, string>(), location, sku.Value, extendedLocation, identity.Value, kind.Value, provisioningState.Value, powerState.Value, creationData.Value, Optional.ToNullable(maxAgentPools), kubernetesVersion.Value, currentKubernetesVersion.Value, dnsPrefix.Value, fqdnSubdomain.Value, fqdn.Value, privateFQDN.Value, azurePortalFQDN.Value, agentPoolProfiles ?? new ChangeTrackingList<ManagedClusterAgentPoolProfile>(), linuxProfile.Value, windowsProfile.Value, servicePrincipalProfile.Value, addonProfiles ?? new ChangeTrackingDictionary<string, ManagedClusterAddonProfile>(), podIdentityProfile.Value, oidcIssuerProfile.Value, nodeResourceGroup.Value, nodeResourceGroupProfile.Value, Optional.ToNullable(enableRBAC), Optional.ToNullable(supportPlan), Optional.ToNullable(enablePodSecurityPolicy), Optional.ToNullable(enableNamespaceResources), networkProfile.Value, aadProfile.Value, autoUpgradeProfile.Value, upgradeSettings.Value, autoScalerProfile.Value, apiServerAccessProfile.Value, diskEncryptionSetId.Value, identityProfile ?? new ChangeTrackingDictionary<string, ContainerServiceUserAssignedIdentity>(), privateLinkResources ?? new ChangeTrackingList<ContainerServicePrivateLinkResourceData>(), Optional.ToNullable(disableLocalAccounts), httpProxyConfig.Value, securityProfile.Value, storageProfile.Value, ingressProfile.Value, Optional.ToNullable(publicNetworkAccess), workloadAutoScalerProfile.Value, azureMonitorProfile.Value, safeguardsProfile.Value, serviceMeshProfile.Value, resourceUID.Value, metricsProfile.Value, aiToolchainOperatorProfile.Value, nodeProvisioningProfile.Value, bootstrapProfile.Value, serializedAdditionalRawData);
        }
