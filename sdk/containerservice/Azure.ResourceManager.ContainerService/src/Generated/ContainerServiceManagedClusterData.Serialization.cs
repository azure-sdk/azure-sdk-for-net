...
namespace Azure.ResourceManager.ContainerService
{
    public partial class ContainerServiceManagedClusterData : IUtf8JsonSerializable, IJsonModel<ContainerServiceManagedClusterData>
    {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("schedulerProfile"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            schedulerProfile = SchedulerProfile.DeserializeSchedulerProfile(property0.Value, options);
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (hasPropertyOverride)
            {
                builder.Append("    schedulerProfile: ");
                builder.AppendLine("{");
                builder.AppendLine("      schedulerProfile: {");
                builder.AppendLine("        schedulerInstanceProfiles: {");
            ...
            else
            {
                ...
                {
                    builder.Append("    schedulerProfile: ");
                    BicepSerializationHelpers.AppendChildObject(builder, SchedulerProfile, options, 4, false, "    schedulerProfile: ");
                }
            }
