...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ContainerServiceManagedClusterResource : ArmResource
    {
        ...
        /// <description>2024-03-02-preview</description>
        /// </item>
        /// <item>
        /// <term>Resource</term>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, bool? ignorePodDisruptionBudget = null, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<ArmOperation<ContainerServiceManagedClusterResource>> UpdateAsync(WaitUntil waitUntil, ContainerServiceTagsObject containerServiceTagsObject, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerServiceArmOperation<ContainerServiceManagedClusterResource>(new ContainerServiceManagedClusterOperationSource(Client), _containerServiceManagedClusterManagedClustersClientDiagnostics, Pipeline, _containerServiceManagedClusterManagedClustersRestClient.CreateUpdateTagsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, containerServiceTagsObject, ifMatch).Request, response, OperationFinalStateVia.Location, apiVersionOverrideValue: "2017-08-31");
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>LoadBalancers_Rebalance</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-03-02-preview</description>
        ...
        public virtual async Task<ArmOperation> RebalanceLoadBalancerAsync(WaitUntil waitUntil, RebalanceLoadBalancersRequestBody rebalanceLoadBalancersRequestBody, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(rebalanceLoadBalancersRequestBody, nameof(rebalanceLoadBalancersRequestBody));

            using var scope = _loadBalancerClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.RebalanceLoadBalancer");
            scope.Start();
            try
            {
                var response = await _loadBalancerRestClient.RebalanceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, rebalanceLoadBalancersRequestBody, cancellationToken).ConfigureAwait(false);
                var operation = new ContainerServiceArmOperation(_loadBalancerClientDiagnostics, Pipeline, _loadBalancerRestClient.CreateRebalanceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, rebalanceLoadBalancersRequestBody).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="rebalanceLoadBalancersRequestBody"/> is null. </exception>
        public virtual ArmOperation RebalanceLoadBalancer(WaitUntil waitUntil, RebalanceLoadBalancersRequestBody rebalanceLoadBalancersRequestBody, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(rebalanceLoadBalancersRequestBody, nameof(rebalanceLoadBalancersRequestBody));
            ...
            try
            {
                var response = _loadBalancerRestClient.Rebalance(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, rebalanceLoadBalancersRequestBody, cancellationToken);
                var operation = new ContainerServiceArmOperation(_loadBalancerClientDiagnostics, Pipeline, _loadBalancerRestClient.CreateRebalanceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, rebalanceLoadBalancersRequestBody).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
