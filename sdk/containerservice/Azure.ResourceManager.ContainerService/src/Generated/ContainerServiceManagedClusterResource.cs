...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ContainerServiceManagedClusterResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of ManagedNamespaceResources in the ContainerServiceManagedCluster. </summary>
        /// <returns> An object representing collection of ManagedNamespaceResources and their operations over a ManagedNamespaceResource. </returns>
        public virtual ManagedNamespaceCollection GetManagedNamespaces()
        {
            return GetCachedClient(client => new ManagedNamespaceCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ManagedNamespaceResource>> GetManagedNamespaceAsync(string managedNamespaceName, CancellationToken cancellationToken = default)
        {
            return await GetManagedNamespaces().GetAsync(managedNamespaceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="managedNamespaceName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ManagedNamespaceResource> GetManagedNamespace(string managedNamespaceName, CancellationToken cancellationToken = default)
        {
            return GetManagedNamespaces().Get(managedNamespaceName, cancellationToken);
        }
        ...
        /// <summary> Gets a collection of LoadBalancerResources in the ContainerServiceManagedCluster. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<LoadBalancerResource>> GetLoadBalancerAsync(string loadBalancerName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="loadBalancerName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<LoadBalancerResource> GetLoadBalancer(string loadBalancerName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch = null, bool? ignorePodDisruptionBudget = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _containerServiceManagedClusterManagedClustersRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch, ignorePodDisruptionBudget, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="ignorePodDisruptionBudget"> ignore-pod-disruption-budget=true to delete those pods on a node without considering Pod Disruption Budget. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation Delete(WaitUntil waitUntil, string ifMatch = null, bool? ignorePodDisruptionBudget = null, CancellationToken cancellationToken = default)
        {
            using var scope = _containerServiceManagedClusterManagedClustersClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.Delete");
            scope.Start();
            try
            {
                var response = _containerServiceManagedClusterManagedClustersRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch, ignorePodDisruptionBudget, cancellationToken);
                var operation = new ContainerServiceArmOperation(_containerServiceManagedClusterManagedClustersClientDiagnostics, Pipeline, _containerServiceManagedClusterManagedClustersRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch, ignorePodDisruptionBudget).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<ContainerServiceManagedClusterResource>> UpdateAsync(WaitUntil waitUntil, ContainerServiceTagsObject containerServiceTagsObject, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerServiceArmOperation<ContainerServiceManagedClusterResource>(new ContainerServiceManagedClusterOperationSource(Client), _containerServiceManagedClusterManagedClustersClientDiagnostics, Pipeline, _containerServiceManagedClusterManagedClustersRestClient.CreateUpdateTagsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, containerServiceTagsObject, ifMatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerServiceTagsObject"/> is null. </exception>
        public virtual ArmOperation<ContainerServiceManagedClusterResource> Update(WaitUntil waitUntil, ContainerServiceTagsObject containerServiceTagsObject, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(containerServiceTagsObject, nameof(containerServiceTagsObject));
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/operations</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>OperationStatusResult_List</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-03-02-preview</description>
        ...
        public virtual AsyncPageable<OperationStatusResult> GetOperationStatusResultsAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<OperationStatusResult> GetOperationStatusResults(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _operationStatusResultRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _operationStatusResultRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>OperationStatusResult_Get</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-03-02-preview</description>
        ...
        public virtual async Task<Response<OperationStatusResult>> GetOperationStatusResultAsync(string operationId, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="operationId"/> is null. </exception>
        public virtual Response<OperationStatusResult> GetOperationStatusResult(string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
