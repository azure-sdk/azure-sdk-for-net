...
namespace Azure.ResourceManager.ContainerService
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="FleetResource"/> using the GetAutoUpgradeProfile method.
    /// </summary>
    public partial class AutoUpgradeProfileResource : ArmResource
    {
        ...
        {
            _autoUpgradeProfileClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", ResourceType.Namespace, Diagnostics);
            ...
            _autoUpgradeProfileOperationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerServiceArmOperation(_autoUpgradeProfileClientDiagnostics, Pipeline, _autoUpgradeProfileRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch).Request, response, OperationFinalStateVia.Location);
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/autoUpgradeProfiles/{autoUpgradeProfileName}/generate</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AutoUpgradeProfileOperations_Generate</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-03-01</description>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<GenerateResponse>> GenerateAutoUpgradeProfileOperationAsync(WaitUntil waitUntil, string startUpdateRun = null, CancellationToken cancellationToken = default)
        {
            using var scope = _autoUpgradeProfileOperationsClientDiagnostics.CreateScope("AutoUpgradeProfileResource.GenerateAutoUpgradeProfileOperation");
            scope.Start();
            try
            {
                var response = await _autoUpgradeProfileOperationsRestClient.GenerateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, startUpdateRun, cancellationToken).ConfigureAwait(false);
                var operation = new ContainerServiceArmOperation<GenerateResponse>(new GenerateResponseOperationSource(), _autoUpgradeProfileOperationsClientDiagnostics, Pipeline, _autoUpgradeProfileOperationsRestClient.CreateGenerateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, startUpdateRun).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="startUpdateRun"> Whether to start the update run after it is created in the generate operation. Empty value indicates that update run will not be started. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<GenerateResponse> GenerateAutoUpgradeProfileOperation(WaitUntil waitUntil, string startUpdateRun = null, CancellationToken cancellationToken = default)
        {
            using var scope = _autoUpgradeProfileOperationsClientDiagnostics.CreateScope("AutoUpgradeProfileResource.GenerateAutoUpgradeProfileOperation");
            scope.Start();
            try
            {
                var response = _autoUpgradeProfileOperationsRestClient.Generate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, startUpdateRun, cancellationToken);
                var operation = new ContainerServiceArmOperation<GenerateResponse>(new GenerateResponseOperationSource(), _autoUpgradeProfileOperationsClientDiagnostics, Pipeline, _autoUpgradeProfileOperationsRestClient.CreateGenerateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, startUpdateRun).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/autoUpgradeProfiles/{autoUpgradeProfileName}/generateUpdateRuns</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AutoUpgradeProfileOperations_GenerateUpdateRuns</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-03-01</description>
        ...
        public virtual async Task<Response<AutoUpgradeProfileResource>> GenerateUpdateRunsAutoUpgradeProfileOperationAsync(GenerateUpdateRunContent content, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = _autoUpgradeProfileOperationsClientDiagnostics.CreateScope("AutoUpgradeProfileResource.GenerateUpdateRunsAutoUpgradeProfileOperation");
            scope.Start();
            try
            {
                var response = await _autoUpgradeProfileOperationsRestClient.GenerateUpdateRunsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, ifMatch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new AutoUpgradeProfileResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<AutoUpgradeProfileResource> GenerateUpdateRunsAutoUpgradeProfileOperation(GenerateUpdateRunContent content, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = _autoUpgradeProfileOperationsRestClient.GenerateUpdateRuns(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, ifMatch, cancellationToken);
                return Response.FromValue(new AutoUpgradeProfileResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
