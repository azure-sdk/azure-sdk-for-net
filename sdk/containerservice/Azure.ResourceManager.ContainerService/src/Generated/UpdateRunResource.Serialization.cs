...
namespace Azure.ResourceManager.ContainerService
{
    public partial class UpdateRunResource : IJsonModel<UpdateRunData>
    {
        ...
        BinaryData IPersistableModel<UpdateRunData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<UpdateRunData>(Data, options, AzureResourceManagerContainerServiceContext.Default);

        UpdateRunData IPersistableModel<UpdateRunData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<UpdateRunData>(data, options, AzureResourceManagerContainerServiceContext.Default);
