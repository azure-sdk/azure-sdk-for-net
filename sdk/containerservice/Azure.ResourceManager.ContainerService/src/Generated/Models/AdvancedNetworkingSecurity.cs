...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AdvancedNetworkingSecurity
    {
        ...
        /// <param name="transitEncryptionType"> This can be enabled only on Cilium-based clusters. If not specified, the default value is None. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal AdvancedNetworkingSecurity(bool? enabled, AdvancedNetworkPolicy? advancedNetworkPolicies, TransitEncryptionType? transitEncryptionType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
        ...
        public TransitEncryptionType? TransitEncryptionType { get; set; }
    }
}
