...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManualScaleProfile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManualScaleProfile"/>. </summary>
        /// <param name="sizes"> The list of allowed vm sizes. AKS will use the first available one when scaling. If a VM size is unavailable (e.g. due to quota or regional capacity reasons), AKS will use the next size. </param>
        ...
        /// <summary> The list of allowed vm sizes. AKS will use the first available one when scaling. If a VM size is unavailable (e.g. due to quota or regional capacity reasons), AKS will use the next size. </summary>
