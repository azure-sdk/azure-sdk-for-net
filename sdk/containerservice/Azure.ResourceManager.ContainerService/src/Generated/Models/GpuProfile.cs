...
{
    /// <summary> The GpuProfile. </summary>
    public partial class GpuProfile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GpuProfile"/>. </summary>
        public GpuProfile()
        {
        }
        ...
        internal GpuProfile(GpuDriver? driver, DriverType? driverType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Driver = driver;
