...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceNetworkProfile
    {
        ...
        /// <param name="podLinkLocalAccess"> Defines access to special link local addresses (IMDS and wire server) for pods with hostNetwork=false. if not specified, the default is 'IMDS'. </param>
        ...
        /// <summary> Defines access to special link local addresses (IMDS and wire server) for pods with hostNetwork=false. if not specified, the default is 'IMDS'. </summary>
        ...
        /// <summary> Advanced Networking profile for enabling observability on a cluster. Note that enabling advanced networking features may incur additional costs. For more information see aka.ms/aksadvancednetworking. </summary>
