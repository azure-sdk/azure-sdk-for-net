...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class IstioEgressGateway
    {
        ...
        /// <param name="gatewayConfigurationName"> Name of the gateway configuration custom resource to configure the Istio egress routing. Must be specified when enabling the Istio egress gateway. Must be deployed in the same namespace that the Istio egress gateway will be deployed in. </param>
        ...
        /// <summary> Name of the gateway configuration custom resource to configure the Istio egress routing. Must be specified when enabling the Istio egress gateway. Must be deployed in the same namespace that the Istio egress gateway will be deployed in. </summary>
