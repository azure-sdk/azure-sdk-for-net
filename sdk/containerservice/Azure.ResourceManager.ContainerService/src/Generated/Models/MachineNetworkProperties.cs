...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class MachineNetworkProperties
    {
        ...
        {
            IPAddresses = new ChangeTrackingList<MachineIPAddress>();
        }

        /// <summary> Initializes a new instance of <see cref="MachineNetworkProperties"/>. </summary>
        /// <param name="ipAddresses"> IPv4, IPv6 addresses of the machine. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal MachineNetworkProperties(IReadOnlyList<MachineIPAddress> ipAddresses, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public IReadOnlyList<MachineIPAddress> IPAddresses { get; }
    }
}
