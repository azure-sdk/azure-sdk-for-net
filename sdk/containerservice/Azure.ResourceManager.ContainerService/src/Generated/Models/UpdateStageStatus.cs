...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class UpdateStageStatus
    {
        ...
        internal UpdateStageStatus(UpdateStatus status, string name, IReadOnlyList<UpdateGroupStatus> groups, IReadOnlyList<UpdateRunGateStatus> beforeGates, IReadOnlyList<UpdateRunGateStatus> afterGates, WaitStatus afterStageWaitStatus, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Name = name;
            Groups = groups;
