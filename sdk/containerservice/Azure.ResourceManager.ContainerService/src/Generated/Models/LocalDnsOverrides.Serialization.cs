...
{
    public partial class LocalDnsOverrides : IUtf8JsonSerializable, IJsonModel<LocalDnsOverrides>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalDnsOverrides>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<LocalDnsOverrides>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<LocalDnsOverrides>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LocalDnsOverrides)} does not support writing '{format}' format.");
            }
        ...
        LocalDnsOverrides IJsonModel<LocalDnsOverrides>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LocalDnsOverrides>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LocalDnsOverrides)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeLocalDnsOverrides(document.RootElement, options);
        }

        internal static LocalDnsOverrides DeserializeLocalDnsOverrides(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<LocalDnsOverrides>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LocalDnsOverrides>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LocalDnsOverrides)} does not support writing '{options.Format}' format.");
            }
        }

        LocalDnsOverrides IPersistableModel<LocalDnsOverrides>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LocalDnsOverrides>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LocalDnsOverrides)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<LocalDnsOverrides>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
