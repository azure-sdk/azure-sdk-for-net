...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class MemberUpdateStatus
    {
        ...
        internal MemberUpdateStatus(UpdateStatus status, string name, ResourceIdentifier clusterResourceId, string operationId, string message, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Name = name;
