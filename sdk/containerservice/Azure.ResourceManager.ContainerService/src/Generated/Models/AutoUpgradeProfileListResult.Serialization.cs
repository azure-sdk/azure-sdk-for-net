...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoUpgradeProfileListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutoUpgradeProfileListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WriteObjectValue<AutoUpgradeProfileData>(item, options);
            }
