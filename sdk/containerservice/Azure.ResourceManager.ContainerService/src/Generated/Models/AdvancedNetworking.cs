...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AdvancedNetworking
    {
        ...
        internal AdvancedNetworking(AdvancedNetworkingObservability observability, AdvancedNetworkingSecurity security, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        {
            get => Security is null ? default : Security.FqdnPolicyEnabled;
            set
            {
                if (Security is null)
                    Security = new AdvancedNetworkingSecurity();
                Security.FqdnPolicyEnabled = value;
            }
        }
    }
}
