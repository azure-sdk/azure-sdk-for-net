...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AgentPoolUpgradeSettings
    {
        ...
        internal AgentPoolUpgradeSettings(string maxSurge, string maxUnavailable, int? drainTimeoutInMinutes, int? nodeSoakDurationInMinutes, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MaxSurge = maxSurge;
