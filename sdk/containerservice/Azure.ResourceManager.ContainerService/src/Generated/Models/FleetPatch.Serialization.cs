...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FleetPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FleetPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FleetPatch)} does not support '{format}' format.");
            }
        ...
        internal static FleetPatch DeserializeFleetPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FleetPatch(tags ?? new ChangeTrackingDictionary<string, string>(), identity, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<FleetPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FleetPatch)} does not support '{options.Format}' format.");
            }
        }
