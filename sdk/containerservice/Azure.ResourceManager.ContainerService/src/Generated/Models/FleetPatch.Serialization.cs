...
namespace Azure.ResourceManager.ContainerService.Models
{
    public partial class FleetPatch : IUtf8JsonSerializable, IJsonModel<FleetPatch>
    {
        ...
        internal static FleetPatch DeserializeFleetPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AzureResourceManagerLegacyManagedServiceIdentityV4Update identity = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("identity"u8))
                {
                    ...
                    identity = AzureResourceManagerLegacyManagedServiceIdentityV4Update.DeserializeAzureResourceManagerLegacyManagedServiceIdentityV4Update(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
