...
namespace Azure.ResourceManager.ContainerService.Models
{
    public partial class FleetPatch : IUtf8JsonSerializable, IJsonModel<FleetPatch>
    {
        ...
        internal static FleetPatch DeserializeFleetPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AzureResourceManagerLegacyManagedServiceIdentityV4 identity = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("identity"u8))
                {
                    ...
                    identity = AzureResourceManagerLegacyManagedServiceIdentityV4.DeserializeAzureResourceManagerLegacyManagedServiceIdentityV4(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
