...
namespace Azure.ResourceManager.ContainerService.Models
{
    public partial class ManagedClusterAgentPoolProfile : IUtf8JsonSerializable, IJsonModel<ManagedClusterAgentPoolProfile>
    {
        ...
        void IJsonModel<ManagedClusterAgentPoolProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (PodIPAllocationMode.HasValue)
            {
            ...
            if (EnableCustomCATrust.HasValue)
            {
            ...
            if (!(NodeInitializationTaints is ChangeTrackingList<string> collection3 && collection3.IsUndefined))
            {
            ...
            if (!(VirtualMachineNodesStatus is ChangeTrackingList<VirtualMachineNodes> collection4 && collection4.IsUndefined))
            {
            ...
            if (GatewayProfile != null)
            {
                ...
                writer.WriteObjectValue(GatewayProfile);
            }
        ...
        internal static ManagedClusterAgentPoolProfile DeserializeManagedClusterAgentPoolProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<PodIPAllocationMode> podIPAllocationMode = default;
            ...
            Optional<AgentPoolGatewayProfile> gatewayProfile = default;
            ...
            return new ManagedClusterAgentPoolProfile(Optional.ToNullable(count), vmSize.Value, Optional.ToNullable(osDiskSizeGB), Optional.ToNullable(osDiskType), Optional.ToNullable(kubeletDiskType), Optional.ToNullable(workloadRuntime), messageOfTheDay.Value, vnetSubnetId.Value, podSubnetId.Value, Optional.ToNullable(podIPAllocationMode), Optional.ToNullable(maxPods), Optional.ToNullable(osType), Optional.ToNullable(osSku), Optional.ToNullable(maxCount), Optional.ToNullable(minCount), Optional.ToNullable(enableAutoScaling), Optional.ToNullable(scaleDownMode), Optional.ToNullable(type), Optional.ToNullable(mode), orchestratorVersion.Value, currentOrchestratorVersion.Value, nodeImageVersion.Value, upgradeSettings.Value, provisioningState.Value, powerState.Value, availabilityZones ?? new ChangeTrackingList<string>(), Optional.ToNullable(enableNodePublicIP), Optional.ToNullable(enableCustomCATrust), nodePublicIPPrefixId.Value, Optional.ToNullable(scaleSetPriority), Optional.ToNullable(scaleSetEvictionPolicy), Optional.ToNullable(spotMaxPrice), tags ?? new ChangeTrackingDictionary<string, string>(), nodeLabels ?? new ChangeTrackingDictionary<string, string>(), nodeTaints ?? new ChangeTrackingList<string>(), nodeInitializationTaints ?? new ChangeTrackingList<string>(), proximityPlacementGroupId.Value, kubeletConfig.Value, linuxOSConfig.Value, Optional.ToNullable(enableEncryptionAtHost), Optional.ToNullable(enableUltraSsd), Optional.ToNullable(enableFIPS), Optional.ToNullable(gpuInstanceProfile), creationData.Value, capacityReservationGroupId.Value, hostGroupId.Value, windowsProfile.Value, networkProfile.Value, securityProfile.Value, gpuProfile.Value, artifactStreamingProfile.Value, virtualMachinesProfile.Value, virtualMachineNodesStatus ?? new ChangeTrackingList<VirtualMachineNodes>(), gatewayProfile.Value, serializedAdditionalRawData, name);
        }
