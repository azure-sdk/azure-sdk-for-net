...
namespace Azure.ResourceManager.ContainerService.Models
{
    public partial class GateTarget : IUtf8JsonSerializable, IJsonModel<GateTarget>
    {
        ...
        internal static GateTarget DeserializeGateTarget(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            GateTargetType type = default;
            GateTargetProperties properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    type = new GateTargetType(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("properties"u8))
                {
                    properties = GateTargetProperties.DeserializeGateTargetProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new GateTarget(id, type, properties, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("GateTargetUpdateRun", out propertyOverride);
            if (hasPropertyOverride)
            {
