    ...
    public partial class GateTarget : IUtf8JsonSerializable, IJsonModel<GateTarget>
    {
        ...
        internal static GateTarget DeserializeGateTarget(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("updateRunProperties"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    updateRunProperties = UpdateRunGateTargetProperties.DeserializeUpdateRunGateTargetProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(UpdateRunProperties), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  updateRunProperties: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  updateRunProperties: ");
                    BicepSerializationHelpers.AppendChildObject(builder, UpdateRunProperties, options, 2, false, "  updateRunProperties: ");
                }
            }
