...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class UpdateGroupStatus
    {
        ...
        internal UpdateGroupStatus(UpdateStatus status, string name, IReadOnlyList<MemberUpdateStatus> members, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Name = name;
            Members = members;
