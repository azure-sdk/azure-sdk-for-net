...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetrics
    {
        ...
        internal ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetrics(bool? enabled, int? port, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            Port = port;
