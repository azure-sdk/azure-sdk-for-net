...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class FleetHubProfile
    {
        ...
        internal FleetHubProfile(string dnsPrefix, ApiServerAccessProfile apiServerAccessProfile, AgentProfile agentProfile, string fqdn, string kubernetesVersion, string portalFqdn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DnsPrefix = dnsPrefix;
        ...
        internal ApiServerAccessProfile ApiServerAccessProfile { get; set; }
        /// <summary> Whether to create the Fleet hub as a private cluster or not. </summary>
        public bool? EnablePrivateCluster
        {
            get => ApiServerAccessProfile is null ? default : ApiServerAccessProfile.EnablePrivateCluster;
            set
            {
                if (ApiServerAccessProfile is null)
                    ApiServerAccessProfile = new ApiServerAccessProfile();
                ApiServerAccessProfile.EnablePrivateCluster = value;
            }
        }
