    ...
    public partial class ContainerServiceManagedClusterData : IUtf8JsonSerializable, IJsonModel<ContainerServiceManagedClusterData>
    {
        ...
        void IJsonModel<ContainerServiceManagedClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SafeguardsProfile))
            {
                ...
                writer.WriteObjectValue(SafeguardsProfile);
            }
        ...
        internal static ContainerServiceManagedClusterData DeserializeContainerServiceManagedClusterData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<SafeguardsProfile> safeguardsProfile = default;
            Optional<ServiceMeshProfile> serviceMeshProfile = default;
            Optional<ResourceIdentifier> resourceUID = default;
            Optional<ManagedClusterMetricsProfile> metricsProfile = default;
            Optional<ManagedClusterAIToolchainOperatorProfile> aiToolchainOperatorProfile = default;
            Optional<ManagedClusterNodeProvisioningProfile> nodeProvisioningProfile = default;
            Optional<ManagedClusterBootstrapProfile> bootstrapProfile = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("safeguardsProfile"u8))
                        {
                            ...
                            safeguardsProfile = SafeguardsProfile.DeserializeSafeguardsProfile(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("metricsProfile"u8))
                        {
                            ...
                            metricsProfile = ManagedClusterMetricsProfile.DeserializeManagedClusterMetricsProfile(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("aiToolchainOperatorProfile"u8))
                        {
                            ...
                            aiToolchainOperatorProfile = ManagedClusterAIToolchainOperatorProfile.DeserializeManagedClusterAIToolchainOperatorProfile(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("nodeProvisioningProfile"u8))
                        {
                            ...
                            nodeProvisioningProfile = ManagedClusterNodeProvisioningProfile.DeserializeManagedClusterNodeProvisioningProfile(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("bootstrapProfile"u8))
                        {
                            ...
                            bootstrapProfile = ManagedClusterBootstrapProfile.DeserializeManagedClusterBootstrapProfile(property0.Value);
                            continue;
                        }
                    }
                    continue;
            ...
            return new ContainerServiceManagedClusterData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, sku.Value, extendedLocation, identity.Value, provisioningState.Value, powerState.Value, creationData.Value, Optional.ToNullable(maxAgentPools), kubernetesVersion.Value, currentKubernetesVersion.Value, dnsPrefix.Value, fqdnSubdomain.Value, fqdn.Value, privateFQDN.Value, azurePortalFQDN.Value, Optional.ToList(agentPoolProfiles), linuxProfile.Value, windowsProfile.Value, servicePrincipalProfile.Value, Optional.ToDictionary(addonProfiles), podIdentityProfile.Value, oidcIssuerProfile.Value, nodeResourceGroup.Value, nodeResourceGroupProfile.Value, Optional.ToNullable(enableRBAC), Optional.ToNullable(supportPlan), Optional.ToNullable(enablePodSecurityPolicy), Optional.ToNullable(enableNamespaceResources), networkProfile.Value, aadProfile.Value, autoUpgradeProfile.Value, upgradeSettings.Value, autoScalerProfile.Value, apiServerAccessProfile.Value, diskEncryptionSetId.Value, Optional.ToDictionary(identityProfile), Optional.ToList(privateLinkResources), Optional.ToNullable(disableLocalAccounts), httpProxyConfig.Value, securityProfile.Value, storageProfile.Value, ingressProfile.Value, Optional.ToNullable(publicNetworkAccess), workloadAutoScalerProfile.Value, azureMonitorProfile.Value, safeguardsProfile.Value, serviceMeshProfile.Value, resourceUID.Value, metricsProfile.Value, aiToolchainOperatorProfile.Value, nodeProvisioningProfile.Value, bootstrapProfile.Value, serializedAdditionalRawData);
        }
