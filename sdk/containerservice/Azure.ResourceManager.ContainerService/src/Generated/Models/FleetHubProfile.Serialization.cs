...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FleetHubProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FleetHubProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FleetHubProfile)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && PortalFqdn != null)
            {
        ...
        internal static FleetHubProfile DeserializeFleetHubProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FleetHubProfile(dnsPrefix.Value, apiServerAccessProfile.Value, agentProfile.Value, fqdn.Value, kubernetesVersion.Value, portalFqdn.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<FleetHubProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FleetHubProfile)} does not support '{options.Format}' format.");
            }
        }
