...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkipTarget>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SkipTarget>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SkipTarget)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SkipTarget>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SkipTarget)} does not support '{options.Format}' format.");
            }
        }
