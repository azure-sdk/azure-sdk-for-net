...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class FleetMemberPatch
    {
        ...
        /// <summary> Initializes a new instance of <see cref="FleetMemberPatch"/>. </summary>
        ...
        internal FleetMemberPatch(string group, IDictionary<string, string> labels, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Group = group;
            Labels = labels;
