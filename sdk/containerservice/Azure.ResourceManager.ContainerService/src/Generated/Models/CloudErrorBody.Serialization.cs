...
{
    public partial class CloudErrorBody : IUtf8JsonSerializable, IJsonModel<CloudErrorBody>
    {
        ...
        internal static CloudErrorBody DeserializeCloudErrorBody(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CloudErrorBody(code, message, target, serializedAdditionalRawData);
        }
