...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class UpdateStage
    {
        ...
        internal UpdateStage(string name, IList<UpdateGroup> groups, int? afterStageWaitInSeconds, IList<GateConfiguration> beforeGates, IList<GateConfiguration> afterGates, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Groups = groups;
        ...
        [WirePath("afterStageWaitInSeconds")]
