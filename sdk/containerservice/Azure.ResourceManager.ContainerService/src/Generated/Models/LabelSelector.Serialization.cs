...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabelSelector>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LabelSelector>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(MatchExpressions))
            {
                ...
                {
                    writer.WriteObjectValue<LabelSelectorRequirement>(item, options);
                }
                writer.WriteEndArray();
            }
