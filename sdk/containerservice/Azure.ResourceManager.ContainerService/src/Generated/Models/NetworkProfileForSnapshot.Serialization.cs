...
namespace Azure.ResourceManager.ContainerService.Models
{
    public partial class NetworkProfileForSnapshot : IUtf8JsonSerializable, IJsonModel<NetworkProfileForSnapshot>
    {
        ...
        internal static NetworkProfileForSnapshot DeserializeNetworkProfileForSnapshot(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetworkProfileForSnapshot(Optional.ToNullable(networkPlugin), Optional.ToNullable(networkPluginMode), Optional.ToNullable(networkPolicy), Optional.ToNullable(networkMode), Optional.ToNullable(loadBalancerSku), serializedAdditionalRawData);
        }
