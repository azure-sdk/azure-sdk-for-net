...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogs
    {
        ...
        internal ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogs(bool? enabled, int? port, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            Port = port;
