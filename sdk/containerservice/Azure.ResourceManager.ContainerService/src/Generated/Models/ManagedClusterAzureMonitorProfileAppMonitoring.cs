...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class ManagedClusterAzureMonitorProfileAppMonitoring
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedClusterAzureMonitorProfileAppMonitoring"/>. </summary>
        /// <param name="enabled"> Indicates if Application Monitoring enabled or not. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal ManagedClusterAzureMonitorProfileAppMonitoring(bool? enabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
