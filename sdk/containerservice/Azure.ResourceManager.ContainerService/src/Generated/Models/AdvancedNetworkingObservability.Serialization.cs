...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdvancedNetworkingObservability>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AdvancedNetworkingObservability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvancedNetworkingObservability)} does not support '{format}' format.");
            }
        ...
        internal static AdvancedNetworkingObservability DeserializeAdvancedNetworkingObservability(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AdvancedNetworkingObservability(Optional.ToNullable(enabled), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AdvancedNetworkingObservability>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdvancedNetworkingObservability)} does not support '{options.Format}' format.");
            }
        }
