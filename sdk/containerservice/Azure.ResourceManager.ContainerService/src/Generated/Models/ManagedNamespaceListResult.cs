...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class ManagedNamespaceListResult
    {
        ...
        {
            Value = new ChangeTrackingList<ManagedNamespaceData>();
        }
        ...
        internal ManagedNamespaceListResult(IReadOnlyList<ManagedNamespaceData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<ManagedNamespaceData> Value { get; }
