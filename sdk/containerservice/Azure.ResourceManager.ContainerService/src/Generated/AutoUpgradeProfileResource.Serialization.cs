...
namespace Azure.ResourceManager.ContainerService
{
    public partial class AutoUpgradeProfileResource : IJsonModel<AutoUpgradeProfileData>
    {
        ...
        BinaryData IPersistableModel<AutoUpgradeProfileData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<AutoUpgradeProfileData>(Data, options, AzureResourceManagerContainerServiceContext.Default);

        AutoUpgradeProfileData IPersistableModel<AutoUpgradeProfileData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<AutoUpgradeProfileData>(data, options, AzureResourceManagerContainerServiceContext.Default);
