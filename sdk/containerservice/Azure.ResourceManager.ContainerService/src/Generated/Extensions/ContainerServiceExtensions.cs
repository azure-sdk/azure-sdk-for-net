...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public static partial class ContainerServiceExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="ManagedNamespaceResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="ManagedNamespaceResource.CreateResourceIdentifier" /> to create a <see cref="ManagedNamespaceResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableContainerServiceArmClient.GetManagedNamespaceResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        /// <returns> Returns a <see cref="ManagedNamespaceResource"/> object. </returns>
        public static ManagedNamespaceResource GetManagedNamespaceResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableContainerServiceArmClient(client).GetManagedNamespaceResource(id);
        }
