...
namespace Azure.ResourceManager.ContainerService.Mocking
{
    ...
    public partial class MockableContainerServiceArmClient : ArmResource
    {
        ...
        public virtual ManagedNamespaceResource GetManagedNamespaceResource(ResourceIdentifier id)
        {
            ManagedNamespaceResource.ValidateResourceId(id);
            return new ManagedNamespaceResource(Client, id);
        }
