...
namespace Azure.ResourceManager.ContainerService
{
    public partial class FleetUpdateStrategyResource : IJsonModel<FleetUpdateStrategyData>
    {
        ...
        BinaryData IPersistableModel<FleetUpdateStrategyData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<FleetUpdateStrategyData>(Data, options, AzureResourceManagerContainerServiceContext.Default);

        FleetUpdateStrategyData IPersistableModel<FleetUpdateStrategyData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<FleetUpdateStrategyData>(data, options, AzureResourceManagerContainerServiceContext.Default);
