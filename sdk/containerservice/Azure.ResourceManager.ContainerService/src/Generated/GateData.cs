...
namespace Azure.ResourceManager.ContainerService
{
    ...
    /// </summary>
    public partial class GateData : TrackedResourceData
    {
        /// <summary>
        ...
        public GateData(AzureLocation location) : base(location)
        {
        }
        ...
        internal GateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ETag? etag, GateProvisioningState? provisioningState, string displayName, GateTarget target, GateType? gateType, GateState? state, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
        ...
        /// <summary> Initializes a new instance of <see cref="GateData"/> for deserialization. </summary>
        internal GateData()
        {
        }
