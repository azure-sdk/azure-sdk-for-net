...
namespace Azure.ResourceManager.ContainerService
{
    internal class AutoUpgradeProfileOperationSource : IOperationSource<AutoUpgradeProfileResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<AutoUpgradeProfileData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerContainerServiceContext.Default);
