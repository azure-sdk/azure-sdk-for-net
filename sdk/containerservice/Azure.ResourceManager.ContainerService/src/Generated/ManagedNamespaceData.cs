...
{
    /// <summary>
    /// A class representing the ManagedNamespace data model.
    /// Namespace managed by ARM.
    /// </summary>
    public partial class ManagedNamespaceData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedNamespaceData"/>. </summary>
        /// <param name="location"> The location. </param>
        public ManagedNamespaceData(AzureLocation location) : base(location)
        {
        }
        ...
        internal ManagedNamespaceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ETag? etag, NamespaceProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedNamespaceData"/> for deserialization. </summary>
        internal ManagedNamespaceData()
        {
        }
