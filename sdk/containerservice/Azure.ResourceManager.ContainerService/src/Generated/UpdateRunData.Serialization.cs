...
namespace Azure.ResourceManager.ContainerService
{
    public partial class UpdateRunData : IUtf8JsonSerializable, IJsonModel<UpdateRunData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AutoUpgradeProfileId), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    autoUpgradeProfileId: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(AutoUpgradeProfileId))
                {
                    builder.Append("    autoUpgradeProfileId: ");
                    builder.AppendLine($"'{AutoUpgradeProfileId.ToString()}'");
                }
            }
