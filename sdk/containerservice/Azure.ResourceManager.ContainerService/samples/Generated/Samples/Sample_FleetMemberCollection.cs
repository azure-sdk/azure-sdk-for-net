...
namespace Azure.ResourceManager.ContainerService.Samples
{
    public partial class Sample_FleetMemberCollection
    {
        ...
        public async Task CreateOrUpdate_CreatesAFleetMemberResourceWithALongRunningOperation()
        {
            ...
            {
                ClusterResourceId = new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/cluster-1"),
            };
        ...
        public async Task CreateOrUpdate_CreatesAFleetMemberResourceWithALongRunningOperationGeneratedByMaximumSetRule()
        {
            ...
            // invoke the operation
            string fleetMemberName = "member1";
            FleetMemberData data = new FleetMemberData
            {
                ClusterResourceId = new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/cluster-1"),
                Group = "group1",
            };
            string ifMatch = "hbshjzpobjetwmpkdwvp";
            string ifNoneMatch = "ia";
