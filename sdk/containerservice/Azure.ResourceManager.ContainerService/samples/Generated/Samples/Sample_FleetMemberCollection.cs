...
namespace Azure.ResourceManager.ContainerService.Samples
{
    public partial class Sample_FleetMemberCollection
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_FleetMembersCreateMaximumSetGen()
        {
            ...
            // invoke the operation
            string fleetMemberName = "Replace this value with a string matching RegExp ^[a-z0-9]([-a-z0-9]*[a-z0-9])?$";
            FleetMemberData data = new FleetMemberData
            {
                ClusterResourceId = new ResourceIdentifier("/subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/cluster-1"),
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Get_FleetMembersGetMaximumSetGen()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetAll_FleetMembersListByFleetMaximumSetGen()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_FleetMembersGetMaximumSetGen()
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/fleet/stable/2025-03-01/examples/FleetMembers_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "FleetMembers_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_FleetMembersGetMaximumSetGen()
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/fleet/stable/2025-03-01/examples/FleetMembers_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "FleetMembers_Get" operation, for the dependent resources, they will have to be created separately.
