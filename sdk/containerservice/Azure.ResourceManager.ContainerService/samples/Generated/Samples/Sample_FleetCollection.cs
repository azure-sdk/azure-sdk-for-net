...
["tier"] = "production"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_FleetsCreateOrUpdateMaximumSetGen()
        {
            ...
            FleetData data = new FleetData(new AzureLocation("East US"))
            {
                Identity = new ResourceManager.Models.ManagedServiceIdentity("None")
                {
...
[new ResourceIdentifier("key126")] = new UserAssignedIdentity()
                ...
                {
                    DnsPrefix = "dnsprefix1",
                    ApiServerAccessProfile = new ApiServerAccessProfile
                    {
                        EnablePrivateCluster = true,
                        EnableVnetIntegration = true,
                        SubnetId = new ResourceIdentifier("kvvopngkpnqqexgsjjssurs"),
                    },
                    AgentProfile = new AgentProfile
                    {
                        SubnetId = new ResourceIdentifier("kvvopngkpnqqexgsjjssurs"),
            ...
            ArmOperation<FleetResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, fleetName, data, ifMatch: ifMatch, ifNoneMatch: ifNoneMatch);
            FleetResource result = lro.Value;
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Get_FleetsGetMaximumSetGen()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetAll_FleetsListByResourceGroupMaximumSetGen()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_FleetsGetMaximumSetGen()
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/fleet/stable/2025-03-01/examples/Fleets_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "Fleets_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_FleetsGetMaximumSetGen()
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/fleet/stable/2025-03-01/examples/Fleets_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "Fleets_Get" operation, for the dependent resources, they will have to be created separately.
