...
namespace Azure.ResourceManager.ContainerService.Samples
{
    public partial class Sample_NamespaceCollection
    {
        ...
        public async Task CreateOrUpdate_CreateUpdateNamespace()
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-03-02-preview/examples/NamespacesCreate_Update.json
            ...
            NamespaceCollection collection = containerServiceManagedCluster.GetNamespaces();

            // invoke the operation
            string namespaceName = "namespace1";
            NamespaceData data = new NamespaceData(default)
            {
...
["tagKey1"] = "tagValue1"
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-03-02-preview/examples/NamespacesGet.json
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-03-02-preview/examples/NamespacesList.json
            // this example is just showing the usage of "Namespaces_ListByManagedCluster" operation, for the dependent resources, they will have to be created separately.
