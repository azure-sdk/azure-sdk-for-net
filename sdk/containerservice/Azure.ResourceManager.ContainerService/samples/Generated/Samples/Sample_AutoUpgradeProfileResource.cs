...
namespace Azure.ResourceManager.ContainerService.Samples
{
    public partial class Sample_AutoUpgradeProfileResource
    {
        ...
        public async Task Get_GetsAnAutoUpgradeProfileResourceGeneratedByMaximumSetRule()
        {
            ...
            string fleetName = "Replace this value with a string matching RegExp ^[a-z0-9]([-a-z0-9]*[a-z0-9])?$";
            string autoUpgradeProfileName = "Replace this value with a string matching RegExp ^[a-z0-9]([-a-z0-9]*[a-z0-9])?$";
            ResourceIdentifier autoUpgradeProfileResourceId = AutoUpgradeProfileResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, fleetName, autoUpgradeProfileName);
            AutoUpgradeProfileResource autoUpgradeProfile = client.GetAutoUpgradeProfileResource(autoUpgradeProfileResourceId);
        ...
        public async Task Update_CreateAnAutoUpgradeProfileGeneratedByMaximumSetRule()
        {
            ...
            AutoUpgradeProfileData data = new AutoUpgradeProfileData
            {
                UpdateStrategyId = new ResourceIdentifier("myzyyupsevijzgbufq"),
                Channel = UpgradeChannel.Stable,
                SelectionType = AutoUpgradeNodeImageSelectionType.Latest,
                Disabled = true,
            };
            string ifMatch = "hbsuomgiwqy";
            string ifNoneMatch = "lqfsfvkjfzxrwvy";
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GenerateAutoUpgradeProfileOperation_AutoUpgradeProfileOperationsGenerateMaximumSet()
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/fleet/stable/2025-03-01/examples/AutoUpgradeProfileOperations_Generate_MaximumSet_Gen.json
            // this example is just showing the usage of "AutoUpgradeProfileOperations_Generate" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            ArmOperation<GenerateResponse> lro = await autoUpgradeProfile.GenerateAutoUpgradeProfileOperationAsync(WaitUntil.Completed);
