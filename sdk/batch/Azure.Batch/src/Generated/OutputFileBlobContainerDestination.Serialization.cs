...
namespace Azure.Compute.Batch
{
    public partial class OutputFileBlobContainerDestination : IUtf8JsonSerializable, IJsonModel<OutputFileBlobContainerDestination>
    {
        ...
        void IJsonModel<OutputFileBlobContainerDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OutputFileBlobContainerDestination)} does not support '{format}' format.");
            }
            ...
            if (!(UploadHeaders is ChangeTrackingList<HttpHeader> collection && collection.IsUndefined))
            {
        ...
        internal static OutputFileBlobContainerDestination DeserializeOutputFileBlobContainerDestination(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OutputFileBlobContainerDestination(path.Value, containerUrl, identityReference.Value, uploadHeaders ?? new ChangeTrackingList<HttpHeader>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<OutputFileBlobContainerDestination>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OutputFileBlobContainerDestination)} does not support '{options.Format}' format.");
            }
        }
