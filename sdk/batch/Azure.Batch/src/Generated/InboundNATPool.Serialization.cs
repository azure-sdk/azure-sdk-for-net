...
namespace Azure.Compute.Batch
{
    public partial class InboundNATPool : IUtf8JsonSerializable, IJsonModel<InboundNATPool>
    {
        ...
        void IJsonModel<InboundNATPool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InboundNATPool)} does not support '{format}' format.");
            }
            ...
            if (!(NetworkSecurityGroupRules is ChangeTrackingList<NetworkSecurityGroupRule> collection && collection.IsUndefined))
            {
