...
namespace Azure.Compute.Batch
{
    public partial class BatchPoolStatistics : IUtf8JsonSerializable, IJsonModel<BatchPoolStatistics>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchPoolStatistics>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchPoolStatistics)} does not support '{format}' format.");
            }
        ...
        BatchPoolStatistics IJsonModel<BatchPoolStatistics>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchPoolStatistics>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static BatchPoolStatistics DeserializeBatchPoolStatistics(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchPoolUsageStatistics> usageStats = default;
            Optional<BatchPoolResourceStatistics> resourceStats = default;
        ...
        BinaryData IPersistableModel<BatchPoolStatistics>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchPoolStatistics>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchPoolStatistics)} does not support '{options.Format}' format.");
            }
        }

        BatchPoolStatistics IPersistableModel<BatchPoolStatistics>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchPoolStatistics>)this).GetFormatFromOptions(options) : options.Format;
