...
namespace Azure.Compute.Batch
{
    public partial class BatchJobCreateContent : IUtf8JsonSerializable, IJsonModel<BatchJobCreateContent>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchJobCreateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchJobCreateContent)} does not support '{format}' format.");
            }
        ...
        BatchJobCreateContent IJsonModel<BatchJobCreateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchJobCreateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeBatchJobCreateContent(document.RootElement, options);
        }
        ...
        internal static BatchJobCreateContent DeserializeBatchJobCreateContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchJobConstraints> constraints = default;
            Optional<BatchJobManagerTask> jobManagerTask = default;
            Optional<BatchJobPreparationTask> jobPreparationTask = default;
            Optional<BatchJobReleaseTask> jobReleaseTask = default;
            IList<EnvironmentSetting> commonEnvironmentSettings = default;
            BatchPoolInfo poolInfo = default;
            Optional<OnAllBatchTasksComplete> onAllTasksComplete = default;
            Optional<OnBatchTaskFailure> onTaskFailure = default;
            Optional<BatchJobNetworkConfiguration> networkConfiguration = default;
            ...
            return new BatchJobCreateContent(
                id,
                displayName.Value,
                Optional.ToNullable(usesTaskDependencies),
                Optional.ToNullable(priority),
                Optional.ToNullable(allowTaskPreemption),
                Optional.ToNullable(maxParallelTasks),
                constraints.Value,
                ...
                poolInfo,
                Optional.ToNullable(onAllTasksComplete),
                Optional.ToNullable(onTaskFailure),
                networkConfiguration.Value,
                metadata ?? new ChangeTrackingList<MetadataItem>(),
                serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<BatchJobCreateContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchJobCreateContent>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchJobCreateContent)} does not support '{options.Format}' format.");
            }
        }

        BatchJobCreateContent IPersistableModel<BatchJobCreateContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchJobCreateContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<BatchJobCreateContent>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static BatchJobCreateContent FromResponse(Response response)
        {
