...
namespace Azure.Compute.Batch
{
    public partial class ExitConditions : IUtf8JsonSerializable, IJsonModel<ExitConditions>
    {
        ...
        void IJsonModel<ExitConditions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExitConditions)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(ExitCodes is ChangeTrackingList<ExitCodeMapping> collection && collection.IsUndefined))
            {
            ...
            if (!(ExitCodeRanges is ChangeTrackingList<ExitCodeRangeMapping> collection0 && collection0.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<ExitConditions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ExitConditions)} does not support '{options.Format}' format.");
            }
        }
