...
namespace Azure.Compute.Batch
{
    public partial class BatchJobManagerTask : IUtf8JsonSerializable, IJsonModel<BatchJobManagerTask>
    {
        ...
        void IJsonModel<BatchJobManagerTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchJobManagerTask)} does not support '{format}' format.");
            }
            ...
            if (KillJobOnCompletion.HasValue)
            {
            ...
            if (AllowLowPriorityNode.HasValue)
            {
        ...
        BinaryData IPersistableModel<BatchJobManagerTask>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchJobManagerTask)} does not support '{options.Format}' format.");
            }
        }
