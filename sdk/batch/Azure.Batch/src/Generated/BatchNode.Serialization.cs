...
namespace Azure.Compute.Batch
{
    public partial class BatchNode : IUtf8JsonSerializable, IJsonModel<BatchNode>
    {
        ...
        void IJsonModel<BatchNode>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchNode)} does not support '{format}' format.");
            }
            ...
            if (StartTaskInfo != null)
            {
                ...
                writer.WriteObjectValue(StartTaskInfo);
            }
            ...
            if (!(Errors is ChangeTrackingList<BatchNodeError> collection1 && collection1.IsUndefined))
            {
        ...
        internal static BatchNode DeserializeBatchNode(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchStartTaskInfo> startTaskInfo = default;
            ...
            Optional<BatchNodeAgentInfo> nodeAgentInfo = default;
            ...
            return new BatchNode(
                ...
                Optional.ToNullable(schedulingState),
                Optional.ToNullable(stateTransitionTime),
                Optional.ToNullable(lastBootTime),
                Optional.ToNullable(allocationTime),
                ipAddress.Value,
                affinityId.Value,
                vmSize.Value,
                Optional.ToNullable(totalTasksRun),
                Optional.ToNullable(runningTasksCount),
                Optional.ToNullable(runningTaskSlotsCount),
                Optional.ToNullable(totalTasksSucceeded),
                ...
                Optional.ToNullable(isDedicated),
                endpointConfiguration.Value,
                nodeAgentInfo.Value,
                virtualMachineInfo.Value,
        ...
        BinaryData IPersistableModel<BatchNode>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchNode)} does not support '{options.Format}' format.");
            }
        }
