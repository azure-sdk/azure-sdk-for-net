...
namespace Azure.Compute.Batch
{
    public partial class BatchError : IUtf8JsonSerializable, IJsonModel<BatchError>
    {
        ...
        void IJsonModel<BatchError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchError)} does not support '{format}' format.");
            }
            ...
            if (!(Values is ChangeTrackingList<BatchErrorDetail> collection && collection.IsUndefined))
            {
        ...
        internal static BatchError DeserializeBatchError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string code = default;
            Optional<BatchErrorMessage> message = default;
            ...
            return new BatchError(code, message.Value, values ?? new ChangeTrackingList<BatchErrorDetail>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<BatchError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchError)} does not support '{options.Format}' format.");
            }
        }
