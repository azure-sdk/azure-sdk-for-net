...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchPoolIdentity>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BatchPoolIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchPoolIdentity)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            writer.WritePropertyName("type"u8);
            writer.WriteStringValue(Type.ToString());
            if (!(UserAssignedIdentities is ChangeTrackingList<UserAssignedIdentity> collection && collection.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<BatchPoolIdentity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchPoolIdentity)} does not support '{options.Format}' format.");
            }
        }
