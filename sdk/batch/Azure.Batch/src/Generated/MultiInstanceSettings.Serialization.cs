...
namespace Azure.Compute.Batch
{
    public partial class MultiInstanceSettings : IUtf8JsonSerializable, IJsonModel<MultiInstanceSettings>
    {
        ...
        void IJsonModel<MultiInstanceSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MultiInstanceSettings)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (NumberOfInstances.HasValue)
            {
            ...
            if (!(CommonResourceFiles is ChangeTrackingList<ResourceFile> collection && collection.IsUndefined))
            {
        ...
        internal static MultiInstanceSettings DeserializeMultiInstanceSettings(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MultiInstanceSettings(Optional.ToNullable(numberOfInstances), coordinationCommandLine, commonResourceFiles ?? new ChangeTrackingList<ResourceFile>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MultiInstanceSettings>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MultiInstanceSettings)} does not support '{options.Format}' format.");
            }
        }
