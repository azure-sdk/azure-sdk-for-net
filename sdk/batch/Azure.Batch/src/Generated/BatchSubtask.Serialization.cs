...
namespace Azure.Compute.Batch
{
    public partial class BatchSubtask : IUtf8JsonSerializable, IJsonModel<BatchSubtask>
    {
        ...
        void IJsonModel<BatchSubtask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchSubtask)} does not support '{format}' format.");
            }
            ...
            if (PreviousStateTransitionTime.HasValue)
            {
        ...
        internal static BatchSubtask DeserializeBatchSubtask(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchSubtaskState> state = default;
            Optional<DateTimeOffset> stateTransitionTime = default;
            Optional<BatchSubtaskState> previousState = default;
        ...
        BinaryData IPersistableModel<BatchSubtask>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchSubtask)} does not support '{options.Format}' format.");
            }
        }
