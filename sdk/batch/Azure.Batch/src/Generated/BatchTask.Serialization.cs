...
namespace Azure.Compute.Batch
{
    public partial class BatchTask : IUtf8JsonSerializable, IJsonModel<BatchTask>
    {
        ...
        void IJsonModel<BatchTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchTask)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && ExitConditions != null)
            {
            ...
            if (options.Format != "W" && ContainerSettings != null)
            {
                writer.WritePropertyName("containerSettings"u8);
                writer.WriteObjectValue(ContainerSettings);
            }
            if (options.Format != "W" && !(ResourceFiles is ChangeTrackingList<ResourceFile> collection && collection.IsUndefined))
            {
            ...
            if (options.Format != "W" && !(OutputFiles is ChangeTrackingList<OutputFile> collection0 && collection0.IsUndefined))
            {
            ...
            if (options.Format != "W" && !(EnvironmentSettings is ChangeTrackingList<EnvironmentSetting> collection1 && collection1.IsUndefined))
            {
            ...
            if (options.Format != "W" && AffinityInfo != null)
            {
            ...
            if (options.Format != "W" && NodeInfo != null)
            {
                writer.WritePropertyName("nodeInfo"u8);
                writer.WriteObjectValue(NodeInfo);
            }
            if (options.Format != "W" && MultiInstanceSettings != null)
            {
            ...
            if (options.Format != "W" && DependsOn != null)
            {
            ...
            if (options.Format != "W" && AuthenticationTokenSettings != null)
            {
        ...
        internal static BatchTask DeserializeBatchTask(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchTaskState> state = default;
            Optional<DateTimeOffset> stateTransitionTime = default;
            Optional<BatchTaskState> previousState = default;
            ...
            Optional<AffinityInfo> affinityInfo = default;
            Optional<BatchTaskConstraints> constraints = default;
            Optional<int> requiredSlots = default;
            Optional<UserIdentity> userIdentity = default;
            Optional<BatchTaskExecutionInfo> executionInfo = default;
            Optional<BatchNodeInfo> nodeInfo = default;
            Optional<MultiInstanceSettings> multiInstanceSettings = default;
            Optional<BatchTaskStatistics> stats = default;
            Optional<BatchTaskDependencies> dependsOn = default;
            ...
            return new BatchTask(
                ...
                affinityInfo.Value,
                constraints.Value,
                Optional.ToNullable(requiredSlots),
                userIdentity.Value,
                executionInfo.Value,
                nodeInfo.Value,
        ...
        BinaryData IPersistableModel<BatchTask>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchTask)} does not support '{options.Format}' format.");
            }
        }
