...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchTaskIdRange>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BatchTaskIdRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchTaskIdRange)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BatchTaskIdRange>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchTaskIdRange)} does not support '{options.Format}' format.");
            }
        }
