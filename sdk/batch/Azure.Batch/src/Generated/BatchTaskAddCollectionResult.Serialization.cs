...
namespace Azure.Compute.Batch
{
    public partial class BatchTaskAddCollectionResult : IUtf8JsonSerializable, IJsonModel<BatchTaskAddCollectionResult>
    {
        ...
        void IJsonModel<BatchTaskAddCollectionResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchTaskAddCollectionResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<BatchTaskAddResult> collection && collection.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<BatchTaskAddCollectionResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchTaskAddCollectionResult)} does not support '{options.Format}' format.");
            }
        }
