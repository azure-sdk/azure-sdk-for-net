...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchApi
    {
        ...
        public virtual async Task<Response> DeletePoolAsync(string poolId, int? timeOutInSeconds = null, DateTimeOffset? ocpdate = null, RequestConditions requestConditions = null, RequestContext context = null)
        {
            ...
            if (poolId.Length == 0)
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(poolId));
            }
        ...
        public virtual async Task<Response> CancelCertificateDeletionAsync(string thumbprintAlgorithm, string thumbprint, int? timeOutInSeconds = null, DateTimeOffset? ocpdate = null, RequestContext context = null)
        {
            ...
            if (thumbprintAlgorithm.Length == 0)
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(thumbprintAlgorithm));
            }
            if (thumbprint == null)
            {
            ...
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(thumbprint));
            }
        ...
        public virtual async Task<Response<bool>> JobScheduleExistsAsync(string jobScheduleId, int? timeOutInSeconds = null, DateTimeOffset? ocpdate = null, RequestConditions requestConditions = null, RequestContext context = null)
        {
            ...
            if (jobScheduleId.Length == 0)
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(jobScheduleId));
            }
        ...
        public virtual async Task<Response> DeleteTaskFileAsync(string jobId, string taskId, string filePath, int? timeOutInSeconds = null, DateTimeOffset? ocpdate = null, bool? recursive = null, RequestContext context = null)
        {
            ...
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(filePath));
            }
