...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchNodeCounts>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BatchNodeCounts>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchNodeCounts)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BatchNodeCounts>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchNodeCounts)} does not support '{options.Format}' format.");
            }
        }
