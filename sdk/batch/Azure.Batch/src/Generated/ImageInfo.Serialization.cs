...
namespace Azure.Compute.Batch
{
    public partial class ImageInfo : IUtf8JsonSerializable, IJsonModel<ImageInfo>
    {
        ...
        void IJsonModel<ImageInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImageInfo)} does not support '{format}' format.");
            }
            ...
            if (!(Capabilities is ChangeTrackingList<string> collection && collection.IsUndefined))
            {
            ...
            if (BatchSupportEndOfLife.HasValue)
            {
        ...
        internal static ImageInfo DeserializeImageInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ImageInfo(
                ...
                Optional.ToNullable(batchSupportEndOfLife),
                verificationType,
        ...
        BinaryData IPersistableModel<ImageInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImageInfo)} does not support '{options.Format}' format.");
            }
        }
