...
namespace Azure.Compute.Batch
{
    public partial class BatchJob : IUtf8JsonSerializable, IJsonModel<BatchJob>
    {
        ...
        void IJsonModel<BatchJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchJob)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && UsesTaskDependencies.HasValue)
            {
            ...
            if (options.Format != "W" && OnTaskFailure.HasValue)
            {
        ...
        internal static BatchJob DeserializeBatchJob(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchJobState> state = default;
            Optional<DateTimeOffset> stateTransitionTime = default;
            Optional<BatchJobState> previousState = default;
            ...
            Optional<BatchJobExecutionInfo> executionInfo = default;
            Optional<BatchJobStatistics> stats = default;
        ...
        BinaryData IPersistableModel<BatchJob>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchJob)} does not support '{options.Format}' format.");
            }
        }
