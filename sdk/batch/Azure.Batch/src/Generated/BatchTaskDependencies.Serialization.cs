...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchTaskDependencies>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BatchTaskDependencies>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchTaskDependencies)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(TaskIds is ChangeTrackingList<string> collection && collection.IsUndefined))
            {
            ...
            if (!(TaskIdRanges is ChangeTrackingList<BatchTaskIdRange> collection0 && collection0.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<BatchTaskDependencies>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchTaskDependencies)} does not support '{options.Format}' format.");
            }
        }
