...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchNodeInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BatchNodeInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchNodeInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BatchNodeInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchNodeInfo)} does not support '{options.Format}' format.");
            }
        }
