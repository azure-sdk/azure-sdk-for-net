...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchJobReleaseTaskExecutionInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BatchJobReleaseTaskExecutionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchJobReleaseTaskExecutionInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BatchJobReleaseTaskExecutionInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchJobReleaseTaskExecutionInfo)} does not support '{options.Format}' format.");
            }
        }
