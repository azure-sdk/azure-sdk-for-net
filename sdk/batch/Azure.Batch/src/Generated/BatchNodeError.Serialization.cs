...
namespace Azure.Compute.Batch
{
    public partial class BatchNodeError : IUtf8JsonSerializable, IJsonModel<BatchNodeError>
    {
        ...
        void IJsonModel<BatchNodeError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchNodeError)} does not support '{format}' format.");
            }
            ...
            if (!(ErrorDetails is ChangeTrackingList<NameValuePair> collection && collection.IsUndefined))
            {
        ...
        internal static BatchNodeError DeserializeBatchNodeError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new BatchNodeError(code.Value, message.Value, errorDetails ?? new ChangeTrackingList<NameValuePair>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<BatchNodeError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchNodeError)} does not support '{options.Format}' format.");
            }
        }
