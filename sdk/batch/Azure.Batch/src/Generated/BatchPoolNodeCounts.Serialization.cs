...
namespace Azure.Compute.Batch
{
    public partial class BatchPoolNodeCounts : IUtf8JsonSerializable, IJsonModel<BatchPoolNodeCounts>
    {
        ...
        void IJsonModel<BatchPoolNodeCounts>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchPoolNodeCounts)} does not support '{format}' format.");
            }
            ...
            if (Dedicated != null)
            {
                ...
                writer.WriteObjectValue(Dedicated);
            }
            if (LowPriority != null)
            {
                writer.WritePropertyName("lowPriority"u8);
                writer.WriteObjectValue(LowPriority);
            }
        ...
        internal static BatchPoolNodeCounts DeserializeBatchPoolNodeCounts(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchNodeCounts> dedicated = default;
            Optional<BatchNodeCounts> lowPriority = default;
            ...
            return new BatchPoolNodeCounts(poolId, dedicated.Value, lowPriority.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<BatchPoolNodeCounts>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchPoolNodeCounts)} does not support '{options.Format}' format.");
            }
        }
