...
namespace Azure.Compute.Batch
{
    public partial class BatchJobStatistics : IUtf8JsonSerializable, IJsonModel<BatchJobStatistics>
    {
        ...
        void IJsonModel<BatchJobStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchJobStatistics)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BatchJobStatistics>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchJobStatistics)} does not support '{options.Format}' format.");
            }
        }
