...
namespace Azure.Compute.Batch
{
    public partial class ExitOptions : IUtf8JsonSerializable, IJsonModel<ExitOptions>
    {
        ...
        void IJsonModel<ExitOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExitOptions)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (JobAction.HasValue)
            {
                writer.WritePropertyName("jobAction"u8);
                writer.WriteStringValue(JobAction.Value.ToString());
            }
            if (DependencyAction.HasValue)
            {
        ...
        internal static ExitOptions DeserializeExitOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchJobAction> jobAction = default;
            ...
            return new ExitOptions(Optional.ToNullable(jobAction), Optional.ToNullable(dependencyAction), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ExitOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ExitOptions)} does not support '{options.Format}' format.");
            }
        }
