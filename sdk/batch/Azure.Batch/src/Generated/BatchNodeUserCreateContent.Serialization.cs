...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchNodeUserCreateContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BatchNodeUserCreateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchNodeUserCreateContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BatchNodeUserCreateContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchNodeUserCreateContent)} does not support '{options.Format}' format.");
            }
        }
