...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchPoolReplaceContent
    {
        ...
        public BatchPoolReplaceContent(IEnumerable<BatchCertificateReference> certificateReferences, IEnumerable<BatchApplicationPackageReference> applicationPackageReferences, IEnumerable<MetadataItem> metadata)
        {
        ...
        internal BatchPoolReplaceContent(BatchStartTask startTask, IList<BatchCertificateReference> certificateReferences, IList<BatchApplicationPackageReference> applicationPackageReferences, IList<MetadataItem> metadata, BatchNodeCommunicationMode? targetNodeCommunicationMode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartTask = startTask;
