...
namespace Azure.Compute.Batch
{
    public partial class BatchCertificate : IUtf8JsonSerializable, IJsonModel<BatchCertificate>
    {
        ...
        void IJsonModel<BatchCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchCertificate)} does not support '{format}' format.");
            }
        ...
        internal static BatchCertificate DeserializeBatchCertificate(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchCertificateState> state = default;
            Optional<DateTimeOffset> stateTransitionTime = default;
            Optional<BatchCertificateState> previousState = default;
            Optional<DateTimeOffset> previousStateTransitionTime = default;
            Optional<string> publicData = default;
            Optional<DeleteBatchCertificateError> deleteCertificateError = default;
            string data = default;
            Optional<BatchCertificateFormat> certificateFormat = default;
            ...
            return new BatchCertificate(
                ...
                data,
                Optional.ToNullable(certificateFormat),
                password.Value,
        ...
        BinaryData IPersistableModel<BatchCertificate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchCertificate)} does not support '{options.Format}' format.");
            }
        }
