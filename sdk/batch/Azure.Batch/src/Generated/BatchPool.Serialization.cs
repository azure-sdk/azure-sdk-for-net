...
namespace Azure.Compute.Batch
{
    public partial class BatchPool : IUtf8JsonSerializable, IJsonModel<BatchPool>
    {
        ...
        void IJsonModel<BatchPool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && AllocationStateTransitionTime.HasValue)
            {
            ...
            if (options.Format != "W" && !(ResourceTags is ChangeTrackingDictionary<string, string> collection0 && collection0.IsUndefined))
            {
            ...
            if (options.Format != "W" && !(CertificateReferences is ChangeTrackingList<BatchCertificateReference> collection1 && collection1.IsUndefined))
            {
            ...
            if (options.Format != "W" && !(ApplicationPackageReferences is ChangeTrackingList<BatchApplicationPackageReference> collection2 && collection2.IsUndefined))
            {
            ...
            if (options.Format != "W" && !(ApplicationLicenses is ChangeTrackingList<string> collection3 && collection3.IsUndefined))
            {
            ...
            if (options.Format != "W" && TaskSlotsPerNode.HasValue)
            {
                writer.WritePropertyName("taskSlotsPerNode"u8);
                writer.WriteNumberValue(TaskSlotsPerNode.Value);
            }
            if (options.Format != "W" && TaskSchedulingPolicy != null)
            {
                writer.WritePropertyName("taskSchedulingPolicy"u8);
                writer.WriteObjectValue(TaskSchedulingPolicy);
            }
            if (options.Format != "W" && !(UserAccounts is ChangeTrackingList<UserAccount> collection4 && collection4.IsUndefined))
            {
            ...
            if (options.Format != "W" && !(Metadata is ChangeTrackingList<MetadataItem> collection5 && collection5.IsUndefined))
            {
            ...
            if (options.Format != "W" && !(MountConfiguration is ChangeTrackingList<MountConfiguration> collection6 && collection6.IsUndefined))
            {
        ...
        internal static BatchPool DeserializeBatchPool(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<BatchPoolState> state = default;
            ...
            Optional<BatchPoolStatistics> stats = default;
            ...
            Optional<BatchNodeCommunicationMode> currentNodeCommunicationMode = default;
