...
namespace Azure.Compute.Batch
{
    public partial class VMExtension : IUtf8JsonSerializable, IJsonModel<VMExtension>
    {
        ...
        void IJsonModel<VMExtension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMExtension)} does not support '{format}' format.");
            }
            ...
            if (!(ProtectedSettings is ChangeTrackingDictionary<string, string> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(ProvisionAfterExtensions is ChangeTrackingList<string> collection1 && collection1.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<VMExtension>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VMExtension)} does not support '{options.Format}' format.");
            }
        }
