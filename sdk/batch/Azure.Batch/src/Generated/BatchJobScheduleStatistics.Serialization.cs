...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchJobScheduleStatistics>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BatchJobScheduleStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchJobScheduleStatistics)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BatchJobScheduleStatistics>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BatchJobScheduleStatistics)} does not support '{options.Format}' format.");
            }
        }
