...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetPoolUsageMetricsAsyncCollectionResultOfT : AsyncPageable<BatchPoolUsageMetrics>
    {
        ...
        public BatchClientGetPoolUsageMetricsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, DateTimeOffset? starttime, DateTimeOffset? endtime, string filter, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
