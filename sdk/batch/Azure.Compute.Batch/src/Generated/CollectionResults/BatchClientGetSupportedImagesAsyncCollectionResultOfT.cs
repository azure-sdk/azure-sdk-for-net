...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetSupportedImagesAsyncCollectionResultOfT : AsyncPageable<BatchSupportedImage>
    {
        ...
        public BatchClientGetSupportedImagesAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
