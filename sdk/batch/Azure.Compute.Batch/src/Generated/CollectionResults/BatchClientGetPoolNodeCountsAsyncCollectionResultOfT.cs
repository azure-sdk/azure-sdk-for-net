...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetPoolNodeCountsAsyncCollectionResultOfT : AsyncPageable<BatchPoolNodeCounts>
    {
        ...
        public BatchClientGetPoolNodeCountsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
