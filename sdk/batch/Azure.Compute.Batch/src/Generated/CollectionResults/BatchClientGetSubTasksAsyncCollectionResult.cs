...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetSubTasksAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetSubTasksAsyncCollectionResult(BatchClient client, string jobId, string taskId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, IEnumerable<string> @select, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _taskId = taskId;
