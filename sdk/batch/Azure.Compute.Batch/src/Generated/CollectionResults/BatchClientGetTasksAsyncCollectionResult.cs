...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetTasksAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetTasksAsyncCollectionResult(BatchClient client, string jobId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
