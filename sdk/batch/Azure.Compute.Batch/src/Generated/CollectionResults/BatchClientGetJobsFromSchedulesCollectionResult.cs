...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetJobsFromSchedulesCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetJobsFromSchedulesCollectionResult(BatchClient client, string jobScheduleId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
