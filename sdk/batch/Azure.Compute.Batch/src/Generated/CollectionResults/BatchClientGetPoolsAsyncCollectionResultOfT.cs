...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetPoolsAsyncCollectionResultOfT : AsyncPageable<BatchPool>
    {
        ...
        public BatchClientGetPoolsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
