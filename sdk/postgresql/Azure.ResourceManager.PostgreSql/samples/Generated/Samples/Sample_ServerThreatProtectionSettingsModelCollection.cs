...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Samples
{
    public partial class Sample_ServerThreatProtectionSettingsModelCollection
    {
        ...
        {
            // Generated from example definition: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2023-03-01-preview/examples/ServerThreatProtectionSettingsListByServer.json
        ...
        {
            // Generated from example definition: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2023-03-01-preview/examples/ServerThreatProtectionSettingsGet.json
        ...
        // Update a database's Threat Protection settings with all parameters
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_UpdateADatabaseSThreatProtectionSettingsWithAllParameters()
        {
            // Generated from example definition: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2023-03-01-preview/examples/ServerThreatProtectionSettingsCreateMax.json
        ...
        // Update a server's Threat Protection settings with minimal parameters
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_UpdateAServerSThreatProtectionSettingsWithMinimalParameters()
        {
            // Generated from example definition: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2023-03-01-preview/examples/ServerThreatProtectionSettingsCreateMin.json
            // this example is just showing the usage of "ServerThreatProtectionSettings_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            ServerThreatProtectionSettingsModelData data = new ServerThreatProtectionSettingsModelData()
            {
                State = ThreatProtectionState.Disabled,
            };
            ArmOperation<ServerThreatProtectionSettingsModelResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, threatProtectionName, data);
            ServerThreatProtectionSettingsModelResource result = lro.Value;
