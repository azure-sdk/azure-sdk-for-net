...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    public partial class PostgreSqlFlexibleServerData : TrackedResourceData
    {
        ...
        /// <param name="sourceServerResourceId"> The source server resource ID to restore from. It&apos;s required when &apos;createMode&apos; is &apos;PointInTimeRestore&apos; or &apos;GeoRestore&apos; or &apos;Replica&apos;. This property is returned only for Replica server. </param>
        ...
        /// <summary> The source server resource ID to restore from. It&apos;s required when &apos;createMode&apos; is &apos;PointInTimeRestore&apos; or &apos;GeoRestore&apos; or &apos;Replica&apos;. This property is returned only for Replica server. </summary>
