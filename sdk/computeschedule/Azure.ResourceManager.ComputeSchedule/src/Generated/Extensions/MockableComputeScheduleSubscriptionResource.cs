...
namespace Azure.ResourceManager.ComputeSchedule.Mocking
{
    ...
    public partial class MockableComputeScheduleSubscriptionResource : ArmResource
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationparameter"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationparameter"/> or <paramref name="content"/> is null. </exception>
        public virtual async Task<Response<CreateResourceOperationResponse>> VirtualMachinesExecuteCreateScheduledActionAsync(string locationparameter, ExecuteCreateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationparameter, nameof(locationparameter));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationparameter"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationparameter"/> or <paramref name="content"/> is null. </exception>
        public virtual Response<CreateResourceOperationResponse> VirtualMachinesExecuteCreateScheduledAction(string locationparameter, ExecuteCreateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationparameter, nameof(locationparameter));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationparameter"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationparameter"/> or <paramref name="content"/> is null. </exception>
        public virtual async Task<Response<DeleteResourceOperationResponse>> VirtualMachinesExecuteDeleteScheduledActionAsync(string locationparameter, ExecuteDeleteContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationparameter, nameof(locationparameter));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationparameter"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationparameter"/> or <paramref name="content"/> is null. </exception>
        public virtual Response<DeleteResourceOperationResponse> VirtualMachinesExecuteDeleteScheduledAction(string locationparameter, ExecuteDeleteContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationparameter, nameof(locationparameter));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationparameter"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationparameter"/> or <paramref name="content"/> is null. </exception>
        public virtual async Task<Response<CreateResourceOperationResponse>> VirtualMachinesSubmitCreateScheduledActionAsync(string locationparameter, SubmitCreateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationparameter, nameof(locationparameter));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ScheduledActionsClientDiagnostics.CreateScope("MockableComputeScheduleSubscriptionResource.VirtualMachinesSubmitCreateScheduledAction");
            scope.Start();
            try
            {
                var response = await ScheduledActionsRestClient.VirtualMachinesSubmitCreateAsync(Id.SubscriptionId, locationparameter, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationparameter"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationparameter"/> or <paramref name="content"/> is null. </exception>
        public virtual Response<CreateResourceOperationResponse> VirtualMachinesSubmitCreateScheduledAction(string locationparameter, SubmitCreateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationparameter, nameof(locationparameter));
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = ScheduledActionsRestClient.VirtualMachinesSubmitCreate(Id.SubscriptionId, locationparameter, content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationparameter"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationparameter"/> or <paramref name="content"/> is null. </exception>
        public virtual async Task<Response<DeleteResourceOperationResponse>> VirtualMachinesSubmitDeleteScheduledActionAsync(string locationparameter, SubmitDeleteContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationparameter, nameof(locationparameter));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ScheduledActionsClientDiagnostics.CreateScope("MockableComputeScheduleSubscriptionResource.VirtualMachinesSubmitDeleteScheduledAction");
            scope.Start();
            try
            {
                var response = await ScheduledActionsRestClient.VirtualMachinesSubmitDeleteAsync(Id.SubscriptionId, locationparameter, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationparameter"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationparameter"/> or <paramref name="content"/> is null. </exception>
        public virtual Response<DeleteResourceOperationResponse> VirtualMachinesSubmitDeleteScheduledAction(string locationparameter, SubmitDeleteContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationparameter, nameof(locationparameter));
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = ScheduledActionsRestClient.VirtualMachinesSubmitDelete(Id.SubscriptionId, locationparameter, content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
