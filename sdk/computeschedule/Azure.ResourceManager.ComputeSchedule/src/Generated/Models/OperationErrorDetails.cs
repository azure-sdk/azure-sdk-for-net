...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class OperationErrorDetails
    {
        ...
        internal OperationErrorDetails(string errorCode, string errorDetails, DateTimeOffset? timestamp, DateTimeOffset? timeStamp, string azureOperationName, string crpOperationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
            ErrorDetails = errorDetails;
            Timestamp = timestamp;
