...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ResourceProvisionPayload
    {
        ...
        {
            ResourceOverrides = new ChangeTrackingList<string>();
        ...
        internal ResourceProvisionPayload(string baseProfile, IList<string> resourceOverrides, int resourceCount, string resourcePrefix, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public IList<string> ResourceOverrides { get; }
