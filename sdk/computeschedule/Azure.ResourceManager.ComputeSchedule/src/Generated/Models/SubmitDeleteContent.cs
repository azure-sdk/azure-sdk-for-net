...
{
    /// <summary> The SubmitDeleteRequest request for delete operations. </summary>
    public partial class SubmitDeleteContent
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SubmitDeleteContent"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="schedule"/>, <paramref name="executionParameters"/> or <paramref name="resources"/> is null. </exception>
        public SubmitDeleteContent(UserRequestSchedule schedule, ScheduledActionExecutionParameterDetail executionParameters, UserRequestResources resources)
        {
        ...
        internal SubmitDeleteContent(UserRequestSchedule schedule, ScheduledActionExecutionParameterDetail executionParameters, UserRequestResources resources, string correlationid, bool? forceDeletion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Schedule = schedule;
            ExecutionParameters = executionParameters;
            Resources = resources;
        ...
        /// <summary> Initializes a new instance of <see cref="SubmitDeleteContent"/> for deserialization. </summary>
        internal SubmitDeleteContent()
        {
        }
