...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class DeallocateResourceOperationResponse
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="description"/>, <paramref name="type"/> or <paramref name="location"/> is null. </exception>
        internal DeallocateResourceOperationResponse(string description, string type, string location)
        {
        ...
        internal DeallocateResourceOperationResponse(string description, string type, string location, IReadOnlyList<ResourceOperation> results, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Description = description;
            Type = type;
            Location = location;
