...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public static partial class ArmComputeScheduleModelFactory
    {
        ...
        /// <param name="type"> The type of resources used in the deallocate request eg virtual machines. </param>
        ...
        public static DeallocateResourceOperationResponse DeallocateResourceOperationResponse(string description = null, string type = null, string location = null, IEnumerable<ResourceOperation> results = null)
        {
            results ??= new List<ResourceOperation>();

            return new DeallocateResourceOperationResponse(description, type, location, results?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        /// <param name="description"> The description of the operation response. </param>
        /// <param name="type"> The type of resources used in the Hibernate request eg virtual machines. </param>
        ...
        public static HibernateResourceOperationResponse HibernateResourceOperationResponse(string description = null, string type = null, string location = null, IEnumerable<ResourceOperation> results = null)
        {
            results ??= new List<ResourceOperation>();

            return new HibernateResourceOperationResponse(description, type, location, results?.ToList(), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.StartResourceOperationResponse"/>. </summary>
        /// <param name="description"> The description of the operation response. </param>
        /// <param name="type"> The type of resources used in the start request eg virtual machines. </param>
        ...
        public static StartResourceOperationResponse StartResourceOperationResponse(string description = null, string type = null, string location = null, IEnumerable<ResourceOperation> results = null)
        {
            results ??= new List<ResourceOperation>();

            return new StartResourceOperationResponse(description, type, location, results?.ToList(), serializedAdditionalRawData: null);
        }
