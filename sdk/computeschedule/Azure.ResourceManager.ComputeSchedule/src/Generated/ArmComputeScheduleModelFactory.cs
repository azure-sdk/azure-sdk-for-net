...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public static partial class ArmComputeScheduleModelFactory
    {
        ...
        public static ResourceProvisionPayload ResourceProvisionPayload(string baseProfile = null, IEnumerable<string> resourceOverrides = null, int resourceCount = default, string resourcePrefix = null)
        {
            resourceOverrides ??= new List<string>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.SubmitCreateContent"/>. </summary>
        /// <param name="schedule"> The schedule for the request. </param>
        /// <param name="resourceConfigParameters"> resource creation payload. </param>
        /// <param name="executionParameters"> The execution parameters for the request. </param>
        /// <param name="correlationid"> CorrelationId item. </param>
        /// <returns> A new <see cref="Models.SubmitCreateContent"/> instance for mocking. </returns>
        public static SubmitCreateContent SubmitCreateContent(UserRequestSchedule schedule = null, ResourceProvisionPayload resourceConfigParameters = null, ScheduledActionExecutionParameterDetail executionParameters = null, string correlationid = null)
        {
            return new SubmitCreateContent(schedule, resourceConfigParameters, executionParameters, correlationid, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.SubmitDeleteContent"/>. </summary>
        /// <param name="schedule"> The schedule for the request. </param>
        /// <param name="executionParameters"> The execution parameters for the request. </param>
        /// <param name="resourcesIds"> The resources for the request. </param>
        /// <param name="correlationid"> CorrelationId item. </param>
        /// <param name="forceDeletion"> Forced delete resource item. </param>
        /// <returns> A new <see cref="Models.SubmitDeleteContent"/> instance for mocking. </returns>
        public static SubmitDeleteContent SubmitDeleteContent(UserRequestSchedule schedule = null, ScheduledActionExecutionParameterDetail executionParameters = null, IEnumerable<ResourceIdentifier> resourcesIds = null, string correlationid = null, bool? forceDeletion = null)
        {
            resourcesIds ??= new List<ResourceIdentifier>();
            ...
            return new SubmitDeleteContent(
                schedule,
                executionParameters,
                resourcesIds != null ? new UserRequestResources(resourcesIds?.ToList(), serializedAdditionalRawData: null) : null,
                correlationid,
                forceDeletion,
                serializedAdditionalRawData: null);
        }
