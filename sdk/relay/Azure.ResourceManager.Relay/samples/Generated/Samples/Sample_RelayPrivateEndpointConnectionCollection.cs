...
namespace Azure.ResourceManager.Relay.Samples
{
    public partial class Sample_RelayPrivateEndpointConnectionCollection
    {
        ...
        {
            // Generated from example definition: specification/relay/resource-manager/Microsoft.Relay/stable/2024-01-01/examples/PrivateEndpointConnections/PrivateEndpointConnectionsList.json
        ...
        public async Task Get_NameSpacePrivateEndPointConnectionGet()
        {
            ...
            // invoke the operation
            string privateEndpointConnectionName = "{privateEndpointConnection name}";
            RelayPrivateEndpointConnectionResource result = await collection.GetAsync(privateEndpointConnectionName);
