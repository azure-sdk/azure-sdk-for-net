...
namespace Azure.ResourceManager.HybridConnectivity
{
    internal partial class ServiceconfigurationsRestOperations
    {
        ...
        internal HttpMessage CreateCreateRequest(string scope, string endpointName, string serviceConfigurationName, ServiceConfigurationResourceData data)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<ServiceConfigurationResourceData>> CreateAsync(string scope, string endpointName, string serviceConfigurationName, ServiceConfigurationResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(scope, nameof(scope));
            Argument.AssertNotNull(endpointName, nameof(endpointName));
            Argument.AssertNotNull(serviceConfigurationName, nameof(serviceConfigurationName));
            ...
            using var message = CreateCreateRequest(scope, endpointName, serviceConfigurationName, data);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="scope"/>, <paramref name="endpointName"/>, <paramref name="serviceConfigurationName"/> or <paramref name="data"/> is null. </exception>
        public Response<ServiceConfigurationResourceData> Create(string scope, string endpointName, string serviceConfigurationName, ServiceConfigurationResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(scope, nameof(scope));
            Argument.AssertNotNull(endpointName, nameof(endpointName));
            Argument.AssertNotNull(serviceConfigurationName, nameof(serviceConfigurationName));
