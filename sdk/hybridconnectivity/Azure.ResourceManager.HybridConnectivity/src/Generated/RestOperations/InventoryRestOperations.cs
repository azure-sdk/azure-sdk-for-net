...
namespace Azure.ResourceManager.HybridConnectivity
{
    internal partial class InventoryRestOperations
    {
        ...
        internal RequestUriBuilder CreateListByWidgetRequestUri(string resourceUri, string solutionConfiguration)
        {
        ...
        internal HttpMessage CreateListByWidgetRequest(string resourceUri, string solutionConfiguration)
        {
        ...
        public async Task<Response<InventoryResourceListResult>> ListByWidgetAsync(string resourceUri, string solutionConfiguration, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
            Argument.AssertNotNullOrEmpty(solutionConfiguration, nameof(solutionConfiguration));

            using var message = CreateListByWidgetRequest(resourceUri, solutionConfiguration);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceUri"/> or <paramref name="solutionConfiguration"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="solutionConfiguration"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<InventoryResourceListResult> ListByWidget(string resourceUri, string solutionConfiguration, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
            Argument.AssertNotNullOrEmpty(solutionConfiguration, nameof(solutionConfiguration));
        ...
        public async Task<Response<InventoryResourceData>> GetAsync(string resourceUri, string solutionConfiguration, string inventoryId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
            Argument.AssertNotNullOrEmpty(solutionConfiguration, nameof(solutionConfiguration));
            ...
            switch (message.Response.Status)
            {
                ...
                case 404:
                    return Response.FromValue((InventoryResourceData)null, message.Response);
                default:
                    throw new RequestFailedException(message.Response);
            }
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceUri"/>, <paramref name="solutionConfiguration"/> or <paramref name="inventoryId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="solutionConfiguration"/> or <paramref name="inventoryId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<InventoryResourceData> Get(string resourceUri, string solutionConfiguration, string inventoryId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
            Argument.AssertNotNullOrEmpty(solutionConfiguration, nameof(solutionConfiguration));
            Argument.AssertNotNullOrEmpty(inventoryId, nameof(inventoryId));
        ...
        internal RequestUriBuilder CreateListByWidgetNextPageRequestUri(string nextLink, string resourceUri, string solutionConfiguration)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
        ...
        internal HttpMessage CreateListByWidgetNextPageRequest(string nextLink, string resourceUri, string solutionConfiguration)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <exception cref="ArgumentException"> <paramref name="solutionConfiguration"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<InventoryResourceListResult>> ListByWidgetNextPageAsync(string nextLink, string resourceUri, string solutionConfiguration, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(nextLink, nameof(nextLink));
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
            Argument.AssertNotNullOrEmpty(solutionConfiguration, nameof(solutionConfiguration));

            using var message = CreateListByWidgetNextPageRequest(nextLink, resourceUri, solutionConfiguration);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/>, <paramref name="resourceUri"/> or <paramref name="solutionConfiguration"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="solutionConfiguration"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<InventoryResourceListResult> ListByWidgetNextPage(string nextLink, string resourceUri, string solutionConfiguration, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(nextLink, nameof(nextLink));
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
            Argument.AssertNotNullOrEmpty(solutionConfiguration, nameof(solutionConfiguration));
