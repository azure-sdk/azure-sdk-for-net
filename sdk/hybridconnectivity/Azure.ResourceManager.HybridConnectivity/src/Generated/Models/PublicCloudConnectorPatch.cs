...
namespace Azure.ResourceManager.HybridConnectivity.Models
{
    ...
    public partial class PublicCloudConnectorPatch : ResourceData
    {
        ...
        internal PublicCloudConnectorPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AwsCloudProfileUpdate awsCloudProfile, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
