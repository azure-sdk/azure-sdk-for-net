...
namespace Azure.ResourceManager.HybridConnectivity
{
    public partial class ServiceConfigurationResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ServiceConfigurationResourceData DeserializeServiceConfigurationResourceData(JsonElement element)
        {
            ...
            Optional<Result> provisioningState = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("provisioningState"u8))
                        {
                            ...
                            provisioningState = new Result(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
            ...
            return new ServiceConfigurationResourceData(id, name, type, systemData.Value, Optional.ToNullable(serviceName), resourceId.Value, port.Value, Optional.ToNullable(provisioningState), createdBy.Value, Optional.ToNullable(createdByType), Optional.ToNullable(createdAt), lastModifiedBy.Value, Optional.ToNullable(lastModifiedByType), Optional.ToNullable(lastModifiedAt));
        }
    }
}
