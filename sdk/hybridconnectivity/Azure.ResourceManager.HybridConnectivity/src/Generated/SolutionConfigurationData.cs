...
namespace Azure.ResourceManager.HybridConnectivity
{
    ...
    public partial class SolutionConfigurationData : ResourceData
    {
        ...
        internal SolutionConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceProvisioningState? provisioningState, string solutionType, IDictionary<string, string> solutionSettings, SolutionConfigurationStatus? status, string statusDetails, DateTimeOffset? lastSyncOn, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
