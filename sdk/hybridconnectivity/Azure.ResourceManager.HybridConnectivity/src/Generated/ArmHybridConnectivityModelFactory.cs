...
namespace Azure.ResourceManager.HybridConnectivity.Models
{
    ...
    public static partial class ArmHybridConnectivityModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.TestPermissionResult"/>. </summary>
        /// <param name="solutionTypes"> Solution type permissions. </param>
        /// <returns> A new <see cref="Models.TestPermissionResult"/> instance for mocking. </returns>
        public static TestPermissionResult TestPermissionResult(IEnumerable<SolutionTypePermissions> solutionTypes = null)
        {
            solutionTypes ??= new List<SolutionTypePermissions>();

            return new TestPermissionResult(solutionTypes?.ToList(), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.SolutionTypePermissions"/>. </summary>
        /// <param name="solutionType"> The name of solution Type. </param>
        /// <param name="status"> The status. </param>
        /// <param name="statusDetails"> The details of the status. </param>
        /// <returns> A new <see cref="Models.SolutionTypePermissions"/> instance for mocking. </returns>
        public static SolutionTypePermissions SolutionTypePermissions(SolutionTypeEnum solutionType = default, Status status = default, string statusDetails = null)
        {
            return new SolutionTypePermissions(solutionType, status, statusDetails, serializedAdditionalRawData: null);
        }
