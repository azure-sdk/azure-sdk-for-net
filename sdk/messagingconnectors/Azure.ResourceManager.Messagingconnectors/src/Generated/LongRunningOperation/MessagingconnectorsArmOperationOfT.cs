...
#pragma warning disable SA1649 // File name should match first type name
    internal class MessagingconnectorsArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal MessagingconnectorsArmOperation(Response<T> response)
        {
            _operation = OperationInternal<T>.Succeeded(response.GetRawResponse(), response.Value);
        }

        internal MessagingconnectorsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(nextLinkOperation, clientDiagnostics, response, "MessagingconnectorsArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
