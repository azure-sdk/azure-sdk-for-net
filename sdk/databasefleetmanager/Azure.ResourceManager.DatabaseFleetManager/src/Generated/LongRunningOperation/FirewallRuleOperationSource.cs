...
namespace Azure.ResourceManager.DatabaseFleetManager
{
    internal class FirewallRuleOperationSource : IOperationSource<FirewallRuleResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<FirewallRuleData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerDatabaseFleetManagerContext.Default);
