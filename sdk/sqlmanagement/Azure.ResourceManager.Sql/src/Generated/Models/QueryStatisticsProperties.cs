...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class QueryStatisticsProperties
    {
        ...
        internal QueryStatisticsProperties(string databaseName, string queryId, string startTime, string endTime, IReadOnlyList<QueryMetricIntervalAutoGenerated> intervals)
        {
