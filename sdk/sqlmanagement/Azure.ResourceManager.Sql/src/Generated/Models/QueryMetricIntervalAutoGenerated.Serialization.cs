...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static QueryMetricIntervalAutoGenerated DeserializeQueryMetricIntervalAutoGenerated(JsonElement element)
        {
            ...
            return new QueryMetricIntervalAutoGenerated(intervalStartTime.Value, Optional.ToNullable(intervalType), Optional.ToNullable(executionCount), Optional.ToList(metrics));
        }
    }
}
