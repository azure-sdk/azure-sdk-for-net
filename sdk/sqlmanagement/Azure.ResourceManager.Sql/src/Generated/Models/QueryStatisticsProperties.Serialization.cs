...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class QueryStatisticsProperties : IUtf8JsonSerializable, IJsonModel<QueryStatisticsProperties>
    {
        ...
        void IJsonModel<QueryStatisticsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(Intervals is ChangeTrackingList<QueryMetricIntervalAutoGenerated> collection && collection.IsUndefined))
            {
        ...
        internal static QueryStatisticsProperties DeserializeQueryStatisticsProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<QueryMetricIntervalAutoGenerated> intervals = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("intervals"u8))
                {
                    ...
                    List<QueryMetricIntervalAutoGenerated> array = new List<QueryMetricIntervalAutoGenerated>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(QueryMetricIntervalAutoGenerated.DeserializeQueryMetricIntervalAutoGenerated(item, options));
                    }
                    intervals = array;
                    continue;
                }
            ...
            return new QueryStatisticsProperties(
                ...
                startTime,
                endTime,
                intervals ?? new ChangeTrackingList<QueryMetricIntervalAutoGenerated>(),
