...
{
    public partial class RefreshExternalGovernanceStatusOperationResultMI : IUtf8JsonSerializable, IJsonModel<RefreshExternalGovernanceStatusOperationResultMI>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RefreshExternalGovernanceStatusOperationResultMI>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<RefreshExternalGovernanceStatusOperationResultMI>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RefreshExternalGovernanceStatusOperationResultMI>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RefreshExternalGovernanceStatusOperationResultMI)} does not support writing '{format}' format.");
            }
        ...
        RefreshExternalGovernanceStatusOperationResultMI IJsonModel<RefreshExternalGovernanceStatusOperationResultMI>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RefreshExternalGovernanceStatusOperationResultMI>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RefreshExternalGovernanceStatusOperationResultMI)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeRefreshExternalGovernanceStatusOperationResultMI(document.RootElement, options);
        }

        internal static RefreshExternalGovernanceStatusOperationResultMI DeserializeRefreshExternalGovernanceStatusOperationResultMI(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<RefreshExternalGovernanceStatusOperationResultMI>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RefreshExternalGovernanceStatusOperationResultMI>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RefreshExternalGovernanceStatusOperationResultMI)} does not support writing '{options.Format}' format.");
            }
        }

        RefreshExternalGovernanceStatusOperationResultMI IPersistableModel<RefreshExternalGovernanceStatusOperationResultMI>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RefreshExternalGovernanceStatusOperationResultMI>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RefreshExternalGovernanceStatusOperationResultMI)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<RefreshExternalGovernanceStatusOperationResultMI>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
