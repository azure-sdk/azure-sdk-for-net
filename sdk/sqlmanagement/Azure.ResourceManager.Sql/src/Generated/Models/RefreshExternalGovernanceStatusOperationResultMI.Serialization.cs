...
{
    public partial class RefreshExternalGovernanceStatusOperationResultMI : IUtf8JsonSerializable
    {
        ...
        internal static RefreshExternalGovernanceStatusOperationResultMI DeserializeRefreshExternalGovernanceStatusOperationResultMI(JsonElement element)
        {
            ...
            return new RefreshExternalGovernanceStatusOperationResultMI(id, name, type, systemData.Value, Optional.ToNullable(requestId), requestType.Value, queuedTime.Value, managedInstanceName.Value, status.Value, errorMessage.Value);
        }
    }
}
