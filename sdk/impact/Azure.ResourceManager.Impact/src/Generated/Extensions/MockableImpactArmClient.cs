...
namespace Azure.ResourceManager.Impact.Mocking
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="MockableImpactArmClient"/> class for mocking. </summary>
        protected MockableImpactArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableImpactArmClient"/> class. </summary>
