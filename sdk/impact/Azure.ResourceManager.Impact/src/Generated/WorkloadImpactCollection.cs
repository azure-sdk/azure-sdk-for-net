...
namespace Azure.ResourceManager.Impact
{
    ...
    public partial class WorkloadImpactCollection : ArmCollection, IEnumerable<WorkloadImpactResource>, IAsyncEnumerable<WorkloadImpactResource>
    {
        ...
        {
            _workloadImpactClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Impact", WorkloadImpactResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<WorkloadImpactResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string workloadImpactName, WorkloadImpactData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ImpactArmOperation<WorkloadImpactResource>(new WorkloadImpactOperationSource(Client), _workloadImpactClientDiagnostics, Pipeline, _workloadImpactRestClient.CreateCreateRequest(Id.SubscriptionId, workloadImpactName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
