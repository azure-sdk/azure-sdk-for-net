...
namespace Azure.ResourceManager.Impact
{
    ...
    /// </summary>
    public partial class ImpactCategoryCollection : ArmCollection, IEnumerable<ImpactCategoryResource>, IAsyncEnumerable<ImpactCategoryResource>
    {
        ...
        public virtual AsyncPageable<ImpactCategoryResource> GetAllAsync(string categoryName = null, string resourceType = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<ImpactCategoryResource> GetAll(string categoryName = null, string resourceType = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _impactCategoryRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, categoryName, resourceType);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _impactCategoryRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, categoryName, resourceType);
        ...
        IEnumerator<ImpactCategoryResource> IEnumerable<ImpactCategoryResource>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<ImpactCategoryResource> IAsyncEnumerable<ImpactCategoryResource>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
