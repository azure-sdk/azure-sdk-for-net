...
#pragma warning disable SA1649 // File name should match first type name
    internal class GraphservicesprodArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal GraphservicesprodArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal GraphservicesprodArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "GraphservicesprodArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
