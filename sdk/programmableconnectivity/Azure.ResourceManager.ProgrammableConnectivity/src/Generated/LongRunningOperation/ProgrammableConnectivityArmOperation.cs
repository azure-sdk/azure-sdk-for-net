...
#pragma warning disable SA1649 // File name should match first type name
    internal class ProgrammableConnectivityArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ProgrammableConnectivityArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ProgrammableConnectivityArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ProgrammableConnectivityArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
