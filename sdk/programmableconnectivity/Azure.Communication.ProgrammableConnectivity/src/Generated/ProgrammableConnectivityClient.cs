...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class ProgrammableConnectivityClient
    {
        ...
        public virtual DeviceLocation GetDeviceLocationClient(string apiVersion = "v2024_01_09_preview")
        {
        ...
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
        public virtual DeviceNetwork GetDeviceNetworkClient(string apiVersion = "v2024_01_09_preview")
        {
            Argument.AssertNotNull(apiVersion, nameof(apiVersion));
        ...
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
        public virtual NumberVerification GetNumberVerificationClient(string apiVersion = "v2024_01_09_preview")
        {
            Argument.AssertNotNull(apiVersion, nameof(apiVersion));
        ...
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
        public virtual SimSwap GetSimSwapClient(string apiVersion = "v2024_01_09_preview")
        {
            Argument.AssertNotNull(apiVersion, nameof(apiVersion));
