...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SimSwapVerificationContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SimSwapVerificationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SimSwapVerificationContent)} does not support '{format}' format.");
            }
        ...
        internal static SimSwapVerificationContent DeserializeSimSwapVerificationContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<int> maxAgeHours = default;
            ...
            return new SimSwapVerificationContent(phoneNumber.Value, Optional.ToNullable(maxAgeHours), networkIdentifier, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SimSwapVerificationContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SimSwapVerificationContent)} does not support '{options.Format}' format.");
            }
        }
