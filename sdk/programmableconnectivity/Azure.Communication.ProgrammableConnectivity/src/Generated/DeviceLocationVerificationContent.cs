...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class DeviceLocationVerificationContent
    {
        ...
        internal DeviceLocationVerificationContent(NetworkIdentifier networkIdentifier, float latitude, float longitude, int accuracy, LocationDevice locationDevice, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NetworkIdentifier = networkIdentifier;
            Latitude = latitude;
            Longitude = longitude;
