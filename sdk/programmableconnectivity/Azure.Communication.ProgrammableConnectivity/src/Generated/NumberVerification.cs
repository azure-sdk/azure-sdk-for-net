...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class NumberVerification
    {
        ...
        {
            if (apcGatewayId == null)
            {
                throw new ArgumentNullException(nameof(apcGatewayId));
            }
            if (numberVerificationWithoutCodeContent == null)
            {
                throw new ArgumentNullException(nameof(numberVerificationWithoutCodeContent));
            }
        ...
        public virtual async Task<Response<NumberVerificationResult>> VerifyWithCodeAsync(string apcGatewayId, NumberVerificationWithCodeContent numberVerificationWithCodeContent, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentNullException(nameof(numberVerificationWithCodeContent));
            }
