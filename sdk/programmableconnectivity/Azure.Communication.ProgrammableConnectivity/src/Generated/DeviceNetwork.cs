...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class DeviceNetwork
    {
        ...
        /// <include file="Docs/DeviceNetwork.xml" path="doc/members/member[@name='RetrieveAsync(string,DeviceNetworkIdentifier,CancellationToken)']/*" />
        public virtual async Task<Response<NetworkRetrievalResult>> RetrieveAsync(string apcGatewayId, DeviceNetworkIdentifier deviceNetworkIdentifier, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apcGatewayId"/> or <paramref name="deviceNetworkIdentifier"/> is null. </exception>
        /// <include file="Docs/DeviceNetwork.xml" path="doc/members/member[@name='Retrieve(string,DeviceNetworkIdentifier,CancellationToken)']/*" />
        public virtual Response<NetworkRetrievalResult> Retrieve(string apcGatewayId, DeviceNetworkIdentifier deviceNetworkIdentifier, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(apcGatewayId, nameof(apcGatewayId));
            Argument.AssertNotNull(deviceNetworkIdentifier, nameof(deviceNetworkIdentifier));
