...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public static partial class CommunicationProgrammableConnectivityModelFactory
    {
        ...
        public static NumberVerificationWithoutCodeContent NumberVerificationWithoutCodeContent(NetworkIdentifier networkIdentifier = null, string phoneNumber = null, string hashedPhoneNumber = null)
        {
            return new NumberVerificationWithoutCodeContent(networkIdentifier, phoneNumber, hashedPhoneNumber, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="ProgrammableConnectivity.NumberVerificationWithCodeContent"/>. </summary>
        /// <param name="networkIdentifier"> Identifier for the network to query for this device. </param>
        /// <param name="phoneNumber"> Phone number in E.164 format (starting with country code), and optionally prefixed with '+'. </param>
        /// <param name="hashedPhoneNumber"> Hashed phone number. SHA-256 (in hexadecimal representation) of the mobile phone number in **E.164 format (starting with country code)**. Optionally prefixed with '+'. </param>
        ...
        public static NumberVerificationWithCodeContent NumberVerificationWithCodeContent(NetworkIdentifier networkIdentifier = null, string phoneNumber = null, string hashedPhoneNumber = null, string apcCode = null)
        {
            return new NumberVerificationWithCodeContent(networkIdentifier, phoneNumber, hashedPhoneNumber, apcCode, serializedAdditionalRawData: null);
        }
