...
namespace Azure.Communication.ProgrammableConnectivity.Samples
{
    public partial class Samples_NumberVerification
    {
        ...
        public void Example_NumberVerification_VerifyWithoutCode_ShortVersion_Convenience()
        {
            ...
            NumberVerificationWithoutCodeContent numberVerificationWithoutCodeContent = new NumberVerificationWithoutCodeContent(new NetworkIdentifier("<identifierType>", "<identifier>"));
        ...
        public void Example_NumberVerification_VerifyWithCode_ShortVersion_Convenience()
        {
            ...
            NumberVerificationWithCodeContent numberVerificationWithCodeContent = new NumberVerificationWithCodeContent(new NetworkIdentifier("<identifierType>", "<identifier>"), "<apcCode>");
