...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public partial class AutonomousDatabaseActionContent
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AutonomousDatabaseActionContent"/>. </summary>
        /// <param name="peerDBId"> The Azure ID of the Disaster Recovery peer database, which is located in a different region from the current peer database. </param>
        ...
        /// <summary> The Azure ID of the Disaster Recovery peer database, which is located in a different region from the current peer database. </summary>
