...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    public partial class AutonomousDatabaseFromBackupTimestampProperties : IUtf8JsonSerializable, IJsonModel<AutonomousDatabaseFromBackupTimestampProperties>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UseLatestAvailableBackupTimeStamp))
            {
                writer.WritePropertyName("useLatestAvailableBackupTimeStamp"u8);
                writer.WriteBooleanValue(UseLatestAvailableBackupTimeStamp.Value);
            }
        }
        ...
        internal static AutonomousDatabaseFromBackupTimestampProperties DeserializeAutonomousDatabaseFromBackupTimestampProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AutonomousDatabaseFromBackupTimestampPropertiesSource source = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    source = new AutonomousDatabaseFromBackupTimestampPropertiesSource(property.Value.GetString());
                    continue;
                }
