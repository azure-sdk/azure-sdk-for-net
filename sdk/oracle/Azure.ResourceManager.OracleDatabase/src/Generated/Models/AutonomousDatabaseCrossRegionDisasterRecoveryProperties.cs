...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public partial class AutonomousDatabaseCrossRegionDisasterRecoveryProperties : AutonomousDatabaseBaseProperties
    {
        ...
        /// <param name="sourceId"> The Azure resource ID of the source Autonomous Database that will be used to create a new peer database for the DR association. </param>
        ...
        /// <summary> The Azure resource ID of the source Autonomous Database that will be used to create a new peer database for the DR association. </summary>
