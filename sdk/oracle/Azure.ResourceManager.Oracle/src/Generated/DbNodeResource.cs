    ...
    public partial class DbNodeResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DbNodeResource>> ActionAsync(WaitUntil waitUntil, DbNodeAction body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new OracleArmOperation<DbNodeResource>(new DbNodeOperationSource(Client), _dbNodeClientDiagnostics, Pipeline, _dbNodeRestClient.CreateActionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, body).Request, response, OperationFinalStateVia.Location);
