...
namespace Azure.ResourceManager.Oracle.Models
{
    ...
    public static partial class ArmOracleModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Oracle.SystemVersionData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        /// <param name="systemVersion"> The resource-specific properties for this resource. </param>
        /// <returns> A new <see cref="Oracle.SystemVersionData"/> instance for mocking. </returns>
