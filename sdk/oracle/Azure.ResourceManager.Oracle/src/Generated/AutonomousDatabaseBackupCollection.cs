...
namespace Azure.ResourceManager.Oracle
{
    ...
    public partial class AutonomousDatabaseBackupCollection : ArmCollection, IEnumerable<AutonomousDatabaseBackupResource>, IAsyncEnumerable<AutonomousDatabaseBackupResource>
    {
        ...
        {
            _autonomousDatabaseBackupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Oracle", AutonomousDatabaseBackupResource.ResourceType.Namespace, Diagnostics);
