...
#pragma warning disable SA1649 // File name should match first type name
    internal class OracleArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of OracleArmOperation for mocking. </summary>
        protected OracleArmOperation()
        {
        }

        internal OracleArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal OracleArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "OracleArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
