...
#pragma warning disable SA1649 // File name should match first type name
    internal class OracleArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal OracleArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal OracleArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "OracleArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
