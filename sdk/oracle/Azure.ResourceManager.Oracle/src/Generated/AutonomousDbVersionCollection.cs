...
namespace Azure.ResourceManager.Oracle
{
    ...
    public partial class AutonomousDbVersionCollection : ArmCollection, IEnumerable<AutonomousDbVersionResource>, IAsyncEnumerable<AutonomousDbVersionResource>
    {
        ...
        {
            _location = location;
            _autonomousDbVersionAutonomousDatabaseVersionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Oracle", AutonomousDbVersionResource.ResourceType.Namespace, Diagnostics);
