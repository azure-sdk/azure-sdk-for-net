...
namespace Azure.ResourceManager.Oracle
{
    ...
    public partial class CloudVmClusterCollection : ArmCollection, IEnumerable<CloudVmClusterResource>, IAsyncEnumerable<CloudVmClusterResource>
    {
        ...
        {
            _cloudVmClusterClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Oracle", CloudVmClusterResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<CloudVmClusterResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string cloudvmclustername, CloudVmClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new OracleArmOperation<CloudVmClusterResource>(new CloudVmClusterOperationSource(Client), _cloudVmClusterClientDiagnostics, Pipeline, _cloudVmClusterRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, cloudvmclustername, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
