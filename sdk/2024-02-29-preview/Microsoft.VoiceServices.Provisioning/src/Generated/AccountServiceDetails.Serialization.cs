...
namespace Microsoft.VoiceServices.Provisioning
{
    public partial class AccountServiceDetails : IUtf8JsonSerializable, IJsonModel<AccountServiceDetails>
    {
        ...
        void IJsonModel<AccountServiceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AccountServiceDetails)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (TeamsTenantId != null)
            {
        ...
        BinaryData IPersistableModel<AccountServiceDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AccountServiceDetails)} does not support '{options.Format}' format.");
            }
        }
