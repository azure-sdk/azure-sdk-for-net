...
{
    public partial class AccountServiceDetails : IUtf8JsonWriteable, IJsonModel<AccountServiceDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AccountServiceDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AccountServiceDetails FromResponse(PipelineResponse response)
        {
