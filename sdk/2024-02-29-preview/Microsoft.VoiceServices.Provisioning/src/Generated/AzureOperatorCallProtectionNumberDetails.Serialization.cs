...
namespace Microsoft.VoiceServices.Provisioning
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureOperatorCallProtectionNumberDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
