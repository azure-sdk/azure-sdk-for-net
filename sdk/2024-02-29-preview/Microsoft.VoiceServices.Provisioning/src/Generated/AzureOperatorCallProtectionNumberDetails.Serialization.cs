...
{
    public partial class AzureOperatorCallProtectionNumberDetails : IUtf8JsonWriteable, IJsonModel<AzureOperatorCallProtectionNumberDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureOperatorCallProtectionNumberDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AzureOperatorCallProtectionNumberDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureOperatorCallProtectionNumberDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureOperatorCallProtectionNumberDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureOperatorCallProtectionNumberDetails)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static AzureOperatorCallProtectionNumberDetails FromResponse(PipelineResponse response)
        {
