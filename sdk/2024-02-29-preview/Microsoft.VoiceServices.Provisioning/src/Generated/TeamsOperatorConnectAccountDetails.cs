...
{
    /// <summary> Account details specific to Teams Operator Connect on this Account. </summary>
    public partial class TeamsOperatorConnectAccountDetails
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TeamsOperatorConnectAccountDetails"/>. </summary>
        ...
        public TeamsOperatorConnectAccountDetails(bool syncEnabled, bool enabled)
        {
        ...
        internal TeamsOperatorConnectAccountDetails(bool syncEnabled, bool enabled, long? numberCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SyncEnabled = syncEnabled;
            Enabled = enabled;
        ...
        /// <summary> Initializes a new instance of <see cref="TeamsOperatorConnectAccountDetails"/> for deserialization. </summary>
        internal TeamsOperatorConnectAccountDetails()
        {
        }
