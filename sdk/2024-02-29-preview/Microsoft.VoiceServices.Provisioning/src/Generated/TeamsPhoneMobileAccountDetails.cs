...
{
    /// <summary> Account details specific to Teams Phone Mobile. </summary>
    public partial class TeamsPhoneMobileAccountDetails
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TeamsPhoneMobileAccountDetails"/>. </summary>
        ...
        public TeamsPhoneMobileAccountDetails(bool syncEnabled, bool enabled)
        {
        ...
        internal TeamsPhoneMobileAccountDetails(bool syncEnabled, bool enabled, long? numberCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SyncEnabled = syncEnabled;
            Enabled = enabled;
        ...
        /// <summary> Initializes a new instance of <see cref="TeamsPhoneMobileAccountDetails"/> for deserialization. </summary>
        internal TeamsPhoneMobileAccountDetails()
        {
        }
