...
{
    public partial class TeamsDirectRoutingNumberDetails : IUtf8JsonWriteable, IJsonModel<TeamsDirectRoutingNumberDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TeamsDirectRoutingNumberDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TeamsDirectRoutingNumberDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TeamsDirectRoutingNumberDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TeamsDirectRoutingNumberDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TeamsDirectRoutingNumberDetails)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static TeamsDirectRoutingNumberDetails FromResponse(PipelineResponse response)
        {
