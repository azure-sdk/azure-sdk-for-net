...
{
    /// <summary> Telephone number configuration for Teams Phone Mobile telephone numbers. </summary>
    public partial class TeamsPhoneMobileNumberConfig
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TeamsPhoneMobileNumberConfig"/>. </summary>
        ...
        public TeamsPhoneMobileNumberConfig(string usage, IEnumerable<string> choosableCapabilities)
        {
            if (usage == null)
            {
                throw new ArgumentNullException(nameof(usage));
            }
            if (choosableCapabilities == null)
            {
                throw new ArgumentNullException(nameof(choosableCapabilities));
            }
        ...
        internal TeamsPhoneMobileNumberConfig(string usage, IList<string> choosableCapabilities, IReadOnlyList<string> acquiredCapabilities, IReadOnlyList<string> availableCapabilities, IList<string> additionalUsages, string civicAddressId, string locationId, bool? allowTenantAddressUpdate, string displayedCountryCode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Usage = usage;
        ...
        /// <summary> Initializes a new instance of <see cref="TeamsPhoneMobileNumberConfig"/> for deserialization. </summary>
        internal TeamsPhoneMobileNumberConfig()
        {
        }
