...
{
    public partial class ContactDetails : IUtf8JsonWriteable, IJsonModel<ContactDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContactDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ContactDetails FromResponse(PipelineResponse response)
        {
