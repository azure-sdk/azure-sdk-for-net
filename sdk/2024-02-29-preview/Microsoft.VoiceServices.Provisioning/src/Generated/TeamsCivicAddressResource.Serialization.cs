...
{
    public partial class TeamsCivicAddressResource : IUtf8JsonWriteable, IJsonModel<TeamsCivicAddressResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TeamsCivicAddressResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TeamsCivicAddressResource FromResponse(PipelineResponse response)
        {
