...
namespace Microsoft.VoiceServices.Provisioning
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureOperatorCallProtectionAccountDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
