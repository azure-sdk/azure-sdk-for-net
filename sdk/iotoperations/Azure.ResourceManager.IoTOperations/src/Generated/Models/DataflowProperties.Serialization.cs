...
namespace Azure.ResourceManager.IoTOperations.Models
{
    public partial class DataflowProperties : IUtf8JsonSerializable, IJsonModel<DataflowProperties>
    {
        ...
        internal static DataflowProperties DeserializeDataflowProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<DataflowOperationDetails> operations = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<DataflowOperationDetails> array = new List<DataflowOperationDetails>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(DataflowOperationDetails.DeserializeDataflowOperationDetails(item, options));
                    }
                    operations = array;
                    continue;
                }
