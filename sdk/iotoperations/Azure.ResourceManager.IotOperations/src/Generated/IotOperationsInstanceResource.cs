...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsInstanceResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of DiagnosticResources in the IotOperationsInstance. </summary>
        /// <returns> An object representing collection of DiagnosticResources and their operations over a DiagnosticResource. </returns>
        public virtual DiagnosticResourceCollection GetDiagnosticResources()
        {
            return GetCachedClient(client => new DiagnosticResourceCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DiagnosticResource>> GetDiagnosticResourceAsync(string diagnosticName, CancellationToken cancellationToken = default)
        {
            return await GetDiagnosticResources().GetAsync(diagnosticName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="diagnosticName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<DiagnosticResource> GetDiagnosticResource(string diagnosticName, CancellationToken cancellationToken = default)
        {
            return GetDiagnosticResources().Get(diagnosticName, cancellationToken);
        }
