...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    public partial class DataflowGraphSourceNode : DataflowGraphNode
    {
        ...
        /// <param name="sourceSettings"> Source configuration. </param>
        internal DataflowGraphSourceNode(string name, DataflowGraphNodeType type, IDictionary<string, BinaryData> serializedAdditionalRawData, DataflowGraphSourceSettings sourceSettings) : base(name, type, serializedAdditionalRawData)
        {
            SourceSettings = sourceSettings;
            Type = type;
        }
