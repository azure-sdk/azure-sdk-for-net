...
namespace Azure.ResourceManager.IotOperations.Models
{
    public partial class DataflowEndpointOpenTelemetry : IUtf8JsonSerializable, IJsonModel<DataflowEndpointOpenTelemetry>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MetricIntervalSec))
            {
                writer.WritePropertyName("metricIntervalSec"u8);
                writer.WriteNumberValue(MetricIntervalSec.Value);
            }
        ...
        internal static DataflowEndpointOpenTelemetry DeserializeDataflowEndpointOpenTelemetry(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            {
                if (property.NameEquals("metricIntervalSec"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    metricIntervalSec = property.Value.GetInt32();
                    continue;
                }
            ...
            return new DataflowEndpointOpenTelemetry(metricIntervalSec, host, batching, tls, serializedAdditionalRawData);
        }
