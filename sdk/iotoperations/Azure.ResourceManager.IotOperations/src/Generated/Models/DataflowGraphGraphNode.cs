...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    public partial class DataflowGraphGraphNode : DataflowGraphNode
    {
        ...
        /// <param name="graphSettings"> Graph configuration. </param>
        internal DataflowGraphGraphNode(string name, DataflowGraphNodeType type, IDictionary<string, BinaryData> serializedAdditionalRawData, DataflowGraphNodeGraphSettings graphSettings) : base(name, type, serializedAdditionalRawData)
        {
            GraphSettings = graphSettings;
            Type = type;
        }
