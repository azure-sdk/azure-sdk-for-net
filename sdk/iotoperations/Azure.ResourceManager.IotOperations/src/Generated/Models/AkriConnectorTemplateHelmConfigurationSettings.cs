...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    public partial class AkriConnectorTemplateHelmConfigurationSettings
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="releaseName"/> or <paramref name="version"/> is null. </exception>
        ...
        internal AkriConnectorTemplateHelmConfigurationSettings(AkriConnectorTemplateHelmRegistrySettings registrySettings, string releaseName, string version, AkriConnectorTemplateHelmAdvancedConfiguration advancedConfiguration, IDictionary<string, string> values, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
