...
{
    /// <summary> AkriDiscoveryHandler Image configuration properties. </summary>
    public partial class AkriDiscoveryHandlerImageConfiguration
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AkriDiscoveryHandlerImageConfiguration"/>. </summary>
        ...
        internal AkriDiscoveryHandlerImageConfiguration(string imageName, AkriConnectorsImagePullPolicy? imagePullPolicy, int? replicas, AkriConnectorsRegistrySettings registrySettings, AkriConnectorsTagDigestSettings tagDigestSettings, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ImageName = imageName;
        ...
        /// <summary> Initializes a new instance of <see cref="AkriDiscoveryHandlerImageConfiguration"/> for deserialization. </summary>
        internal AkriDiscoveryHandlerImageConfiguration()
        {
        }
