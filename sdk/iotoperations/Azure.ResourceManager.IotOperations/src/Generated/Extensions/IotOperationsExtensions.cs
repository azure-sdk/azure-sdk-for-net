...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public static partial class IotOperationsExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsArmClient.GetDiagnosticResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static DiagnosticResource GetDiagnosticResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableIotOperationsArmClient(client).GetDiagnosticResource(id);
        }
        ...
        /// <summary>
        /// Gets an object representing an <see cref="AkriDiscoveryHandlerResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="AkriDiscoveryHandlerResource.CreateResourceIdentifier" /> to create an <see cref="AkriDiscoveryHandlerResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsArmClient.GetAkriDiscoveryHandlerResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        /// <returns> Returns a <see cref="AkriDiscoveryHandlerResource"/> object. </returns>
        public static AkriDiscoveryHandlerResource GetAkriDiscoveryHandlerResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableIotOperationsArmClient(client).GetAkriDiscoveryHandlerResource(id);
        }
