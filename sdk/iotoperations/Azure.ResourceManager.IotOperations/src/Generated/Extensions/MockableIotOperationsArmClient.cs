...
namespace Azure.ResourceManager.IotOperations.Mocking
{
    ...
    public partial class MockableIotOperationsArmClient : ArmResource
    {
        ...
        public virtual AkriDiscoveryHandlerResource GetAkriDiscoveryHandlerResource(ResourceIdentifier id)
        {
            AkriDiscoveryHandlerResource.ValidateResourceId(id);
            return new AkriDiscoveryHandlerResource(Client, id);
        }
    }
}
