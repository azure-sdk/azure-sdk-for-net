...
namespace Azure.ResourceManager.IotOperations.Samples
{
    public partial class Sample_AkriConnectorTemplateResourceCollection
    {
        ...
        public async Task CreateOrUpdate_AkriConnectorTemplateCreateOrUpdateMaximumSet()
        {
            ...
            AkriConnectorTemplateResourceData data = new AkriConnectorTemplateResourceData(new IotOperationsExtendedLocation("qmbrfwcpwwhggszhrdjv", IotOperationsExtendedLocationType.CustomLocation))
            {
                Properties = new AkriConnectorTemplateProperties(null, new AkriConnectorTemplateDeviceInboundEndpointType[]
            {
new AkriConnectorTemplateDeviceInboundEndpointType("chkkpymxhp", "chkkpymxhp")
{
ConfigurationSchemaRefs = new AkriConnectorTemplateDeviceInboundEndpointConfigurationSchemaRefs
{
