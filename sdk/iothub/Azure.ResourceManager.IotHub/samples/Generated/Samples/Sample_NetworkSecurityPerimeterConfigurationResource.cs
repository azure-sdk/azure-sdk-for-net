...
namespace Azure.ResourceManager.IotHub.Samples
{
    public partial class Sample_NetworkSecurityPerimeterConfigurationResource
    {
        ...
        public async Task Get_GetAnNSPConfigByName()
        {
            ...
            ResourceIdentifier networkSecurityPerimeterConfigurationResourceId = NetworkSecurityPerimeterConfigurationResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, resourceName, nspConfigName);
        ...
        {
            // Generated from example definition: specification/iothub/resource-manager/Microsoft.Devices/preview/2023-07-15-preview/examples/iothub_NetworkSecurityPerimeterConfigurationsReconcile.json
