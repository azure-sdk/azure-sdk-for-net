...
namespace Azure.ResourceManager.IotHub
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="IotHubDescriptionResource" /> using the GetNetworkSecurityPerimeterConfiguration method.
    /// </summary>
    public partial class NetworkSecurityPerimeterConfigurationResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string resourceName, string nspConfigName)
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{resourceName}/networkSecurityPerimeterConfigurations/{nspConfigName}";
        ...
        {
            _networkSecurityPerimeterConfigurationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.IotHub", ResourceType.Namespace, Diagnostics);
        ...
        public static readonly ResourceType ResourceType = "Microsoft.Devices/IotHubs/networkSecurityPerimeterConfigurations";
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{resourceName}/networkSecurityPerimeterConfigurations/{nspConfigName}/reconcile</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
