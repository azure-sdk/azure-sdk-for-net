...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubRoutingProperties
    {
        ...
        /// <param name="fallbackRoute"> The properties of the route that is used as a fall-back route when none of the conditions specified in the &apos;routes&apos; section are met. This is an optional parameter. When this property is not present in the template, the fallback route gets disabled by default. </param>
        ...
        /// <summary> The properties of the route that is used as a fall-back route when none of the conditions specified in the &apos;routes&apos; section are met. This is an optional parameter. When this property is not present in the template, the fallback route gets disabled by default. </summary>
