...
namespace Azure.ResourceManager.Sphere
{
    ...
    public static partial class SphereExtensions
    {
        ...
        {
            return GetExtensionClient(subscriptionResource).GetCatalogsAsync(cancellationToken);
        }
        ...
        {
            return GetExtensionClient(subscriptionResource).GetCatalogs(cancellationToken);
        }
        ...
        {
            return GetExtensionClient(resourceGroupResource).GetCatalogs();
        }
