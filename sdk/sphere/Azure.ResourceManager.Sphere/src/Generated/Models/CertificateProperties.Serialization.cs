...
namespace Azure.ResourceManager.Sphere.Models
{
    public partial class CertificateProperties
    {
        internal static CertificateProperties DeserializeCertificateProperties(JsonElement element)
        {
            ...
            return new CertificateProperties(certificate.Value, Optional.ToNullable(status), subject.Value, thumbprint.Value, Optional.ToNullable(expiryUtc), Optional.ToNullable(notBeforeUtc), Optional.ToNullable(provisioningState));
        }
    }
}
