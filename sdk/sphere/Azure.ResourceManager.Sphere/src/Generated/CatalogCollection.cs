    ...
    public partial class CatalogCollection : ArmCollection, IEnumerable<CatalogResource>, IAsyncEnumerable<CatalogResource>
    {
        ...
        public virtual async Task<ArmOperation<CatalogResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string catalogName, CatalogData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SphereArmOperation<CatalogResource>(new CatalogOperationSource(Client), _catalogClientDiagnostics, Pipeline, _catalogRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, catalogName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
