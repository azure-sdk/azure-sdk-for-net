...
role = "user",
        ...
        public void Example_Create_ShortVersion_Convenience()
        {
            ...
            ChatCompletionOptionsunknownRecord chatCompletionOptionsunknownRecord = new ChatCompletionOptionsunknownRecord(new ChatMessageunknown[]
            {
new ChatMessageunknown("<content>", ChatRole.User)
            });
            Response<ChatCompletionunknownRecord> response = client.Create(chatCompletionOptionsunknownRecord);
        }
...
new ChatMessageunknown("<content>", ChatRole.User)
            ...
            Response<ChatCompletionunknownRecord> response = await client.CreateAsync(chatCompletionOptionsunknownRecord);
        }
