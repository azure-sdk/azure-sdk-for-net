...
namespace Azure.AI.ChatProtocol
{
    ...
    public partial class ChatCompletionOptionsunknownRecord
    {
        /// <summary> Initializes a new instance of ChatCompletionOptionsunknownRecord. </summary>
        /// <param name="messages"> The collection of context messages associated with this completion request. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="messages"/> is null. </exception>
        public ChatCompletionOptionsunknownRecord(IEnumerable<ChatMessageunknown> messages)
        {
        ...
        /// </param>
        internal ChatCompletionOptionsunknownRecord(IList<ChatMessageunknown> messages, bool stream, BinaryData sessionState, IDictionary<string, BinaryData> context)
        {
            Messages = messages;
            Stream = stream;
