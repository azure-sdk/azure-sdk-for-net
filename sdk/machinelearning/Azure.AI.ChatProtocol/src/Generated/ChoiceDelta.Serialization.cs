...
namespace Azure.AI.ChatProtocol
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChoiceDelta>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ChoiceDelta>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChoiceDelta)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChoiceDelta>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChoiceDelta)} does not support '{options.Format}' format.");
            }
        }
