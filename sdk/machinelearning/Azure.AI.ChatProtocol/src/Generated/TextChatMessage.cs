...
namespace Azure.AI.ChatProtocol
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="TextChatMessage"/>. </summary>
        ...
        /// <param name="content"> The text associated with the message. </param>
        internal TextChatMessage(MessageKind kind, ChatRole role, BinaryData sessionState, IDictionary<string, BinaryData> serializedAdditionalRawData, string content) : base(kind, role, sessionState, serializedAdditionalRawData)
        {
            Content = content;
        }

        /// <summary> Initializes a new instance of <see cref="TextChatMessage"/> for deserialization. </summary>
        internal TextChatMessage()
        {
        }
