...
{
    /// <summary> The CreateStreamingRequest. </summary>
    internal partial class CreateStreamingRequest
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CreateStreamingRequest"/>. </summary>
        /// <param name="messages">
        ...
        internal CreateStreamingRequest(IEnumerable<ChatMessage> messages)
        {
        ...
        internal CreateStreamingRequest(IReadOnlyList<ChatMessage> messages, bool stream, BinaryData sessionState, IReadOnlyDictionary<string, BinaryData> context, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Messages = messages;
            Stream = stream;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateStreamingRequest"/> for deserialization. </summary>
