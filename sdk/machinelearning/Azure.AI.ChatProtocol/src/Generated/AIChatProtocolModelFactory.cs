...
namespace Azure.AI.ChatProtocol
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="ChatProtocol.ChatCompletionOptions"/>. </summary>
        ...
        /// </param>
        /// <returns> A new <see cref="ChatProtocol.ChatCompletionOptions"/> instance for mocking. </returns>
        public static ChatCompletionOptions ChatCompletionOptions(IEnumerable<ChatMessage> messages = null, bool stream = default, BinaryData sessionState = null, IDictionary<string, BinaryData> context = null)
        {
            messages ??= new List<ChatMessage>();
            context ??= new Dictionary<string, BinaryData>();

            return new ChatCompletionOptions(messages?.ToList(), stream, sessionState, context, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="ChatProtocol.ChatCompletion"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ChatProtocol.ChatChoice"/>. </summary>
