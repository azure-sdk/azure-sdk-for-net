...
namespace Azure.AI.ChatProtocol
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="TextChatMessageDelta"/>. </summary>
        ...
        internal TextChatMessageDelta(MessageKind kind, ChatRole? role, BinaryData sessionState, IDictionary<string, BinaryData> serializedAdditionalRawData, string content) : base(kind, role, sessionState, serializedAdditionalRawData)
        {
            Content = content;
        }
