...
namespace Azure.AI.ChatProtocol
{
    ...
    public partial class ChatProtocolClient
    {
        ...
        internal virtual async Task<Response<ChatCompletionDelta>> CreateStreamingAsync(string operationRoute, StreamingChatCompletionOptions streamingChatCompletionOptions, CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue(ChatCompletionDelta.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="operationRoute"/> or <paramref name="streamingChatCompletionOptions"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="operationRoute"/> is an empty string, and was expected to be non-empty. </exception>
        internal virtual Response<ChatCompletionDelta> CreateStreaming(string operationRoute, StreamingChatCompletionOptions streamingChatCompletionOptions, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(operationRoute, nameof(operationRoute));
            Argument.AssertNotNull(streamingChatCompletionOptions, nameof(streamingChatCompletionOptions));
