...
namespace Azure.AI.ChatProtocol
{
    ...
    public partial class ChatChoice
    {
        ...
        internal ChatChoice(long index, ChatMessage message, BinaryData sessionState, IReadOnlyDictionary<string, BinaryData> context, FinishReason finishReason, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Index = index;
            Message = message;
