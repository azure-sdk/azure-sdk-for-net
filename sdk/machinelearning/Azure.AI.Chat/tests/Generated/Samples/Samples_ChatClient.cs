...
role = "user",
        ...
        public void Example_Create_ShortVersion_Convenience()
        {
            ...
            ChatCompletionOptionsunknownRecord chatCompletionOptions = new ChatCompletionOptionsunknownRecord(new ChatMessageunknown[]
            {
new ChatMessageunknown("<content>", ChatRole.User)
            });
            Response<ChatCompletionunknownRecord> response = client.Create(chatCompletionOptions);
        }
...
new ChatMessageunknown("<content>", ChatRole.User)
            ...
            Response<ChatCompletionunknownRecord> response = await client.CreateAsync(chatCompletionOptions);
        }
