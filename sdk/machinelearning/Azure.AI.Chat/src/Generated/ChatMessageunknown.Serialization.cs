...
{
    public partial class ChatMessageunknown : IUtf8JsonSerializable
    {
        ...
        internal static ChatMessageunknown DeserializeChatMessageunknown(JsonElement element)
        {
            ...
            return new ChatMessageunknown(content, role, sessionState.Value);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static ChatMessageunknown FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeChatMessageunknown(document.RootElement);
        }
