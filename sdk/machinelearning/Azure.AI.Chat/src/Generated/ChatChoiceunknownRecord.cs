...
namespace Azure.AI.Chat
{
    ...
    public partial class ChatChoiceunknownRecord
    {
        ...
        internal ChatChoiceunknownRecord(long index, ChatMessageunknown message, FinishReason finishReason)
        {
        ...
        /// <param name="finishReason"> placeholder. </param>
        internal ChatChoiceunknownRecord(long index, ChatMessageunknown message, BinaryData sessionState, IReadOnlyDictionary<string, BinaryData> context, FinishReason finishReason)
        {
            Index = index;
            Message = message;
        ...
        /// <summary> placeholder. </summary>
        public ChatMessageunknown Message { get; }
        /// <summary>
        /// placeholder
        /// <para>
