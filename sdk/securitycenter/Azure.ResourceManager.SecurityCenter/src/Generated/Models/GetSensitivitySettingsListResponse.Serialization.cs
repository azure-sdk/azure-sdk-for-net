...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetSensitivitySettingsListResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GetSensitivitySettingsListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    writer.WriteObjectValue<SensitivitySettingData>(item, options);
                }
