...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SapOdpLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        /// <param name="sncMode"> SNC activation indicator to access the SAP server where the table is located. Type: boolean (or Expression with resultType boolean). </param>
        ...
        /// <summary> SNC activation indicator to access the SAP server where the table is located. Type: boolean (or Expression with resultType boolean). </summary>
