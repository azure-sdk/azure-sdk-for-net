...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class PostgreSqlV2LinkedService : IUtf8JsonSerializable, IJsonModel<PostgreSqlV2LinkedService>
    {
        ...
        internal static PostgreSqlV2LinkedService DeserializePostgreSqlV2LinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<DataFactoryElement<bool>> pooling = default;
            Optional<DataFactoryElement<int>> connectionTimeout = default;
            Optional<DataFactoryElement<int>> commandTimeout = default;
            Optional<DataFactoryElement<bool>> trustServerCertificate = default;
            Optional<DataFactoryElement<string>> sslCertificate = default;
            Optional<DataFactoryElement<string>> sslKey = default;
            Optional<DataFactoryElement<string>> sslPassword = default;
            Optional<DataFactoryElement<int>> readBufferSize = default;
            Optional<DataFactoryElement<bool>> logParameters = default;
            Optional<DataFactoryElement<string>> timezone = default;
            Optional<DataFactoryElement<string>> encoding = default;
