...
{
    public partial class ServiceNowV2Source : IUtf8JsonSerializable
    {
        ...
        internal static ServiceNowV2Source DeserializeServiceNowV2Source(JsonElement element)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            Optional<ExpressionV2> expression = default;
            ...
            return new ServiceNowV2Source(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, queryTimeout.Value, additionalColumns.Value, expression.Value);
        }
    }
}
