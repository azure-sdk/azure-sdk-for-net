...
{
    public partial class ChangeDataCaptureResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ChangeDataCaptureResourceData DeserializeChangeDataCaptureResourceData(JsonElement element)
        {
            ...
            return new ChangeDataCaptureResourceData(id, name, type, systemData.Value, folder.Value, description.Value, sourceConnectionsInfo, targetConnectionsInfo, policy, Optional.ToNullable(allowVNetOverride), status.Value, Optional.ToNullable(etag), additionalProperties);
        }
    }
}
