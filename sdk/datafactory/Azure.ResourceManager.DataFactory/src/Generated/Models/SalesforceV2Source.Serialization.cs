...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceV2Source : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceV2Source DeserializeSalesforceV2Source(JsonElement element)
        {
            ...
            return new SalesforceV2Source(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, queryTimeout.Value, additionalColumns.Value, soqlQuery.Value, readBehavior.Value);
        }
    }
}
