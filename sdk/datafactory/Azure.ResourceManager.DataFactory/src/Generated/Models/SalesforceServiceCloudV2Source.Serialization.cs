...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceServiceCloudV2Source : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceServiceCloudV2Source DeserializeSalesforceServiceCloudV2Source(JsonElement element)
        {
            ...
            return new SalesforceServiceCloudV2Source(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, soqlQuery.Value, readBehavior.Value, additionalColumns.Value);
        }
    }
}
