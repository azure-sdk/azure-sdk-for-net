...
{
    public partial class ServiceNowV2ObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static ServiceNowV2ObjectDataset DeserializeServiceNowV2ObjectDataset(JsonElement element)
        {
            ...
            return new ServiceNowV2ObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
