...
{
    public partial class WebConnectionLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static WebConnectionLinkedService DeserializeWebConnectionLinkedService(JsonElement element)
        {
            ...
            WebConnectionAuthenticationType authenticationType = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            authenticationType = new WebConnectionAuthenticationType(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("pfx"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            pfx = JsonSerializer.Deserialize<DataFactorySecretBaseDefinition>(property0.Value.GetRawText());
                            continue;
                        }
            ...
            return new WebConnectionLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, url, enableServerCertificateValidation.Value, authenticationType, userName.Value, password, pfx, servicePrincipalId.Value, servicePrincipalKey, tenant.Value, aadResourceId.Value, credential.Value);
        }
    }
}
