...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ServiceNowV2LinkedService : IUtf8JsonSerializable
    {
        ...
        internal static ServiceNowV2LinkedService DeserializeServiceNowV2LinkedService(JsonElement element)
        {
            ...
            Optional<DataFactoryElement<string>> grantType = default;
            ...
            return new ServiceNowV2LinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, endpoint, authenticationType, username.Value, password, clientId.Value, clientSecret, grantType.Value, encryptedCredential.Value);
        }
    }
}
