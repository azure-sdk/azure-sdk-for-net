...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class WebActivity : ExecutionActivity
    {
        ...
        public WebActivity(string name, WebActivityMethod method) : base(name)
        {
        ...
        /// <param name="relativeUri"> Web activity relative url for the target endpoint of linked service. Type: string (or Expression with resultType string). </param>
        ...
        /// <summary> Web activity relative url for the target endpoint of linked service. Type: string (or Expression with resultType string). </summary>
