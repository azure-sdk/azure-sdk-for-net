...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SynapseSparkJobDefinitionActivity : ExecutionActivity
    {
        ...
        internal SynapseSparkJobDefinitionActivity(string name, string activityType, string description, IList<ActivityDependency> dependsOn, IList<ActivityUserProperty> userProperties, IDictionary<string, BinaryData> additionalProperties, FactoryLinkedServiceReference linkedServiceName, ActivityPolicy policy, SynapseSparkJobReference sparkJob, IList<BinaryData> arguments, BinaryData file, BinaryData scanFolder, BinaryData className, IList<BinaryData> files, IList<BinaryData> pythonCodeReference, IList<BinaryData> filesV2, BigDataPoolParametrizationReference targetBigDataPool, BinaryData executorSize, BinaryData conf, BinaryData driverSize, BinaryData numExecutors, ConfigurationType? configurationType, SparkConfigurationParametrizationReference targetSparkConfiguration, IDictionary<string, BinaryData> sparkConfig) : base(name, activityType, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            SparkJob = sparkJob;
            Arguments = arguments;
            File = file;
        ...
        /// </para>
        /// </summary>
        public BinaryData ScanFolder { get; set; }
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public BinaryData NumExecutors { get; set; }
