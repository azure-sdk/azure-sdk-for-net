...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceServiceCloudV2LinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceServiceCloudV2LinkedService DeserializeSalesforceServiceCloudV2LinkedService(JsonElement element)
        {
            ...
            return new SalesforceServiceCloudV2LinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, environmentUrl.Value, clientId.Value, clientSecret, apiVersion.Value, encryptedCredential.Value);
        }
    }
}
