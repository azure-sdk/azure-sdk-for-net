...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SynapseSparkJobDefinitionActivity : IUtf8JsonSerializable
    {
...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(ScanFolder);
#else
                JsonSerializer.Serialize(writer, JsonDocument.Parse(ScanFolder.ToString()).RootElement);
#endif
            }
...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(NumExecutors);
#else
                JsonSerializer.Serialize(writer, JsonDocument.Parse(NumExecutors.ToString()).RootElement);
#endif
            }
        ...
        internal static SynapseSparkJobDefinitionActivity DeserializeSynapseSparkJobDefinitionActivity(JsonElement element)
        {
            ...
            Optional<BinaryData> scanFolder = default;
            ...
            Optional<BinaryData> numExecutors = default;
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("file"u8))
                        {
                            ...
                            file = BinaryData.FromString(property0.Value.GetRawText());
                            continue;
                        }
                        if (property0.NameEquals("scanFolder"u8))
                        {
                            ...
                            scanFolder = BinaryData.FromString(property0.Value.GetRawText());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("numExecutors"u8))
                        {
                            ...
                            numExecutors = BinaryData.FromString(property0.Value.GetRawText());
                            continue;
                        }
