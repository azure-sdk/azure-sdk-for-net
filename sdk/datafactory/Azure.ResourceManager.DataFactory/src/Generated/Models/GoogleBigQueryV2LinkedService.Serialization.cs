...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GoogleBigQueryV2LinkedService>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GoogleBigQueryV2LinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GoogleBigQueryV2LinkedService)} does not support '{format}' format.");
            }
        ...
        internal static GoogleBigQueryV2LinkedService DeserializeGoogleBigQueryV2LinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<DataFactorySecretBaseDefinition> keyFileContent = default;
            ...
            return new GoogleBigQueryV2LinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, projectId, authenticationType, clientId.Value, clientSecret, refreshToken, keyFileContent, encryptedCredential.Value);
        }
        ...
        BinaryData IPersistableModel<GoogleBigQueryV2LinkedService>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GoogleBigQueryV2LinkedService)} does not support '{options.Format}' format.");
            }
        }
