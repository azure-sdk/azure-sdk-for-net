...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MapperConnection : IUtf8JsonSerializable
    {
        ...
        internal static MapperConnection DeserializeMapperConnection(JsonElement element)
        {
            ...
            return new MapperConnection(linkedService.Value, linkedServiceType.Value, type, Optional.ToNullable(isInlineDataset), Optional.ToList(commonDslConnectorProperties));
        }
    }
}
