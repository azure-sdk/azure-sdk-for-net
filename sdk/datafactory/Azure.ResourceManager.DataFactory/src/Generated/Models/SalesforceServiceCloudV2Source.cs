...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceServiceCloudV2Source : CopyActivitySource
    {
        ...
        internal SalesforceServiceCloudV2Source(string copySourceType, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> soqlQuery, DataFactoryElement<string> readBehavior, BinaryData additionalColumns) : base(copySourceType, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            SoqlQuery = soqlQuery;
