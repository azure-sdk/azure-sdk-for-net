...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceV2LinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceV2LinkedService DeserializeSalesforceV2LinkedService(JsonElement element)
        {
            ...
            return new SalesforceV2LinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, environmentUrl.Value, clientId.Value, clientSecret, apiVersion.Value, encryptedCredential.Value);
        }
    }
}
