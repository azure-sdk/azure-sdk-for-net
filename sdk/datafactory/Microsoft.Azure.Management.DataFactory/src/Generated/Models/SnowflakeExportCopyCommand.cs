...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SnowflakeExportCopyCommand : ExportSettings
    {
        ...
        /// <param name="storageIntegration">The name of the snowflake storage
        /// integration to use for the copy operation. Type: string (or
        /// Expression with resultType string).</param>
        public SnowflakeExportCopyCommand(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), IDictionary<string, object> additionalCopyOptions = default(IDictionary<string, object>), IDictionary<string, object> additionalFormatOptions = default(IDictionary<string, object>), object storageIntegration = default(object))
        ...
        /// <summary>
        /// Gets or sets the name of the snowflake storage integration to use
        /// for the copy operation. Type: string (or Expression with resultType
        /// string).
        /// </summary>
        [JsonProperty(PropertyName = "storageIntegration")]
