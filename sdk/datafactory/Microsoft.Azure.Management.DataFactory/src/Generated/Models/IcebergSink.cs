...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class IcebergSink : CopySink
    {
        ...
        /// <param name="storeSettings">Iceberg store settings.</param>
        /// <param name="formatSettings">Iceberg format settings.</param>
        public IcebergSink(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object writeBatchSize = default(object), object writeBatchTimeout = default(object), object sinkRetryCount = default(object), object sinkRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), StoreWriteSettings storeSettings = default(StoreWriteSettings), IcebergWriteSettings formatSettings = default(IcebergWriteSettings))
