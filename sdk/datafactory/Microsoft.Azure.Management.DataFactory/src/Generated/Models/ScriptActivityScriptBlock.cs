...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class ScriptActivityScriptBlock
    {
        ...
        /// <param name="type">The type of the query. Please refer to the
        /// ScriptType for valid options. Type: string (or Expression with
        /// resultType string).</param>
        /// <param name="parameters">Array of script parameters. Type:
        /// array.</param>
        public ScriptActivityScriptBlock(object text, object type, IList<ScriptActivityParameter> parameters = default(IList<ScriptActivityParameter>))
        {
            Text = text;
            Type = type;
        ...
        /// <summary>
        /// Gets or sets the type of the query. Please refer to the ScriptType
        /// for valid options. Type: string (or Expression with resultType
        /// string).
        /// </summary>
