...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class WebHookActivity : ControlActivity
    {
        ...
        public WebHookActivity(string name, object url, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), string state = default(string), string onInactiveMarkAs = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>), string timeout = default(string), IDictionary<string, object> headers = default(IDictionary<string, object>), object body = default(object), WebActivityAuthentication authentication = default(WebActivityAuthentication), object reportStatusOnCallBack = default(object), SecureInputOutputPolicy policy = default(SecureInputOutputPolicy))
