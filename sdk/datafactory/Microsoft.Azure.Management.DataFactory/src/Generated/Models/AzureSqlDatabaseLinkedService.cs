...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class AzureSqlDatabaseLinkedService : LinkedService
    {
        ...
        /// Type: string. Possible values include: 'SQL', 'ServicePrincipal',
        /// 'SystemAssignedManagedIdentity',
        /// 'UserAssignedManagedIdentity'</param>
        /// <param name="userName">The user name to be used when connecting to
        ...
        /// <summary>
        /// Gets or sets the user name to be used when connecting to server.
        /// Type: string (or Expression with resultType string).
        /// </summary>
