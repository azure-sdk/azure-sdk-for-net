...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class IcebergDataset : Dataset
    {
        ...
        /// <param name="location">The location of the iceberg storage. Setting
        /// a file name is not allowed for iceberg format.</param>
        ...
        public IcebergDataset(LinkedServiceReference linkedServiceName, DatasetLocation location, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder))
        ...
        /// <summary>
        /// Gets or sets the location of the iceberg storage. Setting a file
        /// name is not allowed for iceberg format.
        /// </summary>
