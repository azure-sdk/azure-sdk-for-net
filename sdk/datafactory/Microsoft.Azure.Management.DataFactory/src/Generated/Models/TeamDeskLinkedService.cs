...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class TeamDeskLinkedService : LinkedService
    {
        ...
        public TeamDeskLinkedService(string authenticationType, object url, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string version = default(string), IntegrationRuntimeReference connectVia = default(IntegrationRuntimeReference), string description = default(string), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), object userName = default(object), SecretBase password = default(SecretBase), SecretBase apiToken = default(SecretBase), string encryptedCredential = default(string))
