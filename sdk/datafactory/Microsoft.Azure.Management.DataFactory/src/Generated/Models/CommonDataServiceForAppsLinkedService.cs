...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class CommonDataServiceForAppsLinkedService : LinkedService
    {
        ...
        /// scenario, 'Active Directory' for Dynamics on-premises with IFD.
        ...
        /// <param name="domain">The Active Directory domain that will verify
        /// user credentials. Type: string (or Expression with resultType
        /// string).</param>
        ...
        /// <summary>
        /// Gets or sets the Active Directory domain that will verify user
        /// credentials. Type: string (or Expression with resultType string).
        /// </summary>
