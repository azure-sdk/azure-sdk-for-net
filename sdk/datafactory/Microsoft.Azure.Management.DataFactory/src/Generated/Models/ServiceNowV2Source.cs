...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class ServiceNowV2Source : TabularSource
    {
        ...
        /// <param name="expression">Expression to filter data from
        /// source.</param>
        /// <param name="pageSize">Page size of the result. Type: integer (or
        /// Expression with resultType integer).</param>
        public ServiceNowV2Source(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object queryTimeout = default(object), object additionalColumns = default(object), ExpressionV2 expression = default(ExpressionV2), object pageSize = default(object))
