...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SalesforceServiceCloudV2ObjectDataset : Dataset
    {
        ...
        /// <param name="objectApiName">The Salesforce Service Cloud V2 object
        /// API name. Type: string (or Expression with resultType
        /// string).</param>
        /// <param name="reportId">The Salesforce Service Cloud V2 reportId.
        /// Type: string (or Expression with resultType string).</param>
        public SalesforceServiceCloudV2ObjectDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object objectApiName = default(object), object reportId = default(object))
        ...
        /// <summary>
        /// Gets or sets the Salesforce Service Cloud V2 object API name. Type:
        ...
        /// <summary>
        /// Gets or sets the Salesforce Service Cloud V2 reportId. Type: string
        /// (or Expression with resultType string).
        /// </summary>
        [JsonProperty(PropertyName = "typeProperties.reportId")]
