...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class HdfsLinkedService : LinkedService
    {
        ...
        public HdfsLinkedService(object url, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string version = default(string), IntegrationRuntimeReference connectVia = default(IntegrationRuntimeReference), string description = default(string), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), object authenticationType = default(object), string encryptedCredential = default(string), object userName = default(object), SecretBase password = default(SecretBase))
