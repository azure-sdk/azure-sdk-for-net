...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    internal partial class ArmResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<DataProtectionBackupInstanceResource> GetDataProtectionBackupInstancesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DataProtectionBackupInstanceResource(Client, DataProtectionBackupInstanceData.DeserializeDataProtectionBackupInstanceData(e)), BackupInstancesExtensionRoutingClientDiagnostics, Pipeline, "ArmResourceExtensionClient.GetDataProtectionBackupInstances", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataProtectionBackupInstanceResource> GetDataProtectionBackupInstances(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BackupInstancesExtensionRoutingRestClient.CreateListRequest(Id);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => BackupInstancesExtensionRoutingRestClient.CreateListNextPageRequest(nextLink, Id);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DataProtectionBackupInstanceResource(Client, DataProtectionBackupInstanceData.DeserializeDataProtectionBackupInstanceData(e)), BackupInstancesExtensionRoutingClientDiagnostics, Pipeline, "ArmResourceExtensionClient.GetDataProtectionBackupInstances", "value", "nextLink", cancellationToken);
        }
    }
}
