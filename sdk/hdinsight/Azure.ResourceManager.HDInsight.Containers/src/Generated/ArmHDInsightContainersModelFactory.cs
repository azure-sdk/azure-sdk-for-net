...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public static partial class ArmHDInsightContainersModelFactory
    {
        ...
        public static HDInsightClusterPoolData HDInsightClusterPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ClusterPoolResourceProperties properties = null)
        {
            ...
            return new HDInsightClusterPoolData(id, name, resourceType, systemData, tags, location, properties, serializedAdditionalRawData: null);
        }
        ...
        {
            return new ClusterPoolResourceProperties(provisioningState, deploymentId, managedResourceGroupName, aksManagedResourceGroupName, clusterPoolVersion != null ? new ClusterPoolProfile(clusterPoolVersion, serializedAdditionalRawData: null) : null, computeProfile, aksClusterProfile, networkProfile, logAnalyticsProfile, status, serializedAdditionalRawData: null);
        }
        ...
        {
            return new ClusterPoolAvailableUpgrade(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        public static HDInsightClusterData HDInsightClusterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ClusterResourceProperties properties = null)
        {
            ...
            return new HDInsightClusterData(id, name, resourceType, systemData, tags, location, properties, serializedAdditionalRawData: null);
        }
        ...
        public static ClusterResourceProperties ClusterResourceProperties(HDInsightProvisioningStatus? provisioningState = null, string clusterType = null, string deploymentId = null, IEnumerable<ClusterComputeNodeProfile> computeNodes = null, ClusterProfile clusterProfile = null, string status = null)
        {
            computeNodes ??= new List<ClusterComputeNodeProfile>();

            return new ClusterResourceProperties(provisioningState, clusterType, deploymentId, computeNodes != null ? new ComputeProfile(computeNodes?.ToList(), serializedAdditionalRawData: null) : null, clusterProfile, status, serializedAdditionalRawData: null);
        }
        ...
        /// The available derived classes include <see cref="ClusterAvailableUpgradeAksPatchUpgradeProperties"/> and <see cref="ClusterAvailableUpgradeHotfixUpgradeProperties"/>.
        /// </param>
        ...
        {
            return new ClusterAvailableUpgrade(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        public static ClusterResizeContent ClusterResizeContent(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, int? clusterResizeTargetWorkerNodeCount = null)
        {
            ...
            return new ClusterResizeContent(id, name, resourceType, systemData, tags, location, clusterResizeTargetWorkerNodeCount.HasValue ? new ClusterResizeProperties(clusterResizeTargetWorkerNodeCount.Value, serializedAdditionalRawData: null) : null, serializedAdditionalRawData: null);
        }
        ...
        public static ServiceConfigResultProperties ServiceConfigResultProperties(string serviceName = null, string fileName = null, string content = null, string componentName = null, string serviceConfigListResultPropertiesType = null, string path = null, IReadOnlyDictionary<string, string> customKeys = null, IReadOnlyDictionary<string, ClusterServiceConfigValueEntity> defaultKeys = null)
        {
            ...
            return new ServiceConfigResultProperties(serviceName, fileName, content, componentName, serviceConfigListResultPropertiesType, path, customKeys, defaultKeys, serializedAdditionalRawData: null);
        }
        ...
        public static ServiceConfigListResultProperties ServiceConfigListResultProperties(string serviceName = null, string fileName = null, string content = null, string componentName = null, string serviceConfigListResultPropertiesType = null, string path = null, IReadOnlyDictionary<string, string> customKeys = null, IReadOnlyDictionary<string, ClusterServiceConfigValueEntity> defaultKeys = null)
        {
            ...
            return new ServiceConfigListResultProperties(serviceName, fileName, content, componentName, serviceConfigListResultPropertiesType, path, customKeys, defaultKeys, serializedAdditionalRawData: null);
        }
        ...
        {
            return new ClusterPoolVersion(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        {
            return new HDInsightClusterVersion(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        public static ClusterVersionProperties ClusterVersionProperties(string clusterType = null, string clusterVersion = null, string ossVersion = null, string clusterPoolVersion = null, bool? isPreview = null, IEnumerable<ClusterComponentItem> components = null)
        {
            ...
            return new ClusterVersionProperties(clusterType, clusterVersion, ossVersion, clusterPoolVersion, isPreview, components?.ToList(), serializedAdditionalRawData: null);
        }
