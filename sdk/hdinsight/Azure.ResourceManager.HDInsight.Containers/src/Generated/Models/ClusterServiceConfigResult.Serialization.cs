...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    public partial class ClusterServiceConfigResult : IUtf8JsonSerializable, IJsonModel<ClusterServiceConfigResult>
    {
        ...
        internal static ClusterServiceConfigResult DeserializeClusterServiceConfigResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<ServiceConfigResultProperties> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ServiceConfigResultProperties.DeserializeServiceConfigResultProperties(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ClusterServiceConfigResult(properties.Value, serializedAdditionalRawData);
        }
