...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    public partial class TrinoCoordinator : IUtf8JsonSerializable, IJsonModel<TrinoCoordinator>
    {
        ...
        internal static TrinoCoordinator DeserializeTrinoCoordinator(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<TrinoDebugConfig> debug = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("debug"u8))
                {
                    ...
                    debug = TrinoDebugConfig.DeserializeTrinoDebugConfig(property.Value);
                    continue;
                }
            ...
            return new TrinoCoordinator(debug.Value, Optional.ToNullable(highAvailabilityEnabled), serializedAdditionalRawData);
        }
