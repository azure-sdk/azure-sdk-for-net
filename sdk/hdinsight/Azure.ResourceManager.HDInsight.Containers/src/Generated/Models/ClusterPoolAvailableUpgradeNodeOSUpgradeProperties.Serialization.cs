...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterPoolAvailableUpgradeNodeOSUpgradeProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ClusterPoolAvailableUpgradeNodeOSUpgradeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterPoolAvailableUpgradeNodeOSUpgradeProperties)} does not support '{format}' format.");
            }
        ...
        internal static ClusterPoolAvailableUpgradeNodeOSUpgradeProperties DeserializeClusterPoolAvailableUpgradeNodeOSUpgradeProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ClusterPoolAvailableUpgradeNodeOSUpgradeProperties(upgradeType, serializedAdditionalRawData, latestVersion.Value);
        }
        ...
        BinaryData IPersistableModel<ClusterPoolAvailableUpgradeNodeOSUpgradeProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterPoolAvailableUpgradeNodeOSUpgradeProperties)} does not support '{options.Format}' format.");
            }
        }
