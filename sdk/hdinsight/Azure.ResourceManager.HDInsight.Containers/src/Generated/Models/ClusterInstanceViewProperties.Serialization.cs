...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterInstanceViewProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ClusterInstanceViewProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterInstanceViewProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClusterInstanceViewProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterInstanceViewProperties)} does not support '{options.Format}' format.");
            }
        }
