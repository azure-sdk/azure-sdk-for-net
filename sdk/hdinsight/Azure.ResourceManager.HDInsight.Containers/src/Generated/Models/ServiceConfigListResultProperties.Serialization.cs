...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceConfigListResultProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ServiceConfigListResultProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceConfigListResultProperties)} does not support '{format}' format.");
            }
        ...
        internal static ServiceConfigListResultProperties DeserializeServiceConfigListResultProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ServiceConfigListResultProperties(serviceName, fileName, content.Value, componentName, type.Value, path.Value, Optional.ToDictionary(customKeys), Optional.ToDictionary(defaultKeys), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ServiceConfigListResultProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServiceConfigListResultProperties)} does not support '{options.Format}' format.");
            }
        }
