...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterAvailableUpgradeProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ClusterAvailableUpgradeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterAvailableUpgradeProperties)} does not support '{format}' format.");
            }
        ...
        internal static ClusterAvailableUpgradeProperties DeserializeClusterAvailableUpgradeProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("upgradeType", out JsonElement discriminator))
            {
                ...
                {
                    case "AKSPatchUpgrade": return ClusterAvailableUpgradeAksPatchUpgradeProperties.DeserializeClusterAvailableUpgradeAksPatchUpgradeProperties(element);
                    case "HotfixUpgrade": return ClusterAvailableUpgradeHotfixUpgradeProperties.DeserializeClusterAvailableUpgradeHotfixUpgradeProperties(element);
                }
            }
            return UnknownClusterAvailableUpgradeProperties.DeserializeUnknownClusterAvailableUpgradeProperties(element);
        }
        ...
        BinaryData IPersistableModel<ClusterAvailableUpgradeProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterAvailableUpgradeProperties)} does not support '{options.Format}' format.");
            }
        }
