...
{
    /// <summary> The update gateway settings request parameters. Plz note either basic or entraUsers should be selected at a time. </summary>
    public partial class HDInsightClusterUpdateGatewaySettingsContent
    {
        ...
        {
            EntraUsers = new ChangeTrackingList<string>();
        }
        ...
        /// <param name="entraUsers"> List of Entra user emails for gateway access. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal HDInsightClusterUpdateGatewaySettingsContent(bool? isCredentialEnabled, string userName, string password, IList<string> entraUsers, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public IList<string> EntraUsers { get; }
    }
}
