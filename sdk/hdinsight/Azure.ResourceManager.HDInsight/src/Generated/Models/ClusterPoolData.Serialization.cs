...
{
    public partial class ClusterPoolData : IUtf8JsonSerializable
    {
        ...
        internal static ClusterPoolData DeserializeClusterPoolData(JsonElement element)
        {
