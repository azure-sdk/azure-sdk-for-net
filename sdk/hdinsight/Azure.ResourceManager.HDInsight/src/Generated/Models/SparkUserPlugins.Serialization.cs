...
{
    internal partial class SparkUserPlugins : IUtf8JsonSerializable
    {
        ...
        internal static SparkUserPlugins DeserializeSparkUserPlugins(JsonElement element)
        {
            ...
            return new SparkUserPlugins(Optional.ToList(plugins));
        }
    }
}
