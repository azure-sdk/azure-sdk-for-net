...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ParquetSource : CopySource
    {
        ...
        internal ParquetSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, IDictionary<string, object> additionalProperties, StoreReadSettings storeSettings, ParquetReadSettings formatSettings, object additionalColumns) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties)
        {
