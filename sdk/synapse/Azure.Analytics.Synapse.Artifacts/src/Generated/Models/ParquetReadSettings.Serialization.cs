...
{
    [JsonConverter(typeof(ParquetReadSettingsConverter))]
    public partial class ParquetReadSettings : IUtf8JsonSerializable
    {
        ...
        internal partial class ParquetReadSettingsConverter : JsonConverter<ParquetReadSettings>
        {
            public override void Write(Utf8JsonWriter writer, ParquetReadSettings model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override ParquetReadSettings Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeParquetReadSettings(document.RootElement);
            }
        }
    }
}
