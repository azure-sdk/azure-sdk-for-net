    ...
    public partial class LakeHouseTableSink : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(TableActionOption))
            {
                ...
                writer.WriteObjectValue(TableActionOption);
            }
            ...
            if (Optional.IsDefined(PartitionNameList))
            {
                ...
                writer.WriteObjectValue(PartitionNameList);
            }
        ...
        internal static LakeHouseTableSink DeserializeLakeHouseTableSink(JsonElement element)
        {
            ...
            Optional<object> tableActionOption = default;
            Optional<object> partitionOption = default;
            Optional<object> partitionNameList = default;
            string type = default;
            ...
            return new LakeHouseTableSink(type, writeBatchSize.Value, writeBatchTimeout.Value, sinkRetryCount.Value, sinkRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, tableActionOption.Value, partitionOption.Value, partitionNameList.Value);
        }
