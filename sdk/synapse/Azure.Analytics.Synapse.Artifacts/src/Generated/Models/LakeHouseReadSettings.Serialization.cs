...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LakeHouseReadSettings : IUtf8JsonSerializable
    {
        ...
        internal static LakeHouseReadSettings DeserializeLakeHouseReadSettings(JsonElement element)
        {
            ...
            return new LakeHouseReadSettings(type, maxConcurrentConnections.Value, additionalProperties, recursive.Value, wildcardFolderPath.Value, wildcardFileName.Value, fileListPath.Value, enablePartitionDiscovery.Value, partitionRootPath.Value, deleteFilesAfterCompletion.Value, modifiedDatetimeStart.Value, modifiedDatetimeEnd.Value);
        }
