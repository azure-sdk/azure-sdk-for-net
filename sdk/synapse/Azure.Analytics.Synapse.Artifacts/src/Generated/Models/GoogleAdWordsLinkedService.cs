...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class GoogleAdWordsLinkedService : LinkedService
    {
        ...
        internal GoogleAdWordsLinkedService(string type, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object connectionProperties, object clientCustomerID, SecretBase developerToken, GoogleAdWordsAuthenticationType? authenticationType, SecretBase refreshToken, object clientId, SecretBase clientSecret, object email, object keyFilePath, object trustedCertPath, object useSystemTrustStore, SecretBase privateKey, object loginCustomerID, object googleAdsApiVersion, object supportLegacyDataTypes, object encryptedCredential) : base(type, connectVia, description, parameters, annotations, additionalProperties)
        {
