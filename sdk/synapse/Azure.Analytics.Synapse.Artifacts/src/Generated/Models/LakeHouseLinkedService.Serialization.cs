    ...
    public partial class LakeHouseLinkedService : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(ArtifactId))
            {
                ...
                writer.WriteObjectValue(ArtifactId);
            }
        ...
        internal static LakeHouseLinkedService DeserializeLakeHouseLinkedService(JsonElement element)
        {
            ...
            Optional<object> workspaceId = default;
            Optional<object> artifactId = default;
            ...
            return new LakeHouseLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, workspaceId.Value, artifactId.Value, servicePrincipalId.Value, servicePrincipalKey.Value, tenant.Value, encryptedCredential.Value, servicePrincipalCredentialType.Value, servicePrincipalCredential.Value);
        }
