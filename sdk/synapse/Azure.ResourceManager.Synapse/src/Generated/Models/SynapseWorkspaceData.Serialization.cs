    ...
    public partial class SynapseWorkspaceData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(IsAadOnlyAuthenticationEnabled))
            {
				...
				writer.WriteRawValue(IsAadOnlyAuthenticationEnabled);
#else
                JsonSerializer.Serialize(writer, JsonDocument.Parse(IsAadOnlyAuthenticationEnabled.ToString()).RootElement);
#endif
            }
        ...
        internal static SynapseWorkspaceData DeserializeSynapseWorkspaceData(JsonElement element)
        {
            ...
            Optional<BinaryData> azureADOnlyAuthentication = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("azureADOnlyAuthentication"u8))
                        {
                            ...
                            azureADOnlyAuthentication = BinaryData.FromString(property0.Value.GetRawText());
                            continue;
                        }
