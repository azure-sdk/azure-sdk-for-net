...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseSelfHostedIntegrationRuntime : SynapseIntegrationRuntimeProperties
    {
        ...
        internal SynapseSelfHostedIntegrationRuntime(IntegrationRuntimeType integrationRuntimeType, string description, IDictionary<string, BinaryData> additionalProperties, SynapseLinkedIntegrationRuntimeType linkedInfo, bool? selfContainedInteractiveAuthoringEnabled) : base(integrationRuntimeType, description, additionalProperties)
        {
