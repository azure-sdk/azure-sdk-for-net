...
namespace Azure.ResourceManager.ComputeFleet
{
    ...
    public partial class FleetResource : ArmResource
    {
        ...
        internal FleetResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _virtualMachineScaleSetsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ComputeFleet", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<FleetResource>> UpdateAsync(WaitUntil waitUntil, FleetPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ComputeFleetArmOperation<FleetResource>(new FleetOperationSource(Client), _fleetClientDiagnostics, Pipeline, _fleetRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>VirtualMachineScaleSet_listByFleet</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-05-01-preview</description>
        ...
        public virtual AsyncPageable<VirtualMachineScaleSet> GetVirtualMachineScaleSetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => VirtualMachineScaleSet.DeserializeVirtualMachineScaleSet(e), _virtualMachineScaleSetsClientDiagnostics, Pipeline, "FleetResource.GetVirtualMachineScaleSets", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _virtualMachineScaleSetsRestClient.CreateListByFleetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => VirtualMachineScaleSet.DeserializeVirtualMachineScaleSet(e), _virtualMachineScaleSetsClientDiagnostics, Pipeline, "FleetResource.GetVirtualMachineScaleSets", "value", null, cancellationToken);
        }
