...
namespace Azure.ResourceManager.Azurefleet.Mocking
{
    ...
    public partial class MockableAzurefleetResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableAzurefleetResourceGroupResource"/> class for mocking. </summary>
        protected MockableAzurefleetResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAzurefleetResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzurefleetResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
