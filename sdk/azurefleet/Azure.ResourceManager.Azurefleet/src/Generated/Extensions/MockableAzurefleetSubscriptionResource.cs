...
namespace Azure.ResourceManager.Azurefleet.Mocking
{
    ...
    public partial class MockableAzurefleetSubscriptionResource : ArmResource
    {
        private ClientDiagnostics _fleetClientDiagnostics;
        private FleetsRestOperations _fleetRestClient;

        /// <summary> Initializes a new instance of the <see cref="MockableAzurefleetSubscriptionResource"/> class for mocking. </summary>
        protected MockableAzurefleetSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAzurefleetSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzurefleetSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics FleetClientDiagnostics => _fleetClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Azurefleet", FleetResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<FleetResource> GetFleetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new FleetResource(Client, FleetData.DeserializeFleetData(e)), FleetClientDiagnostics, Pipeline, "MockableAzurefleetSubscriptionResource.GetFleets", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<FleetResource> GetFleets(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => FleetRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => FleetRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new FleetResource(Client, FleetData.DeserializeFleetData(e)), FleetClientDiagnostics, Pipeline, "MockableAzurefleetSubscriptionResource.GetFleets", "value", "nextLink", cancellationToken);
        }
    }
}
