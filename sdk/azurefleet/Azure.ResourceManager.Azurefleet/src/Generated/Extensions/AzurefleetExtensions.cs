...
using Azure.Core;
using Azure.ResourceManager.Azurefleet.Mocking;
using Azure.ResourceManager.Resources;

namespace Azure.ResourceManager.Azurefleet
{
    /// <summary> A class to add extension methods to Azure.ResourceManager.Azurefleet. </summary>
    public static partial class AzurefleetExtensions
    {
        private static MockableAzurefleetArmClient GetMockableAzurefleetArmClient(ArmClient client)
        {
            return client.GetCachedClient(client0 => new MockableAzurefleetArmClient(client0));
        }

        private static MockableAzurefleetResourceGroupResource GetMockableAzurefleetResourceGroupResource(ArmResource resource)
        {
            return resource.GetCachedClient(client => new MockableAzurefleetResourceGroupResource(client, resource.Id));
        }

        private static MockableAzurefleetSubscriptionResource GetMockableAzurefleetSubscriptionResource(ArmResource resource)
        {
            return resource.GetCachedClient(client => new MockableAzurefleetSubscriptionResource(client, resource.Id));
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableAzurefleetArmClient.GetFleetResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static FleetResource GetFleetResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableAzurefleetArmClient(client).GetFleetResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableAzurefleetResourceGroupResource.GetFleets()"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static FleetCollection GetFleets(this ResourceGroupResource resourceGroupResource)
        {
            ...
            return GetMockableAzurefleetResourceGroupResource(resourceGroupResource).GetFleets();
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableAzurefleetResourceGroupResource.GetFleetAsync(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        ...
        public static async Task<Response<FleetResource>> GetFleetAsync(this ResourceGroupResource resourceGroupResource, string fleetName, CancellationToken cancellationToken = default)
        {
            ...
            return await GetMockableAzurefleetResourceGroupResource(resourceGroupResource).GetFleetAsync(fleetName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableAzurefleetResourceGroupResource.GetFleet(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        /// <param name="fleetName"> The name of the Compute Fleet. </param>
        ...
        public static Response<FleetResource> GetFleet(this ResourceGroupResource resourceGroupResource, string fleetName, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableAzurefleetResourceGroupResource(resourceGroupResource).GetFleet(fleetName, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableAzurefleetSubscriptionResource.GetFleets(CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static AsyncPageable<FleetResource> GetFleetsAsync(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableAzurefleetSubscriptionResource(subscriptionResource).GetFleetsAsync(cancellationToken);
        }
        ...
        public static Pageable<FleetResource> GetFleets(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableAzurefleetSubscriptionResource(subscriptionResource).GetFleets(cancellationToken);
        }
    }
}
