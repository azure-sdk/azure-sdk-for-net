...
namespace Azure.ResourceManager.Azurefleet
{
    ...
    public partial class FleetCollection : ArmCollection, IEnumerable<FleetResource>, IAsyncEnumerable<FleetResource>
    {
        ...
        {
            _fleetClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Azurefleet", FleetResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<FleetResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string fleetName, FleetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AzurefleetArmOperation<FleetResource>(new FleetOperationSource(Client), _fleetClientDiagnostics, Pipeline, _fleetRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, fleetName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
