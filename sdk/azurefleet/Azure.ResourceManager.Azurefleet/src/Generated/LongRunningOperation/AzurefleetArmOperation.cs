...
#pragma warning disable SA1649 // File name should match first type name
    internal class AzurefleetArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal AzurefleetArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AzurefleetArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "AzurefleetArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
