...
namespace Azure.ResourceManager.Azurefleet
{
    ...
    public partial class FleetData : TrackedResourceData
    {
        ...
        internal FleetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, IList<string> zones, ManagedServiceIdentity identity, ArmPlan plan, ProvisioningState? provisioningState, SpotPriorityProfile spotPriorityProfile, RegularPriorityProfile regularPriorityProfile, IList<VmSizeProfile> vmSizesProfile, ComputeProfile computeProfile, DateTimeOffset? timeCreated, string uniqueId, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Zones = zones;
            Identity = identity;
            Plan = plan;
