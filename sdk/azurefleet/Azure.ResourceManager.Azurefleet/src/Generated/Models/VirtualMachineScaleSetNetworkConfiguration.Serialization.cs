        ...
        internal static VirtualMachineScaleSetNetworkConfiguration DeserializeVirtualMachineScaleSetNetworkConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = VirtualMachineScaleSetNetworkConfigurationProperties.DeserializeVirtualMachineScaleSetNetworkConfigurationProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new VirtualMachineScaleSetNetworkConfiguration(name, properties, serializedAdditionalRawData);
        }
