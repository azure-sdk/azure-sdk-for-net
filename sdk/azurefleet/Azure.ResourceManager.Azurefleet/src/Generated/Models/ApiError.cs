...
namespace Azure.ResourceManager.Azurefleet.Models
{
    ...
    public partial class ApiError
    {
        ...
        internal ApiError(string code, string target, string message, IReadOnlyList<ApiErrorBase> details, InnerError innererror, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Target = target;
            Message = message;
