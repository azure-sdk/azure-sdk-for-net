...
namespace Azure.ResourceManager.Azurefleet.Models
{
    ...
    public partial class VmGalleryApplication
    {
        ...
        public VmGalleryApplication(ResourceIdentifier packageReferenceId)
        {
        ...
        /// </param>
        /// <param name="treatFailureAsDeploymentFailure">
        ...
        internal VmGalleryApplication(string tags, int? order, ResourceIdentifier packageReferenceId, string configurationReference, bool? treatFailureAsDeploymentFailure, bool? enableAutomaticUpgrade, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            Order = order;
            PackageReferenceId = packageReferenceId;
