...
namespace Azure.ResourceManager.Azurefleet.Models
{
    ...
    public partial class VmGalleryApplication
    {
        ...
        internal VmGalleryApplication(string tags, int? order, string packageReferenceId, string configurationReference, bool? treatFailureAsDeploymentFailure, bool? enableAutomaticUpgrade, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            Order = order;
            PackageReferenceId = packageReferenceId;
