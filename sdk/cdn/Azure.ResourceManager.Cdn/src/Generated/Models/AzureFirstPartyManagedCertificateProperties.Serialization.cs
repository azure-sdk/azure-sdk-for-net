...
{
    public partial class AzureFirstPartyManagedCertificateProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureFirstPartyManagedCertificateProperties DeserializeAzureFirstPartyManagedCertificateProperties(JsonElement element)
        {
            ...
            Optional<WritableSubResource> secretSource = default;
            ...
            return new AzureFirstPartyManagedCertificateProperties(type, secretSource, subject.Value, expirationDate.Value, certificateAuthority.Value, Optional.ToList(subjectAlternativeNames), thumbprint.Value);
        }
    }
}
