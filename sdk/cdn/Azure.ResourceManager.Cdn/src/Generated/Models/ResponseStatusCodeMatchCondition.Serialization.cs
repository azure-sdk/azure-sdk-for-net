...
{
    public partial class ResponseStatusCodeMatchCondition : IUtf8JsonSerializable
    {
        ...
        internal static ResponseStatusCodeMatchCondition DeserializeResponseStatusCodeMatchCondition(JsonElement element)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            ResponseStatusCodeMatchConditionType typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new ResponseStatusCodeMatchConditionType(property.Value.GetString());
                    continue;
                }
            ...
            return new ResponseStatusCodeMatchCondition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
