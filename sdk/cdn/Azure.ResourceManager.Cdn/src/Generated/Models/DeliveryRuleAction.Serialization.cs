        ...
        internal static DeliveryRuleAction DeserializeDeliveryRuleAction(JsonElement element)
        {
            ...
            if (element.TryGetProperty("name", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "CustomErrorPageUrl": return DeliveryRuleCustomErrorPageAction.DeserializeDeliveryRuleCustomErrorPageAction(element);
                    ...
                    case "OverrideResponseStatusCode": return DeliveryRuleOverrideResponseStatusCodeAction.DeserializeDeliveryRuleOverrideResponseStatusCodeAction(element);
