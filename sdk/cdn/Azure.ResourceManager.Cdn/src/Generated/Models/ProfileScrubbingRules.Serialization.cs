...
{
    public partial class ProfileScrubbingRules : IUtf8JsonSerializable
    {
        ...
        internal static ProfileScrubbingRules DeserializeProfileScrubbingRules(JsonElement element)
        {
            ...
            return new ProfileScrubbingRules(matchVariable, selectorMatchOperator, selector.Value, Optional.ToNullable(state));
        }
    }
}
