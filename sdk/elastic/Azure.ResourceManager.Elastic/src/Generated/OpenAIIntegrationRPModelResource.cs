...
namespace Azure.ResourceManager.Elastic
{
    ...
    public partial class OpenAIIntegrationRPModelResource : ArmResource
    {
        ...
        {
            _openAIIntegrationRPModelClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Elastic", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string openAIIntegrationRPModelApiVersion);
        ...
        {
            using var scope = _openAIIntegrationRPModelClientDiagnostics.CreateScope("OpenAIIntegrationRPModelResource.Get");
            scope.Start();
            try
            {
                var response = await _openAIIntegrationRPModelRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<OpenAIIntegrationRPModelResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _openAIIntegrationRPModelRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new OpenAIIntegrationRPModelResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _openAIIntegrationRPModelClientDiagnostics.CreateScope("OpenAIIntegrationRPModelResource.Delete");
            scope.Start();
            try
            {
                var response = await _openAIIntegrationRPModelRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var uri = _openAIIntegrationRPModelRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _openAIIntegrationRPModelRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var uri = _openAIIntegrationRPModelRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new ElasticArmOperation(response, rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<OpenAIIntegrationRPModelResource>> UpdateAsync(WaitUntil waitUntil, OpenAIIntegrationRPModelData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _openAIIntegrationRPModelClientDiagnostics.CreateScope("OpenAIIntegrationRPModelResource.Update");
            scope.Start();
            try
            {
                var response = await _openAIIntegrationRPModelRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var uri = _openAIIntegrationRPModelRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
        ...
        public virtual ArmOperation<OpenAIIntegrationRPModelResource> Update(WaitUntil waitUntil, OpenAIIntegrationRPModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _openAIIntegrationRPModelRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var uri = _openAIIntegrationRPModelRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new ElasticArmOperation<OpenAIIntegrationRPModelResource>(Response.FromValue(new OpenAIIntegrationRPModelResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            using var scope = _openAIIntegrationRPModelClientDiagnostics.CreateScope("OpenAIIntegrationRPModelResource.GetStatus");
            scope.Start();
            try
            {
                var response = await _openAIIntegrationRPModelRestClient.GetStatusAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<OpenAIIntegrationStatusResponse> GetStatus(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _openAIIntegrationRPModelRestClient.GetStatus(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
