...
namespace Azure.ResourceManager.Elastic
{
    ...
    public partial class ElasticMonitorResourceCollection : ArmCollection, IEnumerable<ElasticMonitorResource>, IAsyncEnumerable<ElasticMonitorResource>
    {
        ...
        {
            _elasticMonitorResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Elastic", ElasticMonitorResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ElasticMonitorResource.ResourceType, out string elasticMonitorResourceApiVersion);
        ...
        public virtual async Task<ArmOperation<ElasticMonitorResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string monitorName, ElasticMonitorResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _elasticMonitorResourceClientDiagnostics.CreateScope("ElasticMonitorResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _elasticMonitorResourceRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, monitorName, data, cancellationToken).ConfigureAwait(false);
                var operation = new ElasticArmOperation<ElasticMonitorResource>(new ElasticMonitorResourceOperationSource(Client), _elasticMonitorResourceClientDiagnostics, Pipeline, _elasticMonitorResourceRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, monitorName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<ElasticMonitorResource> CreateOrUpdate(WaitUntil waitUntil, string monitorName, ElasticMonitorResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _elasticMonitorResourceRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, monitorName, data, cancellationToken);
                var operation = new ElasticArmOperation<ElasticMonitorResource>(new ElasticMonitorResourceOperationSource(Client), _elasticMonitorResourceClientDiagnostics, Pipeline, _elasticMonitorResourceRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, monitorName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ElasticMonitorResource>> GetAsync(string monitorName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _elasticMonitorResourceClientDiagnostics.CreateScope("ElasticMonitorResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _elasticMonitorResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, monitorName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ElasticMonitorResource> Get(string monitorName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _elasticMonitorResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, monitorName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ElasticMonitorResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _elasticMonitorResourceRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _elasticMonitorResourceRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string monitorName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _elasticMonitorResourceClientDiagnostics.CreateScope("ElasticMonitorResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _elasticMonitorResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, monitorName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string monitorName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _elasticMonitorResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, monitorName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<ElasticMonitorResource>> GetIfExistsAsync(string monitorName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _elasticMonitorResourceClientDiagnostics.CreateScope("ElasticMonitorResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _elasticMonitorResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, monitorName, cancellationToken: cancellationToken).ConfigureAwait(false);
