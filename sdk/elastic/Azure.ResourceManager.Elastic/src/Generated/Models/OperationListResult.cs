...
{
    /// <summary> Represents a paginated list of operations. </summary>
    internal partial class OperationListResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="OperationListResult"/>. </summary>
        /// <param name="value"> The list of operations. </param>
        /// <param name="nextLink"> The URL to get the next set of results, if any. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal OperationListResult(IReadOnlyList<OperationResult> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
