...
{
    public partial class MonitoredResource : IUtf8JsonSerializable, IJsonModel<MonitoredResource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitoredResource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MonitoredResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MonitoredResource IJsonModel<MonitoredResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MonitoredResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static MonitoredResource DeserializeMonitoredResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MonitoredResource(id, sendingLogs, reasonForLogsStatus, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<MonitoredResource>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MonitoredResource>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MonitoredResource IPersistableModel<MonitoredResource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MonitoredResource>)this).GetFormatFromOptions(options) : options.Format;
