...
namespace Azure.ResourceManager.Elastic
{
    public partial class MonitoringTagRuleResource : IJsonModel<MonitoringTagRuleData>
    {
        ...
        BinaryData IPersistableModel<MonitoringTagRuleData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<MonitoringTagRuleData>(Data, options, AzureResourceManagerElasticContext.Default);

        MonitoringTagRuleData IPersistableModel<MonitoringTagRuleData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<MonitoringTagRuleData>(data, options, AzureResourceManagerElasticContext.Default);
