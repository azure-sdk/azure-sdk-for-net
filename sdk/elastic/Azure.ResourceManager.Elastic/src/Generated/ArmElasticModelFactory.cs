...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public static partial class ArmElasticModelFactory
    {
        ...
        public static OperationResult OperationResult(string name = null, bool? isDataAction = null, OperationDisplay display = null, string origin = null)
        {
            return new OperationResult(name, isDataAction, display, origin, serializedAdditionalRawData: null);
        }
        ...
        public static ElasticCloudUser ElasticCloudUser(string emailAddress = null, string id = null, string elasticCloudSsoDefaultUri = null)
        {
        ...
        public static ElasticCloudDeployment ElasticCloudDeployment(string name = null, string deploymentId = null, string azureSubscriptionId = null, string elasticsearchRegion = null, string elasticsearchServiceUri = null, string kibanaServiceUri = null, string kibanaSsoUri = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.MonitoredResource"/>. </summary>
        ...
        {
            return new MonitoredResource(id, sendingLogs, reasonForLogsStatus, serializedAdditionalRawData: null);
        }
        ...
        public static DeploymentInfoResponse DeploymentInfoResponse(ElasticDeploymentStatus? status = null, string version = null, string memoryCapacity = null, string diskCapacity = null, string elasticsearchEndPoint = null, string deploymentUri = null, MarketplaceSaaSInfo marketplaceSaasInfo = null, string projectType = null, string configurationType = null)
        {
        ...
        public static PartnerBillingEntity PartnerBillingEntity(string id = null, string name = null, string partnerEntityUri = null)
        {
        ...
        public static ConnectedPartnerResourceProperties ConnectedPartnerResourceProperties(string partnerDeploymentName = null, string partnerDeploymentUri = null, string azureResourceId = null, string location = null, string type = null)
        {
        ...
        /// <param name="type"> Type of the elastic filter. </param>
        ...
        public static ElasticTrafficFilter ElasticTrafficFilter(string id = null, string name = null, string description = null, string region = null, Type? type = null, bool? includeByDefault = null, IEnumerable<ElasticTrafficFilterRule> rules = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ArmResponseElasticMonitorResource"/>. </summary>
        /// <param name="body"> The body type of the operation request or response. </param>
        /// <returns> A new <see cref="Models.ArmResponseElasticMonitorResource"/> instance for mocking. </returns>
        public static ArmResponseElasticMonitorResource ArmResponseElasticMonitorResource(ElasticMonitorResourceData body = null)
        {
            return new ArmResponseElasticMonitorResource(body, serializedAdditionalRawData: null);
        }
