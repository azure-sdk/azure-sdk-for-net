...
namespace Azure.ResourceManager.Elastic
{
    ...
    {
        private readonly ClientDiagnostics _openAIIntegrationRPModelClientDiagnostics;
        private readonly OpenAIIntegrationRPModelsRestOperations _openAIIntegrationRPModelRestClient;
        ...
        {
            _openAIIntegrationRPModelClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Elastic", OpenAIIntegrationRPModelResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(OpenAIIntegrationRPModelResource.ResourceType, out string openAIIntegrationRPModelApiVersion);
            _openAIIntegrationRPModelRestClient = new OpenAIIntegrationRPModelsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, openAIIntegrationRPModelApiVersion);
#if DEBUG
        ...
        public virtual async Task<ArmOperation<OpenAIIntegrationRPModelResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string integrationName, OpenAIIntegrationRPModelData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _openAIIntegrationRPModelClientDiagnostics.CreateScope("OpenAIIntegrationRPModelCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _openAIIntegrationRPModelRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, data, cancellationToken).ConfigureAwait(false);
                var uri = _openAIIntegrationRPModelRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, data);
        ...
        public virtual ArmOperation<OpenAIIntegrationRPModelResource> CreateOrUpdate(WaitUntil waitUntil, string integrationName, OpenAIIntegrationRPModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _openAIIntegrationRPModelRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, data, cancellationToken);
                var uri = _openAIIntegrationRPModelRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new ElasticArmOperation<OpenAIIntegrationRPModelResource>(Response.FromValue(new OpenAIIntegrationRPModelResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<OpenAIIntegrationRPModelResource>> GetAsync(string integrationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _openAIIntegrationRPModelClientDiagnostics.CreateScope("OpenAIIntegrationRPModelCollection.Get");
            scope.Start();
            try
            {
                var response = await _openAIIntegrationRPModelRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<OpenAIIntegrationRPModelResource> Get(string integrationName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _openAIIntegrationRPModelRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new OpenAIIntegrationRPModelResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _openAIIntegrationRPModelRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _openAIIntegrationRPModelRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
        ...
        public virtual Pageable<OpenAIIntegrationRPModelResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _openAIIntegrationRPModelRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _openAIIntegrationRPModelRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new OpenAIIntegrationRPModelResource(Client, OpenAIIntegrationRPModelData.DeserializeOpenAIIntegrationRPModelData(e)), _openAIIntegrationRPModelClientDiagnostics, Pipeline, "OpenAIIntegrationRPModelCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string integrationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _openAIIntegrationRPModelClientDiagnostics.CreateScope("OpenAIIntegrationRPModelCollection.Exists");
            scope.Start();
            try
            {
                var response = await _openAIIntegrationRPModelRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string integrationName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _openAIIntegrationRPModelRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<OpenAIIntegrationRPModelResource>> GetIfExistsAsync(string integrationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _openAIIntegrationRPModelClientDiagnostics.CreateScope("OpenAIIntegrationRPModelCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _openAIIntegrationRPModelRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationName, cancellationToken: cancellationToken).ConfigureAwait(false);
