...
namespace Azure.AI.SpeechToText.BatchTranscription
{
    ...
    public partial class TranscriptionFile
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="links"/>, <paramref name="name"/>, <paramref name="properties"/> or <paramref name="self"/> is null. </exception>
        internal TranscriptionFile(DateTimeOffset createdDateTime, FileKind kind, FileLinks links, string name, FileProperties properties, Uri self)
        {
        ...
        internal TranscriptionFile(DateTimeOffset createdDateTime, FileKind kind, FileLinks links, string name, FileProperties properties, Uri self, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            Kind = kind;
            Links = links;
