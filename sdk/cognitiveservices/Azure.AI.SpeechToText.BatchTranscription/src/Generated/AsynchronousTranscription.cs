...
namespace Azure.AI.SpeechToText.BatchTranscription
{
    ...
    public partial class AsynchronousTranscription
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AsynchronousTranscription"/>. </summary>
        ...
        public AsynchronousTranscription(TranscriptionProperties properties, string locale, string displayName)
        {
        ...
        internal AsynchronousTranscription(TranscriptionLinks links, TranscriptionProperties properties, Uri self, EntityReference model, EntityReference dataset, IList<Uri> contentUrls, Uri contentContainerUrl, string locale, string displayName, string description, IDictionary<string, string> customProperties, DateTimeOffset? lastActionDateTime, ApiStatus? status, DateTimeOffset? createdDateTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Links = links;
            Properties = properties;
            Self = self;
        ...
        /// <summary> Initializes a new instance of <see cref="AsynchronousTranscription"/> for deserialization. </summary>
        internal AsynchronousTranscription()
        {
        }

        /// <summary> TranscriptionLinks. </summary>
