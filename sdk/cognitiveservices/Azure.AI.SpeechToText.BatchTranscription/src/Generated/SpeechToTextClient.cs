...
namespace Azure.AI.SpeechToText.BatchTranscription
{
    ...
    public partial class SpeechToTextClient
    {
        ...
        public virtual BatchTranscription GetBatchTranscriptionClient(ServiceApiVersions? serviceApiVersionsQueryParameter = null)
        {
            return new BatchTranscription(ClientDiagnostics, _pipeline, _keyCredential, _endpoint, serviceApiVersionsQueryParameter);
        }
    }
}
