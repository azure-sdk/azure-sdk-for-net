...
namespace Azure.AI.SpeechToText.BatchTranscription
{
    ...
    public partial class PageableTranscription
    {
        ...
        {
            Values = new ChangeTrackingList<AsynchronousTranscription>();
        }
        ...
        internal PageableTranscription(IReadOnlyList<AsynchronousTranscription> values, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Values = values;
            NextLink = nextLink;
        ...
        /// It's recommended to build a list on the client and delete after the fetching of the complete list.
        /// </summary>
        public IReadOnlyList<AsynchronousTranscription> Values { get; }
