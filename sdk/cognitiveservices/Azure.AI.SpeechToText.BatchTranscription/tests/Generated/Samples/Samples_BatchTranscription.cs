...
namespace Azure.AI.SpeechToText.BatchTranscription.Samples
{
    public partial class Samples_BatchTranscription
    {
        ...
        public void Example_BatchTranscription_SubmitTranscription_ShortVersion_Convenience()
        {
            ...
            AsynchronousTranscription transcription = new AsynchronousTranscription(new TranscriptionProperties("<timeToLive>"), "<locale>", "<displayName>");
...
"http://localhost:3000"
        ...
        public void Example_BatchTranscription_SubmitTranscription_AllParameters_Convenience()
        {
            ...
            AsynchronousTranscription transcription = new AsynchronousTranscription(new TranscriptionProperties("<timeToLive>")
            {
                WordLevelTimestampsEnabled = true,
                DisplayFormWordLevelTimestampsEnabled = true,
                Channels = { 1234 },
