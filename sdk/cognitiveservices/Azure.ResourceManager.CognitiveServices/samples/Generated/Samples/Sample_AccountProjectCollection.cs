...
{
    public partial class Sample_AccountProjectCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CreateProject()
        {
            ...
            // get the collection of this AccountProjectResource
            AccountProjectCollection collection = cognitiveServicesAccount.GetAccountProjects();
...
ResourceId = new ResourceIdentifier("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/myStorageAccount"),
            ...
            ArmOperation<AccountProjectResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, projectName, data);
        ...
        public async Task Get_GetProject()
        {
            ...
            AccountProjectResource result = await collection.GetAsync(projectName);
        ...
        public async Task GetAll_ListProject()
        {
            ...
            await foreach (AccountProjectResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_GetProject()
        {
            ...
            // invoke the operation
            string projectName = "myProject";
            NullableResponse<AccountProjectResource> response = await collection.GetIfExistsAsync(projectName);
            AccountProjectResource result = response.HasValue ? response.Value : null;
