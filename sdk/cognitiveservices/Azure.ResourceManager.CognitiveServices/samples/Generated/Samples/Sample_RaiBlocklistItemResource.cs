...
namespace Azure.ResourceManager.CognitiveServices.Samples
{
    public partial class Sample_RaiBlocklistItemResource
    {
        ...
        public async Task Get_GetRaiPolicy()
        {
            ...
            // this example is just showing the usage of "RaiBlocklistItem_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task Update_PutRaiPolicy()
        {
            ...
            // this example is just showing the usage of "RaiBlocklistItem_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2023-10-01-preview/examples/DeleteRaiBlocklistItem.json
            // this example is just showing the usage of "RaiBlocklistItem_Delete" operation, for the dependent resources, they will have to be created separately.
