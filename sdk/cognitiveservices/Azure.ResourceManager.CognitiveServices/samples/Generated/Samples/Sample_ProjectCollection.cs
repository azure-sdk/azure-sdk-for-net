...
namespace Azure.ResourceManager.CognitiveServices.Samples
{
    public partial class Sample_ProjectCollection
    {
        ...
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/stable/2025-04-01/examples/CreateProject.json
            ...
            ProjectCollection collection = cognitiveServicesAccount.GetProjects();

            // invoke the operation
            string projectName = "testProject1";
            ProjectData data = new ProjectData(new AzureLocation("West US"))
            {
        ...
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/stable/2025-04-01/examples/CreateProjectMin.json
            // this example is just showing the usage of "Projects_Create" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/stable/2025-04-01/examples/GetProject.json
        ...
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/stable/2025-04-01/examples/ListProjects.json
