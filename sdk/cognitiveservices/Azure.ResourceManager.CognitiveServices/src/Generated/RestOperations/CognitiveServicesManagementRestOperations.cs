...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class CognitiveServicesManagementRestOperations
    {
        ...
        internal RequestUriBuilder CreateCalculateModelCapacityRequestUri(string subscriptionId, CalculateModelCapacityParameter calculateModelCapacityParameter)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCalculateModelCapacityRequest(string subscriptionId, CalculateModelCapacityParameter calculateModelCapacityParameter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
            ...
            content.JsonWriter.WriteObjectValue(calculateModelCapacityParameter, ModelSerializationExtensions.WireOptions);
        ...
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="calculateModelCapacityParameter"> Check Domain Availability parameter. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="calculateModelCapacityParameter"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<CalculateModelCapacityResult>> CalculateModelCapacityAsync(string subscriptionId, CalculateModelCapacityParameter calculateModelCapacityParameter, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(calculateModelCapacityParameter, nameof(calculateModelCapacityParameter));

            using var message = CreateCalculateModelCapacityRequest(subscriptionId, calculateModelCapacityParameter);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="calculateModelCapacityParameter"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<CalculateModelCapacityResult> CalculateModelCapacity(string subscriptionId, CalculateModelCapacityParameter calculateModelCapacityParameter, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(calculateModelCapacityParameter, nameof(calculateModelCapacityParameter));
