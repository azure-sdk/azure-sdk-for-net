...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class RaiBlocklistData : ResourceData
    {
        ...
        internal RaiBlocklistData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, RaiBlocklistProperties properties) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
