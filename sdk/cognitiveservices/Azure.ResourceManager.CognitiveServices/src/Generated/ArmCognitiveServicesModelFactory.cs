...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public static partial class ArmCognitiveServicesModelFactory
    {
        ...
        /// <param name="mode"> Rai policy mode. The enum value mapping is as below: Default = 0, Deferred=1, Blocking=2, Asynchronous_filter =3. Please use 'Asynchronous_filter' after 2024-06-01-preview. It is the same as 'Deferred' in previous version. </param>
        ...
        public static RaiContentFilter RaiContentFilter(string name = null, bool? isMultiLevelFilter = null, RaiPolicyContentSource? source = null)
        {
            return new RaiContentFilter(name, isMultiLevelFilter, source, serializedAdditionalRawData: null);
        }
