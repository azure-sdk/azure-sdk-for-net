...
{
    public partial class OAuth2AuthTypeConnectionProperties : IUtf8JsonSerializable, IJsonModel<OAuth2AuthTypeConnectionProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OAuth2AuthTypeConnectionProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<OAuth2AuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        OAuth2AuthTypeConnectionProperties IJsonModel<OAuth2AuthTypeConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<OAuth2AuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static OAuth2AuthTypeConnectionProperties DeserializeOAuth2AuthTypeConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ConnectionOAuth2 credentials = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credentials"u8))
                {
                    ...
                    credentials = ConnectionOAuth2.DeserializeConnectionOAuth2(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<OAuth2AuthTypeConnectionProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<OAuth2AuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        OAuth2AuthTypeConnectionProperties IPersistableModel<OAuth2AuthTypeConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<OAuth2AuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
