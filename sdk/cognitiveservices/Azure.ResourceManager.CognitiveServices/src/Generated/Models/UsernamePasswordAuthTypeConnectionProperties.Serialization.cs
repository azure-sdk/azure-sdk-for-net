...
{
    public partial class UsernamePasswordAuthTypeConnectionProperties : IUtf8JsonSerializable, IJsonModel<UsernamePasswordAuthTypeConnectionProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UsernamePasswordAuthTypeConnectionProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<UsernamePasswordAuthTypeConnectionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<UsernamePasswordAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UsernamePasswordAuthTypeConnectionProperties)} does not support writing '{format}' format.");
            }
        ...
        UsernamePasswordAuthTypeConnectionProperties IJsonModel<UsernamePasswordAuthTypeConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<UsernamePasswordAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UsernamePasswordAuthTypeConnectionProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeUsernamePasswordAuthTypeConnectionProperties(document.RootElement, options);
        }

        internal static UsernamePasswordAuthTypeConnectionProperties DeserializeUsernamePasswordAuthTypeConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ConnectionUsernamePassword credentials = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credentials"u8))
                {
                    ...
                    credentials = ConnectionUsernamePassword.DeserializeConnectionUsernamePassword(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<UsernamePasswordAuthTypeConnectionProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<UsernamePasswordAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UsernamePasswordAuthTypeConnectionProperties)} does not support writing '{options.Format}' format.");
            }
        }

        UsernamePasswordAuthTypeConnectionProperties IPersistableModel<UsernamePasswordAuthTypeConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<UsernamePasswordAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UsernamePasswordAuthTypeConnectionProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<UsernamePasswordAuthTypeConnectionProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
