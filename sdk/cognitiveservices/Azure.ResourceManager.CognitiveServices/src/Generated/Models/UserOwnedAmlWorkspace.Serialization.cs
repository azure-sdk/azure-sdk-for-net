...
{
    public partial class UserOwnedAmlWorkspace : IUtf8JsonSerializable
    {
        ...
        internal static UserOwnedAmlWorkspace DeserializeUserOwnedAmlWorkspace(JsonElement element)
        {
            ...
            return new UserOwnedAmlWorkspace(resourceId.Value, Optional.ToNullable(identityClientId));
        }
    }
}
