...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CalculateModelCapacityParameter
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CalculateModelCapacityParameter"/>. </summary>
        ...
        internal CalculateModelCapacityParameter(CognitiveServicesAccountDeploymentModel model, string skuName, IList<ModelCapacityCalculatorWorkload> workloads, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Model = model;
            SkuName = skuName;
            Workloads = workloads;
