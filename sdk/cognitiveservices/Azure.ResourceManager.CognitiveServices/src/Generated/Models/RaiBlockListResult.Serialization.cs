...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RaiBlockListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RaiBlockListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RaiBlockListResult)} does not support '{format}' format.");
            }
        ...
        internal static RaiBlockListResult DeserializeRaiBlockListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RaiBlockListResult(nextLink.Value, Optional.ToList(value), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<RaiBlockListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RaiBlockListResult)} does not support '{options.Format}' format.");
            }
        }
