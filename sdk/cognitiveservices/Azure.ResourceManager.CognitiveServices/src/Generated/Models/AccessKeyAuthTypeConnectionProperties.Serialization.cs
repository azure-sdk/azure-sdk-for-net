...
{
    public partial class AccessKeyAuthTypeConnectionProperties : IUtf8JsonSerializable, IJsonModel<AccessKeyAuthTypeConnectionProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AccessKeyAuthTypeConnectionProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AccessKeyAuthTypeConnectionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AccessKeyAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AccessKeyAuthTypeConnectionProperties)} does not support writing '{format}' format.");
            }
        ...
        AccessKeyAuthTypeConnectionProperties IJsonModel<AccessKeyAuthTypeConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AccessKeyAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AccessKeyAuthTypeConnectionProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAccessKeyAuthTypeConnectionProperties(document.RootElement, options);
        }

        internal static AccessKeyAuthTypeConnectionProperties DeserializeAccessKeyAuthTypeConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ConnectionAccessKey credentials = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credentials"u8))
                {
                    ...
                    credentials = ConnectionAccessKey.DeserializeConnectionAccessKey(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<AccessKeyAuthTypeConnectionProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AccessKeyAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AccessKeyAuthTypeConnectionProperties)} does not support writing '{options.Format}' format.");
            }
        }

        AccessKeyAuthTypeConnectionProperties IPersistableModel<AccessKeyAuthTypeConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AccessKeyAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AccessKeyAuthTypeConnectionProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AccessKeyAuthTypeConnectionProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
