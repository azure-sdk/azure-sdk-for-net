...
namespace Azure.ResourceManager.CognitiveServices
{
    public partial class EncryptionScopeData : IUtf8JsonSerializable, IJsonModel<EncryptionScopeData>
    {
        ...
        internal static EncryptionScopeData DeserializeEncryptionScopeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<EncryptionScopeProperties> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = EncryptionScopeProperties.DeserializeEncryptionScopeProperties(property.Value);
                    continue;
                }
            ...
            return new EncryptionScopeData(id, name, type, systemData.Value, Optional.ToNullable(etag), Optional.ToDictionary(tags), properties.Value, serializedAdditionalRawData);
        }
