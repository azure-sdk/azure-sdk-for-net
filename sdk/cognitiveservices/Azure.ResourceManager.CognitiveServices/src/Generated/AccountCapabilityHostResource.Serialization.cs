...
namespace Azure.ResourceManager.CognitiveServices
{
    public partial class AccountCapabilityHostResource : IJsonModel<CapabilityHostData>
    {
        ...
        BinaryData IPersistableModel<CapabilityHostData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        CapabilityHostData IPersistableModel<CapabilityHostData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<CapabilityHostData>(data, options);
