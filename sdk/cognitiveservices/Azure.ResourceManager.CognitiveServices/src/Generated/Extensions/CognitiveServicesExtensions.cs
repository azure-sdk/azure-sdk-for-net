...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public static partial class CognitiveServicesExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing an <see cref="AccountProjectResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="AccountProjectResource.CreateResourceIdentifier" /> to create an <see cref="AccountProjectResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableCognitiveServicesArmClient.GetAccountProjectResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        /// <returns> Returns a <see cref="AccountProjectResource"/> object. </returns>
        public static AccountProjectResource GetAccountProjectResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableCognitiveServicesArmClient(client).GetAccountProjectResource(id);
        }
