...
namespace Azure.ResourceManager.CognitiveServices.Mocking
{
    ...
    public partial class MockableCognitiveServicesSubscriptionResource : ArmResource
    {
        ...
        public virtual async Task<Response<CalculateModelCapacityResult>> CalculateModelCapacityAsync(CalculateModelCapacityParameter calculateModelCapacityParameter, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await DefaultRestClient.CalculateModelCapacityAsync(Id.SubscriptionId, calculateModelCapacityParameter, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="calculateModelCapacityParameter"/> is null. </exception>
        public virtual Response<CalculateModelCapacityResult> CalculateModelCapacity(CalculateModelCapacityParameter calculateModelCapacityParameter, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(calculateModelCapacityParameter, nameof(calculateModelCapacityParameter));
            ...
            try
            {
                var response = DefaultRestClient.CalculateModelCapacity(Id.SubscriptionId, calculateModelCapacityParameter, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
