...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class CognitiveServicesAccountResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of AccountProjectResources in the CognitiveServicesAccount. </summary>
        /// <returns> An object representing collection of AccountProjectResources and their operations over a AccountProjectResource. </returns>
        public virtual AccountProjectCollection GetAccountProjects()
        {
            return GetCachedClient(client => new AccountProjectCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<AccountProjectResource>> GetAccountProjectAsync(string projectName, CancellationToken cancellationToken = default)
        {
            return await GetAccountProjects().GetAsync(projectName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="projectName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<AccountProjectResource> GetAccountProject(string projectName, CancellationToken cancellationToken = default)
        {
            return GetAccountProjects().Get(projectName, cancellationToken);
        }
