...
namespace Azure.ResourceManager.CognitiveServices
{
    public partial class AccountProjectConnectionResource : IJsonModel<ConnectionPropertiesV2BasicResourceData>
    {
        ...
        BinaryData IPersistableModel<ConnectionPropertiesV2BasicResourceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        ConnectionPropertiesV2BasicResourceData IPersistableModel<ConnectionPropertiesV2BasicResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ConnectionPropertiesV2BasicResourceData>(data, options);
