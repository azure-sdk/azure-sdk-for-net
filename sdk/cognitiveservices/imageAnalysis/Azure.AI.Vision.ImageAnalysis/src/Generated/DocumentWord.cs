...
namespace Azure.AI.Vision.ImageAnalysis
{
    ...
    public partial class DocumentWord
    {
        ...
        internal DocumentWord(IEnumerable<double> boundingBox, double confidence, string content, DocumentSpan span)
        {
        ...
        /// <param name="content"> Text content of the word. </param>
        /// <param name="span"> Location of the word in the reading order concatenated content. </param>
        internal DocumentWord(IReadOnlyList<double> boundingBox, double confidence, string content, DocumentSpan span)
        {
