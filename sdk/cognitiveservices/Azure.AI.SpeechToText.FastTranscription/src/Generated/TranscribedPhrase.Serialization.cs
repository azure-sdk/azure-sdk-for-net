...
namespace Azure.AI.SpeechToText.FastTranscription
{
    public partial class TranscribedPhrase : IUtf8JsonSerializable, IJsonModel<TranscribedPhrase>
    {
        ...
        internal static TranscribedPhrase DeserializeTranscribedPhrase(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string text = default;
            IReadOnlyList<TimestampedWord> words = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("words"u8))
                {
                    ...
                    List<TimestampedWord> array = new List<TimestampedWord>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(TimestampedWord.DeserializeTimestampedWord(item, options));
                    }
                    words = array;
                    continue;
                }
