...
namespace Azure.AI.SpeechToText.FastTranscription
{
    ...
    public partial class TimestampedWord
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TimestampedWord"/>. </summary>
        ...
        internal TimestampedWord(string text, int offsetMilliseconds, int durationMilliseconds)
        {
        ...
        internal TimestampedWord(string text, int offsetMilliseconds, int durationMilliseconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            OffsetMilliseconds = offsetMilliseconds;
            DurationMilliseconds = durationMilliseconds;
        ...
        /// <summary> Initializes a new instance of <see cref="TimestampedWord"/> for deserialization. </summary>
