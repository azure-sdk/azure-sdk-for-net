...
namespace Azure.AI.SpeechToText.FastTranscription
{
    ...
    public partial class TranscribedPhrase
    {
        ...
        internal TranscribedPhrase(int offsetMilliseconds, int durationMilliseconds, string text, float confidence)
        {
            ...
            Text = text;
            Words = new ChangeTrackingList<TimestampedWord>();
        ...
        internal TranscribedPhrase(int? channel, int? speaker, int offsetMilliseconds, int durationMilliseconds, string text, IReadOnlyList<TimestampedWord> words, string locale, float confidence, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Channel = channel;
            Speaker = speaker;
            OffsetMilliseconds = offsetMilliseconds;
        ...
        public IReadOnlyList<TimestampedWord> Words { get; }
