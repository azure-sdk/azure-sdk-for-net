...
namespace Azure.Developer.DevCenter.Models
{
    ...
    public partial class DevCenterEnvironmentType
    {
        ...
        internal DevCenterEnvironmentType(string name, string deploymentTargetId, EnvironmentTypeStatus status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            DeploymentTargetId = deploymentTargetId;
            Status = status;
