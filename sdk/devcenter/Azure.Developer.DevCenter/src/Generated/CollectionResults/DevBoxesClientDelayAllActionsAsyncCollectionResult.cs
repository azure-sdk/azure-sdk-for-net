...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientDelayAllActionsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DevBoxesClientDelayAllActionsAsyncCollectionResult(DevBoxesClient client, string projectName, string userId, string devBoxName, DateTimeOffset delayUntil, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
