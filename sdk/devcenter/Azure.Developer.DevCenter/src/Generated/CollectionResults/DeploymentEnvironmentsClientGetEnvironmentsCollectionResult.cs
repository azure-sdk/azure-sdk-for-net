...
namespace Azure.Developer.DevCenter
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentsCollectionResult : Pageable<BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentsCollectionResult(DeploymentEnvironmentsClient client, string projectName, string userId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
