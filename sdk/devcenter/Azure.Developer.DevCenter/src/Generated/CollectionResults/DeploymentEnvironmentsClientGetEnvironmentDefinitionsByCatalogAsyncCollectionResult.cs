...
namespace Azure.Developer.DevCenter
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogAsyncCollectionResult(DeploymentEnvironmentsClient client, string projectName, string catalogName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
