...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetDevBoxActionsCollectionResultOfT : Pageable<DevBoxAction>
    {
        ...
        public DevBoxesClientGetDevBoxActionsCollectionResultOfT(DevBoxesClient client, string projectName, string userId, string devBoxName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
