...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetAllDevBoxesByUserAsyncCollectionResultOfT : AsyncPageable<DevBox>
    {
        ...
        public DevBoxesClientGetAllDevBoxesByUserAsyncCollectionResultOfT(DevBoxesClient client, string userId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _userId = userId;
            _context = context;
