...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetAllDevBoxesByUserCollectionResultOfT : Pageable<DevBox>
    {
        ...
        public DevBoxesClientGetAllDevBoxesByUserCollectionResultOfT(DevBoxesClient client, string userId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _userId = userId;
            _context = context;
