...
{
    internal partial class DevBoxesClientGetSchedulesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of DevBoxesClientGetSchedulesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public DevBoxesClientGetSchedulesAsyncCollectionResult(DevBoxesClient client, string projectName, string poolName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DevBoxesClientGetSchedulesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DevBoxesClientGetSchedulesAsyncCollectionResult as an enumerable collection. </returns>
