...
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogCollectionResult(DeploymentEnvironmentsClient client, string projectName, string catalogName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogCollectionResult as an enumerable collection. </returns>
