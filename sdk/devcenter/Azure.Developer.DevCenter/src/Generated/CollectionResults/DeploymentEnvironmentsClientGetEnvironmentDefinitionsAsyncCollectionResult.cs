...
namespace Azure.Developer.DevCenter
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentDefinitionsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentDefinitionsAsyncCollectionResult(DeploymentEnvironmentsClient client, string projectName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
