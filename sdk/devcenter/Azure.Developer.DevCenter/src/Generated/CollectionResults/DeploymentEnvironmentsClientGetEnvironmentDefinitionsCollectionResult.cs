...
namespace Azure.Developer.DevCenter
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentDefinitionsCollectionResult : Pageable<BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentDefinitionsCollectionResult(DeploymentEnvironmentsClient client, string projectName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
