...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetDevBoxesCollectionResultOfT : Pageable<DevBox>
    {
        ...
        public DevBoxesClientGetDevBoxesCollectionResultOfT(DevBoxesClient client, string projectName, string userId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
