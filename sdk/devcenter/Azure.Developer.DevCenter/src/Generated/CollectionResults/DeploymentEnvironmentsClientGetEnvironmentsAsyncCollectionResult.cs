...
namespace Azure.Developer.DevCenter
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentsAsyncCollectionResult(DeploymentEnvironmentsClient client, string projectName, string userId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
