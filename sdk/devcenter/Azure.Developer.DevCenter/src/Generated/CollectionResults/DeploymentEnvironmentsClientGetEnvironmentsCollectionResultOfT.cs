...
namespace Azure.Developer.DevCenter
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentsCollectionResultOfT : Pageable<DevCenterEnvironment>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentsCollectionResultOfT(DeploymentEnvironmentsClient client, string projectName, string userId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
