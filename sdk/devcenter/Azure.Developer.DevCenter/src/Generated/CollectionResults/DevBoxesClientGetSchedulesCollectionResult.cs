...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetSchedulesCollectionResult : Pageable<BinaryData>
    {
        ...
        public DevBoxesClientGetSchedulesCollectionResult(DevBoxesClient client, string projectName, string poolName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
