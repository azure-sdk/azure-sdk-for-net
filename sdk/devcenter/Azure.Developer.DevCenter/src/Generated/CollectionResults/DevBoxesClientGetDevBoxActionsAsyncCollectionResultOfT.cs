...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetDevBoxActionsAsyncCollectionResultOfT : AsyncPageable<DevBoxAction>
    {
        ...
        public DevBoxesClientGetDevBoxActionsAsyncCollectionResultOfT(DevBoxesClient client, string projectName, string userId, string devBoxName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
