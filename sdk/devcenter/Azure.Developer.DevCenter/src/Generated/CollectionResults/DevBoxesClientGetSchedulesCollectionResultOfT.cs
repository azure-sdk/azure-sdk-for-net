...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetSchedulesCollectionResultOfT : Pageable<DevBoxSchedule>
    {
        ...
        public DevBoxesClientGetSchedulesCollectionResultOfT(DevBoxesClient client, string projectName, string poolName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
