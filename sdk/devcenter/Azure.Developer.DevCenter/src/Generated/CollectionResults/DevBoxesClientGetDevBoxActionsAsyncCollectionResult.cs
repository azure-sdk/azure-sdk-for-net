...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetDevBoxActionsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DevBoxesClientGetDevBoxActionsAsyncCollectionResult(DevBoxesClient client, string projectName, string userId, string devBoxName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
