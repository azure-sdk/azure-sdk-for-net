...
{
    internal partial class DevBoxesClientGetDevBoxActionsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of DevBoxesClientGetDevBoxActionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public DevBoxesClientGetDevBoxActionsCollectionResult(DevBoxesClient client, string projectName, string userId, string devBoxName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DevBoxesClientGetDevBoxActionsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DevBoxesClientGetDevBoxActionsCollectionResult as an enumerable collection. </returns>
