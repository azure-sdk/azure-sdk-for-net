...
namespace Azure.Developer.DevCenter
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentsAsyncCollectionResultOfT : AsyncPageable<DevCenterEnvironment>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentsAsyncCollectionResultOfT(DeploymentEnvironmentsClient client, string projectName, string userId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
