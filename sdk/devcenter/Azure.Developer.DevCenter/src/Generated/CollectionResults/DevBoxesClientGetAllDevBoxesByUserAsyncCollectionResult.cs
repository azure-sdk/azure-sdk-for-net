...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetAllDevBoxesByUserAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DevBoxesClientGetAllDevBoxesByUserAsyncCollectionResult(DevBoxesClient client, string userId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _userId = userId;
            _context = context;
