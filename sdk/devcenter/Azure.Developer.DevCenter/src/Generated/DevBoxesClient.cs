...
namespace Azure.Developer.DevCenter
{
    ...
    public partial class DevBoxesClient
    {
        ...
        /// <summary> Lists Dev Boxes in the Dev Center for a parasadticular user. </summary>
        /// <param name="userId"> The AAD object id of the user. If value is 'me', the identity is taken from the authentication context. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        /// <summary>
        /// [Protocol Method] Lists Dev Boxes in the Dev Center for a parasadticular user.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
