...
{
    /// <summary> Represents the settings used to configure a <see cref="DeploymentEnvironmentsClient"/> that can be loaded from an <see cref="IConfigurationSection"/>. </summary>
    [Experimental("SCME0002")]
    public partial class DeploymentEnvironmentsClientSettings : ClientSettings
    {
