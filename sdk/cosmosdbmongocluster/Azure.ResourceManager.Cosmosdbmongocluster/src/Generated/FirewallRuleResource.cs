...
namespace Azure.ResourceManager.Cosmosdbmongocluster
{
    ...
    public partial class FirewallRuleResource : ArmResource
    {
        ...
        {
            _firewallRuleMongoClustersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Cosmosdbmongocluster", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CosmosdbmongoclusterArmOperation(_firewallRuleMongoClustersClientDiagnostics, Pipeline, _firewallRuleMongoClustersRestClient.CreateDeleteFirewallRuleRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
