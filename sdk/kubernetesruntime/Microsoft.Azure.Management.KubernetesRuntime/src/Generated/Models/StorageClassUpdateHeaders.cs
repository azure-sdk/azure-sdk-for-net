...
namespace Microsoft.Azure.Management.KubernetesRuntime.Models
{
    ...
    /// </summary>
    public partial class StorageClassUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StorageClassUpdateHeaders class.
        /// </summary>
        public StorageClassUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public StorageClassUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
