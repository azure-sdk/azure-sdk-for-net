...
namespace Microsoft.Azure.Management.KubernetesRuntime.Models
{
    ...
    /// </summary>
    public partial class BgpPeersDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BgpPeersDeleteHeaders class.
        /// </summary>
        public BgpPeersDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public BgpPeersDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
