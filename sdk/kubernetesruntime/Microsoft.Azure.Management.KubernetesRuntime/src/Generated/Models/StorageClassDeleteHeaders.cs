...
namespace Microsoft.Azure.Management.KubernetesRuntime.Models
{
    ...
    /// </summary>
    public partial class StorageClassDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StorageClassDeleteHeaders class.
        /// </summary>
        public StorageClassDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public StorageClassDeleteHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
