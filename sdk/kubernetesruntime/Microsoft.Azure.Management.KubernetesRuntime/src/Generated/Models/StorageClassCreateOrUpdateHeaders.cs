...
namespace Microsoft.Azure.Management.KubernetesRuntime.Models
{
    ...
    /// </summary>
    public partial class StorageClassCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StorageClassCreateOrUpdateHeaders
        /// class.
        /// </summary>
        public StorageClassCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public StorageClassCreateOrUpdateHeaders(int? retryAfter = default(int?))
        {
