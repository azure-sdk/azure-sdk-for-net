...
namespace Microsoft.Azure.Management.KubernetesRuntime
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<MicrosoftKubernetesRuntimeClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(MicrosoftKubernetesRuntimeClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.KubernetesRuntime/operations").ToString();
