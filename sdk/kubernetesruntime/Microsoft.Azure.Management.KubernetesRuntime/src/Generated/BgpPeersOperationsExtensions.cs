...
namespace Microsoft.Azure.Management.KubernetesRuntime
{
    ...
    public static partial class BgpPeersOperationsExtensions
    {
            ...
            /// The name of the BgpPeer
            /// </param>
            public static BgpPeersDeleteHeaders Delete(this IBgpPeersOperations operations, string resourceUri, string bgpPeerName)
            {
                return operations.DeleteAsync(resourceUri, bgpPeerName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BgpPeersDeleteHeaders> DeleteAsync(this IBgpPeersOperations operations, string resourceUri, string bgpPeerName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DeleteWithHttpMessagesAsync(resourceUri, bgpPeerName, null, cancellationToken).ConfigureAwait(false))
                {
            ...
            /// The name of the BgpPeer
            /// </param>
            public static BgpPeersDeleteHeaders BeginDelete(this IBgpPeersOperations operations, string resourceUri, string bgpPeerName)
            {
                return operations.BeginDeleteAsync(resourceUri, bgpPeerName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BgpPeersDeleteHeaders> BeginDeleteAsync(this IBgpPeersOperations operations, string resourceUri, string bgpPeerName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDeleteWithHttpMessagesAsync(resourceUri, bgpPeerName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Headers;
                }
            }
