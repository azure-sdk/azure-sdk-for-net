...
namespace Azure.ResourceManager.RedisEnterprise
{
    ...
    public partial class RedisEnterpriseClusterData : TrackedResourceData
    {
        ...
        /// <param name="minTlsVersion"> The minimum TLS version for the cluster to support, e.g. the default of &apos;1.2&apos;. </param>
        /// <param name="provisioningState"> Current provisioning status of the last operation on the cluster. </param>
        ...
        internal RedisEnterpriseClusterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, RedisEnterpriseSku sku, string hostName, RedisEnterpriseTlsVersion? minTlsVersion, RedisEnterpriseProvisioningStatus? provisioningState, RedisEnterpriseClusterResourceState? resourceState, string redisVersion) : base(id, name, resourceType, systemData, tags, location)
        {
            Sku = sku;
            HostName = hostName;
        ...
        /// <summary> The minimum TLS version for the cluster to support, e.g. the default of &apos;1.2&apos;. </summary>
        public RedisEnterpriseTlsVersion? MinTlsVersion { get; set; }
        /// <summary> Current provisioning status of the last operation on the cluster. </summary>
