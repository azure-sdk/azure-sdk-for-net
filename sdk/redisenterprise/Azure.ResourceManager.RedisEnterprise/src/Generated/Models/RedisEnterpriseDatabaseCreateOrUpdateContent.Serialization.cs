...
{
    public partial class RedisEnterpriseDatabaseCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static RedisEnterpriseDatabaseCreateOrUpdateContent DeserializeRedisEnterpriseDatabaseCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new RedisEnterpriseDatabaseCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToNullable(clientProtocol), Optional.ToNullable(evictionPolicy), Optional.ToNullable(port), persistence.Value);
        }
    }
}
