...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    public partial class PrivateLink : IUtf8JsonSerializable
    {
        ...
        internal static PrivateLink DeserializePrivateLink(JsonElement element)
        {
            ...
            return new PrivateLink(id, name, type, systemData.Value, groupId.Value, Optional.ToList(requiredMembers), Optional.ToList(requiredZoneNames), Optional.ToNullable(provisioningState));
        }
    }
}
