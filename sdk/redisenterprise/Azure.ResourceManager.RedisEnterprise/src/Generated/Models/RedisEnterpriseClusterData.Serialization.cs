...
namespace Azure.ResourceManager.RedisEnterprise
{
    public partial class RedisEnterpriseClusterData : IUtf8JsonSerializable
    {
        ...
        internal static RedisEnterpriseClusterData DeserializeRedisEnterpriseClusterData(JsonElement element)
        {
            ...
            return new RedisEnterpriseClusterData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, sku, Optional.ToList(zones), identity.Value, Optional.ToNullable(minimumTlsVersion), encryption.Value, hostName.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(resourceState), redisVersion.Value, Optional.ToList(privateEndpointConnections));
        }
    }
}
