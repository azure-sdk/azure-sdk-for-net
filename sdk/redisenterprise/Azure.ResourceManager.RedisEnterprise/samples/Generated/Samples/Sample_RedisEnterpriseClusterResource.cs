...
namespace Azure.ResourceManager.RedisEnterprise.Samples
{
    public partial class Sample_RedisEnterpriseClusterResource
    {
        ...
        {
            // Generated from example definition: specification/redisenterprise/resource-manager/Microsoft.Cache/preview/2023-10-01-preview/examples/RedisEnterpriseUpdate.json
...
["tag1"] = "value1",
        ...
        {
            // Generated from example definition: specification/redisenterprise/resource-manager/Microsoft.Cache/preview/2023-10-01-preview/examples/RedisEnterpriseDelete.json
        ...
        {
            // Generated from example definition: specification/redisenterprise/resource-manager/Microsoft.Cache/preview/2023-10-01-preview/examples/RedisEnterpriseGet.json
        ...
        {
            // Generated from example definition: specification/redisenterprise/resource-manager/Microsoft.Cache/preview/2023-10-01-preview/examples/RedisEnterpriseList.json
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CheckNameAvailabilityRedisEnterprise_RedisCacheList()
        {
            // Generated from example definition: specification/redisenterprise/resource-manager/Microsoft.Cache/preview/2023-10-01-preview/examples/RedisEnterpriseCheckNameAvailability.json
            // this example is just showing the usage of "RedisEnterprise_CheckNameAvailability" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            CheckNameAvailabilityContent content = new CheckNameAvailabilityContent("cacheName", "Microsoft.Cache/redisenterprise");
            await subscriptionResource.CheckNameAvailabilityRedisEnterpriseAsync(content);
        ...
        {
            // Generated from example definition: specification/redisenterprise/resource-manager/Microsoft.Cache/preview/2023-10-01-preview/examples/RedisEnterpriseListPrivateLinkResources.json
