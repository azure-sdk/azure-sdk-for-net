...
{
    /// <summary>
    /// A class representing the MigrationService data model.
    /// A Migration Service.
    /// </summary>
    public partial class MigrationServiceData : TrackedResourceData
    {
        ...
        internal MigrationServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string provisioningState, string integrationRuntimeState) : base(id, name, resourceType, systemData, tags, location)
        {
