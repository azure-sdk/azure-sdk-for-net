...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobInputData : StreamAnalyticsSubResource
    {
        ...
        /// </param>
        internal StreamingJobInputData(ResourceIdentifier id, string name, Core.ResourceType? resourceType, StreamingJobInputProperties properties) : base(id, name, resourceType)
        {
