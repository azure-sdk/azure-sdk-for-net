...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public static partial class ArmStreamAnalyticsModelFactory
    {
        ...
        /// <param name="subnetResourceId"> The subnet resource id that the user can link their streaming job to. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.StreamingJobInputProperties" />. </summary>
        /// <param name="inputPropertiesType"> Indicates whether the input is a source of reference data or stream data. Required on PUT (CreateOrReplace) requests. </param>
        /// <param name="serialization">
        /// Describes how data from an input is serialized or how data is serialized when written to an output. Required on PUT (CreateOrReplace) requests.
        /// Please note <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.StreamAnalyticsDataSerialization" /> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.AvroFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.CsvFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.CustomClrFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.JsonFormatSerialization" /> and <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.ParquetFormatSerialization" />.
        /// </param>
        /// <param name="diagnosticsConditions"> Describes conditions applicable to the Input, Output, or the job overall, that warrant customer attention. </param>
        /// <param name="etag"> The current entity tag for the input. This is an opaque string. You can use it to detect whether the resource has changed between requests. You can also use it in the If-Match or If-None-Match headers for write operations for optimistic concurrency. </param>
        /// <param name="compressionType"> Describes how input data is compressed. </param>
        /// <param name="partitionKey"> partitionKey Describes a key in the input data which is used for partitioning the input data. </param>
        /// <param name="watermarkMode"> Settings which determine whether to read watermark events. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.StreamingJobInputProperties" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static StreamingJobInputProperties StreamingJobInputProperties(string inputPropertiesType, StreamAnalyticsDataSerialization serialization, IEnumerable<StreamingJobDiagnosticCondition> diagnosticsConditions, ETag? etag, StreamingCompressionType? compressionType, string partitionKey, StreamingJobInputWatermarkMode? watermarkMode)
        {
            return StreamingJobInputProperties(inputPropertiesType: inputPropertiesType, serialization: serialization, diagnosticsConditions: diagnosticsConditions, etag: etag, compressionType: compressionType, partitionKey: partitionKey, watermarkMode: watermarkMode, messagingCatalogConfiguration: default);
        }

        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.StreamInputProperties" />. </summary>
        /// <param name="serialization">
        /// Describes how data from an input is serialized or how data is serialized when written to an output. Required on PUT (CreateOrReplace) requests.
        /// Please note <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.StreamAnalyticsDataSerialization" /> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.AvroFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.CsvFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.CustomClrFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.JsonFormatSerialization" /> and <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.ParquetFormatSerialization" />.
        ...
        /// <param name="datasource">
        /// Describes an input data source that contains stream data. Required on PUT (CreateOrReplace) requests.
        /// Please note <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.StreamInputDataSource" /> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.GatewayMessageBusStreamInputDataSource" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.IoTHubStreamInputDataSource" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.EventGridStreamInputDataSource" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.EventHubV2StreamInputDataSource" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.EventHubStreamInputDataSource" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.BlobStreamInputDataSource" /> and <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.RawStreamInputDataSource" />.
        /// </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.StreamInputProperties" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static StreamInputProperties StreamInputProperties(StreamAnalyticsDataSerialization serialization, IEnumerable<StreamingJobDiagnosticCondition> diagnosticsConditions, ETag? etag, StreamingCompressionType? compressionType, string partitionKey, StreamingJobInputWatermarkMode? watermarkMode, StreamInputDataSource datasource)
        {
            return StreamInputProperties(serialization: serialization, diagnosticsConditions: diagnosticsConditions, etag: etag, compressionType: compressionType, partitionKey: partitionKey, watermarkMode: watermarkMode, messagingCatalogConfiguration: default, datasource: datasource);
        }

        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.ReferenceInputProperties" />. </summary>
        /// <param name="serialization">
        /// Describes how data from an input is serialized or how data is serialized when written to an output. Required on PUT (CreateOrReplace) requests.
        /// Please note <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.StreamAnalyticsDataSerialization" /> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.AvroFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.CsvFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.CustomClrFormatSerialization" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.JsonFormatSerialization" /> and <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.ParquetFormatSerialization" />.
        ...
        /// <param name="datasource">
        /// Describes an input data source that contains reference data. Required on PUT (CreateOrReplace) requests.
        /// Please note <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.ReferenceInputDataSource" /> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.SqlReferenceInputDataSource" />, <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.BlobReferenceInputDataSource" /> and <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.RawReferenceInputDataSource" />.
        /// </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.StreamAnalytics.Models.ReferenceInputProperties" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static ReferenceInputProperties ReferenceInputProperties(StreamAnalyticsDataSerialization serialization, IEnumerable<StreamingJobDiagnosticCondition> diagnosticsConditions, ETag? etag, StreamingCompressionType? compressionType, string partitionKey, StreamingJobInputWatermarkMode? watermarkMode, ReferenceInputDataSource datasource)
        {
            return ReferenceInputProperties(serialization: serialization, diagnosticsConditions: diagnosticsConditions, etag: etag, compressionType: compressionType, partitionKey: partitionKey, watermarkMode: watermarkMode, messagingCatalogConfiguration: default, datasource: datasource);
        }
    }
}
