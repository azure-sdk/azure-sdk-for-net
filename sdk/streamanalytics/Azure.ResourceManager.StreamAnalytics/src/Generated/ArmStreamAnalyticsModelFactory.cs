...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public static partial class ArmStreamAnalyticsModelFactory
    {
        ...
        {
            return new GetStreamingJobSkuResult(resourceType, skuName != null ? new GetStreamingJobSkuResultSku(skuName) : null, capacity);
        }
        ...
        public static SkuCapacity SkuCapacity(int? minimum = null, int? maximum = null, int? @default = null, SkuCapacityScaleType? scaleType = null, IEnumerable<int> allowedValues = null)
        {
            ...
            return new SkuCapacity(minimum, maximum, @default, scaleType, allowedValues?.ToList());
        }
