...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobTransformationData : StreamAnalyticsSubResource
    {
        ...
        internal StreamingJobTransformationData(ResourceIdentifier id, string name, Core.ResourceType? resourceType, IDictionary<string, BinaryData> serializedAdditionalRawData, int? streamingUnits, IList<int> validStreamingUnits, string query, ETag? etag) : base(id, name, resourceType, serializedAdditionalRawData)
        {
