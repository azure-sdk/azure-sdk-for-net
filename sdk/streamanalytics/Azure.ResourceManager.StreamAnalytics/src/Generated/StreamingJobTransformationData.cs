...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobTransformationData : StreamAnalyticsSubResource
    {
        ...
        internal StreamingJobTransformationData(ResourceIdentifier id, string name, Core.ResourceType? resourceType, int? streamingUnits, IList<int> validStreamingUnits, string query, ETag? etag) : base(id, name, resourceType)
        {
