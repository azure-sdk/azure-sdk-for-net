...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobOutputData : StreamAnalyticsSubResource
    {
        ...
        internal StreamingJobOutputData(ResourceIdentifier id, string name, Core.ResourceType? resourceType, IDictionary<string, BinaryData> serializedAdditionalRawData, StreamingJobOutputDataSource datasource, TimeSpan? timeFrame, int? sizeWindow, StreamAnalyticsDataSerialization serialization, StreamingJobDiagnostics diagnostics, ETag? etag, IReadOnlyList<LastOutputEventTimestamp> lastOutputEventTimestamps, StreamingJobOutputWatermarkProperties watermarkSettings) : base(id, name, resourceType, serializedAdditionalRawData)
        {
