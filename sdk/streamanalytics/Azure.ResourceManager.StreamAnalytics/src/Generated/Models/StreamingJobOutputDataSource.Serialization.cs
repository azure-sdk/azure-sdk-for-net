        ...
        internal static StreamingJobOutputDataSource DeserializeStreamingJobOutputDataSource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("type", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "Microsoft.Kusto/clusters/databases": return AzureDataExplorerOutputDataSource.DeserializeAzureDataExplorerOutputDataSource(element, options);
                    ...
                    case "Reflex": return ReflexOutputDataSource.DeserializeReflexOutputDataSource(element, options);
                }
            }
