...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetStreamingJobSkuResultSku>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GetStreamingJobSkuResultSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetStreamingJobSkuResultSku)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GetStreamingJobSkuResultSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetStreamingJobSkuResultSku)} does not support '{options.Format}' format.");
            }
        }
