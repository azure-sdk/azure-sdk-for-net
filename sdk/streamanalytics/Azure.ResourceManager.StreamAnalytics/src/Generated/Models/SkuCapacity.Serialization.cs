...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkuCapacity>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SkuCapacity)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SkuCapacity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SkuCapacity)} does not support '{options.Format}' format.");
            }
        }
