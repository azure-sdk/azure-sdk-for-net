...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class SkuCapacity
    {
        internal static SkuCapacity DeserializeSkuCapacity(JsonElement element)
        {
            ...
            return new SkuCapacity(Optional.ToNullable(minimum), Optional.ToNullable(maximum), Optional.ToNullable(@default), Optional.ToNullable(scaleType), Optional.ToList(allowedValues));
        }
    }
}
