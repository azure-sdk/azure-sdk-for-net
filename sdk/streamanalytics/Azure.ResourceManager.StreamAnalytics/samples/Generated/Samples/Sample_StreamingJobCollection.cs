                ...
                Functions =
{
                ...
                Externals = new StreamingJobExternal()
                {
                    ...
                    RefreshConfiguration = new StreamingJobRefreshConfiguration()
                    {
                        ...
                        RefreshType = UpdatableUdfRefreshType.Nonblocking,
                    },
                },
                Tags =
{
...
["randomKey"] = "randomValue",
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_CreateAStreamingJobShellAStreamingJobWithNoInputsOutputsTransformationOrFunctionsWithUserAssignedIdentity()
        {
            // Generated from example definition: specification/streamanalytics/resource-manager/Microsoft.StreamAnalytics/preview/2021-10-01-preview/examples/StreamingJob_Create_UserAssignedIdentity.json
            // this example is just showing the usage of "StreamingJobs_CreateOrReplace" operation, for the dependent resources, they will have to be created separately.
