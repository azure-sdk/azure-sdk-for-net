...
AccountKey = "someAccountKey==",
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_CreateAReferenceFileInput()
        {
            // Generated from example definition: specification/streamanalytics/resource-manager/Microsoft.StreamAnalytics/preview/2021-10-01-preview/examples/Input_Create_Reference_File.json
            // this example is just showing the usage of "Inputs_CreateOrReplace" operation, for the dependent resources, they will have to be created separately.
            ...
            StreamingJobInputData input = new StreamingJobInputData()
            {
                Properties = new ReferenceInputProperties()
                {
                    Datasource = new FileReferenceInputDataSource()
                    {
                        Path = "my/path",
                    },
                },
