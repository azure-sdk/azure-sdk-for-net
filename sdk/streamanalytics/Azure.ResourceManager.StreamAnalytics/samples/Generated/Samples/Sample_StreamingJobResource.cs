...
namespace Azure.ResourceManager.StreamAnalytics.Samples
{
    public partial class Sample_StreamingJobResource
    {
        ...
        // Schedule stop a streaming job
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Stop_ScheduleStopAStreamingJob()
        {
            // Generated from example definition: specification/streamanalytics/resource-manager/Microsoft.StreamAnalytics/preview/2021-10-01-preview/examples/StreamingJob_Stop_Scheduled.json
            ...
            // invoke the operation
            StopStreamingJobContent content = new StopStreamingJobContent()
            {
                OutputStopOn = DateTimeOffset.Parse("2012-12-12T12:12:12Z"),
            };
            await streamingJob.StopAsync(WaitUntil.Completed, content: content);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetSkus_GetValidSKUsListForTheSpecifiedStreamingJob()
        {
            // Generated from example definition: specification/streamanalytics/resource-manager/Microsoft.StreamAnalytics/preview/2021-10-01-preview/examples/StreamingJob_GetSkus.json
            // this example is just showing the usage of "Sku_List" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation and iterate over the result
            await foreach (GetStreamingJobSkuResult item in streamingJob.GetSkusAsync())
            {
