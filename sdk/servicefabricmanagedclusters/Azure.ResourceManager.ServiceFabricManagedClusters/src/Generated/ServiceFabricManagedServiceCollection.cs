...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    public partial class ServiceFabricManagedServiceCollection : ArmCollection, IEnumerable<ServiceFabricManagedServiceResource>, IAsyncEnumerable<ServiceFabricManagedServiceResource>
    {
        ...
        /// <param name="serviceFabricManagedServiceData"> The service resource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/> or <paramref name="serviceFabricManagedServiceData"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<ArmOperation<ServiceFabricManagedServiceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string serviceName, ServiceFabricManagedServiceData serviceFabricManagedServiceData, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNull(serviceFabricManagedServiceData, nameof(serviceFabricManagedServiceData));
            ...
            try
            {
                ...
                HttpMessage message = _servicesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, serviceName, ServiceFabricManagedServiceData.ToRequestContent(serviceFabricManagedServiceData), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/> or <paramref name="serviceFabricManagedServiceData"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ServiceFabricManagedServiceResource> CreateOrUpdate(WaitUntil waitUntil, string serviceName, ServiceFabricManagedServiceData serviceFabricManagedServiceData, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNull(serviceFabricManagedServiceData, nameof(serviceFabricManagedServiceData));
