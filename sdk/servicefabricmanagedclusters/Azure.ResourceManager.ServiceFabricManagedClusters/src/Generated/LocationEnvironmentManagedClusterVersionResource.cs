...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    public partial class LocationEnvironmentManagedClusterVersionResource : ArmResource
    {
        ...
        internal LocationEnvironmentManagedClusterVersionResource(ArmClient client, ServiceFabricManagedClusterVersionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<LocationEnvironmentManagedClusterVersionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _locationEnvironmentManagedClusterVersionManagedClusterVersionRestClient.GetByEnvironmentAsync(Id.SubscriptionId, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<LocationEnvironmentManagedClusterVersionResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _locationEnvironmentManagedClusterVersionManagedClusterVersionRestClient.GetByEnvironment(Id.SubscriptionId, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new LocationEnvironmentManagedClusterVersionResource(Client, response.Value), response.GetRawResponse());
            }
