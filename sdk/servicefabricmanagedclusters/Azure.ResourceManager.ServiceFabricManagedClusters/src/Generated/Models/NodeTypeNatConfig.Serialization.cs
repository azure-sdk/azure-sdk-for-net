...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NodeTypeNatConfig>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NodeTypeNatConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NodeTypeNatConfig)} does not support '{format}' format.");
            }
        ...
        internal static NodeTypeNatConfig DeserializeNodeTypeNatConfig(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NodeTypeNatConfig(Optional.ToNullable(backendPort), Optional.ToNullable(frontendPortRangeStart), Optional.ToNullable(frontendPortRangeEnd), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<NodeTypeNatConfig>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NodeTypeNatConfig)} does not support '{options.Format}' format.");
            }
        }
