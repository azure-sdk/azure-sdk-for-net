...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Samples
{
    public partial class Sample_ServiceFabricManagedServiceResource
    {
        ...
        public async Task ReadListPartitionInfo_GetPartitionInfoList()
        {
            // Generated from example definition: specification/servicefabricmanagedclusters/resource-manager/Microsoft.ServiceFabric/preview/2023-09-01-preview/examples/ServicesActionGetPartitionInfoList_example.json
            // this example is just showing the usage of "Services_ReadListPartitionInfo" operation, for the dependent resources, they will have to be created separately.
            ...
            await serviceFabricManagedService.ReadListPartitionInfoAsync(WaitUntil.Completed);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task ReadListReplicaInfo_GetReplicaInfoList()
        {
            // Generated from example definition: specification/servicefabricmanagedclusters/resource-manager/Microsoft.ServiceFabric/preview/2023-09-01-preview/examples/ServicesActionGetReplicaInfoList_example.json
            // this example is just showing the usage of "Services_ReadListReplicaInfo" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string partitionId = "65a03af-3718-4580-bef8-6f5f432ea092";
            await serviceFabricManagedService.ReadListReplicaInfoAsync(WaitUntil.Completed, partitionId);
        ...
        {
            // Generated from example definition: specification/servicefabricmanagedclusters/resource-manager/Microsoft.ServiceFabric/preview/2023-09-01-preview/examples/ServiceGetOperation_example.json
        ...
        {
            // Generated from example definition: specification/servicefabricmanagedclusters/resource-manager/Microsoft.ServiceFabric/preview/2023-09-01-preview/examples/ServicePatchOperation_example.json
...
["a"] = "b",
        ...
        {
            // Generated from example definition: specification/servicefabricmanagedclusters/resource-manager/Microsoft.ServiceFabric/preview/2023-09-01-preview/examples/ServiceDeleteOperation_example.json
