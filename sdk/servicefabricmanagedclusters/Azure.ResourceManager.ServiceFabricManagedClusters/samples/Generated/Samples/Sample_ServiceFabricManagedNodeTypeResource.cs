...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Samples
{
    public partial class Sample_ServiceFabricManagedNodeTypeResource
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetNodeTypeSkus_ListANodeTypeSKUs()
        {
            // Generated from example definition: 2024-11-01-preview/NodeTypeSkusListOperation_example.json
            ...
            await foreach (NodeTypeAvailableSku item in serviceFabricManagedNodeType.GetNodeTypeSkusAsync())
            {
