...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public readonly partial struct ImageType : IEquatable<ImageType>
    {
        ...
        private const string GeneralizedValue = "Generalized";
        private const string SpecializedValue = "Specialized";

        /// <summary> Generalized. </summary>
        public static ImageType Generalized { get; } = new ImageType(GeneralizedValue);
        /// <summary> Specialized. </summary>
        public static ImageType Specialized { get; } = new ImageType(SpecializedValue);
