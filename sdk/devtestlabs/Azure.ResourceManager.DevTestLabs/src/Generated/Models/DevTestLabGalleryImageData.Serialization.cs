...
{
    public partial class DevTestLabGalleryImageData : IUtf8JsonSerializable
    {
        ...
        internal static DevTestLabGalleryImageData DeserializeDevTestLabGalleryImageData(JsonElement element)
        {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("imageReference"u8))
                        {
                            ...
                            foreach (var property1 in property0.Value.EnumerateObject())
                            {
                                ...
                                {
                                    osType = property1.Value.GetString();
                                    continue;
                                }
            ...
            return new DevTestLabGalleryImageData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, author.Value, Optional.ToNullable(createdDate), description.Value, icon.Value, Optional.ToNullable(enabled), planId.Value, Optional.ToNullable(isPlanAuthorized), offer.Value, publisher.Value, sku.Value, osType.Value, version.Value);
        }
    }
}
