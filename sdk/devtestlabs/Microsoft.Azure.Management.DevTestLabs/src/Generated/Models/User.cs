...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class User : Resource
    {
        ...
        /// resource (Guid).</param>
        public User(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), string principalName = default(string), string principalId = default(string), string tenantId = default(string), string objectId = default(string), string appId = default(string), string keyVaultUri = default(string), string keyVaultId = default(string), System.DateTime? createdDate = default(System.DateTime?), string provisioningState = default(string), string uniqueIdentifier = default(string))
