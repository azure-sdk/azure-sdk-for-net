...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class LabVirtualMachine : Resource
    {
        ...
        /// lives</param>
        /// <param name="labVirtualMachineLocation">The geo-location where the
        /// resource lives</param>
        /// <param name="location1">The geo-location where the resource
        /// lives</param>
        /// <param name="location2">The geo-location where the resource
        /// lives</param>
        ...
        /// <param name="osType1">The OS type of the gallery image.</param>
        ...
        /// machine.</param>
        /// <param name="osType2">Gets the OS type of the virtual
        /// machine.</param>
        ...
        /// <param name="labVirtualMachineId">Fully qualified resource ID for
        /// the resource. E.g.
        /// "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"</param>
        /// <param name="labVirtualMachineName">The name of the
        /// resource</param>
        /// <param name="labVirtualMachineType">The type of the resource. E.g.
        /// "Microsoft.Compute/virtualMachines" or
        /// "Microsoft.Storage/storageAccounts"</param>
        /// <param name="labVirtualMachineTags">Resource tags.</param>
        /// <param name="labVirtualMachineSystemData">Azure Resource Manager
        /// metadata containing createdBy and modifiedBy information.</param>
        /// <param name="id1">Fully qualified resource ID for the resource.
        /// E.g.
        /// "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"</param>
        ...
        /// <param name="systemData1">Azure Resource Manager metadata
        /// containing createdBy and modifiedBy information.</param>
        ...
        /// resource (Guid).</param>
        /// <param name="id2">Fully qualified resource ID for the resource.
        /// E.g.
        /// "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"</param>
        ...
        /// "Microsoft.Compute/virtualMachines" or
        /// "Microsoft.Storage/storageAccounts"</param>
        /// <param name="tags2">Resource tags.</param>
        /// <param name="systemData2">Azure Resource Manager metadata
        /// containing createdBy and modifiedBy information.</param>
        ...
        /// document.</param>
        /// <param name="securityProfile">Option to apply more security
        /// protection for VMs.</param>
        ...
        /// a resource (Guid).</param>
        public LabVirtualMachine(string location, string labVirtualMachineLocation, string location1, string location2, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), string notes = default(string), string ownerObjectId = default(string), string ownerUserPrincipalName = default(string), string createdByUserId = default(string), string createdByUser = default(string), System.DateTime? createdDate = default(System.DateTime?), string computeId = default(string), string customImageId = default(string), string galleryImageVersionId = default(string), string sharedImageId = default(string), string sharedImageVersion = default(string), string osType = default(string), string size = default(string), string userName = default(string), string password = default(string), string sshKey = default(string), bool? isAuthenticationWithSshKey = default(bool?), string fqdn = default(string), string labSubnetName = default(string), string labVirtualNetworkId = default(string), bool? disallowPublicIpAddress = default(bool?), IList<ArtifactInstallProperties> artifacts = default(IList<ArtifactInstallProperties>), string deploymentStatus = default(string), int? artifactsApplied = default(int?), int? totalArtifacts = default(int?), string offer = default(string), string publisher = default(string), string sku = default(string), string osType1 = default(string), string version = default(string), string planId = default(string), int? osDiskSizeGb = default(int?), IList<ComputeVmInstanceViewStatus> statuses = default(IList<ComputeVmInstanceViewStatus>), string osType2 = default(string), string vmSize = default(string), string networkInterfaceId = default(string), string osDiskId = default(string), IList<string> dataDiskIds = default(IList<string>), IList<ComputeDataDisk> dataDisks = default(IList<ComputeDataDisk>), string virtualNetworkId = default(string), string subnetId = default(string), string publicIpAddressId = default(string), string publicIpAddress = default(string), string privateIpAddress = default(string), string dnsName = default(string), string rdpAuthority = default(string), string sshAuthority = default(string), IList<InboundNatRule> inboundNatRules = default(IList<InboundNatRule>), string labVirtualMachineId = default(string), string labVirtualMachineName = default(string), string labVirtualMachineType = default(string), IDictionary<string, string> labVirtualMachineTags = default(IDictionary<string, string>), SystemData labVirtualMachineSystemData = default(SystemData), string id1 = default(string), string name1 = default(string), string type1 = default(string), IDictionary<string, string> tags1 = default(IDictionary<string, string>), SystemData systemData1 = default(SystemData), string status = default(string), string taskType = default(string), IList<string> weekdays = default(IList<string>), string time = default(string), string time1 = default(string), int? minute = default(int?), string timeZoneId = default(string), string status1 = default(string), int? timeInMinutes = default(int?), string webhookUrl = default(string), string emailRecipient = default(string), string notificationLocale = default(string), System.DateTime? createdDate1 = default(System.DateTime?), string targetResourceId = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string), string id2 = default(string), string name2 = default(string), string type2 = default(string), IDictionary<string, string> tags2 = default(IDictionary<string, string>), SystemData systemData2 = default(SystemData), string status2 = default(string), string taskType1 = default(string), IList<string> weekdays1 = default(IList<string>), string time2 = default(string), string time3 = default(string), int? minute1 = default(int?), string timeZoneId1 = default(string), string status3 = default(string), int? timeInMinutes1 = default(int?), string webhookUrl1 = default(string), string emailRecipient1 = default(string), string notificationLocale1 = default(string), System.DateTime? createdDate2 = default(System.DateTime?), string targetResourceId1 = default(string), string provisioningState1 = default(string), string uniqueIdentifier1 = default(string), System.DateTime? expirationDate = default(System.DateTime?), bool? allowClaim = default(bool?), string storageType = default(string), string virtualMachineCreationSource = default(string), string environmentId = default(string), IList<DataDiskProperties> dataDiskParameters = default(IList<DataDiskProperties>), IList<ScheduleCreationParameter> scheduleParameters = default(IList<ScheduleCreationParameter>), string lastKnownPowerState = default(string), bool? canApplyArtifacts = default(bool?), SecurityProfile securityProfile = default(SecurityProfile), string provisioningState2 = default(string), string uniqueIdentifier2 = default(string))
            : base(location, id, name, type, tags, systemData)
        {
            ...
            LabVirtualMachineName = labVirtualMachineName;
            LabVirtualMachineType = labVirtualMachineType;
            LabVirtualMachineTags = labVirtualMachineTags;
            LabVirtualMachineLocation = labVirtualMachineLocation;
            LabVirtualMachineSystemData = labVirtualMachineSystemData;
            Id1 = id1;
            Name1 = name1;
            Type1 = type1;
            Tags1 = tags1;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.artifactDeploymentStatus.deploymentStatus")]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.artifactDeploymentStatus.artifactsApplied")]
        ...
        /// applied.
        /// </summary>
        [JsonProperty(PropertyName = "properties.artifactDeploymentStatus.totalArtifacts")]
        public int? TotalArtifacts { get; set; }

        /// <summary>
        /// Gets or sets the offer of the gallery image.
        /// </summary>
        [JsonProperty(PropertyName = "properties.galleryImageReference.offer")]
        public string Offer { get; set; }

        /// <summary>
        /// Gets or sets the publisher of the gallery image.
        /// </summary>
        [JsonProperty(PropertyName = "properties.galleryImageReference.publisher")]
        public string Publisher { get; set; }

        /// <summary>
        /// Gets or sets the SKU of the gallery image.
        /// </summary>
        [JsonProperty(PropertyName = "properties.galleryImageReference.sku")]
        public string Sku { get; set; }

        /// <summary>
        /// Gets or sets the OS type of the gallery image.
        /// </summary>
        [JsonProperty(PropertyName = "properties.galleryImageReference.osType")]
        public string OsType1 { get; set; }

        /// <summary>
        /// Gets or sets the version of the gallery image.
        /// </summary>
        [JsonProperty(PropertyName = "properties.galleryImageReference.version")]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.computeVm.statuses")]
        public IList<ComputeVmInstanceViewStatus> Statuses { get; set; }

        /// <summary>
        /// Gets the OS type of the virtual machine.
        /// </summary>
        [JsonProperty(PropertyName = "properties.computeVm.osType")]
        public string OsType2 { get; set; }

        /// <summary>
        /// Gets the size of the virtual machine.
        /// </summary>
        [JsonProperty(PropertyName = "properties.computeVm.vmSize")]
        public string VmSize { get; set; }

        /// <summary>
        /// Gets the network interface ID of the virtual machine.
        /// </summary>
        [JsonProperty(PropertyName = "properties.computeVm.networkInterfaceId")]
        public string NetworkInterfaceId { get; set; }

        /// <summary>
        /// Gets OS disk blob uri for the virtual machine.
        /// </summary>
        [JsonProperty(PropertyName = "properties.computeVm.osDiskId")]
        public string OsDiskId { get; set; }

        /// <summary>
        /// Gets data disks blob uri for the virtual machine.
        /// </summary>
        [JsonProperty(PropertyName = "properties.computeVm.dataDiskIds")]
        public IList<string> DataDiskIds { get; set; }

        /// <summary>
        /// Gets all data disks attached to the virtual machine.
        /// </summary>
        [JsonProperty(PropertyName = "properties.computeVm.dataDisks")]
        public IList<ComputeDataDisk> DataDisks { get; set; }

        /// <summary>
        /// Gets or sets the resource ID of the virtual network.
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.virtualNetworkId")]
        public string VirtualNetworkId { get; set; }

        /// <summary>
        /// Gets or sets the resource ID of the sub net.
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.subnetId")]
        public string SubnetId { get; set; }

        /// <summary>
        /// Gets or sets the resource ID of the public IP address.
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.publicIpAddressId")]
        public string PublicIpAddressId { get; set; }

        /// <summary>
        /// Gets or sets the public IP address.
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.publicIpAddress")]
        public string PublicIpAddress { get; set; }

        /// <summary>
        /// Gets or sets the private IP address.
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.privateIpAddress")]
        public string PrivateIpAddress { get; set; }

        /// <summary>
        /// Gets or sets the DNS name.
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.dnsName")]
        ...
        /// Desktop Protocol).
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.rdpAuthority")]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.sshAuthority")]
        public string SshAuthority { get; set; }

        /// <summary>
        /// Gets or sets the incoming NAT rules
        /// </summary>
        [JsonProperty(PropertyName = "properties.networkInterface.sharedPublicIpAddressConfiguration.inboundNatRules")]
        ...
        public string LabVirtualMachineId { get; private set; }

        /// <summary>
        /// Gets the name of the resource
        /// </summary>
        [JsonProperty(PropertyName = "properties.applicableSchedule.name")]
        public string LabVirtualMachineName { get; private set; }
        ...
        public string LabVirtualMachineType { get; private set; }

        /// <summary>
        /// Gets or sets resource tags.
        /// </summary>
        [JsonProperty(PropertyName = "properties.applicableSchedule.tags")]
        public IDictionary<string, string> LabVirtualMachineTags { get; set; }

        /// <summary>
        /// Gets or sets the geo-location where the resource lives
        /// </summary>
        [JsonProperty(PropertyName = "properties.applicableSchedule.location")]
        public string LabVirtualMachineLocation { get; set; }
        ...
        public SystemData LabVirtualMachineSystemData { get; private set; }
        ...
        /// <summary>
        /// Gets or sets option to apply more security protection for VMs.
        /// </summary>
        ...
        {
            base.Validate();
            if (LabVirtualMachineLocation == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "LabVirtualMachineLocation");
            }
            if (Location1 == null)
            {
            ...
            if (Location2 == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "Location2");
            }
        }
    }
}
