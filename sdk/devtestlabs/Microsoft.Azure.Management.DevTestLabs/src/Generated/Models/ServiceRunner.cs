...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class ServiceRunner : Resource
    {
        ...
        public ServiceRunner(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), string identityUsageType = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string), IdentityProperties identity = default(IdentityProperties))
