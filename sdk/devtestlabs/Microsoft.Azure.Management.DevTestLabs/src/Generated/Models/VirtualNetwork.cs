...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class VirtualNetwork : Resource
    {
        ...
        /// resource (Guid).</param>
        public VirtualNetwork(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), IList<Subnet> allowedSubnets = default(IList<Subnet>), string description = default(string), string externalProviderResourceId = default(string), IList<ExternalSubnet> externalSubnets = default(IList<ExternalSubnet>), IList<SubnetOverride> subnetOverrides = default(IList<SubnetOverride>), System.DateTime? createdDate = default(System.DateTime?), string provisioningState = default(string), string uniqueIdentifier = default(string))
