...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class OperationStatusResult
    {
        ...
        /// operation.</param>
        /// <param name="resourceId">Fully qualified ID of the resource against
        /// which the original async operation was started.</param>
        ...
        /// error.</param>
        public OperationStatusResult(string status, string id = default(string), string resourceId = default(string), string name = default(string), double? percentComplete = default(double?), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), IList<OperationStatusResult> operations = default(IList<OperationStatusResult>), ErrorDetail error = default(ErrorDetail))
        {
            Id = id;
        ...
        /// <summary>
        /// Gets fully qualified ID of the resource against which the original
