...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class LabVirtualMachineFragment : UpdateResource
    {
        ...
        public LabVirtualMachineFragment(IDictionary<string, string> tags = default(IDictionary<string, string>), IdentityProperties identity = default(IdentityProperties))
            : base(tags, identity)
        {
            CustomInit();
        }
