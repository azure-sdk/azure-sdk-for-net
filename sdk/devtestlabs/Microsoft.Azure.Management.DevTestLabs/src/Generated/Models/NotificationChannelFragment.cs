...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class NotificationChannelFragment : UpdateResource
    {
        ...
        public NotificationChannelFragment(IDictionary<string, string> tags = default(IDictionary<string, string>), IdentityProperties identity = default(IdentityProperties))
            : base(tags, identity)
        {
            CustomInit();
        }
