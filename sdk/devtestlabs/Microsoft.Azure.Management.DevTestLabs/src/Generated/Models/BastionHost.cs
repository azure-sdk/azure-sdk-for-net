...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class BastionHost : Resource
    {
        ...
        /// resource (Guid).</param>
        public BastionHost(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), string externalBastionHostId = default(string), string ipAddressId = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string))
