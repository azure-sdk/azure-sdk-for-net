...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class ServiceFabric : Resource
    {
        ...
        /// <param name="serviceFabricSystemData">Azure Resource Manager
        ...
        /// a resource (Guid).</param>
        public ServiceFabric(string location, string serviceFabricLocation, string location1, string location2, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), string externalServiceFabricId = default(string), string environmentId = default(string), string serviceFabricId = default(string), string serviceFabricName = default(string), string serviceFabricType = default(string), IDictionary<string, string> serviceFabricTags = default(IDictionary<string, string>), SystemData serviceFabricSystemData = default(SystemData), string id1 = default(string), string name1 = default(string), string type1 = default(string), IDictionary<string, string> tags1 = default(IDictionary<string, string>), SystemData systemData1 = default(SystemData), string status = default(string), string taskType = default(string), IList<string> weekdays = default(IList<string>), string time = default(string), string time1 = default(string), int? minute = default(int?), string timeZoneId = default(string), string status1 = default(string), int? timeInMinutes = default(int?), string webhookUrl = default(string), string emailRecipient = default(string), string notificationLocale = default(string), System.DateTime? createdDate = default(System.DateTime?), string targetResourceId = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string), string id2 = default(string), string name2 = default(string), string type2 = default(string), IDictionary<string, string> tags2 = default(IDictionary<string, string>), SystemData systemData2 = default(SystemData), string status2 = default(string), string taskType1 = default(string), IList<string> weekdays1 = default(IList<string>), string time2 = default(string), string time3 = default(string), int? minute1 = default(int?), string timeZoneId1 = default(string), string status3 = default(string), int? timeInMinutes1 = default(int?), string webhookUrl1 = default(string), string emailRecipient1 = default(string), string notificationLocale1 = default(string), System.DateTime? createdDate1 = default(System.DateTime?), string targetResourceId1 = default(string), string provisioningState1 = default(string), string uniqueIdentifier1 = default(string), string provisioningState2 = default(string), string uniqueIdentifier2 = default(string))
            : base(location, id, name, type, tags, systemData)
        {
            ...
            ServiceFabricSystemData = serviceFabricSystemData;
            Id1 = id1;
            Name1 = name1;
            Type1 = type1;
            Tags1 = tags1;
        ...
        public SystemData ServiceFabricSystemData { get; private set; }
