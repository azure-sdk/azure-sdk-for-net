...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public static partial class LabSecretsOperationsExtensions
    {
            ...
            /// The name of the lab secret.
            /// </param>
            public static LabSecretsDeleteHeaders Delete(this ILabSecretsOperations operations, string resourceGroupName, string labName, string name)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<LabSecretsDeleteHeaders> DeleteAsync(this ILabSecretsOperations operations, string resourceGroupName, string labName, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The name of the lab secret.
            /// </param>
            public static LabSecretsDeleteHeaders BeginDelete(this ILabSecretsOperations operations, string resourceGroupName, string labName, string name)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<LabSecretsDeleteHeaders> BeginDeleteAsync(this ILabSecretsOperations operations, string resourceGroupName, string labName, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Allows modifying tags of lab secrets. All other properties will be ignored.
            /// </param>
            public static LabSecret BeginUpdate(this ILabSecretsOperations operations, string resourceGroupName, string labName, string name, SecretFragment secret)
            {
                return operations.BeginUpdateAsync(resourceGroupName, labName, name, secret).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<LabSecret> BeginUpdateAsync(this ILabSecretsOperations operations, string resourceGroupName, string labName, string name, SecretFragment secret, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginUpdateWithHttpMessagesAsync(resourceGroupName, labName, name, secret, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
