...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public static partial class BastionHostsOperationsExtensions
    {
            ...
            /// The name of the bastionhost.
            /// </param>
            public static BastionHostsDeleteHeaders Delete(this IBastionHostsOperations operations, string resourceGroupName, string labName, string virtualNetworkName, string name)
            {
                return operations.DeleteAsync(resourceGroupName, labName, virtualNetworkName, name).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BastionHostsDeleteHeaders> DeleteAsync(this IBastionHostsOperations operations, string resourceGroupName, string labName, string virtualNetworkName, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DeleteWithHttpMessagesAsync(resourceGroupName, labName, virtualNetworkName, name, null, cancellationToken).ConfigureAwait(false))
                {
            ...
            /// The name of the bastionhost.
            /// </param>
            public static BastionHostsDeleteHeaders BeginDelete(this IBastionHostsOperations operations, string resourceGroupName, string labName, string virtualNetworkName, string name)
            {
                return operations.BeginDeleteAsync(resourceGroupName, labName, virtualNetworkName, name).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BastionHostsDeleteHeaders> BeginDeleteAsync(this IBastionHostsOperations operations, string resourceGroupName, string labName, string virtualNetworkName, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, labName, virtualNetworkName, name, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Headers;
                }
            }
