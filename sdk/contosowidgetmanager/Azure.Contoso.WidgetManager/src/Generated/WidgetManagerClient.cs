...
namespace Azure.Contoso.WidgetManager
{
    ...
    public partial class WidgetManagerClient
    {
        ...
        public virtual async Task<Response<Widget>> GetWidgetAsync(string widgetName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<Widget> GetWidget(string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Operation<Widget>> DeleteWidgetAsync(WaitUntil waitUntil, string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Operation<BinaryData> response = await DeleteWidgetAsync(waitUntil, widgetName, context).ConfigureAwait(false);
            return ProtocolOperationHelpers.Convert(response, Widget.FromResponse, ClientDiagnostics, "WidgetManagerClient.DeleteWidget");
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Operation<Widget> DeleteWidget(WaitUntil waitUntil, string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
