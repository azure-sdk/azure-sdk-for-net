...
namespace Azure.Template.Contoso
{
    ...
    public static partial class TemplateContosoModelFactory
    {
        ...
        public static WidgetSuite WidgetSuite(string name = null, FakedSharedModel sharedModel = null)
        {
            return new WidgetSuite(name, sharedModel, serializedAdditionalRawData: null);
        }
