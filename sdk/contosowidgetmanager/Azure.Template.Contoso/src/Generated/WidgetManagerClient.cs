...
namespace Azure.Template.Contoso
{
    ...
    public partial class WidgetManagerClient
    {
        ...
        public virtual Widgets GetWidgetsClient(string apiVersion = "2022-11-01-preview")
        {
            Argument.AssertNotNull(apiVersion, nameof(apiVersion));

            return new Widgets(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
    }
}
