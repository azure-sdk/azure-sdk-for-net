...
namespace Azure.Template.Contoso
{
    ...
    public partial class WidgetManagerClient
    {
        ...
        public WidgetManagerClient(TokenCredential credential) : this(credential, new WidgetManagerClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public WidgetManagerClient(TokenCredential credential, WidgetManagerClientOptions options)
        {
        ...
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='GetWidgetAsync(string,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='GetWidget(string,CancellationToken)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='GetWidgetsAsync(CancellationToken)']/*" />
        public virtual AsyncPageable<WidgetSuite> GetWidgetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, WidgetSuite.DeserializeWidgetSuite, ClientDiagnostics, _pipeline, "WidgetManagerClient.GetWidgets", "value", "nextLink", context);
        }

        /// <summary> List Widget resources. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='GetWidgets(CancellationToken)']/*" />
        public virtual Pageable<WidgetSuite> GetWidgets(CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, WidgetSuite.DeserializeWidgetSuite, ClientDiagnostics, _pipeline, "WidgetManagerClient.GetWidgets", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='GetWidgetsAsync(RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetWidgetsAsync(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "WidgetManagerClient.GetWidgets", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='GetWidgets(RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetWidgets(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "WidgetManagerClient.GetWidgets", "value", "nextLink", context);
        }
        ...
        public virtual async Task<Operation<BinaryData>> CreateOrUpdateWidgetAsync(WaitUntil waitUntil, string widgetName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "WidgetManagerClient.CreateOrUpdateWidget", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation<BinaryData> CreateOrUpdateWidget(WaitUntil waitUntil, string widgetName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCreateOrUpdateWidgetRequest(widgetName, content, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "WidgetManagerClient.CreateOrUpdateWidget", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeleteWidgetAsync(WaitUntil waitUntil, string widgetName, RequestContext context = null)
        {
            ...
            try
            {
                ...
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "WidgetManagerClient.DeleteWidget", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation DeleteWidget(WaitUntil waitUntil, string widgetName, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateDeleteWidgetRequest(widgetName, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "WidgetManagerClient.DeleteWidget", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
