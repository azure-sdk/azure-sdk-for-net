...
namespace Azure.Template.Contoso
{
    ...
    public partial class WidgetManagerClient
    {
        ...
        public virtual async Task<Response<Widget>> GetWidgetValueAsync(string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));

            using var scope = ClientDiagnostics.CreateScope("WidgetManagerClient.GetWidgetValue");
            scope.Start();
            try
            {
                RequestContext context = FromCancellationToken(cancellationToken);
                Response response = await GetWidgetAsync(widgetName, context).ConfigureAwait(false);
                return Response.FromValue(Widget.FromResponse(response), response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<Widget> GetWidgetValue(string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AsyncPageable<Widget> GetWidgetValuesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, Widget.DeserializeWidget, ClientDiagnostics, _pipeline, "WidgetManagerClient.GetWidgets", "value", "nextLink", context);
        }

        /// <summary> List Widget resources. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Pageable<Widget> GetWidgetValues(CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, Widget.DeserializeWidget, ClientDiagnostics, _pipeline, "WidgetManagerClient.GetWidgets", "value", "nextLink", context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetWidgetsAsync(RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
        ...
        public virtual Pageable<BinaryData> GetWidgets(RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Operation<Widget>> DeleteWidgetValueAsync(WaitUntil waitUntil, string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));

            using var scope = ClientDiagnostics.CreateScope("WidgetManagerClient.DeleteWidgetValue");
            scope.Start();
            try
            {
                RequestContext context = FromCancellationToken(cancellationToken);
                Operation<BinaryData> response = await DeleteWidgetAsync(waitUntil, widgetName, context).ConfigureAwait(false);
                return ProtocolOperationHelpers.Convert(response, Widget.FromResponse, ClientDiagnostics, "WidgetManagerClient.DeleteWidgetValue");
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Operation<Widget> DeleteWidgetValue(WaitUntil waitUntil, string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
