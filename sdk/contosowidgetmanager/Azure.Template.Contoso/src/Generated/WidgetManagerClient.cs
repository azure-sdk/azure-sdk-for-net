...
namespace Azure.Template.Contoso
{
    ...
    public partial class WidgetManagerClient
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='DeleteWidgetAsync(WaitUntil,string,CancellationToken)']/*" />
        public virtual async Task<Operation<WidgetSuite>> DeleteWidgetAsync(WaitUntil waitUntil, string widgetName, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(response, WidgetSuite.FromResponse, ClientDiagnostics, "WidgetManagerClient.DeleteWidget");
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='DeleteWidget(WaitUntil,string,CancellationToken)']/*" />
