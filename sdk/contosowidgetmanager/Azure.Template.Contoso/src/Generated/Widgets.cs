...
namespace Azure.Template.Contoso
{
    ...
    public partial class Widgets
    {
        ...
        public virtual async Task<Operation> DeleteWidgetAsync(WaitUntil waitUntil, string widgetName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
            ...
            try
            {
                ...
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "Widgets.DeleteWidget", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation DeleteWidget(WaitUntil waitUntil, string widgetName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
            ...
            {
                using HttpMessage message = CreateDeleteWidgetRequest(widgetName, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "Widgets.DeleteWidget", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
