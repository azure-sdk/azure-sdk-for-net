...
namespace Azure.Template.Contoso
{
    ...
    /// <summary> The Widgets sub-client. </summary>
    public partial class Widgets
    {
        ...
        /// <summary> Initializes a new instance of Widgets for mocking. </summary>
        protected Widgets()
        {
        }

        /// <summary> Initializes a new instance of Widgets. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="tokenCredential"> The token credential to copy. </param>
        /// <param name="endpoint"> Service host. </param>
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        internal Widgets(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetSecureAsync(string,CancellationToken)']/*" />
        public virtual async Task<Response<WidgetSuite>> GetWidgetSecureAsync(string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetWidgetSecureAsync(widgetName, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetSecure(string,CancellationToken)']/*" />
        public virtual Response<WidgetSuite> GetWidgetSecure(string widgetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = GetWidgetSecure(widgetName, context);
            return Response.FromValue(WidgetSuite.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetWidgetSecureAsync(string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetSecureAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> GetWidgetSecureAsync(string widgetName, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));

            using var scope = ClientDiagnostics.CreateScope("Widgets.GetWidgetSecure");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetWidgetSecureRequest(widgetName, context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetWidgetSecure(string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetSecure(string,RequestContext)']/*" />
        public virtual Response GetWidgetSecure(string widgetName, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
        ...
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetOperationStatusAsync(string,string,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> or <paramref name="operationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> or <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetOperationStatus(string,string,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetOperationStatusAsync(string,string,RequestContext)']/*" />
        public virtual async Task<Response> GetWidgetOperationStatusAsync(string widgetName, string operationId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Widgets.GetWidgetOperationStatus");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetOperationStatus(string,string,RequestContext)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetsAsync(CancellationToken)']/*" />
        public virtual AsyncPageable<WidgetSuite> GetWidgetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => WidgetSuite.DeserializeWidgetSuite(e), ClientDiagnostics, _pipeline, "Widgets.GetWidgets", "value", "nextLink", context);
        }

        /// <summary> List Widget resources. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgets(CancellationToken)']/*" />
        public virtual Pageable<WidgetSuite> GetWidgets(CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => WidgetSuite.DeserializeWidgetSuite(e), ClientDiagnostics, _pipeline, "Widgets.GetWidgets", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetsAsync(RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetWidgetsAsync(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Widgets.GetWidgets", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgets(RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetWidgets(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Widgets.GetWidgets", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='CreateOrUpdateWidgetAsync(WaitUntil,string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> CreateOrUpdateWidgetAsync(WaitUntil waitUntil, string widgetName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Widgets.CreateOrUpdateWidget");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCreateOrUpdateWidgetRequest(widgetName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "Widgets.CreateOrUpdateWidget", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='CreateOrUpdateWidget(WaitUntil,string,RequestContent,RequestContext)']/*" />
        public virtual Operation<BinaryData> CreateOrUpdateWidget(WaitUntil waitUntil, string widgetName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCreateOrUpdateWidgetRequest(widgetName, content, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "Widgets.CreateOrUpdateWidget", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='DeleteWidgetAsync(WaitUntil,string,CancellationToken)']/*" />
        public virtual async Task<Operation<WidgetSuite>> DeleteWidgetAsync(WaitUntil waitUntil, string widgetName, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(response, FetchWidgetSuiteFromResourceOperationStatusWidgetSuiteWidgetSuiteError, ClientDiagnostics, "Widgets.DeleteWidget");
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='DeleteWidget(WaitUntil,string,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='DeleteWidgetAsync(WaitUntil,string,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> DeleteWidgetAsync(WaitUntil waitUntil, string widgetName, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Widgets.DeleteWidget");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteWidgetRequest(widgetName, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "Widgets.DeleteWidget", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='DeleteWidget(WaitUntil,string,RequestContext)']/*" />
        public virtual Operation<BinaryData> DeleteWidget(WaitUntil waitUntil, string widgetName, RequestContext context)
        {
            ...
            {
                using HttpMessage message = CreateDeleteWidgetRequest(widgetName, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "Widgets.DeleteWidget", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        internal HttpMessage CreateGetWidgetSecureRequest(string widgetName, RequestContext context)
        {
