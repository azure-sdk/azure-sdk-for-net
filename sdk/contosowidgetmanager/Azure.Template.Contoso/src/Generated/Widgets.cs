...
namespace Azure.Template.Contoso
{
    ...
    public partial class Widgets
    {
        ...
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetAsync(string,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="widgetName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="widgetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidget(string,CancellationToken)']/*" />
        ...
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidgetAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> GetWidgetAsync(string widgetName, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));

            using var scope = ClientDiagnostics.CreateScope("Widgets.GetWidget");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Widgets.xml" path="doc/members/member[@name='GetWidget(string,RequestContext)']/*" />
