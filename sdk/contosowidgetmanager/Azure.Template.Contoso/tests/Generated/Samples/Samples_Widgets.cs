...
namespace Azure.Template.Contoso.Samples
{
    public partial class Samples_Widgets
    {
        ...
        public void Example_WidgetSuite_GetWidgetSecure_GetWidgetByWidgetName()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            Widgets client = new WidgetManagerClient(endpoint, credential).GetWidgetsClient(apiVersion: "2022-11-01-preview");

            Response response = client.GetWidgetSecure("searchbox", null);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_WidgetSuite_GetWidgetSecure_GetWidgetByWidgetName_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            Widgets client = new WidgetManagerClient(endpoint, credential).GetWidgetsClient(apiVersion: "2022-11-01-preview");

            Response response = await client.GetWidgetSecureAsync("searchbox", null);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_WidgetSuite_GetWidgetSecure_GetWidgetByWidgetName_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            Widgets client = new WidgetManagerClient(endpoint, credential).GetWidgetsClient(apiVersion: "2022-11-01-preview");

            Response<WidgetSuite> response = client.GetWidgetSecure("searchbox");
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_WidgetSuite_GetWidgetSecure_GetWidgetByWidgetName_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            Widgets client = new WidgetManagerClient(endpoint, credential).GetWidgetsClient(apiVersion: "2022-11-01-preview");

            Response<WidgetSuite> response = await client.GetWidgetSecureAsync("searchbox");
        }
