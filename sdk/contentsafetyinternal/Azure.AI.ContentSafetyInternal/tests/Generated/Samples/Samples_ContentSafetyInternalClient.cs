...
namespace Azure.AI.ContentSafetyInternal.Samples
{
    public class Samples_ContentSafetyInternalClient
    {
        ...
        public void Example_GetWritelistFeatures()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_GetWritelistFeatures_AllParameters()
        {
            var credential = new AzureKeyCredential("<key>");
            var endpoint = new Uri("<https://my-service.azure.com>");
            var client = new ContentSafetyInternalClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_GetWritelistFeatures_Async()
        {
            var credential = new AzureKeyCredential("<key>");
            var endpoint = new Uri("<https://my-service.azure.com>");
            var client = new ContentSafetyInternalClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_GetWritelistFeatures_AllParameters_Async()
        {
            var credential = new AzureKeyCredential("<key>");
            var endpoint = new Uri("<https://my-service.azure.com>");
            var client = new ContentSafetyInternalClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_GetWritelistFeatures_Convenience_Async()
        {
            var credential = new AzureKeyCredential("<key>");
            var endpoint = new Uri("<https://my-service.azure.com>");
            var client = new ContentSafetyInternalClient(endpoint, credential);
