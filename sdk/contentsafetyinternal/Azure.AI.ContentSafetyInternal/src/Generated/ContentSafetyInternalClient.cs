...
namespace Azure.AI.ContentSafetyInternal
{
    ...
    public partial class ContentSafetyInternalClient
    {
        ...
        /// <include file="Docs/ContentSafetyInternalClient.xml" path="doc/members/member[@name='GetWritelistFeaturesAsync(CancellationToken)']/*" />
        public virtual async Task<Response<FeatureList>> GetWritelistFeaturesAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetWritelistFeaturesAsync(context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> Get whitelist features. </remarks>
        /// <include file="Docs/ContentSafetyInternalClient.xml" path="doc/members/member[@name='GetWritelistFeatures(CancellationToken)']/*" />
        public virtual Response<FeatureList> GetWritelistFeatures(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = GetWritelistFeatures(context);
            return Response.FromValue(FeatureList.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetWritelistFeaturesAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/ContentSafetyInternalClient.xml" path="doc/members/member[@name='GetWritelistFeaturesAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetWritelistFeaturesAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("ContentSafetyInternalClient.GetWritelistFeatures");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetWritelistFeaturesRequest(context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetWritelistFeatures(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ContentSafetyInternalClient.xml" path="doc/members/member[@name='GetWritelistFeatures(RequestContext)']/*" />
        public virtual Response GetWritelistFeatures(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("ContentSafetyInternalClient.GetWritelistFeatures");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetWritelistFeaturesRequest(RequestContext context)
        {
