...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class AccountImmutabilityPolicy
    {
        ...
        /// <summary> Initializes a new instance of AccountImmutabilityPolicy. </summary>
        /// <param name="immutabilityPeriodSinceCreationInDays"> The immutability period for the blobs in the container since the policy creation in days. 0 is returned when state is disabled. </param>
        ...
        /// <summary> The immutability period for the blobs in the container since the policy creation in days. 0 is returned when state is disabled. </summary>
