...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        internal static StorageAccountIPv6Endpoints DeserializeStorageAccountIPv6Endpoints(JsonElement element)
        {
            ...
            return new StorageAccountIPv6Endpoints(blob.Value, queue.Value, table.Value, file.Value, web.Value, dfs.Value, microsoftEndpoints.Value, internetEndpoints.Value);
        }
    }
}
