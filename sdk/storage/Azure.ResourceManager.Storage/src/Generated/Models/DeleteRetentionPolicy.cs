...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class DeleteRetentionPolicy
    {
        ...
        /// <param name="days"> Indicates the number of days that the deleted item should be retained. The minimum specified value can be 1 and the maximum value can be 365. 0 will be returned when policy is disabled. </param>
        ...
        /// <summary> Indicates the number of days that the deleted item should be retained. The minimum specified value can be 1 and the maximum value can be 365. 0 will be returned when policy is disabled. </summary>
