...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StorageAccountIPv6Endpoints
    {
        ...
        internal StorageAccountIPv6Endpoints(string blob, string queue, string table, string file, string web, string dfs, StorageAccountMicrosoftEndpoints microsoftEndpoints, StorageAccountInternetEndpoints internetEndpoints)
        {
            Blob = blob;
            Queue = queue;
            Table = table;
