...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        internal static StorageAccountIPv4Endpoints DeserializeStorageAccountIPv4Endpoints(JsonElement element)
        {
            ...
            return new StorageAccountIPv4Endpoints(blob.Value, queue.Value, table.Value, file.Value, web.Value, dfs.Value, microsoftEndpoints.Value, internetEndpoints.Value);
        }
    }
}
