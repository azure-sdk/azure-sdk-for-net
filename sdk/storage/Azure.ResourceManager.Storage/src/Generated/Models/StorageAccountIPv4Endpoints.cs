...
{
    /// <summary> The URIs that are used to perform a retrieval of a public blob, queue, table, web or dfs object via an IPv4 endpoint. </summary>
    public partial class StorageAccountIPv4Endpoints
    {
        ...
        internal StorageAccountIPv4Endpoints(string blob, string queue, string table, string file, string web, string dfs, StorageAccountMicrosoftEndpoints microsoftEndpoints, StorageAccountInternetEndpoints internetEndpoints)
        {
            Blob = blob;
            Queue = queue;
            Table = table;
