...
namespace Azure.Developer.Signing
{
    ...
    public partial class SigningClient
    {
        ...
        /// <include file="Docs/SigningClient.xml" path="doc/members/member[@name='GetSigningStatusAsync(string,string,string,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentException"> <paramref name="accountName"/>, <paramref name="certificateProfile"/> or <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <remarks> This status operation requires that a Sign request has been submitted and the operationId is known. </remarks>
        /// <include file="Docs/SigningClient.xml" path="doc/members/member[@name='GetSigningStatus(string,string,string,CancellationToken)']/*" />
        ...
        /// <include file="Docs/SigningClient.xml" path="doc/members/member[@name='GetSigningStatusAsync(string,string,string,RequestContext)']/*" />
        public virtual async Task<Response> GetSigningStatusAsync(string accountName, string certificateProfile, string operationId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SigningClient.GetSigningStatus");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SigningClient.xml" path="doc/members/member[@name='GetSigningStatus(string,string,string,RequestContext)']/*" />
        ...
        /// <include file="Docs/SigningClient.xml" path="doc/members/member[@name='SignAsync(WaitUntil,string,string,SigningPayloadOptions,string,string,CancellationToken)']/*" />
        public virtual async Task<Operation<SignResult>> SignAsync(WaitUntil waitUntil, string accountName, string certificateProfile, SigningPayloadOptions signingPayloadOptions, string clientVersion = null, string xCorrelationId = null, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(response, FetchSignResultFromOperationStatusSignResultError, ClientDiagnostics, "SigningClient.Sign");
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="accountName"/> or <paramref name="certificateProfile"/> is an empty string, and was expected to be non-empty. </exception>
        /// <remarks> Submit a sign operation under the created account and profile name provided. </remarks>
        /// <include file="Docs/SigningClient.xml" path="doc/members/member[@name='Sign(WaitUntil,string,string,SigningPayloadOptions,string,string,CancellationToken)']/*" />
        ...
        /// <include file="Docs/SigningClient.xml" path="doc/members/member[@name='SignAsync(WaitUntil,string,string,RequestContent,string,string,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> SignAsync(WaitUntil waitUntil, string accountName, string certificateProfile, RequestContent content, string clientVersion = null, string xCorrelationId = null, RequestContext context = null)
        {
            ...
            try
            {
                ...
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "SigningClient.Sign", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/SigningClient.xml" path="doc/members/member[@name='Sign(WaitUntil,string,string,RequestContent,string,string,RequestContext)']/*" />
        public virtual Operation<BinaryData> Sign(WaitUntil waitUntil, string accountName, string certificateProfile, RequestContent content, string clientVersion = null, string xCorrelationId = null, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateSignRequest(accountName, certificateProfile, content, clientVersion, xCorrelationId, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "SigningClient.Sign", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
