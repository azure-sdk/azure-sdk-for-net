...
namespace Azure.Developer.Signing
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SigningPayloadOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SigningPayloadOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SigningPayloadOptions)} does not support '{format}' format.");
            }
        ...
        internal static SigningPayloadOptions DeserializeSigningPayloadOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            SigningPayloadOptionsSignatureAlgorithm signatureAlgorithm = default;
            BinaryData digest = default;
            Optional<IList<BinaryData>> fileHashList = default;
            Optional<IList<BinaryData>> authenticodeHashList = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    signatureAlgorithm = new SigningPayloadOptionsSignatureAlgorithm(property.Value.GetString());
                    continue;
                }
            ...
            return new SigningPayloadOptions(signatureAlgorithm, digest, Optional.ToList(fileHashList), Optional.ToList(authenticodeHashList), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SigningPayloadOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SigningPayloadOptions)} does not support '{options.Format}' format.");
            }
        }
