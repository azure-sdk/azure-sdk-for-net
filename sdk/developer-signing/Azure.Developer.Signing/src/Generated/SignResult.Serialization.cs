...
namespace Azure.Developer.Signing
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SignResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SignResult)} does not support '{format}' format.");
            }
        ...
        internal static SignResult DeserializeSignResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SignResult(signature.Value, signingCertificate.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SignResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SignResult)} does not support '{options.Format}' format.");
            }
        }
