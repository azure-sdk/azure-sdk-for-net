...
namespace Azure.Developer.Signing.Samples
{
    public partial class Samples_CertificateProfile
    {
        ...
        public void Example_CertificateProfileOperations_Sign_ShortVersion_Convenience()
        {
            ...
            SigningPayloadOptions signingPayloadOptions = new SigningPayloadOptions(new SigningPayloadOptionsSignatureAlgorithm("<signatureAlgorithm>"), BinaryData.FromObjectAsJson(new object()));
