...
{
    public partial class ImpactCategoryData : IUtf8JsonSerializable, IJsonModel<ImpactCategoryData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImpactCategoryData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImpactCategoryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ImpactCategoryData IJsonModel<ImpactCategoryData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImpactCategoryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ImpactCategoryData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImpactCategoryData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ImpactCategoryData IPersistableModel<ImpactCategoryData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImpactCategoryData>)this).GetFormatFromOptions(options) : options.Format;
