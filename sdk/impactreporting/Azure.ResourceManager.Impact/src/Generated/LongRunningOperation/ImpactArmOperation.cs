...
#pragma warning disable SA1649 // File name should match first type name
    internal class ImpactArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ImpactArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ImpactArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ImpactArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
