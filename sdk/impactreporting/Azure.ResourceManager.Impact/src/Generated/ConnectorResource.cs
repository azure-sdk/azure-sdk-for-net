...
namespace Azure.ResourceManager.Impact
{
    ...
    public partial class ConnectorResource : ArmResource
    {
        ...
        public virtual async Task<Response<ConnectorResource>> UpdateAsync(ConnectorData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<ConnectorResource> Update(ConnectorData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
