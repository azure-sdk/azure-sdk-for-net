...
namespace Microsoft.Azure.Management.Nginx
{
    ...
    public static partial class ConfigurationsOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NginxConfiguration> GetAsync(this IConfigurationsOperations operations, string resourceGroupName, string deploymentName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static NginxConfiguration CreateOrUpdate(this IConfigurationsOperations operations, string resourceGroupName, string deploymentName, NginxConfiguration body = default(NginxConfiguration))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NginxConfiguration> CreateOrUpdateAsync(this IConfigurationsOperations operations, string resourceGroupName, string deploymentName, NginxConfiguration body = default(NginxConfiguration), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IConfigurationsOperations operations, string resourceGroupName, string deploymentName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The NGINX configuration
            /// </param>
            public static NginxConfiguration BeginCreateOrUpdate(this IConfigurationsOperations operations, string resourceGroupName, string deploymentName, NginxConfiguration body = default(NginxConfiguration))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NginxConfiguration> BeginCreateOrUpdateAsync(this IConfigurationsOperations operations, string resourceGroupName, string deploymentName, NginxConfiguration body = default(NginxConfiguration), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginDeleteAsync(this IConfigurationsOperations operations, string resourceGroupName, string deploymentName, CancellationToken cancellationToken = default(CancellationToken))
            {
