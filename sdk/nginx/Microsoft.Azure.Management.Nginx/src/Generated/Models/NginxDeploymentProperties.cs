...
namespace Microsoft.Azure.Management.Nginx.Models
{
    ...
    public partial class NginxDeploymentProperties
    {
        ...
        public NginxDeploymentProperties(string provisioningState = default(string), string nginxVersion = default(string), string managedResourceGroup = default(string), NginxNetworkProfile networkProfile = default(NginxNetworkProfile), string ipAddress = default(string), bool? enableDiagnosticsSupport = default(bool?), NginxLogging logging = default(NginxLogging), NginxDeploymentScalingProperties scalingProperties = default(NginxDeploymentScalingProperties), NginxDeploymentUserProfile userProfile = default(NginxDeploymentUserProfile))
        {
