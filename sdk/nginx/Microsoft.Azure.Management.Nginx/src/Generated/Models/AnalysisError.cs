...
namespace Microsoft.Azure.Management.Nginx.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AnalysisError class.
        /// </summary>
        ...
        public AnalysisError(string directive, string description, string file, double line, string message, string rule, string id = default(string))
        {
            Id = id;
            Directive = directive;
