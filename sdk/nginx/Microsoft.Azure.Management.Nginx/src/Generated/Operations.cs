...
namespace Microsoft.Azure.Management.Nginx
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<NginxManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(NginxManagementClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// List all operations provided by Nginx.NginxPlus for the 2024-11-01-preview
        /// api version.
        /// </summary>
        ...
        public async Task<AzureOperationResponse<IPage<OperationResult>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Nginx.NginxPlus/operations").ToString();
