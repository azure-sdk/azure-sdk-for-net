...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusDisasterRecoveryData : ResourceData
    {
        ...
        internal ServiceBusDisasterRecoveryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ServiceBusDisasterRecoveryProvisioningState? provisioningState, long? pendingReplicationOperationsCount, string partnerNamespace, Type? typePropertiesType, string alternateName, ServiceBusDisasterRecoveryRole? role, AzureLocation? location) : base(id, name, resourceType, systemData)
        {
