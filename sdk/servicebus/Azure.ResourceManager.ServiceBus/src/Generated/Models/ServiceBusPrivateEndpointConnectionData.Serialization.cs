...
namespace Azure.ResourceManager.ServiceBus
{
    public partial class ServiceBusPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static ServiceBusPrivateEndpointConnectionData DeserializeServiceBusPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new ServiceBusPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToList(groupIds), Optional.ToNullable(provisioningState), Optional.ToNullable(location));
        }
    }
}
