...
namespace Azure.Analytics.Experimentation
{
    public partial class Metric : IUtf8JsonSerializable, IJsonModel<Metric>
    {
        ...
        internal static Metric DeserializeMetric(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            MetricDefinition definition = default;
            ETag eTag = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    definition = MetricDefinition.DeserializeMetricDefinition(property.Value, options);
                    continue;
                }
        ...
        internal static Metric FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeMetric(document.RootElement);
        }
