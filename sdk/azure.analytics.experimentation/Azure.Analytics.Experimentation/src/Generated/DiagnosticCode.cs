...
namespace Azure.Analytics.Experimentation
{
    ...
    public readonly partial struct DiagnosticCode : IEquatable<DiagnosticCode>
    {
        ...
        private const string InvalidMetricDefinitionValue = "InvalidMetricDefinition";
        ...
        /// </summary>
        public static DiagnosticCode InvalidMetricDefinition { get; } = new DiagnosticCode(InvalidMetricDefinitionValue);
