...
namespace Azure.ResourceManager.ExtendedLocations
{
    internal class ResourceSyncRuleOperationSource : IOperationSource<ResourceSyncRuleResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<ResourceSyncRuleData>(response.Content);
        ...
        {
            var data = ModelReaderWriter.Read<ResourceSyncRuleData>(response.Content);
            return await Task.FromResult(new ResourceSyncRuleResource(_client, data)).ConfigureAwait(false);
        }
    }
}
