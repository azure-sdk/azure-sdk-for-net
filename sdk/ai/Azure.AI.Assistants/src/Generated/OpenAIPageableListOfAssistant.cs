...
namespace Azure.AI.Assistants
{
    ...
    internal partial class OpenAIPageableListOfAssistant
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfAssistant"/>. </summary>
        ...
        internal OpenAIPageableListOfAssistant(IEnumerable<Assistant> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal OpenAIPageableListOfAssistant(OpenAIPageableListOfAssistantObject @object, IReadOnlyList<Assistant> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfAssistant"/> for deserialization. </summary>
        internal OpenAIPageableListOfAssistant()
        {
        }
