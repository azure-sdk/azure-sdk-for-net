...
namespace Azure.AI.Connections
{
    ...
    /// <summary> The AIConnections service client. </summary>
    public partial class AIConnectionsClient
    {
        ...
        /// <summary> Initializes a new instance of AIConnectionsClient for mocking. </summary>
        protected AIConnectionsClient()
        {
        }

        /// <summary> Initializes a new instance of AIConnectionsClient. </summary>
