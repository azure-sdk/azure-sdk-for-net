...
ConnectionName = "<connectionName>",
    ...
    public void Example_EvaluationResults_FetchAssetCredentials_ShortVersion_Convenience()
    {
        ...
        Azure.Response < AI.Projects.1DP.AssetCredentialResponse > response = client.FetchAssetCredentials("<name>", "<version>", body);
    }
    ...
    public async Task Example_EvaluationResults_FetchAssetCredentials_ShortVersion_Convenience_Async()
    {
        ...
        AI.Projects.1DP.AssetCredentialRequest body = new Projects.1DP.AssetCredentialRequest("<BlobUri>");
        Azure.Response < AI.Projects.1DP.AssetCredentialResponse > response = await client.FetchAssetCredentialsAsync("<name>", "<version>", body);
    }
