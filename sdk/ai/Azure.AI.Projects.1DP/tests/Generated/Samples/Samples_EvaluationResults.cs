...
public partial class Samples_EvaluationResults
{
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_Create_ShortVersion()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_Create_ShortVersion_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_Create_ShortVersion_Convenience()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_Create_ShortVersion_Convenience_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_Create_AllParameters()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_Create_AllParameters_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_Create_AllParameters_Convenience()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
...
Tags =
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_Create_AllParameters_Convenience_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
...
Tags =
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_CreateVersion_ShortVersion()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_CreateVersion_ShortVersion_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_CreateVersion_ShortVersion_Convenience()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_CreateVersion_ShortVersion_Convenience_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_CreateVersion_AllParameters()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_CreateVersion_AllParameters_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_CreateVersion_AllParameters_Convenience()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
...
Tags =
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_CreateVersion_AllParameters_Convenience_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
...
ConnectionName = "<connectionName>",
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_FetchAssetCredentials_ShortVersion()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
        ...
        Response response = client.FetchAssetCredentials("<name>", "<version>", content);
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_FetchAssetCredentials_ShortVersion_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
        ...
        Response response = await client.FetchAssetCredentialsAsync("<name>", "<version>", content);
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_FetchAssetCredentials_ShortVersion_Convenience()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");

        AI.Projects.1DP.AssetCredentialRequest assetCredentialRequest = new Projects.1DP.AssetCredentialRequest("<BlobUri>");
        Azure.Response < AI.Projects.1DP.AssetCredentialResponse > response = client.FetchAssetCredentials("<name>", "<version>", assetCredentialRequest);
    }

    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_FetchAssetCredentials_ShortVersion_Convenience_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
        ...
        AI.Projects.1DP.AssetCredentialRequest assetCredentialRequest = new Projects.1DP.AssetCredentialRequest("<BlobUri>");
        Azure.Response < AI.Projects.1DP.AssetCredentialResponse > response = await client.FetchAssetCredentialsAsync("<name>", "<version>", assetCredentialRequest);
    }

    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_FetchAssetCredentials_AllParameters()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_FetchAssetCredentials_AllParameters_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_EvaluationResults_FetchAssetCredentials_AllParameters_Convenience()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_EvaluationResults_FetchAssetCredentials_AllParameters_Convenience_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.EvaluationResults client = new Projects.1DP.AIProjectClient(endpoint, credential).GetEvaluationResultsClient(apiVersion: "2025-05-15-preview");
    ...
    public void Example_EvaluationResults_GetAgentEvaluationResults_ShortVersion()
    {
        ...
        Response response = client.GetAgentEvaluationResults("<completionId>", (RequestContext)null);

        JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        Console.WriteLine(result[0].GetProperty("evaluator").ToString());
        Console.WriteLine(result[0].GetProperty("score").ToString());
    ...
    public async Task Example_EvaluationResults_GetAgentEvaluationResults_ShortVersion_Async()
    {
        ...
        Response response = await client.GetAgentEvaluationResultsAsync("<completionId>", (RequestContext)null);
    ...
    public void Example_EvaluationResults_GetAgentEvaluationResults_ShortVersion_Convenience()
    {
        ...
        Azure.Response < System.Collections.Generic.IReadOnlyList < AI.Projects.1DP.AgentEvaluationResult >> response = client.GetAgentEvaluationResults("<completionId>");
    }
    ...
    public async Task Example_EvaluationResults_GetAgentEvaluationResults_ShortVersion_Convenience_Async()
    {
        ...
        Azure.Response < System.Collections.Generic.IReadOnlyList < AI.Projects.1DP.AgentEvaluationResult >> response = await client.GetAgentEvaluationResultsAsync("<completionId>");
    }
    ...
    public void Example_EvaluationResults_GetAgentEvaluationResults_AllParameters()
    {
        ...
        Console.WriteLine(result[0].GetProperty("responseId").ToString());
        Console.WriteLine(result[0].GetProperty("messageId").ToString());
        Console.WriteLine(result[0].GetProperty("threadId").ToString());
        Console.WriteLine(result[0].GetProperty("runId").ToString());
        Console.WriteLine(result[0].GetProperty("error").ToString());
        Console.WriteLine(result[0].GetProperty("additionalDetails").GetProperty("<key>").ToString());
    }
