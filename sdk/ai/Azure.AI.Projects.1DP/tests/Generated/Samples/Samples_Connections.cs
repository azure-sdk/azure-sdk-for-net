...
public partial class Samples_Connections
{
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_Connection_GetWithCredentials_ShortVersion()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.Connections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient(apiVersion: "2025-05-15-preview");

        Response response = client.GetWithCredentials("<name>", (RequestContext)null);
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_Connection_GetWithCredentials_ShortVersion_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.Connections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient(apiVersion: "2025-05-15-preview");

        Response response = await client.GetWithCredentialsAsync("<name>", (RequestContext)null);
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_Connection_GetWithCredentials_ShortVersion_Convenience()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.Connections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient(apiVersion: "2025-05-15-preview");

        Azure.Response < AI.Projects.1DP.Connection > response = client.GetWithCredentials("<name>");
    }

    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_Connection_GetWithCredentials_ShortVersion_Convenience_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.Connections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient(apiVersion: "2025-05-15-preview");

        Azure.Response < AI.Projects.1DP.Connection > response = await client.GetWithCredentialsAsync("<name>");
    }

    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_Connection_GetWithCredentials_AllParameters()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.Connections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_Connection_GetWithCredentials_AllParameters_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.Connections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public void Example_Connection_GetWithCredentials_AllParameters_Convenience()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.Connections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient(apiVersion: "2025-05-15-preview");
    ...
    [Test]
    [Ignore("Only validating compilation of examples")]
    public async Task Example_Connection_GetWithCredentials_AllParameters_Convenience_Async()
    {
        Uri endpoint = new Uri("<endpoint>");
        AzureKeyCredential credential = new AzureKeyCredential("<key>");
        AI.Projects.1DP.Connections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient(apiVersion: "2025-05-15-preview");
