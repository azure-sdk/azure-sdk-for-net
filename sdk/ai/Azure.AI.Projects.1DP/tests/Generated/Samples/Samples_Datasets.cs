...
public partial class Samples_Datasets
{
    ...
    public void Example_Datasets_GetDataset_ShortVersion()
    {
        ...
        Response response = client.GetDataset("<name>", "<version>", (RequestContext)null);
    ...
    public async Task Example_Datasets_GetDataset_ShortVersion_Async()
    {
        ...
        Response response = await client.GetDatasetAsync("<name>", "<version>", (RequestContext)null);
    ...
    public void Example_Datasets_GetDataset_ShortVersion_Convenience()
    {
        ...
        Azure.Response < AI.Projects.1DP.DatasetVersion > response = client.GetDataset("<name>", "<version>");
    }
    ...
    public async Task Example_Datasets_GetDataset_ShortVersion_Convenience_Async()
    {
        ...
        Azure.Response < AI.Projects.1DP.DatasetVersion > response = await client.GetDatasetAsync("<name>", "<version>");
    }
...
ConnectionName = "bknvpmlisrqxaphkf",
        ...
        Azure.Response < AI.Projects.1DP.PendingUploadResponse > response = client.PendingUpload("sgrzyrpltz", "ozdqisviavgqgfbtnzk", body);
    }
...
ConnectionName = "bknvpmlisrqxaphkf",
        ...
        Azure.Response < AI.Projects.1DP.PendingUploadResponse > response = await client.PendingUploadAsync("sgrzyrpltz", "ozdqisviavgqgfbtnzk", body);
    }
    ...
    public void Example_Datasets_PendingUpload_DatasetsStartPendingUploadVersionMinimumSet_Convenience()
    {
        ...
        AI.Projects.1DP.PendingUploadRequest body = new Projects.1DP.PendingUploadRequest();
        Azure.Response < AI.Projects.1DP.PendingUploadResponse > response = client.PendingUpload("duxoiaywfik", "yzzzt", body);
    }
    ...
    public async Task Example_Datasets_PendingUpload_DatasetsStartPendingUploadVersionMinimumSet_Convenience_Async()
    {
        ...
        AI.Projects.1DP.PendingUploadRequest body = new Projects.1DP.PendingUploadRequest();
        Azure.Response < AI.Projects.1DP.PendingUploadResponse > response = await client.PendingUploadAsync("duxoiaywfik", "yzzzt", body);
    }
        ...
        await foreach (Projects.1DP.DatasetVersion item in client.GetVersionsAsync("<name>", maxCount: 1234, skip: "<skip>", tags: "<tags>", listViewType: AI.Projects.1DP.ListViewType.ActiveOnly))
{
    ...
    public void Example_DatasetVersion_GetDatasetVersions_ShortVersion()
    {
        ...
        foreach (BinaryData item in client.GetDatasetVersions((int?)null, (string)null, (string)null, (string)null, (RequestContext)null))
        {
            JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
            Console.WriteLine(result.GetProperty("datasetUri").ToString());
            Console.WriteLine(result.GetProperty("type").ToString());
    ...
    public async Task Example_DatasetVersion_GetDatasetVersions_ShortVersion_Async()
    {
        ...
        await foreach (BinaryData item in client.GetDatasetVersionsAsync((int?)null, (string)null, (string)null, (string)null, (RequestContext)null))
        {
            JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
            Console.WriteLine(result.GetProperty("datasetUri").ToString());
            Console.WriteLine(result.GetProperty("type").ToString());
    ...
    public void Example_DatasetVersion_GetDatasetVersions_ShortVersion_Convenience()
    {
        ...
        foreach (Projects.1DP.DatasetVersion item in client.GetDatasetVersions())
{
        }
    }
    ...
    public async Task Example_DatasetVersion_GetDatasetVersions_ShortVersion_Convenience_Async()
    {
        ...
        await foreach (Projects.1DP.DatasetVersion item in client.GetDatasetVersionsAsync())
{
        }
    }
    ...
    public void Example_DatasetVersion_GetDatasetVersions_AllParameters()
    {
        ...
        foreach (BinaryData item in client.GetDatasetVersions(1234, "<skip>", "<tags>", "ActiveOnly", (RequestContext)null))
        {
            JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
            Console.WriteLine(result.GetProperty("datasetUri").ToString());
            Console.WriteLine(result.GetProperty("type").ToString());
    ...
    public async Task Example_DatasetVersion_GetDatasetVersions_AllParameters_Async()
    {
        ...
        await foreach (BinaryData item in client.GetDatasetVersionsAsync(1234, "<skip>", "<tags>", "ActiveOnly", (RequestContext)null))
        {
            JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
            Console.WriteLine(result.GetProperty("datasetUri").ToString());
            Console.WriteLine(result.GetProperty("type").ToString());
    ...
    public void Example_DatasetVersion_GetDatasetVersions_AllParameters_Convenience()
    {
        ...
        foreach (Projects.1DP.DatasetVersion item in client.GetDatasetVersions(maxCount: 1234, skip: "<skip>", tags: "<tags>", listViewType: AI.Projects.1DP.ListViewType.ActiveOnly))
{
        }
    }
    ...
    public async Task Example_DatasetVersion_GetDatasetVersions_AllParameters_Convenience_Async()
    {
        ...
        await foreach (Projects.1DP.DatasetVersion item in client.GetDatasetVersionsAsync(maxCount: 1234, skip: "<skip>", tags: "<tags>", listViewType: AI.Projects.1DP.ListViewType.ActiveOnly))
{
        }
    }
}
