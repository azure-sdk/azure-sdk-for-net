...
{
public partial class Samples_ConnectionsConnections
{
    [Test]
    ...
    public void Example_Connection_GetConnection_ShortVersion()
    {
        ...
        AI.Projects.1DP.ConnectionsConnections client = new Projects.1DP.AIProjectClient(endpoint, credential).GetConnectionsClient().GetConnectionsConnectionsClient(apiVersion: "2025-05-15-preview");
