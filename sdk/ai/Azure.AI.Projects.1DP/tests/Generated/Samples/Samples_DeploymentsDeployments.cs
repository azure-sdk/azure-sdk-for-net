...
{
public partial class Samples_DeploymentsDeployments
{
    [Test]
    ...
    public void Example_Deployment_GetDeployment_ShortVersion()
    {
        ...
        AI.Projects.1DP.DeploymentsDeployments client = new Projects.1DP.AIProjectClient(endpoint, credential).GetDeploymentsClient().GetDeploymentsDeploymentsClient(apiVersion: "2025-05-15-preview");
        ...
        await foreach (Projects.1DP.Deployment item in client.GetDeploymentsAsync())
{
    ...
    public void Example_Deployment_GetDeployments_AllParameters()
    {
        ...
        foreach (BinaryData item in client.GetDeployments("<modelPublisher>", "<modelName>", 1234, 1234, 1234, (RequestContext)null))
        {
            JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
            Console.WriteLine(result.GetProperty("type").ToString());
            Console.WriteLine(result.GetProperty("name").ToString());
    ...
    public async Task Example_Deployment_GetDeployments_AllParameters_Async()
    {
        ...
        await foreach (BinaryData item in client.GetDeploymentsAsync("<modelPublisher>", "<modelName>", 1234, 1234, 1234, (RequestContext)null))
        {
            JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
            Console.WriteLine(result.GetProperty("type").ToString());
            Console.WriteLine(result.GetProperty("name").ToString());
    ...
    public void Example_Deployment_GetDeployments_AllParameters_Convenience()
    {
        ...
        foreach (Projects.1DP.Deployment item in client.GetDeployments(modelPublisher: "<modelPublisher>", modelName: "<modelName>", maxCount: 1234, skip: 1234, maxpagesize: 1234))
{
        }
    }
    ...
    public async Task Example_Deployment_GetDeployments_AllParameters_Convenience_Async()
    {
        ...
        await foreach (Projects.1DP.Deployment item in client.GetDeploymentsAsync(modelPublisher: "<modelPublisher>", modelName: "<modelName>", maxCount: 1234, skip: 1234, maxpagesize: 1234))
{
        }
    }
}
