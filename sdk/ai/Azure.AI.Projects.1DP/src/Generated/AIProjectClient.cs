...
public partial class AIProjectClient
{
    ...
    {
        return Volatile.Read(ref _cachedServicePatterns) ?? Interlocked.CompareExchange(ref _cachedServicePatterns, new Projects.1DP.ServicePatterns(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint), null) ?? _cachedServicePatterns;
    }
    ...
    public virtual Projects.1DP.Connections GetConnectionsClient(string apiVersion = "2025-05-15-preview")
    {
        ...
        return new Projects.1DP.Connections(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
    }
    ...
    public virtual Projects.1DP.Evaluations GetEvaluationsClient(string apiVersion = "2025-05-15-preview")
    {
        ...
        return new Projects.1DP.Evaluations(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
    }
    ...
    public virtual Projects.1DP.Datasets GetDatasetsClient(string apiVersion = "2025-05-15-preview")
    {
        ...
        return new Projects.1DP.Datasets(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
    }
    ...
    public virtual Projects.1DP.Indexes GetIndexesClient(string apiVersion = "2025-05-15-preview")
    {
        ...
        return new Projects.1DP.Indexes(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
    }
    ...
    public virtual Projects.1DP.Deployments GetDeploymentsClient(string apiVersion = "2025-05-15-preview")
    {
        ...
        return new Projects.1DP.Deployments(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
    }
    ...
    public virtual Projects.1DP.RedTeams GetRedTeamsClient(string apiVersion = "2025-05-15-preview")
    {
        ...
        return new Projects.1DP.RedTeams(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
    }
}
}
