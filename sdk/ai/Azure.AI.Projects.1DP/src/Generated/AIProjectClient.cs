...
public partial class AIProjectClient
{
    ...
    private Projects.1DP.Connections _cachedConnections;
    ...
    public virtual Projects.1DP.Connections GetConnectionsClient()
    {
        return Volatile.Read(ref _cachedConnections) ?? Interlocked.CompareExchange(ref _cachedConnections, new Projects.1DP.Connections(ClientDiagnostics, _pipeline, _keyCredential, _tokenCredential, _endpoint), null) ?? _cachedConnections;
    }
