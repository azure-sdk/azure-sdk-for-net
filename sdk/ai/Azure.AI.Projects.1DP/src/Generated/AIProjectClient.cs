...
public partial class AIProjectClient
{
    ...
    private Projects.1DP.Internal _cachedInternal;
    private Projects.1DP.ServicePatterns _cachedServicePatterns;

    /// <summary> Initializes a new instance of Internal. </summary>
    public virtual Projects.1DP.Internal GetInternalClient()
    {
        return Volatile.Read(ref _cachedInternal) ?? Interlocked.CompareExchange(ref _cachedInternal, new Projects.1DP.Internal(ClientDiagnostics, _pipeline, _keyCredential, _tokenCredential, _endpoint), null) ?? _cachedInternal;
    }
