...
public partial class AIProjectClient
{
    ...
    public virtual Projects.1DP.Connections GetConnectionsClient(string apiVersion = "latest")
    {
    ...
    /// <param name="apiVersion"> The API version to use for this operation. </param>
    /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
    public virtual Projects.1DP.Datasets GetDatasetsClient(string apiVersion = "latest")
    {
        AI.Projects.1DP.Argument.AssertNotNull(apiVersion, nameof(apiVersion));
    ...
    /// <param name="apiVersion"> The API version to use for this operation. </param>
    /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
    public virtual Projects.1DP.Indexes GetIndexesClient(string apiVersion = "latest")
    {
        AI.Projects.1DP.Argument.AssertNotNull(apiVersion, nameof(apiVersion));
    ...
    /// <param name="apiVersion"> The API version to use for this operation. </param>
    /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
    public virtual Projects.1DP.Deployments GetDeploymentsClient(string apiVersion = "latest")
    {
        AI.Projects.1DP.Argument.AssertNotNull(apiVersion, nameof(apiVersion));
