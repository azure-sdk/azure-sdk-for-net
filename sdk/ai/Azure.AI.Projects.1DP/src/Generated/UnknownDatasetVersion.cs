...
internal partial class UnknownDatasetVersion : Projects.1DP.DatasetVersion
{
    ...
    internal UnknownDatasetVersion(string dataUri, Projects.1DP.DatasetType type, bool? isReference, string id, string name, string version, string description, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(dataUri, type, isReference, id, name, version, description, tags, serializedAdditionalRawData)
    {
    }
