...
{
    /// <summary> Initializes a new instance of <see cref="Projects.1DP.UnknownDatasetVersion"/>. </summary>
    ...
    internal UnknownDatasetVersion(string datasetUri, Projects.1DP.DatasetType type, bool? isReference, string stage, string id, string name, string version, string description, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(datasetUri, type, isReference, stage, id, name, version, description, tags, serializedAdditionalRawData)
    {
    }

    /// <summary> Initializes a new instance of <see cref="Projects.1DP.UnknownDatasetVersion"/> for deserialization. </summary>
