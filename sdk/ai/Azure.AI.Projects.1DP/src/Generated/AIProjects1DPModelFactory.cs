...
public static Azure.AI.Projects .1DP.DatasetVersion DatasetVersion(string dataUri = (string)null, string type = (string)null, bool? isReference = (bool?)null, string id = (string)null, string name = (string)null, string version = (string)null, string description = (string)null, IDictionary<string, string> tags = (IDictionary<string, string>)null)
{
    tags ??= new Dictionary<string, string>();
...
public static Azure.AI.Projects .1DP.FileDatasetVersion FileDatasetVersion(string dataUri = (string)null, bool? isReference = (bool?)null, string id = (string)null, string name = (string)null, string version = (string)null, string description = (string)null, IDictionary<string, string> tags = (IDictionary<string, string>)null)
{
    tags ??= new Dictionary<string, string>();
...
public static Azure.AI.Projects .1DP.FolderDatasetVersion FolderDatasetVersion(string dataUri = (string)null, bool? isReference = (bool?)null, string id = (string)null, string name = (string)null, string version = (string)null, string description = (string)null, IDictionary<string, string> tags = (IDictionary<string, string>)null)
{
    tags ??= new Dictionary<string, string>();
...
public static Azure.AI.Projects .1DP.PendingUploadResponse PendingUploadResponse(Azure.AI.Projects.1DP.BlobReference blobReference = (Azure.AI.Projects.1DP.BlobReference)null,string pendingUploadId = null,string version = (string)null,Azure.AI.Projects.1DP.PendingUploadType pendingUploadType = default)
{
    return new Azure.AI.Projects.1DP.PendingUploadResponse(blobReference, pendingUploadId, version, pendingUploadType, serializedAdditionalRawData: null);
}

/// <summary> Initializes a new instance of <see cref="Azure.AI.Projects.1DP.BlobReference"/>. </summary>
...
/// <returns> A new <see cref="Azure.AI.Projects.1DP.BlobReference"/> instance for mocking. </returns>
public static Azure.AI.Projects .1DP.BlobReference BlobReference(string blobUri = (string)null, string storageAccountArmId = (string)null, Azure.AI.Projects.1DP.SasCredential credential = (Azure.AI.Projects.1DP.SasCredential)null)
{
    return new Azure.AI.Projects.1DP.BlobReference(blobUri, storageAccountArmId, credential, serializedAdditionalRawData: null);
}
...
public static Azure.AI.Projects .1DP.AssetCredentialResponse AssetCredentialResponse(Azure.AI.Projects.1DP.BlobReference blobReference = (Azure.AI.Projects.1DP.BlobReference)null)
{
    return new Azure.AI.Projects.1DP.AssetCredentialResponse(blobReference, serializedAdditionalRawData: null);
}
...
public static Azure.AI.Projects .1DP.Index Index(string type = (string)null, string id = (string)null, string name = (string)null, string version = (string)null, string description = (string)null, IDictionary<string, string> tags = (IDictionary<string, string>)null)
{
    tags ??= new Dictionary<string, string>();
...
public static Azure.AI.Projects .1DP.AzureAISearchIndex AzureAISearchIndex(string id = (string)null, string name = (string)null, string version = (string)null, string description = (string)null, IDictionary<string, string> tags = (IDictionary<string, string>)null, string connectionName = (string)null, string indexName = (string)null)
{
    tags ??= new Dictionary<string, string>();
...
public static Azure.AI.Projects .1DP.ManagedAzureAISearchIndex ManagedAzureAISearchIndex(string id = (string)null, string name = (string)null, string version = (string)null, string description = (string)null, IDictionary<string, string> tags = (IDictionary<string, string>)null, string vectorStoreId = (string)null)
{
    tags ??= new Dictionary<string, string>();
...
public static Azure.AI.Projects .1DP.CosmosDBIndex CosmosDBIndex(string id = (string)null, string name = (string)null, string version = (string)null, string description = (string)null, IDictionary<string, string> tags = (IDictionary<string, string>)null, string connectionName = (string)null, string databaseName = (string)null, string containerName = (string)null, Azure.AI.Projects.1DP.EmbeddingConfiguration embeddingConfiguration = (Azure.AI.Projects.1DP.EmbeddingConfiguration)null)
{
    tags ??= new Dictionary<string, string>();
