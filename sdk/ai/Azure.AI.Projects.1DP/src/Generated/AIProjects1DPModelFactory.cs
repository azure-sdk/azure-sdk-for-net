...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.ConnectionPaged"/>. </summary>
/// <param name="value"> The Connection items on this page. </param>
/// <param name="nextLink"> The link to the next page of items. </param>
/// <returns> A new <see cref="Projects.1DP.ConnectionPaged"/> instance for mocking. </returns>
public static Projects.1DP.ConnectionPaged ConnectionPaged(System.Collections.Generic.IEnumerable<Projects.1DP.Connection> value = (System.Collections.Generic.IEnumerable < AI.Projects.1DP.Connection>)null,Uri nextLink = null)
{
value ??= new System.Collections.Generic.List<Projects.1DP.Connection>();

return new Projects.1DP.ConnectionPaged(value?.ToList(), nextLink, serializedAdditionalRawData: null);
}
