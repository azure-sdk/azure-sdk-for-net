...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.EvaluationResult"/>. </summary>
/// <param name="resultType"> Type of Evaluation result. </param>
/// <param name="modelName"> Model Name. </param>
/// <param name="modelVersion"> Model Version. </param>
/// <param name="modelAssetId"> Model Asset ID. </param>
/// <param name="datasetFamily"> Dataset Family. </param>
...
/// <returns> A new <see cref="Projects.1DP.EvaluationResult"/> instance for mocking. </returns>
public static Projects.1DP.EvaluationResult EvaluationResult(Projects.1DP.ResultType? resultType = (Projects.1DP.ResultType?)null,string modelName = null,string modelVersion = null,string modelAssetId = null,string datasetFamily = null,string datasetName = null, global::System.Collections.Generic.IDictionary<string, double> metrics = (IDictionary<string, double>)null,string blobUri = null,string stage = null,string id = null,string name = null,string version = null,string description = null, global::System.Collections.Generic.IDictionary<string, string> tags = (IDictionary<string, string>)null)
{
metrics ??= new Dictionary<string, double>();
tags ??= new Dictionary<string, string>();

return new Projects.1DP.EvaluationResult(
    resultType,
    modelName,
    modelVersion,
    modelAssetId,
...
public static Azure.AI.Projects .1DP.SasCredential SasCredential(string sasToken = (string)null)
{
    return new Azure.AI.Projects.1DP.SasCredential(Azure.AI.Projects.1DP.CredentialType.SAS, serializedAdditionalRawData: null, sasToken);
}

/// <summary> Initializes a new instance of <see cref="Azure.AI.Projects.1DP.ApiKeyCredential"/>. </summary>
/// <param name="apiKey"> API Key. </param>
/// <returns> A new <see cref="Azure.AI.Projects.1DP.ApiKeyCredential"/> instance for mocking. </returns>
public static Azure.AI.Projects .1DP.ApiKeyCredential ApiKeyCredential(string apiKey = (string)null)
{
    return new Azure.AI.Projects.1DP.ApiKeyCredential(Azure.AI.Projects.1DP.CredentialType.ApiKey, serializedAdditionalRawData: null, apiKey);
}
...
/// <summary> Initializes a new instance of <see cref="Azure.AI.Projects.1DP.Evaluation"/>. </summary>
...
/// <param name="outputs"> Read-only result outputs. Example: { 'evaluationResultId': 'azureai://accounts/{AccountName}/projects/{myproject}/evaluationresults/{name}/{version}', 'logId': 'azureai://accounts/{AccountName}/projects/{myproject}/datasets/{dataset-name}/{dataset-version}' }. </param>
/// <returns> A new <see cref="Azure.AI.Projects.1DP.Evaluation"/> instance for mocking. </returns>
public static Azure.AI.Projects .1DP.Evaluation Evaluation(string id = (string)null, Azure.AI.Projects.1DP.InputData data = (Azure.AI.Projects.1DP.InputData)null,string displayName = null,string description = (string)null,string status = null, global::System.Collections.Generic.IDictionary<string, string> tags = (global::System.Collections.Generic.IDictionary<string, string>)null,IDictionary<string, string> properties = null, global::System.Collections.Generic.IDictionary<string, global::Azure.AI.Projects.1DP.EvaluatorConfiguration> evaluators = (global::System.Collections.Generic.IDictionary<string, global::Azure.AI.Projects.1DP.EvaluatorConfiguration>)null,IReadOnlyDictionary<string, string> outputs = null)
{
    tags ??= new Dictionary<string, string>();
...
/// <summary> Initializes a new instance of <see cref="Azure.AI.Projects.1DP.Connection"/>. </summary>
/// <param name="name"> The name of the resource. </param>
/// <param name="type"> Category of the connection. </param>
/// <param name="target"> The connection URL to be used for this service. </param>
/// <param name="authType"> The authentication type used by the connection. </param>
/// <param name="metadata"> Metadata of the connection. </param>
/// <returns> A new <see cref="Azure.AI.Projects.1DP.Connection"/> instance for mocking. </returns>
public static Azure.AI.Projects .1DP.Connection Connection(string name = (string)null, Azure.AI.Projects.1DP.ConnectionType type = default, string target = (string)null, Azure.AI.Projects.1DP.AuthenticationType authType = default, IReadOnlyDictionary<string, string> metadata = (IReadOnlyDictionary<string, string>)null)
{
