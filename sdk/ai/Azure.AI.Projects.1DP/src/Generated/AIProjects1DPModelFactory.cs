...
public static Azure.AI.Projects .1DP.AgentEvaluation AgentEvaluation(string threadId = (string)null, string runId = (string)null, System.Collections.Generic.IReadOnlyDictionary<string, Azure.AI.Projects.1DP.EvaluatorConfiguration> evaluators = (System.Collections.Generic.IReadOnlyDictionary < string, Azure.AI.Projects.1DP.EvaluatorConfiguration>)null,Azure.AI.Projects.1DP.SamplingConfiguration samplingConfiguration = (Azure.AI.Projects.1DP.SamplingConfiguration)null,string appInsightsConnectionString = null)
{
    evaluators ??= new Dictionary<string, Azure.AI.Projects.1DP.EvaluatorConfiguration >;

    return new Azure.AI.Projects.1DP.AgentEvaluation(
        threadId,
        runId,
        evaluators,
...
/// <summary> Initializes a new instance of <see cref="Azure.AI.Projects.1DP.SamplingConfiguration"/>. </summary>
/// <param name="name"> Name of the sampling strategy. </param>
/// <param name="samplingPercent"> Percentage of sampling per hour. </param>
/// <param name="maxRequestRate"> Maximum request rate per hour. </param>
/// <returns> A new <see cref="Azure.AI.Projects.1DP.SamplingConfiguration"/> instance for mocking. </returns>
public static Azure.AI.Projects .1DP.SamplingConfiguration SamplingConfiguration(string name = (string)null, double samplingPercent = default, double maxRequestRate = default)
{
    return new Azure.AI.Projects.1DP.SamplingConfiguration(name, samplingPercent, maxRequestRate, serializedAdditionalRawData: null);
}
...
/// <summary> Initializes a new instance of <see cref="Azure.AI.Projects.1DP.AgentLongRunningOperationResponse"/>. </summary>
/// <param name="location"> URI for the long running operation. </param>
/// <param name="operationResult"> Result of the long running operation. </param>
/// <returns> A new <see cref="Azure.AI.Projects.1DP.AgentLongRunningOperationResponse"/> instance for mocking. </returns>
public static Azure.AI.Projects .1DP.AgentLongRunningOperationResponse AgentLongRunningOperationResponse(string location = (string)null, BinaryData operationResult = (BinaryData)null)
{
    return new Azure.AI.Projects.1DP.AgentLongRunningOperationResponse(location, operationResult, serializedAdditionalRawData: null);
}
