...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.Deployment"/>. </summary>
/// <param name="type"> The type of the deployment. </param>
/// <param name="name"> Name of the deployment. </param>
/// <returns> A new <see cref="Projects.1DP.Deployment"/> instance for mocking. </returns>
...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.ModelDeployment"/>. </summary>
/// <param name="name"> Name of the deployment. </param>
...
/// <returns> A new <see cref="Projects.1DP.ModelDeployment"/> instance for mocking. </returns>
public static Projects.1DP.ModelDeployment ModelDeployment(string name = null, string modelName = null, string modelVersion = null, string modelPublisher = null, IReadOnlyDictionary<string, string> capabilities = null, Projects.1DP.Sku sku = (Projects.1DP.Sku)null,string connectionName = null)
{
