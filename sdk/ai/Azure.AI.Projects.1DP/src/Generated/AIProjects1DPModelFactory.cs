...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.EvaluationUpload"/>. </summary>
...
/// <returns> A new <see cref="Projects.1DP.EvaluationUpload"/> instance for mocking. </returns>
public static Projects.1DP.EvaluationUpload EvaluationUpload(string id = null, Projects.1DP.InputData data = (Projects.1DP.InputData)null,Projects.1DP.EvaluationTarget target = (Projects.1DP.EvaluationTarget)null,string displayName = null,string description = null, global::Azure.AI.Projects.1DP.SystemData systemData = (Projects.1DP.SystemData)null,string status = null, global::System.Collections.Generic.IDictionary<string, string> tags = (IDictionary<string, string>)null, global::System.Collections.Generic.IDictionary<string, string> properties = (IDictionary<string, string>)null, global::System.Collections.Generic.IDictionary<string, Projects.1DP.EvaluatorConfiguration> evaluators = (System.Collections.Generic.IDictionary < string, AI.Projects.1DP.EvaluatorConfiguration>)null,IDictionary<string, string> outputs = null)
{
...
return new Projects.1DP.EvaluationUpload(
    id,
    data,
    target,
    displayName,
