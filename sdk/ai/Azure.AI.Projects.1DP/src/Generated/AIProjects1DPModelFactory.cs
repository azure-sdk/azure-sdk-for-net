...
public static Projects.1DP.Evaluation Evaluation(string id = null, Projects.1DP.InputData data = (Projects.1DP.InputData)null,string displayName = null,string description = null,string status = null, global::System.Collections.Generic.IDictionary<string, string> tags = (IDictionary<string, string>)null, global::System.Collections.Generic.IDictionary<string, string> properties = (IDictionary<string, string>)null, global::System.Collections.Generic.IDictionary<string, Projects.1DP.EvaluatorConfiguration> evaluators = (System.Collections.Generic.IDictionary < string, AI.Projects.1DP.EvaluatorConfiguration>)null)
{
...
/// <param name="appInsightsConnectionString"> Optional and temporary way to pass the AppInsights connection string to the evaluator. When this string is not null, the evaluation results will be logged to Azure AppInsights. </param>
...
public static Azure.AI.Projects .1DP.AgentEvaluation AgentEvaluation(string id = (string)null, string status = (string)null, System.Collections.Generic.IEnumerable<Azure.AI.Projects.1DP.AgentEvaluationResult> result = (System.Collections.Generic.IEnumerable < Azure.AI.Projects.1DP.AgentEvaluationResult>)null)
{
    result ??= new List<Azure.AI.Projects.1DP.AgentEvaluationResult >;

    return new Azure.AI.Projects.1DP.AgentEvaluation(id, status, result?.ToList(), serializedAdditionalRawData: null);
}
