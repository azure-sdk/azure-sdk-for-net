...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.Sku"/>. </summary>
...
/// <returns> A new <see cref="Projects.1DP.Sku"/> instance for mocking. </returns>
public static Projects.1DP.Sku Sku(long capacity = default, string family = null, string name = null, string size = null, string tier = null)
{
    return new Projects.1DP.Sku(
        capacity,
        family,
        name,
        size,
...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.Index"/>. </summary>
...
/// <returns> A new <see cref="Projects.1DP.Index"/> instance for mocking. </returns>
public static Projects.1DP.Index Index(string type = null, string stage = null, string id = null, string name = null, string version = null, string description = null, IDictionary<string, string> tags = null)
{
    tags ??= new Dictionary<string, string>();

    return new Projects.1DP.UnknownIndex(
        type == null ? ((AI.Projects.1DP.IndexType)default) : new Projects.1DP.IndexType(type),
	stage,
	id,
	name,
	version,
...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.AzureAISearchIndex"/>. </summary>
/// <param name="stage"> Asset stage. </param>
/// <param name="id"> A unique identifier for the asset, assetId probably?. </param>
/// <param name="name"> The name of the resource. </param>
/// <param name="version"> The version of the resource. </param>
...
/// <returns> A new <see cref="Projects.1DP.AzureAISearchIndex"/> instance for mocking. </returns>
public static Projects.1DP.AzureAISearchIndex AzureAISearchIndex(string stage = null, string id = null, string name = null, string version = null, string description = null, IDictionary<string, string> tags = null, string connectionName = null, string indexName = null)
{
    tags ??= new Dictionary<string, string>();

    return new Projects.1DP.AzureAISearchIndex(
        AI.Projects.1DP.IndexType.AzureSearch,
        stage,
        id,
        name,
        version,
...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.ManagedAzureAISearchIndex"/>. </summary>
/// <param name="stage"> Asset stage. </param>
/// <param name="id"> A unique identifier for the asset, assetId probably?. </param>
/// <param name="name"> The name of the resource. </param>
/// <param name="version"> The version of the resource. </param>
...
/// <returns> A new <see cref="Projects.1DP.ManagedAzureAISearchIndex"/> instance for mocking. </returns>
public static Projects.1DP.ManagedAzureAISearchIndex ManagedAzureAISearchIndex(string stage = null, string id = null, string name = null, string version = null, string description = null, IDictionary<string, string> tags = null, string vectorStoreId = null)
{
    tags ??= new Dictionary<string, string>();

    return new Projects.1DP.ManagedAzureAISearchIndex(
        AI.Projects.1DP.IndexType.ManagedAzureSearch,
        stage,
        id,
        name,
        version,
...
/// <summary> Initializes a new instance of <see cref="Projects.1DP.CosmosDBIndex"/>. </summary>
/// <param name="stage"> Asset stage. </param>
/// <param name="id"> A unique identifier for the asset, assetId probably?. </param>
/// <param name="name"> The name of the resource. </param>
/// <param name="version"> The version of the resource. </param>
...
/// <returns> A new <see cref="Projects.1DP.CosmosDBIndex"/> instance for mocking. </returns>
public static Projects.1DP.CosmosDBIndex CosmosDBIndex(string stage = null, string id = null, string name = null, string version = null, string description = null, IDictionary<string, string> tags = null, string connectionName = null, string databaseName = null, string containerName = null, Projects.1DP.EmbeddingConfiguration embeddingConfiguration = (Projects.1DP.EmbeddingConfiguration)null)
{
tags ??= new Dictionary<string, string>();

return new Projects.1DP.CosmosDBIndex(
    Projects.1DP.IndexType.CosmosDB,
	stage,
	id,
	name,
	version,
