...
/// <include file="Docs/EvaluationResultsEvaluationResults.xml" path="doc/members/member[@name='GetVersions(string,int?,string,string,ListViewType?,CancellationToken)']/*" />
...
return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Projects.1DP.EvaluationResult.DeserializeEvaluationResult(e), ClientDiagnostics, _pipeline, "EvaluationResultsEvaluationResults.GetVersions", "value", "nextLink", context);
}
...
/// <include file="Docs/EvaluationResultsEvaluationResults.xml" path="doc/members/member[@name='GetVersionsAsync(string,int?,string,string,string,RequestContext)']/*" />
public virtual Azure.AsyncPageable<BinaryData> GetVersionsAsync(string name, int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    ...
    return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EvaluationResultsEvaluationResults.GetVersions", "value", "nextLink", context);
}
...
/// <include file="Docs/EvaluationResultsEvaluationResults.xml" path="doc/members/member[@name='GetVersions(string,int?,string,string,string,RequestContext)']/*" />
public virtual Azure.Pageable<BinaryData> GetVersions(string name, int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    ...
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetVersionsRequest(name, maxCount, skip, tags, listViewType, context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetVersionsNextPageRequest(nextLink, name, maxCount, skip, tags, listViewType, context);
    return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EvaluationResultsEvaluationResults.GetVersions", "value", "nextLink", context);
}
...
/// <param name="listViewType"> [ListViewType.ActiveOnly, ListViewType.ArchivedOnly, ListViewType.All] View type for including/excluding (for example) archived entities. </param>
/// <param name="cancellationToken"> The cancellation token to use. </param>
/// <include file="Docs/EvaluationResultsEvaluationResults.xml" path="doc/members/member[@name='GetLatestsAsync(int?,string,string,ListViewType?,CancellationToken)']/*" />
public virtual Azure.AsyncPageable<Azure.AI.Projects.1DP.EvaluationResult> GetLatestsAsync(int? maxCount = null, string skip = null, string tags = null, Azure.AI.Projects.1DP.ListViewType? listViewType = (Azure.AI.Projects.1DP.ListViewType?)null,CancellationToken cancellationToken = default)
{
    ...
    return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Azure.AI.Projects.1DP.EvaluationResult.DeserializeEvaluationResult(e), ClientDiagnostics, _pipeline, "EvaluationResultsEvaluationResults.GetLatests", "value", "nextLink", context);
}
...
/// <param name="listViewType"> [ListViewType.ActiveOnly, ListViewType.ArchivedOnly, ListViewType.All] View type for including/excluding (for example) archived entities. </param>
/// <param name="cancellationToken"> The cancellation token to use. </param>
/// <include file="Docs/EvaluationResultsEvaluationResults.xml" path="doc/members/member[@name='GetLatests(int?,string,string,ListViewType?,CancellationToken)']/*" />
public virtual Azure.Pageable<Azure.AI.Projects.1DP.EvaluationResult> GetLatests(int? maxCount = null, string skip = null, string tags = null, Azure.AI.Projects.1DP.ListViewType? listViewType = (Azure.AI.Projects.1DP.ListViewType?)null,CancellationToken cancellationToken = default)
{
    ...
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetLatestsRequest(maxCount, skip, tags, listViewType?.ToString(), context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetLatestsNextPageRequest(nextLink, maxCount, skip, tags, listViewType?.ToString(), context);
    return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Azure.AI.Projects.1DP.EvaluationResult.DeserializeEvaluationResult(e), ClientDiagnostics, _pipeline, "EvaluationResultsEvaluationResults.GetLatests", "value", "nextLink", context);
}
...
/// <exception cref="Azure.RequestFailedException"> Service returned a non-success status code. </exception>
/// <returns> The <see cref="Azure.AsyncPageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
/// <include file="Docs/EvaluationResultsEvaluationResults.xml" path="doc/members/member[@name='GetLatestsAsync(int?,string,string,string,RequestContext)']/*" />
public virtual Azure.AsyncPageable<BinaryData> GetLatestsAsync(int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    ...
    return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EvaluationResultsEvaluationResults.GetLatests", "value", "nextLink", context);
}
...
/// <exception cref="Azure.RequestFailedException"> Service returned a non-success status code. </exception>
/// <returns> The <see cref="Azure.Pageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
/// <include file="Docs/EvaluationResultsEvaluationResults.xml" path="doc/members/member[@name='GetLatests(int?,string,string,string,RequestContext)']/*" />
public virtual Azure.Pageable<BinaryData> GetLatests(int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetLatestsRequest(maxCount, skip, tags, listViewType, context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetLatestsNextPageRequest(nextLink, maxCount, skip, tags, listViewType, context);
    return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EvaluationResultsEvaluationResults.GetLatests", "value", "nextLink", context);
}
