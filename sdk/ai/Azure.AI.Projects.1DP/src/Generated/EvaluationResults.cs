...
/// <summary> List all versions of the given EvaluationResult. </summary>
...
/// <include file="Docs/EvaluationResults.xml" path="doc/members/member[@name='GetVersions(string,int?,string,string,ListViewType?,CancellationToken)']/*" />
public virtual Azure.Pageable<Projects.1DP.EvaluationResult> GetVersions(string name, int? maxCount = null, string skip = null, string tags = null, Projects.1DP.ListViewType? listViewType = (Projects.1DP.ListViewType?)null,CancellationToken cancellationToken = default)
{
...
return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Projects.1DP.EvaluationResult.DeserializeEvaluationResult(e), ClientDiagnostics, _pipeline, "EvaluationResults.GetVersions", "value", "nextLink", context);
}

/// <summary>
/// [Protocol Method] List all versions of the given EvaluationResult
/// <list type="bullet">
/// <item>
/// <description>
...
/// <include file="Docs/EvaluationResults.xml" path="doc/members/member[@name='GetVersionsAsync(string,int?,string,string,string,RequestContext)']/*" />
public virtual Azure.AsyncPageable<BinaryData> GetVersionsAsync(string name, int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    ...
    return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EvaluationResults.GetVersions", "value", "nextLink", context);
}
...
/// <include file="Docs/EvaluationResults.xml" path="doc/members/member[@name='GetVersions(string,int?,string,string,string,RequestContext)']/*" />
public virtual Azure.Pageable<BinaryData> GetVersions(string name, int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    ...
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetVersionsRequest(name, maxCount, skip, tags, listViewType, context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetVersionsNextPageRequest(nextLink, name, maxCount, skip, tags, listViewType, context);
    return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EvaluationResults.GetVersions", "value", "nextLink", context);
}

/// <summary> List the latest version of each EvaluationResult. </summary>
/// <param name="maxCount"> Top count of results, top count cannot be greater than the page size. If topCount &gt; page size, results with be default page size count will be returned. </param>
/// <param name="skip"> Continuation token for pagination. </param>
/// <param name="tags"> Comma-separated list of tag names (and optionally values). Example: tag1,tag2=value2. </param>
/// <param name="listViewType"> [ListViewType.ActiveOnly, ListViewType.ArchivedOnly, ListViewType.All] View type for including/excluding (for example) archived entities. </param>
/// <param name="cancellationToken"> The cancellation token to use. </param>
/// <include file="Docs/EvaluationResults.xml" path="doc/members/member[@name='GetLatestsAsync(int?,string,string,ListViewType?,CancellationToken)']/*" />
public virtual Azure.AsyncPageable<Azure.AI.Projects.1DP.EvaluationResult> GetLatestsAsync(int? maxCount = null, string skip = null, string tags = null, Azure.AI.Projects.1DP.ListViewType? listViewType = (Azure.AI.Projects.1DP.ListViewType?)null,CancellationToken cancellationToken = default)
{
    ...
    return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Azure.AI.Projects.1DP.EvaluationResult.DeserializeEvaluationResult(e), ClientDiagnostics, _pipeline, "EvaluationResults.GetLatests", "value", "nextLink", context);
}
...
/// <param name="listViewType"> [ListViewType.ActiveOnly, ListViewType.ArchivedOnly, ListViewType.All] View type for including/excluding (for example) archived entities. </param>
/// <param name="cancellationToken"> The cancellation token to use. </param>
/// <include file="Docs/EvaluationResults.xml" path="doc/members/member[@name='GetLatests(int?,string,string,ListViewType?,CancellationToken)']/*" />
public virtual Azure.Pageable<Azure.AI.Projects.1DP.EvaluationResult> GetLatests(int? maxCount = null, string skip = null, string tags = null, Azure.AI.Projects.1DP.ListViewType? listViewType = (Azure.AI.Projects.1DP.ListViewType?)null,CancellationToken cancellationToken = default)
{
    Azure.RequestContext context = cancellationToken.CanBeCanceled ? new Azure.RequestContext { CancellationToken = cancellationToken } : null;
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetLatestsRequest(maxCount, skip, tags, listViewType?.ToString(), context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetLatestsNextPageRequest(nextLink, maxCount, skip, tags, listViewType?.ToString(), context);
    return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Azure.AI.Projects.1DP.EvaluationResult.DeserializeEvaluationResult(e), ClientDiagnostics, _pipeline, "EvaluationResults.GetLatests", "value", "nextLink", context);
}

/// <summary>
/// [Protocol Method] List the latest version of each EvaluationResult
/// <list type="bullet">
/// <item>
/// <description>
/// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
...
/// <exception cref="Azure.RequestFailedException"> Service returned a non-success status code. </exception>
/// <returns> The <see cref="Azure.AsyncPageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
/// <include file="Docs/EvaluationResults.xml" path="doc/members/member[@name='GetLatestsAsync(int?,string,string,string,RequestContext)']/*" />
public virtual Azure.AsyncPageable<BinaryData> GetLatestsAsync(int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    ...
    return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EvaluationResults.GetLatests", "value", "nextLink", context);
}
...
/// <exception cref="Azure.RequestFailedException"> Service returned a non-success status code. </exception>
/// <returns> The <see cref="Azure.Pageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
/// <include file="Docs/EvaluationResults.xml" path="doc/members/member[@name='GetLatests(int?,string,string,string,RequestContext)']/*" />
public virtual Azure.Pageable<BinaryData> GetLatests(int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetLatestsRequest(maxCount, skip, tags, listViewType, context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetLatestsNextPageRequest(nextLink, maxCount, skip, tags, listViewType, context);
    return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EvaluationResults.GetLatests", "value", "nextLink", context);
}
...
internal HttpMessage CreateGetVersionsRequest(string name, int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    ...
    uri.Reset(_endpoint);
    uri.AppendPath("/evaluationResults/", false);
...
internal HttpMessage CreateCreateOrUpdateVersionRequest(string name, string version, RequestContent content, Azure.RequestContext context)
{
...
internal HttpMessage CreateStartPendingUploadRequest(string name, string version, RequestContent content, Azure.RequestContext context)
{
    var message = _pipeline.CreateMessage(context, ResponseClassifier200);
    var request = message.Request;
...
internal HttpMessage CreateGetCredentialsRequest(string name, string version, RequestContent content, Azure.RequestContext context)
{
    var message = _pipeline.CreateMessage(context, ResponseClassifier200);
    var request = message.Request;
    request.Method = RequestMethod.Post;
...
internal HttpMessage CreateGetAgentEvaluationResultsRequest(string runId, Azure.RequestContext context)
{
    ...
    var uri = new RawRequestUriBuilder();
    uri.Reset(_endpoint);
    uri.AppendPath("/runs/agents/", false);
