...
internal HttpMessage CreateGetVersionsRequest(string name, int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    ...
    uri.Reset(_endpoint);
    uri.AppendPath("/evaluationResult/", false);
...
internal HttpMessage CreateFetchAssetCredentialsRequest(string name, string version, RequestContent content, Azure.RequestContext context)
{
    var message = _pipeline.CreateMessage(context, ResponseClassifier200);
    var request = message.Request;
    request.Method = RequestMethod.Post;
...
internal HttpMessage CreateGetAgentEvaluationResultsRequest(string completionId, Azure.RequestContext context)
{
    var message = _pipeline.CreateMessage(context, ResponseClassifier200);
    var request = message.Request;
    request.Method = RequestMethod.Get;
