...
/// <param name="listViewType"> [ListViewType.ActiveOnly, ListViewType.ArchivedOnly, ListViewType.All] View type for including/excluding (for example) archived entities. </param>
/// <param name="cancellationToken"> The cancellation token to use. </param>
/// <include file="Docs/Datasets.xml" path="doc/members/member[@name='GetDatasetVersionsAsync(int?,string,string,ListViewType?,CancellationToken)']/*" />
public virtual Azure.AsyncPageable<Azure.AI.Projects.1DP.DatasetVersion> GetDatasetVersionsAsync(int? maxCount = null, string skip = null, string tags = null, Azure.AI.Projects.1DP.ListViewType? listViewType = (Azure.AI.Projects.1DP.ListViewType?)null,CancellationToken cancellationToken = default)
{
    ...
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetDatasetVersionsRequest(maxCount, skip, tags, listViewType?.ToString(), context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetDatasetVersionsNextPageRequest(nextLink, maxCount, skip, tags, listViewType?.ToString(), context);
    return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Azure.AI.Projects.1DP.DatasetVersion.DeserializeDatasetVersion(e), ClientDiagnostics, _pipeline, "Datasets.GetDatasetVersions", "value", "nextLink", context);
}
...
/// <param name="listViewType"> [ListViewType.ActiveOnly, ListViewType.ArchivedOnly, ListViewType.All] View type for including/excluding (for example) archived entities. </param>
/// <param name="cancellationToken"> The cancellation token to use. </param>
/// <include file="Docs/Datasets.xml" path="doc/members/member[@name='GetDatasetVersions(int?,string,string,ListViewType?,CancellationToken)']/*" />
public virtual Azure.Pageable<Azure.AI.Projects.1DP.DatasetVersion> GetDatasetVersions(int? maxCount = null, string skip = null, string tags = null, Azure.AI.Projects.1DP.ListViewType? listViewType = (Azure.AI.Projects.1DP.ListViewType?)null,CancellationToken cancellationToken = default)
{
    Azure.RequestContext context = cancellationToken.CanBeCanceled ? new Azure.RequestContext { CancellationToken = cancellationToken } : null;
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetDatasetVersionsRequest(maxCount, skip, tags, listViewType?.ToString(), context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetDatasetVersionsNextPageRequest(nextLink, maxCount, skip, tags, listViewType?.ToString(), context);
    return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Azure.AI.Projects.1DP.DatasetVersion.DeserializeDatasetVersion(e), ClientDiagnostics, _pipeline, "Datasets.GetDatasetVersions", "value", "nextLink", context);
}
...
/// <item>
/// <description>
/// Please try the simpler <see cref="GetDatasetVersionsAsync(int?,string,string,Projects.1DP.ListViewType?,global::System.Threading.CancellationToken)"/> convenience overload with strongly typed models first.
/// </description>
/// </item>
/// </list>
/// </summary>
...
/// <exception cref="Azure.RequestFailedException"> Service returned a non-success status code. </exception>
/// <returns> The <see cref="Azure.AsyncPageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
/// <include file="Docs/Datasets.xml" path="doc/members/member[@name='GetDatasetVersionsAsync(int?,string,string,string,RequestContext)']/*" />
public virtual Azure.AsyncPageable<BinaryData> GetDatasetVersionsAsync(int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetDatasetVersionsRequest(maxCount, skip, tags, listViewType, context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetDatasetVersionsNextPageRequest(nextLink, maxCount, skip, tags, listViewType, context);
...
/// <item>
/// <description>
/// Please try the simpler <see cref="GetDatasetVersions(int?,string,string,Projects.1DP.ListViewType?,global::System.Threading.CancellationToken)"/> convenience overload with strongly typed models first.
/// </description>
/// </item>
/// </list>
/// </summary>
...
/// <exception cref="Azure.RequestFailedException"> Service returned a non-success status code. </exception>
/// <returns> The <see cref="Azure.Pageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
/// <include file="Docs/Datasets.xml" path="doc/members/member[@name='GetDatasetVersions(int?,string,string,string,RequestContext)']/*" />
public virtual Azure.Pageable<BinaryData> GetDatasetVersions(int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetDatasetVersionsRequest(maxCount, skip, tags, listViewType, context);
    HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetDatasetVersionsNextPageRequest(nextLink, maxCount, skip, tags, listViewType, context);
...
internal HttpMessage CreateGetDatasetVersionsRequest(int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    var message = _pipeline.CreateMessage(context, ResponseClassifier200);
    var request = message.Request;
    request.Method = RequestMethod.Get;
...
internal HttpMessage CreateGetDatasetRequest(string name, string version, Azure.RequestContext context)
{
    var message = _pipeline.CreateMessage(context, ResponseClassifier200);
    var request = message.Request;
    request.Method = RequestMethod.Get;
...
internal HttpMessage CreateDeleteRequest(string name, string version, Azure.RequestContext context)
{
...
internal HttpMessage CreateCreateOrUpdateRequest(string name, string version, RequestContent content, Azure.RequestContext context)
{
...
internal HttpMessage CreatePendingUploadRequest(string name, string version, RequestContent content, Azure.RequestContext context)
{
    var message = _pipeline.CreateMessage(context, ResponseClassifier200);
    var request = message.Request;
...
internal HttpMessage CreateGetDatasetVersionsNextPageRequest(string nextLink, int? maxCount, string skip, string tags, string listViewType, Azure.RequestContext context)
{
    var message = _pipeline.CreateMessage(context, ResponseClassifier200);
    var request = message.Request;
    request.Method = RequestMethod.Get;
