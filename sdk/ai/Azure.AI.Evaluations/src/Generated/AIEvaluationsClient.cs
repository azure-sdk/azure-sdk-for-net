...
namespace Azure.AI.Evaluations
{
    ...
    /// <summary> The AIEvaluations service client. </summary>
    public partial class AIEvaluationsClient
    {
        ...
        /// <summary> Initializes a new instance of AIEvaluationsClient for mocking. </summary>
        protected AIEvaluationsClient()
        {
        }

        /// <summary> Initializes a new instance of AIEvaluationsClient. </summary>
        ...
        public AIEvaluationsClient(Uri endpoint, string subscriptionId, string resourceGroupName, string projectName, TokenCredential credential) : this(endpoint, subscriptionId, resourceGroupName, projectName, credential, new AIEvaluationsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/>, <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="projectName"/> or <paramref name="credential"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="projectName"/> is an empty string, and was expected to be non-empty. </exception>
        public AIEvaluationsClient(Uri endpoint, string subscriptionId, string resourceGroupName, string projectName, TokenCredential credential, AIEvaluationsClientOptions options)
        {
            ...
            options ??= new AIEvaluationsClientOptions();
