...
namespace Azure.AI.Projects.OneDP.Samples
{
    public partial class Samples_Messages
    {
        ...
        public void Example_Messages_SendMessage_ShortVersion()
        {
...
text = "<text>",
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Messages_SendMessage_ShortVersion_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Messages client = new AIProjectClient(endpoint, credential).GetMessagesClient(apiVersion: "2025-05-01-preview");
...
text = "<text>",
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Messages_SendMessage_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Messages client = new AIProjectClient(endpoint, credential).GetMessagesClient(apiVersion: "2025-05-01-preview");

            ChatMessage body = new UserMessage(new AIContent[]
            {
new TextContent("<text>")
            });
            Response<ChatMessage> response = client.SendMessage("<conversationId>", body);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Messages_SendMessage_ShortVersion_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Messages client = new AIProjectClient(endpoint, credential).GetMessagesClient(apiVersion: "2025-05-01-preview");
...
new TextContent("<text>")
            ...
            Response<ChatMessage> response = await client.SendMessageAsync("<conversationId>", body);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Messages_SendMessage_AllParameters()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Messages client = new AIProjectClient(endpoint, credential).GetMessagesClient(apiVersion: "2025-05-01-preview");
...
start = 1234,
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Messages_SendMessage_AllParameters_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Messages client = new AIProjectClient(endpoint, credential).GetMessagesClient(apiVersion: "2025-05-01-preview");
...
start = 1234,
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Messages_SendMessage_AllParameters_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Messages client = new AIProjectClient(endpoint, credential).GetMessagesClient(apiVersion: "2025-05-01-preview");
...
End = 1234,
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Messages_SendMessage_AllParameters_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Messages client = new AIProjectClient(endpoint, credential).GetMessagesClient(apiVersion: "2025-05-01-preview");
...
End = 1234,
        ...
        public void Example_ChatMessage_GetMessage_ShortVersion()
        {
            ...
            Response response = client.GetMessage("<conversationId>", "<messageId>", null);
        ...
        public async Task Example_ChatMessage_GetMessage_ShortVersion_Async()
        {
            ...
            Response response = await client.GetMessageAsync("<conversationId>", "<messageId>", null);
        ...
        public void Example_ChatMessage_GetMessage_ShortVersion_Convenience()
        {
            ...
            Response<ChatMessage> response = client.GetMessage("<conversationId>", "<messageId>");
        }
        ...
        public async Task Example_ChatMessage_GetMessage_ShortVersion_Convenience_Async()
        {
            ...
            Response<ChatMessage> response = await client.GetMessageAsync("<conversationId>", "<messageId>");
        }
...
text = "<text>",
            ...
            Response response = client.UpdateMessage("<conversationId>", "<messageId>", content);
...
text = "<text>",
            ...
            Response response = await client.UpdateMessageAsync("<conversationId>", "<messageId>", content);
...
new TextContent("<text>")
            ...
            Response<ChatMessage> response = client.UpdateMessage("<conversationId>", "<messageId>", resource);
        }
...
new TextContent("<text>")
            ...
            Response<ChatMessage> response = await client.UpdateMessageAsync("<conversationId>", "<messageId>", resource);
        }
...
End = 1234,
        ...
        public void Example_ChatMessage_DeleteMessage_ShortVersion()
        {
            ...
            Response response = client.DeleteMessage("<conversationId>", "<messageId>");
        ...
        public async Task Example_ChatMessage_DeleteMessage_ShortVersion_Async()
        {
            ...
            Response response = await client.DeleteMessageAsync("<conversationId>", "<messageId>");
        ...
        public void Example_ChatMessage_GetMessages_ShortVersion()
        {
            ...
            foreach (BinaryData item in client.GetMessages("<conversationId>", null))
            {
        ...
        public async Task Example_ChatMessage_GetMessages_ShortVersion_Async()
        {
            ...
            await foreach (BinaryData item in client.GetMessagesAsync("<conversationId>", null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("messageId").ToString());
                Console.WriteLine(result.GetProperty("conversationId").ToString());
        ...
        public void Example_ChatMessage_GetMessages_ShortVersion_Convenience()
        {
            ...
            foreach (ChatMessage item in client.GetMessages("<conversationId>"))
            {
            }
        }
        ...
        public async Task Example_ChatMessage_GetMessages_ShortVersion_Convenience_Async()
        {
            ...
            await foreach (ChatMessage item in client.GetMessagesAsync("<conversationId>"))
            {
            }
        }
