...
namespace Azure.AI.Projects.OneDP.Samples
{
    public partial class Samples_Agents
    {
        ...
        public void Example_Agents_CreateAgent_ShortVersion_Convenience()
        {
            ...
            Response<Agent> response = client.CreateAgent("<name>");
        }
        ...
        public async Task Example_Agents_CreateAgent_ShortVersion_Convenience_Async()
        {
            ...
            Response<Agent> response = await client.CreateAgentAsync("<name>");
        }
...
"<toolNames>"
        ...
        public void Example_Agents_CreateAgent_AllParameters_Convenience()
        {
            ...
            Response<Agent> response = client.CreateAgent("<name>", agentModel: agentModel, instructions: new DeveloperMessage[]
            {
...
Parameters = default,
        ...
        public async Task Example_Agents_CreateAgent_AllParameters_Convenience_Async()
        {
            ...
            ToolChoiceBehavior toolChoice = new AutoToolChoiceBehavior(new string[] { "<toolNames>" });
            Response<Agent> response = await client.CreateAgentAsync("<name>", agentModel: agentModel, instructions: new DeveloperMessage[]
            {
new DeveloperMessage(new AIContent[]
{
new TextContent("<text>")
...
completedAt = 1234L,
            ...
            Console.WriteLine(result.GetProperty("runInputs").GetProperty("truncationStrategy").GetProperty("type").ToString());
            Console.WriteLine(result.GetProperty("runInputs").GetProperty("truncationStrategy").GetProperty("lastMessages").ToString());
...
completedAt = 1234L,
        ...
        public void Example_Agents_Run_AllParameters_Convenience()
        {
            ...
            ToolChoiceBehavior toolChoice = new AutoToolChoiceBehavior(new string[] { "<toolNames>" });
            TruncationStrategy truncationStrategy = new TruncationStrategy(TruncationStrategyType.Auto)
            {
                LastMessages = 1234,
            };
            Response<Run> response = client.Run(new ChatMessage[]
...
CompletedAt = 1234L,
            ...
            }, agentModel: agentModel, instructions: new DeveloperMessage[]
            {
new DeveloperMessage(new AIContent[]
{
new TextContent("<text>")
...
Parameters = default,
            ...
            }, toolChoice: toolChoice, agentId: "<agentId>", threadId: "<threadId>", metadata: new Dictionary<string, string>
            {
                ["key"] = "<metadata>"
            }, truncationStrategy: truncationStrategy, userId: "<userId>");
        }
