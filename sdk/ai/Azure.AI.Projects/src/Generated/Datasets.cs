...
namespace Azure.AI.Projects
{
    ...
    public partial class Datasets
    {
        ...
        public virtual AsyncPageable<DatasetVersion> GetDatasetVersionsAsync(int? maxCount = null, string skip = null, string tags = null, ListViewType? listViewType = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
        ...
        public virtual Pageable<DatasetVersion> GetDatasetVersions(int? maxCount = null, string skip = null, string tags = null, ListViewType? listViewType = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetDatasetVersionsRequest(maxCount, skip, tags, listViewType?.ToString(), context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetDatasetVersionsNextPageRequest(nextLink, maxCount, skip, tags, listViewType?.ToString(), context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetDatasetVersionsAsync(int?,string,string,ListViewType?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual AsyncPageable<BinaryData> GetDatasetVersionsAsync(int? maxCount, string skip, string tags, string listViewType, RequestContext context)
        {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetDatasetVersions(int?,string,string,ListViewType?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual Pageable<BinaryData> GetDatasetVersions(int? maxCount, string skip, string tags, string listViewType, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetDatasetVersionsRequest(maxCount, skip, tags, listViewType, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetDatasetVersionsNextPageRequest(nextLink, maxCount, skip, tags, listViewType, context);
        ...
        internal HttpMessage CreateGetDatasetVersionsRequest(int? maxCount, string skip, string tags, string listViewType, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateGetDatasetVersionsNextPageRequest(string nextLink, int? maxCount, string skip, string tags, string listViewType, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
