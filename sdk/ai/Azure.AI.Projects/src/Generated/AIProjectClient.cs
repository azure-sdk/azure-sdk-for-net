...
namespace Azure.AI.Projects
{
    ...
    public partial class AIProjectClient
    {
        ...
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
        public virtual Diagnostics GetDiagnosticsClient(string apiVersion = "2024-07-01-preview")
        {
            Argument.AssertNotNull(apiVersion, nameof(apiVersion));

            return new Diagnostics(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, _subscriptionId, _resourceGroupName, _projectName, apiVersion);
        }
