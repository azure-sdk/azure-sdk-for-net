...
namespace Azure.AI.Projects
{
    ...
    public partial class IncompleteRunDetails
    {
        ...
        /// <param name="reason"> he reason why the run is incomplete. This indicates which specific token limit was reached during the run. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="reason"/> is null. </exception>
        internal IncompleteRunDetails(string reason)
        {
        ...
        internal IncompleteRunDetails(string reason, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Reason = reason;
        ...
        /// <summary> he reason why the run is incomplete. This indicates which specific token limit was reached during the run. </summary>
