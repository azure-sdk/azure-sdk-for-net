...
namespace Azure.AI.Projects
{
    ...
    internal partial class GetConnectionResponse
    {
        ...
        internal GetConnectionResponse(string id, string name, ConnectionProperties properties)
        {
        ...
        internal GetConnectionResponse(string id, string name, ConnectionProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Properties = properties;
