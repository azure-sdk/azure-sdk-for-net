...
namespace Azure.AI.Projects
{
    ...
    public partial class RunStepFileSearchToolCall : RunStepToolCall
    {
        ...
        internal RunStepFileSearchToolCall(string id, IEnumerable<RunStepFileSearchToolCallResults> fileSearch) : base(id)
        {
        ...
        /// <param name="fileSearch"> The results of the file search. </param>
        internal RunStepFileSearchToolCall(string type, string id, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<RunStepFileSearchToolCallResults> fileSearch) : base(type, id, serializedAdditionalRawData)
        {
        ...
        public IReadOnlyList<RunStepFileSearchToolCallResults> FileSearch { get; }
    }
}
