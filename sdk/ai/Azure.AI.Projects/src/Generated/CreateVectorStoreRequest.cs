...
namespace Azure.AI.Projects
{
    ...
    internal partial class CreateVectorStoreRequest
    {
        ...
        internal CreateVectorStoreRequest(IReadOnlyList<string> fileIds, string name, VectorStorageConfiguration storeConfiguration, VectorStoreExpirationPolicy expiresAfter, VectorStoreChunkingStrategyRequest chunkingStrategy, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
            Name = name;
        ...
        /// <summary> The vector store configuration, used when vector store is created from Azure asset ID. </summary>
        public VectorStorageConfiguration StoreConfiguration { get; }
