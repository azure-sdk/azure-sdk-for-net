...
namespace Azure.AI.Projects
{
    ...
    public partial class Indexes
    {
        ...
        public virtual AsyncPageable<Index> GetIndicesAsync(int? maxCount = null, string skip = null, string tags = null, ListViewType? listViewType = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
        ...
        public virtual Pageable<Index> GetIndices(int? maxCount = null, string skip = null, string tags = null, ListViewType? listViewType = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetIndicesRequest(maxCount, skip, tags, listViewType?.ToString(), context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetIndicesNextPageRequest(nextLink, maxCount, skip, tags, listViewType?.ToString(), context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetIndicesAsync(int?,string,string,ListViewType?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual AsyncPageable<BinaryData> GetIndicesAsync(int? maxCount, string skip, string tags, string listViewType, RequestContext context)
        {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetIndices(int?,string,string,ListViewType?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual Pageable<BinaryData> GetIndices(int? maxCount, string skip, string tags, string listViewType, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetIndicesRequest(maxCount, skip, tags, listViewType, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetIndicesNextPageRequest(nextLink, maxCount, skip, tags, listViewType, context);
        ...
        internal HttpMessage CreateGetIndicesRequest(int? maxCount, string skip, string tags, string listViewType, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateGetIndicesNextPageRequest(string nextLink, int? maxCount, string skip, string tags, string listViewType, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
