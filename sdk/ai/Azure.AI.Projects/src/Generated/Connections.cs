...
namespace Azure.AI.Projects
{
    ...
    public partial class Connections
    {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("Connections.GetWorkspace");
            scope.Start();
            try
            {
        ...
        internal virtual async Task<Response> GetConnectionWithSecretsAsync(string connectionName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Connections.GetConnectionWithSecrets");
            scope.Start();
            try
            {
