...
namespace Azure.AI.Projects
{
    ...
    public partial class ConnectionsClient
    {
        ...
        internal ConnectionsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetWithCredentialsAsync(string,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetWithCredentials(string,CancellationToken)']/*" />
        ...
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetWithCredentialsAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> GetWithCredentialsAsync(string name, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));

            using var scope = ClientDiagnostics.CreateScope("ConnectionsClient.GetWithCredentials");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetWithCredentials(string,RequestContext)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetConnectionsAsync(ConnectionType?,bool?,int?,int?,int?,CancellationToken)']/*" />
        public virtual AsyncPageable<Connection> GetConnectionsAsync(ConnectionType? connectionType = null, bool? defaultConnection = null, int? maxCount = null, int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Connection.DeserializeConnection(e), ClientDiagnostics, _pipeline, "ConnectionsClient.GetConnections", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <param name="maxpagesize"> The maximum number of result items per page. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetConnections(ConnectionType?,bool?,int?,int?,int?,CancellationToken)']/*" />
        public virtual Pageable<Connection> GetConnections(ConnectionType? connectionType = null, bool? defaultConnection = null, int? maxCount = null, int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConnectionsRequest(connectionType?.ToString(), defaultConnection, maxCount, skip, pageSizeHint, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConnectionsNextPageRequest(nextLink, connectionType?.ToString(), defaultConnection, maxCount, skip, pageSizeHint, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Connection.DeserializeConnection(e), ClientDiagnostics, _pipeline, "ConnectionsClient.GetConnections", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetConnectionsAsync(string,bool?,int?,int?,int?,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetConnectionsAsync(string connectionType, bool? defaultConnection, int? maxCount, int? skip, int? maxpagesize, RequestContext context)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ConnectionsClient.GetConnections", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetConnections(string,bool?,int?,int?,int?,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetConnections(string connectionType, bool? defaultConnection, int? maxCount, int? skip, int? maxpagesize, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConnectionsRequest(connectionType, defaultConnection, maxCount, skip, pageSizeHint, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConnectionsNextPageRequest(nextLink, connectionType, defaultConnection, maxCount, skip, pageSizeHint, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ConnectionsClient.GetConnections", "value", "nextLink", maxpagesize, context);
        }
