...
namespace Azure.AI.Projects
{
    ...
    public partial class ConnectionsClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetConnectionsAsync(ConnectionType?,bool?,CancellationToken)']/*" />
        public virtual AsyncPageable<Connection> GetConnectionsAsync(ConnectionType? connectionType = null, bool? defaultConnection = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Connection.DeserializeConnection(e), ClientDiagnostics, _pipeline, "ConnectionsClient.GetConnections", "value", "nextLink", context);
        }
        ...
        /// <param name="defaultConnection"> List connections that are default connections. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetConnections(ConnectionType?,bool?,CancellationToken)']/*" />
        public virtual Pageable<Connection> GetConnections(ConnectionType? connectionType = null, bool? defaultConnection = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConnectionsRequest(connectionType?.ToString(), defaultConnection, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConnectionsNextPageRequest(nextLink, connectionType?.ToString(), defaultConnection, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Connection.DeserializeConnection(e), ClientDiagnostics, _pipeline, "ConnectionsClient.GetConnections", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetConnectionsAsync(string,bool?,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetConnectionsAsync(string connectionType, bool? defaultConnection, RequestContext context)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ConnectionsClient.GetConnections", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/ConnectionsClient.xml" path="doc/members/member[@name='GetConnections(string,bool?,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetConnections(string connectionType, bool? defaultConnection, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConnectionsRequest(connectionType, defaultConnection, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConnectionsNextPageRequest(nextLink, connectionType, defaultConnection, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ConnectionsClient.GetConnections", "value", "nextLink", context);
        }
