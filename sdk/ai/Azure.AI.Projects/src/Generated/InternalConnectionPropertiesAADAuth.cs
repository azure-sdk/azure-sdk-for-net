...
namespace Azure.AI.Projects
{
    ...
    internal partial class InternalConnectionPropertiesAADAuth : InternalConnectionProperties
    {
        ...
        internal InternalConnectionPropertiesAADAuth(ConnectionType category, string target)
        {
        ...
        /// <param name="category"> Category of the connection. </param>
        /// <param name="target"> The connection URL to be used for this service. </param>
        internal InternalConnectionPropertiesAADAuth(AuthenticationType authType, IDictionary<string, BinaryData> serializedAdditionalRawData, ConnectionType category, string target) : base(authType, serializedAdditionalRawData)
        {
            Category = category;
            Target = target;
        }
