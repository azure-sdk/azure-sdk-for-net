...
namespace Azure.AI.Projects
{
    ...
    public partial class RunStepFileSearchToolCallResults
    {
        ...
        internal RunStepFileSearchToolCallResults(string fileId, string fileName, float score)
        {
        ...
        internal RunStepFileSearchToolCallResults(string fileId, string fileName, float score, IReadOnlyList<FileSearchToolCallContent> content, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileId = fileId;
            FileName = fileName;
            Score = score;
