...
namespace Azure.AI.Projects
{
    ...
    public partial class Diagnostics
    {
        ...
        public virtual async Task<Response<GetAppInsightsResponse>> GetAppInsightsAsync(string appInsightsResourceUrl, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="appInsightsResourceUrl"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="appInsightsResourceUrl"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<GetAppInsightsResponse> GetAppInsights(string appInsightsResourceUrl, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(appInsightsResourceUrl, nameof(appInsightsResourceUrl));
        ...
        public virtual async Task<Response> GetAppInsightsAsync(string appInsightsResourceUrl, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(appInsightsResourceUrl, nameof(appInsightsResourceUrl));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual Response GetAppInsights(string appInsightsResourceUrl, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(appInsightsResourceUrl, nameof(appInsightsResourceUrl));
