...
namespace Azure.AI.Projects
{
    ...
    /// <summary> The Diagnostics sub-client. </summary>
    public partial class Diagnostics
    {
        ...
        internal Diagnostics(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string subscriptionId, string resourceGroupName, string projectName, string apiVersion)
        {
        ...
        /// <param name="resourceName"> The AppInsights Azure resource Name. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<GetAppInsightsResponse>> GetAppInsightsAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetAppInsightsAsync(resourceName, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<GetAppInsightsResponse> GetAppInsights(string resourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = GetAppInsights(resourceName, context);
            return Response.FromValue(GetAppInsightsResponse.FromResponse(response), response);
        }
        ...
        public virtual async Task<Response> GetAppInsightsAsync(string resourceName, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));

            using var scope = ClientDiagnostics.CreateScope("Diagnostics.GetAppInsights");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetAppInsightsRequest(resourceName, context);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual Response GetAppInsights(string resourceName, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));
        ...
        internal HttpMessage CreateGetAppInsightsRequest(string resourceName, RequestContext context)
        {
