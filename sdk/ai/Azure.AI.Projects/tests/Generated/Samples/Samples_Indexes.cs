...
namespace Azure.AI.Projects.Samples
{
    public partial class Samples_Indexes
    {
        ...
        public void Example_Index_GetIndices_ShortVersion()
        {
            ...
            foreach (BinaryData item in client.GetIndices(null, null, null, null, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("type").ToString());
                Console.WriteLine(result.GetProperty("name").ToString());
        ...
        public async Task Example_Index_GetIndices_ShortVersion_Async()
        {
            ...
            await foreach (BinaryData item in client.GetIndicesAsync(null, null, null, null, null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("type").ToString());
                Console.WriteLine(result.GetProperty("name").ToString());
        ...
        public void Example_Index_GetIndices_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetIndices(1234, "<skip>", "<tags>", "ActiveOnly", null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("type").ToString());
                Console.WriteLine(result.GetProperty("stage").ToString());
        ...
        public async Task Example_Index_GetIndices_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetIndicesAsync(1234, "<skip>", "<tags>", "ActiveOnly", null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("type").ToString());
                Console.WriteLine(result.GetProperty("stage").ToString());
        ...
        public void Example_Index_GetIndices_AllParameters_Convenience()
        {
            ...
            foreach (Index item in client.GetIndices(maxCount: 1234, skip: "<skip>", tags: "<tags>", listViewType: ListViewType.ActiveOnly))
            {
            }
        }
        ...
        public async Task Example_Index_GetIndices_AllParameters_Convenience_Async()
        {
            ...
            await foreach (Index item in client.GetIndicesAsync(maxCount: 1234, skip: "<skip>", tags: "<tags>", listViewType: ListViewType.ActiveOnly))
            {
            }
        }
    }
