...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class PersistentAgentsAdministrationClient
    {
        ...
        {
            return Volatile.Read(ref _cachedMessages) ?? Interlocked.CompareExchange(ref _cachedMessages, new Messages(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, _apiVersion), null) ?? _cachedMessages;
        }

        /// <summary> Initializes a new instance of Runs. </summary>
        public virtual Runs GetRunsClient()
        {
            return Volatile.Read(ref _cachedRuns) ?? Interlocked.CompareExchange(ref _cachedRuns, new Runs(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, _apiVersion), null) ?? _cachedRuns;
        }

        /// <summary> Initializes a new instance of RunSteps. </summary>
        public virtual RunSteps GetRunStepsClient()
        {
            return Volatile.Read(ref _cachedRunSteps) ?? Interlocked.CompareExchange(ref _cachedRunSteps, new RunSteps(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, _apiVersion), null) ?? _cachedRunSteps;
        }

        /// <summary> Initializes a new instance of Files. </summary>
        public virtual Files GetFilesClient()
        {
            return Volatile.Read(ref _cachedFiles) ?? Interlocked.CompareExchange(ref _cachedFiles, new Files(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, _apiVersion), null) ?? _cachedFiles;
        }
