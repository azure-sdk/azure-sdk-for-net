...
namespace Azure.AI.Agents.Persistent
{
    ...
    /// <summary> The Administration service client. </summary>
    public partial class AdministrationClient
    {
        ...
        /// <summary> Initializes a new instance of AdministrationClient for mocking. </summary>
        protected AdministrationClient()
        {
        }

        /// <summary> Initializes a new instance of AdministrationClient. </summary>
        ...
        public AdministrationClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new AdministrationClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AdministrationClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new AdministrationClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AdministrationClient(Uri endpoint, AzureKeyCredential credential, AdministrationClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new AdministrationClientOptions();
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AdministrationClient(Uri endpoint, TokenCredential credential, AdministrationClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new AdministrationClientOptions();
        ...
        public virtual async Task<Response> CreateAgentAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AdministrationClient.CreateAgent");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("AdministrationClient.InternalGetAgents");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetAgentAsync(string assistantId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AdministrationClient.GetAgent");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> UpdateAgentAsync(string assistantId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AdministrationClient.UpdateAgent");
            scope.Start();
            try
            {
        ...
        internal virtual async Task<Response> InternalDeleteAgentAsync(string assistantId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AdministrationClient.InternalDeleteAgent");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> CreateThreadAndRunAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AdministrationClient.CreateThreadAndRun");
            scope.Start();
            try
            {
