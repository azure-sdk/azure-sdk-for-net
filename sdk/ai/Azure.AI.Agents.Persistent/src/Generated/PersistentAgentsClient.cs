...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class PersistentAgentsClient
    {
        ...
        private RunsClientY _cachedRunsClientY;
        ...
        public virtual RunsClientY GetRunsClientYClient()
        {
            return Volatile.Read(ref _cachedRunsClientY) ?? Interlocked.CompareExchange(ref _cachedRunsClientY, new RunsClientY(ClientDiagnostics, _pipeline, _keyCredential, _tokenCredential, _endpoint, _apiVersion), null) ?? _cachedRunsClientY;
        }
