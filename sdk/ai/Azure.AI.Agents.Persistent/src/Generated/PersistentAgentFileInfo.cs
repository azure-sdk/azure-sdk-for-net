...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class PersistentAgentFileInfo
    {
        ...
        internal PersistentAgentFileInfo(PersistentAgentFileInfoObject @object, string id, int size, string filename, DateTimeOffset createdAt, PersistentAgentFilePurpose purpose, FileState? status, string statusDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Id = id;
            Size = size;
        ...
        public PersistentAgentFileInfoObject Object { get; } = PersistentAgentFileInfoObject.File;
