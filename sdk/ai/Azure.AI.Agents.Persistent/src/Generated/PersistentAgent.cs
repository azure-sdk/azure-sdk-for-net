...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class PersistentAgent
    {
        ...
        internal PersistentAgent(string id, PersistentAgentObject @object, DateTimeOffset createdAt, string name, string description, string model, string instructions, IReadOnlyList<ToolDefinition> tools, ToolResources toolResources, float? temperature, float? topP, BinaryData responseFormat, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            CreatedAt = createdAt;
        ...
        public PersistentAgentObject Object { get; } = PersistentAgentObject.Assistant;
