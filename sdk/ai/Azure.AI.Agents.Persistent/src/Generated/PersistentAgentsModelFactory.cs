...
namespace Azure.AI.Agents.Persistent
{
    ...
    public static partial class PersistentAgentsModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Persistent.PersistentThreadMessage"/>. </summary>
        ...
        /// The available derived classes include <see cref="Persistent.MessageImageFileContent"/> and <see cref="Persistent.MessageTextContent"/>.
        /// </param>
        ...
        public static PersistentThreadMessage PersistentThreadMessage(string id = null, PersistentThreadMessageObject @object = default, DateTimeOffset createdAt = default, string threadId = null, MessageStatus status = default, MessageIncompleteDetails incompleteDetails = null, DateTimeOffset? completedAt = null, DateTimeOffset? incompleteAt = null, MessageRole role = default, IEnumerable<MessageContent> contentItems = null, string assistantId = null, string runId = null, IEnumerable<MessageAttachment> attachments = null, IReadOnlyDictionary<string, string> metadata = null)
        {
