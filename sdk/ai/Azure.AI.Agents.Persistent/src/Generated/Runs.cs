...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class Runs
    {
        ...
        internal Runs(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> SubmitToolOutputsToRunAsync(string threadId, string runId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Runs.SubmitToolOutputsToRun");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ThreadRun> GetRunsAsync(string threadId, int? limit = null, ListSortOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRunsRequest(threadId, limit, order?.ToString(), after, before, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => ThreadRun.DeserializeThreadRun(e), ClientDiagnostics, _pipeline, "Runs.GetRuns", "data", null, context);
        }
        ...
        public virtual Pageable<ThreadRun> GetRuns(string threadId, int? limit = null, ListSortOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRunsRequest(threadId, limit, order?.ToString(), after, before, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => ThreadRun.DeserializeThreadRun(e), ClientDiagnostics, _pipeline, "Runs.GetRuns", "data", null, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetRunsAsync(string threadId, int? limit, string order, string after, string before, RequestContext context)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Runs.GetRuns", "data", null, context);
        }
        ...
        public virtual Pageable<BinaryData> GetRuns(string threadId, int? limit, string order, string after, string before, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetRunsRequest(threadId, limit, order, after, before, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Runs.GetRuns", "data", null, context);
        }
