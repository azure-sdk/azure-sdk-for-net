...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class Threads
    {
        ...
        public virtual AsyncPageable<PersistentAgentThread> GetThreadsAsync(int? limit = null, ListSortOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => PersistentAgentThread.DeserializePersistentAgentThread(e), ClientDiagnostics, _pipeline, "Threads.GetThreads", "data", null, context);
        }
        ...
        public virtual Pageable<PersistentAgentThread> GetThreads(int? limit = null, ListSortOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetThreadsRequest(limit, order?.ToString(), after, before, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => PersistentAgentThread.DeserializePersistentAgentThread(e), ClientDiagnostics, _pipeline, "Threads.GetThreads", "data", null, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetThreadsAsync(int? limit, string order, string after, string before, RequestContext context)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Threads.GetThreads", "data", null, context);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetThreadsRequest(limit, order, after, before, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Threads.GetThreads", "data", null, context);
        }
