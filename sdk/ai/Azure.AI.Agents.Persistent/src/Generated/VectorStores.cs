...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class VectorStores
    {
        ...
        public virtual AsyncPageable<VectorStore> GetVectorStoresAsync(int? limit = null, ListSortOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => VectorStore.DeserializeVectorStore(e), ClientDiagnostics, _pipeline, "VectorStores.GetVectorStores", "data", null, context);
        }
        ...
        public virtual Pageable<VectorStore> GetVectorStores(int? limit = null, ListSortOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetVectorStoresRequest(limit, order?.ToString(), after, before, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => VectorStore.DeserializeVectorStore(e), ClientDiagnostics, _pipeline, "VectorStores.GetVectorStores", "data", null, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetVectorStoresAsync(int? limit, string order, string after, string before, RequestContext context)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "VectorStores.GetVectorStores", "data", null, context);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetVectorStoresRequest(limit, order, after, before, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "VectorStores.GetVectorStores", "data", null, context);
        }
