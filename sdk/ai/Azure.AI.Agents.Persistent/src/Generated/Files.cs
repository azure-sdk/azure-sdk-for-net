...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class Files
    {
        ...
        internal Files(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response<PersistentAgentFileInfo>> UploadFileAsync(UploadFileRequest body, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual Response<PersistentAgentFileInfo> UploadFile(UploadFileRequest body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
