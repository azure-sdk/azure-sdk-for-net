...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class RunsClientY
    {
        ...
        /// <summary> Initializes a new instance of RunsClientY for mocking. </summary>
        protected RunsClientY()
        {
        }

        /// <summary> Initializes a new instance of RunsClientY. </summary>
        ...
        internal RunsClientY(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> CreateRunAsync(string threadId, RequestContent content, IEnumerable<RunAdditionalFieldList> include = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClientY.CreateRun");
            scope.Start();
            try
            {
        ...
        internal virtual async Task<Response> InternalGetRunsAsync(string threadId, int? limit, string order, string after, string before, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClientY.InternalGetRuns");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetRunAsync(string threadId, string runId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClientY.GetRun");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> UpdateRunAsync(string threadId, string runId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClientY.UpdateRun");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> SubmitToolOutputsAsync(string threadId, string runId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClientY.SubmitToolOutputs");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> CancelRunAsync(string threadId, string runId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClientY.CancelRun");
            scope.Start();
            try
            {
