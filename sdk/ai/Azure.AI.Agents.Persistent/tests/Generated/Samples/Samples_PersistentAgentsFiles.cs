...
namespace Azure.AI.Agents.Persistent.Samples
{
    public partial class Samples_PersistentAgentsFiles
    {
        ...
        public void Example_Files_UploadFile_FilesUploadFileMaximumSet()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            PersistentAgentsFiles client = new PersistentAgentsAdministration(endpoint, credential).GetPersistentAgentsFilesClient();
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Files_UploadFile_FilesUploadFileMaximumSet_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            PersistentAgentsFiles client = new PersistentAgentsAdministration(endpoint, credential).GetPersistentAgentsFilesClient();
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Files_UploadFile_FilesUploadFileMaximumSet_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            PersistentAgentsFiles client = new PersistentAgentsAdministration(endpoint, credential).GetPersistentAgentsFilesClient();

            UploadFileRequest body = null;
            Response<PersistentAgentFileInfo> response = client.UploadFile(body);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Files_UploadFile_FilesUploadFileMaximumSet_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            PersistentAgentsFiles client = new PersistentAgentsAdministration(endpoint, credential).GetPersistentAgentsFilesClient();
            ...
            UploadFileRequest body = null;
            Response<PersistentAgentFileInfo> response = await client.UploadFileAsync(body);
        }
