...
{
    public partial class Samples_PersistentAgentsAdministration
    {
        [Test]
        ...
        public void Example_Agents_CreateAgent_CreateAgentMaximumSet()
        {
            ...
            PersistentAgentsAdministration client = new PersistentAgentsAdministration(endpoint, credential);
...
index_asset_id = "iwfmzmxzh",
        ...
        public void Example_Agents_GetAgent_GetAgentMaximumSet()
        {
            ...
            Response response = client.GetAgent("rzrtnsfncjtctybnxemiugavvf", null);
        ...
        public async Task Example_Agents_GetAgent_GetAgentMaximumSet_Async()
        {
            ...
            Response response = await client.GetAgentAsync("rzrtnsfncjtctybnxemiugavvf", null);
