...
namespace Azure.AI.Agents.Persistent.Samples
{
    public partial class Samples_ThreadRuns
    {
        ...
        public void Example_Runs_CreateRun_RunsCreateRunMaximumSet()
        {
            ...
            {
                assistant_id = "akgzhhlrjauolzlugfhaglvlk",
                model = "viswuoavpi",
                instructions = "czqhiwewiytmblwbxxbeqgnxdjsc",
                additional_instructions = "rzofcolleybbxcnvihxclvb",
...
key4143 = "ysgghfrexpy",
                ...
                metadata = new
                {
                    key9887 = "gtafqmpnjzdgqg",
                },
            });
            Response response = client.CreateRun("ltfkuamvmkfuqbgxwnqtiprepavn", content);
...
key4143 = "ysgghfrexpy",
            ...
            Response response = await client.CreateRunAsync("ltfkuamvmkfuqbgxwnqtiprepavn", content);
        ...
        public void Example_Runs_CreateRun_RunsCreateRunMaximumSet_Convenience()
        {
            ...
            Response<ThreadRun> response = client.CreateRun("ltfkuamvmkfuqbgxwnqtiprepavn", "akgzhhlrjauolzlugfhaglvlk");
        }
        ...
        public async Task Example_Runs_CreateRun_RunsCreateRunMaximumSet_Convenience_Async()
        {
            ...
            Response<ThreadRun> response = await client.CreateRunAsync("ltfkuamvmkfuqbgxwnqtiprepavn", "akgzhhlrjauolzlugfhaglvlk");
        }
        ...
        public void Example_Runs_GetRun_RunsGetRunMaximumSet()
        {
            ...
            Response response = client.GetRun("ahhtmbrcqhaprwmajbpvmoyuxtoato", "gjoxsotqdszzbvoew", null);
        ...
        public async Task Example_Runs_GetRun_RunsGetRunMaximumSet_Async()
        {
            ...
            Response response = await client.GetRunAsync("ahhtmbrcqhaprwmajbpvmoyuxtoato", "gjoxsotqdszzbvoew", null);
        ...
        public void Example_Runs_GetRun_RunsGetRunMaximumSet_Convenience()
        {
            ...
            Response<ThreadRun> response = client.GetRun("ahhtmbrcqhaprwmajbpvmoyuxtoato", "gjoxsotqdszzbvoew");
        }
        ...
        public async Task Example_Runs_GetRun_RunsGetRunMaximumSet_Convenience_Async()
        {
            ...
            Response<ThreadRun> response = await client.GetRunAsync("ahhtmbrcqhaprwmajbpvmoyuxtoato", "gjoxsotqdszzbvoew");
        }
        ...
        public void Example_Runs_UpdateRun_RunsUpdateRunMaximumSet()
        {
            ...
            using RequestContent content = RequestContent.Create(new
            {
                metadata = new
                {
                    key3291 = "rqicsxebmniswhmluraxvilvgh",
                },
            });
            Response response = client.UpdateRun("at", "ejzmcjnjmjgaxvrjrr", content);
        ...
        public async Task Example_Runs_UpdateRun_RunsUpdateRunMaximumSet_Async()
        {
            ...
            Response response = await client.UpdateRunAsync("at", "ejzmcjnjmjgaxvrjrr", content);
        ...
        public void Example_Runs_UpdateRun_RunsUpdateRunMaximumSet_Convenience()
        {
            ...
            Response<ThreadRun> response = client.UpdateRun("at", "ejzmcjnjmjgaxvrjrr");
        }
        ...
        public async Task Example_Runs_UpdateRun_RunsUpdateRunMaximumSet_Convenience_Async()
        {
            ...
            Response<ThreadRun> response = await client.UpdateRunAsync("at", "ejzmcjnjmjgaxvrjrr");
        }
...
new
{
tool_call_id = "ercvmsfnm",
output = "neeh",
}
            },
                stream = true,
            });
            Response response = client.SubmitToolOutputsToRun("tbxcgksbqpbgrwdrmxblvon", "psygq", content);
...
output = "neeh",
            ...
            Response response = await client.SubmitToolOutputsToRunAsync("tbxcgksbqpbgrwdrmxblvon", "psygq", content);
        ...
        public void Example_Runs_SubmitToolOutputsToRun_RunsSubmitToolOutputsToRunMaximumSet_Convenience()
        {
            ...
            Response<ThreadRun> response = client.SubmitToolOutputsToRun("tbxcgksbqpbgrwdrmxblvon", "psygq", new ToolOutput[]
            {
new ToolOutput
{
ToolCallId = "ercvmsfnm",
Output = "neeh",
}
            });
        }
        ...
        public async Task Example_Runs_SubmitToolOutputsToRun_RunsSubmitToolOutputsToRunMaximumSet_Convenience_Async()
        {
            ...
            Response<ThreadRun> response = await client.SubmitToolOutputsToRunAsync("tbxcgksbqpbgrwdrmxblvon", "psygq", new ToolOutput[]
            {
new ToolOutput
{
ToolCallId = "ercvmsfnm",
Output = "neeh",
        ...
        public void Example_Runs_CancelRun_RunsCancelRunMaximumSet()
        {
            ...
            Response response = client.CancelRun("hoijbwzesdpafiymwshr", "dlhwwpyyoykguvkhmfm", null);
        ...
        public async Task Example_Runs_CancelRun_RunsCancelRunMaximumSet_Async()
        {
            ...
            Response response = await client.CancelRunAsync("hoijbwzesdpafiymwshr", "dlhwwpyyoykguvkhmfm", null);
        ...
        public void Example_Runs_CancelRun_RunsCancelRunMaximumSet_Convenience()
        {
            ...
            Response<ThreadRun> response = client.CancelRun("hoijbwzesdpafiymwshr", "dlhwwpyyoykguvkhmfm");
        }
        ...
        public async Task Example_Runs_CancelRun_RunsCancelRunMaximumSet_Convenience_Async()
        {
            ...
            Response<ThreadRun> response = await client.CancelRunAsync("hoijbwzesdpafiymwshr", "dlhwwpyyoykguvkhmfm");
        }
        ...
        public void Example_Runs_GetRuns_RunsListRunsMaximumSet()
        {
            ...
            foreach (BinaryData item in client.GetRuns("cvzeyrauc", 16, "asc", "olshlwmtludxnvqemmblugnvqt", "hasjcoqlryhrmdpaanoiklciwdrlwm", (RequestContext)null))
            {
        ...
        public async Task Example_Runs_GetRuns_RunsListRunsMaximumSet_Async()
        {
            ...
            await foreach (BinaryData item in client.GetRunsAsync("cvzeyrauc", 16, "asc", "olshlwmtludxnvqemmblugnvqt", "hasjcoqlryhrmdpaanoiklciwdrlwm", (RequestContext)null))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("id").ToString());
                Console.WriteLine(result.GetProperty("object").ToString());
        ...
        public void Example_Runs_GetRuns_RunsListRunsMaximumSet_Convenience()
        {
            ...
            foreach (ThreadRun item in client.GetRuns("cvzeyrauc"))
            {
            }
        }
        ...
        public async Task Example_Runs_GetRuns_RunsListRunsMaximumSet_Convenience_Async()
        {
            ...
            await foreach (ThreadRun item in client.GetRunsAsync("cvzeyrauc"))
            {
            }
        }
    }
