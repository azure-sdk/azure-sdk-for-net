...
namespace Azure.AI.Client
{
    ...
    internal partial class OpenAIPageableListOfRunStep
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfRunStep"/>. </summary>
        ...
        internal OpenAIPageableListOfRunStep(IEnumerable<RunStep> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal OpenAIPageableListOfRunStep(OpenAIPageableListOfRunStepObject @object, IReadOnlyList<RunStep> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfRunStep"/> for deserialization. </summary>
        internal OpenAIPageableListOfRunStep()
        {
        }
