...
namespace Azure.AI.Client
{
    ...
    internal partial class CreateVectorStoreFileRequest
    {
        ...
        internal CreateVectorStoreFileRequest(string fileId, IReadOnlyList<VectorStorageDataSource> dataSources, VectorStoreChunkingStrategyRequest chunkingStrategy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileId = fileId;
