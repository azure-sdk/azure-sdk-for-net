...
namespace Azure.AI.Client
{
    ...
    internal partial class OpenAIPageableListOfThreadMessage
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfThreadMessage"/>. </summary>
        ...
        internal OpenAIPageableListOfThreadMessage(IEnumerable<ThreadMessage> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal OpenAIPageableListOfThreadMessage(OpenAIPageableListOfThreadMessageObject @object, IReadOnlyList<ThreadMessage> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfThreadMessage"/> for deserialization. </summary>
        internal OpenAIPageableListOfThreadMessage()
        {
        }
