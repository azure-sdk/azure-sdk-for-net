...
namespace Azure.AI.Client
{
    ...
    public partial class AppInsightsConfiguration : InputData
    {
        ...
        /// <param name="query"> Query to fetch the data. </param>
        /// <param name="serviceName"> Service name. </param>
        /// <param name="connectionString"> Connection String to connect to AppInsights. </param>
        internal AppInsightsConfiguration(string type, IDictionary<string, BinaryData> serializedAdditionalRawData, string resourceId, string query, string serviceName, string connectionString) : base(type, serializedAdditionalRawData)
        {
            ResourceId = resourceId;
            Query = query;
            ServiceName = serviceName;
        ...
        /// <summary> Connection String to connect to AppInsights. </summary>
