...
namespace Azure.AI.Client
{
    ...
    public partial class Connections
    {
        ...
        internal Connections(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string subscriptionId, string resourceGroupName, string projectName, string apiVersion)
        {
        ...
        /// <param name="includeAll"> Indicates whether to list datastores. Service default: do not lines datastores. </param>
        /// <param name="target"> Target of the workspace connection. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="target"/> is null. </exception>
        internal virtual async Task<Response<ConnectionsListResponse>> GetConnectionsAsync(ConnectionType category, bool includeAll, string target, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="target"/> is null. </exception>
        internal virtual Response<ConnectionsListResponse> GetConnections(ConnectionType category, bool includeAll, string target, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(target, nameof(target));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="category"/> or <paramref name="target"/> is null. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        internal virtual async Task<Response> GetConnectionsAsync(string category, bool includeAll, string target, RequestContext context = null)
        {
            Argument.AssertNotNull(category, nameof(category));
            Argument.AssertNotNull(target, nameof(target));

            using var scope = ClientDiagnostics.CreateScope("Connections.GetConnections");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        internal virtual Response GetConnections(string category, bool includeAll, string target, RequestContext context = null)
        {
            Argument.AssertNotNull(category, nameof(category));
            Argument.AssertNotNull(target, nameof(target));
        ...
        /// <param name="ignored"> The body is ignored. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionNameInUrl"/> or <paramref name="ignored"/> is null. </exception>
        ...
        internal virtual async Task<Response<ConnectionsListSecretsResponse>> GetSecretsAsync(string connectionNameInUrl, string ignored, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="connectionNameInUrl"/> or <paramref name="ignored"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="connectionNameInUrl"/> is an empty string, and was expected to be non-empty. </exception>
        internal virtual Response<ConnectionsListSecretsResponse> GetSecrets(string connectionNameInUrl, string ignored, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(connectionNameInUrl, nameof(connectionNameInUrl));
            Argument.AssertNotNull(ignored, nameof(ignored));
        ...
        internal virtual async Task<Response> GetSecretsAsync(string connectionNameInUrl, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Connections.GetSecrets");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateGetConnectionsRequest(string category, bool includeAll, string target, RequestContext context)
        {
            ...
            uri.AppendQuery("includeAll", includeAll, true);
