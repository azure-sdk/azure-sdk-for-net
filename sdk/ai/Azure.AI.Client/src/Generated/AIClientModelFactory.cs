...
namespace Azure.AI.Client.Models
{
    ...
    public static partial class AIClientModelFactory
    {
        ...
        /// The available derived classes include <see cref="Models.RunStepAzureAISearchToolCall"/>, <see cref="Models.RunStepBingSearchToolCall"/>, <see cref="RunStepCodeInterpreterToolCall"/>, <see cref="Models.RunStepFileSearchToolCall"/>, <see cref="RunStepFunctionToolCall"/>, <see cref="Models.RunStepMicrosoftFabricToolCall"/> and <see cref="Models.RunStepSharepointToolCall"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.RunStepBingSearchToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="bingSearch"> Reserved for future use. </param>
        /// <returns> A new <see cref="Models.RunStepBingSearchToolCall"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.RunStepAzureAISearchToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="azureAISearch"> Reserved for future use. </param>
        /// <returns> A new <see cref="Models.RunStepAzureAISearchToolCall"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.RunStepSharepointToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="sharePoint"> Reserved for future use. </param>
        /// <returns> A new <see cref="Models.RunStepSharepointToolCall"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.RunStepMicrosoftFabricToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="microsoftFabric"> Reserved for future use. </param>
        /// <returns> A new <see cref="Models.RunStepMicrosoftFabricToolCall"/> instance for mocking. </returns>
