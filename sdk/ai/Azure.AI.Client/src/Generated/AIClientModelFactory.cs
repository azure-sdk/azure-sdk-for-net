...
namespace Azure.AI.Client
{
    ...
    public static partial class AIClientModelFactory
    {
        ...
        /// <param name="id"> Unique identifier for the evaluation, which also serves as the name for the schedule. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Client.Agent"/>. </summary>
        ...
        /// <returns> A new <see cref="Client.Agent"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Client.AgentThread"/>. </summary>
        /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
        ...
        /// </param>
        /// <param name="metadata"> A set of up to 16 key/value pairs that can be attached to an object, used for storing additional information about that object in a structured format. Keys may be up to 64 characters in length and values may be up to 512 characters in length. </param>
        /// <returns> A new <see cref="Client.AgentThread"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Client.ThreadMessage"/>. </summary>
        /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
        ...
        /// <param name="metadata"> A set of up to 16 key/value pairs that can be attached to an object, used for storing additional information about that object in a structured format. Keys may be up to 64 characters in length and values may be up to 512 characters in length. </param>
        /// <returns> A new <see cref="Client.ThreadMessage"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Client.ThreadRun"/>. </summary>
        /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
        ...
        /// <returns> A new <see cref="Client.ThreadRun"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Client.RunStep"/>. </summary>
        /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
        ...
        /// The available derived classes include <see cref="Client.RunStepMessageCreationDetails"/> and <see cref="Client.RunStepToolCallDetails"/>.
        /// </param>
        ...
        /// <param name="metadata"> A set of up to 16 key/value pairs that can be attached to an object, used for storing additional information about that object in a structured format. Keys may be up to 64 characters in length and values may be up to 512 characters in length. </param>
        /// <returns> A new <see cref="Client.RunStep"/> instance for mocking. </returns>
        ...
        /// The available derived classes include <see cref="Client.RunStepAzureAISearchToolCall"/>, <see cref="Client.RunStepBingGroundingToolCall"/>, <see cref="RunStepCodeInterpreterToolCall"/>, <see cref="Client.RunStepFileSearchToolCall"/>, <see cref="RunStepFunctionToolCall"/>, <see cref="Client.RunStepMicrosoftFabricToolCall"/> and <see cref="Client.RunStepSharepointToolCall"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Client.OpenAIFile"/>. </summary>
        ...
        /// <returns> A new <see cref="Client.OpenAIFile"/> instance for mocking. </returns>
