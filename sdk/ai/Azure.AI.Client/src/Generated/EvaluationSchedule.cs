...
namespace Azure.AI.Client
{
    ...
    public partial class EvaluationSchedule
    {
        ...
        public EvaluationSchedule(AppInsightsConfiguration data, IDictionary<string, EvaluatorConfiguration> evaluators, Trigger trigger, SamplingStrategy samplingStrategy)
        {
        ...
        /// <summary> Unique identifier for the evaluation, which also serves as the name for the schedule. </summary>
        public string Id { get; }
        /// <summary> Data for evaluation. </summary>
        public AppInsightsConfiguration Data { get; set; }
