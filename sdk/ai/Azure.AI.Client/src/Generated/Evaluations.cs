...
namespace Azure.AI.Client
{
    ...
    public partial class Evaluations
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="id"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Evaluations.xml" path="doc/members/member[@name='CreateOrReplaceScheduleAsync(string,EvaluationSchedule,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> or <paramref name="resource"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="id"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Evaluations.xml" path="doc/members/member[@name='CreateOrReplaceSchedule(string,EvaluationSchedule,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Evaluations.xml" path="doc/members/member[@name='CreateOrReplaceScheduleAsync(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Evaluations.xml" path="doc/members/member[@name='CreateOrReplaceSchedule(string,RequestContent,RequestContext)']/*" />
