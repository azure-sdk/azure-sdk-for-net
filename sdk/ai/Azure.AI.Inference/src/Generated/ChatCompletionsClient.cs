...
namespace Azure.AI.Inference
{
    ...
    public partial class ChatCompletionsClient
    {
        ...
        /// <include file="Docs/ChatCompletionsClient.xml" path="doc/members/member[@name='CompleteAsync(IEnumerable{ChatRequestMessage},float?,bool?,float?,float?,float?,int?,ChatCompletionsResponseFormat,IEnumerable{string},IEnumerable{ChatCompletionsToolDefinition},BinaryData,long?,string,ExtraParameters?,CancellationToken)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="messages"/> is null. </exception>
        /// <include file="Docs/ChatCompletionsClient.xml" path="doc/members/member[@name='Complete(IEnumerable{ChatRequestMessage},float?,bool?,float?,float?,float?,int?,ChatCompletionsResponseFormat,IEnumerable{string},IEnumerable{ChatCompletionsToolDefinition},BinaryData,long?,string,ExtraParameters?,CancellationToken)']/*" />
        ...
        /// <include file="Docs/ChatCompletionsClient.xml" path="doc/members/member[@name='CompleteAsync(RequestContent,string,RequestContext)']/*" />
        public virtual async Task<Response> CompleteAsync(RequestContent content, string extraParams = null, RequestContext context = null)
        {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ChatCompletionsClient.xml" path="doc/members/member[@name='Complete(RequestContent,string,RequestContext)']/*" />
        public virtual Response Complete(RequestContent content, string extraParams = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
