...
namespace Azure.Ai.Client.Models
{
    ...
    public partial class EvaluationSchedule
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/>, <paramref name="evaluators"/> or <paramref name="samplingStrategy"/> is null. </exception>
        public EvaluationSchedule(InputData data, IDictionary<string, EvaluatorConfiguration> evaluators, SamplingStrategy samplingStrategy)
        {
        ...
        internal EvaluationSchedule(string id, InputData data, string displayName, string description, SystemData systemData, string status, IDictionary<string, string> tags, IDictionary<string, string> properties, IDictionary<string, EvaluatorConfiguration> evaluators, Recurrence recurrence, string cronExpression, SamplingStrategy samplingStrategy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Data = data;
        ...
        /// <summary> Recurrence pattern for the evaluation. </summary>
        public Recurrence Recurrence { get; set; }
        /// <summary> Cron expression for the evaluation. </summary>
