...
namespace Azure.AI.Project
{
    ...
    internal partial class OpenAIPageableListOfThreadRun
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfThreadRun"/>. </summary>
        ...
        internal OpenAIPageableListOfThreadRun(IEnumerable<ThreadRun> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal OpenAIPageableListOfThreadRun(OpenAIPageableListOfThreadRunObject @object, IReadOnlyList<ThreadRun> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfThreadRun"/> for deserialization. </summary>
        internal OpenAIPageableListOfThreadRun()
        {
        }
