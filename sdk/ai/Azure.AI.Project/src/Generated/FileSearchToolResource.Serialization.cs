...
namespace Azure.AI.Project
{
    public partial class FileSearchToolResource : IUtf8JsonSerializable, IJsonModel<FileSearchToolResource>
    {
        ...
        internal static FileSearchToolResource DeserializeFileSearchToolResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<VectorStoreFromAzure> vectorStores = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("vector_stores"u8))
                {
                    ...
                    List<VectorStoreFromAzure> array = new List<VectorStoreFromAzure>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(VectorStoreFromAzure.DeserializeVectorStoreFromAzure(item, options));
                    }
                    vectorStores = array;
                    continue;
                }
            ...
            return new FileSearchToolResource(vectorStoreIds ?? new ChangeTrackingList<string>(), vectorStores ?? new ChangeTrackingList<VectorStoreFromAzure>(), serializedAdditionalRawData);
        }
