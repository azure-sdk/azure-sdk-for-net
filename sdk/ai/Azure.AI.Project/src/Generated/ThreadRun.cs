...
namespace Azure.AI.Project
{
    ...
    public partial class ThreadRun
    {
        ...
        /// Please note <see cref="Project.RequiredAction"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
