...
namespace Azure.AI.Project
{
    ...
    public partial class MessageAttachment
    {
        ...
        internal MessageAttachment(string fileId, IList<VectorStorageDataSource> dataSources, IList<BinaryData> tools, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileId = fileId;
