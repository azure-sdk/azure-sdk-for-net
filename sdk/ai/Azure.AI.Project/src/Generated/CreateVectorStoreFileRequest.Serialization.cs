...
namespace Azure.AI.Project
{
    internal partial class CreateVectorStoreFileRequest : IUtf8JsonSerializable, IJsonModel<CreateVectorStoreFileRequest>
    {
        ...
        internal static CreateVectorStoreFileRequest DeserializeCreateVectorStoreFileRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CreateVectorStoreFileRequest(fileId, dataSources ?? new ChangeTrackingList<VectorStorageDataSource>(), chunkingStrategy, serializedAdditionalRawData);
        }
