...
namespace Azure.AI.Project
{
    ...
    public partial class FileSearchToolResource
    {
        ...
        public FileSearchToolResource()
        {
            ...
            VectorStores = new ChangeTrackingList<VectorStoreFromAzure>();
        }
        ...
        internal FileSearchToolResource(IList<string> vectorStoreIds, IList<VectorStoreFromAzure> vectorStores, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Gets the vector stores. </summary>
        public IList<VectorStoreFromAzure> VectorStores { get; }
    }
}
