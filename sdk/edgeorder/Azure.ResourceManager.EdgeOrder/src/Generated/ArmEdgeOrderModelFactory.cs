...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public static partial class ArmEdgeOrderModelFactory
    {
        ...
        public static EdgeOrderAddressData EdgeOrderAddressData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AddressClassification? addressClassification = null, EdgeOrderShippingAddress shippingAddress = null, EdgeOrderAddressContactDetails contactDetails = null, EdgeOrderAddressValidationStatus? addressValidationStatus = null, ProvisioningState? provisioningState = null)
        {
            ...
            return new EdgeOrderAddressData(id, name, resourceType, systemData, tags, location, addressClassification, shippingAddress, contactDetails, addressValidationStatus, provisioningState, serializedAdditionalRawData: null);
        }
        ...
        {
            return new EdgeOrderItemAddressProperties(addressClassification, shippingAddress, contactDetails, addressValidationStatus, provisioningState, serializedAdditionalRawData: null);
        }
        ...
        public static ProductConfiguration ProductConfiguration(string displayName = null, ProductDescription description = null, IEnumerable<EdgeOrderProductImageInformation> imageInformation = null, EdgeOrderProductCostInformation costInformation = null, ProductAvailabilityInformation availabilityInformation = null, HierarchyInformation hierarchyInformation = null, FulfillmentType? fulfilledBy = null, IEnumerable<FilterableProperty> filterableProperties = null, IEnumerable<ProductSpecification> specifications = null, ProductDimensions dimensions = null, ProvisioningSupport? provisioningSupport = null, IEnumerable<ChildConfigurationType> childConfigurationTypes = null, IEnumerable<GroupedChildConfigurations> groupedChildConfigurations = null, IEnumerable<TimeSpan> supportedTermCommitmentDurations = null)
        {
            ...
            return new ProductConfiguration(displayName, description, imageInformation?.ToList(), costInformation, availabilityInformation, hierarchyInformation, fulfilledBy, filterableProperties?.ToList(), specifications?.ToList(), dimensions, provisioningSupport, childConfigurationTypes?.ToList(), groupedChildConfigurations?.ToList(), supportedTermCommitmentDurations?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        {
            return new EdgeOrderProductBillingMeterDetails(name, meterDetails, meteringType, frequency, termTypeDetails, serializedAdditionalRawData: null);
        }
        ...
        public static ProductFamily ProductFamily(string displayName = null, ProductDescription description = null, IEnumerable<EdgeOrderProductImageInformation> imageInformation = null, EdgeOrderProductCostInformation costInformation = null, ProductAvailabilityInformation availabilityInformation = null, HierarchyInformation hierarchyInformation = null, FulfillmentType? fulfilledBy = null, IEnumerable<FilterableProperty> filterableProperties = null, IEnumerable<ProductLine> productLines = null, IEnumerable<ResourceProviderDetails> resourceProviderDetails = null)
        {
            ...
            return new ProductFamily(displayName, description, imageInformation?.ToList(), costInformation, availabilityInformation, hierarchyInformation, fulfilledBy, filterableProperties?.ToList(), productLines?.ToList(), resourceProviderDetails?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        public static ProductLine ProductLine(string displayName = null, ProductDescription description = null, IEnumerable<EdgeOrderProductImageInformation> imageInformation = null, EdgeOrderProductCostInformation costInformation = null, ProductAvailabilityInformation availabilityInformation = null, HierarchyInformation hierarchyInformation = null, FulfillmentType? fulfilledBy = null, IEnumerable<FilterableProperty> filterableProperties = null, IEnumerable<EdgeOrderProduct> products = null)
        {
            ...
            return new ProductLine(displayName, description, imageInformation?.ToList(), costInformation, availabilityInformation, hierarchyInformation, fulfilledBy, filterableProperties?.ToList(), products?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        public static EdgeOrderProduct EdgeOrderProduct(string displayName = null, ProductDescription description = null, IEnumerable<EdgeOrderProductImageInformation> imageInformation = null, EdgeOrderProductCostInformation costInformation = null, ProductAvailabilityInformation availabilityInformation = null, HierarchyInformation hierarchyInformation = null, FulfillmentType? fulfilledBy = null, IEnumerable<FilterableProperty> filterableProperties = null, IEnumerable<ProductConfiguration> configurations = null)
        {
            ...
            return new EdgeOrderProduct(displayName, description, imageInformation?.ToList(), costInformation, availabilityInformation, hierarchyInformation, fulfilledBy, filterableProperties?.ToList(), configurations?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        public static EdgeOrderItemData EdgeOrderItemData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, EdgeOrderItemDetails orderItemDetails = null, EdgeOrderItemAddressDetails addressDetails = null, DateTimeOffset? startOn = null, ResourceIdentifier orderId = null, ProvisioningState? provisioningState = null)
        {
            ...
            return new EdgeOrderItemData(id, name, resourceType, systemData, tags, location, identity, orderItemDetails, addressDetails, startOn, orderId, provisioningState, serializedAdditionalRawData: null);
        }
        ...
        public static ProductDetails ProductDetails(ProductDisplayInfo displayInfo = null, HierarchyInformation hierarchyInformation = null, DoubleEncryptionStatus? productDoubleEncryptionStatus = null, IdentificationType? identificationType = null, EdgeOrderProductDeviceDetails parentDeviceDetails = null, ProvisioningDetails parentProvisioningDetails = null, IEnumerable<AdditionalConfiguration> optInAdditionalConfigurations = null, IEnumerable<ConfigurationDeviceDetails> childConfigurationDeviceDetails = null, TermCommitmentInformation termCommitmentInformation = null)
        {
            ...
            return new ProductDetails(displayInfo, hierarchyInformation, productDoubleEncryptionStatus, identificationType, parentDeviceDetails, parentProvisioningDetails, optInAdditionalConfigurations?.ToList(), childConfigurationDeviceDetails?.ToList(), termCommitmentInformation, serializedAdditionalRawData: null);
        }
        ...
        {
            return new EdgeOrderProductDeviceDetails(serialNumber, displaySerialNumber, managementResourceId, managementResourceTenantId, provisioningSupport, provisioningDetails, serializedAdditionalRawData: null);
        }
        ...
        {
            return new ProvisioningDetails(quantity, provisioningArmId, provisioningEndPoint, serialNumber, vendorName, readyToConnectArmId, managementResourceArmId, uniqueDeviceIdentifier, autoProvisioningStatus, devicePresenceVerification, serializedAdditionalRawData: null);
        }
        ...
        public static ConfigurationDeviceDetails ConfigurationDeviceDetails(ProductDisplayInfo displayInfo = null, HierarchyInformation hierarchyInformation = null, int? quantity = null, IdentificationType? identificationType = null, IEnumerable<EdgeOrderProductDeviceDetails> deviceDetails = null, TermCommitmentInformation termCommitmentInformation = null)
        {
            ...
            return new ConfigurationDeviceDetails(displayInfo, hierarchyInformation, quantity, identificationType, deviceDetails?.ToList(), termCommitmentInformation, serializedAdditionalRawData: null);
        }
        ...
        public static EdgeOrderData EdgeOrderData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<ResourceIdentifier> orderItemIds = null, EdgeOrderStageDetails currentStage = null, IEnumerable<EdgeOrderStageDetails> orderStageHistory = null, OrderMode? orderMode = null)
        {
            ...
            return new EdgeOrderData(id, name, resourceType, systemData, orderItemIds?.ToList(), currentStage, orderStageHistory?.ToList(), orderMode, serializedAdditionalRawData: null);
        }
        ...
        public static ProductFamiliesMetadata ProductFamiliesMetadata(string displayName = null, ProductDescription description = null, IEnumerable<EdgeOrderProductImageInformation> imageInformation = null, EdgeOrderProductCostInformation costInformation = null, ProductAvailabilityInformation availabilityInformation = null, HierarchyInformation hierarchyInformation = null, FulfillmentType? fulfilledBy = null, IEnumerable<FilterableProperty> filterableProperties = null, IEnumerable<ProductLine> productLines = null, IEnumerable<ResourceProviderDetails> resourceProviderDetails = null)
        {
            ...
            return new ProductFamiliesMetadata(displayName, description, imageInformation?.ToList(), costInformation, availabilityInformation, hierarchyInformation, fulfilledBy, filterableProperties?.ToList(), productLines?.ToList(), resourceProviderDetails?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.EdgeOrder.Models.ProductFamily" />. </summary>
        /// <param name="displayName"> Display Name for the product system. </param>
        /// <param name="description"> Description related to the product system. </param>
        /// <param name="imageInformation"> Image information for the product system. </param>
        /// <param name="costInformation"> Cost information for the product system. </param>
        ...
        /// <param name="productLines"> List of product lines supported in the product family. </param>
        /// <param name="resourceProviderDetails"> Contains details related to resource provider. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.EdgeOrder.Models.ProductFamily" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        {
            return ProductFamily(displayName: displayName, description: description, imageInformation: imageInformation, costInformation: costInformation, availabilityInformation: availabilityInformation, hierarchyInformation: hierarchyInformation, fulfilledBy: default, filterableProperties: filterableProperties, productLines: productLines, resourceProviderDetails: resourceProviderDetails);
        }

        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.EdgeOrder.Models.ProductLine" />. </summary>
        /// <param name="displayName"> Display Name for the product system. </param>
        /// <param name="description"> Description related to the product system. </param>
        /// <param name="imageInformation"> Image information for the product system. </param>
        /// <param name="costInformation"> Cost information for the product system. </param>
        ...
        /// <param name="filterableProperties"> list of filters supported for a product. </param>
        /// <param name="products"> List of products in the product line. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.EdgeOrder.Models.ProductLine" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.EdgeOrder.Models.EdgeOrderProduct" />. </summary>
        /// <param name="displayName"> Display Name for the product system. </param>
        /// <param name="description"> Description related to the product system. </param>
        /// <param name="imageInformation"> Image information for the product system. </param>
        /// <param name="costInformation"> Cost information for the product system. </param>
        ...
        /// <param name="filterableProperties"> list of filters supported for a product. </param>
        /// <param name="configurations"> List of configurations for the product. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.EdgeOrder.Models.EdgeOrderProduct" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.EdgeOrder.Models.ProductFamiliesMetadata" />. </summary>
        /// <param name="displayName"> Display Name for the product system. </param>
        /// <param name="description"> Description related to the product system. </param>
        /// <param name="imageInformation"> Image information for the product system. </param>
        /// <param name="costInformation"> Cost information for the product system. </param>
        ...
        /// <param name="productLines"> List of product lines supported in the product family. </param>
        /// <param name="resourceProviderDetails"> Contains details related to resource provider. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.EdgeOrder.Models.ProductFamiliesMetadata" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        {
            return EdgeOrderItemData(id: id, name: name, resourceType: resourceType, systemData: systemData, tags: tags, location: location, identity: default, orderItemDetails: orderItemDetails, addressDetails: addressDetails, startOn: startOn, orderId: orderId, provisioningState: default);
        }
