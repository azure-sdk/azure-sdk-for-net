...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="EdgeOrder.AddressResourceData"/>. </summary>
        ...
        /// <returns> A new <see cref="EdgeOrder.AddressResourceData"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AddressProperties"/>. </summary>
        /// <param name="addressClassification"> Type of address based on its usage context. </param>
        /// <param name="shippingAddress"> Shipping details for the address. </param>
        /// <param name="contactDetails"> Contact details for the address. </param>
        /// <param name="addressValidationStatus"> Status of address validation. </param>
        /// <param name="provisioningState"> Provisioning state. </param>
        /// <returns> A new <see cref="Models.AddressProperties"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="EdgeOrder.OrderItemResourceData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="EdgeOrder.OrderItemResourceData"/> instance for mocking. </returns>
        ...
        public static ProductDetails ProductDetails(DisplayInfo displayInfo = null, HierarchyInformation hierarchyInformation = null, DoubleEncryptionStatus? productDoubleEncryptionStatus = null, IdentificationType? identificationType = null, DeviceDetails parentDeviceDetails = null, ProvisioningDetails parentProvisioningDetails = null, IEnumerable<AdditionalConfiguration> optInAdditionalConfigurations = null, IEnumerable<ConfigurationDeviceDetails> childConfigurationDeviceDetails = null, TermCommitmentInformation termCommitmentInformation = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.DisplayInfo"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.DisplayInfo"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.DeviceDetails"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.DeviceDetails"/> instance for mocking. </returns>
        ...
        public static ConfigurationDeviceDetails ConfigurationDeviceDetails(DisplayInfo displayInfo = null, HierarchyInformation hierarchyInformation = null, int? quantity = null, IdentificationType? identificationType = null, IEnumerable<DeviceDetails> deviceDetails = null, TermCommitmentInformation termCommitmentInformation = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AddressDetails"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ReturnOrderItemDetails"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ReturnOrderItemDetails"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="EdgeOrder.OrderResourceData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="EdgeOrder.OrderResourceData"/> instance for mocking. </returns>
        public static OrderResourceData OrderResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> orderItemIds = null, StageDetails currentStage = null, IEnumerable<StageDetails> orderStageHistory = null, OrderMode? orderMode = null)
        {
        ...
        public static Configuration Configuration(IEnumerable<Specification> specifications = null, Dimensions dimensions = null, ProvisioningSupport? provisioningSupport = null, IEnumerable<ChildConfigurationType> childConfigurationTypes = null, IEnumerable<GroupedChildConfigurations> groupedChildConfigurations = null, IEnumerable<TimeSpan> supportedTermCommitmentDurations = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.Specification"/>. </summary>
        /// <param name="name"> Name of the specification. </param>
        /// <param name="value"> Value of the specification. </param>
        /// <returns> A new <see cref="Models.Specification"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.Dimensions"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.Dimensions"/> instance for mocking. </returns>
        ...
        public static CategoryInformation CategoryInformation(string categoryName = null, string categoryDisplayName = null, string description = null, IEnumerable<Link> links = null)
        {
            links ??= new List<Link>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.Link"/>. </summary>
        ...
        public static ChildConfiguration ChildConfiguration(ChildConfigurationType? childConfigurationType = null, bool? isPartOfBaseConfiguration = null, int? minimumQuantity = null, int? maximumQuantity = null, IEnumerable<Specification> specifications = null, Dimensions dimensions = null, ProvisioningSupport? provisioningSupport = null, IEnumerable<ChildConfigurationType> childConfigurationTypes = null, IEnumerable<GroupedChildConfigurations> groupedChildConfigurations = null, IEnumerable<TimeSpan> supportedTermCommitmentDurations = null, IEnumerable<FilterableProperty> filterableProperties = null, string displayName = null, Description description = null, IEnumerable<ImageInformation> imageInformation = null, CostInformation costInformation = null, AvailabilityInformation availabilityInformation = null, HierarchyInformation hierarchyInformation = null, FulfillmentType? fulfilledBy = null)
        {
            specifications ??= new List<Specification>();
            childConfigurationTypes ??= new List<ChildConfigurationType>();
            groupedChildConfigurations ??= new List<GroupedChildConfigurations>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.Description"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.Description"/> instance for mocking. </returns>
        public static Description Description(DescriptionType? descriptionType = null, string shortDescription = null, string longDescription = null, IEnumerable<string> keywords = null, IEnumerable<string> attributes = null, IEnumerable<Link> links = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ImageInformation"/>. </summary>
        ...
        public static ImageInformation ImageInformation(ImageType? imageType = null, string imageUri = null)
        {
            return new ImageInformation(imageType, imageUri, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.CostInformation"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.CostInformation"/> instance for mocking. </returns>
        public static CostInformation CostInformation(IEnumerable<BillingMeterDetails> billingMeterDetails = null, string billingInfoUri = null)
        {
            billingMeterDetails ??= new List<BillingMeterDetails>();

            return new CostInformation(billingMeterDetails?.ToList(), billingInfoUri, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.BillingMeterDetails"/>. </summary>
        /// <param name="name"> Represents Billing type name. </param>
        /// <param name="meterDetails">
        /// Represents MeterDetails.
        /// Please note <see cref="Models.MeterDetails"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        /// <returns> A new <see cref="Models.BillingMeterDetails"/> instance for mocking. </returns>
        public static BillingMeterDetails BillingMeterDetails(string name = null, MeterDetails meterDetails = null, MeteringType? meteringType = null, string frequency = null, TermTypeDetails termTypeDetails = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.MeterDetails"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.MeterDetails"/> instance for mocking. </returns>
        public static MeterDetails MeterDetails(string billingType = null, double? multiplier = null, ChargingType? chargingType = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AvailabilityInformation"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.AvailabilityInformation"/> instance for mocking. </returns>
        public static AvailabilityInformation AvailabilityInformation(AvailabilityStage? availabilityStage = null, DisabledReason? disabledReason = null, string disabledReasonMessage = null)
        {
            return new AvailabilityInformation(availabilityStage, disabledReason, disabledReasonMessage, serializedAdditionalRawData: null);
        }
        ...
        public static Product Product(IEnumerable<Configuration> configurations = null)
        {
