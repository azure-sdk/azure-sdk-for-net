...
{
    /// <summary>
    /// A class representing the OrderItemResource data model.
    ...
    public partial class OrderItemResourceData : TrackedResourceData
    {
        ...
        public OrderItemResourceData(AzureLocation location, OrderItemDetails orderItemDetails, string orderId) : base(location)
        {
        ...
        internal OrderItemResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, OrderItemDetails orderItemDetails, AddressDetails addressDetails, DateTimeOffset? startOn, string orderId, ProvisioningState? provisioningState, ManagedServiceIdentity identity, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            OrderItemDetails = orderItemDetails;
        ...
        /// <summary> Initializes a new instance of <see cref="OrderItemResourceData"/> for deserialization. </summary>
        internal OrderItemResourceData()
        {
        }
