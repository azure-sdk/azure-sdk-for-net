...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public partial class AddressResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AddressResource_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-02-01</description>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AddressResource_Update</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-02-01</description>
        ...
        public virtual async Task<ArmOperation<AddressResource>> UpdateAsync(WaitUntil waitUntil, AddressResourcePatch patch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EdgeOrderArmOperation<AddressResource>(new AddressResourceOperationSource(Client), _addressResourceClientDiagnostics, Pipeline, _addressResourceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
