...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ProductConfiguration
    {
        internal static ProductConfiguration DeserializeProductConfiguration(JsonElement element)
        {
            ...
            return new ProductConfiguration(displayName.Value, description.Value, Optional.ToList(imageInformation), costInformation.Value, availabilityInformation.Value, hierarchyInformation.Value, Optional.ToNullable(fulfilledBy), Optional.ToList(filterableProperties), Optional.ToList(specifications), dimensions.Value, Optional.ToList(childConfigurationTypes), Optional.ToList(groupedChildConfigurations));
        }
    }
}
