...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class ContactDetails
    {
        ...
        internal ContactDetails(string contactName, string phone, string phoneExtension, string mobile, IList<string> emailList, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
