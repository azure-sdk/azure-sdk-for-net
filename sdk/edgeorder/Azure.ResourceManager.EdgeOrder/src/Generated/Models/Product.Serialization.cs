...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class Product : IUtf8JsonSerializable, IJsonModel<Product>
    {
        ...
        internal static Product DeserializeProduct(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<Configuration> configurations = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("configurations"u8))
                        {
                            ...
                            {
                                array.Add(Configuration.DeserializeConfiguration(item, options));
                            }
            ...
            return new Product(configurations ?? new ChangeTrackingList<Configuration>(), serializedAdditionalRawData);
        }
