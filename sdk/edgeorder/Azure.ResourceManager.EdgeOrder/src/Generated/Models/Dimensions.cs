...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class Dimensions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Dimensions"/>. </summary>
        internal Dimensions()
        {
        }
        ...
        internal Dimensions(double? length, double? height, double? width, LengthHeightUnit? lengthHeightUnit, double? weight, double? depth, WeightMeasurementUnit? weightUnit, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Length = length;
            Height = height;
            Width = width;
