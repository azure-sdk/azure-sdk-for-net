...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CategoryInformation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CategoryInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CategoryInformation)} does not support '{format}' format.");
            }
        ...
        internal static CategoryInformation DeserializeCategoryInformation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CategoryInformation(categoryName.Value, categoryDisplayName.Value, description.Value, Optional.ToList(links), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CategoryInformation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CategoryInformation)} does not support '{options.Format}' format.");
            }
        }
