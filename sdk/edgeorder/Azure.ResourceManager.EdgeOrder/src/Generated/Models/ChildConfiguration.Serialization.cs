...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChildConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ChildConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChildConfiguration)} does not support '{format}' format.");
            }
        ...
        internal static ChildConfiguration DeserializeChildConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ChildConfiguration(Optional.ToNullable(childConfigurationType), Optional.ToNullable(isPartOfBaseConfiguration), Optional.ToNullable(minimumQuantity), Optional.ToNullable(maximumQuantity), Optional.ToList(specifications), dimensions.Value, Optional.ToNullable(provisioningSupport), Optional.ToList(childConfigurationTypes), Optional.ToList(groupedChildConfigurations), Optional.ToList(supportedTermCommitmentDurations), Optional.ToList(filterableProperties), displayName.Value, description.Value, Optional.ToList(imageInformation), costInformation.Value, availabilityInformation.Value, hierarchyInformation.Value, Optional.ToNullable(fulfilledBy), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ChildConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChildConfiguration)} does not support '{options.Format}' format.");
            }
        }
