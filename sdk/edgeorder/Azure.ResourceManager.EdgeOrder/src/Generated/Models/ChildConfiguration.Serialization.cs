...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ChildConfiguration : IUtf8JsonSerializable, IJsonModel<ChildConfiguration>
    {
        ...
        internal static ChildConfiguration DeserializeChildConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ImageInformation> imageInformation = default;
            CostInformation costInformation = default;
            AvailabilityInformation availabilityInformation = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("description"u8))
                        {
                            ...
                            description = Description.DeserializeDescription(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("imageInformation"u8))
                        {
                            ...
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(Models.ImageInformation.DeserializeImageInformation(item, options));
                            }
                        ...
                        if (property0.NameEquals("costInformation"u8))
                        {
                            ...
                            costInformation = CostInformation.DeserializeCostInformation(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("availabilityInformation"u8))
                        {
                            ...
                            availabilityInformation = AvailabilityInformation.DeserializeAvailabilityInformation(property0.Value, options);
                            continue;
                        }
