...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class BillingMeterDetails
    {
        ...
        internal BillingMeterDetails(string name, MeterDetails meterDetails, MeteringType? meteringType, string frequency, TermTypeDetails termTypeDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
