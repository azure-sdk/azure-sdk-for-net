    ...
    internal partial class OrderItemResourceList : IJsonModel<OrderItemResourceList>
    {
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OrderItemResourceList)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OrderItemResourceList>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OrderItemResourceList)} does not support writing '{format}' format.");
            }
            if (options.Format != "W")
            {
                writer.WritePropertyName("value"u8);
                writer.WriteStartArray();
                foreach (EdgeOrderItemData item in Value)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OrderItemResourceList IJsonModel<OrderItemResourceList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual OrderItemResourceList JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<OrderItemResourceList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OrderItemResourceList)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OrderItemResourceList DeserializeOrderItemResourceList(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new OrderItemResourceList(value, nextLink, additionalBinaryDataProperties);
        }
    }
}
