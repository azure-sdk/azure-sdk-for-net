...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class DeviceDetails
    {
        ...
        internal DeviceDetails(string serialNumber, string displaySerialNumber, string managementResourceId, string managementResourceTenantId, ProvisioningSupport? provisioningSupport, ProvisioningDetails provisioningDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
