...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdditionalConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AdditionalConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdditionalConfiguration)} does not support '{format}' format.");
            }
        ...
        internal static AdditionalConfiguration DeserializeAdditionalConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AdditionalConfiguration(hierarchyInformation, quantity, Optional.ToList(provisioningDetails), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AdditionalConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdditionalConfiguration)} does not support '{options.Format}' format.");
            }
        }
