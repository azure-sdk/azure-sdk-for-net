...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class CategoryInformation
    {
        ...
        internal CategoryInformation(string categoryName, string categoryDisplayName, string description, IReadOnlyList<Link> links, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
