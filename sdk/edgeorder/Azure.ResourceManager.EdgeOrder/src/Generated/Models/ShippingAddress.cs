...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class ShippingAddress
    {
        ...
        internal ShippingAddress(string streetAddress1, string streetAddress2, string streetAddress3, string city, string stateOrProvince, string country, string postalCode, string zipExtendedCode, string companyName, AddressType? addressType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="ShippingAddress"/> for deserialization. </summary>
