...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class OrderItemPreferences : IUtf8JsonSerializable, IJsonModel<OrderItemPreferences>
    {
        ...
        internal static OrderItemPreferences DeserializeOrderItemPreferences(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OrderItemPreferences(Optional.ToList(notificationPreferences), transportPreferences.Value, encryptionPreferences.Value, managementResourcePreferences.Value, termCommitmentPreferences.Value, serializedAdditionalRawData);
        }
