...
namespace Azure.ResourceManager.EdgeOrder
{
    public partial class EdgeOrderItemData : IUtf8JsonSerializable
    {
        ...
        internal static EdgeOrderItemData DeserializeEdgeOrderItemData(JsonElement element)
        {
            ...
            return new EdgeOrderItemData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, orderItemDetails, addressDetails.Value, Optional.ToNullable(startTime), orderId, Optional.ToNullable(provisioningState));
        }
    }
}
