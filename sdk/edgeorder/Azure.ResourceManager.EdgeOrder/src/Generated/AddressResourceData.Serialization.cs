...
{
    public partial class AddressResourceData : IUtf8JsonSerializable, IJsonModel<AddressResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddressResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AddressResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AddressResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AddressResourceData IJsonModel<AddressResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AddressResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AddressResourceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AddressResourceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AddressResourceData IPersistableModel<AddressResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AddressResourceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AddressResourceData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
