...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public partial class OrderResourceCollection : ArmCollection
    {
        ...
        internal OrderResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _orderResourceRestClient = new OrderResourcesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, orderResourceApiVersion);
#if DEBUG
        ...
        public virtual async Task<Response<OrderResource>> GetAsync(AzureLocation location, string orderName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _orderResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, location, orderName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<OrderResource> Get(AzureLocation location, string orderName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _orderResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, location, orderName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new OrderResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(AzureLocation location, string orderName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _orderResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, location, orderName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(AzureLocation location, string orderName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _orderResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, location, orderName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
