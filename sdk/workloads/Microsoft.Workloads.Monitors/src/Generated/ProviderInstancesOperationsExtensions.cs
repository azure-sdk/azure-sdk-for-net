...
namespace Microsoft.Workloads.Monitors
{
    ...
    public static partial class ProviderInstancesOperationsExtensions
    {
            ...
            /// Name of the provider instance.
            /// </param>
            public static void Delete(this IProviderInstancesOperations operations, string resourceGroupName, string monitorName, string providerInstanceName)
            {
                operations.DeleteAsync(resourceGroupName, monitorName, providerInstanceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IProviderInstancesOperations operations, string resourceGroupName, string monitorName, string providerInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DeleteWithHttpMessagesAsync(resourceGroupName, monitorName, providerInstanceName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// Name of the provider instance.
            /// </param>
            public static void BeginDelete(this IProviderInstancesOperations operations, string resourceGroupName, string monitorName, string providerInstanceName)
            {
                operations.BeginDeleteAsync(resourceGroupName, monitorName, providerInstanceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginDeleteAsync(this IProviderInstancesOperations operations, string resourceGroupName, string monitorName, string providerInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, monitorName, providerInstanceName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
