...
namespace Microsoft.Workloads.Monitors.Models
{
    ...
    public partial class SapNetWeaverProviderInstanceProperties : ProviderSpecificProperties
    {
        ...
        public SapNetWeaverProviderInstanceProperties(string sapSid = default(string), string sapHostname = default(string), string sapInstanceNr = default(string), IList<string> sapHostFileEntries = default(IList<string>), string sapUsername = default(string), string sapPassword = default(string), string sapPasswordUri = default(string), string sapClientId = default(string), string sapPortNumber = default(string), string sslCertificateUri = default(string), string sslPreference = default(string))
        {
            SapSid = sapSid;
