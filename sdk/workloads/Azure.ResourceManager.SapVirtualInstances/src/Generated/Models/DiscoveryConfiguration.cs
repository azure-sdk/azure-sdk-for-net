...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class DiscoveryConfiguration : SAPConfiguration
    {
        ...
        internal DiscoveryConfiguration(SAPConfigurationType configurationType, IDictionary<string, BinaryData> serializedAdditionalRawData, string centralServerVmId, string managedRgStorageAccountName, string appLocation) : base(configurationType, serializedAdditionalRawData)
        {
