...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class Error
    {
        ...
        internal Error(string code, string message, string target, IReadOnlyList<ErrorDetails> details, string innerError, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
