...
namespace Microsoft.Workloads
{
    ...
    public static partial class SAPVirtualInstancesOperationsExtensions
    {
            ...
            /// </param>
            public static OperationStatusResult Stop(this ISAPVirtualInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, long? softStopTimeoutSeconds = 0)
            {
                return operations.StopAsync(resourceGroupName, sapVirtualInstanceName, softStopTimeoutSeconds).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> StopAsync(this ISAPVirtualInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, long? softStopTimeoutSeconds = 0, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.StopWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, softStopTimeoutSeconds, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// into the next shutdown state, i.e. hard stop.
            /// </param>
            public static OperationStatusResult BeginStop(this ISAPVirtualInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, long? softStopTimeoutSeconds = 0)
            {
                return operations.BeginStopAsync(resourceGroupName, sapVirtualInstanceName, softStopTimeoutSeconds).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> BeginStopAsync(this ISAPVirtualInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, long? softStopTimeoutSeconds = 0, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginStopWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, softStopTimeoutSeconds, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
