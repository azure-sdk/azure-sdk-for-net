...
namespace Microsoft.Workloads
{
    ...
    public static partial class SAPCentralInstancesOperationsExtensions
    {
            ...
            /// auto generation to work correctly.
            /// </param>
            public static OperationStatusResult StartInstance(this ISAPCentralInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string centralInstanceName)
            {
                return operations.StartInstanceAsync(resourceGroupName, sapVirtualInstanceName, centralInstanceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> StartInstanceAsync(this ISAPCentralInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string centralInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.StartInstanceWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, centralInstanceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static OperationStatusResult StopInstance(this ISAPCentralInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string centralInstanceName, long? softStopTimeoutSeconds = 0)
            {
                return operations.StopInstanceAsync(resourceGroupName, sapVirtualInstanceName, centralInstanceName, softStopTimeoutSeconds).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> StopInstanceAsync(this ISAPCentralInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string centralInstanceName, long? softStopTimeoutSeconds = 0, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.StopInstanceWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, centralInstanceName, softStopTimeoutSeconds, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// auto generation to work correctly.
            /// </param>
            public static OperationStatusResult BeginStartInstance(this ISAPCentralInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string centralInstanceName)
            {
                return operations.BeginStartInstanceAsync(resourceGroupName, sapVirtualInstanceName, centralInstanceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> BeginStartInstanceAsync(this ISAPCentralInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string centralInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginStartInstanceWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, centralInstanceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// into the next shutdown state, i.e. hard stop.
            /// </param>
            public static OperationStatusResult BeginStopInstance(this ISAPCentralInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string centralInstanceName, long? softStopTimeoutSeconds = 0)
            {
                return operations.BeginStopInstanceAsync(resourceGroupName, sapVirtualInstanceName, centralInstanceName, softStopTimeoutSeconds).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> BeginStopInstanceAsync(this ISAPCentralInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string centralInstanceName, long? softStopTimeoutSeconds = 0, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginStopInstanceWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, centralInstanceName, softStopTimeoutSeconds, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
