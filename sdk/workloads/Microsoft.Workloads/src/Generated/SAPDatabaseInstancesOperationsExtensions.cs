...
namespace Microsoft.Workloads
{
    ...
    public static partial class SAPDatabaseInstancesOperationsExtensions
    {
            ...
            /// work correctly.
            /// </param>
            public static OperationStatusResult StartInstance(this ISAPDatabaseInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string databaseInstanceName)
            {
                return operations.StartInstanceAsync(resourceGroupName, sapVirtualInstanceName, databaseInstanceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> StartInstanceAsync(this ISAPDatabaseInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string databaseInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.StartInstanceWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static OperationStatusResult StopInstance(this ISAPDatabaseInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string databaseInstanceName, long? softStopTimeoutSeconds = 0)
            {
                return operations.StopInstanceAsync(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, softStopTimeoutSeconds).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> StopInstanceAsync(this ISAPDatabaseInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string databaseInstanceName, long? softStopTimeoutSeconds = 0, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.StopInstanceWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, softStopTimeoutSeconds, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// work correctly.
            /// </param>
            public static OperationStatusResult BeginStartInstance(this ISAPDatabaseInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string databaseInstanceName)
            {
                return operations.BeginStartInstanceAsync(resourceGroupName, sapVirtualInstanceName, databaseInstanceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> BeginStartInstanceAsync(this ISAPDatabaseInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string databaseInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginStartInstanceWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// into the next shutdown state, i.e. hard stop.
            /// </param>
            public static OperationStatusResult BeginStopInstance(this ISAPDatabaseInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string databaseInstanceName, long? softStopTimeoutSeconds = 0)
            {
                return operations.BeginStopInstanceAsync(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, softStopTimeoutSeconds).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationStatusResult> BeginStopInstanceAsync(this ISAPDatabaseInstancesOperations operations, string resourceGroupName, string sapVirtualInstanceName, string databaseInstanceName, long? softStopTimeoutSeconds = 0, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginStopInstanceWithHttpMessagesAsync(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, softStopTimeoutSeconds, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
