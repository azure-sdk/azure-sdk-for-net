    ...
    public partial class AutoUpgradeProfileResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GenerateResponse>> GenerateUpdateRunAutoUpgradeProfileOperationAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerServiceFleetArmOperation<GenerateResponse>(new GenerateResponseOperationSource(), _autoUpgradeProfileOperationsClientDiagnostics, Pipeline, _autoUpgradeProfileOperationsRestClient.CreateGenerateUpdateRunRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
