...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoUpgradeProfileData>)this).Write(writer, new ModelReaderWriterOptions("W"));
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("nodeImageSelection"u8))
                        {
                            ...
                            nodeImageSelection = NodeImageSelection.DeserializeNodeImageSelection(property0.Value, options);
                            continue;
                        }
