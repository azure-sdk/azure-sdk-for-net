...
namespace Azure.ResourceManager.DatabaseFleetManager.Models
{
    ...
    public partial class FleetUpdateStage
    {
        ...
        public FleetUpdateStage(string name)
        {
            ...
            Name = name;
            Groups = new ChangeTrackingList<FleetUpdateGroup>();
        }
        ...
        internal FleetUpdateStage(string name, IList<FleetUpdateGroup> groups, int? afterStageWaitInSeconds)
        {
            Name = name;
            Groups = groups;
        ...
        public IList<FleetUpdateGroup> Groups { get; }
