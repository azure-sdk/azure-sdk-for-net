...
namespace Azure.ResourceManager.DatabaseFleetManager
{
    ...
    /// Each <see cref="FleetUpdateStrategyResource" /> in the collection will belong to the same instance of <see cref="DatabaseFleetResource" />.
    /// To get a <see cref="FleetUpdateStrategyCollection" /> instance call the GetFleetUpdateStrategies method from an instance of <see cref="DatabaseFleetResource" />.
    /// </summary>
    public partial class FleetUpdateStrategyCollection : ArmCollection, IEnumerable<FleetUpdateStrategyResource>, IAsyncEnumerable<FleetUpdateStrategyResource>
    {
        ...
        {
            _fleetUpdateStrategyClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DatabaseFleetManager", FleetUpdateStrategyResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<FleetUpdateStrategyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string updateStrategyName, FleetUpdateStrategyData data, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DatabaseFleetManagerArmOperation<FleetUpdateStrategyResource>(new FleetUpdateStrategyOperationSource(Client), _fleetUpdateStrategyClientDiagnostics, Pipeline, _fleetUpdateStrategyRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, updateStrategyName, data, ifMatch, ifNoneMatch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
