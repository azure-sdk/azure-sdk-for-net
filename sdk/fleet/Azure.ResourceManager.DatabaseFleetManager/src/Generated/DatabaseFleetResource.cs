...
namespace Azure.ResourceManager.DatabaseFleetManager
{
    ...
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="DatabaseFleetResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetDatabaseFleetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource" /> using the GetDatabaseFleet method.
    /// </summary>
    public partial class DatabaseFleetResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="DatabaseFleetResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="DatabaseFleetResource"/> class for mocking. </summary>
        protected DatabaseFleetResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "DatabaseFleetResource"/> class. </summary>
        ...
        {
            _databaseFleetFleetsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DatabaseFleetManager", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string databaseFleetFleetsApiVersion);
        ...
        public virtual DatabaseFleetMemberCollection GetDatabaseFleetMembers()
        {
            return GetCachedClient(Client => new DatabaseFleetMemberCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DatabaseFleetMemberResource>> GetDatabaseFleetMemberAsync(string fleetMemberName, CancellationToken cancellationToken = default)
        {
            return await GetDatabaseFleetMembers().GetAsync(fleetMemberName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="fleetMemberName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<DatabaseFleetMemberResource> GetDatabaseFleetMember(string fleetMemberName, CancellationToken cancellationToken = default)
        {
        ...
        public virtual DatabaseFleetUpdateRunCollection GetDatabaseFleetUpdateRuns()
        {
            return GetCachedClient(Client => new DatabaseFleetUpdateRunCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DatabaseFleetUpdateRunResource>> GetDatabaseFleetUpdateRunAsync(string updateRunName, CancellationToken cancellationToken = default)
        {
            return await GetDatabaseFleetUpdateRuns().GetAsync(updateRunName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="updateRunName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<DatabaseFleetUpdateRunResource> GetDatabaseFleetUpdateRun(string updateRunName, CancellationToken cancellationToken = default)
        {
            return GetDatabaseFleetUpdateRuns().Get(updateRunName, cancellationToken);
        }

        /// <summary> Gets a collection of FleetUpdateStrategyResources in the DatabaseFleet. </summary>
        ...
        {
            using var scope = _databaseFleetFleetsClientDiagnostics.CreateScope("DatabaseFleetResource.Get");
            scope.Start();
            try
            {
                var response = await _databaseFleetFleetsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DatabaseFleetResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseFleetFleetsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DatabaseFleetResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _databaseFleetFleetsClientDiagnostics.CreateScope("DatabaseFleetResource.Delete");
            scope.Start();
            try
            {
                var response = await _databaseFleetFleetsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
                var operation = new DatabaseFleetManagerArmOperation(_databaseFleetFleetsClientDiagnostics, Pipeline, _databaseFleetFleetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseFleetFleetsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch, cancellationToken);
                var operation = new DatabaseFleetManagerArmOperation(_databaseFleetFleetsClientDiagnostics, Pipeline, _databaseFleetFleetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<DatabaseFleetResource>> UpdateAsync(WaitUntil waitUntil, DatabaseFleetPatch patch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));

            using var scope = _databaseFleetFleetsClientDiagnostics.CreateScope("DatabaseFleetResource.Update");
            scope.Start();
            try
            {
                var response = await _databaseFleetFleetsRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<DatabaseFleetResource> Update(WaitUntil waitUntil, DatabaseFleetPatch patch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _databaseFleetFleetsRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch, cancellationToken);
                var operation = new DatabaseFleetManagerArmOperation<DatabaseFleetResource>(new DatabaseFleetOperationSource(Client), _databaseFleetFleetsClientDiagnostics, Pipeline, _databaseFleetFleetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            using var scope = _databaseFleetFleetsClientDiagnostics.CreateScope("DatabaseFleetResource.GetCredentials");
            scope.Start();
            try
            {
                var response = await _databaseFleetFleetsRestClient.ListCredentialsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<FleetCredentialResults> GetCredentials(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseFleetFleetsRestClient.ListCredentials(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<DatabaseFleetResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseFleetFleetsClientDiagnostics.CreateScope("DatabaseFleetResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _databaseFleetFleetsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new DatabaseFleetResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new DatabaseFleetPatch();
        ...
        public virtual Response<DatabaseFleetResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _databaseFleetFleetsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new DatabaseFleetResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<DatabaseFleetResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseFleetFleetsClientDiagnostics.CreateScope("DatabaseFleetResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<DatabaseFleetResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseFleetFleetsClientDiagnostics.CreateScope("DatabaseFleetResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
