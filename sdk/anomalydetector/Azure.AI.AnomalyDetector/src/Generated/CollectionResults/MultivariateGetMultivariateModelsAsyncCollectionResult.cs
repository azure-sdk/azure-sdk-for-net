...
namespace Azure.AI.AnomalyDetector
{
    internal partial class MultivariateGetMultivariateModelsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public MultivariateGetMultivariateModelsAsyncCollectionResult(Multivariate client, int? skip, int? maxCount, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _skip = skip;
            _maxCount = maxCount;
