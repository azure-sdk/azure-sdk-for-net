...
namespace Azure.AI.AnomalyDetector
{
    internal partial class MultivariateGetMultivariateModelsAsyncCollectionResultOfT : AsyncPageable<AnomalyDetectionModel>
    {
        ...
        public MultivariateGetMultivariateModelsAsyncCollectionResultOfT(Multivariate client, int? skip, int? maxCount, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _skip = skip;
            _maxCount = maxCount;
