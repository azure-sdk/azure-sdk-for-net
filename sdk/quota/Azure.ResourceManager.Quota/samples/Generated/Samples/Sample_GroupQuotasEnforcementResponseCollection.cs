...
namespace Azure.ResourceManager.Quota.Samples
{
    public partial class Sample_GroupQuotasEnforcementResponseCollection
    {
        ...
        public async Task CreateOrUpdate_GroupQuotasEnforcementPut()
        {
            ...
            // this example is just showing the usage of "GroupQuotaEnforcement_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            ArmOperation<GroupQuotasEnforcementResponseResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, location);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_GroupQuotasEnforcementPutFailed()
        {
        ...
        public async Task Get_GroupQuotasEnforcementGet()
        {
            ...
            // this example is just showing the usage of "GroupQuotaEnforcement_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task GetAll_GroupQuotaEnforcementList()
        {
            ...
            // this example is just showing the usage of "GroupQuotaEnforcement_List" operation, for the dependent resources, they will have to be created separately.
