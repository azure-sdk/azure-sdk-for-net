...
namespace Azure.ResourceManager.Quota.Samples
{
    public partial class Sample_QuotaAllocationRequestStatusCollection
    {
        ...
        public async Task Get_SubscriptionQuotaAllocationRequestsGetRequestForCompute()
        {
            ...
            QuotaAllocationRequestStatusCollection collection = managementGroupResource.GetQuotaAllocationRequestStatuses(subscriptionId, groupQuotaName);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_SubscriptionQuotaAllocationRequestsListRequestForCompute()
        {
