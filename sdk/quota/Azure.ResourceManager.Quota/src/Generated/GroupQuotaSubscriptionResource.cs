...
namespace Azure.ResourceManager.Quota
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="GroupQuotasEntityResource" /> using the GetGroupQuotaSubscription method.
    /// </summary>
    public partial class GroupQuotaSubscriptionResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string mgId, string groupQuotaName, string subscriptionId)
        {
            var resourceId = $"/providers/Microsoft.Management/managementGroups/{mgId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/subscriptions/{subscriptionId}";
        ...
        internal GroupQuotaSubscriptionResource(ArmClient client, GroupQuotaSubscriptionIdData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
