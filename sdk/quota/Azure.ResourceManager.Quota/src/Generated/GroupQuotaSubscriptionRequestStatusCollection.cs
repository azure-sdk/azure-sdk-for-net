...
namespace Azure.ResourceManager.Quota
{
    ...
    {
        private readonly ClientDiagnostics _groupQuotaSubscriptionRequestStatusSubscriptionRequestsClientDiagnostics;
        private readonly SubscriptionRequestsRestOperations _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient;
        ...
        {
            _groupQuotaSubscriptionRequestStatusSubscriptionRequestsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Quota", GroupQuotaSubscriptionRequestStatusResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(GroupQuotaSubscriptionRequestStatusResource.ResourceType, out string groupQuotaSubscriptionRequestStatusSubscriptionRequestsApiVersion);
            _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient = new SubscriptionRequestsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, groupQuotaSubscriptionRequestStatusSubscriptionRequestsApiVersion);
#if DEBUG
        ...
        public virtual async Task<Response<GroupQuotaSubscriptionRequestStatusResource>> GetAsync(string requestId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _groupQuotaSubscriptionRequestStatusSubscriptionRequestsClientDiagnostics.CreateScope("GroupQuotaSubscriptionRequestStatusCollection.Get");
            scope.Start();
            try
            {
                var response = await _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.GetAsync(Id.Parent.Name, Id.Name, requestId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GroupQuotaSubscriptionRequestStatusResource> Get(string requestId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.Get(Id.Parent.Name, Id.Name, requestId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new GroupQuotaSubscriptionRequestStatusResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.CreateListRequest(Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.CreateListNextPageRequest(nextLink, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new GroupQuotaSubscriptionRequestStatusResource(Client, GroupQuotaSubscriptionRequestStatusData.DeserializeGroupQuotaSubscriptionRequestStatusData(e)), _groupQuotaSubscriptionRequestStatusSubscriptionRequestsClientDiagnostics, Pipeline, "GroupQuotaSubscriptionRequestStatusCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string requestId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _groupQuotaSubscriptionRequestStatusSubscriptionRequestsClientDiagnostics.CreateScope("GroupQuotaSubscriptionRequestStatusCollection.Exists");
            scope.Start();
            try
            {
                var response = await _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.GetAsync(Id.Parent.Name, Id.Name, requestId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string requestId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.Get(Id.Parent.Name, Id.Name, requestId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<GroupQuotaSubscriptionRequestStatusResource>> GetIfExistsAsync(string requestId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _groupQuotaSubscriptionRequestStatusSubscriptionRequestsClientDiagnostics.CreateScope("GroupQuotaSubscriptionRequestStatusCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.GetAsync(Id.Parent.Name, Id.Name, requestId, cancellationToken: cancellationToken).ConfigureAwait(false);
