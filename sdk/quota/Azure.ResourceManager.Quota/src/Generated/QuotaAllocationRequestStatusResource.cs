...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class QuotaAllocationRequestStatusResource : ArmResource
    {
        ...
        {
            _quotaAllocationRequestStatusGroupQuotaSubscriptionQuotaAllocationRequestsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Quota", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string quotaAllocationRequestStatusGroupQuotaSubscriptionQuotaAllocationRequestsApiVersion);
        ...
        {
            using var scope = _quotaAllocationRequestStatusGroupQuotaSubscriptionQuotaAllocationRequestsClientDiagnostics.CreateScope("QuotaAllocationRequestStatusResource.Get");
            scope.Start();
            try
            {
                var response = await _quotaAllocationRequestStatusGroupQuotaSubscriptionQuotaAllocationRequestsRestClient.GetAsync(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<QuotaAllocationRequestStatusResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _quotaAllocationRequestStatusGroupQuotaSubscriptionQuotaAllocationRequestsRestClient.Get(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new QuotaAllocationRequestStatusResource(Client, response.Value), response.GetRawResponse());
            }
