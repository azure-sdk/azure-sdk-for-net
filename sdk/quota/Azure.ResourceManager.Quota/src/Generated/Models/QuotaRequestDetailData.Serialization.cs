...
namespace Azure.ResourceManager.Quota
{
    public partial class QuotaRequestDetailData : IUtf8JsonSerializable, IJsonModel<QuotaRequestDetailData>
    {
        ...
        internal static QuotaRequestDetailData DeserializeQuotaRequestDetailData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<QuotaRequestProperties> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = QuotaRequestProperties.DeserializeQuotaRequestProperties(property.Value);
                    continue;
                }
            ...
            return new QuotaRequestDetailData(id, name, type, systemData.Value, properties.Value, serializedAdditionalRawData);
        }
