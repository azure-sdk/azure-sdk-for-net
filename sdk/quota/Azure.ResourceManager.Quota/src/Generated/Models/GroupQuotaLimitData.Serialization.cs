...
namespace Azure.ResourceManager.Quota
{
    public partial class GroupQuotaLimitData : IUtf8JsonSerializable, IJsonModel<GroupQuotaLimitData>
    {
        ...
        void IJsonModel<GroupQuotaLimitData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GroupQuotaLimitData)} does not support '{format}' format.");
            }
        ...
        internal static GroupQuotaLimitData DeserializeGroupQuotaLimitData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<GroupQuotaDetails> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = GroupQuotaDetails.DeserializeGroupQuotaDetails(property.Value);
                    continue;
                }
            ...
            return new GroupQuotaLimitData(id, name, type, systemData.Value, properties.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<GroupQuotaLimitData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GroupQuotaLimitData)} does not support '{options.Format}' format.");
            }
        }
