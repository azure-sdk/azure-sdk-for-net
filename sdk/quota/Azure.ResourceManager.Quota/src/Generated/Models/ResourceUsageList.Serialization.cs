...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    internal partial class ResourceUsageList : IJsonModel<ResourceUsageList>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ResourceUsageList"/> from. </param>
        internal static ResourceUsageList FromResponse(Response response)
        {
