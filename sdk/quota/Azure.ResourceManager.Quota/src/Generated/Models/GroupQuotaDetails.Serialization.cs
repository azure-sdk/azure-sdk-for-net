...
namespace Azure.ResourceManager.Quota.Models
{
    public partial class GroupQuotaDetails : IUtf8JsonSerializable, IJsonModel<GroupQuotaDetails>
    {
        ...
        internal static GroupQuotaDetails DeserializeGroupQuotaDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IReadOnlyList<AllocatedToSubscription>> allocatedToSubscriptions = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("allocatedToSubscriptions"u8))
                {
                    ...
                    {
                        array.Add(AllocatedToSubscription.DeserializeAllocatedToSubscription(item));
                    }
            ...
            return new GroupQuotaDetails(resourceProviderScope.Value, Optional.ToNullable(limit), comment.Value, name.Value, unit.Value, Optional.ToNullable(availableLimit), Optional.ToList(allocatedToSubscriptions), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
