...
namespace Azure.ResourceManager.Quota
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ManagementGroupResource" /> using the GetGroupQuotaLimit method.
    /// </summary>
    public partial class GroupQuotaLimitResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string mgId, string resourceProviderScope, string groupQuotaName, string resourceName)
        {
            var resourceId = $"/providers/Microsoft.Management/managementGroups/{mgId}/{resourceProviderScope}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/groupQuotaLimits/{resourceName}";
        ...
        public virtual async Task<Response<GroupQuotaLimitResource>> GetAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _groupQuotaLimitRestClient.GetAsync(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.ResourceType.GetLastType(), _groupQuotaName, resourceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GroupQuotaLimitResource> Get(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _groupQuotaLimitRestClient.Get(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.ResourceType.GetLastType(), _groupQuotaName, resourceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new GroupQuotaLimitResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation<GroupQuotaLimitResource>> UpdateAsync(WaitUntil waitUntil, string resourceName, GroupQuotaLimitData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));
            ...
            try
            {
                var response = await _groupQuotaLimitRestClient.UpdateAsync(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.ResourceType.GetLastType(), _groupQuotaName, resourceName, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<GroupQuotaLimitResource> Update(WaitUntil waitUntil, string resourceName, GroupQuotaLimitData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _groupQuotaLimitRestClient.Update(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.ResourceType.GetLastType(), _groupQuotaName, resourceName, data, cancellationToken);
                var operation = new QuotaArmOperation<GroupQuotaLimitResource>(new GroupQuotaLimitOperationSource(Client), _groupQuotaLimitClientDiagnostics, Pipeline, _groupQuotaLimitRestClient.CreateUpdateRequest(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.ResourceType.GetLastType(), _groupQuotaName, resourceName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
