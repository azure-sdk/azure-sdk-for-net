...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class GroupQuotaSubscriptionRequestStatusResource : ArmResource
    {
        ...
        {
            _groupQuotaSubscriptionRequestStatusSubscriptionRequestsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Quota", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string groupQuotaSubscriptionRequestStatusSubscriptionRequestsApiVersion);
        ...
        {
            using var scope = _groupQuotaSubscriptionRequestStatusSubscriptionRequestsClientDiagnostics.CreateScope("GroupQuotaSubscriptionRequestStatusResource.Get");
            scope.Start();
            try
            {
                var response = await _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.GetAsync(Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GroupQuotaSubscriptionRequestStatusResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _groupQuotaSubscriptionRequestStatusSubscriptionRequestsRestClient.Get(Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new GroupQuotaSubscriptionRequestStatusResource(Client, response.Value), response.GetRawResponse());
            }
