...
namespace Azure.ResourceManager.Help.Samples
{
    public partial class Sample_ArmClientExtensions
    {
        ...
        public async Task CheckAvailabilityCheckNameAvailabilityOperationGroup_ExampleWhenNameIsAvailableForADiagnosticResource()
        {
            ...
            CheckNameAvailabilityResult result = await client.CheckAvailabilityCheckNameAvailabilityOperationGroupAsync(scope, content: content);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CheckAvailabilityCheckNameAvailabilityOperationGroup_ExampleWhenNameIsNotAvailableForADiagnosticResource()
        {
