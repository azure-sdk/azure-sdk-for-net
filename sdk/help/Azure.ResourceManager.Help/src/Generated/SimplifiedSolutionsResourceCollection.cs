...
namespace Azure.ResourceManager.Help
{
    ...
    {
        private readonly ClientDiagnostics _simplifiedSolutionsResourceClientDiagnostics;
        private readonly SimplifiedSolutionsResourcesRestOperations _simplifiedSolutionsResourceRestClient;
        ...
        {
            _simplifiedSolutionsResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Help", SimplifiedSolutionsResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(SimplifiedSolutionsResource.ResourceType, out string simplifiedSolutionsResourceApiVersion);
            _simplifiedSolutionsResourceRestClient = new SimplifiedSolutionsResourcesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, simplifiedSolutionsResourceApiVersion);
        }
        ...
        public virtual async Task<ArmOperation<SimplifiedSolutionsResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string simplifiedSolutionsResourceName, SimplifiedSolutionsResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _simplifiedSolutionsResourceClientDiagnostics.CreateScope("SimplifiedSolutionsResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _simplifiedSolutionsResourceRestClient.CreateAsync(Id, simplifiedSolutionsResourceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new HelpArmOperation<SimplifiedSolutionsResource>(new SimplifiedSolutionsResourceOperationSource(Client), _simplifiedSolutionsResourceClientDiagnostics, Pipeline, _simplifiedSolutionsResourceRestClient.CreateCreateRequest(Id, simplifiedSolutionsResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<SimplifiedSolutionsResource> CreateOrUpdate(WaitUntil waitUntil, string simplifiedSolutionsResourceName, SimplifiedSolutionsResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _simplifiedSolutionsResourceRestClient.Create(Id, simplifiedSolutionsResourceName, data, cancellationToken);
                var operation = new HelpArmOperation<SimplifiedSolutionsResource>(new SimplifiedSolutionsResourceOperationSource(Client), _simplifiedSolutionsResourceClientDiagnostics, Pipeline, _simplifiedSolutionsResourceRestClient.CreateCreateRequest(Id, simplifiedSolutionsResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<SimplifiedSolutionsResource>> GetAsync(string simplifiedSolutionsResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _simplifiedSolutionsResourceClientDiagnostics.CreateScope("SimplifiedSolutionsResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _simplifiedSolutionsResourceRestClient.GetAsync(Id, simplifiedSolutionsResourceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SimplifiedSolutionsResource> Get(string simplifiedSolutionsResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _simplifiedSolutionsResourceRestClient.Get(Id, simplifiedSolutionsResourceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SimplifiedSolutionsResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string simplifiedSolutionsResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _simplifiedSolutionsResourceClientDiagnostics.CreateScope("SimplifiedSolutionsResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _simplifiedSolutionsResourceRestClient.GetAsync(Id, simplifiedSolutionsResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string simplifiedSolutionsResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _simplifiedSolutionsResourceRestClient.Get(Id, simplifiedSolutionsResourceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<SimplifiedSolutionsResource>> GetIfExistsAsync(string simplifiedSolutionsResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _simplifiedSolutionsResourceClientDiagnostics.CreateScope("SimplifiedSolutionsResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _simplifiedSolutionsResourceRestClient.GetAsync(Id, simplifiedSolutionsResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
