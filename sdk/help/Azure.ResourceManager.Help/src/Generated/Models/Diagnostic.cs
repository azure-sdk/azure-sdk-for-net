...
namespace Azure.ResourceManager.Help.Models
{
    ...
    public partial class Diagnostic
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Diagnostic"/>. </summary>
        internal Diagnostic()
        {
        ...
        internal Diagnostic(string solutionId, Status? status, IReadOnlyList<Insight> insights, Error error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
