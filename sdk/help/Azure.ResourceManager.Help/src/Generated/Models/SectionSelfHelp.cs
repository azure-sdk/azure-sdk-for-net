...
namespace Azure.ResourceManager.Help.Models
{
    ...
    public partial class SectionSelfHelp
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SectionSelfHelp"/>. </summary>
        ...
        internal SectionSelfHelp(string title, string content, ReplacementMapsSelfHelp replacementMaps, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Content = content;
