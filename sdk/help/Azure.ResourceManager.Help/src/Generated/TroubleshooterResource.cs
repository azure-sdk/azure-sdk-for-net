...
namespace Azure.ResourceManager.Help
{
    ...
    public partial class TroubleshooterResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _troubleshooterResourceClientDiagnostics;
        private readonly TroubleshooterResourcesRestOperations _troubleshooterResourceRestClient;
        ...
        {
            _troubleshooterResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Help", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string troubleshooterResourceApiVersion);
            _troubleshooterResourceRestClient = new TroubleshooterResourcesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, troubleshooterResourceApiVersion);
#if DEBUG
        ...
        {
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResource.Get");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.GetAsync(Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<TroubleshooterResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _troubleshooterResourceRestClient.Get(Id.Parent, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new TroubleshooterResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation<TroubleshooterResource>> UpdateAsync(WaitUntil waitUntil, TroubleshooterResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResource.Update");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.CreateAsync(Id.Parent, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var uri = _troubleshooterResourceRestClient.CreateCreateRequestUri(Id.Parent, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new HelpArmOperation<TroubleshooterResource>(Response.FromValue(new TroubleshooterResource(Client, response), response.GetRawResponse()), rehydrationToken);
        ...
        public virtual ArmOperation<TroubleshooterResource> Update(WaitUntil waitUntil, TroubleshooterResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _troubleshooterResourceRestClient.Create(Id.Parent, Id.Name, data, cancellationToken);
                var uri = _troubleshooterResourceRestClient.CreateCreateRequestUri(Id.Parent, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new HelpArmOperation<TroubleshooterResource>(Response.FromValue(new TroubleshooterResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResource.Continue");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.ContinueAsync(Id.Parent, Id.Name, continueRequestBody, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Continue(ContinueRequestBody continueRequestBody = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _troubleshooterResourceRestClient.Continue(Id.Parent, Id.Name, continueRequestBody, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResource.End");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.EndAsync(Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response End(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _troubleshooterResourceRestClient.End(Id.Parent, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResource.Restart");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.RestartAsync(Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<RestartTroubleshooterResult> Restart(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _troubleshooterResourceRestClient.Restart(Id.Parent, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
