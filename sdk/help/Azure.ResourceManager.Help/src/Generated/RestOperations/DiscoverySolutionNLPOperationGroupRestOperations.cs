...
namespace Azure.ResourceManager.Help
{
    internal partial class DiscoverySolutionNLPOperationGroupRestOperations
    {
        ...
        public async Task<Response<DiscoveryNlpResponse>> DiscoverSolutionsAsync(DiscoveryNlpContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public Response<DiscoveryNlpResponse> DiscoverSolutions(DiscoveryNlpContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public async Task<Response<DiscoveryNlpResponse>> DiscoverSolutionsBySubscriptionAsync(string subscriptionId, DiscoveryNlpContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<DiscoveryNlpResponse> DiscoverSolutionsBySubscription(string subscriptionId, DiscoveryNlpContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(content, nameof(content));
