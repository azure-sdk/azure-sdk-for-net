...
namespace Azure.ResourceManager.Help
{
    ...
    public partial class TroubleshooterResourceCollection : ArmCollection
    {
        ...
        {
            _troubleshooterResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Help", TroubleshooterResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(TroubleshooterResource.ResourceType, out string troubleshooterResourceApiVersion);
        ...
        public virtual async Task<ArmOperation<TroubleshooterResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string troubleshooterName, TroubleshooterResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.CreateAsync(Id, troubleshooterName, data, cancellationToken).ConfigureAwait(false);
                var uri = _troubleshooterResourceRestClient.CreateCreateRequestUri(Id, troubleshooterName, data);
        ...
        public virtual ArmOperation<TroubleshooterResource> CreateOrUpdate(WaitUntil waitUntil, string troubleshooterName, TroubleshooterResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _troubleshooterResourceRestClient.Create(Id, troubleshooterName, data, cancellationToken);
                var uri = _troubleshooterResourceRestClient.CreateCreateRequestUri(Id, troubleshooterName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new HelpArmOperation<TroubleshooterResource>(Response.FromValue(new TroubleshooterResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<TroubleshooterResource>> GetAsync(string troubleshooterName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.GetAsync(Id, troubleshooterName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<TroubleshooterResource> Get(string troubleshooterName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _troubleshooterResourceRestClient.Get(Id, troubleshooterName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new TroubleshooterResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string troubleshooterName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.GetAsync(Id, troubleshooterName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string troubleshooterName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _troubleshooterResourceRestClient.Get(Id, troubleshooterName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<TroubleshooterResource>> GetIfExistsAsync(string troubleshooterName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _troubleshooterResourceClientDiagnostics.CreateScope("TroubleshooterResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _troubleshooterResourceRestClient.GetAsync(Id, troubleshooterName, cancellationToken: cancellationToken).ConfigureAwait(false);
