...
namespace Azure.ResourceManager.Help
{
    ...
    public partial class SolutionResource : ArmResource
    {
        ...
        {
            _solutionResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Help", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string solutionResourceApiVersion);
        ...
        {
            using var scope = _solutionResourceClientDiagnostics.CreateScope("SolutionResource.Get");
            scope.Start();
            try
            {
                var response = await _solutionResourceRestClient.GetAsync(Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SolutionResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionResourceRestClient.Get(Id.Parent, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SolutionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation<SolutionResource>> UpdateAsync(WaitUntil waitUntil, SolutionResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _solutionResourceClientDiagnostics.CreateScope("SolutionResource.Update");
            scope.Start();
            try
            {
                var response = await _solutionResourceRestClient.UpdateAsync(Id.Parent, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new HelpArmOperation<SolutionResource>(new SolutionResourceOperationSource(Client), _solutionResourceClientDiagnostics, Pipeline, _solutionResourceRestClient.CreateUpdateRequest(Id.Parent, Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<SolutionResource> Update(WaitUntil waitUntil, SolutionResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionResourceRestClient.Update(Id.Parent, Id.Name, patch, cancellationToken);
                var operation = new HelpArmOperation<SolutionResource>(new SolutionResourceOperationSource(Client), _solutionResourceClientDiagnostics, Pipeline, _solutionResourceRestClient.CreateUpdateRequest(Id.Parent, Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            using var scope = _solutionResourceClientDiagnostics.CreateScope("SolutionResource.WarmUp");
            scope.Start();
            try
            {
                var response = await _solutionResourceRestClient.WarmUpAsync(Id.Parent, Id.Name, solutionWarmUpRequestBody, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response WarmUp(SolutionWarmUpRequestBody solutionWarmUpRequestBody = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionResourceRestClient.WarmUp(Id.Parent, Id.Name, solutionWarmUpRequestBody, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
