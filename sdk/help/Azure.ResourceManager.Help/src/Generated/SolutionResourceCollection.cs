...
namespace Azure.ResourceManager.Help
{
    ...
    {
        private readonly ClientDiagnostics _solutionResourceClientDiagnostics;
        private readonly SolutionResourcesRestOperations _solutionResourceRestClient;
        ...
        {
            _solutionResourceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Help", SolutionResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(SolutionResource.ResourceType, out string solutionResourceApiVersion);
            _solutionResourceRestClient = new SolutionResourcesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, solutionResourceApiVersion);
        }
        ...
        public virtual async Task<ArmOperation<SolutionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string solutionResourceName, SolutionResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _solutionResourceClientDiagnostics.CreateScope("SolutionResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _solutionResourceRestClient.CreateAsync(Id, solutionResourceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new HelpArmOperation<SolutionResource>(new SolutionResourceOperationSource(Client), _solutionResourceClientDiagnostics, Pipeline, _solutionResourceRestClient.CreateCreateRequest(Id, solutionResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<SolutionResource> CreateOrUpdate(WaitUntil waitUntil, string solutionResourceName, SolutionResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionResourceRestClient.Create(Id, solutionResourceName, data, cancellationToken);
                var operation = new HelpArmOperation<SolutionResource>(new SolutionResourceOperationSource(Client), _solutionResourceClientDiagnostics, Pipeline, _solutionResourceRestClient.CreateCreateRequest(Id, solutionResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<SolutionResource>> GetAsync(string solutionResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _solutionResourceClientDiagnostics.CreateScope("SolutionResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _solutionResourceRestClient.GetAsync(Id, solutionResourceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SolutionResource> Get(string solutionResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionResourceRestClient.Get(Id, solutionResourceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SolutionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string solutionResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _solutionResourceClientDiagnostics.CreateScope("SolutionResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _solutionResourceRestClient.GetAsync(Id, solutionResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string solutionResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionResourceRestClient.Get(Id, solutionResourceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<SolutionResource>> GetIfExistsAsync(string solutionResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _solutionResourceClientDiagnostics.CreateScope("SolutionResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _solutionResourceRestClient.GetAsync(Id, solutionResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
