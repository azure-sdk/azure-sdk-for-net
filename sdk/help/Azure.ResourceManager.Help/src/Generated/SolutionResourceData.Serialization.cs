...
namespace Azure.ResourceManager.Help
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SolutionResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SolutionResourceData)} does not support writing '{format}' format.");
            }
        ...
        SolutionResourceData IJsonModel<SolutionResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SolutionResourceData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SolutionResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SolutionResourceData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SolutionResourceData IPersistableModel<SolutionResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SolutionResourceData)} does not support reading '{options.Format}' format.");
            }
        }
