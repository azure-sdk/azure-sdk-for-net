...
namespace Microsoft.Azure.Management.DelegatedNetwork.Models
{
    ...
    public partial class DelegatedSubnet : DelegatedSubnetResource
    {
        ...
        /// <summary>
        /// Gets or sets defines prefix size of CIDR blocks allocated to nodes
        /// in VnetBlock Mode.
        /// Delegated subnet's prefix size should be smaller than this by a
        /// minimum of 3.
        /// </summary>
        [JsonProperty(PropertyName = "properties.allocationBlockPrefixSize")]
        public int? AllocationBlockPrefixSize { get; set; }
        ...
        {
            if (AllocationBlockPrefixSize > 30)
            {
                throw new ValidationException(ValidationRules.InclusiveMaximum, "AllocationBlockPrefixSize", 30);
            }
            if (AllocationBlockPrefixSize < 24)
            {
                throw new ValidationException(ValidationRules.InclusiveMinimum, "AllocationBlockPrefixSize", 24);
            }
        }
    }
}
