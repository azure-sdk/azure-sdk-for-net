...
namespace Microsoft.Azure.Management.DelegatedNetwork.Models
{
    ...
    public partial class DelegatedSubnet : DelegatedSubnetResource
    {
        ...
        /// controller.</param>
        /// <param name="allocationBlockPrefixSize">Defines size of CIDR blocks
        /// allocated to nodes in VnetBlock Mode.</param>
        ...
        /// <summary>
        /// Gets or sets defines size of CIDR blocks allocated to nodes in
        /// VnetBlock Mode.
        /// </summary>
        ...
        {
            if (AllocationBlockPrefixSize > 32)
            {
                throw new ValidationException(ValidationRules.InclusiveMaximum, "AllocationBlockPrefixSize", 32);
            }
            if (AllocationBlockPrefixSize < 12)
            {
                throw new ValidationException(ValidationRules.InclusiveMinimum, "AllocationBlockPrefixSize", 12);
            }
        }
    }
}
