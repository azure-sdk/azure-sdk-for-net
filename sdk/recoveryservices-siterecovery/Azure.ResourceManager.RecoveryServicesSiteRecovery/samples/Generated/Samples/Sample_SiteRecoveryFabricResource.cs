...
"Vm1","Vm2"
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task DeleteReplicationInfrastructure_RemovesTheApplianceSInfrastructureUnderTheFabric()
        {
            ...
            // this example is just showing the usage of "ReplicationInfrastructure_Delete" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            await siteRecoveryFabric.DeleteReplicationInfrastructureAsync(WaitUntil.Completed);
