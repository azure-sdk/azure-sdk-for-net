...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class SiteRecoveryAlertResource : ArmResource
    {
        ...
        {
            _siteRecoveryAlertReplicationAlertSettingsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.RecoveryServicesSiteRecovery", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string siteRecoveryAlertReplicationAlertSettingsApiVersion);
        ...
        {
            using var scope = _siteRecoveryAlertReplicationAlertSettingsClientDiagnostics.CreateScope("SiteRecoveryAlertResource.Get");
            scope.Start();
            try
            {
                var response = await _siteRecoveryAlertReplicationAlertSettingsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteRecoveryAlertResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _siteRecoveryAlertReplicationAlertSettingsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SiteRecoveryAlertResource(Client, response.Value), response.GetRawResponse());
            }
