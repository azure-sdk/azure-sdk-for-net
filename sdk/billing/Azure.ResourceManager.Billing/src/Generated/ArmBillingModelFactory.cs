...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public static partial class ArmBillingModelFactory
    {
        ...
        /// <param name="customerName"> The name of the customer for whom the subscription was created. The field is applicable only for Microsoft Partner Agreement billing accounts. </param>
        ...
        {
            return new SubscriptionRenewalTermDetails(billingFrequency, productTypeId, quantity, skuId, termDuration, serializedAdditionalRawData: null);
        }
        ...
        public static BillingPaymentMethodData BillingPaymentMethodData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, PaymentMethodFamily? family = null, string paymentMethodType = null, string accountHolderName = null, string expiration = null, string lastFourDigits = null, string displayName = null, IEnumerable<PaymentMethodLogo> logos = null, PaymentMethodStatus? status = null)
        {
            ...
            return new BillingPaymentMethodData(id, name, resourceType, systemData, family, paymentMethodType, accountHolderName, expiration, lastFourDigits, displayName, logos?.ToList(), status, serializedAdditionalRawData: null);
        }
        ...
        {
            return new BillingPaymentMethodLinkData(id, name, resourceType, systemData, paymentMethod, serializedAdditionalRawData: null);
        }
        ...
        public static PaymentMethodProjectionProperties PaymentMethodProjectionProperties(ResourceIdentifier paymentMethodId = null, PaymentMethodFamily? family = null, string paymentMethodProjectionPropertiesType = null, string accountHolderName = null, string expiration = null, string lastFourDigits = null, string displayName = null, IEnumerable<PaymentMethodLogo> logos = null, PaymentMethodStatus? status = null)
        {
            ...
            return new PaymentMethodProjectionProperties(paymentMethodId, family, paymentMethodProjectionPropertiesType, accountHolderName, expiration, lastFourDigits, displayName, logos?.ToList(), status, serializedAdditionalRawData: null);
        }
        ...
        /// <param name="subscriptionEnrollmentAccountStatus"> The current enrollment account status of the subscription. This field is available only for the Enterprise Agreement billing accounts. </param>
        /// <param name="enrollmentAccountStartOn"> The enrollment Account and the subscription association start date. This field is available only for the Enterprise Agreement billing accounts. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.Billing.BillingSubscriptionData" /> instance for mocking. </returns>
        ...
        {
            return BillingSubscriptionData(id: id, name: name, resourceType: resourceType, systemData: systemData, autoRenew: autoRenew, beneficiaryTenantId: beneficiaryTenantId, billingFrequency: billingFrequency, billingProfileId: billingProfileId, billingPolicies: billingPolicies, billingProfileDisplayName: billingProfileDisplayName, billingProfileName: billingProfileName, consumptionCostCenter: consumptionCostCenter, customerId: customerId, customerDisplayName: customerDisplayName, customerName: default, displayName: displayName, enrollmentAccountId: enrollmentAccountId, enrollmentAccountDisplayName: enrollmentAccountDisplayName, invoiceSectionId: invoiceSectionId, invoiceSectionDisplayName: invoiceSectionDisplayName, invoiceSectionName: invoiceSectionName, lastMonthCharges: lastMonthCharges, monthToDateCharges: monthToDateCharges, nextBillingCycleBillingFrequency: nextBillingCycleBillingFrequency, offerId: offerId, productCategory: productCategory, productType: productType, productTypeId: productTypeId, purchaseOn: purchaseOn, quantity: quantity, reseller: reseller, renewalTermDetails: renewalTermDetails, skuDescription: skuDescription, skuId: skuId, status: status, subscriptionId: subscriptionId, suspensionReasons: suspensionReasons, termDuration: termDuration, termStartOn: termStartOn, termEndOn: termEndOn, subscriptionEnrollmentAccountStatus: subscriptionEnrollmentAccountStatus, enrollmentAccountStartOn: enrollmentAccountStartOn);
        }
        ...
        /// <param name="enrollmentAccountStartOn"> The enrollment Account and the subscription association start date. This field is available only for the Enterprise Agreement billing accounts. </param>
        /// <param name="billingSubscriptionId"> The ID of the billing subscription with the subscription alias. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.Billing.BillingSubscriptionAliasData" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
