...
namespace Azure.ResourceManager.Contoso
{
    ...
    public partial class EmployeeResource : ArmResource
    {
        ...
        public virtual async Task<Response<EmployeeResource>> UpdateAsync(EmployeePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _employeeRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new EmployeeResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<EmployeeResource> Update(EmployeePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _employeeRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Response.FromValue(new EmployeeResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
