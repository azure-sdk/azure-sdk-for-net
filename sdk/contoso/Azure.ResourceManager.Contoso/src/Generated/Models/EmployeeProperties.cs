...
namespace Azure.ResourceManager.Contoso.Models
{
    ...
    public partial class EmployeeProperties
    {
        ...
        internal EmployeeProperties(int? age, string city, string state, byte[] profile, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Age = age;
            City = city;
            State = state;
        ...
        /// <summary> State or province of employee. </summary>
