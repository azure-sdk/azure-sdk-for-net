...
namespace Azure.ResourceManager.Contoso.Models
{
    ...
    public partial class EmployeeProperties
    {
        ...
        internal EmployeeProperties(int? age, string city, string country, byte[] profile, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Age = age;
            City = city;
            Country = country;
        ...
        /// <summary> Country of employee. </summary>
