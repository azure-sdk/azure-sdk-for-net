...
namespace Azure.ResourceManager.Contoso
{
    ...
    public static partial class ContosoExtensions
    {
        ...
        private static MockableContosoTenantResource GetMockableContosoTenantResource(ArmResource resource)
        {
            return resource.GetCachedClient(client => new MockableContosoTenantResource(client, resource.Id));
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableContosoTenantResource.GetOperations(CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static AsyncPageable<Models.Operation> GetOperationsAsync(this TenantResource tenantResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableContosoTenantResource(tenantResource).GetOperationsAsync(cancellationToken);
        }
        ...
        public static Pageable<Models.Operation> GetOperations(this TenantResource tenantResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableContosoTenantResource(tenantResource).GetOperations(cancellationToken);
        }
    }
}
