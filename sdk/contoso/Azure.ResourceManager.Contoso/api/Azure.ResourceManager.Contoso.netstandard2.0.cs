...
namespace Azure.ResourceManager.Contoso.Models
{
    public static partial class ArmContosoModelFactory
    {
        ...
        public static Azure.ResourceManager.Contoso.Models.EmployeeProperties EmployeeProperties(int? age = default(int?), string city = null, string state = null, byte[] profile = null, Azure.ResourceManager.Contoso.Models.ProvisioningState? provisioningState = default(Azure.ResourceManager.Contoso.Models.ProvisioningState?)) { throw null; }
    }
