...
namespace Azure.ResourceManager.Contoso.Samples
{
    public partial class Sample_EmployeeResource
    {
        ...
        public async Task Get_EmployeesGet()
        {
            ...
            // this example is just showing the usage of "Employees_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task Update_EmployeesUpdate()
        {
            ...
            // this example is just showing the usage of "Employees_Update" operation, for the dependent resources, they will have to be created separately.
...
["key7952"] = "no",
                ...
                Properties = new EmployeeUpdateProperties()
                {
                    Age = 24,
                    City = "uyfg",
                    Profile = Convert.FromBase64String("oapgijcswfkruiuuzbwco"),
                },
            };
            EmployeeResource result = await employee.UpdateAsync(patch);
        ...
        public async Task Delete_EmployeesDelete()
        {
            ...
            // this example is just showing the usage of "Employees_Delete" operation, for the dependent resources, they will have to be created separately.
