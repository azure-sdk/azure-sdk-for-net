    ...
    public partial class AutomationAccountPython3PackageCollection : ArmCollection, IEnumerable<AutomationAccountPython3PackageResource>, IAsyncEnumerable<AutomationAccountPython3PackageResource>
    {
        ...
        public virtual async Task<ArmOperation<AutomationAccountPython3PackageResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string packageName, PythonPackageCreateParameters pythonPackageCreateParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AutomationArmOperation<AutomationAccountPython3PackageResource>(new AutomationAccountPython3PackageOperationSource(Client), _automationAccountPython3PackagePython3PackageClientDiagnostics, Pipeline, _automationAccountPython3PackagePython3PackageRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, packageName, pythonPackageCreateParameters).Request, response, OperationFinalStateVia.Location);
