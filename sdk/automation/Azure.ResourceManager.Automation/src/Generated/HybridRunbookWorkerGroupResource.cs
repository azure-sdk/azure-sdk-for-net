...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class HybridRunbookWorkerGroupResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridRunbookWorkerGroupResource"/> class for mocking. </summary>
        ...
        /// <summary> Gets a collection of HybridRunbookWorkerResources in the HybridRunbookWorkerGroup. </summary>
        ...
        {
            using var scope = _hybridRunbookWorkerGroupClientDiagnostics.CreateScope("HybridRunbookWorkerGroupResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _hybridRunbookWorkerGroupClientDiagnostics.CreateScope("HybridRunbookWorkerGroupResource.Delete");
            scope.Start();
            try
            {
                var response = await _hybridRunbookWorkerGroupRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var uri = _hybridRunbookWorkerGroupRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _hybridRunbookWorkerGroupRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var uri = _hybridRunbookWorkerGroupRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AutomationArmOperation(response, rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
