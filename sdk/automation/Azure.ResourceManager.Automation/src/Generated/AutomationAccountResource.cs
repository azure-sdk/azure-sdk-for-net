...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class AutomationAccountResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _deletedRunbooksClientDiagnostics;
        private readonly DeletedRunbooksRestOperations _deletedRunbooksRestClient;
        ...
        internal AutomationAccountResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _deletedRunbooksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Automation", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _deletedRunbooksRestClient = new DeletedRunbooksRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>DeletedRunbooks_ListByAutomationAccount</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _deletedRunbooksRestClient.CreateListByAutomationAccountRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _deletedRunbooksRestClient.CreateListByAutomationAccountNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, DeletedRunbook.DeserializeDeletedRunbook, _deletedRunbooksClientDiagnostics, Pipeline, "AutomationAccountResource.GetDeletedRunbooks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DeletedRunbook> GetDeletedRunbooks(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _deletedRunbooksRestClient.CreateListByAutomationAccountRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _deletedRunbooksRestClient.CreateListByAutomationAccountNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, DeletedRunbook.DeserializeDeletedRunbook, _deletedRunbooksClientDiagnostics, Pipeline, "AutomationAccountResource.GetDeletedRunbooks", "value", "nextLink", cancellationToken);
        }
