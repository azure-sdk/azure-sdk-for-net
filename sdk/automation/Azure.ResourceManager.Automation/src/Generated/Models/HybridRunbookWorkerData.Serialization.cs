...
namespace Azure.ResourceManager.Automation
{
    public partial class HybridRunbookWorkerData : IUtf8JsonSerializable
    {
        ...
        internal static HybridRunbookWorkerData DeserializeHybridRunbookWorkerData(JsonElement element)
        {
            ...
            return new HybridRunbookWorkerData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, ip.Value, Optional.ToNullable(registeredDateTime), Optional.ToNullable(lastSeenDateTime), vmResourceId.Value, Optional.ToNullable(workerType), workerName.Value);
        }
    }
}
