...
{
    public partial class AutomationPrivateEndpointConnection
    {
        internal static AutomationPrivateEndpointConnection DeserializeAutomationPrivateEndpointConnection(JsonElement element)
        {
            ...
            return new AutomationPrivateEndpointConnection(id, name, type, systemData.Value, privateEndpoint, Optional.ToList(groupIds), privateLinkServiceConnectionState.Value);
        }
    }
}
