...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationJobCollectionItemData : ResourceData
    {
        ...
        internal AutomationJobCollectionItemData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RunbookAssociationProperty runbook, Guid? jobId, string startedBy, DateTimeOffset? createdOn, AutomationJobStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, DateTimeOffset? lastModifiedOn, string provisioningState, JobRuntimeEnvironment jobRuntimeEnvironment, string runOn) : base(id, name, resourceType, systemData)
        {
            Runbook = runbook;
            JobId = jobId;
            StartedBy = startedBy;
