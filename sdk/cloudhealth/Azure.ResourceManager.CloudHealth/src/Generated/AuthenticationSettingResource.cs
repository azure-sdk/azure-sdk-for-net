...
namespace Azure.ResourceManager.CloudHealth
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct an <see cref="AuthenticationSettingResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetAuthenticationSettingResource method.
    /// Otherwise you can get one from its parent resource <see cref="HealthModelResource"/> using the GetAuthenticationSetting method.
    /// </summary>
    public partial class AuthenticationSettingResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="AuthenticationSettingResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="AuthenticationSettingResource"/> class for mocking. </summary>
        protected AuthenticationSettingResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AuthenticationSettingResource"/> class. </summary>
        ...
        public virtual async Task<Response<AuthenticationSettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AuthenticationSettingResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _authenticationSettingClientDiagnostics.CreateScope("AuthenticationSettingResource.Get");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<AuthenticationSettingResource>> UpdateAsync(WaitUntil waitUntil, AuthenticationSettingData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<AuthenticationSettingResource> Update(WaitUntil waitUntil, AuthenticationSettingData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
