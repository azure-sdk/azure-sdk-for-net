...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class EntityLinkingResult
    {
        internal static EntityLinkingResult DeserializeEntityLinkingResult(JsonElement element)
        {
            ...
            IReadOnlyList<LinkedEntitiesDocumentResult> documents = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<LinkedEntitiesDocumentResult> array = new List<LinkedEntitiesDocumentResult>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(LinkedEntitiesDocumentResult.DeserializeLinkedEntitiesDocumentResult(item));
                    }
                    documents = array;
                    continue;
                }
