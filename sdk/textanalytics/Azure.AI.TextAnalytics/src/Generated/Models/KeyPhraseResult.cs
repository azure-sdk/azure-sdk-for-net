...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class KeyPhraseResult
    {
        ...
        internal KeyPhraseResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<KeyPhrasesDocumentResult> documents)
        {
        ...
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        /// <param name="documents"> Response by document. </param>
        internal KeyPhraseResult(IReadOnlyList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IReadOnlyList<KeyPhrasesDocumentResult> documents)
        {
            Errors = errors;
        ...
        public IReadOnlyList<KeyPhrasesDocumentResult> Documents { get; }
    }
}
