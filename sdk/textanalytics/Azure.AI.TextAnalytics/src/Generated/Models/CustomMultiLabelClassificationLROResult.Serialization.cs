...
{
    internal partial class CustomMultiLabelClassificationLROResult
    {
        internal static CustomMultiLabelClassificationLROResult DeserializeCustomMultiLabelClassificationLROResult(JsonElement element)
        {
            ...
            return new CustomMultiLabelClassificationLROResult(lastUpdateDateTime, status, taskName, kind, results);
        }
