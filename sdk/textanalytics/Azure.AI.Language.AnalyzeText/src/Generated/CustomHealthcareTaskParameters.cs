...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class CustomHealthcareTaskParameters
    {
        ...
        internal CustomHealthcareTaskParameters(bool? loggingOptOut, string projectName, string deploymentName, StringIndexType? stringIndexType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="CustomHealthcareTaskParameters"/> for deserialization. </summary>
        internal CustomHealthcareTaskParameters()
        {
        }
