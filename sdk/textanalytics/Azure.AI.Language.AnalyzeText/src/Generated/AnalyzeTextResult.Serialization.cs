    ...
    public partial class AnalyzeTextResult : IUtf8JsonSerializable, IJsonModel<AnalyzeTextResult>
    {
        ...
        internal static AnalyzeTextResult DeserializeAnalyzeTextResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("kind", out JsonElement discriminator))
            {
                ...
                {
                    case "DynamicClassificationResults": return DynamicClassificationResult.DeserializeDynamicClassificationResult(element, options);
                    case "EntityLinkingResults": return EntityLinkingResult.DeserializeEntityLinkingResult(element, options);
                    case "EntityRecognitionResults": return EntitiesResult.DeserializeEntitiesResult(element, options);
                    case "KeyPhraseExtractionResults": return KeyPhraseResult.DeserializeKeyPhraseResult(element, options);
                    case "LanguageDetectionResults": return LanguageDetectionResult.DeserializeLanguageDetectionResult(element, options);
                    case "PiiEntityRecognitionResults": return PiiResult.DeserializePiiResult(element, options);
                    case "SentimentAnalysisResults": return SentimentResult.DeserializeSentimentResult(element, options);
                }
            }
