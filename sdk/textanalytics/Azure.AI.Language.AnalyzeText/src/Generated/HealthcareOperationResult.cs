...
namespace Azure.AI.Language.Text
{
    ...
    public partial class HealthcareOperationResult : AnalyzeTextOperationResult
    {
        ...
        internal HealthcareOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, HealthcareResult results) : base(lastUpdateDateTime, status)
        {
        ...
        /// <param name="results"> Results of the task. </param>
        internal HealthcareOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, string name, AnalyzeTextOperationResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, HealthcareResult results) : base(lastUpdateDateTime, status, name, kind, serializedAdditionalRawData)
        {
            Results = results;
        }
