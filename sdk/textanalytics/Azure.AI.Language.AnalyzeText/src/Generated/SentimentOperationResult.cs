...
namespace Azure.AI.Language.Text
{
    ...
    public partial class SentimentOperationResult : AnalyzeTextOperationResult
    {
        ...
        internal SentimentOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, SentimentResult results) : base(lastUpdateDateTime, status)
        {
        ...
        /// <param name="results"> The sentiment analysis results. </param>
        internal SentimentOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, string name, AnalyzeTextOperationResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, SentimentResult results) : base(lastUpdateDateTime, status, name, kind, serializedAdditionalRawData)
        {
            Results = results;
        }
