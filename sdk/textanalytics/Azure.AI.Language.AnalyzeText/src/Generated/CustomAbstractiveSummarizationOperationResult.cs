...
namespace Azure.AI.Language.Text
{
    ...
    public partial class CustomAbstractiveSummarizationOperationResult : AnalyzeTextOperationResult
    {
        ...
        internal CustomAbstractiveSummarizationOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, CustomAbstractiveSummarizationResult results) : base(lastUpdateDateTime, status)
        {
