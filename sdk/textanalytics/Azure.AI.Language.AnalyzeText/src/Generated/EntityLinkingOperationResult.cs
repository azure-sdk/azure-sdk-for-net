...
namespace Azure.AI.Language.Text
{
    ...
    public partial class EntityLinkingOperationResult : AnalyzeTextOperationResult
    {
        ...
        internal EntityLinkingOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, EntityLinkingResult results) : base(lastUpdateDateTime, status)
        {
        ...
        /// <param name="results"> Entity linking result. </param>
        internal EntityLinkingOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, string name, AnalyzeTextOperationResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, EntityLinkingResult results) : base(lastUpdateDateTime, status, name, kind, serializedAdditionalRawData)
        {
            Results = results;
        }
