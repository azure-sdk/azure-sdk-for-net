...
namespace Azure.AI.Language.Text
{
    ...
    public partial class KeyPhraseExtractionOperationResult : AnalyzeTextOperationResult
    {
        ...
        internal KeyPhraseExtractionOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, KeyPhraseResult results) : base(lastUpdateDateTime, status)
        {
        ...
        /// <param name="results"> The list of Key phrase extraction results. </param>
        internal KeyPhraseExtractionOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, string name, AnalyzeTextOperationResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, KeyPhraseResult results) : base(lastUpdateDateTime, status, name, kind, serializedAdditionalRawData)
        {
            Results = results;
        }
