...
namespace Azure.AI.Language.Text
{
    ...
    public partial class KeyPhraseOperationAction : AnalyzeTextOperationAction
    {
        ...
        internal KeyPhraseOperationAction(string name, AnalyzeTextOperationActionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, KeyPhraseTaskActionContent actionContent) : base(name, kind, serializedAdditionalRawData)
        {
