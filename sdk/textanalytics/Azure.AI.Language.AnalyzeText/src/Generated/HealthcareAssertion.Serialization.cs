        ...
        internal static HealthcareAssertion DeserializeHealthcareAssertion(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("conditionality"u8))
                {
                    ...
                    conditionality = new HealthcareAssertionConditionality(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("certainty"u8))
                {
                    ...
                    certainty = new HealthcareAssertionCertainty(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("association"u8))
                {
                    ...
                    association = new HealthcareAssertionAssociation(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("temporality"u8))
                {
                    ...
                    temporality = new HealthcareAssertionTemporality(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
