...
{
    public partial class RedactionPolicy : IUtf8JsonSerializable, IJsonModel<RedactionPolicy>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedactionPolicy>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<RedactionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RedactionPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsDefined(PolicyKind))
            {
                writer.WritePropertyName("policyKind"u8);
                writer.WriteStringValue(PolicyKind.Value.ToString());
            }
        ...
        RedactionPolicy IJsonModel<RedactionPolicy>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RedactionPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static RedactionPolicy DeserializeRedactionPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RedactionPolicy(policyKind, redactionCharacter, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<RedactionPolicy>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RedactionPolicy>)this).GetFormatFromOptions(options) : options.Format;
        ...
        RedactionPolicy IPersistableModel<RedactionPolicy>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RedactionPolicy>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static RedactionPolicy FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeRedactionPolicy(document.RootElement);
        }
