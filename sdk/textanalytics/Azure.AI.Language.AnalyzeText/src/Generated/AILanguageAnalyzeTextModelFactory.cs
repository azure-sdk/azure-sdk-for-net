...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public static partial class AILanguageAnalyzeTextModelFactory
    {
        ...
        public static SentimentDocumentResultWithDetectedLanguage SentimentDocumentResultWithDetectedLanguage(string id = null, IEnumerable<DocumentWarning> warnings = null, DocumentStatistics statistics = null, SentimentDocumentResultWithDetectedLanguageSentiment sentiment = default, SentimentConfidenceScores confidenceScores = null, IEnumerable<SentenceSentiment> sentences = null, DetectedLanguage detectedLanguage = null)
        {
            warnings ??= new List<DocumentWarning>();
        ...
        public static SentenceSentiment SentenceSentiment(string text = null, SentenceSentimentSentiment sentiment = default, SentimentConfidenceScores confidenceScores = null, int offset = default, int length = default, IEnumerable<SentenceTarget> targets = null, IEnumerable<SentenceAssessment> assessments = null)
        {
        ...
        public static SentenceTarget SentenceTarget(SentenceTargetSentiment sentiment = default, TargetConfidenceScoreLabel confidenceScores = null, int offset = default, int length = default, string text = null, IEnumerable<TargetRelation> relations = null)
        {
        ...
        public static TargetRelation TargetRelation(string @ref = null, TargetRelationRelationType relationType = default)
        {
        ...
        public static SentenceAssessment SentenceAssessment(SentenceAssessmentSentiment sentiment = default, TargetConfidenceScoreLabel confidenceScores = null, int offset = default, int length = default, string text = null, bool isNegated = default)
        {
        ...
        public static CustomSentenceSentiment CustomSentenceSentiment(string text = null, CustomSentenceSentimentSentiment sentiment = default, SentimentConfidenceScores confidenceScores = null, int offset = default, int length = default)
        {
        ...
        public static CustomSentimentAnalysisResultDocument CustomSentimentAnalysisResultDocument(string id = null, IEnumerable<DocumentWarning> warnings = null, DocumentStatistics statistics = null, CustomSentimentAnalysisResultDocumentSentiment sentiment = default, SentimentConfidenceScores confidenceScores = null, IEnumerable<CustomSentenceSentiment> sentences = null, DetectedLanguage detectedLanguage = null)
        {
            warnings ??= new List<DocumentWarning>();
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeText.CustomHealthcareTaskParameters"/>. </summary>
        /// <param name="loggingOptOut"> logging opt out. </param>
        /// <param name="projectName"> This field indicates the project name for the model. </param>
        /// <param name="deploymentName"> This field indicates the deployment name for the model. </param>
        /// <param name="stringIndexType"> Optional parameter to provide the string index type used to interpret string offsets. Defaults to TextElements (Graphemes). </param>
        /// <returns> A new <see cref="AnalyzeText.CustomHealthcareTaskParameters"/> instance for mocking. </returns>
        public static CustomHealthcareTaskParameters CustomHealthcareTaskParameters(bool? loggingOptOut = null, string projectName = null, string deploymentName = null, StringIndexType? stringIndexType = null)
        {
            return new CustomHealthcareTaskParameters(loggingOptOut, projectName, deploymentName, stringIndexType, serializedAdditionalRawData: null);
        }
