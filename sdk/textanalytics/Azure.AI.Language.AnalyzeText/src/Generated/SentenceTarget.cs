...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class SentenceTarget
    {
        ...
        internal SentenceTarget(SentenceTargetSentiment sentiment, TargetConfidenceScoreLabel confidenceScores, int offset, int length, string text, IEnumerable<TargetRelation> relations)
        {
        ...
        internal SentenceTarget(SentenceTargetSentiment sentiment, TargetConfidenceScoreLabel confidenceScores, int offset, int length, string text, IReadOnlyList<TargetRelation> relations, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
            Offset = offset;
        ...
        public SentenceTargetSentiment Sentiment { get; }
