...
namespace Azure.AI.Language.Text
{
    ...
    public partial class ActionStatus
    {
        ...
        internal ActionStatus(int completed, int failed, int inProgress, int total)
        {
            Completed = completed;
            Failed = failed;
        ...
        internal ActionStatus(int completed, int failed, int inProgress, int total, IReadOnlyList<AnalyzeTextOperationResult> items, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Completed = completed;
            Failed = failed;
            InProgress = inProgress;
        ...
        /// <summary> Initializes a new instance of <see cref="ActionStatus"/> for deserialization. </summary>
