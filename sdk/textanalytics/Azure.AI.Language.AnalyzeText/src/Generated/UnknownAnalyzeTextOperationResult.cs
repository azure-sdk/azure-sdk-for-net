...
namespace Azure.AI.Language.Text
{
    ...
    internal partial class UnknownAnalyzeTextOperationResult : AnalyzeTextOperationResult
    {
        ...
        internal UnknownAnalyzeTextOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, string name, AnalyzeTextOperationResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(lastUpdateDateTime, status, name, kind, serializedAdditionalRawData)
        {
        }
