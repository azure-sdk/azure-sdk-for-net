...
namespace Azure.AI.Language.Text
{
    ...
    public partial class CustomHealthcareOperationResult : AnalyzeTextOperationResult
    {
        ...
        internal CustomHealthcareOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, CustomHealthcareResult results) : base(lastUpdateDateTime, status)
        {
