...
namespace Azure.AI.Language.Text
{
    ...
    public partial class PiiActionContent
    {
        ...
        /// <param name="redactionPolicy"> RedactionPolicy to be used on the input. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal PiiActionContent(bool? loggingOptOut, string modelVersion, PiiDomain? domain, IList<PiiCategory> piiCategories, StringIndexType? stringIndexType, IList<PiiCategoriesExclude> excludePiiCategories, RedactionPolicy redactionPolicy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> RedactionPolicy to be used on the input. </summary>
        public RedactionPolicy RedactionPolicy { get; set; }
    }
}
