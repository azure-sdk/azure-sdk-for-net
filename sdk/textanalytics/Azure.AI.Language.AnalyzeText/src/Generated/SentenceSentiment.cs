...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class SentenceSentiment
    {
        ...
        internal SentenceSentiment(string text, SentenceSentimentSentiment sentiment, SentimentConfidenceScores confidenceScores, int offset, int length)
        {
        ...
        internal SentenceSentiment(string text, SentenceSentimentSentiment sentiment, SentimentConfidenceScores confidenceScores, int offset, int length, IReadOnlyList<SentenceTarget> targets, IReadOnlyList<SentenceAssessment> assessments, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
        ...
        public SentenceSentimentSentiment Sentiment { get; }
