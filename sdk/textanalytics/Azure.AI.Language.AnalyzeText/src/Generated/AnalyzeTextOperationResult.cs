...
namespace Azure.AI.Language.Text
{
    ...
    public abstract partial class AnalyzeTextOperationResult
    {
        ...
        protected AnalyzeTextOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status)
        {
        ...
        internal AnalyzeTextOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, string name, AnalyzeTextOperationResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LastUpdateDateTime = lastUpdateDateTime;
            Status = status;
            Name = name;
