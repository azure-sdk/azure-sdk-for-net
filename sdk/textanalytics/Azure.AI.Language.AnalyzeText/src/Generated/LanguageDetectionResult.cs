...
namespace Azure.AI.Language.Text
{
    ...
    public partial class LanguageDetectionResult : AnalyzeTextResult
    {
        ...
        internal LanguageDetectionResult(LanguageDetectionResult results)
        {
        ...
        /// <param name="results"> Contains the language detection results. </param>
        internal LanguageDetectionResult(AnalyzeTextResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, LanguageDetectionResult results) : base(kind, serializedAdditionalRawData)
        {
            Results = results;
        }
