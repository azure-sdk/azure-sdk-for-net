...
{
    /// <summary> Enum for sentiment in SentenceSentiment. </summary>
    public readonly partial struct SentenceSentimentSentiment : IEquatable<SentenceSentimentSentiment>
    {
        private readonly string _value;

        /// <summary> Initializes a new instance of <see cref="SentenceSentimentSentiment"/>. </summary>
        ...
        /// <inheritdoc />
        public bool Equals(SentenceSentimentSentiment other) => string.Equals(_value, other._value, StringComparison.InvariantCultureIgnoreCase);
