...
namespace Azure.AI.Language.Text
{
    ...
    public partial class TextKeyPhraseExtractionInput : AnalyzeTextInput
    {
        ...
        internal TextKeyPhraseExtractionInput(AnalyzeTextInputKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, MultiLanguageTextInput textInput, KeyPhraseTaskActionContent actionContent) : base(kind, serializedAdditionalRawData)
        {
            TextInput = textInput;
        ...
        public KeyPhraseTaskActionContent ActionContent { get; set; }
    }
}
