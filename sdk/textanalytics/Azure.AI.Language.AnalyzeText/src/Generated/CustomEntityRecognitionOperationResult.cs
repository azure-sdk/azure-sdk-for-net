...
namespace Azure.AI.Language.Text
{
    ...
    public partial class CustomEntityRecognitionOperationResult : AnalyzeTextOperationResult
    {
        ...
        internal CustomEntityRecognitionOperationResult(DateTimeOffset lastUpdateDateTime, CurrentState status, CustomEntitiesResultWithDocumentDetectedLanguage results) : base(lastUpdateDateTime, status)
        {
