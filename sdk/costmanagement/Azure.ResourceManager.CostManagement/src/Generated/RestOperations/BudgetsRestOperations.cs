...
namespace Azure.ResourceManager.CostManagement
{
    internal partial class BudgetsRestOperations
    {
        ...
        public BudgetsRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default, string filter = null)
        {
        ...
        internal HttpMessage CreateListRequest(string scope)
        {
            ...
            if (_filter != null)
            {
                uri.AppendQuery("$filter", _filter, true);
            }
            request.Uri = uri;
