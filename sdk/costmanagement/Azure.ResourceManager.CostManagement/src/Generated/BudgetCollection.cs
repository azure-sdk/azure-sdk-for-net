...
namespace Azure.ResourceManager.CostManagement
{
    ...
    public partial class BudgetCollection : ArmCollection, IEnumerable<BudgetResource>, IAsyncEnumerable<BudgetResource>
    {
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _budgetRestClient.CreateListRequest(Id);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _budgetRestClient.CreateListNextPageRequest(nextLink, Id);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new BudgetResource(Client, BudgetData.DeserializeBudgetData(e)), _budgetClientDiagnostics, Pipeline, "BudgetCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<BudgetResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _budgetRestClient.CreateListRequest(Id);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _budgetRestClient.CreateListNextPageRequest(nextLink, Id);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new BudgetResource(Client, BudgetData.DeserializeBudgetData(e)), _budgetClientDiagnostics, Pipeline, "BudgetCollection.GetAll", "value", "nextLink", cancellationToken);
        }
