...
namespace Azure.ResourceManager.CostManagement
{
    ...
    public partial class ScheduledActionData : ResourceData
    {
        ...
        /// <summary> Resource Etag. For update calls, eTag is mandatory. Fetch the resource's eTag by doing a 'GET' call first and then including the latest eTag as part of the request body or 'If-Match' header while performing the update. For create calls, eTag is not required. </summary>
