...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class Notification
    {
        ...
        ///  Supported for CategoryType(s): Cost, ReservationUtilization.
        /// </param>
        internal Notification(bool enabled, BudgetNotificationOperatorType @operator, float threshold, Frequency? frequency, IList<string> contactEmails, IList<string> contactRoles, IList<string> contactGroups, ThresholdType? thresholdType, CultureCode? locale)
        {
            Enabled = enabled;
            Operator = @operator;
            Threshold = threshold;
