...
namespace Azure.ResourceManager.Datadog.Mocking
{
    ...
    public partial class MockableDatadogSubscriptionResource : ArmResource
    {
        ...
        public virtual AsyncPageable<CreateResourceSupportedResponse> GetCreationSupportedsAsync(string datadogOrganizationId, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => CreateResourceSupportedResponse.DeserializeCreateResourceSupportedResponse(e), CreationSupportedClientDiagnostics, Pipeline, "MockableDatadogSubscriptionResource.GetCreationSupporteds", "value", null, cancellationToken);
        }
        ...
        public virtual Pageable<CreateResourceSupportedResponse> GetCreationSupporteds(string datadogOrganizationId, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreationSupportedRestClient.CreateListRequest(Id.SubscriptionId, datadogOrganizationId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => CreateResourceSupportedResponse.DeserializeCreateResourceSupportedResponse(e), CreationSupportedClientDiagnostics, Pipeline, "MockableDatadogSubscriptionResource.GetCreationSupporteds", "value", null, cancellationToken);
        }
