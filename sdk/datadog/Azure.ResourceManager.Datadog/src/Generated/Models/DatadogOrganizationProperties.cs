...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class DatadogOrganizationProperties
    {
        ...
        internal DatadogOrganizationProperties(string name, string id, string linkingAuthCode, string linkingClientId, string redirectUri, string apiKey, string applicationKey, string enterpriseAppId, bool? cspm, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
