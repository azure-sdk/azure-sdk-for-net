...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public static partial class ArmDatadogModelFactory
    {
        ...
        {
            return new CreateResourceSupportedResponse(properties);
        }
        ...
        {
            return new CreateResourceSupportedProperties(name, creationSupported);
        }
        ...
        public static MonitoringTagRulesProperties MonitoringTagRulesProperties(ProvisioningState? provisioningState = null, LogRules logRules = null, IEnumerable<FilteringTag> metricRulesFilteringTags = null, bool? automuting = null)
        {
            ...
            return new MonitoringTagRulesProperties(provisioningState, logRules, metricRulesFilteringTags != null ? new MetricRules(metricRulesFilteringTags?.ToList()) : null, automuting);
        }
        ...
        /// <summary> Initializes a new instance of MonitoredSubscriptionPropertyData. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new MonitoredSubscriptionPropertyData(id, name, resourceType, systemData, properties);
        }
    }
}
