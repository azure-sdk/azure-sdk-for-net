        ...
        public async Task CreateOrUpdate_MonitorsAddMonitoredSubscriptions()
        {
            ...
            MonitoredSubscriptionPropertyData data = new MonitoredSubscriptionPropertyData
            {
                Properties = new SubscriptionList
                {
                    ...
                    MonitoredSubscriptionList = {new MonitoredSubscription("/subscriptions/00000000-0000-0000-0000-000000000000")
{
...
}, new MonitoredSubscription("/subscriptions/00000000-0000-0000-0000-000000000001")
{
