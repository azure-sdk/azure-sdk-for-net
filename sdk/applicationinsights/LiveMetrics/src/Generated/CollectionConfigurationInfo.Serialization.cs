...
namespace LiveMetrics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CollectionConfigurationInfo>)this).Write(writer, ModelSerializationExtensions.WireOptions);
