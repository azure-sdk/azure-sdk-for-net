...
namespace Azure.ResourceManager.Offazurespringboot.Mocking
{
    ...
    public partial class MockableOffazurespringbootArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableOffazurespringbootArmClient"/> class for mocking. </summary>
        protected MockableOffazurespringbootArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableOffazurespringbootArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableOffazurespringbootArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableOffazurespringbootArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
