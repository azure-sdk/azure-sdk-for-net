...
namespace Azure.ResourceManager.Offazurespringboot
{
    ...
    public partial class SummaryCollection : ArmCollection, IEnumerable<SummaryResource>, IAsyncEnumerable<SummaryResource>
    {
        ...
        {
            _summaryClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Offazurespringboot", SummaryResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SummaryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string summaryName, SummaryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new OffazurespringbootArmOperation<SummaryResource>(Response.FromValue(new SummaryResource(Client, response), response.GetRawResponse()));
