...
namespace Azure.ResourceManager.Offazurespringboot
{
    ...
    public partial class ErrorSummaryCollection : ArmCollection, IEnumerable<ErrorSummaryResource>, IAsyncEnumerable<ErrorSummaryResource>
    {
        ...
        {
            _errorSummaryClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Offazurespringboot", ErrorSummaryResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ErrorSummaryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string errorSummaryName, ErrorSummaryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new OffazurespringbootArmOperation<ErrorSummaryResource>(Response.FromValue(new ErrorSummaryResource(Client, response), response.GetRawResponse()));
