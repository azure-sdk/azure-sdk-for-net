...
namespace Azure.ResourceManager.Offazurespringboot.Models
{
    ...
    public static partial class ArmOffazurespringbootModelFactory
    {
        ...
        public static SpringbootsitesModelData SpringbootsitesModelData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SpringbootsitesProperties properties = null, SpringbootsitesModelExtendedLocation extendedLocation = null)
        {
            ...
            return new SpringbootsitesModelData(id, name, resourceType, systemData, tags, location, properties, extendedLocation, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.SpringbootsitesProperties"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.SpringbootsitesProperties"/> instance for mocking. </returns>
        public static SpringbootsitesProperties SpringbootsitesProperties(string masterSiteId = null, string migrateProjectId = null, ProvisioningState? provisioningState = null)
        {
            return new SpringbootsitesProperties(masterSiteId, migrateProjectId, provisioningState, serializedAdditionalRawData: null);
        }
        ...
        {
            return new SpringbootappsModelData(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        public static SpringbootappsProperties SpringbootappsProperties(string appName = null, string artifactName = null, int? appPort = null, string appType = null, IEnumerable<SpringbootappsPropertiesApplicationConfigurationsItem> applicationConfigurations = null, IEnumerable<int> bindingPorts = null, string buildJdkVersion = null, IEnumerable<string> certificates = null, string checksum = null, IEnumerable<string> dependencies = null, IEnumerable<string> environments = null, int? instanceCount = null, string jarFileLocation = null, int? jvmMemoryInMB = null, IEnumerable<string> jvmOptions = null, IEnumerable<SpringbootappsPropertiesMiscsItem> miscs = null, IEnumerable<SpringbootappsPropertiesInstancesItem> instances = null, string runtimeJdkVersion = null, IEnumerable<string> servers = null, IEnumerable<string> machineArmIds = null, string siteName = null, string springBootVersion = null, IEnumerable<string> staticContentLocations = null, IEnumerable<string> connectionStrings = null, DateTimeOffset? lastModifiedOn = null, DateTimeOffset? lastUpdatedOn = null, ProvisioningState? provisioningState = null, IEnumerable<Error> errors = null)
        {
            ...
            return new SpringbootappsProperties(appName, artifactName, appPort, appType, applicationConfigurations?.ToList(), bindingPorts?.ToList(), buildJdkVersion, certificates?.ToList(), checksum, dependencies?.ToList(), environments?.ToList(), instanceCount, jarFileLocation, jvmMemoryInMB, jvmOptions?.ToList(), miscs?.ToList(), instances?.ToList(), runtimeJdkVersion, servers?.ToList(), machineArmIds?.ToList(), siteName, springBootVersion, staticContentLocations?.ToList(), connectionStrings?.ToList(), lastModifiedOn, lastUpdatedOn, provisioningState, errors?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        {
            return new SpringbootserversModelData(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.SpringbootserversProperties"/>. </summary>
        ...
        /// <param name="errors"> The list of errors. </param>
        /// <param name="provisioningState"> The resource provisioning state. </param>
        /// <returns> A new <see cref="Models.SpringbootserversProperties"/> instance for mocking. </returns>
        public static SpringbootserversProperties SpringbootserversProperties(int? port = null, string server = null, IEnumerable<string> fqdnAndIPAddressList = null, string machineArmId = null, int? totalApps = null, int? springBootApps = null, IEnumerable<Error> errors = null, ProvisioningState? provisioningState = null)
        {
            fqdnAndIPAddressList ??= new List<string>();
            errors ??= new List<Error>();

            return new SpringbootserversProperties(port, server, fqdnAndIPAddressList?.ToList(), machineArmId, totalApps, springBootApps, errors?.ToList(), provisioningState, serializedAdditionalRawData: null);
        }
        ...
        public static SpringbootsitesModelPatch SpringbootsitesModelPatch(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SpringbootsitesProperties properties = null)
        {
            ...
            return new SpringbootsitesModelPatch(id, name, resourceType, systemData, tags, location, properties, serializedAdditionalRawData: null);
        }
        ...
        public static ErrorSummaryData ErrorSummaryData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ErrorSummariesProperties properties = null)
        {
            return new ErrorSummaryData(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.ErrorSummariesProperties"/>. </summary>
        /// <param name="discoveryScopeErrorSummaries"> The list of ErrorSummary. </param>
        /// <param name="errors"> The list of errors. </param>
        /// <param name="provisioningState"> The resource provisioning state. </param>
        /// <returns> A new <see cref="Models.ErrorSummariesProperties"/> instance for mocking. </returns>
        public static ErrorSummariesProperties ErrorSummariesProperties(IEnumerable<ErrorSummaryModel> discoveryScopeErrorSummaries = null, IEnumerable<Error> errors = null, ProvisioningState? provisioningState = null)
        {
            discoveryScopeErrorSummaries ??= new List<ErrorSummaryModel>();
            errors ??= new List<Error>();

            return new ErrorSummariesProperties(discoveryScopeErrorSummaries?.ToList(), errors?.ToList(), provisioningState, serializedAdditionalRawData: null);
        }
        ...
        {
            return new SpringbootappsModelPatch(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        {
            return new SpringbootserversModelPatch(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        public static SummaryData SummaryData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SummariesProperties properties = null)
        {
            return new SummaryData(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.SummariesProperties"/>. </summary>
        ...
        /// <param name="errors"> The list of errors. </param>
        /// <param name="provisioningState"> The resource provisioning state. </param>
        /// <returns> A new <see cref="Models.SummariesProperties"/> instance for mocking. </returns>
        public static SummariesProperties SummariesProperties(long? discoveredServers = null, long? discoveredApps = null, IEnumerable<Error> errors = null, ProvisioningState? provisioningState = null)
        {
            errors ??= new List<Error>();

            return new SummariesProperties(discoveredServers, discoveredApps, errors?.ToList(), provisioningState, serializedAdditionalRawData: null);
        }
    }
}
