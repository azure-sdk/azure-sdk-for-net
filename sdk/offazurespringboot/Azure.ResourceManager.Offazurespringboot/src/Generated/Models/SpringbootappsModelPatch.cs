...
namespace Azure.ResourceManager.Offazurespringboot.Models
{
    ...
    public partial class SpringbootappsModelPatch : ResourceData
    {
        ...
        internal SpringbootappsModelPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SpringbootappsProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
