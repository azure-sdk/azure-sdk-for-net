...
namespace Azure.ResourceManager.Offazurespringboot.Models
{
    ...
    public partial class SpringbootserversProperties
    {
        ...
        internal SpringbootserversProperties(int? port, string server, IList<string> fqdnAndIPAddressList, string machineArmId, int? totalApps, int? springBootApps, IList<Error> errors, ProvisioningState? provisioningState, IDictionary<string, string> labels, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Port = port;
            Server = server;
        ...
        /// <summary> Initializes a new instance of <see cref="SpringbootserversProperties"/> for deserialization. </summary>
        internal SpringbootserversProperties()
        {
        }
        ...
        /// <summary> Resource labels. </summary>
