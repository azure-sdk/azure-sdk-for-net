...
namespace Azure.ResourceManager.Offazurespringboot.Models
{
    ...
    public partial class SpringbootserversProperties
    {
        ...
        internal SpringbootserversProperties(int? port, string server, IList<string> fqdnAndIPAddressList, string machineArmId, int? totalApps, int? springBootApps, IList<Error> errors, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Port = port;
            Server = server;
