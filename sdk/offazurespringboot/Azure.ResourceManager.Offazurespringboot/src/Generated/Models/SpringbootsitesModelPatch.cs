...
namespace Azure.ResourceManager.Offazurespringboot.Models
{
    ...
    public partial class SpringbootsitesModelPatch
    {
        /// <summary>
        ...
        internal SpringbootsitesModelPatch(IDictionary<string, string> tags, SpringbootsitesProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
