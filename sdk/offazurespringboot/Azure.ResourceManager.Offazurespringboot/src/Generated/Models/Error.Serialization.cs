...
namespace Azure.ResourceManager.Offazurespringboot.Models
{
    public partial class Error : IUtf8JsonSerializable
    {
        ...
        internal static Error DeserializeError(JsonElement element)
        {
            ...
            return new Error(Optional.ToNullable(id), code.Value, summaryMessage.Value, runAsAccountId.Value, message.Value, possibleCauses.Value, recommendedAction.Value, severity.Value, Optional.ToNullable(updatedTimeStamp));
        }
    }
}
