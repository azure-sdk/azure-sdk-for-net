...
namespace Azure.ResourceManager.Offazurespringboot.Models
{
    public partial class Error : IUtf8JsonSerializable, IJsonModel<Error>
    {
        ...
        internal static Error DeserializeError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Error(Optional.ToNullable(id), code.Value, summaryMessage.Value, runAsAccountId.Value, message.Value, possibleCauses.Value, recommendedAction.Value, severity.Value, Optional.ToNullable(updatedTimeStamp), serializedAdditionalRawData);
        }
