...
{
    public partial class SpringbootsitesProperties : IUtf8JsonSerializable
    {
        ...
        internal static SpringbootsitesProperties DeserializeSpringbootsitesProperties(JsonElement element)
        {
            ...
            return new SpringbootsitesProperties(masterSiteId.Value, migrateProjectId.Value, Optional.ToNullable(provisioningState));
        }
    }
}
