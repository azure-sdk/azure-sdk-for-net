...
{
    public partial class SpringbootappsProperties : IUtf8JsonSerializable, IJsonModel<SpringbootappsProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpringbootappsProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SpringbootappsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SpringbootappsProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SpringbootappsProperties)} does not support '{format}' format.");
            }
        ...
        SpringbootappsProperties IJsonModel<SpringbootappsProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SpringbootappsProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeSpringbootappsProperties(document.RootElement, options);
        }

        internal static SpringbootappsProperties DeserializeSpringbootappsProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("applicationConfigurations"u8))
                {
                    ...
                    {
                        array.Add(SpringbootappsPropertiesApplicationConfigurationsItem.DeserializeSpringbootappsPropertiesApplicationConfigurationsItem(item, options));
                    }
                ...
                if (property.NameEquals("miscs"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(SpringbootappsPropertiesMiscsItem.DeserializeSpringbootappsPropertiesMiscsItem(item, options));
                    }
                    miscs = array;
                    continue;
                }
                if (property.NameEquals("instances"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(SpringbootappsPropertiesInstancesItem.DeserializeSpringbootappsPropertiesInstancesItem(item, options));
                    }
                    instances = array;
                    continue;
                }
            ...
            return new SpringbootappsProperties(appName.Value, artifactName.Value, Optional.ToNullable(appPort), appType.Value, Optional.ToList(applicationConfigurations), Optional.ToList(bindingPorts), buildJdkVersion.Value, Optional.ToList(certificates), checksum.Value, Optional.ToList(dependencies), Optional.ToList(environments), Optional.ToNullable(instanceCount), jarFileLocation.Value, Optional.ToNullable(jvmMemoryInMB), Optional.ToList(jvmOptions), Optional.ToList(miscs), Optional.ToList(instances), runtimeJdkVersion.Value, Optional.ToList(servers), Optional.ToList(machineArmIds), springBootVersion.Value, Optional.ToList(staticContentLocations), Optional.ToList(connectionStrings), Optional.ToNullable(lastModifiedTime), Optional.ToNullable(lastUpdatedTime), Optional.ToNullable(provisioningState), Optional.ToList(errors), Optional.ToDictionary(labels), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<SpringbootappsProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SpringbootappsProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SpringbootappsProperties)} does not support '{options.Format}' format.");
            }
        }

        SpringbootappsProperties IPersistableModel<SpringbootappsProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SpringbootappsProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<SpringbootappsProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
