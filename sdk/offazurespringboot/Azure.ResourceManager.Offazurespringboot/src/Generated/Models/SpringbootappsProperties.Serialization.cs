...
namespace Azure.ResourceManager.Offazurespringboot.Models
{
    public partial class SpringbootappsProperties : IUtf8JsonSerializable, IJsonModel<SpringbootappsProperties>
    {
        ...
        void IJsonModel<SpringbootappsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SpringbootappsProperties)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(ApplicationConfigurations))
            {
                ...
                {
                    writer.WriteObjectValue<SpringbootappsPropertiesApplicationConfigurationsItem>(item, options);
                }
            ...
            if (Optional.IsCollectionDefined(Miscs))
            {
                ...
                {
                    writer.WriteObjectValue<SpringbootappsPropertiesMiscsItem>(item, options);
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(Instances))
            {
                ...
                {
                    writer.WriteObjectValue<SpringbootappsPropertiesInstancesItem>(item, options);
                }
                writer.WriteEndArray();
            }
            ...
            if (Optional.IsCollectionDefined(Errors))
            {
                ...
                {
                    writer.WriteObjectValue<Error>(item, options);
                }
                writer.WriteEndArray();
            }
        ...
        SpringbootappsProperties IJsonModel<SpringbootappsProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SpringbootappsProperties)} does not support reading '{format}' format.");
            }
        ...
        internal static SpringbootappsProperties DeserializeSpringbootappsProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<SpringbootappsPropertiesApplicationConfigurationsItem> applicationConfigurations = default;
            ...
            IList<SpringbootappsPropertiesMiscsItem> miscs = default;
            IList<SpringbootappsPropertiesInstancesItem> instances = default;
            string runtimeJdkVersion = default;
            IList<string> servers = default;
            IList<string> machineArmIds = default;
        ...
        BinaryData IPersistableModel<SpringbootappsProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SpringbootappsProperties)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SpringbootappsProperties IPersistableModel<SpringbootappsProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SpringbootappsProperties)} does not support reading '{options.Format}' format.");
            }
        }
