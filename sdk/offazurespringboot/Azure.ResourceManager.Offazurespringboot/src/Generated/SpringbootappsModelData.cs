...
namespace Azure.ResourceManager.Offazurespringboot
{
    ...
    public partial class SpringbootappsModelData : ResourceData
    {
        ...
        internal SpringbootappsModelData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SpringbootappsProperties properties) : base(id, name, resourceType, systemData)
        {
