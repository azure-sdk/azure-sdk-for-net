...
namespace Azure.ResourceManager.Offazurespringboot
{
    ...
    public partial class SpringbootsitesModelResource : ArmResource
    {
        ...
        {
            _springbootsitesModelspringbootsitesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Offazurespringboot", ResourceType.Namespace, Diagnostics);
        ...
        /// <item>
        /// <term>Resource</term>
        /// <description><see cref="ErrorSummaryResource"/></description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new OffazurespringbootArmOperation(_springbootsitesModelspringbootsitesClientDiagnostics, Pipeline, _springbootsitesModelspringbootsitesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation> TriggerRefreshSiteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new OffazurespringbootArmOperation(_springbootsitesModelspringbootsitesClientDiagnostics, Pipeline, _springbootsitesModelspringbootsitesRestClient.CreateTriggerRefreshSiteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<Response<SpringbootsitesModelResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new SpringbootsitesModelPatch();
