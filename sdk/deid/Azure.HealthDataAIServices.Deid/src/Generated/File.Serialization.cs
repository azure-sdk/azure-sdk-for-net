...
namespace Azure.HealthDataAIServices.Deid
{
    public partial class File : IUtf8JsonSerializable, IJsonModel<File>
    {
        ...
        void IJsonModel<File>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Explanation))
            {
                writer.WritePropertyName("explanation"u8);
                writer.WriteStringValue(Explanation);
            }
            if (options.Format != "W")
            {
        ...
        internal static File DeserializeFile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<string> explanation = default;
            string etag = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("explanation"u8))
                {
            ...
            return new File(path, status, explanation.Value, etag, serializedAdditionalRawData);
        }
