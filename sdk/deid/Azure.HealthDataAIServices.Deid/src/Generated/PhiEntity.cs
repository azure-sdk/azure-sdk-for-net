...
namespace Azure.HealthDataAIServices.Deid
{
    ...
    public partial class PhiEntity
    {
        ...
        internal PhiEntity(PhiCategories category, int offset, int length)
        {
            Category = category;
            Offset = offset;
            Length = length;
        ...
        internal PhiEntity(PhiCategories category, int offset, int length, string text, double? confidenceScore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Offset = offset;
            Length = length;
        ...
        public PhiCategories Category { get; }
