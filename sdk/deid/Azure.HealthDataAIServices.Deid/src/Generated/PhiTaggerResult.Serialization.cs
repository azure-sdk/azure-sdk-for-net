...
namespace Azure.HealthDataAIServices.Deid
{
    public partial class PhiTaggerResult : IUtf8JsonSerializable, IJsonModel<PhiTaggerResult>
    {
        ...
        void IJsonModel<PhiTaggerResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PhiTaggerResult)} does not support '{format}' format.");
            }
        ...
        internal static PhiTaggerResult DeserializePhiTaggerResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("entities"u8))
                {
                    ...
                    {
                        array.Add(PhiEntity.DeserializePhiEntity(item));
                    }
                    entities = array;
                    continue;
                }
            ...
            return new PhiTaggerResult(entities, stringIndexType, path.Value, checksum.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PhiTaggerResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PhiTaggerResult)} does not support '{options.Format}' format.");
            }
        }
