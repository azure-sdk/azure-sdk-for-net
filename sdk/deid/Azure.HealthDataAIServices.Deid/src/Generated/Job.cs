...
namespace Azure.HealthDataAIServices.Deid
{
    ...
    public partial class Job
    {
        ...
        public Job(SourceStorageLocation sourceLocation, TargetStorageLocation targetLocation, DocumentDataType dataType, OperationType operation)
        {
        ...
        internal Job(string name, JobStatus? status, JobSummary summary, DateTimeOffset? createdAt, DateTimeOffset? startedAt, DateTimeOffset? completedAt, SourceStorageLocation sourceLocation, TargetStorageLocation targetLocation, DocumentDataType dataType, OperationType operation, string redactionFormat, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Status = status;
            Summary = summary;
