...
namespace Azure.HealthDataAIServices.Deid
{
    ...
    public partial class DeidentifyOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DeidentifyOptions"/>. </summary>
        ...
        public DeidentifyOptions(string inputText, DocumentDataType dataType, OperationType operation, StringIndexType stringIndexType)
        {
        ...
        internal DeidentifyOptions(string inputText, DocumentDataType dataType, OperationType operation, StringIndexType stringIndexType, string redactionFormat, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            InputText = inputText;
            DataType = dataType;
            Operation = operation;
        ...
        /// <summary> Initializes a new instance of <see cref="DeidentifyOptions"/> for deserialization. </summary>
        internal DeidentifyOptions()
        {
        }
