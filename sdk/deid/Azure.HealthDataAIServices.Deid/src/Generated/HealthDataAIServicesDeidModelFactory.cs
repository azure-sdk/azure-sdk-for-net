...
namespace Azure.HealthDataAIServices.Deid
{
    ...
    public static partial class HealthDataAIServicesDeidModelFactory
    {
        ...
        public static DeidRequest DeidRequest(string inputText = null, DocumentDataType dataType = default, OperationType operation = default, StringIndexType stringIndexType = default, string redactionFormat = null)
        {
