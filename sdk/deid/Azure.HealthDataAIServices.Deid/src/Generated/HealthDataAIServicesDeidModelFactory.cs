...
namespace Azure.HealthDataAIServices.Deid
{
    ...
    public static partial class HealthDataAIServicesDeidModelFactory
    {
        ...
        public static File File(string id = null, FileLocation input = null, FileLocation output = null, OperationState status = default, ResponseError error = null)
        {
            return new File(
                id,
                input,
        ...
        /// <summary> Initializes a new instance of <see cref="Deid.FileLocation"/>. </summary>
        /// <param name="path"> Absolute path to the file in storage. </param>
        /// <param name="etag"> The entity tag for this resource. </param>
        /// <returns> A new <see cref="Deid.FileLocation"/> instance for mocking. </returns>
