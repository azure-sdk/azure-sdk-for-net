...
namespace Azure.HealthDataAIServices.Deid
{
    ...
    public partial class PhiTaggerResult
    {
        ...
        internal PhiTaggerResult(IReadOnlyList<PhiEntity> entities, StringIndexType stringIndexType, string path, string checksum, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Entities = entities;
            StringIndexType = stringIndexType;
            Path = path;
        ...
        /// <summary> Checksum of the file. </summary>
