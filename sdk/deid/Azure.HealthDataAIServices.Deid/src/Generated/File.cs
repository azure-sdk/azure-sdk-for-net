...
namespace Azure.HealthDataAIServices.Deid
{
    ...
    public partial class File
    {
        ...
        internal File(FileLocation input, OperationState status)
        {
        ...
        internal File(string id, FileLocation input, FileLocation output, OperationState status, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Input = input;
            Output = output;
