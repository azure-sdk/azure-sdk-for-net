...
namespace Azure.HealthDataAIServices.Deid.Samples
{
    public partial class Samples_Jobs
    {
        ...
        public void Example_Job_Create_ShortVersion_Convenience()
        {
            ...
            Job resource = new Job(new SourceStorageLocation(new Uri("http://localhost:3000"), "<prefix>"), new TargetStorageLocation(new Uri("http://localhost:3000"), "<prefix>"), DocumentDataType.PlainText, OperationType.Redact);
...
"<extensions>"
        ...
        public void Example_Job_Create_AllParameters_Convenience()
        {
            ...
            }, new TargetStorageLocation(new Uri("http://localhost:3000"), "<prefix>"), DocumentDataType.PlainText, OperationType.Redact)
            {
                RedactionFormat = "<redactionFormat>",
            };
            Operation<Job> operation = client.Create(WaitUntil.Completed, "<name>", resource);
