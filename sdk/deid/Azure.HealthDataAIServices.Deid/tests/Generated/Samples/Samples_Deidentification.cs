...
namespace Azure.HealthDataAIServices.Deid.Samples
{
    public partial class Samples_Deidentification
    {
        ...
        public void Example_DeidentifyJob_GetJob_ShortVersion()
        {
            ...
            Deidentification client = new DeidentificationClient(endpoint, credential).GetDeidentificationClient(apiVersion: "2024-01-31-preview");
        ...
        public void Example_Deidentification_Deidentify_ShortVersion_Convenience()
        {
            ...
            DeidentifyOptions body = new DeidentifyOptions("<inputText>", DocumentDataType.PlainText, OperationType.Redact, StringIndexType.TextElementV8);
