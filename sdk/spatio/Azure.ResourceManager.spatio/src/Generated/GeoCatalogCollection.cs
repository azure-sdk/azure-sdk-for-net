...
namespace Azure.ResourceManager.spatio
{
    ...
    public partial class GeoCatalogCollection : ArmCollection, IEnumerable<GeoCatalogResource>, IAsyncEnumerable<GeoCatalogResource>
    {
        ...
        {
            _geoCatalogClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.spatio", GeoCatalogResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<GeoCatalogResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string catalogName, GeoCatalogData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new spatioArmOperation<GeoCatalogResource>(new GeoCatalogOperationSource(Client), _geoCatalogClientDiagnostics, Pipeline, _geoCatalogRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, catalogName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
