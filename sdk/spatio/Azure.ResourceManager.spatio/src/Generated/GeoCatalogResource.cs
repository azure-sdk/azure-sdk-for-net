...
using Azure.ResourceManager.spatio.Models;
...
namespace Azure.ResourceManager.spatio
{
    ...
    public partial class GeoCatalogResource : ArmResource
    {
        ...
        {
            _geoCatalogClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.spatio", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new spatioArmOperation(_geoCatalogClientDiagnostics, Pipeline, _geoCatalogRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<GeoCatalogResource>> UpdateAsync(WaitUntil waitUntil, GeoCatalogPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new spatioArmOperation<GeoCatalogResource>(new GeoCatalogOperationSource(Client), _geoCatalogClientDiagnostics, Pipeline, _geoCatalogRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
