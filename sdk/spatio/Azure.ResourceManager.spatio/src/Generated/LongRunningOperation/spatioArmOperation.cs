...
#pragma warning disable SA1649 // File name should match first type name
    internal class spatioArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal spatioArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal spatioArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "spatioArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
