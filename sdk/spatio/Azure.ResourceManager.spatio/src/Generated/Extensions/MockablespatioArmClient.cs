...
namespace Azure.ResourceManager.spatio.Mocking
{
    ...
    public partial class MockablespatioArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockablespatioArmClient"/> class for mocking. </summary>
        protected MockablespatioArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockablespatioArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockablespatioArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockablespatioArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
