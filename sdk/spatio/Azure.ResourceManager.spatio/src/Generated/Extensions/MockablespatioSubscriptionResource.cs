...
namespace Azure.ResourceManager.spatio.Mocking
{
    ...
    public partial class MockablespatioSubscriptionResource : ArmResource
    {
        private ClientDiagnostics _geoCatalogClientDiagnostics;
        private GeoCatalogsRestOperations _geoCatalogRestClient;

        /// <summary> Initializes a new instance of the <see cref="MockablespatioSubscriptionResource"/> class for mocking. </summary>
        protected MockablespatioSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockablespatioSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockablespatioSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics GeoCatalogClientDiagnostics => _geoCatalogClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.spatio", GeoCatalogResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<GeoCatalogResource> GetGeoCatalogsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new GeoCatalogResource(Client, GeoCatalogData.DeserializeGeoCatalogData(e)), GeoCatalogClientDiagnostics, Pipeline, "MockablespatioSubscriptionResource.GetGeoCatalogs", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<GeoCatalogResource> GetGeoCatalogs(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => GeoCatalogRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => GeoCatalogRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new GeoCatalogResource(Client, GeoCatalogData.DeserializeGeoCatalogData(e)), GeoCatalogClientDiagnostics, Pipeline, "MockablespatioSubscriptionResource.GetGeoCatalogs", "value", "nextLink", cancellationToken);
        }
    }
}
