...
namespace Azure.ResourceManager.spatio.Mocking
{
    ...
    public partial class MockablespatioResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockablespatioResourceGroupResource"/> class for mocking. </summary>
        protected MockablespatioResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockablespatioResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockablespatioResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
