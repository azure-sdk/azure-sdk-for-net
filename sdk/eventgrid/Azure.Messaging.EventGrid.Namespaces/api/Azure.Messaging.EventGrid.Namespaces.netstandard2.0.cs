namespace Azure.Messaging.EventGrid.Namespaces
{
    public partial class EventGridClient
    {
        ...
        public virtual Azure.Response ReceiveCloudEvents(string topicName, string eventSubscriptionName, int? maxEvents = default(int?), int? maxWaitTime = default(int?), Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> ReceiveCloudEventsAsync(string topicName, string eventSubscriptionName, int? maxEvents = default(int?), int? maxWaitTime = default(int?), Azure.RequestContext context = null) { throw null; }
