...
namespace Azure.Messaging.EventGrid.Namespaces.Samples
{
    ...
    new {
        ...
        public void Example_ReceiveCloudEvents_AllParameters()
        {
            ...
            Response response = client.ReceiveCloudEvents("<topicName>", "<eventSubscriptionName>", 1234, 1234, new RequestContext());
        ...
        public async Task Example_ReceiveCloudEvents_AllParameters_Async()
        {
            ...
            Response response = await client.ReceiveCloudEventsAsync("<topicName>", "<eventSubscriptionName>", 1234, 1234, new RequestContext());
