...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class WebhookAuthenticationSettings
    {
        ...
        /// <param name="azureActiveDirectoryApplicationIdOrUri"> Azure Active Directory Application ID or URI to get the access token that will be included as the bearer token in delivery requests. </param>
        /// <param name="azureActiveDirectoryTenantId"> Azure Active Directory Tenant ID to get the access token that will be included as the bearer token in delivery requests. </param>
        ...
        /// <summary> Azure Active Directory Application ID or URI to get the access token that will be included as the bearer token in delivery requests. </summary>
        [WirePath("azureActiveDirectoryApplicationIdOrUri")]
        public Uri AzureActiveDirectoryApplicationIdOrUri { get; set; }
        /// <summary> Azure Active Directory Tenant ID to get the access token that will be included as the bearer token in delivery requests. </summary>
