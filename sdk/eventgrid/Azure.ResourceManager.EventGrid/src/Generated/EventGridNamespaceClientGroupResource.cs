...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class EventGridNamespaceClientGroupResource : ArmResource
    {
        ...
        internal EventGridNamespaceClientGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _eventGridNamespaceClientGroupClientGroupsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventGrid", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string eventGridNamespaceClientGroupClientGroupsApiVersion);
        ...
        public virtual EventGridNamespaceClientGroupData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <description>2024-12-15-preview</description>
        /// </item>
        /// <item>
        /// <term>Resource</term>
        ...
        public virtual async Task<Response<EventGridNamespaceClientGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _eventGridNamespaceClientGroupClientGroupsClientDiagnostics.CreateScope("EventGridNamespaceClientGroupResource.Get");
            scope.Start();
            try
            {
                var response = await _eventGridNamespaceClientGroupClientGroupsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<EventGridNamespaceClientGroupResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _eventGridNamespaceClientGroupClientGroupsClientDiagnostics.CreateScope("EventGridNamespaceClientGroupResource.Get");
            scope.Start();
            try
            {
                var response = _eventGridNamespaceClientGroupClientGroupsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new EventGridNamespaceClientGroupResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _eventGridNamespaceClientGroupClientGroupsClientDiagnostics.CreateScope("EventGridNamespaceClientGroupResource.Delete");
            scope.Start();
            try
            {
                var response = await _eventGridNamespaceClientGroupClientGroupsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new EventGridArmOperation(_eventGridNamespaceClientGroupClientGroupsClientDiagnostics, Pipeline, _eventGridNamespaceClientGroupClientGroupsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _eventGridNamespaceClientGroupClientGroupsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new EventGridArmOperation(_eventGridNamespaceClientGroupClientGroupsClientDiagnostics, Pipeline, _eventGridNamespaceClientGroupClientGroupsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<EventGridNamespaceClientGroupResource>> UpdateAsync(WaitUntil waitUntil, EventGridNamespaceClientGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _eventGridNamespaceClientGroupClientGroupsClientDiagnostics.CreateScope("EventGridNamespaceClientGroupResource.Update");
            scope.Start();
            try
            {
                var response = await _eventGridNamespaceClientGroupClientGroupsRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<EventGridNamespaceClientGroupResource> Update(WaitUntil waitUntil, EventGridNamespaceClientGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _eventGridNamespaceClientGroupClientGroupsRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new EventGridArmOperation<EventGridNamespaceClientGroupResource>(new EventGridNamespaceClientGroupOperationSource(Client), _eventGridNamespaceClientGroupClientGroupsClientDiagnostics, Pipeline, _eventGridNamespaceClientGroupClientGroupsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
