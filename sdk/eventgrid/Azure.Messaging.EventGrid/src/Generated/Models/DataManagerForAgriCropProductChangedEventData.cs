...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.CropProductChanged event. </summary>
    public partial class DataManagerForAgriCropProductChangedEventData
    {
        ...
        internal DataManagerForAgriCropProductChangedEventData(DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
