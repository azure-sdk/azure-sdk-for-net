...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterWorkerSelector
    {
        ...
        internal AcsRouterWorkerSelector(string key, AcsRouterLabelOperator? labelOperator, object labelValue, float? timeToLive, AcsRouterWorkerSelectorState? state, DateTimeOffset? expirationTime)
        {
            Key = key;
