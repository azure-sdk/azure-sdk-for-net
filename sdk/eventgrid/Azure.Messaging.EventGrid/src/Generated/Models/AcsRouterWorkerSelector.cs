...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterWorkerSelector
    {
        ...
        internal AcsRouterWorkerSelector(string key, string labelOperator, IReadOnlyDictionary<string, string> value, double? ttlSeconds, AcsRouterWorkerSelectorState? state, DateTimeOffset? expireTime)
        {
            Key = key;
