...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobClassifiedEventData : AcsRouterJobEventBaseProperties
    {
        ...
        internal AcsRouterJobClassifiedEventData(string jobId, string channelReference, string channelId, string queueId, IReadOnlyDictionary<string, string> labels, IReadOnlyDictionary<string, string> tags, AcsRouterQueueInfo queueInfo, string classificationPolicyId, int? priority, AcsRouterWorkerSelector attachedWorkerSelectors) : base(jobId, channelReference, channelId, queueId, labels, tags)
        {
            QueueInfo = queueInfo;
        ...
        public AcsRouterQueueInfo QueueInfo { get; }
        ...
        public AcsRouterWorkerSelector AttachedWorkerSelectors { get; }
    }
}
