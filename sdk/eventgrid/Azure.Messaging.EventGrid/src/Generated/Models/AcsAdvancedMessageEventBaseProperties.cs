...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AcsAdvancedMessageEventBaseProperties"/>. </summary>
        ...
        internal AcsAdvancedMessageEventBaseProperties(string @from, string to, DateTimeOffset? receivedTimestamp, AcsAdvancedMessageChannelEventError error)
        {
            From = @from;
            To = to;
        ...
        public AcsAdvancedMessageChannelEventError Error { get; }
    }
}
