...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriPrescriptionChangedV2EventData
    {
        ...
        internal DataManagerForAgriPrescriptionChangedV2EventData(string prescriptionMapId, string partyId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
