...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.PartyChanged event. </summary>
    public partial class DataManagerForAgriPartyChangedEventData
    {
        ...
        internal DataManagerForAgriPartyChangedEventData(DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
