...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobCancelledEventData
    {
        internal static AcsRouterJobCancelledEventData DeserializeAcsRouterJobCancelledEventData(JsonElement element)
        {
            ...
            return new AcsRouterJobCancelledEventData(jobId.Value, channelReference.Value, channelId.Value, queueId.Value, Optional.ToDictionary(labels), Optional.ToDictionary(tags), note.Value, Optional.ToNullable(dispositionCode));
        }
