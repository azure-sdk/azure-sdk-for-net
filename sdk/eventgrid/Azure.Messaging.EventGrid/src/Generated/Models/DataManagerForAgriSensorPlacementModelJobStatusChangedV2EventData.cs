...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriSensorPlacementModelJobStatusChangedV2EventData
    {
        ...
        internal DataManagerForAgriSensorPlacementModelJobStatusChangedV2EventData(string partyId, string message, JobStatus? status, DateTimeOffset? lastActionDateTime, bool? isCancellationRequested, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            PartyId = partyId;
            Message = message;
            Status = status;
