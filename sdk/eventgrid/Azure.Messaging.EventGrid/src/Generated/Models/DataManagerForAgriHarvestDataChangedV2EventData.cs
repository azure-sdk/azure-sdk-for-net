...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriHarvestDataChangedV2EventData
    {
        ...
        internal DataManagerForAgriHarvestDataChangedV2EventData(ResourceActionType? actionType, string partyId, string status, string source, DateTimeOffset? modifiedDateTime, IReadOnlyDictionary<string, object> properties, ETag? eTag, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
