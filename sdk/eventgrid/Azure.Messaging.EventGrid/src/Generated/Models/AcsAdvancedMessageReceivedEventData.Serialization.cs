...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsAdvancedMessageReceivedEventData
    {
        internal static AcsAdvancedMessageReceivedEventData DeserializeAcsAdvancedMessageReceivedEventData(JsonElement element)
        {
            ...
            Optional<AcsAdvancedMessageMediaContent> media = default;
            Optional<AcsAdvancedMessageButtonContent> button = default;
            Optional<AcsAdvancedMessageInteractiveContent> interactive = default;
            ...
            return new AcsAdvancedMessageReceivedEventData(@from.Value, to.Value, Optional.ToNullable(receivedTimestamp), error.Value, content.Value, Optional.ToNullable(channelType), media.Value, button.Value, interactive.Value);
        }
