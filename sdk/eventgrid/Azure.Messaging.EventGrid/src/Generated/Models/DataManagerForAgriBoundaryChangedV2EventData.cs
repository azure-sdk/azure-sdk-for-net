...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.BoundaryChanged.V2 event. </summary>
    public partial class DataManagerForAgriBoundaryChangedV2EventData
    {
        ...
        internal DataManagerForAgriBoundaryChangedV2EventData(string parentId, DataManagerForAgriBoundaryParentType? parentType, string partyId, DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            ParentId = parentId;
        ...
        public DataManagerForAgriBoundaryParentType? ParentType { get; }
