...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriBoundaryChangedV2EventData
    {
        ...
        internal DataManagerForAgriBoundaryChangedV2EventData(string parentId, BoundaryParentType? parentType, string partyId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            ParentId = parentId;
        ...
        public BoundaryParentType? ParentType { get; }
