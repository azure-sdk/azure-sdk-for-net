...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsIncomingCallEventData
    {
        ...
        internal AcsIncomingCallEventData(CommunicationIdentifierModel to, CommunicationIdentifierModel @from, string serverCallId, string callerDisplayName, AcsIncomingCallCustomContext customContext, string incomingCallContext, string correlationId)
        {
            To = to;
            From = @from;
