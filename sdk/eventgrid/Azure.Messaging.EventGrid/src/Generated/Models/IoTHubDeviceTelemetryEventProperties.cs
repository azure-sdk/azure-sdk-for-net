...
namespace Azure.Messaging.EventGrid.Models
{
    ...
    internal partial class IoTHubDeviceTelemetryEventProperties
    {
        /// <summary> Initializes a new instance of IoTHubDeviceTelemetryEventProperties. </summary>
        internal IoTHubDeviceTelemetryEventProperties()
        {
            Body = new ChangeTrackingDictionary<string, object>();
