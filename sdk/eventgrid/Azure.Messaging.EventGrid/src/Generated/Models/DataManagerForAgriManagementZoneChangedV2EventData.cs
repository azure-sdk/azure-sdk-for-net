...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.ManagementZoneChanged.V2 event. </summary>
    public partial class DataManagerForAgriManagementZoneChangedV2EventData
    {
        ...
        internal DataManagerForAgriManagementZoneChangedV2EventData(string seasonId, string cropId, string fieldId, string partyId, DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            SeasonId = seasonId;
            CropId = cropId;
            FieldId = fieldId;
        ...
        /// <summary> Season Id associated with the management zone. </summary>
        public string SeasonId { get; }
        /// <summary> Crop Id associated with the management zone. </summary>
        public string CropId { get; }
        /// <summary> Field Id associated with the management zone. </summary>
