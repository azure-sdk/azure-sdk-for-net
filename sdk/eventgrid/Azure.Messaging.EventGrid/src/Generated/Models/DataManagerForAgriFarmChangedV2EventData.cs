...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.FarmChanged.V2 event. </summary>
    public partial class DataManagerForAgriFarmChangedV2EventData
    {
        ...
        internal DataManagerForAgriFarmChangedV2EventData(string partyId, DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            PartyId = partyId;
