...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.ApplicationDataChanged.V2 event. </summary>
    public partial class DataManagerForAgriApplicationDataChangedV2EventData
    {
        ...
        internal DataManagerForAgriApplicationDataChangedV2EventData(ResourceActionType? actionType, string partyId, string status, string source, DateTimeOffset? modifiedDateTime, IReadOnlyDictionary<string, object> properties, ETag? eTag, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
