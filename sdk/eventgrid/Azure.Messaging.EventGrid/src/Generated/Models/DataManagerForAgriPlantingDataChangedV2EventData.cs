...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.PlantingDataChanged.V2 event. </summary>
    public partial class DataManagerForAgriPlantingDataChangedV2EventData
    {
        ...
        internal DataManagerForAgriPlantingDataChangedV2EventData(DataManagerForAgriResourceActionType? actionType, string partyId, string status, string source, DateTimeOffset? modifiedDateTime, IReadOnlyDictionary<string, object> properties, ETag? eTag, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
