...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriPlantingDataChangedV2EventData
    {
        ...
        internal DataManagerForAgriPlantingDataChangedV2EventData(ResourceActionType? actionType, string partyId, string status, string source, DateTimeOffset? modifiedDateTime, IReadOnlyDictionary<string, object> properties, ETag? eTag, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
