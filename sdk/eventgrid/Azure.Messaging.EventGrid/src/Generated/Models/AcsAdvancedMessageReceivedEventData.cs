...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsAdvancedMessageReceivedEventData : AcsAdvancedMessageEventData
    {
        ...
        internal AcsAdvancedMessageReceivedEventData(string @from, string to, DateTimeOffset? receivedTimestamp, AcsAdvancedMessageChannelEventError error, string content, AcsMessageChannelKind? channelKind, AcsAdvancedMessageMediaContent mediaContent, AcsAdvancedMessageContext context, AcsAdvancedMessageButtonContent button, AcsAdvancedMessageInteractiveContent interactiveContent) : base(@from, to, receivedTimestamp, error)
        {
            Content = content;
