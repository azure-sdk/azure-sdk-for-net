...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    public partial class AcsRouterWorkerSelector
    {
        internal static AcsRouterWorkerSelector DeserializeAcsRouterWorkerSelector(JsonElement element)
        {
            ...
            return new AcsRouterWorkerSelector(key.Value, Optional.ToNullable(labelOperator), labelValue.Value, Optional.ToNullable(ttl), Optional.ToNullable(state), Optional.ToNullable(expirationTime));
        }
    }
}
