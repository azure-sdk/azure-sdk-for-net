...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageBlobTierChangedEventData
    {
        ...
        internal StorageBlobTierChangedEventData(string api, string clientRequestId, string requestId, string contentType, long? contentLength, string blobType, string accessTier, string previousTier, string url, string sequencer, string identity, object storageDiagnostics)
        {
            Api = api;
