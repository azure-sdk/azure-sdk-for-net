...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobCancelledEventData : AcsRouterJobEventData
    {
        ...
        internal AcsRouterJobCancelledEventData(string jobId, string channelReference, string channelId, string queueId, IReadOnlyDictionary<string, string> labels, IReadOnlyDictionary<string, string> tags, string note, DispositionCodeType? dispositionCode) : base(jobId, channelReference, channelId, queueId, labels, tags)
        {
            Note = note;
        ...
        public DispositionCodeType? DispositionCode { get; }
    }
}
