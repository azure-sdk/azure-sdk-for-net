...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobWaitingForActivationEventData
    {
        internal static AcsRouterJobWaitingForActivationEventData DeserializeAcsRouterJobWaitingForActivationEventData(JsonElement element)
        {
            ...
            return new AcsRouterJobWaitingForActivationEventData(jobId.Value, channelReference.Value, channelId.Value, queueId.Value, Optional.ToDictionary(labels), Optional.ToDictionary(tags), Optional.ToNullable(priority), Optional.ToList(attachedWorkerSelectorsExpired), Optional.ToList(requestedWorkerSelectorsExpired), Optional.ToNullable(scheduledTimeUtc), Optional.ToNullable(unavailableForMatching));
        }
