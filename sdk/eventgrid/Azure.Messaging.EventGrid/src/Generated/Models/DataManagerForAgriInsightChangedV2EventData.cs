...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.InsightChanged.V2 event. </summary>
    public partial class DataManagerForAgriInsightChangedV2EventData
    {
        ...
        internal DataManagerForAgriInsightChangedV2EventData(string modelId, DataManagerForAgriFarmHierarchyResourceType? resourceType, string resourceId, string modelVersion, string partyId, DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            ModelId = modelId;
        ...
        /// <summary> Version of the associated model. </summary>
