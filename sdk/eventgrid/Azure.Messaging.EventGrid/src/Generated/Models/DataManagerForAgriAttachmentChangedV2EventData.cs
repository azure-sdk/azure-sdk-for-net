...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriAttachmentChangedV2EventData
    {
        ...
        internal DataManagerForAgriAttachmentChangedV2EventData(string resourceId, AttachmentResourceType? resourceType, string partyId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
        ...
        public AttachmentResourceType? ResourceType { get; }
