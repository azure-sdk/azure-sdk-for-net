...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.SoilMoistureModelJobStatusChanged.V2 event. </summary>
    public partial class DataManagerForAgriSoilMoistureModelJobStatusChangedV2EventData
    {
        ...
        internal DataManagerForAgriSoilMoistureModelJobStatusChangedV2EventData(string partyId, string message, JobStatus? status, DateTimeOffset? lastActionDateTime, bool? isCancellationRequested, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            PartyId = partyId;
            Message = message;
            Status = status;
