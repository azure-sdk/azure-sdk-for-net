...
{
    [JsonConverter(typeof(AcsRouterJobRecievedEventDataConverter))]
    public partial class AcsRouterJobRecievedEventData
    {
        internal static AcsRouterJobRecievedEventData DeserializeAcsRouterJobRecievedEventData(JsonElement element)
        {
            ...
            return new AcsRouterJobRecievedEventData(jobId.Value, channelReference.Value, channelId.Value, queueId.Value, Optional.ToDictionary(labels), Optional.ToDictionary(tags), jobStatus.Value, classificationPolicyId.Value, Optional.ToNullable(priority), Optional.ToList(requestedWorkerSelectors), Optional.ToNullable(scheduledTimeUtc), Optional.ToNullable(unavailableForMatching));
        }

        internal partial class AcsRouterJobRecievedEventDataConverter : JsonConverter<AcsRouterJobRecievedEventData>
        {
            public override void Write(Utf8JsonWriter writer, AcsRouterJobRecievedEventData model, JsonSerializerOptions options)
            {
                throw new NotImplementedException();
            }
            public override AcsRouterJobRecievedEventData Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeAcsRouterJobRecievedEventData(document.RootElement);
            }
        }
    }
}
