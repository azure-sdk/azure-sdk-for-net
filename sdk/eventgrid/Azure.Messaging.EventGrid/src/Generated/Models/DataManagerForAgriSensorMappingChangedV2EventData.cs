...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriSensorMappingChangedV2EventData
    {
        ...
        internal DataManagerForAgriSensorMappingChangedV2EventData(string sensorId, string partyId, string boundaryId, string sensorPartnerId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            SensorId = sensorId;
            PartyId = partyId;
