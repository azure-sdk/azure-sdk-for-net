...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.SensorDataModelChanged event. </summary>
    public partial class DataManagerForAgriSensorDataModelChangedEventData
    {
        ...
        internal DataManagerForAgriSensorDataModelChangedEventData(string sensorPartnerId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
