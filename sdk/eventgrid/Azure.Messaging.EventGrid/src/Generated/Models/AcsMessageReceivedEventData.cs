...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsMessageReceivedEventData : AcsMessageEventData
    {
        ...
        internal AcsMessageReceivedEventData(string @from, string to, DateTimeOffset? receivedTimestamp, AcsMessageChannelEventError error, string content, AcsMessageChannelKind? channelKind, AcsMessageMediaContent mediaContent, AcsMessageContext context, AcsMessageButtonContent button, AcsMessageInteractiveContent interactiveContent) : base(@from, to, receivedTimestamp, error)
        {
            Content = content;
