...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsAdvancedMessageDeliveryStatusUpdatedEventData : AcsAdvancedMessageEventData
    {
        ...
        internal AcsAdvancedMessageDeliveryStatusUpdatedEventData(string @from, string to, DateTimeOffset? receivedTimestamp, AcsAdvancedMessageChannelEventError error, string messageId, AcsAdvanceMessageDeliveryStatus? status, AcsMessageChannelKind? channelKind) : base(@from, to, receivedTimestamp, error)
        {
            MessageId = messageId;
            Status = status;
