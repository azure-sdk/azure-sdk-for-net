...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.DeviceDataModelChanged event. </summary>
    public partial class DataManagerForAgriDeviceDataModelChangedEventData
    {
        ...
        internal DataManagerForAgriDeviceDataModelChangedEventData(string sensorPartnerId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
