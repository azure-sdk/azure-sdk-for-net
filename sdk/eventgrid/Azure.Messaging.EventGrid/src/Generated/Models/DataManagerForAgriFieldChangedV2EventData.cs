...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.FieldChanged.V2 event. </summary>
    public partial class DataManagerForAgriFieldChangedV2EventData
    {
        ...
        internal DataManagerForAgriFieldChangedV2EventData(string farmId, string partyId, DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            FarmId = farmId;
            PartyId = partyId;
