...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriFieldChangedV2EventData
    {
        ...
        internal DataManagerForAgriFieldChangedV2EventData(string farmId, string partyId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            FarmId = farmId;
            PartyId = partyId;
