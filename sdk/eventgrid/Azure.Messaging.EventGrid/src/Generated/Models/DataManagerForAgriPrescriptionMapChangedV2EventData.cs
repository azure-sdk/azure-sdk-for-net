...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.PrescriptionMapChanged.V2 event. </summary>
    public partial class DataManagerForAgriPrescriptionMapChangedV2EventData
    {
        ...
        internal DataManagerForAgriPrescriptionMapChangedV2EventData(string seasonId, string cropId, string fieldId, string partyId, DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            SeasonId = seasonId;
            CropId = cropId;
            FieldId = fieldId;
        ...
        /// <summary> Season Id associated with the prescription map. </summary>
        public string SeasonId { get; }
        /// <summary> Crop Id associated with the prescription map. </summary>
        public string CropId { get; }
        /// <summary> Field Id associated with the prescription map. </summary>
