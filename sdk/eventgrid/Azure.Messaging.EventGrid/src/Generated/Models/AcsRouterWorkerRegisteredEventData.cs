...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterWorkerRegisteredEventData
    {
        ...
        {
            QueueAssignments = new ChangeTrackingList<AcsRouterQueueInfo>();
        ...
        internal AcsRouterWorkerRegisteredEventData(string workerId, IReadOnlyList<AcsRouterQueueInfo> queueAssignments, IReadOnlyList<AcsRouterChannelConfiguration> channelConfigurations, int? totalCapacity, IReadOnlyDictionary<string, string> labels, IReadOnlyDictionary<string, string> tags)
        {
            WorkerId = workerId;
        ...
        public IReadOnlyList<AcsRouterQueueInfo> QueueAssignments { get; }
