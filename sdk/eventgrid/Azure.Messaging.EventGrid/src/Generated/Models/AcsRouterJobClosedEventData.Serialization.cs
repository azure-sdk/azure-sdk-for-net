...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobClosedEventData
    {
        internal static AcsRouterJobClosedEventData DeserializeAcsRouterJobClosedEventData(JsonElement element)
        {
            ...
            Optional<DispositionCodeType> dispositionCode = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("dispositionCode"u8))
                {
                    ...
                    dispositionCode = new DispositionCodeType(property.Value.GetString());
                    continue;
                }
            ...
            return new AcsRouterJobClosedEventData(jobId.Value, channelReference.Value, channelId.Value, queueId.Value, Optional.ToDictionary(labels), Optional.ToDictionary(tags), assignmentId.Value, workerId.Value, Optional.ToNullable(dispositionCode));
        }
