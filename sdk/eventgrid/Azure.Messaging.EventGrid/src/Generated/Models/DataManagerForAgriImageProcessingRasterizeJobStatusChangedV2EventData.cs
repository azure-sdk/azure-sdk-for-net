...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriImageProcessingRasterizeJobStatusChangedV2EventData
    {
        ...
        internal DataManagerForAgriImageProcessingRasterizeJobStatusChangedV2EventData(string shapefileAttachmentId, string partyId, string message, JobStatus? status, DateTimeOffset? lastActionDateTime, bool? isCancellationRequested, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
