...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.ImageProcessingRasterizeJobStatusChanged.V2 event. </summary>
    public partial class DataManagerForAgriImageProcessingRasterizeJobStatusChangedV2EventData
    {
        ...
        internal DataManagerForAgriImageProcessingRasterizeJobStatusChangedV2EventData(string shapefileAttachmentId, string partyId, string message, DataManagerForAgriJobStatus? status, DateTimeOffset? lastActionDateTime, bool? isCancellationRequested, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
        ...
        /// <summary> Attachment id of the shapefile for which job was created. </summary>
        public string ShapefileAttachmentId { get; }
        /// <summary> Party id for which job was created. </summary>
        ...
        public DataManagerForAgriJobStatus? Status { get; }
