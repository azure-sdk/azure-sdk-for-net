...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobClassifiedEventData
    {
        internal static AcsRouterJobClassifiedEventData DeserializeAcsRouterJobClassifiedEventData(JsonElement element)
        {
            ...
            Optional<AcsRouterQueueInfo> queueInfo = default;
            Optional<string> classificationPolicyId = default;
            Optional<int> priority = default;
            Optional<AcsRouterWorkerSelector> attachedWorkerSelectors = default;
            ...
            {
                if (property.NameEquals("queueInfo"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    queueInfo = AcsRouterQueueInfo.DeserializeAcsRouterQueueInfo(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("attachedWorkerSelectors"u8))
                {
                    ...
                    attachedWorkerSelectors = AcsRouterWorkerSelector.DeserializeAcsRouterWorkerSelector(property.Value);
                    continue;
                }
            ...
            return new AcsRouterJobClassifiedEventData(jobId.Value, channelReference.Value, channelId.Value, queueId.Value, Optional.ToDictionary(labels), Optional.ToDictionary(tags), queueInfo.Value, classificationPolicyId.Value, Optional.ToNullable(priority), attachedWorkerSelectors.Value);
        }
