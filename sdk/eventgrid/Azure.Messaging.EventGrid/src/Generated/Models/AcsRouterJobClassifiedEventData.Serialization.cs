...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobClassifiedEventData
    {
        internal static AcsRouterJobClassifiedEventData DeserializeAcsRouterJobClassifiedEventData(JsonElement element)
        {
            ...
            return new AcsRouterJobClassifiedEventData(jobId.Value, channelReference.Value, channelId.Value, queueId.Value, Optional.ToDictionary(labels), Optional.ToDictionary(tags), queueInfo.Value, classificationPolicyId.Value, Optional.ToNullable(priority), Optional.ToList(attachedWorkerSelectors));
        }
