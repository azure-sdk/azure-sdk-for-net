...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriSensorChangedEventData
    {
        ...
        internal DataManagerForAgriSensorChangedEventData(string sensorDataModelId, string integrationId, string deviceId, string sensorPartnerId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
