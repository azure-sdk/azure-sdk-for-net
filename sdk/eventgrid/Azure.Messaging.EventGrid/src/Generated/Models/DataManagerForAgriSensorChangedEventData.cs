...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.SensorChanged event. </summary>
    public partial class DataManagerForAgriSensorChangedEventData
    {
        ...
        internal DataManagerForAgriSensorChangedEventData(string sensorDataModelId, string integrationId, string deviceId, string sensorPartnerId, DataManagerForAgriResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
        ...
        /// <summary> Id associated with the sensorDataModel. </summary>
        public string SensorDataModelId { get; }
        /// <summary> Id associated with the integration. </summary>
        public string IntegrationId { get; }
        /// <summary> Id associated with the device. </summary>
