...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DataManagerForAgriPlantTissueAnalysisChangedV2EventData
    {
        ...
        internal DataManagerForAgriPlantTissueAnalysisChangedV2EventData(string fieldId, string cropId, string cropProductId, string seasonId, string partyId, ResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, ETag? eTag, IReadOnlyDictionary<string, object> properties, string id, string name, string description, DateTimeOffset? createdDateTime)
        {
            FieldId = fieldId;
            CropId = cropId;
