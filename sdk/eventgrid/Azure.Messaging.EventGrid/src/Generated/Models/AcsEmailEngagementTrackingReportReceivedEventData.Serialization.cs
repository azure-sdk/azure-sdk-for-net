...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsEmailEngagementTrackingReportReceivedEventData
    {
        internal static AcsEmailEngagementTrackingReportReceivedEventData DeserializeAcsEmailEngagementTrackingReportReceivedEventData(JsonElement element)
        {
            ...
            Optional<UserEngagementTypeModel> engagementType = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("userActionTimeStamp"))
                {
                ...
                if (property.NameEquals("engagementContext"))
                {
                ...
                if (property.NameEquals("engagementType"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                    ...
                    engagementType = new UserEngagementTypeModel(property.Value.GetString());
                    continue;
                }
            }
