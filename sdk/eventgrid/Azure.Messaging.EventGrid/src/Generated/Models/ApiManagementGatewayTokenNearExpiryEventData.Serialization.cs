...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ApiManagementGatewayTokenNearExpiryEventData
    {
        internal static ApiManagementGatewayTokenNearExpiryEventData DeserializeApiManagementGatewayTokenNearExpiryEventData(JsonElement element)
        {
            ...
            ApiManagementGatewayInfo gatewayInfo = default;
            ApiManagementGatewayTokenNearExpiryInfo tokenInfo = default;
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("gatewayInfo"u8))
                {
                    ...
                    gatewayInfo = ApiManagementGatewayInfo.DeserializeApiManagementGatewayInfo(property.Value);
                    continue;
                }
                if (property.NameEquals("tokenInfo"u8))
                {
                    ...
                    tokenInfo = ApiManagementGatewayTokenNearExpiryInfo.DeserializeApiManagementGatewayTokenNearExpiryInfo(property.Value);
                    continue;
                }
            }
