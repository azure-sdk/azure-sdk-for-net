...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageTaskCompletedEventData
    {
        ...
        internal StorageTaskCompletedEventData(StorageTaskCompletedStatus? status, DateTimeOffset? completedDateTime, string taskExecutionId, string taskName, Uri summaryReportBlobUrl)
        {
            Status = status;
