...
namespace Azure.Messaging.EventGrid
{
    ...
    public static partial class EventGridModelFactory
    {
        ...
        public static AcsIncomingCallEventData AcsIncomingCallEventData(CommunicationIdentifierModel to = null, CommunicationIdentifierModel @from = null, string serverCallId = null, string callerDisplayName = null, AcsIncomingCallCustomContext customContext = null, string incomingCallContext = null, string correlationId = null)
        {
            return new AcsIncomingCallEventData(to, @from, serverCallId, callerDisplayName, customContext, incomingCallContext, correlationId);
        }
        ...
        public static AcsIncomingCallCustomContext AcsIncomingCallCustomContext(IReadOnlyDictionary<string, string> customHeaders = null, IReadOnlyDictionary<string, string> sipHeaders = null, IReadOnlyDictionary<string, string> voipHeaders = null)
        {
