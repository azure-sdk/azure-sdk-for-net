...
namespace Azure.Messaging.EventGrid
{
    ...
    public static partial class EventGridModelFactory
    {
        ...
        /// <summary> Initializes a new instance of AcsRouterJobEventBaseProperties. </summary>
        /// <param name="jobId"> Router Event Job ID. </param>
        /// <param name="channelReference"> Router Event Channel Reference. </param>
        /// <param name="channelId"> Router Event Channel ID. </param>
        /// <param name="queueId"> Router Job events Queue Id. </param>
        /// <param name="labels"> Router Job events Labels. </param>
        /// <param name="tags"> Router Jobs events Tags. </param>
        /// <returns> A new <see cref="SystemEvents.AcsRouterJobEventBaseProperties"/> instance for mocking. </returns>
        public static AcsRouterJobEventBaseProperties AcsRouterJobEventBaseProperties(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null)
        {
            labels ??= new Dictionary<string, string>();
            tags ??= new Dictionary<string, string>();

            return new AcsRouterJobEventBaseProperties(jobId, channelReference, channelId, queueId, labels, tags);
        }
        ...
        /// <param name="channelReference"> Router Event Channel Reference. </param>
        /// <param name="channelId"> Router Event Channel ID. </param>
        /// <returns> A new <see cref="SystemEvents.AcsRouterEventBaseProperties"/> instance for mocking. </returns>
        public static AcsRouterEventBaseProperties AcsRouterEventBaseProperties(string jobId = null, string channelReference = null, string channelId = null)
        {
            return new AcsRouterEventBaseProperties(jobId, channelReference, channelId);
        }
        ...
        public static AcsRouterWorkerSelector AcsRouterWorkerSelector(string key = null, string labelOperator = null, IReadOnlyDictionary<string, string> value = null, double? ttlSeconds = null, AcsRouterWorkerSelectorState? state = null, DateTimeOffset? expireTime = null)
        {
        ...
        /// <returns> A new <see cref="SystemEvents.AcsRouterJobRecievedEventData"/> instance for mocking. </returns>
        public static AcsRouterJobRecievedEventData AcsRouterJobRecievedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, string jobStatus = null, string classificationPolicyId = null, int? priority = null, IEnumerable<AcsRouterWorkerSelector> requestedWorkerSelectors = null, DateTimeOffset? scheduledTimeUtc = null, bool? unavailableForMatching = null)
        {
            labels ??= new Dictionary<string, string>();
            tags ??= new Dictionary<string, string>();
            requestedWorkerSelectors ??= new List<AcsRouterWorkerSelector>();

            return new AcsRouterJobRecievedEventData(jobId, channelReference, channelId, queueId, labels, tags, jobStatus, classificationPolicyId, priority, requestedWorkerSelectors?.ToList(), scheduledTimeUtc, unavailableForMatching);
        }
        ...
        /// <param name="tags"> Router Jobs events Tags. </param>
        /// <param name="priority"> Router Job Priority. </param>
        /// <param name="attachedWorkerSelectorsExpired"> Router Job Scheduling Failed Attached Worker Selector Expired. </param>
        /// <param name="requestedWorkerSelectorsExpired"> Router Job Scheduling Failed Requested Worker Selector Expired. </param>
        ...
        public static AcsRouterJobSchedulingFailedEventData AcsRouterJobSchedulingFailedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, int? priority = null, IEnumerable<AcsRouterWorkerSelector> attachedWorkerSelectorsExpired = null, IEnumerable<AcsRouterWorkerSelector> requestedWorkerSelectorsExpired = null, DateTimeOffset? scheduledTimeUtc = null, string failureReason = null)
        {
            labels ??= new Dictionary<string, string>();
            tags ??= new Dictionary<string, string>();
            attachedWorkerSelectorsExpired ??= new List<AcsRouterWorkerSelector>();
            requestedWorkerSelectorsExpired ??= new List<AcsRouterWorkerSelector>();

            return new AcsRouterJobSchedulingFailedEventData(jobId, channelReference, channelId, queueId, labels, tags, priority, attachedWorkerSelectorsExpired?.ToList(), requestedWorkerSelectorsExpired?.ToList(), scheduledTimeUtc, failureReason);
        }
        ...
        public static AcsRouterJobWaitingForActivationEventData AcsRouterJobWaitingForActivationEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, int? priority = null, IEnumerable<AcsRouterWorkerSelector> attachedWorkerSelectorsExpired = null, IEnumerable<AcsRouterWorkerSelector> requestedWorkerSelectorsExpired = null, DateTimeOffset? scheduledTimeUtc = null, bool? unavailableForMatching = null)
        {
            labels ??= new Dictionary<string, string>();
            tags ??= new Dictionary<string, string>();
            attachedWorkerSelectorsExpired ??= new List<AcsRouterWorkerSelector>();
            ...
            return new AcsRouterJobWaitingForActivationEventData(jobId, channelReference, channelId, queueId, labels, tags, priority, attachedWorkerSelectorsExpired?.ToList(), requestedWorkerSelectorsExpired?.ToList(), scheduledTimeUtc, unavailableForMatching);
        }
        ...
        public static AcsRouterJobWorkerSelectorsExpiredEventData AcsRouterJobWorkerSelectorsExpiredEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, IEnumerable<AcsRouterWorkerSelector> requestedWorkerSelectorsExpired = null, IEnumerable<AcsRouterWorkerSelector> attachedWorkerSelectorsExpired = null)
        {
            labels ??= new Dictionary<string, string>();
            tags ??= new Dictionary<string, string>();
            requestedWorkerSelectorsExpired ??= new List<AcsRouterWorkerSelector>();
            ...
            return new AcsRouterJobWorkerSelectorsExpiredEventData(jobId, channelReference, channelId, queueId, labels, tags, requestedWorkerSelectorsExpired?.ToList(), attachedWorkerSelectorsExpired?.ToList());
        }
        ...
        /// <summary> Initializes a new instance of AcsRouterWorkerEventBaseProperties. </summary>
        /// <param name="jobId"> Router Event Job ID. </param>
        /// <param name="channelReference"> Router Event Channel Reference. </param>
        /// <param name="channelId"> Router Event Channel ID. </param>
        /// <param name="workerId"> Router Worker events Worker Id. </param>
        /// <returns> A new <see cref="SystemEvents.AcsRouterWorkerEventBaseProperties"/> instance for mocking. </returns>
        public static AcsRouterWorkerEventBaseProperties AcsRouterWorkerEventBaseProperties(string jobId = null, string channelReference = null, string channelId = null, string workerId = null)
        {
            return new AcsRouterWorkerEventBaseProperties(jobId, channelReference, channelId, workerId);
        }
        ...
        /// <param name="kubernetesVersion"> The Kubernetes version of the ManagedCluster resource. </param>
        /// <returns> A new <see cref="SystemEvents.ContainerServiceClusterSupportBaseProperties"/> instance for mocking. </returns>
        public static ContainerServiceClusterSupportBaseProperties ContainerServiceClusterSupportBaseProperties(string kubernetesVersion = null)
        {
            return new ContainerServiceClusterSupportBaseProperties(kubernetesVersion);
        }
        ...
        /// <param name="nodePoolName"> The name of the node pool in the ManagedCluster resource. </param>
        /// <returns> A new <see cref="SystemEvents.ContainerServiceNodePoolRollingBaseProperties"/> instance for mocking. </returns>
        public static ContainerServiceNodePoolRollingBaseProperties ContainerServiceNodePoolRollingBaseProperties(string nodePoolName = null)
        {
            return new ContainerServiceNodePoolRollingBaseProperties(nodePoolName);
        }
