...
"<lockTokens>"
            ...
            Response response = client.ReleaseCloudEvents("<topicName>", "<eventSubscriptionName>", content, releaseDelayInSeconds: BinaryData.FromObjectAsJson("<releaseDelayInSeconds>"));
...
"<lockTokens>"
            ...
            Response response = await client.ReleaseCloudEventsAsync("<topicName>", "<eventSubscriptionName>", content, releaseDelayInSeconds: BinaryData.FromObjectAsJson("<releaseDelayInSeconds>"));
        ...
        public void Example_EventGrid_ReleaseCloudEvents_AllParameters_Convenience()
        {
            ...
            ReleaseOptions releaseOptions = new ReleaseOptions(new string[] { "<lockTokens>" });
            Response<ReleaseResult> response = client.ReleaseCloudEvents("<topicName>", "<eventSubscriptionName>", releaseOptions, releaseDelayInSeconds: BinaryData.FromObjectAsJson("<releaseDelayInSeconds>"));
        }
        ...
        public async Task Example_EventGrid_ReleaseCloudEvents_AllParameters_Convenience_Async()
        {
            ...
            ReleaseOptions releaseOptions = new ReleaseOptions(new string[] { "<lockTokens>" });
            Response<ReleaseResult> response = await client.ReleaseCloudEventsAsync("<topicName>", "<eventSubscriptionName>", releaseOptions, releaseDelayInSeconds: BinaryData.FromObjectAsJson("<releaseDelayInSeconds>"));
        }
