...
namespace Azure.Messaging.EventGrid.Namespaces
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RenewCloudEventLocksResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RenewCloudEventLocksResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RenewCloudEventLocksResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RenewCloudEventLocksResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RenewCloudEventLocksResult)} does not support '{options.Format}' format.");
            }
        }
