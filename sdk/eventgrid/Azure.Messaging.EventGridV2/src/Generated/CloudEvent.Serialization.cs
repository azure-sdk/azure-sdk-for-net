...
namespace Azure.Messaging.EventGrid.Namespaces
{
    public partial class CloudEvent : IUtf8JsonSerializable, IJsonModel<CloudEvent>
    {
        ...
        void IJsonModel<CloudEvent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudEvent)} does not support '{format}' format.");
            }
        ...
        internal static CloudEvent DeserializeCloudEvent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CloudEvent(id, source, data.Value, dataBase64.Value, type, Optional.ToNullable(time), specversion, dataschema.Value, datacontenttype.Value, subject.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CloudEvent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CloudEvent)} does not support '{options.Format}' format.");
            }
        }
