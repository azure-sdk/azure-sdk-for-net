...
namespace Azure.Messaging.EventGrid.Namespaces
{
    ...
    public partial class RenewCloudEventLocksResult
    {
        ...
        {
            if (failedLockTokens == null)
            {
                throw new ArgumentNullException(nameof(failedLockTokens));
            }
            if (succeededLockTokens == null)
            {
                throw new ArgumentNullException(nameof(succeededLockTokens));
            }
