...
namespace Azure.Messaging.EventGrid.Namespaces
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReleaseOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ReleaseOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReleaseOptions)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ReleaseOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ReleaseOptions)} does not support '{options.Format}' format.");
            }
        }
