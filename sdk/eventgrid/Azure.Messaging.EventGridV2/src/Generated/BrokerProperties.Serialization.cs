...
{
    internal partial class BrokerProperties : IUtf8JsonSerializable, IJsonModel<BrokerProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BrokerProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BrokerProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BrokerProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BrokerProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BrokerProperties)} does not support '{options.Format}' format.");
            }
        }
