...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        protected MediaJobOutput(Azure.Messaging.EventGrid.SystemEvents.MediaJobError error, string label, long progress) { }
    ...
    {
        internal MediaJobOutputAsset() : base (default(Azure.Messaging.EventGrid.SystemEvents.MediaJobError), default(string), default(long)) { }
