...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerRegistryImageDeletedEventData : ContainerRegistryEventData
    {
        ...
        internal ContainerRegistryImageDeletedEventData(string id, DateTimeOffset timestamp, string action, string location, ContainerRegistryEventTarget target) : base(id, timestamp, action, location, target)
        {
