...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerRegistryImageDeletedEventData : ContainerRegistryEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/>, <paramref name="action"/>, <paramref name="location"/>, <paramref name="target"/>, <paramref name="request"/>, <paramref name="actor"/>, <paramref name="source"/> or <paramref name="connectedRegistry"/> is null. </exception>
        internal ContainerRegistryImageDeletedEventData(string id, string action, string location, ContainerRegistryEventTarget target, ContainerRegistryEventRequest request, ContainerRegistryEventActor actor, ContainerRegistryEventSource source, ContainerRegistryEventConnectedRegistry connectedRegistry) : base(id, action, location, target, request, actor, source, connectedRegistry)
        {
