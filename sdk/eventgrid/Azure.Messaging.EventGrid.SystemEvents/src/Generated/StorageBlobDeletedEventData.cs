...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageBlobDeletedEventData
    {
        ...
        internal StorageBlobDeletedEventData(string api, string clientRequestId, string requestId, string blobType, string url, string sequencer, string identity, IReadOnlyDictionary<string, BinaryData> storageDiagnostics)
        {
