...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobClassifiedEventData : AcsRouterJobEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="jobId"/>, <paramref name="channelReference"/>, <paramref name="channelId"/>, <paramref name="queueId"/>, <paramref name="labels"/>, <paramref name="tags"/>, <paramref name="queueDetails"/>, <paramref name="classificationPolicyId"/> or <paramref name="attachedWorkerSelectors"/> is null. </exception>
        internal AcsRouterJobClassifiedEventData(string jobId, string channelReference, string channelId, string queueId, IReadOnlyDictionary<string, string> labels, IReadOnlyDictionary<string, string> tags, AcsRouterQueueDetails queueDetails, string classificationPolicyId, IEnumerable<AcsRouterWorkerSelector> attachedWorkerSelectors) : base(jobId, channelReference, channelId, queueId, labels, tags)
        {
