...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatThreadPropertiesUpdatedPerUserEventData : AcsChatThreadEventBaseProperties
    {
        ...
        internal AcsChatThreadPropertiesUpdatedPerUserEventData(CommunicationIdentifierModel recipientCommunicationIdentifier, CommunicationIdentifierModel editedByCommunicationIdentifier, IReadOnlyDictionary<string, string> metadata, IReadOnlyDictionary<string, AcsChatThreadPropertiesUpdatedPerUserEventDataProperty> properties) : base(recipientCommunicationIdentifier)
        {
        ...
        /// <param name="metadata"> The thread metadata. </param>
        /// <param name="properties"> The updated thread properties. </param>
        internal AcsChatThreadPropertiesUpdatedPerUserEventData(CommunicationIdentifierModel recipientCommunicationIdentifier, string transactionId, string threadId, IDictionary<string, BinaryData> serializedAdditionalRawData, DateTimeOffset? createTime, long? version, CommunicationIdentifierModel editedByCommunicationIdentifier, DateTimeOffset? editTime, IReadOnlyDictionary<string, string> metadata, IReadOnlyDictionary<string, AcsChatThreadPropertiesUpdatedPerUserEventDataProperty> properties) : base(recipientCommunicationIdentifier, transactionId, threadId, serializedAdditionalRawData, createTime, version)
        {
            EditedByCommunicationIdentifier = editedByCommunicationIdentifier;
            EditTime = editTime;
            Metadata = metadata;
        ...
        public IReadOnlyDictionary<string, AcsChatThreadPropertiesUpdatedPerUserEventDataProperty> Properties { get; }
    }
}
