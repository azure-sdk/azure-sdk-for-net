...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AvsScriptExecutionCancelledEventData : AvsScriptExecutionEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="operationId"/>, <paramref name="cmdletId"/> or <paramref name="output"/> is null. </exception>
        internal AvsScriptExecutionCancelledEventData(string operationId, string cmdletId, IEnumerable<string> output) : base(operationId, cmdletId, output)
        {
