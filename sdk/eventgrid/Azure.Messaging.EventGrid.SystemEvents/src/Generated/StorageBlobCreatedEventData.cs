...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageBlobCreatedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="clientRequestId"/>, <paramref name="requestId"/>, <paramref name="eTag"/>, <paramref name="blobType"/>, <paramref name="url"/>, <paramref name="sequencer"/>, <paramref name="identity"/> or <paramref name="storageDiagnostics"/> is null. </exception>
        internal StorageBlobCreatedEventData(string clientRequestId, string requestId, string eTag, string blobType, string url, string sequencer, string identity, IReadOnlyDictionary<string, BinaryData> storageDiagnostics)
        {
