...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterWorkerSelector
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="labelValue"/> is null. </exception>
        internal AcsRouterWorkerSelector(string key, BinaryData labelValue, double timeToLive)
        {
