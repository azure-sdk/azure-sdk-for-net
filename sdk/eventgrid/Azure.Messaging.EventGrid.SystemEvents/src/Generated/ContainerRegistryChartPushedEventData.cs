...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerRegistryChartPushedEventData : ContainerRegistryArtifactEventData
    {
        ...
        internal ContainerRegistryChartPushedEventData(string id, string action, string location, ContainerRegistryArtifactEventTarget target, ContainerRegistryEventConnectedRegistry connectedRegistry) : base(id, action, location, target, connectedRegistry)
        {
