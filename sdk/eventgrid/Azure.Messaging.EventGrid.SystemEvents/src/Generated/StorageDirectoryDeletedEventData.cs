...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageDirectoryDeletedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="api"/>, <paramref name="clientRequestId"/>, <paramref name="requestId"/>, <paramref name="url"/>, <paramref name="recursive"/>, <paramref name="sequencer"/>, <paramref name="identity"/> or <paramref name="storageDiagnostics"/> is null. </exception>
        internal StorageDirectoryDeletedEventData(string api, string clientRequestId, string requestId, string url, string recursive, string sequencer, string identity, IReadOnlyDictionary<string, BinaryData> storageDiagnostics)
        {
            ...
            Argument.AssertNotNull(recursive, nameof(recursive));
