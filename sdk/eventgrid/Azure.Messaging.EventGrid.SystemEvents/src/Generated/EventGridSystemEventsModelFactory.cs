...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public static partial class EventGridSystemEventsModelFactory
    {
        ...
        /// <param name="segmentCount"> Number of segmensts in the message. </param>
        /// <returns> A new <see cref="SystemEvents.AcsSmsReceivedEventData"/> instance for mocking. </returns>
        public static AcsSmsReceivedEventData AcsSmsReceivedEventData(string messageId = null, string @from = null, string to = null, string message = null, DateTimeOffset? receivedTimestamp = null, int? segmentCount = null)
        {
