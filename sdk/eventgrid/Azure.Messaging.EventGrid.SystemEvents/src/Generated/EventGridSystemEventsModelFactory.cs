...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public static partial class EventGridSystemEventsModelFactory
    {
        ...
        public static AcsMessageAnalysisCompletedEventData AcsMessageAnalysisCompletedEventData(string @from = null, string to = null, DateTimeOffset receivedTimestamp = default, AcsMessageChannelEventError error = null, string originalMessage = null, AcsMessageChannelKind channelKind = default, string intentAnalysis = null, IEnumerable<string> keyPhraseExtraction = null, AcsMessageLanguageDetection languageDetection = null)
        {
            keyPhraseExtraction ??= new List<string>();
