...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageBlobTierChangedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="api"/>, <paramref name="requestId"/>, <paramref name="blobType"/>, <paramref name="url"/>, <paramref name="sequencer"/>, <paramref name="identity"/> or <paramref name="storageDiagnostics"/> is null. </exception>
        internal StorageBlobTierChangedEventData(string api, string requestId, string blobType, string url, string sequencer, string identity, IReadOnlyDictionary<string, BinaryData> storageDiagnostics)
        {
