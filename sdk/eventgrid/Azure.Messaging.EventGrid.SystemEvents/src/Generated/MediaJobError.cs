...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobError
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> or <paramref name="details"/> is null. </exception>
        internal MediaJobError(string message, IEnumerable<MediaJobErrorDetail> details)
        {
