...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerRegistryChartDeletedEventData : ContainerRegistryArtifactEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/>, <paramref name="action"/>, <paramref name="location"/>, <paramref name="target"/> or <paramref name="connectedRegistry"/> is null. </exception>
        internal ContainerRegistryChartDeletedEventData(string id, string action, string location, ContainerRegistryArtifactEventTarget target, ContainerRegistryEventConnectedRegistry connectedRegistry) : base(id, action, location, target, connectedRegistry)
        {
