...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MachineLearningServicesRunCompletedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="experimentId"/>, <paramref name="experimentName"/>, <paramref name="runId"/>, <paramref name="runType"/>, <paramref name="runTags"/> or <paramref name="runProperties"/> is null. </exception>
        internal MachineLearningServicesRunCompletedEventData(string experimentId, string experimentName, string runId, string runType, IReadOnlyDictionary<string, BinaryData> runTags, IReadOnlyDictionary<string, BinaryData> runProperties)
        {
