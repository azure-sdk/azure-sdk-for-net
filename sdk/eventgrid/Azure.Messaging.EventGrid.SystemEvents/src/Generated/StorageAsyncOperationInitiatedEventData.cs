...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageAsyncOperationInitiatedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="api"/>, <paramref name="clientRequestId"/>, <paramref name="requestId"/>, <paramref name="blobType"/>, <paramref name="url"/>, <paramref name="sequencer"/>, <paramref name="identity"/> or <paramref name="storageDiagnostics"/> is null. </exception>
        internal StorageAsyncOperationInitiatedEventData(string api, string clientRequestId, string requestId, string blobType, string url, string sequencer, string identity, IReadOnlyDictionary<string, BinaryData> storageDiagnostics)
        {
            ...
            Argument.AssertNotNull(blobType, nameof(blobType));
