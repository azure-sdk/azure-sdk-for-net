...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageBlobRenamedEventData
    {
        ...
        internal StorageBlobRenamedEventData(string api, string clientRequestId, string requestId, string sourceUrl, string destinationUrl, string sequencer, string identity, IReadOnlyDictionary<string, BinaryData> storageDiagnostics)
        {
