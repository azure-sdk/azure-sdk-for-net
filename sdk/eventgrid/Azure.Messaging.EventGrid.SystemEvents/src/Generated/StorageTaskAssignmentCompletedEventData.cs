...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageTaskAssignmentCompletedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="taskExecutionId"/>, <paramref name="taskName"/> or <paramref name="summaryReportBlobUri"/> is null. </exception>
        internal StorageTaskAssignmentCompletedEventData(string taskExecutionId, string taskName, Uri summaryReportBlobUri)
        {
