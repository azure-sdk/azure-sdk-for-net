...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class CommunicationIdentifierModel
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="rawId"/>, <paramref name="communicationUser"/>, <paramref name="phoneNumber"/>, <paramref name="microsoftTeamsUser"/> or <paramref name="microsoftTeamsApp"/> is null. </exception>
        internal CommunicationIdentifierModel(string rawId, CommunicationUserIdentifierModel communicationUser, PhoneNumberIdentifierModel phoneNumber, MicrosoftTeamsUserIdentifierModel microsoftTeamsUser, MicrosoftTeamsAppIdentifierModel microsoftTeamsApp)
        {
