...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsMessageDeliveryStatusUpdatedEventData : AcsMessageEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="from"/>, <paramref name="to"/>, <paramref name="error"/> or <paramref name="messageId"/> is null. </exception>
        internal AcsMessageDeliveryStatusUpdatedEventData(string @from, string to, AcsMessageChannelEventError error, string messageId) : base(@from, to, error)
        {
