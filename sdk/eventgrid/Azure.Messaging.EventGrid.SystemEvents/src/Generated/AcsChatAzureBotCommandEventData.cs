...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.Communication.ChatAzureBotCommand event. </summary>
    public partial class AcsChatAzureBotCommandEventData : AcsChatMessageEventInThreadBaseProperties
    {
        /// <summary> Initializes a new instance of <see cref="AcsChatAzureBotCommandEventData"/>. </summary>
        ...
        internal AcsChatAzureBotCommandEventData(CommunicationIdentifierModel senderCommunicationIdentifier, string type, long version) : base(senderCommunicationIdentifier, type, version)
        {
