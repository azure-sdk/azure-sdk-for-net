...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class WebRestoreOperationCompletedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="appEventTypeDetail"/>, <paramref name="name"/>, <paramref name="clientRequestId"/>, <paramref name="correlationRequestId"/>, <paramref name="requestId"/>, <paramref name="address"/> or <paramref name="verb"/> is null. </exception>
        internal WebRestoreOperationCompletedEventData(AppEventTypeDetail appEventTypeDetail, string name, string clientRequestId, string correlationRequestId, string requestId, string address, string verb)
        {
            ...
            Argument.AssertNotNull(correlationRequestId, nameof(correlationRequestId));
            Argument.AssertNotNull(requestId, nameof(requestId));
            Argument.AssertNotNull(address, nameof(address));
            Argument.AssertNotNull(verb, nameof(verb));
