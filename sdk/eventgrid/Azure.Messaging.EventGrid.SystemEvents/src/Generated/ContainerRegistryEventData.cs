...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerRegistryEventData
    {
        ...
        internal ContainerRegistryEventData(string id, string action, string location, ContainerRegistryEventTarget target, ContainerRegistryEventRequest request, ContainerRegistryEventActor actor, ContainerRegistryEventSource source, ContainerRegistryEventConnectedRegistry connectedRegistry)
        {
