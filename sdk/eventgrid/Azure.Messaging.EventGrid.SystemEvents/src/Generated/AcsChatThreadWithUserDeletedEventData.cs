...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatThreadWithUserDeletedEventData : AcsChatThreadEventBaseProperties
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="recipientCommunicationIdentifier"/>, <paramref name="transactionId"/>, <paramref name="threadId"/> or <paramref name="deletedByCommunicationIdentifier"/> is null. </exception>
        internal AcsChatThreadWithUserDeletedEventData(CommunicationIdentifierModel recipientCommunicationIdentifier, string transactionId, string threadId, CommunicationIdentifierModel deletedByCommunicationIdentifier) : base(recipientCommunicationIdentifier, transactionId, threadId)
        {
