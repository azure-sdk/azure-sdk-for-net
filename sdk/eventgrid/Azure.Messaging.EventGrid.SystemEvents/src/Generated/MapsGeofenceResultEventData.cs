...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MapsGeofenceResultEventData : MapsGeofenceEventProperties
    {
        ...
        internal MapsGeofenceResultEventData(IEnumerable<string> expiredGeofenceGeometryId, IEnumerable<MapsGeofenceGeometry> geometries, IEnumerable<string> invalidPeriodGeofenceGeometryId, bool isEventPublished) : base(expiredGeofenceGeometryId, geometries, invalidPeriodGeofenceGeometryId, isEventPublished)
        {
