...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageDirectoryCreatedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="api"/>, <paramref name="clientRequestId"/>, <paramref name="requestId"/>, <paramref name="eTag"/>, <paramref name="url"/>, <paramref name="sequencer"/>, <paramref name="identity"/> or <paramref name="storageDiagnostics"/> is null. </exception>
        internal StorageDirectoryCreatedEventData(string api, string clientRequestId, string requestId, string eTag, string url, string sequencer, string identity, IReadOnlyDictionary<string, BinaryData> storageDiagnostics)
        {
