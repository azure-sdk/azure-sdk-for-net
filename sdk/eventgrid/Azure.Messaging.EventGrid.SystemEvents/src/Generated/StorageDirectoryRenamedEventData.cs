...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageDirectoryRenamedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="api"/>, <paramref name="clientRequestId"/>, <paramref name="requestId"/>, <paramref name="sourceUrl"/>, <paramref name="destinationUrl"/>, <paramref name="sequencer"/>, <paramref name="identity"/> or <paramref name="storageDiagnostics"/> is null. </exception>
        internal StorageDirectoryRenamedEventData(string api, string clientRequestId, string requestId, string sourceUrl, string destinationUrl, string sequencer, string identity, IReadOnlyDictionary<string, BinaryData> storageDiagnostics)
        {
            ...
            Argument.AssertNotNull(destinationUrl, nameof(destinationUrl));
            Argument.AssertNotNull(sequencer, nameof(sequencer));
