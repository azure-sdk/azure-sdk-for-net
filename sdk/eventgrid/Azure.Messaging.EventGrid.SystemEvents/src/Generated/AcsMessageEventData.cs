...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsMessageEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="from"/>, <paramref name="to"/> or <paramref name="error"/> is null. </exception>
        internal AcsMessageEventData(string @from, string to, AcsMessageChannelEventError error)
        {
