...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatMessageReceivedEventData : AcsChatMessageEventBaseProperties
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="recipientCommunicationIdentifier"/>, <paramref name="transactionId"/>, <paramref name="threadId"/>, <paramref name="messageId"/>, <paramref name="senderCommunicationIdentifier"/>, <paramref name="senderDisplayName"/>, <paramref name="type"/>, <paramref name="messageBody"/> or <paramref name="metadata"/> is null. </exception>
        internal AcsChatMessageReceivedEventData(CommunicationIdentifierModel recipientCommunicationIdentifier, string transactionId, string threadId, string messageId, CommunicationIdentifierModel senderCommunicationIdentifier, string senderDisplayName, string type, string messageBody, IReadOnlyDictionary<string, string> metadata) : base(recipientCommunicationIdentifier, transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, type)
        {
