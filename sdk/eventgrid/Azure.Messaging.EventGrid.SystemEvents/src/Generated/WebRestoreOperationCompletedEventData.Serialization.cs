...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebRestoreOperationCompletedEventData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
