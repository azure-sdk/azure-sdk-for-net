...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerServiceNewKubernetesVersionAvailableEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="latestSupportedKubernetesVersion"/>, <paramref name="latestStableKubernetesVersion"/>, <paramref name="lowestMinorKubernetesVersion"/> or <paramref name="latestPreviewKubernetesVersion"/> is null. </exception>
        internal ContainerServiceNewKubernetesVersionAvailableEventData(string latestSupportedKubernetesVersion, string latestStableKubernetesVersion, string lowestMinorKubernetesVersion, string latestPreviewKubernetesVersion)
        {
            ...
            Argument.AssertNotNull(latestPreviewKubernetesVersion, nameof(latestPreviewKubernetesVersion));
