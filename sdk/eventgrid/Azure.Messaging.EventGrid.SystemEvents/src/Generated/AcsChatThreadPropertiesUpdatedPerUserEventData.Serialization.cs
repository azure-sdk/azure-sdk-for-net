...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    public partial class AcsChatThreadPropertiesUpdatedPerUserEventData : IUtf8JsonSerializable, IJsonModel<AcsChatThreadPropertiesUpdatedPerUserEventData>
    {
        ...
        internal static AcsChatThreadPropertiesUpdatedPerUserEventData DeserializeAcsChatThreadPropertiesUpdatedPerUserEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyDictionary<string, AcsChatThreadPropertiesUpdatedPerUserEventDataProperty> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    Dictionary<string, AcsChatThreadPropertiesUpdatedPerUserEventDataProperty> dictionary = new Dictionary<string, AcsChatThreadPropertiesUpdatedPerUserEventDataProperty>();
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        dictionary.Add(property0.Name, AcsChatThreadPropertiesUpdatedPerUserEventDataProperty.DeserializeAcsChatThreadPropertiesUpdatedPerUserEventDataProperty(property0.Value, options));
                    }
