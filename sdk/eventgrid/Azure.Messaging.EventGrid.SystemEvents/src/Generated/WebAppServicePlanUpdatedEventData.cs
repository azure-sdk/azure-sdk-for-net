...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class WebAppServicePlanUpdatedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="appServicePlanEventTypeDetail"/>, <paramref name="sku"/>, <paramref name="name"/>, <paramref name="clientRequestId"/>, <paramref name="correlationRequestId"/>, <paramref name="requestId"/>, <paramref name="address"/> or <paramref name="verb"/> is null. </exception>
