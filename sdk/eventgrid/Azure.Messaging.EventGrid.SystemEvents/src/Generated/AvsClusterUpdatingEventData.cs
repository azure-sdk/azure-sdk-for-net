...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AvsClusterUpdatingEventData : AvsClusterEventData
    {
        ...
        internal AvsClusterUpdatingEventData(string operationId, IEnumerable<string> addedHostNames, IEnumerable<string> removedHostNames, IEnumerable<string> inMaintenanceHostNames) : base(operationId, addedHostNames, removedHostNames, inMaintenanceHostNames)
        {
