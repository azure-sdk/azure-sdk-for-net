...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MachineLearningServicesRunStatusChangedEventData
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="experimentId"/>, <paramref name="experimentName"/>, <paramref name="runId"/>, <paramref name="runType"/>, <paramref name="runTags"/>, <paramref name="runProperties"/> or <paramref name="runStatus"/> is null. </exception>
        internal MachineLearningServicesRunStatusChangedEventData(string experimentId, string experimentName, string runId, string runType, IReadOnlyDictionary<string, BinaryData> runTags, IReadOnlyDictionary<string, BinaryData> runProperties, string runStatus)
        {
