...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatMessageDeletedEventData : AcsChatMessageEventBaseProperties
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="recipientCommunicationIdentifier"/>, <paramref name="transactionId"/>, <paramref name="threadId"/>, <paramref name="messageId"/>, <paramref name="senderCommunicationIdentifier"/>, <paramref name="senderDisplayName"/> or <paramref name="type"/> is null. </exception>
        internal AcsChatMessageDeletedEventData(CommunicationIdentifierModel recipientCommunicationIdentifier, string transactionId, string threadId, string messageId, CommunicationIdentifierModel senderCommunicationIdentifier, string senderDisplayName, string type) : base(recipientCommunicationIdentifier, transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, type)
        {
