...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatThreadCreatedEventData : AcsChatThreadEventInThreadBaseProperties
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="threadId"/>, <paramref name="createdByCommunicationIdentifier"/>, <paramref name="properties"/> or <paramref name="participants"/> is null. </exception>
        internal AcsChatThreadCreatedEventData(string threadId, CommunicationIdentifierModel createdByCommunicationIdentifier, IReadOnlyDictionary<string, BinaryData> properties, IEnumerable<AcsChatThreadParticipantProperties> participants) : base(threadId)
        {
