...
namespace Azure.ResourceManager.Fabric
{
    ...
    public static partial class FabricExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableFabricSubscriptionResource.GetUsagesFabricCapacity(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="subscriptionResource"> The <see cref="SubscriptionResource" /> instance the method will execute against. </param>
        ...
        public static async Task<Response<FabricUsageAndQuotaDetailsForExistingResource>> GetUsagesFabricCapacityAsync(this SubscriptionResource subscriptionResource, string location, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return await GetMockableFabricSubscriptionResource(subscriptionResource).GetUsagesFabricCapacityAsync(location, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="location"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionResource"/> or <paramref name="location"/> is null. </exception>
        public static Response<FabricUsageAndQuotaDetailsForExistingResource> GetUsagesFabricCapacity(this SubscriptionResource subscriptionResource, string location, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return GetMockableFabricSubscriptionResource(subscriptionResource).GetUsagesFabricCapacity(location, cancellationToken);
        }
    }
}
