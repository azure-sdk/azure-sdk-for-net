...
namespace Azure.ResourceManager.Fabric.Models
{
    ...
    internal partial class PagedQuota : IJsonModel<PagedQuota>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (FabricCapacitiesQuota item in Value)
            {
        ...
        internal static PagedQuota DeserializePagedQuota(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<FabricCapacitiesQuota> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<FabricCapacitiesQuota> array = new List<FabricCapacitiesQuota>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(FabricCapacitiesQuota.DeserializeFabricCapacitiesQuota(item, options));
                    }
                    value = array;
                    continue;
                }
