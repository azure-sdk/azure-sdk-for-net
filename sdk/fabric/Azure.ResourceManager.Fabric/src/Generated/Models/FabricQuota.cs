...
namespace Azure.ResourceManager.Fabric.Models
{
    ...
    public partial class FabricQuota
    {
        ...
        internal FabricQuota(ResourceIdentifier id, string unit, long currentValue, long limit)
        {
        ...
        internal FabricQuota(QuotaName name, ResourceIdentifier id, string unit, long currentValue, long limit, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
            Unit = unit;
