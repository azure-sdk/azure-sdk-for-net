...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public static partial class ArmAuthorizationModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AuthorizationProviderOperationsMetadata"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Models.AuthorizationProviderOperationsMetadata"/> instance for mocking. </returns>
        public static AuthorizationProviderOperationsMetadata AuthorizationProviderOperationsMetadata(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, IEnumerable<AuthorizationProviderResourceType> resourceTypes = null, IEnumerable<AuthorizationProviderOperationInfo> operations = null)
        {
