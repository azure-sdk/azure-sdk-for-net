...
namespace Azure.ResourceManager.Support.Samples
{
    public partial class Sample_TenantResourceExtensions
    {
        ...
        public async Task ClassifyServicesServiceClassificationsNoSubscription_ClassifyListOfAzureServices()
        {
            ...
            ServiceClassificationRequest serviceClassificationRequest = new ServiceClassificationRequest()
            {
        ...
        public async Task PostLookUpResourceId_LookUpResourceIdOfSupportResourceType()
        {
            ...
            LookUpResourceIdResponse result = await tenantResource.PostLookUpResourceIdAsync(content);
