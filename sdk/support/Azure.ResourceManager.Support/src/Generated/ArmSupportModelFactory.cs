...
namespace Azure.ResourceManager.Support.Models
{
    ...
    public static partial class ArmSupportModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.Support.SupportAzureServiceData" />. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        /// <param name="displayName"> Localized name of the Azure service. </param>
        /// <param name="resourceTypes"> ARM Resource types. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.Support.SupportAzureServiceData" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static SupportAzureServiceData SupportAzureServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, IEnumerable<string> resourceTypes)
        {
            return SupportAzureServiceData(id: id, name: name, resourceType: resourceType, systemData: systemData, displayName: displayName, resourceTypes: resourceTypes, metadata: default);
        }

        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.Support.ProblemClassificationData" />. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        /// <param name="displayName"> Localized name of problem classification. </param>
        /// <param name="secondaryConsentEnabled"> This property indicates whether secondary consent is present for problem classification. </param>
        /// <returns> A new <see cref="T:Azure.ResourceManager.Support.ProblemClassificationData" /> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static ProblemClassificationData ProblemClassificationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, IEnumerable<SecondaryConsentEnabled> secondaryConsentEnabled)
        {
            return ProblemClassificationData(id: id, name: name, resourceType: resourceType, systemData: systemData, displayName: displayName, secondaryConsentEnabled: secondaryConsentEnabled, metadata: default, parentProblemClassification: default);
        }
    }
}
