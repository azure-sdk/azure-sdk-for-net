...
namespace Azure.ResourceManager.Support
{
    internal partial class ServiceClassificationsRestOperations
    {
        ...
        internal HttpMessage CreateClassifyServicesRequest(string subscriptionId, ServiceClassificationRequest serviceClassificationRequest)
        {
        ...
        public async Task<Response<ServiceClassificationOutput>> ClassifyServicesAsync(string subscriptionId, ServiceClassificationRequest serviceClassificationRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="serviceClassificationRequest"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<ServiceClassificationOutput> ClassifyServices(string subscriptionId, ServiceClassificationRequest serviceClassificationRequest, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
