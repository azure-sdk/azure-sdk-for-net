...
namespace Azure.ResourceManager.Support.Models
{
    ...
    public partial class ServiceClassificationAnswer : ClassificationService
    {
        ...
        internal ServiceClassificationAnswer(ResourceIdentifier serviceId, string displayName, IReadOnlyList<string> resourceTypes, IDictionary<string, BinaryData> serializedAdditionalRawData, ClassificationService childService) : base(serviceId, displayName, resourceTypes, serializedAdditionalRawData)
        {
