...
namespace Azure.ResourceManager.Support.Mocking
{
    ...
    public partial class MockableSupportSubscriptionResource : ArmResource
    {
        ...
        public virtual async Task<Response<ServiceClassificationOutput>> ClassifyServicesServiceClassificationAsync(ServiceClassificationRequest serviceClassificationRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="serviceClassificationRequest"/> is null. </exception>
        public virtual Response<ServiceClassificationOutput> ClassifyServicesServiceClassification(ServiceClassificationRequest serviceClassificationRequest, CancellationToken cancellationToken = default)
        {
            if (serviceClassificationRequest == null)
            {
                throw new ArgumentNullException(nameof(serviceClassificationRequest));
