...
namespace Azure.ResourceManager.Support.Mocking
{
    ...
    public partial class MockableSupportTenantResource : ArmResource
    {
        ...
        public virtual async Task<Response<ServiceClassificationOutput>> ClassifyServicesServiceClassificationsNoSubscriptionAsync(ServiceClassificationRequest serviceClassificationRequest, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await ServiceClassificationsNoSubscriptionRestClient.ClassifyServicesAsync(serviceClassificationRequest, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="serviceClassificationRequest"/> is null. </exception>
        public virtual Response<ServiceClassificationOutput> ClassifyServicesServiceClassificationsNoSubscription(ServiceClassificationRequest serviceClassificationRequest, CancellationToken cancellationToken = default)
        {
            if (serviceClassificationRequest == null)
            {
                throw new ArgumentNullException(nameof(serviceClassificationRequest));
            ...
            try
            {
                var response = ServiceClassificationsNoSubscriptionRestClient.ClassifyServices(serviceClassificationRequest, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<Response<LookUpResourceIdResponse>> PostLookUpResourceIdAsync(LookUpResourceIdContent content, CancellationToken cancellationToken = default)
        {
            if (content == null)
            {
                throw new ArgumentNullException(nameof(content));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<LookUpResourceIdResponse> PostLookUpResourceId(LookUpResourceIdContent content, CancellationToken cancellationToken = default)
        {
            if (content == null)
            {
                throw new ArgumentNullException(nameof(content));
