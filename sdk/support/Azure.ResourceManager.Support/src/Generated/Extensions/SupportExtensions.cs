...
namespace Azure.ResourceManager.Support
{
    ...
    public static partial class SupportExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableSupportSubscriptionResource.ClassifyProblemsProblemClassification(string,ServiceProblemClassificationContent,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="subscriptionResource"> The <see cref="SubscriptionResource" /> instance the method will execute against. </param>
        ...
        public static async Task<Response<ServiceProblemClassificationListResult>> ClassifyProblemsProblemClassificationAsync(this SubscriptionResource subscriptionResource, string problemServiceName, ServiceProblemClassificationContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return await GetMockableSupportSubscriptionResource(subscriptionResource).ClassifyProblemsProblemClassificationAsync(problemServiceName, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="problemServiceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionResource"/>, <paramref name="problemServiceName"/> or <paramref name="content"/> is null. </exception>
        public static Response<ServiceProblemClassificationListResult> ClassifyProblemsProblemClassification(this SubscriptionResource subscriptionResource, string problemServiceName, ServiceProblemClassificationContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return GetMockableSupportSubscriptionResource(subscriptionResource).ClassifyProblemsProblemClassification(problemServiceName, content, cancellationToken);
        }
