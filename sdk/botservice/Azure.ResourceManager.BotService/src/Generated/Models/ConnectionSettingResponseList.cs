...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    internal partial class ConnectionSettingResponseList
    {
        ...
        internal ConnectionSettingResponseList(IEnumerable<ConnectionSettingData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ConnectionSettingResponseList(IReadOnlyList<ConnectionSettingData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
