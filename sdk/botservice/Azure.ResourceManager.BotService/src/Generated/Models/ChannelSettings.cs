...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class ChannelSettings
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ChannelSettings"/>. </summary>
        ...
        internal ChannelSettings(string extensionKey1, string extensionKey2, IReadOnlyList<Site> sites, string channelId, string channelDisplayName, string botId, string botIconUri, bool? isEnabled, bool? disableLocalAuth, bool? requireTermsAgreement, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
