...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class OperationEntity
    {
        ...
        internal OperationEntity(string name, OperationDisplayInfo display, string origin, BinaryData properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Display = display;
            Origin = origin;
