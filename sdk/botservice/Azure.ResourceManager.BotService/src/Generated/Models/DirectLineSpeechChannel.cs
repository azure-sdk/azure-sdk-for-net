...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class DirectLineSpeechChannel : Channel
    {
        ...
        internal DirectLineSpeechChannel(string channelName, string etag, string provisioningState, string location, IDictionary<string, BinaryData> serializedAdditionalRawData, DirectLineSpeechChannelProperties properties) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
