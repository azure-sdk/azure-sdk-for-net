...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class ServiceProviderParameter
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ServiceProviderParameter"/>. </summary>
        ...
        internal ServiceProviderParameter(string name, string type, string displayName, string description, string helpUri, string @default, ServiceProviderParameterMetadata metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Type = type;
