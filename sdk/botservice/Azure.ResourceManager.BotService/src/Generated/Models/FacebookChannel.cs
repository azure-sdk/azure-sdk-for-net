...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class FacebookChannel : Channel
    {
        ...
        internal FacebookChannel(string channelName, string etag, string provisioningState, string location, IDictionary<string, BinaryData> serializedAdditionalRawData, FacebookChannelProperties properties) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
