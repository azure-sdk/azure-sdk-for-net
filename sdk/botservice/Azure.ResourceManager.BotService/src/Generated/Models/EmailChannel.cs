...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class EmailChannel : Channel
    {
        ...
        internal EmailChannel(string channelName, string etag, string provisioningState, string location, IDictionary<string, BinaryData> serializedAdditionalRawData, EmailChannelProperties properties) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
