...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class ConnectionSettingProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ConnectionSettingProperties"/>. </summary>
        ...
        internal ConnectionSettingProperties(string id, string name, string clientId, string settingId, string clientSecret, string scopes, string serviceProviderId, string serviceProviderDisplayName, IList<ConnectionSettingParameter> parameters, string provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            ClientId = clientId;
