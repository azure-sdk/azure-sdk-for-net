...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class CheckNameAvailabilityResponseBody
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CheckNameAvailabilityResponseBody"/>. </summary>
        ...
        internal CheckNameAvailabilityResponseBody(bool? valid, string message, string absCode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Valid = valid;
            Message = message;
            AbsCode = absCode;
