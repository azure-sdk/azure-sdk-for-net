...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class KikChannel : Channel
    {
        ...
        internal KikChannel(string channelName, string etag, string provisioningState, string location, IDictionary<string, BinaryData> serializedAdditionalRawData, KikChannelProperties properties) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
