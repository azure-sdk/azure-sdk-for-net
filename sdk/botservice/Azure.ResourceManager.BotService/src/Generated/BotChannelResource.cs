...
namespace Azure.ResourceManager.BotService
{
    ...
    public partial class BotChannelResource : ArmResource
    {
        ...
        {
            using var scope = _botChannelClientDiagnostics.CreateScope("BotChannelResource.GetWithKeys");
            scope.Start();
            try
            {
                var response = await _botChannelRestClient.ListWithKeysAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ListChannelWithKeysResponse> GetWithKeys(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _botChannelRestClient.ListWithKeys(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<BotChannelResource>> RegenerateKeysAsync(SiteContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = _botChannelClientDiagnostics.CreateScope("BotChannelResource.RegenerateKeys");
            scope.Start();
            try
            {
                var response = await _botChannelRestClient.RegenerateKeysAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new BotChannelResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<BotChannelResource> RegenerateKeys(SiteContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = _botChannelRestClient.RegenerateKeys(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken);
                return Response.FromValue(new BotChannelResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
