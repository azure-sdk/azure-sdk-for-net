...
namespace Azure.ResourceManager.BotService
{
    ...
    public partial class BotResource : ArmResource
    {
        ...
        {
            using var scope = _botClientDiagnostics.CreateScope("BotResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _botClientDiagnostics.CreateScope("BotResource.Delete");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CreateEmailSignInUrlResponse>> CreateSignInUrlAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CreateEmailSignInUrlResponse> CreateSignInUrl(CancellationToken cancellationToken = default)
        {
            using var scope = _botClientDiagnostics.CreateScope("BotResource.CreateSignInUrl");
            scope.Start();
            try
        ...
        public virtual async Task<Response<BotResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new BotData(current.Location);
