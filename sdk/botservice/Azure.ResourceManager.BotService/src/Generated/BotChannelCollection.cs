...
namespace Azure.ResourceManager.BotService
{
    ...
    public partial class BotChannelCollection : ArmCollection, IEnumerable<BotChannelResource>, IAsyncEnumerable<BotChannelResource>
    {
        ...
        public virtual async Task<ArmOperation<BotChannelResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string channelName, BotChannelData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="channelName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="channelName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<BotChannelResource> CreateOrUpdate(WaitUntil waitUntil, string channelName, BotChannelData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(channelName, nameof(channelName));
            Argument.AssertNotNull(data, nameof(data));
