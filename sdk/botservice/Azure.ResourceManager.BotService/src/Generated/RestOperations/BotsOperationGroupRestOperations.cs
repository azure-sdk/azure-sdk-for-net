...
{
    internal partial class BotsOperationGroupRestOperations
    {
        ...
        /// <summary> Initializes a new instance of BotsOperationGroupRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service host. </param>
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public BotsOperationGroupRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal RequestUriBuilder CreateGetCheckNameAvailabilityRequestUri(CheckNameAvailabilityRequestBody checkNameAvailabilityRequestBody)
        {
        ...
        internal HttpMessage CreateGetCheckNameAvailabilityRequest(CheckNameAvailabilityRequestBody checkNameAvailabilityRequestBody)
        {
            ...
            content.JsonWriter.WriteObjectValue(checkNameAvailabilityRequestBody, ModelSerializationExtensions.WireOptions);
