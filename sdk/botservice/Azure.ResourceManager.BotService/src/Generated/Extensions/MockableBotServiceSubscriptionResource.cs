...
namespace Azure.ResourceManager.BotService.Mocking
{
    ...
    public partial class MockableBotServiceSubscriptionResource : ArmResource
    {
        ...
        public virtual AsyncPageable<ServiceProvider> GetServiceProvidersBotConnectionOperationGroupsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => ServiceProvider.DeserializeServiceProvider(e), BotConnectionOperationGroupClientDiagnostics, Pipeline, "MockableBotServiceSubscriptionResource.GetServiceProvidersBotConnectionOperationGroups", "value", null, cancellationToken);
        }
        ...
        public virtual Pageable<ServiceProvider> GetServiceProvidersBotConnectionOperationGroups(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BotConnectionOperationGroupRestClient.CreateListServiceProvidersRequest(Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => ServiceProvider.DeserializeServiceProvider(e), BotConnectionOperationGroupClientDiagnostics, Pipeline, "MockableBotServiceSubscriptionResource.GetServiceProvidersBotConnectionOperationGroups", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<QnAMakerEndpointKeysResponse>> GetQnAMakerEndpointKeysOperationGroupAsync(QnAMakerEndpointKeysRequestBody qnAMakerEndpointKeysRequestBody, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await QnAMakerEndpointKeysOperationGroupRestClient.GetAsync(Id.SubscriptionId, qnAMakerEndpointKeysRequestBody, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="qnAMakerEndpointKeysRequestBody"/> is null. </exception>
        public virtual Response<QnAMakerEndpointKeysResponse> GetQnAMakerEndpointKeysOperationGroup(QnAMakerEndpointKeysRequestBody qnAMakerEndpointKeysRequestBody, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(qnAMakerEndpointKeysRequestBody, nameof(qnAMakerEndpointKeysRequestBody));
            ...
            try
            {
                var response = QnAMakerEndpointKeysOperationGroupRestClient.Get(Id.SubscriptionId, qnAMakerEndpointKeysRequestBody, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<HostSettingsResponse>> GetHostSettingsOperationGroupAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<HostSettingsResponse> GetHostSettingsOperationGroup(CancellationToken cancellationToken = default)
        {
            using var scope = HostSettingsOperationGroupClientDiagnostics.CreateScope("MockableBotServiceSubscriptionResource.GetHostSettingsOperationGroup");
            scope.Start();
            try
