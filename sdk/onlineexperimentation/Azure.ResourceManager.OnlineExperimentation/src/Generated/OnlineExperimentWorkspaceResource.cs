...
namespace Azure.ResourceManager.OnlineExperimentation
{
    ...
    public partial class OnlineExperimentWorkspaceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<OnlineExperimentWorkspaceResource>> UpdateAsync(WaitUntil waitUntil, OnlineExperimentWorkspaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _onlineExperimentWorkspaceRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var operation = new OnlineExperimentationArmOperation<OnlineExperimentWorkspaceResource>(new OnlineExperimentWorkspaceOperationSource(Client), _onlineExperimentWorkspaceClientDiagnostics, Pipeline, _onlineExperimentWorkspaceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<OnlineExperimentWorkspaceResource> Update(WaitUntil waitUntil, OnlineExperimentWorkspaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _onlineExperimentWorkspaceRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken);
                var operation = new OnlineExperimentationArmOperation<OnlineExperimentWorkspaceResource>(new OnlineExperimentWorkspaceOperationSource(Client), _onlineExperimentWorkspaceClientDiagnostics, Pipeline, _onlineExperimentWorkspaceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<OnlineExperimentWorkspaceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new OnlineExperimentWorkspaceData(current.Location);
