...
namespace Azure.ResourceManager.OnlineExperimentation.Samples
{
    public partial class Sample_OnlineExperimentWorkspaceResource
    {
        ...
        public async Task Update_UpdateAnOnlineExperimentWorkspace()
        {
            ...
            // invoke the operation
            OnlineExperimentWorkspaceData data = new OnlineExperimentWorkspaceData(default)
            {
...
["newKey"] = "newVal"
            ...
            ArmOperation<OnlineExperimentWorkspaceResource> lro = await onlineExperimentWorkspace.UpdateAsync(WaitUntil.Completed, data);
