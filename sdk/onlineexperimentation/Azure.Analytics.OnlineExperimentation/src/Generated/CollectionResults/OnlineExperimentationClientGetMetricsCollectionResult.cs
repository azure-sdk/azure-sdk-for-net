...
namespace Azure.Analytics.OnlineExperimentation
{
    internal partial class OnlineExperimentationClientGetMetricsCollectionResult : Pageable<BinaryData>
    {
        ...
        public OnlineExperimentationClientGetMetricsCollectionResult(OnlineExperimentationClient client, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of OnlineExperimentationClientGetMetricsCollectionResult as an enumerable collection. </summary>
