...
namespace Azure.Analytics.OnlineExperimentation
{
    internal partial class OnlineExperimentationClientGetMetricsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public OnlineExperimentationClientGetMetricsAsyncCollectionResult(OnlineExperimentationClient client, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
