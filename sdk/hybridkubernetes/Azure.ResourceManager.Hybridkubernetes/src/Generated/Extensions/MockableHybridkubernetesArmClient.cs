...
namespace Azure.ResourceManager.Hybridkubernetes.Mocking
{
    ...
    public partial class MockableHybridkubernetesArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableHybridkubernetesArmClient"/> class for mocking. </summary>
        protected MockableHybridkubernetesArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableHybridkubernetesArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableHybridkubernetesArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableHybridkubernetesArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
