...
namespace Azure.ResourceManager.Hybridkubernetes.Mocking
{
    ...
    public partial class MockableHybridkubernetesSubscriptionResource : ArmResource
    {
        private ClientDiagnostics _connectedClusterClientDiagnostics;
        private ConnectedClustersRestOperations _connectedClusterRestClient;

        /// <summary> Initializes a new instance of the <see cref="MockableHybridkubernetesSubscriptionResource"/> class for mocking. </summary>
        protected MockableHybridkubernetesSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableHybridkubernetesSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableHybridkubernetesSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics ConnectedClusterClientDiagnostics => _connectedClusterClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Hybridkubernetes", ConnectedClusterResource.ResourceType.Namespace, Diagnostics);
        private ConnectedClustersRestOperations ConnectedClusterRestClient => _connectedClusterRestClient ??= new ConnectedClustersRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, GetApiVersionOrNull(ConnectedClusterResource.ResourceType));
