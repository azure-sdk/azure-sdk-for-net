...
namespace Azure.ResourceManager.Hybridkubernetes.Mocking
{
    ...
    public partial class MockableHybridkubernetesResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableHybridkubernetesResourceGroupResource"/> class for mocking. </summary>
        protected MockableHybridkubernetesResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableHybridkubernetesResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableHybridkubernetesResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
