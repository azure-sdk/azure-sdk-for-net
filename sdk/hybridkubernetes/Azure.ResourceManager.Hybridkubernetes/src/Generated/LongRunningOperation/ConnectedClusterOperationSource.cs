...
namespace Azure.ResourceManager.Hybridkubernetes
{
    internal class ConnectedClusterOperationSource : IOperationSource<ConnectedClusterResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<ConnectedClusterData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerHybridkubernetesContext.Default);
