...
#pragma warning disable SA1649 // File name should match first type name
    internal class HybridkubernetesArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of HybridkubernetesArmOperation for mocking. </summary>
        protected HybridkubernetesArmOperation()
        {
        }

        internal HybridkubernetesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HybridkubernetesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "HybridkubernetesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerHybridkubernetesContext.Default).ToObjectFromJson<Dictionary<string, string>>();
