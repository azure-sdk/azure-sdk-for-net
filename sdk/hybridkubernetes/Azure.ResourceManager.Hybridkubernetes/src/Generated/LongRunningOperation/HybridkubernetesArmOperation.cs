...
#pragma warning disable SA1649 // File name should match first type name
    internal class HybridkubernetesArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal HybridkubernetesArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HybridkubernetesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "HybridkubernetesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
