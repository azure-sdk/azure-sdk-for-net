        ...
        internal static SecurityProfile DeserializeSecurityProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("workloadIdentity"u8))
                {
                    ...
                    workloadIdentity = SecurityProfileWorkloadIdentity.DeserializeSecurityProfileWorkloadIdentity(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new SecurityProfile(workloadIdentity, serializedAdditionalRawData);
        }
