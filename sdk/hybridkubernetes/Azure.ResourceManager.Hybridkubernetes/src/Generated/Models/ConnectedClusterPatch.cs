...
namespace Azure.ResourceManager.Hybridkubernetes.Models
{
    ...
    public partial class ConnectedClusterPatch
    {
        ...
        internal ConnectedClusterPatch(IDictionary<string, string> tags, string distribution, string distributionVersion, AzureHybridBenefit? azureHybridBenefit, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
