...
namespace Azure.ResourceManager.Hybridkubernetes.Models
{
    ...
    public partial class Gateway
    {
        ...
        /// <param name="resourceId"> The resource ID of the gateway used for the Arc router feature. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal Gateway(bool? enabled, ResourceIdentifier resourceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
