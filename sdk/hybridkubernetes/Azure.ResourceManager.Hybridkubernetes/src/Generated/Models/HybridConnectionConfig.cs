...
namespace Azure.ResourceManager.Hybridkubernetes.Models
{
    ...
    public partial class HybridConnectionConfig
    {
        ...
        internal HybridConnectionConfig(long? expirationTime, string hybridConnectionName, string relay, string token, string relayTid, string relayType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
