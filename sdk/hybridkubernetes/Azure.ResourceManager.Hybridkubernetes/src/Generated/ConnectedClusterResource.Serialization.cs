...
namespace Azure.ResourceManager.Hybridkubernetes
{
    public partial class ConnectedClusterResource : IJsonModel<ConnectedClusterData>
    {
        ...
        BinaryData IPersistableModel<ConnectedClusterData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ConnectedClusterData>(Data, options, AzureResourceManagerHybridkubernetesContext.Default);

        ConnectedClusterData IPersistableModel<ConnectedClusterData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ConnectedClusterData>(data, options, AzureResourceManagerHybridkubernetesContext.Default);
