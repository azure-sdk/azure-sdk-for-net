...
namespace Azure.ResourceManager.Hybridkubernetes
{
    ...
    public partial class ConnectedClusterCollection : ArmCollection, IEnumerable<ConnectedClusterResource>, IAsyncEnumerable<ConnectedClusterResource>
    {
        ...
        private readonly ConnectedClustersRestOperations _connectedClusterRestClient;
        ...
        {
            _connectedClusterClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hybridkubernetes", ConnectedClusterResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ConnectedClusterResource.ResourceType, out string connectedClusterApiVersion);
            _connectedClusterRestClient = new ConnectedClustersRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, connectedClusterApiVersion);
#if DEBUG
        ...
        /// <description>ConnectedCluster_CreateOrReplace</description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<ConnectedClusterResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string clusterName, ConnectedClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _connectedClusterRestClient.CreateOrReplaceAsync(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data, cancellationToken).ConfigureAwait(false);
                var operation = new HybridkubernetesArmOperation<ConnectedClusterResource>(new ConnectedClusterOperationSource(Client), _connectedClusterClientDiagnostics, Pipeline, _connectedClusterRestClient.CreateCreateOrReplaceRequest(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<ConnectedClusterResource> CreateOrUpdate(WaitUntil waitUntil, string clusterName, ConnectedClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _connectedClusterRestClient.CreateOrReplace(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data, cancellationToken);
                var operation = new HybridkubernetesArmOperation<ConnectedClusterResource>(new ConnectedClusterOperationSource(Client), _connectedClusterClientDiagnostics, Pipeline, _connectedClusterRestClient.CreateCreateOrReplaceRequest(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
