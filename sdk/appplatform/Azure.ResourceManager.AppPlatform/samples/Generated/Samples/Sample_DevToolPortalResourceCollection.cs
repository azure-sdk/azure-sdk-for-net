...
{
    public partial class Sample_DevToolPortalResourceCollection
    {
        // DevToolPortals_List
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_DevToolPortalsList()
        {
            // Generated from example definition: specification/appplatform/resource-manager/Microsoft.AppPlatform/stable/2023-12-01/examples/DevToolPortals_List.json
            // this example is just showing the usage of "DevToolPortals_List" operation, for the dependent resources, they will have to be created separately.
            ...
            // get the collection of this DevToolPortalResource
            DevToolPortalResourceCollection collection = appPlatformService.GetDevToolPortalResources();

            // invoke the operation and iterate over the result
            await foreach (DevToolPortalResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DevToolPortalResourceData resourceData = item.Data;
        ...
        public async Task Get_DevToolPortalsGet()
        {
            ...
            DevToolPortalResource result = await collection.GetAsync(devToolPortalName);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_DevToolPortalsGet()
        {
            // Generated from example definition: specification/appplatform/resource-manager/Microsoft.AppPlatform/stable/2023-12-01/examples/DevToolPortals_Get.json
            // this example is just showing the usage of "DevToolPortals_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string devToolPortalName = "default";
            bool result = await collection.ExistsAsync(devToolPortalName);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_DevToolPortalsGet()
        {
            // Generated from example definition: specification/appplatform/resource-manager/Microsoft.AppPlatform/stable/2023-12-01/examples/DevToolPortals_Get.json
            // this example is just showing the usage of "DevToolPortals_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string devToolPortalName = "default";
            NullableResponse<DevToolPortalResource> response = await collection.GetIfExistsAsync(devToolPortalName);
            DevToolPortalResource result = response.HasValue ? response.Value : null;
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_DevToolPortalsCreateOrUpdate()
        {
...
"openid"
            ...
            ArmOperation<DevToolPortalResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, devToolPortalName, data);
