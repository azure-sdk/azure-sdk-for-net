...
{
    public partial class WarUploadedUserSourceInfo : IUtf8JsonSerializable
    {
        ...
        internal static WarUploadedUserSourceInfo DeserializeWarUploadedUserSourceInfo(JsonElement element)
        {
            ...
            return new WarUploadedUserSourceInfo(type, version.Value, relativePath.Value, runtimeVersion.Value, jvmOptions.Value, serverVersion.Value);
        }
    }
}
