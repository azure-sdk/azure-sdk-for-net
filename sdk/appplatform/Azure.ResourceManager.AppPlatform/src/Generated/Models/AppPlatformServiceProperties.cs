...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformServiceProperties
    {
        ...
        internal AppPlatformServiceProperties(AppPlatformServiceProvisioningState? provisioningState, AppPlatformServiceNetworkProfile networkProfile, ServiceVnetAddons vnetAddons, int? version, Guid? serviceId, string managedEnvironmentId, string infraResourceGroup, AppPlatformServicePowerState? powerState, bool? isZoneRedundant, string fqdn, MarketplaceResource marketplaceResource)
        {
