...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformServiceProperties
    {
        ...
        internal AppPlatformServiceProperties(AppPlatformServiceProvisioningState? provisioningState, AppPlatformServiceNetworkProfile networkProfile, ServiceVnetAddons vnetAddons, int? version, string serviceInstanceId, string managedEnvironmentId, string infraResourceGroup, AppPlatformServicePowerState? powerState, bool? isZoneRedundant, string fqdn, MarketplaceResource marketplaceResource)
        {
