...
namespace Azure.ResourceManager.AppPlatform.Models
{
    public partial class AppPlatformServiceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AppPlatformServiceProperties DeserializeAppPlatformServiceProperties(JsonElement element)
        {
            ...
            return new AppPlatformServiceProperties(Optional.ToNullable(provisioningState), networkProfile.Value, vnetAddons.Value, Optional.ToNullable(version), Optional.ToNullable(serviceId), managedEnvironmentId.Value, infraResourceGroup.Value, Optional.ToNullable(powerState), Optional.ToNullable(zoneRedundant), fqdn.Value, marketplaceResource.Value);
        }
    }
}
