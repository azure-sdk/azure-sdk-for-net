...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformDeploymentSettings
    {
        ...
        /// <param name="apms"> Collection of ApmReferences. </param>
        ...
        /// <param name="scale"> Scaling properties for the Azure Spring Apps App Instance. </param>
        /// <param name="containerProbeSettings"> Container liveness and readiness probe settings. </param>
        internal AppPlatformDeploymentSettings(AppPlatformDeploymentResourceRequirements resourceRequests, IDictionary<string, string> environmentVariables, IList<ApmReference> apms, IDictionary<string, BinaryData> addonConfigs, AppInstanceProbe livenessProbe, AppInstanceProbe readinessProbe, AppInstanceProbe startupProbe, int? terminationGracePeriodInSeconds, Scale scale, ContainerProbeSettings containerProbeSettings)
        {
