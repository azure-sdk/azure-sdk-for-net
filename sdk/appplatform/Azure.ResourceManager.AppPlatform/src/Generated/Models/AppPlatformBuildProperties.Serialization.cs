        ...
        internal static AppPlatformBuildProperties DeserializeAppPlatformBuildProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("triggeredBuildResult"u8))
                {
                    ...
                    triggeredBuildResult = TriggeredBuildResult.DeserializeTriggeredBuildResult(property.Value);
                    continue;
                }
            ...
            return new AppPlatformBuildProperties(relativePath.Value, builder.Value, agentPool.Value, Optional.ToNullable(provisioningState), Optional.ToDictionary(env), Optional.ToList(apms), Optional.ToList(certificates), triggeredBuildResult.Value, resourceRequests.Value);
        }
    }
}
