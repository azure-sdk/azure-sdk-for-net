...
namespace Azure.ResourceManager.AppPlatform.Models
{
    public partial class CustomizedAcceleratorProperties : IUtf8JsonSerializable
    {
        ...
        internal static CustomizedAcceleratorProperties DeserializeCustomizedAcceleratorProperties(JsonElement element)
        {
            ...
            return new CustomizedAcceleratorProperties(Optional.ToNullable(provisioningState), Optional.ToNullable(acceleratorType), displayName.Value, description.Value, iconUri.Value, Optional.ToList(acceleratorTags), Optional.ToList(imports), gitRepository);
        }
    }
}
