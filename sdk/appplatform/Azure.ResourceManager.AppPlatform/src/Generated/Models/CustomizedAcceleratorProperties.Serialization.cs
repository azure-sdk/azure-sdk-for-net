...
namespace Azure.ResourceManager.AppPlatform.Models
{
    public partial class CustomizedAcceleratorProperties : IUtf8JsonSerializable
    {
        ...
        internal static CustomizedAcceleratorProperties DeserializeCustomizedAcceleratorProperties(JsonElement element)
        {
            ...
            Optional<CustomizedAcceleratorType> type = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("type"u8))
                {
                    ...
                    type = new CustomizedAcceleratorType(property.Value.GetString());
                    continue;
                }
            ...
            return new CustomizedAcceleratorProperties(Optional.ToNullable(provisioningState), Optional.ToNullable(type), displayName.Value, description.Value, iconUri.Value, Optional.ToList(acceleratorTags), Optional.ToList(imports), gitRepository);
        }
    }
}
