...
{
    public partial class ContainerRegistryProperties : IUtf8JsonSerializable, IJsonModel<ContainerRegistryProperties>
    {
        ...
        internal static ContainerRegistryProperties DeserializeContainerRegistryProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerRegistryProperties(credentials, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
