...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public static partial class ArmAppPlatformModelFactory
    {
        ...
        public static AppPlatformServiceProperties AppPlatformServiceProperties(AppPlatformServiceProvisioningState? provisioningState = null, AppPlatformServiceNetworkProfile networkProfile = null, ServiceVnetAddons vnetAddons = null, int? version = null, string serviceInstanceId = null, string managedEnvironmentId = null, string infraResourceGroup = null, AppPlatformServicePowerState? powerState = null, bool? isZoneRedundant = null, string fqdn = null, MarketplaceResource marketplaceResource = null)
        {
            return new AppPlatformServiceProperties(provisioningState, networkProfile, vnetAddons, version, serviceInstanceId, managedEnvironmentId, infraResourceGroup, powerState, isZoneRedundant, fqdn, marketplaceResource);
        }
        ...
        public static DevToolPortalProperties DevToolPortalProperties(DevToolPortalProvisioningState? provisioningState = null, DevToolPortalResourceRequests resourceRequests = null, IEnumerable<DevToolPortalInstance> instances = null, bool? @public = null, Uri uri = null, DevToolPortalSsoProperties ssoProperties = null, DevToolPortalFeatureSettings features = null)
        {
            instances ??= new List<DevToolPortalInstance>();

            return new DevToolPortalProperties(provisioningState, resourceRequests, instances?.ToList(), @public, uri, ssoProperties, features);
        }
        ...
        public static CustomizedAcceleratorProperties CustomizedAcceleratorProperties(CustomizedAcceleratorProvisioningState? provisioningState = null, string displayName = null, string description = null, Uri iconUri = null, IEnumerable<string> acceleratorTags = null, AcceleratorGitRepository gitRepository = null)
        {
            acceleratorTags ??= new List<string>();

            return new CustomizedAcceleratorProperties(provisioningState, displayName, description, iconUri, acceleratorTags?.ToList(), gitRepository);
        }
