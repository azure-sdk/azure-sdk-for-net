...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformBuildServiceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AppPlatformBuildServiceResource>> UpdateAsync(WaitUntil waitUntil, AppPlatformBuildServiceData data, CancellationToken cancellationToken = default)
        {
            if (data == null)
            {
            ...
            using var scope = _appPlatformBuildServiceBuildServiceClientDiagnostics.CreateScope("AppPlatformBuildServiceResource.Update");
            scope.Start();
            try
            {
                var response = await _appPlatformBuildServiceBuildServiceRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<AppPlatformBuildServiceResource> Update(WaitUntil waitUntil, AppPlatformBuildServiceData data, CancellationToken cancellationToken = default)
        {
            if (data == null)
            {
                throw new ArgumentNullException(nameof(data));
            ...
            try
            {
                var response = _appPlatformBuildServiceBuildServiceRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new AppPlatformArmOperation<AppPlatformBuildServiceResource>(new AppPlatformBuildServiceOperationSource(Client), _appPlatformBuildServiceBuildServiceClientDiagnostics, Pipeline, _appPlatformBuildServiceBuildServiceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
