...
namespace Azure.ResourceManager.AppPlatform.Mocking
{
    ...
    public partial class MockableAppPlatformResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableAppPlatformResourceGroupResource"/> class for mocking. </summary>
        protected MockableAppPlatformResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAppPlatformResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAppPlatformResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            return await GetAppPlatformServices().GetAsync(serviceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetAppPlatformServices().Get(serviceName, cancellationToken);
        }
    }
}
