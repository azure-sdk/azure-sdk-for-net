...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    {
        /// <summary> Generate the resource identifier of a <see cref="AppPlatformGatewayCustomDomainResource"/> instance. </summary>
        ...
        internal AppPlatformGatewayCustomDomainResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _appPlatformGatewayCustomDomainGatewayCustomDomainsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppPlatform", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string appPlatformGatewayCustomDomainGatewayCustomDomainsApiVersion);
        ...
        public virtual AppPlatformGatewayCustomDomainData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<AppPlatformGatewayCustomDomainResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _appPlatformGatewayCustomDomainGatewayCustomDomainsClientDiagnostics.CreateScope("AppPlatformGatewayCustomDomainResource.Get");
            scope.Start();
            try
            {
                var response = await _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AppPlatformGatewayCustomDomainResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _appPlatformGatewayCustomDomainGatewayCustomDomainsClientDiagnostics.CreateScope("AppPlatformGatewayCustomDomainResource.Get");
            scope.Start();
            try
            {
                var response = _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AppPlatformGatewayCustomDomainResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>GatewayCustomDomains_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-12-01</description>
        ...
        {
            using var scope = _appPlatformGatewayCustomDomainGatewayCustomDomainsClientDiagnostics.CreateScope("AppPlatformGatewayCustomDomainResource.Delete");
            scope.Start();
            try
            {
                var response = await _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new AppPlatformArmOperation(_appPlatformGatewayCustomDomainGatewayCustomDomainsClientDiagnostics, Pipeline, _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new AppPlatformArmOperation(_appPlatformGatewayCustomDomainGatewayCustomDomainsClientDiagnostics, Pipeline, _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<AppPlatformGatewayCustomDomainResource>> UpdateAsync(WaitUntil waitUntil, AppPlatformGatewayCustomDomainData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<AppPlatformGatewayCustomDomainResource> Update(WaitUntil waitUntil, AppPlatformGatewayCustomDomainData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new AppPlatformArmOperation<AppPlatformGatewayCustomDomainResource>(new AppPlatformGatewayCustomDomainOperationSource(Client), _appPlatformGatewayCustomDomainGatewayCustomDomainsClientDiagnostics, Pipeline, _appPlatformGatewayCustomDomainGatewayCustomDomainsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
