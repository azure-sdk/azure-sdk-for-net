...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformBuildResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>BuildService_DeleteBuild</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-12-01</description>
        ...
        {
            using var scope = _appPlatformBuildBuildServiceClientDiagnostics.CreateScope("AppPlatformBuildResource.Delete");
            scope.Start();
            try
            {
                var response = await _appPlatformBuildBuildServiceRestClient.DeleteBuildAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new AppPlatformArmOperation(_appPlatformBuildBuildServiceClientDiagnostics, Pipeline, _appPlatformBuildBuildServiceRestClient.CreateDeleteBuildRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appPlatformBuildBuildServiceRestClient.DeleteBuild(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new AppPlatformArmOperation(_appPlatformBuildBuildServiceClientDiagnostics, Pipeline, _appPlatformBuildBuildServiceRestClient.CreateDeleteBuildRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
