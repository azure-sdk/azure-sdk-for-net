...
namespace Azure.ResourceManager.Confluent
{
    ...
    public partial class TopicRecordCollection : ArmCollection, IEnumerable<TopicRecordResource>, IAsyncEnumerable<TopicRecordResource>
    {
        ...
        {
            _topicRecordTopicsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Confluent", TopicRecordResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(TopicRecordResource.ResourceType, out string topicRecordTopicsApiVersion);
        ...
        public virtual async Task<ArmOperation<TopicRecordResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string topicName, TopicRecordData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _topicRecordTopicsClientDiagnostics.CreateScope("TopicRecordCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _topicRecordTopicsRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, data, cancellationToken).ConfigureAwait(false);
                var uri = _topicRecordTopicsRestClient.CreateCreateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, data);
        ...
        public virtual ArmOperation<TopicRecordResource> CreateOrUpdate(WaitUntil waitUntil, string topicName, TopicRecordData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _topicRecordTopicsRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, data, cancellationToken);
                var uri = _topicRecordTopicsRestClient.CreateCreateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new ConfluentArmOperation<TopicRecordResource>(Response.FromValue(new TopicRecordResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<TopicRecordResource>> GetAsync(string topicName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _topicRecordTopicsClientDiagnostics.CreateScope("TopicRecordCollection.Get");
            scope.Start();
            try
            {
                var response = await _topicRecordTopicsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<TopicRecordResource> Get(string topicName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _topicRecordTopicsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new TopicRecordResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Topics_List</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-07-01</description>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _topicRecordTopicsRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, pageSizeHint, pageToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _topicRecordTopicsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, pageSizeHint, pageToken);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new TopicRecordResource(Client, TopicRecordData.DeserializeTopicRecordData(e)), _topicRecordTopicsClientDiagnostics, Pipeline, "TopicRecordCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<TopicRecordResource> GetAll(int? pageSize = null, string pageToken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _topicRecordTopicsRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, pageSizeHint, pageToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _topicRecordTopicsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, pageSizeHint, pageToken);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new TopicRecordResource(Client, TopicRecordData.DeserializeTopicRecordData(e)), _topicRecordTopicsClientDiagnostics, Pipeline, "TopicRecordCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string topicName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _topicRecordTopicsClientDiagnostics.CreateScope("TopicRecordCollection.Exists");
            scope.Start();
            try
            {
                var response = await _topicRecordTopicsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string topicName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _topicRecordTopicsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<TopicRecordResource>> GetIfExistsAsync(string topicName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _topicRecordTopicsClientDiagnostics.CreateScope("TopicRecordCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _topicRecordTopicsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, topicName, cancellationToken: cancellationToken).ConfigureAwait(false);
