...
namespace Azure.ResourceManager.Confluent
{
    ...
    /// </summary>
    public partial class SCClusterRecordData
    {
        /// <summary>
        ...
        internal SCClusterRecordData(string kind, string id, string resourceType, string name, SCMetadataEntity metadata, SCClusterSpecEntity spec, ClusterStatusEntity status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Id = id;
