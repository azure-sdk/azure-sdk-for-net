        ...
        internal static APIKeySpecEntity DeserializeAPIKeySpecEntity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("resource"u8))
                {
                    ...
                    resource = APIKeyResourceEntity.DeserializeAPIKeyResourceEntity(property.Value);
                    continue;
                }
                if (property.NameEquals("owner"u8))
                {
                    ...
                    owner = APIKeyOwnerEntity.DeserializeAPIKeyOwnerEntity(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new APIKeySpecEntity(description.Value, name.Value, secret.Value, resource.Value, owner.Value, serializedAdditionalRawData);
        }
