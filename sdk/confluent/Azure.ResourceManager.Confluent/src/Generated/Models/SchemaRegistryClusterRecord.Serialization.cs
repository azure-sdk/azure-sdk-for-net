...
namespace Azure.ResourceManager.Confluent.Models
{
    public partial class SchemaRegistryClusterRecord : IUtf8JsonSerializable, IJsonModel<SchemaRegistryClusterRecord>
    {
        ...
        internal static SchemaRegistryClusterRecord DeserializeSchemaRegistryClusterRecord(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<SchemaRegistryClusterSpecEntity> spec = default;
            Optional<SchemaRegistryClusterStatusEntity> status = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("metadata"u8))
                        {
                            ...
                            metadata = SCMetadataEntity.DeserializeSCMetadataEntity(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("spec"u8))
                        {
                            ...
                            spec = SchemaRegistryClusterSpecEntity.DeserializeSchemaRegistryClusterSpecEntity(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("status"u8))
                        {
                            ...
                            status = SchemaRegistryClusterStatusEntity.DeserializeSchemaRegistryClusterStatusEntity(property0.Value);
                            continue;
                        }
                    }
                    continue;
