        ...
        internal static SchemaRegistryClusterSpecEntity DeserializeSchemaRegistryClusterSpecEntity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("region"u8))
                {
                    ...
                    region = SchemaRegistryClusterEnvironmentRegionEntity.DeserializeSchemaRegistryClusterEnvironmentRegionEntity(property.Value);
                    continue;
                }
                if (property.NameEquals("environment"u8))
                {
                    ...
                    environment = SchemaRegistryClusterEnvironmentRegionEntity.DeserializeSchemaRegistryClusterEnvironmentRegionEntity(property.Value);
                    continue;
                }
