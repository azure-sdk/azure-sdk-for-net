...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    {
        internal static ClusterByokEntity DeserializeClusterByokEntity(JsonElement element)
        {
            ...
            return new ClusterByokEntity(id.Value, related.Value, resourceName.Value);
        }
    }
}
