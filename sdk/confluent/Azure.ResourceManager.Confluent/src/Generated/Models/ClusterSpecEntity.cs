...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class ClusterSpecEntity
    {
        ...
        internal ClusterSpecEntity(string displayName, string availability, string cloud, string zone, string region, string kafkaBootstrapEndpoint, string httpEndpoint, string apiEndpoint, ClusterConfigEntity config, ClusterEnvironmentEntity environment, ClusterNetworkEntity network, ClusterByokEntity byok)
        {
