        ...
        internal static SCClusterSpecEntity DeserializeSCClusterSpecEntity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("environment"u8))
                {
                    ...
                    environment = SCClusterNetworkEnvironmentEntity.DeserializeSCClusterNetworkEnvironmentEntity(property.Value);
                    continue;
                }
                if (property.NameEquals("network"u8))
                {
                    ...
                    network = SCClusterNetworkEnvironmentEntity.DeserializeSCClusterNetworkEnvironmentEntity(property.Value);
                    continue;
                }
                if (property.NameEquals("byok"u8))
                {
                    ...
                    byok = SCClusterByokEntity.DeserializeSCClusterByokEntity(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
