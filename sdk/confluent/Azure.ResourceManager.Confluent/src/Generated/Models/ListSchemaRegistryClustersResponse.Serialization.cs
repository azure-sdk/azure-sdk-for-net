...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListSchemaRegistryClustersResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ListSchemaRegistryClustersResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListSchemaRegistryClustersResponse)} does not support '{format}' format.");
            }
        ...
        internal static ListSchemaRegistryClustersResponse DeserializeListSchemaRegistryClustersResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IReadOnlyList<SchemaRegistryClusterRecord>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(SchemaRegistryClusterRecord.DeserializeSchemaRegistryClusterRecord(item));
                    }
                    value = array;
                    continue;
                }
            ...
            return new ListSchemaRegistryClustersResponse(Optional.ToList(value), nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ListSchemaRegistryClustersResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListSchemaRegistryClustersResponse)} does not support '{options.Format}' format.");
            }
        }
