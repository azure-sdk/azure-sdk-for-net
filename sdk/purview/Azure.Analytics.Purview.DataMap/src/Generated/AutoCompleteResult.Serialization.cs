...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AutoCompleteResult : IUtf8JsonSerializable, IJsonModel<AutoCompleteResult>
    {
        ...
        void IJsonModel<AutoCompleteResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutoCompleteResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<AutoCompleteResultValue> collection && collection.IsUndefined))
            {
