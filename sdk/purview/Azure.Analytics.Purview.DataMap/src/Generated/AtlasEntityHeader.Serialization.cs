...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasEntityHeader : IUtf8JsonSerializable, IJsonModel<AtlasEntityHeader>
    {
        ...
        void IJsonModel<AtlasEntityHeader>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AtlasEntityHeader)} does not support '{format}' format.");
            }
            ...
            if (!(ClassificationNames is ChangeTrackingList<string> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(Labels is ChangeTrackingList<string> collection2 && collection2.IsUndefined))
            {
            ...
            if (!(MeaningNames is ChangeTrackingList<string> collection3 && collection3.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<AtlasEntityHeader>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AtlasEntityHeader)} does not support '{options.Format}' format.");
            }
        }
