...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasAttributeDef : IUtf8JsonSerializable, IJsonModel<AtlasAttributeDef>
    {
        ...
        void IJsonModel<AtlasAttributeDef>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AtlasAttributeDef)} does not support '{format}' format.");
            }
            ...
            if (!(Constraints is ChangeTrackingList<AtlasConstraintDef> collection && collection.IsUndefined))
            {
            ...
            if (!(Options is ChangeTrackingDictionary<string, string> collection0 && collection0.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<AtlasAttributeDef>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AtlasAttributeDef)} does not support '{options.Format}' format.");
            }
        }
