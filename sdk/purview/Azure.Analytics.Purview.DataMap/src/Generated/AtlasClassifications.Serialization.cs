...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasClassifications : IUtf8JsonSerializable, IJsonModel<AtlasClassifications>
    {
        ...
        void IJsonModel<AtlasClassifications>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AtlasClassifications)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(List is ChangeTrackingList<BinaryData> collection && collection.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<AtlasClassifications>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AtlasClassifications)} does not support '{options.Format}' format.");
            }
        }
