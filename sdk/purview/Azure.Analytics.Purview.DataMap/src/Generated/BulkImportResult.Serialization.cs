...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class BulkImportResult : IUtf8JsonSerializable, IJsonModel<BulkImportResult>
    {
        ...
        void IJsonModel<BulkImportResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(FailedImportInfoList is ChangeTrackingList<ImportInfo> collection && collection.IsUndefined))
            {
            ...
            if (!(SuccessImportInfoList is ChangeTrackingList<ImportInfo> collection0 && collection0.IsUndefined))
            {
