...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class AtlasEntityDef
    {
        ...
        internal AtlasEntityDef(TypeCategory? category, long? createTime, string createdBy, DateFormat dateFormatter, string description, string guid, string name, IDictionary<string, string> options, string serviceType, string typeVersion, long? updateTime, string updatedBy, long? version, string lastModifiedTS, IList<AtlasAttributeDef> attributeDefs, IList<string> subTypes, IList<string> superTypes, IList<AtlasRelationshipAttributeDef> relationshipAttributeDefs, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
