...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoveEntitiesOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MoveEntitiesOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MoveEntitiesOptions)} does not support '{format}' format.");
            }
        ...
        internal static MoveEntitiesOptions DeserializeMoveEntitiesOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MoveEntitiesOptions(Optional.ToList(entityGuids), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MoveEntitiesOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MoveEntitiesOptions)} does not support '{options.Format}' format.");
            }
        }
