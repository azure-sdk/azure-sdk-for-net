...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasTypeDef : IUtf8JsonSerializable, IJsonModel<AtlasTypeDef>
    {
        ...
        void IJsonModel<AtlasTypeDef>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AtlasTypeDef)} does not support '{format}' format.");
            }
            ...
            if (!(EntityTypes is ChangeTrackingList<string> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(SubTypes is ChangeTrackingList<string> collection1 && collection1.IsUndefined))
            {
            ...
            if (!(SuperTypes is ChangeTrackingList<string> collection2 && collection2.IsUndefined))
            {
            ...
            if (!(RelationshipAttributeDefs is ChangeTrackingList<AtlasRelationshipAttributeDef> collection3 && collection3.IsUndefined))
            {
            ...
            if (!(ElementDefs is ChangeTrackingList<AtlasEnumElementDef> collection4 && collection4.IsUndefined))
            {
            ...
            if (RelationshipCategory.HasValue)
            {
            ...
            if (!(AttributeDefs is ChangeTrackingList<AtlasAttributeDef> collection5 && collection5.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<AtlasTypeDef>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AtlasTypeDef)} does not support '{options.Format}' format.");
            }
        }
