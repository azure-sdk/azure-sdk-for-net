...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasLineageInfo : IUtf8JsonSerializable, IJsonModel<AtlasLineageInfo>
    {
        ...
        void IJsonModel<AtlasLineageInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (BaseEntityGuid != null)
            {
                writer.WritePropertyName("baseEntityGuid"u8);
                writer.WriteStringValue(BaseEntityGuid);
            }
            if (!(GuidEntityMap is ChangeTrackingDictionary<string, AtlasEntityHeader> collection && collection.IsUndefined))
            {
            ...
            if (!(WidthCounts is ChangeTrackingDictionary<string, IDictionary<string, BinaryData>> collection0 && collection0.IsUndefined))
            {
            ...
            if (LineageDirection.HasValue)
            {
                writer.WritePropertyName("lineageDirection"u8);
                writer.WriteStringValue(LineageDirection.Value.ToString());
            }
            if (!(ParentRelations is ChangeTrackingList<ParentRelation> collection1 && collection1.IsUndefined))
            {
            ...
            if (!(Relations is ChangeTrackingList<LineageRelation> collection2 && collection2.IsUndefined))
            {
