...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NumberFormat>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NumberFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NumberFormat)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NumberFormat>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NumberFormat)} does not support '{options.Format}' format.");
            }
        }
