...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<QueryOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(QueryOptions)} does not support '{format}' format.");
            }
        ...
        internal static QueryOptions DeserializeQueryOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new QueryOptions(keywords.Value, Optional.ToNullable(limit), continuationToken.Value, Optional.ToList(orderby), filter.Value, Optional.ToList(facets), taxonomySetting.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<QueryOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(QueryOptions)} does not support '{options.Format}' format.");
            }
        }
