...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchFacetSort>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SearchFacetSort>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SearchFacetSort)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SearchFacetSort>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SearchFacetSort)} does not support '{options.Format}' format.");
            }
        }
