...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class AtlasClassifications
    {
        ...
        internal AtlasClassifications(IReadOnlyList<BinaryData> list, int? pageSize, string sortBy, SortType? sortType, int? startIndex, int? totalCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            List = list;
            PageSize = pageSize;
            SortBy = sortBy;
