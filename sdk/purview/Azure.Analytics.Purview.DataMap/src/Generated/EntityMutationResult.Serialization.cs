...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class EntityMutationResult : IUtf8JsonSerializable, IJsonModel<EntityMutationResult>
    {
        ...
        void IJsonModel<EntityMutationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(GuidAssignments is ChangeTrackingDictionary<string, string> collection && collection.IsUndefined))
            {
            ...
            if (!(MutatedEntities is ChangeTrackingDictionary<string, IList<AtlasEntityHeader>> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(PartialUpdatedEntities is ChangeTrackingList<AtlasEntityHeader> collection1 && collection1.IsUndefined))
            {
