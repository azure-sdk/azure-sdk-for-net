...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasEntity : IUtf8JsonSerializable, IJsonModel<AtlasEntity>
    {
        ...
        void IJsonModel<AtlasEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(BusinessAttributes is ChangeTrackingDictionary<string, BinaryData> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(Classifications is ChangeTrackingList<AtlasClassification> collection1 && collection1.IsUndefined))
            {
            ...
            if (!(CustomAttributes is ChangeTrackingDictionary<string, string> collection2 && collection2.IsUndefined))
            {
            ...
            if (!(Labels is ChangeTrackingList<string> collection3 && collection3.IsUndefined))
            {
            ...
            if (!(Meanings is ChangeTrackingList<AtlasTermAssignmentHeader> collection4 && collection4.IsUndefined))
            {
            ...
            if (!(RelationshipAttributes is ChangeTrackingDictionary<string, BinaryData> collection5 && collection5.IsUndefined))
            {
            ...
            if (!(Contacts is ChangeTrackingDictionary<string, IList<ContactInfo>> collection6 && collection6.IsUndefined))
            {
