...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasGlossaryTerm : IUtf8JsonSerializable, IJsonModel<AtlasGlossaryTerm>
    {
        ...
        void IJsonModel<AtlasGlossaryTerm>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(TemplateName is ChangeTrackingList<BinaryData> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(Antonyms is ChangeTrackingList<AtlasRelatedTermHeader> collection1 && collection1.IsUndefined))
            {
            ...
            if (!(HierarchyInfo is ChangeTrackingList<PurviewObjectId> collection2 && collection2.IsUndefined))
            {
            ...
            if (!(Resources is ChangeTrackingList<ResourceLink> collection3 && collection3.IsUndefined))
            {
            ...
            if (!(Contacts is ChangeTrackingDictionary<string, IList<ContactInfo>> collection4 && collection4.IsUndefined))
            {
            ...
            if (!(Attributes is ChangeTrackingDictionary<string, IDictionary<string, BinaryData>> collection5 && collection5.IsUndefined))
            {
            ...
            if (!(AssignedEntities is ChangeTrackingList<AtlasRelatedObjectId> collection6 && collection6.IsUndefined))
            {
            ...
            if (!(Categories is ChangeTrackingList<AtlasTermCategorizationHeader> collection7 && collection7.IsUndefined))
            {
            ...
            if (!(Classifies is ChangeTrackingList<AtlasRelatedTermHeader> collection8 && collection8.IsUndefined))
            {
            ...
            if (!(Examples is ChangeTrackingList<string> collection9 && collection9.IsUndefined))
            {
            ...
            if (!(IsA is ChangeTrackingList<AtlasRelatedTermHeader> collection10 && collection10.IsUndefined))
            {
            ...
            if (!(PreferredTerms is ChangeTrackingList<AtlasRelatedTermHeader> collection11 && collection11.IsUndefined))
            {
            ...
            if (!(PreferredToTerms is ChangeTrackingList<AtlasRelatedTermHeader> collection12 && collection12.IsUndefined))
            {
            ...
            if (!(ReplacedBy is ChangeTrackingList<AtlasRelatedTermHeader> collection13 && collection13.IsUndefined))
            {
            ...
            if (!(ReplacementTerms is ChangeTrackingList<AtlasRelatedTermHeader> collection14 && collection14.IsUndefined))
            {
            ...
            if (!(SeeAlso is ChangeTrackingList<AtlasRelatedTermHeader> collection15 && collection15.IsUndefined))
            {
            ...
            if (!(Synonyms is ChangeTrackingList<AtlasRelatedTermHeader> collection16 && collection16.IsUndefined))
            {
            ...
            if (!(TranslatedTerms is ChangeTrackingList<AtlasRelatedTermHeader> collection17 && collection17.IsUndefined))
            {
            ...
            if (!(TranslationTerms is ChangeTrackingList<AtlasRelatedTermHeader> collection18 && collection18.IsUndefined))
            {
            ...
            if (!(ValidValues is ChangeTrackingList<AtlasRelatedTermHeader> collection19 && collection19.IsUndefined))
            {
            ...
            if (!(ValidValuesFor is ChangeTrackingList<AtlasRelatedTermHeader> collection20 && collection20.IsUndefined))
            {
