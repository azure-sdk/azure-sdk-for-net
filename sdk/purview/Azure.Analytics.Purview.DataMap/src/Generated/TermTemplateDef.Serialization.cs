...
{
    public partial class TermTemplateDef : IUtf8JsonSerializable, IJsonModel<TermTemplateDef>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TermTemplateDef>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TermTemplateDef>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(Options is ChangeTrackingDictionary<string, string> collection && collection.IsUndefined))
            {
            ...
            if (!(AttributeDefs is ChangeTrackingList<AtlasAttributeDef> collection0 && collection0.IsUndefined))
            {
        ...
        TermTemplateDef IJsonModel<TermTemplateDef>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TermTemplateDef>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static TermTemplateDef DeserializeTermTemplateDef(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<TermTemplateDef>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TermTemplateDef>)this).GetFormatFromOptions(options) : options.Format;
        ...
        TermTemplateDef IPersistableModel<TermTemplateDef>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TermTemplateDef>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static TermTemplateDef FromResponse(Response response)
        {
