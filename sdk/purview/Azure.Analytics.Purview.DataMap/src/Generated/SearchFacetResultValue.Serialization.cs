...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class SearchFacetResultValue : IUtf8JsonSerializable, IJsonModel<SearchFacetResultValue>
    {
        ...
        void IJsonModel<SearchFacetResultValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(EntityType is ChangeTrackingList<SearchFacetItemValue> collection && collection.IsUndefined))
            {
            ...
            if (!(AssetType is ChangeTrackingList<SearchFacetItemValue> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(Classification is ChangeTrackingList<SearchFacetItemValue> collection1 && collection1.IsUndefined))
            {
            ...
            if (!(Term is ChangeTrackingList<SearchFacetItemValue> collection2 && collection2.IsUndefined))
            {
            ...
            if (!(ContactId is ChangeTrackingList<SearchFacetItemValue> collection3 && collection3.IsUndefined))
            {
            ...
            if (!(ContactType is ChangeTrackingList<SearchFacetItemValue> collection4 && collection4.IsUndefined))
            {
            ...
            if (!(Label is ChangeTrackingList<SearchFacetItemValue> collection5 && collection5.IsUndefined))
            {
            ...
            if (!(GlossaryType is ChangeTrackingList<SearchFacetItemValue> collection6 && collection6.IsUndefined))
            {
            ...
            if (!(TermStatus is ChangeTrackingList<SearchFacetItemValue> collection7 && collection7.IsUndefined))
            {
            ...
            if (!(TermTemplate is ChangeTrackingList<SearchFacetItemValue> collection8 && collection8.IsUndefined))
            {
