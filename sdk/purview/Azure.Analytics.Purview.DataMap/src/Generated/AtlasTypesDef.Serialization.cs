...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasTypesDef : IUtf8JsonSerializable, IJsonModel<AtlasTypesDef>
    {
        ...
        void IJsonModel<AtlasTypesDef>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(BusinessMetadataDefs is ChangeTrackingList<AtlasBusinessMetadataDef> collection && collection.IsUndefined))
            {
            ...
            if (!(ClassificationDefs is ChangeTrackingList<AtlasClassificationDef> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(EntityDefs is ChangeTrackingList<AtlasEntityDef> collection1 && collection1.IsUndefined))
            {
            ...
            if (!(EnumDefs is ChangeTrackingList<AtlasEnumDef> collection2 && collection2.IsUndefined))
            {
            ...
            if (!(RelationshipDefs is ChangeTrackingList<AtlasRelationshipDef> collection3 && collection3.IsUndefined))
            {
            ...
            if (!(StructDefs is ChangeTrackingList<AtlasStructDef> collection4 && collection4.IsUndefined))
            {
            ...
            if (!(TermTemplateDefs is ChangeTrackingList<TermTemplateDef> collection5 && collection5.IsUndefined))
            {
