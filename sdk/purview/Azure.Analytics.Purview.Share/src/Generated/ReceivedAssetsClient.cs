...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class ReceivedAssetsClient
    {
        ...
        public ReceivedAssetsClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewShareClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ReceivedAssetsClient(Uri endpoint, TokenCredential credential, PurviewShareClientOptions options)
        {
