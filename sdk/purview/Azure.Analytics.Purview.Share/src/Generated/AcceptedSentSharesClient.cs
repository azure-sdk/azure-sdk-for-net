...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class AcceptedSentSharesClient
    {
        ...
        public AcceptedSentSharesClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AcceptedSentSharesClient(Uri endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
