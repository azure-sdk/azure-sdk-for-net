...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class ScanResultClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetScanHistoriesAsync(string dataSourceName, string scanName, RequestContext context = null)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetScanHistoriesRequest(dataSourceName, scanName, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetScanHistoriesNextPageRequest(nextLink, dataSourceName, scanName, context);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ScanResultClient.GetScanHistories", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetScanHistories(string dataSourceName, string scanName, RequestContext context = null)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetScanHistoriesRequest(dataSourceName, scanName, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetScanHistoriesNextPageRequest(nextLink, dataSourceName, scanName, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ScanResultClient.GetScanHistories", "value", "nextLink", context);
        }
