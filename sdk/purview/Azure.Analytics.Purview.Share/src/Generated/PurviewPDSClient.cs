...
namespace Azure.Analytics.Purview.Share
{
    ...
    /// <summary> The PurviewPDS service client. </summary>
    public partial class PurviewPDSClient
    {
        ...
        /// <summary> Initializes a new instance of PurviewPDSClient for mocking. </summary>
        protected PurviewPDSClient()
        {
        }

        /// <summary> Initializes a new instance of PurviewPDSClient. </summary>
        ...
        public PurviewPDSClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewPDSClient(Uri endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
        ...
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowAsync(Guid,RequestContext)']/*" />
        public virtual async Task<Response> GetWorkflowAsync(Guid workflowId, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.GetWorkflow");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflow(Guid,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='CreateOrReplaceWorkflowAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateOrReplaceWorkflowAsync(Guid workflowId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.CreateOrReplaceWorkflow");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='CreateOrReplaceWorkflow(Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='DeleteWorkflowAsync(Guid,RequestContext)']/*" />
        public virtual async Task<Response> DeleteWorkflowAsync(Guid workflowId, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.DeleteWorkflow");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='DeleteWorkflow(Guid,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='SubmitUserRequestsAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> SubmitUserRequestsAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.SubmitUserRequests");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='SubmitUserRequests(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowRunAsync(Guid,RequestContext)']/*" />
        public virtual async Task<Response> GetWorkflowRunAsync(Guid workflowRunId, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.GetWorkflowRun");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowRun(Guid,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='CancelWorkflowRunAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CancelWorkflowRunAsync(Guid workflowRunId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.CancelWorkflowRun");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='CancelWorkflowRun(Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowTaskAsync(Guid,RequestContext)']/*" />
        public virtual async Task<Response> GetWorkflowTaskAsync(Guid taskId, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.GetWorkflowTask");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowTask(Guid,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='ApproveApprovalTaskAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ApproveApprovalTaskAsync(Guid taskId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.ApproveApprovalTask");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='ApproveApprovalTask(Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='RejectApprovalTaskAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> RejectApprovalTaskAsync(Guid taskId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.RejectApprovalTask");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='RejectApprovalTask(Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='ReassignWorkflowTaskAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ReassignWorkflowTaskAsync(Guid taskId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.ReassignWorkflowTask");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='ReassignWorkflowTask(Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='UpdateTaskRequestAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateTaskRequestAsync(Guid taskId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.UpdateTaskRequest");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='UpdateTaskRequest(Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='ClaimDsarTaskRequestAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ClaimDsarTaskRequestAsync(Guid taskId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.ClaimDsarTaskRequest");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='ClaimDsarTaskRequest(Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='ReleaseDsarTaskRequestAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ReleaseDsarTaskRequestAsync(Guid taskId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewPDSClient.ReleaseDsarTaskRequest");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='ReleaseDsarTaskRequest(Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowsAsync(RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetWorkflowsAsync(RequestContext context = null)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewPDSClient.GetWorkflows", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflows(RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetWorkflows(RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWorkflowsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWorkflowsNextPageRequest(nextLink, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewPDSClient.GetWorkflows", "value", "nextLink", context);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="AsyncPageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowRunsAsync(String,String,IEnumerable,IEnumerable,IEnumerable,Int32,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetWorkflowRunsAsync(string timeWindow = null, string orderby = null, IEnumerable<string> runStatuses = null, IEnumerable<string> userRequestIds = null, IEnumerable<string> workflowIds = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewPDSClient.GetWorkflowRuns", "value", "nextLink", context);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Pageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowRuns(String,String,IEnumerable,IEnumerable,IEnumerable,Int32,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetWorkflowRuns(string timeWindow = null, string orderby = null, IEnumerable<string> runStatuses = null, IEnumerable<string> userRequestIds = null, IEnumerable<string> workflowIds = null, int? maxpagesize = null, RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWorkflowRunsRequest(timeWindow, orderby, runStatuses, userRequestIds, workflowIds, maxpagesize, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWorkflowRunsNextPageRequest(nextLink, timeWindow, orderby, runStatuses, userRequestIds, workflowIds, maxpagesize, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewPDSClient.GetWorkflowRuns", "value", "nextLink", context);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="AsyncPageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowTasksAsync(String,IEnumerable,String,Int32,String,IEnumerable,IEnumerable,String,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetWorkflowTasksAsync(string viewMode = null, IEnumerable<string> workflowIds = null, string timeWindow = null, int? maxpagesize = null, string orderby = null, IEnumerable<string> taskTypes = null, IEnumerable<string> taskStatuses = null, string workflowNameKeyword = null, RequestContext context = null)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewPDSClient.GetWorkflowTasks", "value", "nextLink", context);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Pageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <include file="Docs/PurviewPDSClient.xml" path="doc/members/member[@name='GetWorkflowTasks(String,IEnumerable,String,Int32,String,IEnumerable,IEnumerable,String,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetWorkflowTasks(string viewMode = null, IEnumerable<string> workflowIds = null, string timeWindow = null, int? maxpagesize = null, string orderby = null, IEnumerable<string> taskTypes = null, IEnumerable<string> taskStatuses = null, string workflowNameKeyword = null, RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWorkflowTasksRequest(viewMode, workflowIds, timeWindow, maxpagesize, orderby, taskTypes, taskStatuses, workflowNameKeyword, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWorkflowTasksNextPageRequest(nextLink, viewMode, workflowIds, timeWindow, maxpagesize, orderby, taskTypes, taskStatuses, workflowNameKeyword, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewPDSClient.GetWorkflowTasks", "value", "nextLink", context);
        }
