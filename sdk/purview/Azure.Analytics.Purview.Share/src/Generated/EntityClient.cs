...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class EntityClient
    {
        ...
        public EntityClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EntityClient(string endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
        ...
        /// <param name="minExtInfo"> Whether to return minimal information for referred entities. </param>
        /// <param name="ignoreRelationships"> Whether to ignore relationship attributes. </param>
        /// <param name="attrNQualifiedName"> Qualified name of an entity. E.g. to find 2 entities you can set attrs_1:qualifiedName=db1@cl1&amp;attrs_2:qualifiedName=db2@cl1. (This is only an example. qualifiedName can be changed to other unique attributes). </param>
        /// <param name="context"> The request context, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="typeName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="typeName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/EntityClient.xml" path="doc/members/member[@name='GetImportCsvOperationStatusAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetImportCsvOperationStatusAsync(string operationGuid, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EntityClient.GetImportCsvOperationStatus");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/EntityClient.xml" path="doc/members/member[@name='GetImportCsvOperationStatus(String,RequestContext)']/*" />
        ...
        /// <summary> Import Entity from local csv file. </summary>
        ...
        /// <include file="Docs/EntityClient.xml" path="doc/members/member[@name='ImportEntityViaCsvAsync(WaitUntil,RequestContent,RequestContext)']/*" />
        public virtual async Task<Operation> ImportEntityViaCsvAsync(WaitUntil waitUntil, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("EntityClient.ImportEntityViaCsv");
            scope.Start();
            try
            {
                using HttpMessage message = CreateImportEntityViaCsvRequest(content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "EntityClient.ImportEntityViaCsv", OperationFinalStateVia.AzureAsyncOperation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/EntityClient.xml" path="doc/members/member[@name='ImportEntityViaCsv(WaitUntil,RequestContent,RequestContext)']/*" />
        public virtual Operation ImportEntityViaCsv(WaitUntil waitUntil, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            {
                using HttpMessage message = CreateImportEntityViaCsvRequest(content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "EntityClient.ImportEntityViaCsv", OperationFinalStateVia.AzureAsyncOperation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        internal HttpMessage CreateImportEntityViaCsvRequest(RequestContent content, RequestContext context)
        {
            ...
            uri.AppendRaw(_endpoint, false);
            uri.AppendRaw("/catalog/api", false);
            uri.AppendPath("/entity/import", false);
        ...
        internal HttpMessage CreateGetImportCsvOperationStatusRequest(string operationGuid, RequestContext context)
        {
            ...
            uri.AppendRaw(_endpoint, false);
            uri.AppendRaw("/catalog/api", false);
            uri.AppendPath("/entity/operation/", false);
