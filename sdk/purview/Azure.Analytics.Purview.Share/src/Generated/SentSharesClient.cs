...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class SentSharesClient
    {
        ...
        public SentSharesClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public SentSharesClient(Uri endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
