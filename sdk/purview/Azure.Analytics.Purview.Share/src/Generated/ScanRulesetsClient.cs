...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class ScanRulesetsClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetScanRulesetsAsync(RequestContext context = null)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ScanRulesetsClient.GetScanRulesets", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetScanRulesets(RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetScanRulesetsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetScanRulesetsNextPageRequest(nextLink, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ScanRulesetsClient.GetScanRulesets", "value", "nextLink", context);
        }
