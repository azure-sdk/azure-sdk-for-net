...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class EmailRegistrationClient
    {
        ...
        public EmailRegistrationClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EmailRegistrationClient(Uri endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
