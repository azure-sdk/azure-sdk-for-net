...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class MetadataRolesClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetMetadataRolesAsync(RequestContext context = null)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "MetadataRolesClient.GetMetadataRoles", "values", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetMetadataRoles(RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetMetadataRolesRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetMetadataRolesNextPageRequest(nextLink, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "MetadataRolesClient.GetMetadataRoles", "values", "nextLink", context);
        }
