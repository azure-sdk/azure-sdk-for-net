...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class ClassificationRulesClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetClassificationRulesAsync(RequestContext context = null)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ClassificationRulesClient.GetClassificationRules", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetClassificationRules(RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetClassificationRulesRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetClassificationRulesNextPageRequest(nextLink, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ClassificationRulesClient.GetClassificationRules", "value", "nextLink", context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetVersionsByClassificationRuleNameAsync(string classificationRuleName, RequestContext context = null)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetVersionsByClassificationRuleNameRequest(classificationRuleName, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetVersionsByClassificationRuleNameNextPageRequest(nextLink, classificationRuleName, context);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ClassificationRulesClient.GetVersionsByClassificationRuleName", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetVersionsByClassificationRuleName(string classificationRuleName, RequestContext context = null)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetVersionsByClassificationRuleNameRequest(classificationRuleName, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetVersionsByClassificationRuleNameNextPageRequest(nextLink, classificationRuleName, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ClassificationRulesClient.GetVersionsByClassificationRuleName", "value", "nextLink", context);
        }
