...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class DataSourcesClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetDataSourcesAsync(RequestContext context = null)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "DataSourcesClient.GetDataSources", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetDataSources(RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetDataSourcesRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetDataSourcesNextPageRequest(nextLink, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "DataSourcesClient.GetDataSources", "value", "nextLink", context);
        }
