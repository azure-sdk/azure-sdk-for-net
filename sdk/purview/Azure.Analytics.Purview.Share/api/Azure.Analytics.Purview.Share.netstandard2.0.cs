namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class PurviewPDSClient
    {
        ...
        public virtual Azure.Response UpdateSimpleTask(System.Guid taskId, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> UpdateSimpleTaskAsync(System.Guid taskId, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
    }
