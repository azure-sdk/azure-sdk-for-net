...
namespace Azure.Analytics.Purview.Administration
{
    ...
    public partial class PurviewAdministrationClient
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewAdministrationClient.xml" path="doc/members/member[@name='UpdateSimpleTaskAsync(Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateSimpleTaskAsync(Guid taskId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("PurviewAdministrationClient.UpdateSimpleTask");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PurviewAdministrationClient.xml" path="doc/members/member[@name='UpdateSimpleTask(Guid,RequestContent,RequestContext)']/*" />
