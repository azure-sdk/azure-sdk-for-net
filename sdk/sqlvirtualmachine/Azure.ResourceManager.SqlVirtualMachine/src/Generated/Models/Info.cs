...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class Info
    {
        ...
        internal Info(string name, OperationDisplay display, OperationOrigin? origin, IReadOnlyDictionary<string, OperationProperty> properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Display = display;
            Origin = origin;
