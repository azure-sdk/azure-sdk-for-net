...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class SQLTempDbSettings
    {
        ...
        internal SQLTempDbSettings(int? dataFileSize, int? dataGrowth, int? logFileSize, int? logGrowth, int? dataFileCount, bool? persistFolder, string persistFolderPath, IList<int> luns, string defaultFilePath, bool? useStoragePool, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
