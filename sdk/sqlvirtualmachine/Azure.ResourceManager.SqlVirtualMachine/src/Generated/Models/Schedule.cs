...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class Schedule
    {
        ...
        internal Schedule(bool? enable, int? weeklyInterval, int? monthlyOccurrence, AssessmentDayOfWeek? dayOfWeek, string startTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enable = enable;
