...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class SQLInstanceSettings
    {
        ...
        internal SQLInstanceSettings(string collation, int? maxDop, bool? isOptimizeForAdHocWorkloadsEnabled, int? minServerMemoryMB, int? maxServerMemoryMB, bool? isLpimEnabled, bool? isIfiEnabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Collation = collation;
            MaxDop = maxDop;
