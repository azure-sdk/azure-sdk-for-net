...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of MeterDetailsV2. </summary>
        internal MeterDetailsV2()
        {
        }
        ...
        internal MeterDetailsV2(string meterName, string meterCategory, string meterSubCategory, string unit, string meterLocation, float? totalIncludedQuantity, float? pretaxStandardRate, string serviceName, string serviceTier)
        {
            MeterName = meterName;
        ...
        public float? TotalIncludedQuantity { get; }
        /// <summary> The pretax listing price. </summary>
        public float? PretaxStandardRate { get; }
