...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of PriceSheetPropertiesV2. </summary>
        internal PriceSheetPropertiesV2()
        {
        }
        ...
        internal PriceSheetPropertiesV2(string billingPeriodId, Guid? meterId, MeterDetailsV2 meterDetails, string unitOfMeasure, float? includedQuantity, string partNumber, float? unitPrice, string currencyCode, string offerId)
        {
        ...
        public MeterDetailsV2 MeterDetails { get; }
