...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetAllCollectionResult : Pageable<BinaryData>
    {
        ...
        public IngestionClientGetAllCollectionResult(IngestionClient client, string collectionId, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
