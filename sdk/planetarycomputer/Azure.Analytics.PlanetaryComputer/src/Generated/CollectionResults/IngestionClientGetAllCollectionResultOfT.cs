...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetAllCollectionResultOfT : Pageable<IngestionInformation>
    {
        ...
        public IngestionClientGetAllCollectionResultOfT(IngestionClient client, string collectionId, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
