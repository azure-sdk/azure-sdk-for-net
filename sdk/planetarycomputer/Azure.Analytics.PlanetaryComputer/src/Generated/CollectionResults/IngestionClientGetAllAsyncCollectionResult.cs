...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetAllAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public IngestionClientGetAllAsyncCollectionResult(IngestionClient client, string collectionId, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
