...
{
    internal partial class IngestionClientGetOperationsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of IngestionClientGetOperationsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public IngestionClientGetOperationsCollectionResult(IngestionClient client, int? maxCount, int? skip, string collectionId, string status, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of IngestionClientGetOperationsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of IngestionClientGetOperationsCollectionResult as an enumerable collection. </returns>
