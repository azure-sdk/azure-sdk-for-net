...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetOperationsAsyncCollectionResultOfT : AsyncPageable<LongRunningOperation>
    {
        ...
        /// <summary> Initializes a new instance of IngestionClientGetOperationsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public IngestionClientGetOperationsAsyncCollectionResultOfT(IngestionClient client, int? maxCount, int? skip, string collectionId, string status, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of IngestionClientGetOperationsAsyncCollectionResultOfT as an enumerable collection. </summary>
