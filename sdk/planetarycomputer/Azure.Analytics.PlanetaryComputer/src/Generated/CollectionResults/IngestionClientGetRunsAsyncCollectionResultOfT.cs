...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetRunsAsyncCollectionResultOfT : AsyncPageable<IngestionRun>
    {
        ...
        public IngestionClientGetRunsAsyncCollectionResultOfT(IngestionClient client, string collectionId, Guid ingestionId, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
