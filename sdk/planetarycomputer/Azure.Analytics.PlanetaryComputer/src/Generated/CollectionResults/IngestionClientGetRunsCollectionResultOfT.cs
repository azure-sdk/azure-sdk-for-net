...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetRunsCollectionResultOfT : Pageable<IngestionRun>
    {
        ...
        public IngestionClientGetRunsCollectionResultOfT(IngestionClient client, string collectionId, Guid ingestionId, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
