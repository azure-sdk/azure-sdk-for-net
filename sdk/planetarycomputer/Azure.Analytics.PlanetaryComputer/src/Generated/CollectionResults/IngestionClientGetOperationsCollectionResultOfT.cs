...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetOperationsCollectionResultOfT : Pageable<LongRunningOperation>
    {
        ...
        public IngestionClientGetOperationsCollectionResultOfT(IngestionClient client, int? maxCount, int? skip, string collectionId, string status, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
