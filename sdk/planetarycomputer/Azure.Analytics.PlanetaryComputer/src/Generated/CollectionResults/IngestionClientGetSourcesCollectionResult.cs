...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetSourcesCollectionResult : Pageable<BinaryData>
    {
        ...
        public IngestionClientGetSourcesCollectionResult(IngestionClient client, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
