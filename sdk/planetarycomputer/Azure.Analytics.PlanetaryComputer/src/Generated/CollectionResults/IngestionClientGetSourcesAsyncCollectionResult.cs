...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetSourcesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public IngestionClientGetSourcesAsyncCollectionResult(IngestionClient client, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
