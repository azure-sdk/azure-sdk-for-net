...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetAllAsyncCollectionResultOfT : AsyncPageable<IngestionInformation>
    {
        ...
        public IngestionClientGetAllAsyncCollectionResultOfT(IngestionClient client, string collectionId, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
