...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetRunsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public IngestionClientGetRunsAsyncCollectionResult(IngestionClient client, string collectionId, Guid ingestionId, int? maxCount, int? skip, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
