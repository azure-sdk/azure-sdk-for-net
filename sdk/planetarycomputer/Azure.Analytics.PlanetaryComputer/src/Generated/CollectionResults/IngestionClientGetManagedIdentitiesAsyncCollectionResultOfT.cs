...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetManagedIdentitiesAsyncCollectionResultOfT : AsyncPageable<ManagedIdentityMetadata>
    {
        ...
        public IngestionClientGetManagedIdentitiesAsyncCollectionResultOfT(IngestionClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
