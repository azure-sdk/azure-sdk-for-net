...
{
    /// <summary> Extension methods to add <see cref="ContentSafetyClient"/>, <see cref="BlocklistClient"/>, <see cref="RaiPolicyClient"/> to client builder. </summary>
    public static partial class ContentSafetyClientBuilderExtensions
    {
        ...
        /// <summary> Registers a <see cref="RaiPolicyClient"/> instance. </summary>
        /// <param name="builder"> The builder to register with. </param>
        /// <param name="endpoint">
        /// Supported Cognitive Services endpoints (protocol and hostname, for example:
        /// https://&lt;resource-name&gt;.cognitiveservices.azure.com).
        /// </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        public static IAzureClientBuilder<RaiPolicyClient, ContentSafetyClientOptions> AddRaiPolicyClient<TBuilder>(this TBuilder builder, Uri endpoint, AzureKeyCredential credential)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<RaiPolicyClient, ContentSafetyClientOptions>((options) => new RaiPolicyClient(endpoint, credential, options));
        }
        ...
        /// https://&lt;resource-name&gt;.cognitiveservices.azure.com).
        /// </param>
        public static IAzureClientBuilder<RaiPolicyClient, ContentSafetyClientOptions> AddRaiPolicyClient<TBuilder>(this TBuilder builder, Uri endpoint)
        where TBuilder : IAzureClientFactoryBuilderWithCredential
        {
            return builder.RegisterClientFactory<RaiPolicyClient, ContentSafetyClientOptions>((options, cred) => new RaiPolicyClient(endpoint, cred, options));
        }
        ...
        /// <param name="builder"> The builder to register with. </param>
        /// <param name="configuration"> The configuration values. </param>
        public static IAzureClientBuilder<RaiPolicyClient, ContentSafetyClientOptions> AddRaiPolicyClient<TBuilder, TConfiguration>(this TBuilder builder, TConfiguration configuration)
        where TBuilder : IAzureClientFactoryBuilderWithConfiguration<TConfiguration>
        {
            return builder.RegisterClientFactory<RaiPolicyClient, ContentSafetyClientOptions>(configuration);
        }
    }
}
