...
namespace Azure.AI.ContentSafety
{
    internal partial class BlocklistClientGetTextBlocklistItemsCollectionResult : Pageable<BinaryData>
    {
        ...
        public BlocklistClientGetTextBlocklistItemsCollectionResult(BlocklistClient client, string name, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _name = name;
            _maxCount = maxCount;
