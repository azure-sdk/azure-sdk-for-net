...
namespace Azure.AI.ContentSafety
{
    internal partial class BlocklistClientGetTextBlocklistsAsyncCollectionResultOfT : AsyncPageable<TextBlocklist>
    {
        ...
        public BlocklistClientGetTextBlocklistsAsyncCollectionResultOfT(BlocklistClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
