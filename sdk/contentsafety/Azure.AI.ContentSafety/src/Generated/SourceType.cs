...
namespace Azure.AI.ContentSafety
{
    ...
    public readonly partial struct SourceType : IEquatable<SourceType>
    {
        ...
        private const string MessageToAIValue = "messageToAI";
        private const string MessageFromAIValue = "messageFromAI";

        /// <summary> The source type for message - message to AI. </summary>
        public static SourceType MessageToAI { get; } = new SourceType(MessageToAIValue);
        /// <summary> The source type for message - message from AI. </summary>
        public static SourceType MessageFromAI { get; } = new SourceType(MessageFromAIValue);
