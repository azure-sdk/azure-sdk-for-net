...
namespace Azure.AI.ContentSafety
{
    ...
    public static partial class ContentSafetyModelFactory
    {
        ...
        public static AnalyzeTextResult AnalyzeTextResult(IEnumerable<TextBlocklistMatch> blocklistsMatch = null)
        {
            blocklistsMatch ??= new List<TextBlocklistMatch>();

            return new AnalyzeTextResult(blocklistsMatch?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        public static TextBlocklistMatch TextBlocklistMatch(string blocklistName = null, string blocklistItemId = null)
        {
            return new TextBlocklistMatch(blocklistName, blocklistItemId, serializedAdditionalRawData: null);
        }
