...
namespace Azure.AI.ContentSafety
{
    ...
    public partial class ContentSafetyClient
    {
        ...
        /// <summary> Rai Policy Analysis. </summary>
        /// <param name="options"> The rai policy analyze request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="options"/> is null. </exception>
        /// <remarks> A synchronous API for the rai policy analysis of input content. </remarks>
        /// <include file="Docs/ContentSafetyClient.xml" path="doc/members/member[@name='AnalyzeWithRaiPolicyAsync(RaiPolicyAnalyzeOption,CancellationToken)']/*" />
        public virtual async Task<Response<RaiPolicyAnalyzeResponse>> AnalyzeWithRaiPolicyAsync(RaiPolicyAnalyzeOption options, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(options, nameof(options));

            using RequestContent content = options.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await AnalyzeWithRaiPolicyAsync(content, context).ConfigureAwait(false);
            return Response.FromValue(RaiPolicyAnalyzeResponse.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="options"/> is null. </exception>
        /// <remarks> A synchronous API for the rai policy analysis of input content. </remarks>
        /// <include file="Docs/ContentSafetyClient.xml" path="doc/members/member[@name='AnalyzeWithRaiPolicy(RaiPolicyAnalyzeOption,CancellationToken)']/*" />
        public virtual Response<RaiPolicyAnalyzeResponse> AnalyzeWithRaiPolicy(RaiPolicyAnalyzeOption options, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(options, nameof(options));

            using RequestContent content = options.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = AnalyzeWithRaiPolicy(content, context);
            return Response.FromValue(RaiPolicyAnalyzeResponse.FromResponse(response), response);
        }

        /// <summary>
        /// [Protocol Method] Rai Policy Analysis
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AnalyzeWithRaiPolicyAsync(RaiPolicyAnalyzeOption,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ContentSafetyClient.xml" path="doc/members/member[@name='AnalyzeWithRaiPolicyAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> AnalyzeWithRaiPolicyAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("ContentSafetyClient.AnalyzeWithRaiPolicy");
            scope.Start();
            try
            {
                using HttpMessage message = CreateAnalyzeWithRaiPolicyRequest(content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AnalyzeWithRaiPolicy(RaiPolicyAnalyzeOption,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ContentSafetyClient.xml" path="doc/members/member[@name='AnalyzeWithRaiPolicy(RequestContent,RequestContext)']/*" />
        public virtual Response AnalyzeWithRaiPolicy(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateAnalyzeWithRaiPolicyRequest(RequestContent content, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Post;
            ...
            uri.Reset(_endpoint);
            uri.AppendRaw("/contentsafety", false);
            uri.AppendPath("/analyzeWithRaiPolicy", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            request.Headers.Add("Content-Type", "application/json");
