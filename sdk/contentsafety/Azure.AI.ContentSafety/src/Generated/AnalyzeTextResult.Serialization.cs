...
namespace Azure.AI.ContentSafety
{
    public partial class AnalyzeTextResult
    {
        internal static AnalyzeTextResult DeserializeAnalyzeTextResult(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<string>> reason = default;
            ...
            return new AnalyzeTextResult(Optional.ToList(blocklistsMatch), categoriesAnalysis, Optional.ToList(incidentMatches), Optional.ToList(reason));
        }
