namespace Azure.AI.ContentSafety
{
    ...
    {
        public ContentSafetyClientOptions(Azure.AI.ContentSafety.ContentSafetyClientOptions.ServiceVersion version = Azure.AI.ContentSafety.ContentSafetyClientOptions.ServiceVersion.V2023_10_30_Preview) { }
    ...
    public static partial class ContentSafetyModelFactory
    {
        ...
        public static Azure.AI.ContentSafety.AnalyzeImageOptions AnalyzeImageOptions(Azure.AI.ContentSafety.ContentSafetyImageData image = null, System.Collections.Generic.IEnumerable<Azure.AI.ContentSafety.ImageCategory> categories = null, Azure.AI.ContentSafety.AnalyzeImageOutputType? outputType = default(Azure.AI.ContentSafety.AnalyzeImageOutputType?), Azure.AI.ContentSafety.IncidentOptions incidents = null) { throw null; }
        ...
        public static Azure.AI.ContentSafety.AnalyzeTextOptions AnalyzeTextOptions(string text = null, System.Collections.Generic.IEnumerable<Azure.AI.ContentSafety.TextCategory> categories = null, System.Collections.Generic.IEnumerable<string> blocklistNames = null, bool? haltOnBlocklistHit = default(bool?), Azure.AI.ContentSafety.AnalyzeTextOutputType? outputType = default(Azure.AI.ContentSafety.AnalyzeTextOutputType?), Azure.AI.ContentSafety.IncidentOptions incidents = null) { throw null; }
    ...
    public partial class IncidentMatch : System.ClientModel.Primitives.IJsonModel<Azure.AI.ContentSafety.IncidentMatch>, System.ClientModel.Primitives.IPersistableModel<Azure.AI.ContentSafety.IncidentMatch>
    {
        internal IncidentMatch() { }
        public string IncidentName { get { throw null; } }
        Azure.AI.ContentSafety.IncidentMatch System.ClientModel.Primitives.IJsonModel<Azure.AI.ContentSafety.IncidentMatch>.Create(ref System.Text.Json.Utf8JsonReader reader, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        void System.ClientModel.Primitives.IJsonModel<Azure.AI.ContentSafety.IncidentMatch>.Write(System.Text.Json.Utf8JsonWriter writer, System.ClientModel.Primitives.ModelReaderWriterOptions options) { }
        Azure.AI.ContentSafety.IncidentMatch System.ClientModel.Primitives.IPersistableModel<Azure.AI.ContentSafety.IncidentMatch>.Create(System.BinaryData data, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        string System.ClientModel.Primitives.IPersistableModel<Azure.AI.ContentSafety.IncidentMatch>.GetFormatFromOptions(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        System.BinaryData System.ClientModel.Primitives.IPersistableModel<Azure.AI.ContentSafety.IncidentMatch>.Write(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
    }
    public partial class IncidentOptions : System.ClientModel.Primitives.IJsonModel<Azure.AI.ContentSafety.IncidentOptions>, System.ClientModel.Primitives.IPersistableModel<Azure.AI.ContentSafety.IncidentOptions>
    {
        ...
        Azure.AI.ContentSafety.IncidentOptions System.ClientModel.Primitives.IJsonModel<Azure.AI.ContentSafety.IncidentOptions>.Create(ref System.Text.Json.Utf8JsonReader reader, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        void System.ClientModel.Primitives.IJsonModel<Azure.AI.ContentSafety.IncidentOptions>.Write(System.Text.Json.Utf8JsonWriter writer, System.ClientModel.Primitives.ModelReaderWriterOptions options) { }
        Azure.AI.ContentSafety.IncidentOptions System.ClientModel.Primitives.IPersistableModel<Azure.AI.ContentSafety.IncidentOptions>.Create(System.BinaryData data, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        string System.ClientModel.Primitives.IPersistableModel<Azure.AI.ContentSafety.IncidentOptions>.GetFormatFromOptions(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        System.BinaryData System.ClientModel.Primitives.IPersistableModel<Azure.AI.ContentSafety.IncidentOptions>.Write(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
    }
