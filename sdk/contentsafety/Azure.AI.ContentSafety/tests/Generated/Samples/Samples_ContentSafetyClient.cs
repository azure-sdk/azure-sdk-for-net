...
"<blocklistNames>"
            ...
            Console.WriteLine(result.GetProperty("categoriesAnalysis")[0].GetProperty("accepted").ToString());
            Console.WriteLine(result.GetProperty("accepted").ToString());
        }
...
"<blocklistNames>"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_DetectTextJailbreak_ShortVersion()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_DetectTextJailbreak_ShortVersion_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_DetectTextJailbreak_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);

            AnalyzeTextJailbreakOptions body = new AnalyzeTextJailbreakOptions("<text>");
            Response<AnalyzeTextJailbreakResult> response = client.DetectTextJailbreak(body);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_DetectTextJailbreak_ShortVersion_Convenience_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
            ...
            AnalyzeTextJailbreakOptions body = new AnalyzeTextJailbreakOptions("<text>");
            Response<AnalyzeTextJailbreakResult> response = await client.DetectTextJailbreakAsync(body);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_DetectTextJailbreak_AllParameters()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_DetectTextJailbreak_AllParameters_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_DetectTextJailbreak_AllParameters_Convenience()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_DetectTextJailbreak_AllParameters_Convenience_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_DetectTextProtectedMaterial_ShortVersion()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_DetectTextProtectedMaterial_ShortVersion_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_DetectTextProtectedMaterial_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);

            AnalyzeTextProtectedMaterialOptions body = new AnalyzeTextProtectedMaterialOptions("<text>");
            Response<AnalyzeTextProtectedMaterialResult> response = client.DetectTextProtectedMaterial(body);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_DetectTextProtectedMaterial_ShortVersion_Convenience_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
            ...
            AnalyzeTextProtectedMaterialOptions body = new AnalyzeTextProtectedMaterialOptions("<text>");
            Response<AnalyzeTextProtectedMaterialResult> response = await client.DetectTextProtectedMaterialAsync(body);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_DetectTextProtectedMaterial_AllParameters()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_DetectTextProtectedMaterial_AllParameters_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_DetectTextProtectedMaterial_AllParameters_Convenience()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_DetectTextProtectedMaterial_AllParameters_Convenience_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ContentSafetyClient client = new ContentSafetyClient(endpoint, credential);
