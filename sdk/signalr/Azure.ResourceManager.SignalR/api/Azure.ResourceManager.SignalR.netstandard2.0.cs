namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class ReplicaData : Azure.ResourceManager.Models.TrackedResourceData
    {
        public ReplicaData(Azure.Core.AzureLocation location) : base (default(Azure.Core.AzureLocation)) { }
