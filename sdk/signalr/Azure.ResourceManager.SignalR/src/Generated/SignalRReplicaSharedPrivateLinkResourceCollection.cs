...
namespace Azure.ResourceManager.SignalR
{
    ...
    {
        private readonly ClientDiagnostics _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics;
        private readonly SignalRReplicaRestOperations _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient;
        ...
        {
            _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SignalR", SignalRReplicaSharedPrivateLinkResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(SignalRReplicaSharedPrivateLinkResource.ResourceType, out string signalRReplicaSharedPrivateLinkResourceSignalRReplicaApiVersion);
            _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient = new SignalRReplicaRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, signalRReplicaSharedPrivateLinkResourceSignalRReplicaApiVersion);
#if DEBUG
        ...
        /// <description>SignalRReplica_SharedPrivateLinkResources_CreateOrUpdate</description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<SignalRReplicaSharedPrivateLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sharedPrivateLinkResourceName, SignalRSharedPrivateLinkResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics.CreateScope("SignalRReplicaSharedPrivateLinkResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.SharedPrivateLinkResourcesCreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new SignalRArmOperation<SignalRReplicaSharedPrivateLinkResource>(new SignalRReplicaSharedPrivateLinkResourceOperationSource(Client), _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics, Pipeline, _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.CreateSharedPrivateLinkResourcesCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<SignalRReplicaSharedPrivateLinkResource> CreateOrUpdate(WaitUntil waitUntil, string sharedPrivateLinkResourceName, SignalRSharedPrivateLinkResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.SharedPrivateLinkResourcesCreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, data, cancellationToken);
                var operation = new SignalRArmOperation<SignalRReplicaSharedPrivateLinkResource>(new SignalRReplicaSharedPrivateLinkResourceOperationSource(Client), _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics, Pipeline, _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.CreateSharedPrivateLinkResourcesCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SignalRReplica_SharedPrivateLinkResources_Get</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-01-01-preview</description>
        ...
        public virtual async Task<Response<SignalRReplicaSharedPrivateLinkResource>> GetAsync(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics.CreateScope("SignalRReplicaSharedPrivateLinkResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.SharedPrivateLinkResourcesGetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SignalRReplicaSharedPrivateLinkResource> Get(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.SharedPrivateLinkResourcesGet(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SignalRReplicaSharedPrivateLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SignalRReplica_SharedPrivateLinkResources_List</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-01-01-preview</description>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.CreateSharedPrivateLinkResourcesListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.CreateSharedPrivateLinkResourcesListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new SignalRReplicaSharedPrivateLinkResource(Client, SignalRSharedPrivateLinkResourceData.DeserializeSignalRSharedPrivateLinkResourceData(e)), _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics, Pipeline, "SignalRReplicaSharedPrivateLinkResourceCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics.CreateScope("SignalRReplicaSharedPrivateLinkResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.SharedPrivateLinkResourcesGetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.SharedPrivateLinkResourcesGet(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<SignalRReplicaSharedPrivateLinkResource>> GetIfExistsAsync(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _signalRReplicaSharedPrivateLinkResourceSignalRReplicaClientDiagnostics.CreateScope("SignalRReplicaSharedPrivateLinkResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _signalRReplicaSharedPrivateLinkResourceSignalRReplicaRestClient.SharedPrivateLinkResourcesGetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
