...
namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class ReplicaCollection : ArmCollection, IEnumerable<ReplicaResource>, IAsyncEnumerable<ReplicaResource>
    {
        ...
        public virtual async Task<ArmOperation<ReplicaResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string replicaName, ReplicaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _replicaSignalRReplicasRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, replicaName, data, cancellationToken).ConfigureAwait(false);
                var operation = new SignalRArmOperation<ReplicaResource>(new ReplicaOperationSource(Client), _replicaSignalRReplicasClientDiagnostics, Pipeline, _replicaSignalRReplicasRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, replicaName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<ReplicaResource> CreateOrUpdate(WaitUntil waitUntil, string replicaName, ReplicaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _replicaSignalRReplicasRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, replicaName, data, cancellationToken);
                var operation = new SignalRArmOperation<ReplicaResource>(new ReplicaOperationSource(Client), _replicaSignalRReplicasClientDiagnostics, Pipeline, _replicaSignalRReplicasRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, replicaName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ReplicaResource>> GetAsync(string replicaName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _replicaSignalRReplicasRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, replicaName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ReplicaResource> Get(string replicaName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _replicaSignalRReplicasRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, replicaName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ReplicaResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _replicaSignalRReplicasRestClient.CreateListRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _replicaSignalRReplicasRestClient.CreateListNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ReplicaResource(Client, ReplicaData.DeserializeReplicaData(e)), _replicaSignalRReplicasClientDiagnostics, Pipeline, "ReplicaCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ReplicaResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _replicaSignalRReplicasRestClient.CreateListRequest(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _replicaSignalRReplicasRestClient.CreateListNextPageRequest(nextLink, Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ReplicaResource(Client, ReplicaData.DeserializeReplicaData(e)), _replicaSignalRReplicasClientDiagnostics, Pipeline, "ReplicaCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string replicaName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _replicaSignalRReplicasRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, replicaName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string replicaName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _replicaSignalRReplicasRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, replicaName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
