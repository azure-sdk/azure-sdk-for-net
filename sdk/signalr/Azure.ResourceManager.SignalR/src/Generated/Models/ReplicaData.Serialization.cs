...
namespace Azure.ResourceManager.SignalR
{
    public partial class ReplicaData : IUtf8JsonSerializable
    {
        ...
        internal static ReplicaData DeserializeReplicaData(JsonElement element)
        {
            ...
            Optional<string> regionEndpointEnabled = default;
            Optional<string> resourceStopped = default;
            ...
            return new ReplicaData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, sku.Value, Optional.ToNullable(provisioningState), regionEndpointEnabled.Value, resourceStopped.Value);
        }
    }
}
