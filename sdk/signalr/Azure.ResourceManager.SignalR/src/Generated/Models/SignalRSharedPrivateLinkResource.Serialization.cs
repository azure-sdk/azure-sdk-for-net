...
{
    public partial class SignalRSharedPrivateLinkResource : IUtf8JsonSerializable
    {
        ...
        internal static SignalRSharedPrivateLinkResource DeserializeSignalRSharedPrivateLinkResource(JsonElement element)
        {
            ...
            return new SignalRSharedPrivateLinkResource(id, name, type, systemData.Value, groupId.Value, privateLinkResourceId.Value, Optional.ToNullable(provisioningState), requestMessage.Value, Optional.ToNullable(status));
        }
    }
}
