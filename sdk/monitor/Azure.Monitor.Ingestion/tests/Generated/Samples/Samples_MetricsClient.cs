...
namespace Azure.Monitor.Ingestion.Samples
{
    public partial class Samples_MetricsClient
    {
        ...
        public void Example_Batch_ShortVersion()
        {
            ...
            MetricsClient client = new MetricsClient("<SubscriptionId>", credential);

            RequestContent content = RequestContent.Create(new object());
            Response response = client.Batch("<baseUrl>", new string[] { "<metricnames>" }, content);
        ...
        public async Task Example_Batch_ShortVersion_Async()
        {
            ...
            RequestContent content = RequestContent.Create(new object());
            Response response = await client.BatchAsync("<baseUrl>", new string[] { "<metricnames>" }, content);
...
new object()
            ...
            Response response = client.Batch("<baseUrl>", new string[] { "<metricnames>" }, content, starttime: "<starttime>", endtime: "<endtime>", interval: XmlConvert.ToTimeSpan("PT1H23M45S"), metricnamespace: "<metricnamespace>", aggregation: "<aggregation>", top: 1234, orderby: "<orderby>", filter: "<filter>");
...
new object()
            ...
            Response response = await client.BatchAsync("<baseUrl>", new string[] { "<metricnames>" }, content, starttime: "<starttime>", endtime: "<endtime>", interval: XmlConvert.ToTimeSpan("PT1H23M45S"), metricnamespace: "<metricnamespace>", aggregation: "<aggregation>", top: 1234, orderby: "<orderby>", filter: "<filter>");
