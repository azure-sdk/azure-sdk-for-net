...
namespace Azure.Monitor.Ingestion
{
    ...
    public partial class MetricsClient
    {
        ...
        public MetricsClient(TokenCredential credential) : this(credential, new MetricsClientOptions())
        {
        }
        ...
        /// <include file="Docs/MetricsClient.xml" path="doc/members/member[@name='BatchAsync(string,string,string,IEnumerable{string},RequestContent,string,string,TimeSpan?,string,int?,string,string,RequestContext)']/*" />
        public virtual async Task<Response> BatchAsync(string baseUrl, string subscriptionId, string metricnamespace, IEnumerable<string> metricnames, RequestContent content, string starttime = null, string endtime = null, TimeSpan? interval = null, string aggregation = null, int? top = null, string orderby = null, string filter = null, RequestContext context = null)
        {
            ...
            try
            {
                using HttpMessage message = CreateBatchRequest(baseUrl, subscriptionId, metricnamespace, metricnames, content, starttime, endtime, interval, aggregation, top, orderby, filter, context);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/MetricsClient.xml" path="doc/members/member[@name='Batch(string,string,string,IEnumerable{string},RequestContent,string,string,TimeSpan?,string,int?,string,string,RequestContext)']/*" />
        public virtual Response Batch(string baseUrl, string subscriptionId, string metricnamespace, IEnumerable<string> metricnames, RequestContent content, string starttime = null, string endtime = null, TimeSpan? interval = null, string aggregation = null, int? top = null, string orderby = null, string filter = null, RequestContext context = null)
        {
            Argument.AssertNotNull(baseUrl, nameof(baseUrl));
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(metricnamespace, nameof(metricnamespace));
        ...
        internal HttpMessage CreateBatchRequest(string baseUrl, string subscriptionId, string metricnamespace, IEnumerable<string> metricnames, RequestContent content, string starttime, string endtime, TimeSpan? interval, string aggregation, int? top, string orderby, string filter, RequestContext context)
        {
