...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public static partial class ArmDataBoxModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.DataBoxSku"/>. </summary>
        ...
        public static DataBoxSku DataBoxSku(DataBoxSkuName name = default, string displayName = null, string family = null, ModelName? model = null)
        {
            return new DataBoxSku(name, displayName, family, model, serializedAdditionalRawData: null);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Models.TransportAvailabilityRequest"/>. </summary>
        /// <param name="skuName"> Type of the device. </param>
        /// <param name="model"> The model name. </param>
        /// <returns> A new <see cref="Models.TransportAvailabilityRequest"/> instance for mocking. </returns>
        public static TransportAvailabilityRequest TransportAvailabilityRequest(DataBoxSkuName? skuName = null, ModelName? model = null)
        {
            return new TransportAvailabilityRequest(skuName, model, serializedAdditionalRawData: null);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Models.DeviceCapabilityRequest"/>. </summary>
        /// <param name="skuName"> Type of the device. </param>
        /// <param name="model"> The model name. </param>
        /// <returns> A new <see cref="Models.DeviceCapabilityRequest"/> instance for mocking. </returns>
        public static DeviceCapabilityRequest DeviceCapabilityRequest(DataBoxSkuName? skuName = null, ModelName? model = null)
        {
            return new DeviceCapabilityRequest(skuName, model, serializedAdditionalRawData: null);
        }
