...
namespace Azure.ResourceManager.Maps.Models
{
    public partial class MapsAccountProperties : IUtf8JsonSerializable, IJsonModel<MapsAccountProperties>
    {
        ...
        void IJsonModel<MapsAccountProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && !(PrivateEndpointConnections is ChangeTrackingList<MapsPrivateEndpointConnectionData> collection0 && collection0.IsUndefined))
            {
            ...
            if (!(Locations is ChangeTrackingList<LocationsItem> collection1 && collection1.IsUndefined))
            {
