...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsCreatorProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MapsCreatorProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MapsCreatorProperties)} does not support '{format}' format.");
            }
        ...
        internal static MapsCreatorProperties DeserializeMapsCreatorProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MapsCreatorProperties(provisioningState, storageUnits, totalStorageUnitSizeInBytes, consumedStorageUnitSizeInBytes, serializedAdditionalRawData);
        }
