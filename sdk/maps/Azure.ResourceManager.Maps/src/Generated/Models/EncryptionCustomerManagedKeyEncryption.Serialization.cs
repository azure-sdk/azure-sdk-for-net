...
{
    public partial class EncryptionCustomerManagedKeyEncryption : IUtf8JsonSerializable, IJsonModel<EncryptionCustomerManagedKeyEncryption>
    {
        ...
        internal static EncryptionCustomerManagedKeyEncryption DeserializeEncryptionCustomerManagedKeyEncryption(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<EncryptionCustomerManagedKeyEncryptionKeyIdentity> keyEncryptionKeyIdentity = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("keyEncryptionKeyIdentity"u8))
                {
                    ...
                    keyEncryptionKeyIdentity = EncryptionCustomerManagedKeyEncryptionKeyIdentity.DeserializeEncryptionCustomerManagedKeyEncryptionKeyIdentity(property.Value);
                    continue;
                }
            ...
            return new EncryptionCustomerManagedKeyEncryption(keyEncryptionKeyIdentity.Value, keyEncryptionKeyUrl.Value, serializedAdditionalRawData);
        }
