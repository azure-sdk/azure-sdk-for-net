...
namespace Azure.ResourceManager.Maps.Models
{
    public partial class EncryptionCustomerManagedKeyEncryption : IUtf8JsonSerializable, IJsonModel<EncryptionCustomerManagedKeyEncryption>
    {
        ...
        internal static EncryptionCustomerManagedKeyEncryption DeserializeEncryptionCustomerManagedKeyEncryption(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            EncryptionCustomerManagedKeyEncryptionKeyIdentity keyEncryptionKeyIdentity = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("keyEncryptionKeyIdentity"u8))
                {
                    ...
                    keyEncryptionKeyIdentity = EncryptionCustomerManagedKeyEncryptionKeyIdentity.DeserializeEncryptionCustomerManagedKeyEncryptionKeyIdentity(property.Value, options);
                    continue;
                }
            ...
            return new EncryptionCustomerManagedKeyEncryption(keyEncryptionKeyIdentity, keyEncryptionKeyUrl, serializedAdditionalRawData);
        }
