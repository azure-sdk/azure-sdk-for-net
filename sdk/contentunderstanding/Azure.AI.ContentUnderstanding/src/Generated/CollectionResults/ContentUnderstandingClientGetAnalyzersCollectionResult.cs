...
namespace Azure.AI.ContentUnderstanding
{
    internal partial class ContentUnderstandingClientGetAnalyzersCollectionResult : Pageable<BinaryData>
    {
        ...
        public ContentUnderstandingClientGetAnalyzersCollectionResult(ContentUnderstandingClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
