...
{
    internal partial class ContentUnderstandingClientGetAnalyzersAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        private readonly ContentUnderstandingClient _client;
        private readonly RequestContext _context;
        private readonly string _scope;

        /// <summary> Initializes a new instance of ContentUnderstandingClientGetAnalyzersAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ContentUnderstandingClientGetAnalyzersAsyncCollectionResult(ContentUnderstandingClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
        ...
        /// <summary> Gets the pages of ContentUnderstandingClientGetAnalyzersAsyncCollectionResult as an enumerable collection. </summary>
