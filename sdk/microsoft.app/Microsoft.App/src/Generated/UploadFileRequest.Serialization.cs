...
namespace Microsoft.App
{
    public partial class UploadFileRequest : IUtf8JsonSerializable, IJsonModel<UploadFileRequest>
    {
        ...
        internal static UploadFileRequest DeserializeUploadFileRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UploadFileRequest(properties, serializedAdditionalRawData);
        }
        ...
        internal virtual MultipartFormDataRequestContent ToMultipartRequestContent()
        {
            ...
            content.Add(ModelReaderWriter.Write(Properties, ModelSerializationExtensions.WireOptions), "properties");
            return content;
        }
