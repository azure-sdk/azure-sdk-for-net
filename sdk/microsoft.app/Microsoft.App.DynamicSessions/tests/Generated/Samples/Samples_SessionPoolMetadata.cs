...
namespace Microsoft.App.DynamicSessions.Samples
{
    public partial class Samples_SessionPoolMetadata
    {
        ...
        public void Example_SessionPoolMetadata_GetSessionPoolMetadata_SessionPoolMetadataGet()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_SessionPoolMetadata_GetSessionPoolMetadata_SessionPoolMetadataGet_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            SessionPoolMetadata client = new DynamicSessionsClient(endpoint, credential).GetSessionPoolMetadataClient(apiVersion: "2024-10-02-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_SessionPoolMetadata_GetSessionPoolMetadata_SessionPoolMetadataGet_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            SessionPoolMetadata client = new DynamicSessionsClient(endpoint, credential).GetSessionPoolMetadataClient(apiVersion: "2024-10-02-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_SessionPoolMetadata_GetSessionPoolMetadata_SessionPoolMetadataGet_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            SessionPoolMetadata client = new DynamicSessionsClient(endpoint, credential).GetSessionPoolMetadataClient(apiVersion: "2024-10-02-preview");
