...
namespace Microsoft.App.DynamicSessions
{
    ...
    public partial class CodeExecution
    {
        ...
        public virtual async Task<Operation<SessionCodeExecutionResult>> ExecuteCodeAsync(WaitUntil waitUntil, string identifier, SessionCodeExecutionRequest codeExecutionRequest, string operationId = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(identifier, nameof(identifier));
            ...
            RequestContext context = FromCancellationToken(cancellationToken);
            Operation<BinaryData> response = await ExecuteCodeAsync(waitUntil, identifier, content, operationId, context).ConfigureAwait(false);
            return ProtocolOperationHelpers.Convert(response, FetchSessionCodeExecutionResultFromSessionCodeExecutionResponse, ClientDiagnostics, "CodeExecution.ExecuteCode");
        }
        ...
        public virtual Operation<SessionCodeExecutionResult> ExecuteCode(WaitUntil waitUntil, string identifier, SessionCodeExecutionRequest codeExecutionRequest, string operationId = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(identifier, nameof(identifier));
            Argument.AssertNotNull(codeExecutionRequest, nameof(codeExecutionRequest));
            ...
            using RequestContent content = codeExecutionRequest.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Operation<BinaryData> response = ExecuteCode(waitUntil, identifier, content, operationId, context);
            return ProtocolOperationHelpers.Convert(response, FetchSessionCodeExecutionResultFromSessionCodeExecutionResponse, ClientDiagnostics, "CodeExecution.ExecuteCode");
        }
        ...
        public virtual async Task<Operation<BinaryData>> ExecuteCodeAsync(WaitUntil waitUntil, string identifier, RequestContent content, string operationId = null, RequestContext context = null)
        {
            Argument.AssertNotNull(identifier, nameof(identifier));
            ...
            try
            {
                using HttpMessage message = CreateExecuteCodeRequest(identifier, content, operationId, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "CodeExecution.ExecuteCode", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation<BinaryData> ExecuteCode(WaitUntil waitUntil, string identifier, RequestContent content, string operationId = null, RequestContext context = null)
        {
            Argument.AssertNotNull(identifier, nameof(identifier));
            Argument.AssertNotNull(content, nameof(content));
            ...
            {
                using HttpMessage message = CreateExecuteCodeRequest(identifier, content, operationId, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "CodeExecution.ExecuteCode", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        internal HttpMessage CreateExecuteCodeRequest(string identifier, RequestContent content, string operationId, RequestContext context)
        {
        ...
        private SessionCodeExecutionResult FetchSessionCodeExecutionResultFromSessionCodeExecutionResponse(Response response)
        {
