...
namespace Microsoft.App.DynamicSessions
{
    ...
    public partial class Session
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> or <paramref name="etag"/> is null. </exception>
        internal Session(string identifier, DateTimeOffset createdAt, DateTimeOffset lastAccessedAt, DateTimeOffset expireAt, string etag)
        {
        ...
        internal Session(string identifier, DateTimeOffset createdAt, DateTimeOffset lastAccessedAt, DateTimeOffset expireAt, string etag, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identifier = identifier;
            CreatedAt = createdAt;
            LastAccessedAt = lastAccessedAt;
