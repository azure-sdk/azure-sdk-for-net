...
namespace Microsoft.App.DynamicSessions
{
    ...
    public static partial class MicrosoftAppDynamicSessionsModelFactory
    {
        ...
        public static JupyterKernel JupyterKernel(string name = null, string version = null, string projectUrl = null, string description = null)
        {
        ...
        public static SessionsListResponse SessionsListResponse(IEnumerable<Session> sessions = null)
        {
            sessions ??= new List<Session>();

            return new SessionsListResponse(sessions?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        public static Session Session(string identifier = null, DateTimeOffset createdAt = default, DateTimeOffset lastAccessedAt = default, DateTimeOffset expireAt = default, string etag = null)
        {
            return new Session(
                identifier,
                createdAt,
