...
namespace Microsoft.App.DynamicSessions
{
    ...
    public static partial class MicrosoftAppDynamicSessionsModelFactory
    {
        ...
        public static SessionCodeExecutionResponse SessionCodeExecutionResponse(string id = null, string identifier = null, ExecutionType executionType = default, OperationState status = default, ErrorResponse error = null, SessionCodeExecutionResult result = null)
        {
