...
namespace Microsoft.App.DynamicSessions
{
    ...
    public partial class SessionResourceFile
    {
        ...
        internal SessionResourceFile(string name, string type, long sizeInBytes, DateTimeOffset lastModifiedAt)
        {
        ...
        internal SessionResourceFile(string name, string type, long sizeInBytes, DateTimeOffset lastModifiedAt, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Type = type;
            SizeInBytes = sizeInBytes;
