...
namespace Microsoft.App.DynamicSessions
{
    public partial class Runtime : IUtf8JsonSerializable, IJsonModel<Runtime>
    {
        ...
        internal static Runtime DeserializeRuntime(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Runtime(name, version, serializedAdditionalRawData);
        }
        ...
        internal static Runtime FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeRuntime(document.RootElement);
        }
