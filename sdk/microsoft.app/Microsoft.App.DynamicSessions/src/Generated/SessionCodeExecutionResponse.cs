...
namespace Microsoft.App.DynamicSessions
{
    ...
    public partial class SessionCodeExecutionResponse
    {
        ...
        internal SessionCodeExecutionResponse(string identifier, ExecutionType executionType, OperationState status)
        {
        ...
        internal SessionCodeExecutionResponse(string id, string identifier, ExecutionType executionType, OperationState status, ErrorResponse error, SessionCodeExecutionResult result, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Identifier = identifier;
            ExecutionType = executionType;
