...
namespace Microsoft.App.DynamicSessions
{
    ...
    public partial class SessionCodeExecutionResult
    {
        ...
        {
            ExecutionResult = new ChangeTrackingDictionary<string, BinaryData>();
        }
        ...
        internal SessionCodeExecutionResult(string stdout, string stderr, IReadOnlyDictionary<string, BinaryData> executionResult, long? executionTimeInMilliseconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Stdout = stdout;
            Stderr = stderr;
        ...
        /// </para>
        /// </summary>
        public IReadOnlyDictionary<string, BinaryData> ExecutionResult { get; }
