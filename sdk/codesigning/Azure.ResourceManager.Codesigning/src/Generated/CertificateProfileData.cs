...
namespace Azure.ResourceManager.Codesigning
{
    ...
    public partial class CertificateProfileData : ResourceData
    {
        ...
        internal CertificateProfileData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProfileType? profileType, bool? includeStreetAddress, bool? includeCity, bool? includeState, bool? includeCountry, bool? includePostalCode, string identityValidationId, ProvisioningState? provisioningState, CertificateProfileStatus? status, IReadOnlyList<Certificate> certificates, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
