...
namespace Azure.ResourceManager.Codesigning.Models
{
    ...
    public readonly partial struct ProfileType : IEquatable<ProfileType>
    {
        ...
        /// <summary> Used for signing code files which are distributed publicly. </summary>
        public static ProfileType PublicTrust { get; } = new ProfileType(PublicTrustValue);
        /// <summary> Used for signing code files which are distributed internally within organization or group boundary. </summary>
        ...
        /// <summary> Used for signing code files which are run in secure vbs enclave. </summary>
        public static ProfileType VBSEnclave { get; } = new ProfileType(VBSEnclaveValue);
        /// <summary> Used for signing code files for testing purpose. </summary>
        ...
        public static ProfileType C2PAContentCredentials { get; } = new ProfileType(C2PAContentCredentialsValue);
