...
namespace Azure.ResourceManager.Codesigning.Models
{
    ...
    internal partial class AccountSku
    {
        ...
        public AccountSku(CodesigningSkuName name)
        {
            Name = name;
        }
        ...
        internal AccountSku(CodesigningSkuName name, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
        ...
        public CodesigningSkuName Name { get; set; }
    }
}
