...
namespace Azure.ResourceManager.Codesigning.Models
{
    internal partial class AccountSku : IUtf8JsonSerializable, IJsonModel<AccountSku>
    {
        ...
        void IJsonModel<AccountSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AccountSku)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AccountSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AccountSku)} does not support '{options.Format}' format.");
            }
        }
