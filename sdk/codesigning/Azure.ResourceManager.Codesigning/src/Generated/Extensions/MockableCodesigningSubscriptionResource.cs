...
namespace Azure.ResourceManager.Codesigning.Mocking
{
    ...
    public partial class MockableCodesigningSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableCodesigningSubscriptionResource"/> class for mocking. </summary>
        protected MockableCodesigningSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableCodesigningSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableCodesigningSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<CheckNameAvailabilityResult>> CheckNameAvailabilityCodeSigningAccountAsync(CheckNameAvailability body, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CodeSigningAccountClientDiagnostics.CreateScope("MockableCodesigningSubscriptionResource.CheckNameAvailabilityCodeSigningAccount");
            scope.Start();
            try
            {
