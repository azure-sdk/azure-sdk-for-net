...
namespace Azure.ResourceManager.Codesigning.Mocking
{
    ...
    public partial class MockableCodesigningArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableCodesigningArmClient"/> class for mocking. </summary>
        protected MockableCodesigningArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableCodesigningArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableCodesigningArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableCodesigningArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
