...
namespace Azure.ResourceManager.Codesigning.Mocking
{
    ...
    public partial class MockableCodesigningResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableCodesigningResourceGroupResource"/> class for mocking. </summary>
        protected MockableCodesigningResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableCodesigningResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableCodesigningResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
