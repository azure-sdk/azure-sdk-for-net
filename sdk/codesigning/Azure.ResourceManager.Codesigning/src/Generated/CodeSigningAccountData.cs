...
namespace Azure.ResourceManager.Codesigning
{
    ...
    public partial class CodeSigningAccountData : TrackedResourceData
    {
        ...
        internal CodeSigningAccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, Uri accountUri, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData, tags, location)
        {
