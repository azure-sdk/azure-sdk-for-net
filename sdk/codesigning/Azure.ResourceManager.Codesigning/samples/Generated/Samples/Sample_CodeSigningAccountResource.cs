...
["key1"] = "value1",
        ...
        public async Task CheckNameAvailabilityCodeSigningAccount_ValidateACodeSigningAccountName()
        {
            ...
            // invoke the operation
            CheckNameAvailability accountName = new CheckNameAvailability("sample-account");
            CheckNameAvailabilityResult result = await subscriptionResource.CheckNameAvailabilityCodeSigningAccountAsync(accountName);
