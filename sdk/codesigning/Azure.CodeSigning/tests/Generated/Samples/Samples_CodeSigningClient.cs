...
namespace Azure.CodeSigning.Samples
{
    public class Samples_CodeSigningClient
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_GetSignRootCertificate_Convenience()
        {
            TokenCredential credential = new DefaultAzureCredential();
            CodeSigningClient client = new CodeSigningClient("<region>", credential);
        ...
        public void Example_GetSignEkus()
        {
            ...
            foreach (BinaryData item in client.GetSignEkus("<codeSigningAccountName>", "<certificateProfileName>", null))
            {
                ...
                Console.WriteLine(result[0].GetProperty("ekus")[0].ToString());
            }
        }
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_GetSignEkus_Convenience()
        {
            TokenCredential credential = new DefaultAzureCredential();
            CodeSigningClient client = new CodeSigningClient("<region>", credential);
        ...
        public void Example_Sign_AllParameters()
        {
            ...
            RequestContent content = RequestContent.Create(new
            {
                signatureAlgorithm = "RS256",
                digest = new object(),
                fileHashList = new List<object>()
{
new object()
},
                authenticodeHashList = new List<object>()
{
new object()
},
            });
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Sign_Convenience()
        {
            TokenCredential credential = new DefaultAzureCredential();
            CodeSigningClient client = new CodeSigningClient("<region>", credential);
