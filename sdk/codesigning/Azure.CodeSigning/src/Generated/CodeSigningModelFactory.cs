...
namespace Azure.CodeSigning
{
    ...
    public static partial class CodeSigningModelFactory
    {
        ...
        /// <returns> A new <see cref="CodeSigning.ResourceOperationStatusCertificateProfileCodeSignOperationStatusError"/> instance for mocking. </returns>
        public static ResourceOperationStatusCertificateProfileCodeSignOperationStatusError ResourceOperationStatusCertificateProfileCodeSignOperationStatusError(string id = null, OperationState status = default, ResponseError error = null, CodeSignOperationStatus result = null)
        {
            return new ResourceOperationStatusCertificateProfileCodeSignOperationStatusError(id, status, error, result);
        }
