...
namespace Azure.ResourceManager.Storagetasks
{
    ...
    public static partial class StoragetasksExtensions
    {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/providers/Microsoft.StorageTasks/locations/{location}/previewActions</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public static async Task<Response<StorageTaskPreviewAction>> PreviewActionsStorageTaskAsync(this SubscriptionResource subscriptionResource, AzureLocation location, StorageTaskPreviewAction storageTaskPreviewAction, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSubscriptionResourceExtensionClient(subscriptionResource).PreviewActionsStorageTaskAsync(location, storageTaskPreviewAction, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<StorageTaskPreviewAction> PreviewActionsStorageTask(this SubscriptionResource subscriptionResource, AzureLocation location, StorageTaskPreviewAction storageTaskPreviewAction, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtensionClient(subscriptionResource).PreviewActionsStorageTask(location, storageTaskPreviewAction, cancellationToken);
        }
    }
}
