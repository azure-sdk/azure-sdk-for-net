...
namespace Azure.ResourceManager.Storagetasks
{
    ...
    public partial class StorageTaskCollection : ArmCollection, IEnumerable<StorageTaskResource>, IAsyncEnumerable<StorageTaskResource>
    {
        ...
        {
            _storageTaskClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Storagetasks", StorageTaskResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<StorageTaskResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string storageTaskName, StorageTaskData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new StoragetasksArmOperation<StorageTaskResource>(new StorageTaskOperationSource(Client), _storageTaskClientDiagnostics, Pipeline, _storageTaskRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, storageTaskName, data).Request, response, OperationFinalStateVia.Location);
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageTasks/storageTasks</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
