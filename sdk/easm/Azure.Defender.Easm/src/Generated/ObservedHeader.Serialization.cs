...
{
    public partial class ObservedHeader
    {
        internal static ObservedHeader DeserializeObservedHeader(JsonElement element)
        {
            ...
            return new ObservedHeader(Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent), headerName.Value, headerValue.Value);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static ObservedHeader FromResponse(Response response)
        {
