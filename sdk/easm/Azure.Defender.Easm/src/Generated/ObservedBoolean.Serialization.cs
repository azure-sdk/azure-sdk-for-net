...
{
    public partial class ObservedBoolean
    {
        internal static ObservedBoolean DeserializeObservedBoolean(JsonElement element)
        {
            ...
            return new ObservedBoolean(Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent), Optional.ToNullable(value), Optional.ToList(sources));
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static ObservedBoolean FromResponse(Response response)
        {
