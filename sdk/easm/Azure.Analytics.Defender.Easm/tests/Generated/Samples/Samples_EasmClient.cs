...
"<columns>"
        ...
        public void Example_EasmClient_GetAssetsExport_ShortVersion_Convenience()
        {
            ...
            AssetsExportRequest assetsExportRequest = new AssetsExportRequest("<fileName>", new string[] { "<columns>" });
            Response<TaskResource> response = client.GetAssetsExport(assetsExportRequest);
        }
        ...
        public async Task Example_EasmClient_GetAssetsExport_ShortVersion_Convenience_Async()
        {
            ...
            AssetsExportRequest assetsExportRequest = new AssetsExportRequest("<fileName>", new string[] { "<columns>" });
            Response<TaskResource> response = await client.GetAssetsExportAsync(assetsExportRequest);
        }
...
"<columns>"
        ...
        public void Example_EasmClient_GetAssetsExport_AllParameters_Convenience()
        {
            ...
            AssetsExportRequest assetsExportRequest = new AssetsExportRequest("<fileName>", new string[] { "<columns>" });
            Response<TaskResource> response = client.GetAssetsExport(assetsExportRequest, filter: "<filter>", orderby: "<orderby>");
        }
        ...
        public async Task Example_EasmClient_GetAssetsExport_AllParameters_Convenience_Async()
        {
            ...
            AssetsExportRequest assetsExportRequest = new AssetsExportRequest("<fileName>", new string[] { "<columns>" });
            Response<TaskResource> response = await client.GetAssetsExportAsync(assetsExportRequest, filter: "<filter>", orderby: "<orderby>");
        }
        ...
        public void Example_EasmClient_GetDeltaSummary_ShortVersion_Convenience()
        {
            ...
            DeltaSummaryRequest deltaSummaryRequest = new DeltaSummaryRequest();
            Response<DeltaSummaryResult> response = client.GetDeltaSummary(deltaSummaryRequest);
        }
        ...
        public async Task Example_EasmClient_GetDeltaSummary_ShortVersion_Convenience_Async()
        {
            ...
            DeltaSummaryRequest deltaSummaryRequest = new DeltaSummaryRequest();
            Response<DeltaSummaryResult> response = await client.GetDeltaSummaryAsync(deltaSummaryRequest);
        }
...
"<sourceIds>"
        ...
        public void Example_EasmClient_GetAssetChainSummary_ShortVersion_Convenience()
        {
            ...
            AssetChainRequest assetChainRequest = new AssetChainRequest(AssetChainSource.DISCOGROUP, new string[] { "<sourceIds>" });
...
"<sourceIds>"
        ...
        public void Example_EasmClient_DismissAssetChain_ShortVersion_Convenience()
        {
            ...
            AssetChainRequest assetChainRequest = new AssetChainRequest(AssetChainSource.DISCOGROUP, new string[] { "<sourceIds>" });
            Response<TaskResource> response = client.DismissAssetChain(assetChainRequest);
        }
        ...
        public async Task Example_EasmClient_DismissAssetChain_ShortVersion_Convenience_Async()
        {
            ...
            AssetChainRequest assetChainRequest = new AssetChainRequest(AssetChainSource.DISCOGROUP, new string[] { "<sourceIds>" });
            Response<TaskResource> response = await client.DismissAssetChainAsync(assetChainRequest);
        }
...
"<columns>"
        ...
        public void Example_EasmClient_GetDeltaDetails_ShortVersion_Convenience()
        {
            ...
            DeltaDetailsRequest deltaDetailsRequest = new DeltaDetailsRequest(DeltaDetailType.Added, GlobalAssetType.Page);
            foreach (DeltaResult item in client.GetDeltaDetails(deltaDetailsRequest))
            {
            }
        }
        ...
        public async Task Example_EasmClient_GetDeltaDetails_ShortVersion_Convenience_Async()
        {
            ...
            DeltaDetailsRequest deltaDetailsRequest = new DeltaDetailsRequest(DeltaDetailType.Added, GlobalAssetType.Page);
            await foreach (DeltaResult item in client.GetDeltaDetailsAsync(deltaDetailsRequest))
            {
            }
        }
        ...
        public void Example_EasmClient_GetDeltaDetails_AllParameters_Convenience()
        {
            ...
            foreach (DeltaResult item in client.GetDeltaDetails(deltaDetailsRequest, skip: 1234, maxpagesize: 1234))
            {
            }
        }
        ...
        public async Task Example_EasmClient_GetDeltaDetails_AllParameters_Convenience_Async()
        {
            ...
            await foreach (DeltaResult item in client.GetDeltaDetailsAsync(deltaDetailsRequest, skip: 1234, maxpagesize: 1234))
            {
            }
        }
