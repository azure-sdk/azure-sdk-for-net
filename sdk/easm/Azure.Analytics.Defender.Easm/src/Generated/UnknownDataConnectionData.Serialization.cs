...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class UnknownDataConnectionData : IUtf8JsonSerializable, IJsonModel<DataConnectionData>
    {
        ...
        internal static UnknownDataConnectionData DeserializeUnknownDataConnectionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<DataConnectionDataContent> content = default;
            Optional<DataConnectionDataFrequency> frequency = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("content"u8))
                {
                    ...
                    content = new DataConnectionDataContent(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("frequency"u8))
                {
                    ...
                    frequency = new DataConnectionDataFrequency(property.Value.GetString());
                    continue;
                }
