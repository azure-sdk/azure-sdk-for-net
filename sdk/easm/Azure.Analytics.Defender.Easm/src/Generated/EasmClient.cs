...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class EasmClient
    {
        ...
        /// <summary> Create or update a policy with a given policyName. </summary>
        /// <param name="policyName"> The caller provided unique name for the resource. </param>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="policyName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="policyName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='CreateOrReplacePolicyAsync(string,string,string,PolicyAction?,int?,ActionParameters,CancellationToken)']/*" />
        public virtual async Task<Response<Policy>> CreateOrReplacePolicyAsync(string policyName, string description = null, string filterName = null, PolicyAction? action = null, int? priority = null, ActionParameters actionParameters = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(policyName, nameof(policyName));

            CreateOrReplacePolicyRequest createOrReplacePolicyRequest = new CreateOrReplacePolicyRequest(
                description,
                filterName,
                action,
                priority,
                ...
                null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await CreateOrReplacePolicyAsync(policyName, createOrReplacePolicyRequest.ToRequestContent(), context).ConfigureAwait(false);
            return Response.FromValue(Policy.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="policyName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="policyName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='CreateOrReplacePolicy(string,string,string,PolicyAction?,int?,ActionParameters,CancellationToken)']/*" />
        public virtual Response<Policy> CreateOrReplacePolicy(string policyName, string description = null, string filterName = null, PolicyAction? action = null, int? priority = null, ActionParameters actionParameters = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(policyName, nameof(policyName));
            ...
            CreateOrReplacePolicyRequest createOrReplacePolicyRequest = new CreateOrReplacePolicyRequest(
                ...
                null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = CreateOrReplacePolicy(policyName, createOrReplacePolicyRequest.ToRequestContent(), context);
            return Response.FromValue(Policy.FromResponse(response), response);
        }

        /// <summary>
        /// [Protocol Method] Create or update a policy with a given policyName.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrReplacePolicyAsync(string,string,string,PolicyAction?,int?,ActionParameters,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrReplacePolicy(string,string,string,PolicyAction?,int?,ActionParameters,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
