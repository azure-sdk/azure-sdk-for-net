...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class EasmClient
    {
        ...
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='ValidateDataConnectionAsync(string,DataConnectionPayload,CancellationToken)']/*" />
        public virtual async Task<Response<ValidateResult>> ValidateDataConnectionAsync(string dataConnectionName, DataConnectionPayload body, CancellationToken cancellationToken = default)
        {
            ...
            using RequestContent content = body.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await ValidateDataConnectionAsync(dataConnectionName, content, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="dataConnectionName"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="dataConnectionName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='ValidateDataConnection(string,DataConnectionPayload,CancellationToken)']/*" />
        public virtual Response<ValidateResult> ValidateDataConnection(string dataConnectionName, DataConnectionPayload body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataConnectionName, nameof(dataConnectionName));
            Argument.AssertNotNull(body, nameof(body));
            ...
            using RequestContent content = body.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = ValidateDataConnection(dataConnectionName, content, context);
            return Response.FromValue(ValidateResult.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ValidateDataConnectionAsync(string,DataConnectionPayload,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='ValidateDataConnectionAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ValidateDataConnectionAsync(string dataConnectionName, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(dataConnectionName, nameof(dataConnectionName));
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                using HttpMessage message = CreateValidateDataConnectionRequest(dataConnectionName, content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ValidateDataConnection(string,DataConnectionPayload,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='ValidateDataConnection(string,RequestContent,RequestContext)']/*" />
        public virtual Response ValidateDataConnection(string dataConnectionName, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(dataConnectionName, nameof(dataConnectionName));
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<Response<DataConnectionPayload>> GetDataConnectionAsync(string dataConnectionName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataConnectionName, nameof(dataConnectionName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetDataConnectionAsync(dataConnectionName, context).ConfigureAwait(false);
            return Response.FromValue(DataConnectionPayload.FromResponse(response), response);
        }
        ...
        public virtual Response<DataConnectionPayload> GetDataConnection(string dataConnectionName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataConnectionName, nameof(dataConnectionName));
        ...
        public virtual async Task<Response<DataConnectionPayload>> CreateOrReplaceDataConnectionAsync(string dataConnectionName, DataConnectionPayload body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataConnectionName, nameof(dataConnectionName));
            Argument.AssertNotNull(body, nameof(body));
        ...
        public virtual Response<DataConnectionPayload> CreateOrReplaceDataConnection(string dataConnectionName, DataConnectionPayload body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataConnectionName, nameof(dataConnectionName));
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='ValidateDiscoGroupAsync(string,DiscoveryGroup,CancellationToken)']/*" />
        public virtual async Task<Response<ValidateResult>> ValidateDiscoGroupAsync(string groupName, DiscoveryGroup body, CancellationToken cancellationToken = default)
        {
            ...
            using RequestContent content = body.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await ValidateDiscoGroupAsync(groupName, content, context).ConfigureAwait(false);
            return Response.FromValue(ValidateResult.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="groupName"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="groupName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='ValidateDiscoGroup(string,DiscoveryGroup,CancellationToken)']/*" />
        public virtual Response<ValidateResult> ValidateDiscoGroup(string groupName, DiscoveryGroup body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupName, nameof(groupName));
            Argument.AssertNotNull(body, nameof(body));
            ...
            using RequestContent content = body.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = ValidateDiscoGroup(groupName, content, context);
            return Response.FromValue(ValidateResult.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ValidateDiscoGroupAsync(string,DiscoveryGroup,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='ValidateDiscoGroupAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ValidateDiscoGroupAsync(string groupName, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(groupName, nameof(groupName));
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                using HttpMessage message = CreateValidateDiscoGroupRequest(groupName, content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ValidateDiscoGroup(string,DiscoveryGroup,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='ValidateDiscoGroup(string,RequestContent,RequestContext)']/*" />
        public virtual Response ValidateDiscoGroup(string groupName, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(groupName, nameof(groupName));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="groupName"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="groupName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='CreateOrReplaceDiscoGroupAsync(string,DiscoveryGroup,CancellationToken)']/*" />
        public virtual async Task<Response<DiscoveryGroup>> CreateOrReplaceDiscoGroupAsync(string groupName, DiscoveryGroup body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupName, nameof(groupName));
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="groupName"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="groupName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='CreateOrReplaceDiscoGroup(string,DiscoveryGroup,CancellationToken)']/*" />
        public virtual Response<DiscoveryGroup> CreateOrReplaceDiscoGroup(string groupName, DiscoveryGroup body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupName, nameof(groupName));
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrReplaceDiscoGroupAsync(string,DiscoveryGroup,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateOrReplaceDiscoGroup(string,DiscoveryGroup,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response<SavedFilter>> CreateOrReplaceSavedFilterAsync(string filterName, SavedFilter body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(filterName, nameof(filterName));
            Argument.AssertNotNull(body, nameof(body));
        ...
        public virtual Response<SavedFilter> CreateOrReplaceSavedFilter(string filterName, SavedFilter body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(filterName, nameof(filterName));
            Argument.AssertNotNull(body, nameof(body));
        ...
        public virtual AsyncPageable<DataConnectionPayload> GetDataConnectionsAsync(int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => DataConnectionPayload.DeserializeDataConnectionPayload(e), ClientDiagnostics, _pipeline, "EasmClient.GetDataConnections", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<DataConnectionPayload> GetDataConnections(int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetDataConnectionsRequest(skip, maxpagesize, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetDataConnectionsNextPageRequest(nextLink, skip, maxpagesize, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => DataConnectionPayload.DeserializeDataConnectionPayload(e), ClientDiagnostics, _pipeline, "EasmClient.GetDataConnections", "value", "nextLink", context);
        }
        ...
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetPoliciesRequest(filter, skip, maxpagesize, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetPoliciesNextPageRequest(nextLink, filter, skip, maxpagesize, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Policy.DeserializePolicy(e), ClientDiagnostics, _pipeline, "EasmClient.GetPolicies", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<Policy> GetPolicies(string filter = null, int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetPoliciesRequest(filter, skip, maxpagesize, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetPoliciesNextPageRequest(nextLink, filter, skip, maxpagesize, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Policy.DeserializePolicy(e), ClientDiagnostics, _pipeline, "EasmClient.GetPolicies", "value", "nextLink", context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetPoliciesAsync(string filter, int? skip, int? maxpagesize, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetPoliciesRequest(filter, skip, maxpagesize, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetPoliciesNextPageRequest(nextLink, filter, skip, maxpagesize, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EasmClient.GetPolicies", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetPolicies(string filter, int? skip, int? maxpagesize, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetPoliciesRequest(filter, skip, maxpagesize, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetPoliciesNextPageRequest(nextLink, filter, skip, maxpagesize, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "EasmClient.GetPolicies", "value", "nextLink", context);
        }
        ...
        internal HttpMessage CreateValidateDataConnectionRequest(string dataConnectionName, RequestContent content, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        internal HttpMessage CreateValidateDiscoGroupRequest(string groupName, RequestContent content, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Post;
