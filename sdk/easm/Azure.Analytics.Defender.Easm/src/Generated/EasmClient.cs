...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class EasmClient
    {
        ...
        /// <param name="assetsExportRequest"> A request body used to export an asset. </param>
        /// <param name="filter"> Filter the result list using the given expression. </param>
        /// <param name="orderby"> A list of expressions that specify the order of the returned resources. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="assetsExportRequest"/> is null. </exception>
        ...
        public virtual async Task<Response<TaskResource>> GetAssetsExportAsync(AssetsExportRequest assetsExportRequest, string filter = null, string orderby = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(assetsExportRequest, nameof(assetsExportRequest));

            using RequestContent content = assetsExportRequest.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        public virtual Response<TaskResource> GetAssetsExport(AssetsExportRequest assetsExportRequest, string filter = null, string orderby = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(assetsExportRequest, nameof(assetsExportRequest));
        ...
        /// <param name="deltaSummaryRequest"> A request body used to retrieve a delta summary. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deltaSummaryRequest"/> is null. </exception>
        /// <include file="Docs/EasmClient.xml" path="doc/members/member[@name='GetDeltaSummaryAsync(DeltaSummaryRequest,CancellationToken)']/*" />
        public virtual async Task<Response<DeltaSummaryResult>> GetDeltaSummaryAsync(DeltaSummaryRequest deltaSummaryRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(deltaSummaryRequest, nameof(deltaSummaryRequest));

            using RequestContent content = deltaSummaryRequest.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        public virtual Response<DeltaSummaryResult> GetDeltaSummary(DeltaSummaryRequest deltaSummaryRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(deltaSummaryRequest, nameof(deltaSummaryRequest));
        ...
        public virtual async Task<Response<TaskResource>> DismissAssetChainAsync(AssetChainRequest assetChainRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(assetChainRequest, nameof(assetChainRequest));
        ...
        public virtual Response<TaskResource> DismissAssetChain(AssetChainRequest assetChainRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(assetChainRequest, nameof(assetChainRequest));
        ...
        /// <param name="deltaDetailsRequest"> A request body used to retrieve a list of deltas. </param>
        /// <param name="skip"> The number of result items to skip. </param>
        /// <param name="maxpagesize"> The maximum number of result items per page. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deltaDetailsRequest"/> is null. </exception>
        ...
        public virtual AsyncPageable<DeltaResult> GetDeltaDetailsAsync(DeltaDetailsRequest deltaDetailsRequest, int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(deltaDetailsRequest, nameof(deltaDetailsRequest));

            RequestContent content = deltaDetailsRequest.ToRequestContent();
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
        ...
        public virtual Pageable<DeltaResult> GetDeltaDetails(DeltaDetailsRequest deltaDetailsRequest, int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(deltaDetailsRequest, nameof(deltaDetailsRequest));
