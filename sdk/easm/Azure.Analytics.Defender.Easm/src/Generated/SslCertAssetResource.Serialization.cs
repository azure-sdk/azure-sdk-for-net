...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SslCertAssetResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SslCertAssetResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SslCertAssetResource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SslCertAssetResource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SslCertAssetResource)} does not support '{options.Format}' format.");
            }
        }
