...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class ObservationResult
    {
        ...
        internal ObservationResult(string name, IEnumerable<ObservationType> type, ObservationPriority priority, double cvssScoreV2, double cvssScoreV3)
        {
        ...
        internal ObservationResult(string name, IReadOnlyList<ObservationType> type, ObservationPriority priority, double cvssScoreV2, double cvssScoreV3, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Type = type;
            Priority = priority;
        ...
        public IReadOnlyList<ObservationType> Type { get; }
