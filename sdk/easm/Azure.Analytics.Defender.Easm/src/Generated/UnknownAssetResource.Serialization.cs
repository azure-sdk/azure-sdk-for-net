...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class UnknownAssetResource : IUtf8JsonSerializable, IJsonModel<AssetResource>
    {
        ...
        internal static UnknownAssetResource DeserializeUnknownAssetResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownAssetResource(kind, id, name.Value, displayName.Value, Optional.ToNullable(uuid), Optional.ToNullable(createdDate), Optional.ToNullable(updatedDate), state.Value, externalId.Value, Optional.ToList(labels), Optional.ToNullable(wildcard), discoGroupName.Value, Optional.ToList(auditTrail), reason.Value, serializedAdditionalRawData);
        }
