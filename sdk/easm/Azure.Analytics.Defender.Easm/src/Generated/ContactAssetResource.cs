...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class ContactAssetResource : AssetResource
    {
        ...
        /// <param name="asset"> asset. </param>
        internal ContactAssetResource(string kind, string id, string name, string displayName, Guid? uuid, DateTimeOffset? createdDate, DateTimeOffset? updatedDate, AssetState? state, string externalId, IReadOnlyList<string> labels, bool? wildcard, string discoGroupName, IReadOnlyList<AuditTrailItem> auditTrail, string reason, ContactAsset asset) : base(kind, id, name, displayName, uuid, createdDate, updatedDate, state, externalId, labels, wildcard, discoGroupName, auditTrail, reason)
        {
            Asset = asset;
        }
