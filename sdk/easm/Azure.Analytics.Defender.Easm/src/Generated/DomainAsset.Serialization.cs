...
namespace Azure.Analytics.Defender.Easm
{
    public partial class DomainAsset : IUtf8JsonSerializable, IJsonModel<DomainAsset>
    {
        ...
        internal static new DomainAsset FromResponse(Response response)
        {
