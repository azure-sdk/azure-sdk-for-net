...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class DeltaDetailsRequestBody
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DeltaDetailsRequestBody"/>. </summary>
        public DeltaDetailsRequestBody()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DeltaDetailsRequestBody"/>. </summary>
        /// <param name="deltaDetailType"> The type of delta detail to retrieve. </param>
        /// <param name="daysPrior"> The number of days prior to retrieve deltas for. </param>
        /// <param name="kind"> The type of asset. </param>
        /// <param name="date"> expected format to be: yyyy-MM-dd. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal DeltaDetailsRequestBody(DeltaDetailType? deltaDetailType, int? daysPrior, GlobalAssetType? kind, string date, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public DeltaDetailType? DeltaDetailType { get; set; }
        ...
        public GlobalAssetType? Kind { get; set; }
