...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public abstract partial class DataConnectionData
    {
        ...
        internal DataConnectionData(string kind, string name, DataConnectionDataContent? content, DataConnectionDataFrequency? frequency, int? frequencyOffset, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Name = name;
            Content = content;
        ...
        public DataConnectionDataContent? Content { get; set; }
        /// <summary> The rate at which the data connection will receive updates. </summary>
        public DataConnectionDataFrequency? Frequency { get; set; }
