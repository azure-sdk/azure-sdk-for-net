...
{
    internal partial class EasmClientGetDiscoveryGroupRunsCollectionResult : Pageable<BinaryData>
    {
        ...
        public EasmClientGetDiscoveryGroupRunsCollectionResult(EasmClient client, string groupName, string filter, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of EasmClientGetDiscoveryGroupRunsCollectionResult as an enumerable collection. </returns>
