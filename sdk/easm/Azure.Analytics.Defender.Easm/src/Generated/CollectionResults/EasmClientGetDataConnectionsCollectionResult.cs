...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetDataConnectionsCollectionResult : Pageable<BinaryData>
    {
        ...
        public EasmClientGetDataConnectionsCollectionResult(EasmClient client, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _skip = skip;
