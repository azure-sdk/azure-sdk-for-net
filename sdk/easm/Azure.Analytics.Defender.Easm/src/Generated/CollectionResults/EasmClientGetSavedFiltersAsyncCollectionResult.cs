...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetSavedFiltersAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public EasmClientGetSavedFiltersAsyncCollectionResult(EasmClient client, string filter, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _skip = skip;
