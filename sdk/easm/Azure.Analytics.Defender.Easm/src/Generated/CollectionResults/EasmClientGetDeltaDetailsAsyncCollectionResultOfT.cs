...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetDeltaDetailsAsyncCollectionResultOfT : AsyncPageable<DeltaResult>
    {
        ...
        public EasmClientGetDeltaDetailsAsyncCollectionResultOfT(EasmClient client, RequestContent content, int? skip, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _content = content;
            _skip = skip;
