...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetTasksAsyncCollectionResultOfT : AsyncPageable<TaskResource>
    {
        ...
        public EasmClientGetTasksAsyncCollectionResultOfT(EasmClient client, string filter, string @orderby, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _orderby = @orderby;
