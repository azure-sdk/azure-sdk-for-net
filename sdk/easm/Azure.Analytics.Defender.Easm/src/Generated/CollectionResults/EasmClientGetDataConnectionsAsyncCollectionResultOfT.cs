...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetDataConnectionsAsyncCollectionResultOfT : AsyncPageable<DataConnection>
    {
        ...
        public EasmClientGetDataConnectionsAsyncCollectionResultOfT(EasmClient client, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _skip = skip;
