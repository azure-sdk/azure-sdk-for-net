...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetDiscoveryGroupRunsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public EasmClientGetDiscoveryGroupRunsAsyncCollectionResult(EasmClient client, string groupName, string filter, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
