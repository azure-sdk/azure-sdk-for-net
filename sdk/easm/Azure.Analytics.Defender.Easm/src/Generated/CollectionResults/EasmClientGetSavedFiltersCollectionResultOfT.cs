...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetSavedFiltersCollectionResultOfT : Pageable<SavedFilter>
    {
        ...
        public EasmClientGetSavedFiltersCollectionResultOfT(EasmClient client, string filter, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _skip = skip;
