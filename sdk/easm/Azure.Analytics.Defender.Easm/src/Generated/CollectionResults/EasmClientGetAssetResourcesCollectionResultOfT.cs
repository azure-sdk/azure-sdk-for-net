...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetAssetResourcesCollectionResultOfT : Pageable<AssetResource>
    {
        ...
        public EasmClientGetAssetResourcesCollectionResultOfT(EasmClient client, string filter, string @orderby, int? skip, int? maxPageSize, string mark, string responseType, IEnumerable<string> responseIncludes, bool? recentOnly, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _orderby = @orderby;
