...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetTasksCollectionResult : Pageable<BinaryData>
    {
        ...
        public EasmClientGetTasksCollectionResult(EasmClient client, string filter, string @orderby, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _orderby = @orderby;
