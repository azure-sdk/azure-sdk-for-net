...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetDeltaDetailsCollectionResult : Pageable<BinaryData>
    {
        ...
        public EasmClientGetDeltaDetailsCollectionResult(EasmClient client, RequestContent content, int? skip, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _content = content;
            _skip = skip;
