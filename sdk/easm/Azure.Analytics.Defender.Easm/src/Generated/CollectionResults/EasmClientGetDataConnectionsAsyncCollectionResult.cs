...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetDataConnectionsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public EasmClientGetDataConnectionsAsyncCollectionResult(EasmClient client, int? skip, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _skip = skip;
