...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class ContactAsset : InventoryAsset
    {
        ...
        internal ContactAsset(IDictionary<string, BinaryData> serializedAdditionalRawData, string email, IReadOnlyList<ObservedString> names, IReadOnlyList<ObservedString> organizations, IReadOnlyList<Source> sources, DateTimeOffset? firstSeen, DateTimeOffset? lastSeen, long? count) : base(serializedAdditionalRawData)
        {
            Email = email;
            Names = names;
