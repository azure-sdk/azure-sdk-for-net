...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class DiscoRunResult
    {
        ...
        internal DiscoRunResult(DateTimeOffset? submittedDate, DateTimeOffset? startedDate, DateTimeOffset? completedDate, string tier, DiscoRunResultState? state, long? totalAssetsFoundCount, IReadOnlyList<DiscoSource> seeds, IReadOnlyList<DiscoSource> excludes, IReadOnlyList<string> names, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public DiscoRunResultState? State { get; }
