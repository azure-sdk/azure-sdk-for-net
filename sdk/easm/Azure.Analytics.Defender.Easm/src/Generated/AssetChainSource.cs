...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public readonly partial struct AssetChainSource : IEquatable<AssetChainSource>
    {
        ...
        private const string DISCOSEEDValue = "DISCO_SEED";
        private const string ASSETCHAINValue = "ASSET_CHAIN";

        /// <summary> DISCO_GROUP. </summary>
        public static AssetChainSource DISCOGROUP { get; } = new AssetChainSource(DISCOGROUPValue);
        /// <summary> DISCO_SEED. </summary>
        public static AssetChainSource DISCOSEED { get; } = new AssetChainSource(DISCOSEEDValue);
        /// <summary> ASSET_CHAIN. </summary>
        public static AssetChainSource ASSETCHAIN { get; } = new AssetChainSource(ASSETCHAINValue);
