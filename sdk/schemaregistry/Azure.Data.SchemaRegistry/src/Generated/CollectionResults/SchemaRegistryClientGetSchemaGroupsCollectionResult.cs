...
namespace Azure.Data.SchemaRegistry
{
    internal partial class SchemaRegistryClientGetSchemaGroupsCollectionResult : Pageable<BinaryData>
    {
        ...
        public SchemaRegistryClientGetSchemaGroupsCollectionResult(SchemaRegistryClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
