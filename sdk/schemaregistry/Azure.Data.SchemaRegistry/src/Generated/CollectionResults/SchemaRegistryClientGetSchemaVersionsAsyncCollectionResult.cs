...
namespace Azure.Data.SchemaRegistry
{
    internal partial class SchemaRegistryClientGetSchemaVersionsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public SchemaRegistryClientGetSchemaVersionsAsyncCollectionResult(SchemaRegistryClient client, string groupName, string schemaName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
