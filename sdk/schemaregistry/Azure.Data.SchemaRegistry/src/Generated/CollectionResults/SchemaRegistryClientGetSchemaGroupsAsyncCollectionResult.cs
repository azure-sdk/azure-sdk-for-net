...
namespace Azure.Data.SchemaRegistry
{
    internal partial class SchemaRegistryClientGetSchemaGroupsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public SchemaRegistryClientGetSchemaGroupsAsyncCollectionResult(SchemaRegistryClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
