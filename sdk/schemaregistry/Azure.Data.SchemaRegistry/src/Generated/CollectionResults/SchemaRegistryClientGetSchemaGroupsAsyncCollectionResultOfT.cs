...
namespace Azure.Data.SchemaRegistry
{
    internal partial class SchemaRegistryClientGetSchemaGroupsAsyncCollectionResultOfT : AsyncPageable<string>
    {
        ...
        public SchemaRegistryClientGetSchemaGroupsAsyncCollectionResultOfT(SchemaRegistryClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
