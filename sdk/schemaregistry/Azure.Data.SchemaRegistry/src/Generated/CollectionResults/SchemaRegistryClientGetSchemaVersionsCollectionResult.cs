...
namespace Azure.Data.SchemaRegistry
{
    internal partial class SchemaRegistryClientGetSchemaVersionsCollectionResult : Pageable<BinaryData>
    {
        ...
        public SchemaRegistryClientGetSchemaVersionsCollectionResult(SchemaRegistryClient client, string groupName, string schemaName, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
