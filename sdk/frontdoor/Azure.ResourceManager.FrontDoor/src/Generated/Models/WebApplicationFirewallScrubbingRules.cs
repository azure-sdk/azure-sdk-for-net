...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class WebApplicationFirewallScrubbingRules
    {
        ...
        /// <param name="matchVariable"> The variable to be scrubbed from the logs. </param>
        /// <param name="selectorMatchOperator"> Comparison type to use for matching with the variable value in log. </param>
        /// <param name="selector"> Match against a specific key from the QueryString, PostArgs, RequestHeader or Cookies variables in the log. Default value is null. </param>
        ...
        /// <summary> Match against a specific key from the QueryString, PostArgs, RequestHeader or Cookies variables in the log. Default value is null. </summary>
