...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public static partial class FrontDoorExtensions
    {
        ...
        {
            return GetExtensionClient(subscriptionResource).GetFrontDoorWebApplicationFirewallPoliciesByFrontDoorWebApplicationFirewallPolicyAsync(cancellationToken);
        }
        ...
        {
            return GetExtensionClient(subscriptionResource).GetFrontDoorWebApplicationFirewallPoliciesByFrontDoorWebApplicationFirewallPolicy(cancellationToken);
        }
