...
namespace Azure.ResourceManager.Storageactions.Models
{
    ...
    public static partial class ArmStorageactionsModelFactory
    {
        ...
        public static StorageTaskData StorageTaskData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, StorageTaskProperties properties = null)
        {
            ...
            return new StorageTaskData(id, name, resourceType, systemData, tags, location, identity, properties, serializedAdditionalRawData: null);
        }
        ...
        public static StorageTaskProperties StorageTaskProperties(long? taskVersion = null, bool enabled = default, string description = null, StorageTaskAction action = null, ProvisioningState? provisioningState = null, DateTimeOffset? creationTimeInUtc = null)
        {
            return new StorageTaskProperties(taskVersion, enabled, description, action, provisioningState, creationTimeInUtc, serializedAdditionalRawData: null);
        }
        ...
        {
            return new StorageTaskReportInstance(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        {
            return new StorageTaskReportProperties(taskAssignmentId, storageAccountId, startTime, finishTime, objectsTargetedCount, objectsOperatedOnCount, objectFailedCount, objectsSucceededCount, runStatusError, runStatusEnum, summaryReportPath, taskId, taskVersion, runResult, serializedAdditionalRawData: null);
        }
        ...
        public static StorageTaskPreviewBlobProperties StorageTaskPreviewBlobProperties(string name = null, IEnumerable<StorageTaskPreviewKeyValueProperties> properties = null, IEnumerable<StorageTaskPreviewKeyValueProperties> metadata = null, IEnumerable<StorageTaskPreviewKeyValueProperties> tags = null, MatchedBlockName? matchedBlock = null)
        {
            ...
            return new StorageTaskPreviewBlobProperties(name, properties?.ToList(), metadata?.ToList(), tags?.ToList(), matchedBlock, serializedAdditionalRawData: null);
        }
    }
}
