...
namespace Azure.ResourceManager.Storageactions.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageTaskPreviewActionProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<StorageTaskPreviewActionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageTaskPreviewActionProperties)} does not support '{format}' format.");
            }
        ...
        internal static StorageTaskPreviewActionProperties DeserializeStorageTaskPreviewActionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    container = StorageTaskPreviewContainerProperties.DeserializeStorageTaskPreviewContainerProperties(property.Value);
                    continue;
                }
                ...
                {
                    action = StorageTaskPreviewActionCondition.DeserializeStorageTaskPreviewActionCondition(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<StorageTaskPreviewActionProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageTaskPreviewActionProperties)} does not support '{options.Format}' format.");
            }
        }
