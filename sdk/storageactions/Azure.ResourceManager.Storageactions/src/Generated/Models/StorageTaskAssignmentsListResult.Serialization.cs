...
namespace Azure.ResourceManager.Storageactions.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageTaskAssignmentsListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<StorageTaskAssignmentsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageTaskAssignmentsListResult)} does not support '{format}' format.");
            }
        ...
        internal static StorageTaskAssignmentsListResult DeserializeStorageTaskAssignmentsListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StorageTaskAssignmentsListResult(Optional.ToList(value), nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<StorageTaskAssignmentsListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageTaskAssignmentsListResult)} does not support '{options.Format}' format.");
            }
        }
