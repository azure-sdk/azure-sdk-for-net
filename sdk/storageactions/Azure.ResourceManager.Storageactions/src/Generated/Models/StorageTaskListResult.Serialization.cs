...
namespace Azure.ResourceManager.Storageactions.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageTaskListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<StorageTaskListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageTaskListResult)} does not support '{format}' format.");
            }
        ...
        internal static StorageTaskListResult DeserializeStorageTaskListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StorageTaskListResult(value, nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<StorageTaskListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageTaskListResult)} does not support '{options.Format}' format.");
            }
        }
