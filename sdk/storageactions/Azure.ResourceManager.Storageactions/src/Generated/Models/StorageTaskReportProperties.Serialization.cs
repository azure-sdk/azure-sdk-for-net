...
namespace Azure.ResourceManager.Storageactions.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageTaskReportProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<StorageTaskReportProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageTaskReportProperties)} does not support '{format}' format.");
            }
        ...
        internal static StorageTaskReportProperties DeserializeStorageTaskReportProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StorageTaskReportProperties(taskAssignmentId.Value, storageAccountId.Value, startTime.Value, finishTime.Value, objectsTargetedCount.Value, objectsOperatedOnCount.Value, objectFailedCount.Value, objectsSucceededCount.Value, runStatusError.Value, Optional.ToNullable(runStatusEnum), summaryReportPath.Value, taskId.Value, taskVersion.Value, Optional.ToNullable(runResult), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<StorageTaskReportProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageTaskReportProperties)} does not support '{options.Format}' format.");
            }
        }
