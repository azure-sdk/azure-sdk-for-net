...
#pragma warning disable SA1649 // File name should match first type name
    internal class StorageactionsArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal StorageactionsArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal StorageactionsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "StorageactionsArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
