...
namespace Azure.ResourceManager.Storageactions.Samples
{
    public partial class Sample_StorageTaskCollection
    {
        ...
        public async Task CreateOrUpdate_PutStorageTask()
        {
            ...
            StorageTaskData data = new StorageTaskData(new AzureLocation("westus"), new ManagedServiceIdentity("SystemAssigned"), new StorageTaskProperties(true, "My Storage task", new StorageTaskAction(new IfCondition("[[equals(AccessTier, 'Cool')]]", new StorageTaskOperation[]
            {
