...
namespace Azure.ResourceManager.ElasticSan
{
    ...
    public static partial class ElasticSanExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableElasticSanArmClient.GetVolumeGroupResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static VolumeGroupResource GetVolumeGroupResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableElasticSanArmClient(client).GetVolumeGroupResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableElasticSanArmClient.GetVolumeResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static VolumeResource GetVolumeResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableElasticSanArmClient(client).GetVolumeResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableElasticSanArmClient.GetSnapshotResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static SnapshotResource GetSnapshotResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableElasticSanArmClient(client).GetSnapshotResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableElasticSanSubscriptionResource.GetSkusOperationGroups(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="subscriptionResource"> The <see cref="SubscriptionResource" /> instance the method will execute against. </param>
        ...
        public static AsyncPageable<ElasticSanSkuInformation> GetSkusOperationGroupsAsync(this SubscriptionResource subscriptionResource, string filter = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return GetMockableElasticSanSubscriptionResource(subscriptionResource).GetSkusOperationGroupsAsync(filter, cancellationToken);
        }
        ...
        public static Pageable<ElasticSanSkuInformation> GetSkusOperationGroups(this SubscriptionResource subscriptionResource, string filter = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return GetMockableElasticSanSubscriptionResource(subscriptionResource).GetSkusOperationGroups(filter, cancellationToken);
        }
    }
}
