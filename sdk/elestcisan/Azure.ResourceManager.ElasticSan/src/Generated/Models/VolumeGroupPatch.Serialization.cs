...
{
    public partial class VolumeGroupPatch : IUtf8JsonSerializable, IJsonModel<VolumeGroupPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VolumeGroupPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeGroupPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        VolumeGroupPatch IJsonModel<VolumeGroupPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeGroupPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static VolumeGroupPatch DeserializeVolumeGroupPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<VolumeGroupPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeGroupPatch>)this).GetFormatFromOptions(options) : options.Format;
        ...
        VolumeGroupPatch IPersistableModel<VolumeGroupPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VolumeGroupPatch>)this).GetFormatFromOptions(options) : options.Format;
