...
{
    /// <summary> Customizations options to override default service behaviors for realtime behavior. </summary>
    public partial class RealtimeCustomizationOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="RealtimeCustomizationOptions"/>. </summary>
        public RealtimeCustomizationOptions()
        {
        }
        ...
        internal RealtimeCustomizationOptions(string redactionFormat, OperationType? operation, string surrogateLocale, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
