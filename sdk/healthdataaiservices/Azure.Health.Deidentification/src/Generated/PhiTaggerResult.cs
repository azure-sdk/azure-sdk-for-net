...
namespace Azure.Health.Deidentification
{
    ...
    public partial class PhiTaggerResult
    {
        ...
        internal PhiTaggerResult(IReadOnlyList<PhiEntity> entities, StringIndexType stringIndexType, string path, ETag etag, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Entities = entities;
            StringIndexType = stringIndexType;
            Path = path;
