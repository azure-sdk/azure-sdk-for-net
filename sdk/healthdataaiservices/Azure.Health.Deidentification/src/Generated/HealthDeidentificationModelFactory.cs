...
namespace Azure.Health.Deidentification
{
    ...
    public static partial class HealthDeidentificationModelFactory
    {
        ...
        /// <param name="successful"> Number of blobs that have completed. </param>
        /// <param name="failed"> Number of blobs that have failed. </param>
        /// <param name="canceled"> Number of blobs that have been canceled. </param>
        /// <param name="total"> Number of blobs total. </param>
        ...
        public static FileLocation FileLocation(string path = null, ETag etag = default)
        {
        ...
        public static DeidentificationContent DeidentificationContent(string inputText = null, OperationType operation = default, DocumentDataType dataType = default, StringIndexType? stringIndexType = null, string redactionFormat = null)
        {
        ...
        public static PhiTaggerResult PhiTaggerResult(IEnumerable<PhiEntity> entities = null, StringIndexType stringIndexType = default, string path = null, ETag etag = default)
        {
