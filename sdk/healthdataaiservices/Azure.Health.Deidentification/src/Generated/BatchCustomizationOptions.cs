...
{
    /// <summary> Customizations options to override default service behaviors for job behavior. </summary>
    public partial class BatchCustomizationOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BatchCustomizationOptions"/>. </summary>
        public BatchCustomizationOptions()
        {
        }
        ...
        internal BatchCustomizationOptions(string redactionFormat, OperationType? operation, string surrogateLocale, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
