...
namespace Azure.Health.Deidentification
{
    public partial class CustomizationOptions : IUtf8JsonSerializable, IJsonModel<CustomizationOptions>
    {
        ...
        void IJsonModel<CustomizationOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DisableConsistency))
            {
                writer.WritePropertyName("disableConsistency"u8);
                writer.WriteBooleanValue(DisableConsistency.Value);
            }
        ...
        internal static CustomizationOptions DeserializeCustomizationOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            bool? disableConsistency = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("disableConsistency"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    disableConsistency = property.Value.GetBoolean();
                    continue;
                }
            ...
            return new CustomizationOptions(redactionFormat, disableConsistency, overwrite, locale, serializedAdditionalRawData);
        }
