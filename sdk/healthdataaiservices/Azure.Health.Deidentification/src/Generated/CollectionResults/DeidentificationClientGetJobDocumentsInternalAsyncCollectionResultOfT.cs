...
namespace Azure.Health.Deidentification
{
    internal partial class DeidentificationClientGetJobDocumentsInternalAsyncCollectionResultOfT : AsyncPageable<DeidentificationDocumentDetails>
    {
        ...
        public DeidentificationClientGetJobDocumentsInternalAsyncCollectionResultOfT(DeidentificationClient client, string jobName, int? maxpagesize, string continuationToken, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobName = jobName;
