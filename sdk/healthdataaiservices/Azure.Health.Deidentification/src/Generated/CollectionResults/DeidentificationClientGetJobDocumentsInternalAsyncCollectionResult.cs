...
namespace Azure.Health.Deidentification
{
    internal partial class DeidentificationClientGetJobDocumentsInternalAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DeidentificationClientGetJobDocumentsInternalAsyncCollectionResult(DeidentificationClient client, string jobName, int? maxpagesize, string continuationToken, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobName = jobName;
