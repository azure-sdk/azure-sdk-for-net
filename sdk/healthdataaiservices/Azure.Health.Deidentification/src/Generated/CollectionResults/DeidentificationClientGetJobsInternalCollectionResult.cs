...
namespace Azure.Health.Deidentification
{
    internal partial class DeidentificationClientGetJobsInternalCollectionResult : Pageable<BinaryData>
    {
        ...
        public DeidentificationClientGetJobsInternalCollectionResult(DeidentificationClient client, int? maxpagesize, string continuationToken, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
