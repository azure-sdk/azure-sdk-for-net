...
namespace Azure.Health.Deidentification
{
    internal partial class DeidentificationClientGetJobsInternalAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DeidentificationClientGetJobsInternalAsyncCollectionResult(DeidentificationClient client, int? maxpagesize, string continuationToken, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
