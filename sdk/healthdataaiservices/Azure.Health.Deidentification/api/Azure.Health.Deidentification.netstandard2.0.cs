namespace Azure.Health.Deidentification
{
    public partial class DeidentificationClient
    {
        ...
        public virtual Azure.Pageable<System.BinaryData> GetJobFiles(string name, int? maxpagesize, string continuationToken, Azure.RequestContext context) { throw null; }
        public virtual Azure.Pageable<Azure.Health.Deidentification.HealthFileDetails> GetJobFiles(string name, int? maxpagesize = default(int?), string continuationToken = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
        public virtual Azure.AsyncPageable<System.BinaryData> GetJobFilesAsync(string name, int? maxpagesize, string continuationToken, Azure.RequestContext context) { throw null; }
        public virtual Azure.AsyncPageable<Azure.Health.Deidentification.HealthFileDetails> GetJobFilesAsync(string name, int? maxpagesize = default(int?), string continuationToken = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
    ...
    {
        public DeidentificationClientOptions(Azure.Health.Deidentification.DeidentificationClientOptions.ServiceVersion version = Azure.Health.Deidentification.DeidentificationClientOptions.ServiceVersion.V2024_01_16_Preview) { }
        public enum ServiceVersion
        {
            V2024_01_16_Preview = 1,
        }
    }
    ...
    {
        public DeidentificationContent(string inputText, Azure.Health.Deidentification.OperationType operation, Azure.Health.Deidentification.DocumentDataType dataType) { }
        public Azure.Health.Deidentification.DocumentDataType DataType { get { throw null; } }
        public string InputText { get { throw null; } }
        public Azure.Health.Deidentification.OperationType Operation { get { throw null; } }
        public string RedactionFormat { get { throw null; } set { } }
        public Azure.Health.Deidentification.StringIndexType? StringIndexType { get { throw null; } set { } }
    ...
    {
        public DeidentificationJob(Azure.Health.Deidentification.SourceStorageLocation sourceLocation, Azure.Health.Deidentification.TargetStorageLocation targetLocation, Azure.Health.Deidentification.OperationType operation, Azure.Health.Deidentification.DocumentDataType dataType) { }
    ...
    public partial class FileLocation : System.ClientModel.Primitives.IJsonModel<Azure.Health.Deidentification.FileLocation>, System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.FileLocation>
    {
        internal FileLocation() { }
        public Azure.ETag Etag { get { throw null; } }
        public string Path { get { throw null; } }
        Azure.Health.Deidentification.FileLocation System.ClientModel.Primitives.IJsonModel<Azure.Health.Deidentification.FileLocation>.Create(ref System.Text.Json.Utf8JsonReader reader, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        void System.ClientModel.Primitives.IJsonModel<Azure.Health.Deidentification.FileLocation>.Write(System.Text.Json.Utf8JsonWriter writer, System.ClientModel.Primitives.ModelReaderWriterOptions options) { }
        Azure.Health.Deidentification.FileLocation System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.FileLocation>.Create(System.BinaryData data, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        string System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.FileLocation>.GetFormatFromOptions(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        System.BinaryData System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.FileLocation>.Write(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
    }
    public static partial class HealthDeidentificationModelFactory
    {
        public static Azure.Health.Deidentification.DeidentificationContent DeidentificationContent(string inputText = null, Azure.Health.Deidentification.OperationType operation = default(Azure.Health.Deidentification.OperationType), Azure.Health.Deidentification.DocumentDataType dataType = default(Azure.Health.Deidentification.DocumentDataType), Azure.Health.Deidentification.StringIndexType? stringIndexType = default(Azure.Health.Deidentification.StringIndexType?), string redactionFormat = null) { throw null; }
        ...
        public static Azure.Health.Deidentification.FileLocation FileLocation(string path = null, Azure.ETag etag = default(Azure.ETag)) { throw null; }
        public static Azure.Health.Deidentification.HealthFileDetails HealthFileDetails(string id = null, Azure.Health.Deidentification.FileLocation input = null, Azure.Health.Deidentification.FileLocation output = null, Azure.Health.Deidentification.OperationState status = default(Azure.Health.Deidentification.OperationState), Azure.ResponseError error = null) { throw null; }
        ...
        public static Azure.Health.Deidentification.PhiEntity PhiEntity(Azure.Health.Deidentification.PhiCategory category = default(Azure.Health.Deidentification.PhiCategory), int offset = 0, int length = 0, string text = null, double? confidenceScore = default(double?)) { throw null; }
        public static Azure.Health.Deidentification.PhiTaggerResult PhiTaggerResult(System.Collections.Generic.IEnumerable<Azure.Health.Deidentification.PhiEntity> entities = null, Azure.Health.Deidentification.StringIndexType stringIndexType = default(Azure.Health.Deidentification.StringIndexType), string path = null, Azure.ETag etag = default(Azure.ETag)) { throw null; }
    }
    public partial class HealthFileDetails : System.ClientModel.Primitives.IJsonModel<Azure.Health.Deidentification.HealthFileDetails>, System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.HealthFileDetails>
    {
        internal HealthFileDetails() { }
        public Azure.ResponseError Error { get { throw null; } }
        public string Id { get { throw null; } }
        public Azure.Health.Deidentification.FileLocation Input { get { throw null; } }
        public Azure.Health.Deidentification.FileLocation Output { get { throw null; } }
        public Azure.Health.Deidentification.OperationState Status { get { throw null; } }
        Azure.Health.Deidentification.HealthFileDetails System.ClientModel.Primitives.IJsonModel<Azure.Health.Deidentification.HealthFileDetails>.Create(ref System.Text.Json.Utf8JsonReader reader, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        void System.ClientModel.Primitives.IJsonModel<Azure.Health.Deidentification.HealthFileDetails>.Write(System.Text.Json.Utf8JsonWriter writer, System.ClientModel.Primitives.ModelReaderWriterOptions options) { }
        Azure.Health.Deidentification.HealthFileDetails System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.HealthFileDetails>.Create(System.BinaryData data, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        string System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.HealthFileDetails>.GetFormatFromOptions(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        System.BinaryData System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.HealthFileDetails>.Write(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
    }
    [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
    ...
    public partial class PhiTaggerResult : System.ClientModel.Primitives.IJsonModel<Azure.Health.Deidentification.PhiTaggerResult>, System.ClientModel.Primitives.IPersistableModel<Azure.Health.Deidentification.PhiTaggerResult>
    {
        ...
        public Azure.ETag Etag { get { throw null; } }
        public string Path { get { throw null; } }
        public Azure.Health.Deidentification.StringIndexType StringIndexType { get { throw null; } }
    ...
    {
        public SourceStorageLocation(System.Uri location, string prefix, System.Collections.Generic.IEnumerable<string> extensions) { }
    ...
    [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
    public readonly partial struct StringIndexType : System.IEquatable<Azure.Health.Deidentification.StringIndexType>
    {
        private readonly object _dummy;
        private readonly int _dummyPrimitive;
        public StringIndexType(string value) { throw null; }
        public static Azure.Health.Deidentification.StringIndexType TextElementV8 { get { throw null; } }
        public static Azure.Health.Deidentification.StringIndexType UnicodeCodePoint { get { throw null; } }
        public static Azure.Health.Deidentification.StringIndexType Utf16CodeUnit { get { throw null; } }
        public bool Equals(Azure.Health.Deidentification.StringIndexType other) { throw null; }
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public override bool Equals(object obj) { throw null; }
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public override int GetHashCode() { throw null; }
        public static bool operator ==(Azure.Health.Deidentification.StringIndexType left, Azure.Health.Deidentification.StringIndexType right) { throw null; }
        public static implicit operator Azure.Health.Deidentification.StringIndexType (string value) { throw null; }
        public static bool operator !=(Azure.Health.Deidentification.StringIndexType left, Azure.Health.Deidentification.StringIndexType right) { throw null; }
        public override string ToString() { throw null; }
    }
