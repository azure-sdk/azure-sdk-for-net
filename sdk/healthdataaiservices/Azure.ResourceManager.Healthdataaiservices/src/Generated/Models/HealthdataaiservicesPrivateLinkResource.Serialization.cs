...
{
    public partial class HealthdataaiservicesPrivateLinkResource : IUtf8JsonSerializable, IJsonModel<HealthdataaiservicesPrivateLinkResource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthdataaiservicesPrivateLinkResource>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<HealthdataaiservicesPrivateLinkResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthdataaiservicesPrivateLinkResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        HealthdataaiservicesPrivateLinkResource IJsonModel<HealthdataaiservicesPrivateLinkResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthdataaiservicesPrivateLinkResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static HealthdataaiservicesPrivateLinkResource DeserializeHealthdataaiservicesPrivateLinkResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<HealthdataaiservicesPrivateLinkResource>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthdataaiservicesPrivateLinkResource>)this).GetFormatFromOptions(options) : options.Format;
        ...
        HealthdataaiservicesPrivateLinkResource IPersistableModel<HealthdataaiservicesPrivateLinkResource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthdataaiservicesPrivateLinkResource>)this).GetFormatFromOptions(options) : options.Format;
