...
namespace Azure.ResourceManager.HealthDataAIServices
{
    ...
    public static partial class HealthDataAIServicesExtensions
    {
        ...
        private static MockableHealthDataAIServicesTenantResource GetMockableHealthDataAIServicesTenantResource(ArmResource resource)
        {
            return resource.GetCachedClient(client => new MockableHealthDataAIServicesTenantResource(client, resource.Id));
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableHealthDataAIServicesArmClient.GetPrivateEndpointConnectionResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static PrivateEndpointConnectionResource GetPrivateEndpointConnectionResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableHealthDataAIServicesArmClient(client).GetPrivateEndpointConnectionResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableHealthDataAIServicesTenantResource.GetOperations(CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static AsyncPageable<Models.Operation> GetOperationsAsync(this TenantResource tenantResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableHealthDataAIServicesTenantResource(tenantResource).GetOperationsAsync(cancellationToken);
        }
        ...
        public static Pageable<Models.Operation> GetOperations(this TenantResource tenantResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableHealthDataAIServicesTenantResource(tenantResource).GetOperations(cancellationToken);
        }
    }
}
