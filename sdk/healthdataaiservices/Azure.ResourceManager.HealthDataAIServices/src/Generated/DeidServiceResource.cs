...
namespace Azure.ResourceManager.HealthDataAIServices
{
    ...
    public partial class DeidServiceResource : ArmResource
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="HealthDataAIServicesPrivateLinkResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<HealthDataAIServicesPrivateLinkResource> GetPrivateLinksAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => HealthDataAIServicesPrivateLinkResource.DeserializeHealthDataAIServicesPrivateLinkResource(e), _privateLinksClientDiagnostics, Pipeline, "DeidServiceResource.GetPrivateLinks", "value", "nextLink", cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="HealthDataAIServicesPrivateLinkResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<HealthDataAIServicesPrivateLinkResource> GetPrivateLinks(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _privateLinksRestClient.CreateListByDeidServiceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _privateLinksRestClient.CreateListByDeidServiceNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => HealthDataAIServicesPrivateLinkResource.DeserializeHealthDataAIServicesPrivateLinkResource(e), _privateLinksClientDiagnostics, Pipeline, "DeidServiceResource.GetPrivateLinks", "value", "nextLink", cancellationToken);
        }
