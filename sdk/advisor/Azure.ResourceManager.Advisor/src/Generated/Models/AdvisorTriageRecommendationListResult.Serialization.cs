...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    internal partial class AdvisorTriageRecommendationListResult : IJsonModel<AdvisorTriageRecommendationListResult>
    {
        /// <summary> Initializes a new instance of <see cref="AdvisorTriageRecommendationListResult"/> for deserialization. </summary>
        internal AdvisorTriageRecommendationListResult()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<AdvisorTriageRecommendationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvisorTriageRecommendationListResult)} does not support writing '{format}' format.");
            }
            writer.WritePropertyName("value"u8);
            writer.WriteStartArray();
            foreach (AdvisorTriageRecommendationData item in Value)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AdvisorTriageRecommendationListResult IJsonModel<AdvisorTriageRecommendationListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AdvisorTriageRecommendationListResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AdvisorTriageRecommendationListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvisorTriageRecommendationListResult)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AdvisorTriageRecommendationListResult DeserializeAdvisorTriageRecommendationListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            IList<AdvisorTriageRecommendationData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<AdvisorTriageRecommendationData> array = new List<AdvisorTriageRecommendationData>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(AdvisorTriageRecommendationData.DeserializeAdvisorTriageRecommendationData(item, options));
                    }
                    value = array;
                    continue;
                }
