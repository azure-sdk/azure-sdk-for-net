...
namespace Azure.ResourceManager.VoiceServices.Models
{
    ...
    public static partial class ArmVoiceServicesModelFactory
    {
        ...
        public static VoiceServicesCommunicationsGatewayData VoiceServicesCommunicationsGatewayData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, VoiceServicesProvisioningState? provisioningState = null, VoiceServicesCommunicationsGatewayStatus? status = null, IEnumerable<VoiceServicesServiceRegionProperties> serviceLocations = null, VoiceServicesCommunicationsGatewayConnectivity? connectivity = null, IEnumerable<VoiceServicesTeamsCodec> codecs = null, VoiceServicesEmergencyCallType? e911Type = null, IEnumerable<VoiceServicesCommunicationsPlatform> platforms = null, BinaryData apiBridge = null, VoiceServicesAutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = null, string autoGeneratedDomainNameLabel = null, string teamsVoicemailPilotNumber = null, bool? isOnPremMcpEnabled = null, bool? integratedMcpEnabled = null, IEnumerable<string> emergencyDialStrings = null)
        {
            ...
            return new VoiceServicesCommunicationsGatewayData(id, name, resourceType, systemData, tags, location, identity, provisioningState, status, serviceLocations?.ToList(), connectivity, codecs?.ToList(), e911Type, platforms?.ToList(), apiBridge, autoGeneratedDomainNameLabelScope, autoGeneratedDomainNameLabel, teamsVoicemailPilotNumber, isOnPremMcpEnabled, integratedMcpEnabled, emergencyDialStrings?.ToList());
        }
