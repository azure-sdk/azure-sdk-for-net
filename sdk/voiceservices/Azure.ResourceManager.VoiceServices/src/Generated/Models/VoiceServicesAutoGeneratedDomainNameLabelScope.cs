...
namespace Azure.ResourceManager.VoiceServices.Models
{
    ...
    public readonly partial struct VoiceServicesAutoGeneratedDomainNameLabelScope : IEquatable<VoiceServicesAutoGeneratedDomainNameLabelScope>
    {
        ...
        /// <summary> Generated domain name label depends on resource name and tenant ID. </summary>
        ...
        /// <summary> Generated domain name label depends on resource name, tenant ID and subscription ID. </summary>
        ...
        /// <summary> Generated domain name label depends on resource name, tenant ID, subscription ID and resource group name. </summary>
        ...
        /// <summary> Generated domain name label is always unique. </summary>
