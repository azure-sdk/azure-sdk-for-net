...
namespace Azure.ResourceManager.VoiceServices.Models
{
    ...
    public partial class VoiceServicesSku
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceServicesSku"/>. </summary>
        /// <param name="name"> The name of the SKU. Ex - P3. It is typically a letter+number code. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public VoiceServicesSku(string name)
        {
        ...
        internal VoiceServicesSku(string name, VoiceServicesSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceServicesSku"/> for deserialization. </summary>
        internal VoiceServicesSku()
        {
        }
        ...
        public VoiceServicesSkuTier? Tier { get; set; }
