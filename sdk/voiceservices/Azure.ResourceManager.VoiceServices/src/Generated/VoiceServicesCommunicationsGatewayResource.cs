...
{
    /// <summary>
    /// A Class representing a VoiceServicesCommunicationsGateway along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="VoiceServicesCommunicationsGatewayResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetVoiceServicesCommunicationsGatewayResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetVoiceServicesCommunicationsGateway method.
    /// </summary>
    public partial class VoiceServicesCommunicationsGatewayResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="VoiceServicesCommunicationsGatewayResource"/> class for mocking. </summary>
        protected VoiceServicesCommunicationsGatewayResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VoiceServicesCommunicationsGatewayResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal VoiceServicesCommunicationsGatewayResource(ArmClient client, VoiceServicesCommunicationsGatewayData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal VoiceServicesCommunicationsGatewayResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual VoiceServicesCommunicationsGatewayData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<VoiceServicesCommunicationsGatewayResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _voiceServicesCommunicationsGatewayCommunicationsGatewaysClientDiagnostics.CreateScope("VoiceServicesCommunicationsGatewayResource.Get");
            scope.Start();
            try
            {
                var response = await _voiceServicesCommunicationsGatewayCommunicationsGatewaysRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<VoiceServicesCommunicationsGatewayResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _voiceServicesCommunicationsGatewayCommunicationsGatewaysClientDiagnostics.CreateScope("VoiceServicesCommunicationsGatewayResource.Get");
            scope.Start();
            try
            {
                var response = _voiceServicesCommunicationsGatewayCommunicationsGatewaysRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new VoiceServicesCommunicationsGatewayResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _voiceServicesCommunicationsGatewayCommunicationsGatewaysClientDiagnostics.CreateScope("VoiceServicesCommunicationsGatewayResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<VoiceServicesCommunicationsGatewayResource>> UpdateAsync(VoiceServicesCommunicationsGatewayPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _voiceServicesCommunicationsGatewayCommunicationsGatewaysRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new VoiceServicesCommunicationsGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<VoiceServicesCommunicationsGatewayResource> Update(VoiceServicesCommunicationsGatewayPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _voiceServicesCommunicationsGatewayCommunicationsGatewaysRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Response.FromValue(new VoiceServicesCommunicationsGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<VoiceServicesCommunicationsGatewayResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _voiceServicesCommunicationsGatewayCommunicationsGatewaysRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new VoiceServicesCommunicationsGatewayResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual Response<VoiceServicesCommunicationsGatewayResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _voiceServicesCommunicationsGatewayCommunicationsGatewaysRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new VoiceServicesCommunicationsGatewayResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
