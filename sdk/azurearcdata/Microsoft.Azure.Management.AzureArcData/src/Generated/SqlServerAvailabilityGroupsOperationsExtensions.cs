...
namespace Microsoft.Azure.Management.AzureArcData
{
    ...
    public static partial class SqlServerAvailabilityGroupsOperationsExtensions
    {
            ...
            /// Name of SQL Availability Group
            /// </param>
            public static void Delete(this ISqlServerAvailabilityGroupsOperations operations, string resourceGroupName, string sqlServerInstanceName, string availabilityGroupName)
            {
                operations.DeleteAsync(resourceGroupName, sqlServerInstanceName, availabilityGroupName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this ISqlServerAvailabilityGroupsOperations operations, string resourceGroupName, string sqlServerInstanceName, string availabilityGroupName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DeleteWithHttpMessagesAsync(resourceGroupName, sqlServerInstanceName, availabilityGroupName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
