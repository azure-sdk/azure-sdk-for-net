...
namespace Microsoft.Azure.Management.AzureArcData
{
    ...
    public partial interface ISqlServerInstancesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<SqlServerInstance>> UpdateWithHttpMessagesAsync(string resourceGroupName, string sqlServerInstanceName, SqlServerInstanceUpdate parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
