...
namespace Microsoft.Azure.Management.AzureArcData
{
    ...
    public partial interface ISqlServerInstancesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<SqlServerInstanceTelemetryColumn>,SqlServerInstancesGetTelemetryHeaders>> PostInstanceTelemetryWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieves SQL Server instance telemetry
        /// </summary>
        /// <param name='nextPageLink'>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<SqlServerInstanceTelemetryColumn>,SqlServerInstancesGetTelemetryHeaders>> PostInstanceTelemetry1WithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
