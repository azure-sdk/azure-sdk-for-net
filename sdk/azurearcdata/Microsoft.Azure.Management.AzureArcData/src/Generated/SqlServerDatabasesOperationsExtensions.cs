...
namespace Microsoft.Azure.Management.AzureArcData
{
    ...
    public static partial class SqlServerDatabasesOperationsExtensions
    {
            ...
            /// Name of the database
            /// </param>
            public static SqlServerDatabasesDeleteHeaders Delete(this ISqlServerDatabasesOperations operations, string resourceGroupName, string sqlServerInstanceName, string databaseName)
            {
                return operations.DeleteAsync(resourceGroupName, sqlServerInstanceName, databaseName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SqlServerDatabasesDeleteHeaders> DeleteAsync(this ISqlServerDatabasesOperations operations, string resourceGroupName, string sqlServerInstanceName, string databaseName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DeleteWithHttpMessagesAsync(resourceGroupName, sqlServerInstanceName, databaseName, null, cancellationToken).ConfigureAwait(false))
                {
            ...
            /// Name of the database
            /// </param>
            public static SqlServerDatabasesDeleteHeaders BeginDelete(this ISqlServerDatabasesOperations operations, string resourceGroupName, string sqlServerInstanceName, string databaseName)
            {
                return operations.BeginDeleteAsync(resourceGroupName, sqlServerInstanceName, databaseName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SqlServerDatabasesDeleteHeaders> BeginDeleteAsync(this ISqlServerDatabasesOperations operations, string resourceGroupName, string sqlServerInstanceName, string databaseName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, sqlServerInstanceName, databaseName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Headers;
                }
            }
            ...
            /// The requested database resource state.
            /// </param>
            public static SqlServerDatabaseResource BeginUpdate(this ISqlServerDatabasesOperations operations, string resourceGroupName, string sqlServerInstanceName, string databaseName, SqlServerDatabaseUpdate sqlServerDatabaseUpdate)
            {
                return operations.BeginUpdateAsync(resourceGroupName, sqlServerInstanceName, databaseName, sqlServerDatabaseUpdate).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SqlServerDatabaseResource> BeginUpdateAsync(this ISqlServerDatabasesOperations operations, string resourceGroupName, string sqlServerInstanceName, string databaseName, SqlServerDatabaseUpdate sqlServerDatabaseUpdate, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginUpdateWithHttpMessagesAsync(resourceGroupName, sqlServerInstanceName, databaseName, sqlServerDatabaseUpdate, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
