...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class AvailabilityGroupConfigure
    {
        ...
        /// <summary>
        /// Gets or sets the Availability Synchronization mode of the
        /// availability group replica.
        /// </summary>
        [JsonProperty(PropertyName = "availabilityModeDescription")]
        public string AvailabilityModeDescription { get; set; }

        /// <summary>
        /// Gets or sets the failover mode of the availability group replica.
        /// </summary>
        [JsonProperty(PropertyName = "failoverModeDescription")]
        public string FailoverModeDescription { get; set; }
        ...
        /// <summary>
        /// Gets or sets whether the availability allows all connections or
        /// only read-write connections.
        /// </summary>
        [JsonProperty(PropertyName = "primaryRoleAllowConnectionsDescription")]
        public string PrimaryRoleAllowConnectionsDescription { get; set; }

        /// <summary>
        /// Gets or sets whether an availability replica that is performing the
        ...
        public string SeedingModeDescription { get; set; }
