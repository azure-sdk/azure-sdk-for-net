...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class FailoverCluster
    {
        ...
        public FailoverCluster(string id, string networkName, IList<string> sqlInstanceIds = default(IList<string>), IList<string> hostNames = default(IList<string>))
        {
            Id = id;
        ...
        /// <summary>
        /// Gets or sets the GUID of the SQL Server's underlying Failover
        /// Cluster.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the network name to connect to the SQL FCI.
        /// </summary>
        [JsonProperty(PropertyName = "networkName")]
        public string NetworkName { get; set; }

        /// <summary>
        /// Gets or sets the ARM IDs of the Arc SQL Server resources, belonging
        /// to the current server's Failover cluster.
        /// </summary>
        [JsonProperty(PropertyName = "sqlInstanceIds")]
        public IList<string> SqlInstanceIds { get; set; }

        /// <summary>
        /// Gets or sets the host names which are part of the SQL FCI resource
        /// group.
        /// </summary>
