...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class SqlServerInstanceUpdate
    {
        ...
        public SqlServerInstanceUpdate(IDictionary<string, string> tags = default(IDictionary<string, string>), SqlServerInstanceUpdateProperties properties = default(SqlServerInstanceUpdateProperties))
        {
            Tags = tags;
        ...
        public SqlServerInstanceUpdateProperties Properties { get; set; }
