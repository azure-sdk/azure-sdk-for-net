...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestRunClientGetMetricsCollectionResultOfT : Pageable<TimeSeriesElement>
    {
        ...
        public LoadTestRunClientGetMetricsCollectionResultOfT(LoadTestRunClient client, string testRunId, string metricname, string metricNamespace, string timespan, RequestContent content, string aggregation, string interval, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
