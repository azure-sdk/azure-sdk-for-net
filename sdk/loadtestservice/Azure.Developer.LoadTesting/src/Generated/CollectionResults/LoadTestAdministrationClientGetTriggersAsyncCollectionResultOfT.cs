...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestAdministrationClientGetTriggersAsyncCollectionResultOfT : AsyncPageable<LoadTestingTrigger>
    {
        ...
        public LoadTestAdministrationClientGetTriggersAsyncCollectionResultOfT(LoadTestAdministrationClient client, string testIds, string states, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _testIds = testIds;
            _states = states;
