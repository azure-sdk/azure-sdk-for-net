...
{
    internal partial class LoadTestAdministrationClientGetNotificationRulesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Gets the pages of LoadTestAdministrationClientGetNotificationRulesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LoadTestAdministrationClientGetNotificationRulesAsyncCollectionResult as an enumerable collection. </returns>
