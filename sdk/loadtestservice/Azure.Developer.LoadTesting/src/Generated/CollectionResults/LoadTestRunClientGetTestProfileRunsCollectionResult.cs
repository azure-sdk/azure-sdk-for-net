...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestRunClientGetTestProfileRunsCollectionResult : Pageable<BinaryData>
    {
        ...
        public LoadTestRunClientGetTestProfileRunsCollectionResult(LoadTestRunClient client, int? maxpagesize, DateTimeOffset? minStartDateTime, DateTimeOffset? maxStartDateTime, DateTimeOffset? minEndDateTime, DateTimeOffset? maxEndDateTime, DateTimeOffset? createdDateStartTime, DateTimeOffset? createdDateEndTime, IEnumerable<string> testProfileRunIds, IEnumerable<string> testProfileIds, IEnumerable<string> statuses, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
