...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestAdministrationClientGetTriggersCollectionResultOfT : Pageable<LoadTestingTrigger>
    {
        ...
        public LoadTestAdministrationClientGetTriggersCollectionResultOfT(LoadTestAdministrationClient client, string testIds, string states, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _testIds = testIds;
            _states = states;
        ...
        /// <summary> Gets the pages of LoadTestAdministrationClientGetTriggersCollectionResultOfT as an enumerable collection. </summary>
