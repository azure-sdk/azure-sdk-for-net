...
{
    internal partial class LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResult(LoadTestRunClient client, string testRunId, string name, string metricname, string metricNamespace, string timespan, string interval, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResult as an enumerable collection. </returns>
