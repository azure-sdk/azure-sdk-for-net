...
{
    internal partial class LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT : AsyncPageable<string>
    {
        ...
        /// <summary> Initializes a new instance of LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT(LoadTestRunClient client, string testRunId, string name, string metricname, string metricNamespace, string timespan, string interval, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT as an enumerable collection. </summary>
