...
{
    internal partial class LoadTestAdministrationClientGetTestsAsyncCollectionResultOfT : AsyncPageable<LoadTest>
    {
        ...
        public LoadTestAdministrationClientGetTestsAsyncCollectionResultOfT(LoadTestAdministrationClient client, string @orderby, string search, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
        ...
        /// <returns> The pages of LoadTestAdministrationClientGetTestsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<LoadTest>> AsPages(string continuationToken, int? pageSizeHint)
        {
