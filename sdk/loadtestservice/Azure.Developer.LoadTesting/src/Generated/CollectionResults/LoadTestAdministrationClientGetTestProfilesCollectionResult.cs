...
{
    internal partial class LoadTestAdministrationClientGetTestProfilesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Gets the pages of LoadTestAdministrationClientGetTestProfilesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LoadTestAdministrationClientGetTestProfilesCollectionResult as an enumerable collection. </returns>
