...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestRunClientGetMetricDimensionValuesCollectionResultOfT : Pageable<string>
    {
        ...
        public LoadTestRunClientGetMetricDimensionValuesCollectionResultOfT(LoadTestRunClient client, string testRunId, string name, string metricname, string metricNamespace, string timespan, string interval, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
