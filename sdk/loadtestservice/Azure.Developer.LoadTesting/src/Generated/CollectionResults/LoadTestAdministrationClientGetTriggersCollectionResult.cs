...
{
    internal partial class LoadTestAdministrationClientGetTriggersCollectionResult : Pageable<BinaryData>
    {
        ...
        public LoadTestAdministrationClientGetTriggersCollectionResult(LoadTestAdministrationClient client, string testIds, string states, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _testIds = testIds;
            _states = states;
        ...
        /// <returns> The pages of LoadTestAdministrationClientGetTriggersCollectionResult as an enumerable collection. </returns>
