...
{
    internal partial class LoadTestAdministrationClientGetTestFilesCollectionResultOfT : Pageable<TestFileInfo>
    {
        ...
        /// <summary> Initializes a new instance of LoadTestAdministrationClientGetTestFilesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LoadTestAdministrationClientGetTestFilesCollectionResultOfT(LoadTestAdministrationClient client, string testId, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _testId = testId;
            _context = context;
        ...
        /// <summary> Gets the pages of LoadTestAdministrationClientGetTestFilesCollectionResultOfT as an enumerable collection. </summary>
