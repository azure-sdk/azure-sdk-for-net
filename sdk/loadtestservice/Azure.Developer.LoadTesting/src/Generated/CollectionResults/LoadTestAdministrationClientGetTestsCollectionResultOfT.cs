...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestAdministrationClientGetTestsCollectionResultOfT : Pageable<LoadTest>
    {
        ...
        public LoadTestAdministrationClientGetTestsCollectionResultOfT(LoadTestAdministrationClient client, string @orderby, string search, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxPageSize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
