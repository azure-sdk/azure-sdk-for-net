...
{
    internal partial class LoadTestAdministrationClientGetNotificationRulesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of LoadTestAdministrationClientGetNotificationRulesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public LoadTestAdministrationClientGetNotificationRulesCollectionResult(LoadTestAdministrationClient client, string testIds, string scopes, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _testIds = testIds;
            _scopes = scopes;
        ...
        /// <summary> Gets the pages of LoadTestAdministrationClientGetNotificationRulesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LoadTestAdministrationClientGetNotificationRulesCollectionResult as an enumerable collection. </returns>
