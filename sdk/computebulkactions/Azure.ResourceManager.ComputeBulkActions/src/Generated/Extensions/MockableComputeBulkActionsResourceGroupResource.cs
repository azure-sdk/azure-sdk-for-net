...
namespace Azure.ResourceManager.ComputeBulkActions.Mocking
{
    ...
    public partial class MockableComputeBulkActionsResourceGroupResource : ArmResource
    {
        ...
        public virtual AsyncPageable<VirtualMachine> GetVirtualMachinesAsync(AzureLocation location, string name, string filter = default, string skiptoken = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <returns> A collection of <see cref="VirtualMachine"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<VirtualMachine> GetVirtualMachines(AzureLocation location, string name, string filter = default, string skiptoken = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
