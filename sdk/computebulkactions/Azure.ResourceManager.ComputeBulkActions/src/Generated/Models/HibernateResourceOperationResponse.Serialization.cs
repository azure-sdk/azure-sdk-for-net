...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class HibernateResourceOperationResponse : IJsonModel<HibernateResourceOperationResponse>
    {
        ...
        protected virtual HibernateResourceOperationResponse PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        internal static HibernateResourceOperationResponse FromResponse(Response response)
        {
            ...
            return DeserializeHibernateResourceOperationResponse(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HibernateResourceOperationResponse IJsonModel<HibernateResourceOperationResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HibernateResourceOperationResponse JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HibernateResourceOperationResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HibernateResourceOperationResponse DeserializeHibernateResourceOperationResponse(JsonElement element, ModelReaderWriterOptions options)
        {
