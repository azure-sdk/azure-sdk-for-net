...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class PriorityProfile
    {
        ...
        internal PriorityProfile(VirtualMachineType? @type, float? maxPricePerVM, EvictionPolicy? evictionPolicy, AllocationStrategy? allocationStrategy, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
