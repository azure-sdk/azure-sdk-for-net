...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ExecuteDeallocateRequest
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ExecuteDeallocateRequest"/>. </summary>
        ...
        public ExecuteDeallocateRequest(ExecutionParameters executionParameters, string correlationid)
        {
        ...
        internal ExecuteDeallocateRequest(ExecutionParameters executionParameters, Resources resources, string correlationid, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExecutionParameters = executionParameters;
            Resources = resources;
            Correlationid = correlationid;
