...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class StartResourceOperationResponse
    {
        ...
        internal StartResourceOperationResponse(string description, string @type, AzureLocation location)
        {
        ...
        internal StartResourceOperationResponse(string description, string @type, AzureLocation location, IList<ResourceOperation> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Description = description;
            Type = @type;
            Location = location;
