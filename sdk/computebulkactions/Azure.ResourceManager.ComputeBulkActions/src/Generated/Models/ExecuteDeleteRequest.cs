...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ExecuteDeleteRequest
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ExecuteDeleteRequest"/>. </summary>
        ...
        public ExecuteDeleteRequest(ExecutionParameters executionParameters, string correlationid)
        {
        ...
        internal ExecuteDeleteRequest(ExecutionParameters executionParameters, Resources resources, string correlationid, bool? forceDeletion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExecutionParameters = executionParameters;
            Resources = resources;
            Correlationid = correlationid;
