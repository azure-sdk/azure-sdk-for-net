...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ManagedDiskParameters : SubResource
    {
        ...
        internal ManagedDiskParameters(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, StorageAccountTypes? storageAccountType, DiskEncryptionSetParameters diskEncryptionSet, VMDiskSecurityProfile securityProfile) : base(id, additionalBinaryDataProperties)
        {
