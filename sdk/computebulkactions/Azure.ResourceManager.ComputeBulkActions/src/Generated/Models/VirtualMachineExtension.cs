...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class VirtualMachineExtension
    {
        ...
        public VirtualMachineExtension(string name, VirtualMachineExtensionProperties properties)
        {
        ...
        internal VirtualMachineExtension(string name, VirtualMachineExtensionProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Properties = properties;
