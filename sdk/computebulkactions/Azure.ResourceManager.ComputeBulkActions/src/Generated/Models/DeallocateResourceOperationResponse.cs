...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class DeallocateResourceOperationResponse
    {
        ...
        internal DeallocateResourceOperationResponse(string description, string @type, AzureLocation location)
        {
        ...
        internal DeallocateResourceOperationResponse(string description, string @type, AzureLocation location, IList<ResourceOperation> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Description = description;
            Type = @type;
            Location = location;
