...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class HibernateResourceOperationResponse
    {
        ...
        internal HibernateResourceOperationResponse(string description, string @type, AzureLocation location)
        {
        ...
        internal HibernateResourceOperationResponse(string description, string @type, AzureLocation location, IList<ResourceOperation> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Description = description;
            Type = @type;
            Location = location;
