...
namespace Azure.ResourceManager.Qumulo.Models
{
    internal partial class FileSystemResourceListResult : IUtf8JsonSerializable, IJsonModel<FileSystemResourceListResult>
    {
        ...
        internal static FileSystemResourceListResult DeserializeFileSystemResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<Qumulo.QumuloFileSystemResourceData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<Qumulo.QumuloFileSystemResourceData> array = new List<Qumulo.QumuloFileSystemResourceData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(Qumulo.QumuloFileSystemResourceData.DeserializeQumuloFileSystemResourceData(item, options));
                    }
                    value = array;
                    continue;
                }
