...
namespace Azure.Developer.Playwright
{
    ...
    public partial class Workspace
    {
        ...
        internal Workspace(Guid id, ResourceIdentifier resourceId, string name, ResourceState state, Guid subscriptionId, SubscriptionState subscriptionState, Guid tenantId, string location, EnablementStatus? regionalAffinity, EnablementStatus? localAuth, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
