...
namespace Azure.Developer.Playwright
{
    ...
    public static partial class DeveloperPlaywrightModelFactory
    {
        ...
        public static Workspace Workspace(Guid id = default, ResourceIdentifier resourceId = null, string name = null, ResourceState state = default, Guid subscriptionId = default, SubscriptionState subscriptionState = default, Guid tenantId = default, string location = null, EnablementStatus? regionalAffinity = null, EnablementStatus? localAuth = null)
        {
