...
namespace Microsoft.Azure.Management.Analysis
{
    ...
    public partial interface IServersOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<AnalysisServicesServer>> GetDetaisWithHttpMessagesAsync(string resourceGroupName, string serverName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
