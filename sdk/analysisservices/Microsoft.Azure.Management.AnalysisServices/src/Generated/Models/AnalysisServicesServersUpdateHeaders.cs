...
namespace Microsoft.Azure.Management.Analysis.Models
{
    ...
    /// </summary>
    public partial class AnalysisServicesServersUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AnalysisServicesServersUpdateHeaders class.
        /// </summary>
        public AnalysisServicesServersUpdateHeaders()
        {
            CustomInit();
        }
        ...
        public AnalysisServicesServersUpdateHeaders(int? retryAfter = default(int?), string location = default(string))
        {
