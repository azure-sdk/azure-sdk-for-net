...
namespace Microsoft.Azure.Management.Analysis.Models
{
    ...
    public partial class ResourceModelWithAllowedPropertySetSku : Sku
    {
        ...
        /// <param name="tier">Possible values include: 'Development', 'Basic',
        /// 'Standard'</param>
        ...
        public ResourceModelWithAllowedPropertySetSku(string name, string tier = default(string), string size = default(string), string family = default(string), int? capacity = default(int?))
