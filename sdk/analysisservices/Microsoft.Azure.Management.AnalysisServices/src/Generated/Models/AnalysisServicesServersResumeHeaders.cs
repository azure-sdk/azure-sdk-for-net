...
namespace Microsoft.Azure.Management.Analysis.Models
{
    ...
    /// </summary>
    public partial class AnalysisServicesServersResumeHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AnalysisServicesServersResumeHeaders class.
        /// </summary>
        public AnalysisServicesServersResumeHeaders()
        {
            CustomInit();
        }
        ...
        public AnalysisServicesServersResumeHeaders(int? retryAfter = default(int?), string location = default(string))
        {
