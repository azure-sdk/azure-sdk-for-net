...
namespace Microsoft.Azure.Management.Analysis.Models
{
    ...
    /// </summary>
    public partial class AnalysisServicesServersDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AnalysisServicesServersDeleteHeaders class.
        /// </summary>
        public AnalysisServicesServersDeleteHeaders()
        {
            CustomInit();
        }
        ...
        public AnalysisServicesServersDeleteHeaders(int? retryAfter = default(int?), string location = default(string))
        {
