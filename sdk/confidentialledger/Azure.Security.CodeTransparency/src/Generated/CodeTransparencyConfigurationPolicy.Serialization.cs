...
{
    public partial class CodeTransparencyConfigurationPolicy : IUtf8JsonSerializable, IJsonModel<CodeTransparencyConfigurationPolicy>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CodeTransparencyConfigurationPolicy>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CodeTransparencyConfigurationPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CodeTransparencyConfigurationPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        CodeTransparencyConfigurationPolicy IJsonModel<CodeTransparencyConfigurationPolicy>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CodeTransparencyConfigurationPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        CodeTransparencyConfigurationPolicy IPersistableModel<CodeTransparencyConfigurationPolicy>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CodeTransparencyConfigurationPolicy>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<CodeTransparencyConfigurationPolicy>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
