...
namespace Azure.Security.CodeTransparency
{
    ...
    public partial class CodeTransparencyClient
    {
        ...
        public virtual async Task<Response<CreateEntryResult>> CreateEntryAsync(BinaryData body, CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue(CreateEntryResult.FromResponse(response), response);
        }
        ...
        public virtual Response<CreateEntryResult> CreateEntry(BinaryData body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <summary>
        /// [Protocol Method] Post an entry to be registered on the CodeTransparency instance.
        /// <list type="bullet">
        /// <item>
        /// <description>
