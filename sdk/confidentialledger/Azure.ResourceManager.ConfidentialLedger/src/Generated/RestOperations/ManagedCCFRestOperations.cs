...
namespace Azure.ResourceManager.ConfidentialLedger
{
    internal partial class ManagedCCFRestOperations
    {
        ...
        internal HttpMessage CreateBackupRequest(string subscriptionId, string resourceGroupName, string appName, ManagedCcfBackup managedCcf)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue<ManagedCcfBackup>(managedCcf, new ModelReaderWriterOptions("W"));
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateRestoreRequest(string subscriptionId, string resourceGroupName, string appName, ManagedCcfRestore managedCcf)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue<ManagedCcfRestore>(managedCcf, new ModelReaderWriterOptions("W"));
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
