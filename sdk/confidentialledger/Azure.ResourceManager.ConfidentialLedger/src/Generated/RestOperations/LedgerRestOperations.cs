...
namespace Azure.ResourceManager.ConfidentialLedger
{
    internal partial class LedgerRestOperations
    {
        ...
        public LedgerRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
            ...
            _apiVersion = apiVersion ?? "2024-03-11-preview";
        ...
        internal HttpMessage CreateBackupRequest(string subscriptionId, string resourceGroupName, string ledgerName, ConfidentialLedgerBackup confidentialLedger)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue<ConfidentialLedgerBackup>(confidentialLedger, new ModelReaderWriterOptions("W"));
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateRestoreRequest(string subscriptionId, string resourceGroupName, string ledgerName, ConfidentialLedgerRestore confidentialLedger)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue<ConfidentialLedgerRestore>(confidentialLedger, new ModelReaderWriterOptions("W"));
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
