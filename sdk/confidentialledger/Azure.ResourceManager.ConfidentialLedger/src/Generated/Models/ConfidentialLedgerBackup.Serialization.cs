...
namespace Azure.ResourceManager.ConfidentialLedger.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfidentialLedgerBackup>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ConfidentialLedgerBackup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConfidentialLedgerBackup)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ConfidentialLedgerBackup>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConfidentialLedgerBackup)} does not support '{options.Format}' format.");
            }
        }
