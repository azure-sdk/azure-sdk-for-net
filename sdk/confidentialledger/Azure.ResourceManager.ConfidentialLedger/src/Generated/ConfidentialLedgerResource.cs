...
namespace Azure.ResourceManager.ConfidentialLedger
{
    ...
    public partial class ConfidentialLedgerResource : ArmResource
    {
        ...
        /// <description>2024-03-11-preview</description>
        /// </item>
        /// <item>
        /// <term>Resource</term>
        ...
        public virtual async Task<ArmOperation<ConfidentialLedgerBackupResponse>> BackupAsync(WaitUntil waitUntil, ConfidentialLedgerBackup confidentialLedger, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ConfidentialLedgerArmOperation<ConfidentialLedgerBackupResponse>(new ConfidentialLedgerBackupResponseOperationSource(), _confidentialLedgerLedgerClientDiagnostics, Pipeline, _confidentialLedgerLedgerRestClient.CreateBackupRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, confidentialLedger).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="confidentialLedger"/> is null. </exception>
        public virtual ArmOperation<ConfidentialLedgerBackupResponse> Backup(WaitUntil waitUntil, ConfidentialLedgerBackup confidentialLedger, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(confidentialLedger, nameof(confidentialLedger));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="confidentialLedger"/> is null. </exception>
        public virtual async Task<ArmOperation<ConfidentialLedgerRestoreResponse>> RestoreAsync(WaitUntil waitUntil, ConfidentialLedgerRestore confidentialLedger, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(confidentialLedger, nameof(confidentialLedger));
            ...
            try
            {
                ...
                var operation = new ConfidentialLedgerArmOperation<ConfidentialLedgerRestoreResponse>(new ConfidentialLedgerRestoreResponseOperationSource(), _confidentialLedgerLedgerClientDiagnostics, Pipeline, _confidentialLedgerLedgerRestClient.CreateRestoreRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, confidentialLedger).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="confidentialLedger"/> is null. </exception>
        public virtual ArmOperation<ConfidentialLedgerRestoreResponse> Restore(WaitUntil waitUntil, ConfidentialLedgerRestore confidentialLedger, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(confidentialLedger, nameof(confidentialLedger));
