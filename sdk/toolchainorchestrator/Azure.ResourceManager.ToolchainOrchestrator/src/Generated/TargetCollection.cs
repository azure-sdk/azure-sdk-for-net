...
namespace Azure.ResourceManager.ToolchainOrchestrator
{
    ...
    public partial class TargetCollection : ArmCollection, IEnumerable<TargetResource>, IAsyncEnumerable<TargetResource>
    {
        ...
        {
            _targetClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ToolchainOrchestrator", TargetResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<TargetResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string targetName, TargetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ToolchainOrchestratorArmOperation<TargetResource>(new TargetOperationSource(Client), _targetClientDiagnostics, Pipeline, _targetRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, targetName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ToolchainOrchestrator/targets</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
