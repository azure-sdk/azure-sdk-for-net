...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class OpenAIPageableListOfThreadMessage
    {
        ...
        /// <param name="lastId"> The last ID represented in this list. </param>
        /// <param name="hasMore"> A value indicating whether there are additional values available not captured in this list. </param>
        internal OpenAIPageableListOfThreadMessage(OpenAIPageableListOfThreadMessageObject @object, IReadOnlyList<ThreadMessage> data, string firstId, string lastId, bool hasMore)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
