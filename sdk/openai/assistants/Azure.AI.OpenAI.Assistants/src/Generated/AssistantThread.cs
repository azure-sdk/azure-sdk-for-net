...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class AssistantThread
    {
        ...
        internal AssistantThread(string id, AssistantThreadObject @object, DateTimeOffset createdAt, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            CreatedAt = createdAt;
