...
namespace Azure.AI.OpenAI.Assistants
{
    public partial class RunStep : IUtf8JsonSerializable, IJsonModel<RunStep>
    {
        ...
        void IJsonModel<RunStep>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WritePropertyName("stepDetails"u8);
            ...
            if (CancelledAt != null)
            {
                writer.WritePropertyName("cancelledAt"u8);
                writer.WriteStringValue(CancelledAt.Value, "O");
            }
            else
            {
                writer.WriteNull("cancelledAt");
            }
            if (FailedAt != null)
            {
                writer.WritePropertyName("failedAt"u8);
                writer.WriteStringValue(FailedAt.Value, "O");
            }
            else
            {
                writer.WriteNull("failedAt");
            }
        ...
        internal static RunStep DeserializeRunStep(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("stepDetails"u8))
                {
                    stepDetails = RunStepDetails.DeserializeRunStepDetails(property.Value);
                    continue;
                }
                if (property.NameEquals("lastError"u8))
                {
                ...
                if (property.NameEquals("cancelledAt"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        cancelledAt = null;
                ...
                if (property.NameEquals("failedAt"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        failedAt = null;
