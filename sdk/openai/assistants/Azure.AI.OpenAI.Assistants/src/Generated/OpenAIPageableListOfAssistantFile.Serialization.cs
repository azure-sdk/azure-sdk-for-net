...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        internal static OpenAIPageableListOfAssistantFile DeserializeOpenAIPageableListOfAssistantFile(JsonElement element)
        {
            ...
            return new OpenAIPageableListOfAssistantFile(@object, data, firstId, lastId, hasMore);
        }
