...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalMessageTextFileCitationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<InternalMessageTextFileCitationDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalMessageTextFileCitationDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InternalMessageTextFileCitationDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalMessageTextFileCitationDetails)} does not support '{options.Format}' format.");
            }
        }
