...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        internal static OpenAIPageableListOfAssistant DeserializeOpenAIPageableListOfAssistant(JsonElement element)
        {
            ...
            return new OpenAIPageableListOfAssistant(@object, data, firstId, lastId, hasMore);
        }
