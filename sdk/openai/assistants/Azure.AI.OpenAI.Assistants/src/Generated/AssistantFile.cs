...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class AssistantFile
    {
        ...
        internal AssistantFile(string id, AssistantFileObject @object, DateTimeOffset createdAt, string assistantId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            CreatedAt = createdAt;
