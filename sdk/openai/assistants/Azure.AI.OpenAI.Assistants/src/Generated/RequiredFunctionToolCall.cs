...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class RequiredFunctionToolCall : RequiredToolCall
    {
        ...
        internal RequiredFunctionToolCall(string id, InternalFunctionToolCallDetails internalFunctionDefinition) : base(id)
        {
        ...
        /// <param name="internalFunctionDefinition"> Detailed information about the function to be executed by the tool that includes name and arguments. </param>
        internal RequiredFunctionToolCall(string type, string id, IDictionary<string, BinaryData> serializedAdditionalRawData, InternalFunctionToolCallDetails internalFunctionDefinition) : base(type, id, serializedAdditionalRawData)
        {
            InternalFunctionDefinition = internalFunctionDefinition;
        }
        ...
        public InternalFunctionToolCallDetails InternalFunctionDefinition { get; }
    }
}
