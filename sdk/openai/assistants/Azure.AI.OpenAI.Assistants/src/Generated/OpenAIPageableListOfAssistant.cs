...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class OpenAIPageableListOfAssistant
    {
        ...
        /// <param name="lastId"> The last ID represented in this list. </param>
        /// <param name="hasMore"> A value indicating whether there are additional values available not captured in this list. </param>
        internal OpenAIPageableListOfAssistant(OpenAIPageableListOfAssistantObject @object, IReadOnlyList<Assistant> data, string firstId, string lastId, bool hasMore)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
