...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        internal static OpenAIPageableListOfThreadMessage DeserializeOpenAIPageableListOfThreadMessage(JsonElement element)
        {
            ...
            return new OpenAIPageableListOfThreadMessage(@object, data, firstId, lastId, hasMore);
        }
