...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class MessageAttachment
    {
        ...
        public MessageAttachment(string fileId, IEnumerable<MessageAttachmentToolAssignment> tools)
        {
        ...
        internal MessageAttachment(string fileId, IList<MessageAttachmentToolAssignment> tools, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileId = fileId;
            Tools = tools;
        ...
        /// <summary> The tools to add to this file. </summary>
        public IList<MessageAttachmentToolAssignment> Tools { get; }
    }
}
