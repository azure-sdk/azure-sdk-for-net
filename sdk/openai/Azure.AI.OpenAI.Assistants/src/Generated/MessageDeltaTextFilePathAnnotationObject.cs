...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class MessageDeltaTextFilePathAnnotationObject : MessageDeltaTextAnnotation
    {
        ...
        internal MessageDeltaTextFilePathAnnotationObject(int index, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, MessageDeltaTextFilePathAnnotation filePath, int? startIndex, int? endIndex) : base(index, type, serializedAdditionalRawData)
        {
            FilePath = filePath;
