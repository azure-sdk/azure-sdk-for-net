...
{
    public partial class AssistantsApiResponseFormatText : IUtf8JsonSerializable, IJsonModel<AssistantsApiResponseFormatText>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantsApiResponseFormatText>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AssistantsApiResponseFormatText>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatText>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AssistantsApiResponseFormatText IJsonModel<AssistantsApiResponseFormatText>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatText>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AssistantsApiResponseFormatText>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatText>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AssistantsApiResponseFormatText IPersistableModel<AssistantsApiResponseFormatText>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatText>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AssistantsApiResponseFormatText>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
