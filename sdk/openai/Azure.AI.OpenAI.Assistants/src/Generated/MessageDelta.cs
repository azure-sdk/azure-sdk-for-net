...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class MessageDelta
    {
        ...
        internal MessageDelta(MessageRole role, IReadOnlyList<MessageDeltaContent> content, IReadOnlyList<string> fileIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Role = role;
            Content = content;
            FileIds = fileIds;
