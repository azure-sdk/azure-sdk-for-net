...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class VectorStoreOptions
    {
        ...
        internal VectorStoreOptions(IList<string> fileIds, string name, VectorStoreExpirationPolicy expiresAfter, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
            Name = name;
