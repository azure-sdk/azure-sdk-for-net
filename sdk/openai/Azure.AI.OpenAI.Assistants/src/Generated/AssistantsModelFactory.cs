...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public static partial class AssistantsModelFactory
    {
        ...
        /// The available derived classes include <see cref="BingSearchToolDefinition"/>, <see cref="CodeInterpreterToolDefinition"/>, <see cref="FileSearchToolDefinition"/> and <see cref="FunctionToolDefinition"/>.
        /// </param>
        ...
        public static CreateRunOptions CreateRunOptions(string assistantId = null, string overrideModelName = null, string overrideInstructions = null, string additionalInstructions = null, IEnumerable<ThreadMessage> additionalMessages = null, IEnumerable<ToolDefinition> overrideTools = null, bool? stream = null, float? temperature = null, float? topP = null, int? maxPromptTokens = null, int? maxCompletionTokens = null, TruncationObject truncationStrategy = null, BinaryData toolChoice = null, BinaryData responseFormat = null, bool? parallelToolCalls = null, IDictionary<string, string> metadata = null)
        {
        ...
        /// The available derived classes include <see cref="Assistants.RunStepBingSearchToolCall"/>, <see cref="Assistants.RunStepCodeInterpreterToolCall"/>, <see cref="Assistants.RunStepFileSearchToolCall"/> and <see cref="Assistants.RunStepFunctionToolCall"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.RunStepBingSearchToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="browser"> For now, this is always going to be an empty object. </param>
        /// <returns> A new <see cref="Assistants.RunStepBingSearchToolCall"/> instance for mocking. </returns>
        public static RunStepBingSearchToolCall RunStepBingSearchToolCall(string id = null, IReadOnlyDictionary<string, string> browser = null)
        {
            browser ??= new Dictionary<string, string>();

            return new RunStepBingSearchToolCall("browser", id, serializedAdditionalRawData: null, browser);
        }
        ...
        /// The available derived classes include <see cref="Assistants.MessageDeltaTextFileCitationAnnotationObject"/>, <see cref="Assistants.MessageDeltaTextFilePathAnnotationObject"/> and <see cref="Assistants.MessageDeltaTextUrlCitationAnnotation"/>.
        /// </param>
        ...
        public static MessageDeltaTextUrlCitationAnnotation MessageDeltaTextUrlCitationAnnotation(int index = default, MessageTextUrlCitationDetails urlCitation = null, int? startIndex = null, int? endIndex = null)
        {
        ...
        /// The available derived classes include <see cref="Assistants.RunStepDeltaBingSearchToolCall"/>, <see cref="Assistants.RunStepDeltaCodeInterpreterToolCall"/>, <see cref="Assistants.RunStepDeltaFileSearchToolCall"/> and <see cref="Assistants.RunStepDeltaFunctionToolCall"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.RunStepDeltaBingSearchToolCall"/>. </summary>
        /// <param name="index"> The index of the tool call detail in the run step's tool_calls array. </param>
        /// <param name="id"> The ID of the tool call, used when submitting outputs to the run. </param>
        /// <param name="browser"> For now, this is always going to be an empty object. </param>
        /// <returns> A new <see cref="Assistants.RunStepDeltaBingSearchToolCall"/> instance for mocking. </returns>
        public static RunStepDeltaBingSearchToolCall RunStepDeltaBingSearchToolCall(int index = default, string id = null, IReadOnlyDictionary<string, string> browser = null)
        {
            browser ??= new Dictionary<string, string>();

            return new RunStepDeltaBingSearchToolCall(index, id, "browser", serializedAdditionalRawData: null, browser);
        }
    }
}
