...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class CreateRunOptions
    {
        ...
        internal CreateRunOptions(string assistantId, string overrideModelName, string overrideInstructions, string additionalInstructions, IList<ToolDefinition> overrideTools, bool? stream, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AssistantId = assistantId;
