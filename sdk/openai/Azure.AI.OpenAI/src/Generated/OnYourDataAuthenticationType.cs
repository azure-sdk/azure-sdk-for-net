...
namespace Azure.AI.OpenAI
{
    ...
    internal readonly partial struct OnYourDataAuthenticationType : IEquatable<OnYourDataAuthenticationType>
    {
        ...
        /// <summary> Authentication via username and password. </summary>
        public static OnYourDataAuthenticationType UsernameAndPassword { get; } = new OnYourDataAuthenticationType(UsernameAndPasswordValue);
        ...
        public static bool operator !=(OnYourDataAuthenticationType left, OnYourDataAuthenticationType right) => !left.Equals(right);
        /// <summary> Converts a <see cref="string"/> to a <see cref="OnYourDataAuthenticationType"/>. </summary>
