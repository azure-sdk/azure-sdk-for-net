...
namespace Azure.AI.OpenAI
{
    ...
    {
        /// <summary> Initializes a new instance of AudioTranscriptionOptionsVerboseJson. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranscriptionOptionsVerboseJson(BinaryData file)
        {
        ...
        internal AudioTranscriptionOptionsVerboseJson(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, string language, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
