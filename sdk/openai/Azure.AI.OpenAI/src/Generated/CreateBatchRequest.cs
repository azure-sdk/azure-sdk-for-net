...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class CreateBatchRequest
    {
        ...
        internal CreateBatchRequest(string endpoint, string inputFileId, string completionWindow)
        {
        ...
        internal CreateBatchRequest(string endpoint, string inputFileId, string completionWindow, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Endpoint = endpoint;
            InputFileId = inputFileId;
            CompletionWindow = completionWindow;
