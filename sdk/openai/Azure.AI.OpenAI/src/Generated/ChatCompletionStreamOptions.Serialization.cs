...
{
    public partial class ChatCompletionStreamOptions : IUtf8JsonSerializable, IJsonModel<ChatCompletionStreamOptions>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionStreamOptions>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ChatCompletionStreamOptions FromResponse(Response response)
        {
