...
{
    /// <summary> The translation will be provided in SRT format (SubRip Text) in the form of plain/text. </summary>
    internal partial class AudioTranslationOptionsSrt
    {
        /// <summary> Initializes a new instance of AudioTranslationOptionsSrt. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranslationOptionsSrt(BinaryData file)
        {
        ...
        internal AudioTranslationOptionsSrt(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
