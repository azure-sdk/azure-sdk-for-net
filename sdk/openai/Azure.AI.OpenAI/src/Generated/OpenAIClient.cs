...
namespace Azure.AI.OpenAI
{
    ...
    public partial class OpenAIClient
    {
        ...
        /// <param name="limit"> The number of batches to retrieve. The default is 20. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual async Task<Response<OpenAI.Batch>> CreateBatchAsync(string endpoint, string inputFileId, string completionWindow, IReadOnlyDictionary<string, string> metadata = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(inputFileId, nameof(inputFileId));
            Argument.AssertNotNull(completionWindow, nameof(completionWindow));

            CreateBatchRequest createBatchRequest = new CreateBatchRequest(endpoint, inputFileId, completionWindow, metadata ?? new ChangeTrackingDictionary<string, string>(), null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await CreateBatchAsync(createBatchRequest.ToRequestContent(), context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/>, <paramref name="inputFileId"/> or <paramref name="completionWindow"/> is null. </exception>
        public virtual Response<OpenAI.Batch> CreateBatch(string endpoint, string inputFileId, string completionWindow, IReadOnlyDictionary<string, string> metadata = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(inputFileId, nameof(inputFileId));
            Argument.AssertNotNull(completionWindow, nameof(completionWindow));
            ...
            CreateBatchRequest createBatchRequest = new CreateBatchRequest(endpoint, inputFileId, completionWindow, metadata ?? new ChangeTrackingDictionary<string, string>(), null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = CreateBatch(createBatchRequest.ToRequestContent(), context);
            return Response.FromValue(OpenAI.Batch.FromResponse(response), response);
        }
