...
namespace Azure.AI.OpenAI
{
    ...
    public static partial class AzureOpenAIModelFactory
    {
        ...
        public static AzureChatExtensionDataSourceResponseCitation AzureChatExtensionDataSourceResponseCitation(string content = null, string title = null, string url = null, string filepath = null, AzureChatExtensionDataSourceResponseCitationMetadata metadata = null, string chunkId = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAI.AzureChatExtensionDataSourceResponseCitationMetadata"/>. </summary>
        /// <param name="chunking"> Additional information about chunking operations related to this citation. </param>
        /// <returns> A new <see cref="OpenAI.AzureChatExtensionDataSourceResponseCitationMetadata"/> instance for mocking. </returns>
        public static AzureChatExtensionDataSourceResponseCitationMetadata AzureChatExtensionDataSourceResponseCitationMetadata(string chunking = null)
        {
            return new AzureChatExtensionDataSourceResponseCitationMetadata(chunking, serializedAdditionalRawData: null);
        }
