...
namespace Azure.AI.OpenAI
{
    ...
    public static partial class AzureOpenAIModelFactory
    {
        ...
        /// <returns> A new <see cref="OpenAI.ImageOperationResponse"/> instance for mocking. </returns>
        public static ImageOperationResponse ImageOperationResponse(string id = null, long created = default, long? expires = null, ImageResponse result = null, State status = default, ResponseError error = null)
        {
            return new ImageOperationResponse(id, created, expires, result, status, error);
        }

        /// <summary> Initializes a new instance of ImageResponse. </summary>
        /// <param name="created"> A timestamp when this job or item was created (in unix epochs). </param>
        /// <param name="data"> The images generated by the operator. </param>
        /// <returns> A new <see cref="OpenAI.ImageResponse"/> instance for mocking. </returns>
        public static ImageResponse ImageResponse(long created = default, IEnumerable<ImageLocation> data = null)
        {
            data ??= new List<ImageLocation>();

            return new ImageResponse(created, data?.ToList());
        }
        ...
        public static ImageLocation ImageLocation(Uri url = null, ResponseError error = null)
        {
            return new ImageLocation(url, error);
        }
    }
}
