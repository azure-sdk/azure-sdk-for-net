...
namespace Azure.AI.OpenAI
{
    ...
    public partial class AzureChatExtensionRetrievedDocument
    {
        ...
        internal AzureChatExtensionRetrievedDocument(string content, string title, string url, string filepath, string chunkId, IReadOnlyList<string> searchQueries, int dataSourceIndex, double? originalSearchScore, double? rerankScore, AzureChatExtensionRetrieveDocumentFilterReason? filterReason, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Content = content;
            Title = title;
            Url = url;
