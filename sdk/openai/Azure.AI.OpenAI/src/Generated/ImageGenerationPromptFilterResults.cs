...
{
    /// <summary> Describes the content filtering results for the prompt of a image generation request. </summary>
    public partial class ImageGenerationPromptFilterResults
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ImageGenerationPromptFilterResults"/>. </summary>
        ...
        internal ImageGenerationPromptFilterResults(ContentFilterResult sexual, ContentFilterResult violence, ContentFilterResult hate, ContentFilterResult selfHarm, ContentFilterDetectionResult profanity, ContentFilterDetectionResult jailbreak, ContentFilterDetailedResults customBlocklists, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sexual = sexual;
            Violence = violence;
            Hate = hate;
        ...
        /// <summary> Information about customer block lists and if something was detected the associated list ID. </summary>
