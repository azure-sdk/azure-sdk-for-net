...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatRequestSystemMessage : ChatRequestMessage
    {
        ...
        internal ChatRequestSystemMessage(ChatRole role, IDictionary<string, BinaryData> serializedAdditionalRawData, BinaryData content, string name) : base(role, serializedAdditionalRawData)
        {
            Content = content;
            Name = name;
        }
