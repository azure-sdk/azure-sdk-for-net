...
namespace Azure.AI.OpenAI
{
    public partial class PredictionContent : IUtf8JsonSerializable, IJsonModel<PredictionContent>
    {
        ...
        internal static PredictionContent DeserializePredictionContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            PredictionContentType type = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    type = new PredictionContentType(property.Value.GetString());
                    continue;
                }
            ...
            return new PredictionContent(type, content, serializedAdditionalRawData);
        }
        ...
        internal static PredictionContent FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializePredictionContent(document.RootElement);
        }
