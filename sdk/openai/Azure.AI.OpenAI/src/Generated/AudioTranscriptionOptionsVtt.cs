...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class AudioTranscriptionOptionsVtt
    {
        /// <summary> Initializes a new instance of AudioTranscriptionOptionsVtt. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranscriptionOptionsVtt(BinaryData file)
        {
        ...
        internal AudioTranscriptionOptionsVtt(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, string language, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
