...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatExtensionsMessageContext>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static AzureChatExtensionsMessageContext DeserializeAzureChatExtensionsMessageContext(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<AzureChatExtensionRetrievedDocument> allRetrievedDocuments = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("all_retrieved_documents"u8))
                {
                    ...
                    List<AzureChatExtensionRetrievedDocument> array = new List<AzureChatExtensionRetrievedDocument>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(AzureChatExtensionRetrievedDocument.DeserializeAzureChatExtensionRetrievedDocument(item, options));
                    }
            ...
            return new AzureChatExtensionsMessageContext(citations ?? new ChangeTrackingList<AzureChatExtensionDataSourceResponseCitation>(), intent, allRetrievedDocuments ?? new ChangeTrackingList<AzureChatExtensionRetrievedDocument>(), serializedAdditionalRawData);
        }
