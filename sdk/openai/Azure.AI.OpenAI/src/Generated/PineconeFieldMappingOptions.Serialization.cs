...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PineconeFieldMappingOptions>)this).Write(writer, ModelSerializationExtensions.WireOptions);
