...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatChoice
    {
        ...
        internal ChatChoice(ChatResponseMessage message, ChatChoiceLogProbabilityInfo logProbabilityInfo, int index, CompletionsFinishReason? finishReason, ChatResponseMessage internalStreamingDeltaMessage, ContentFilterResultsForChoice contentFilterResults, AzureChatEnhancements enhancements, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
            LogProbabilityInfo = logProbabilityInfo;
            Index = index;
