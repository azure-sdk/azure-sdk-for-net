...
namespace Azure.AI.OpenAI
{
    ...
    public partial class MongoDBChatExtensionParameters
    {
        ...
        internal MongoDBChatExtensionParameters(OnYourDataAuthenticationOptions authentication, int? documentCount, bool? shouldRestrictResultScope, int? strictness, int? maxSearchQueries, bool? allowPartialResult, IList<OnYourDataContextProperty> includeContexts, string endpoint, string collectionName, string databaseName, string appName, string indexName, MongoDBChatExtensionParametersFieldsMapping fieldsMapping, BinaryData embeddingDependency, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
