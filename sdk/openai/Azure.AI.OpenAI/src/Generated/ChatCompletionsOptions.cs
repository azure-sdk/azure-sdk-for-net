...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatCompletionsOptions
    {
        ...
        /// The available derived classes include <see cref="ChatRequestAssistantMessage"/>, <see cref="ChatRequestDeveloperMessage"/>, <see cref="ChatRequestFunctionMessage"/>, <see cref="ChatRequestSystemMessage"/>, <see cref="ChatRequestToolMessage"/> and <see cref="ChatRequestUserMessage"/>.
        /// </param>
        ...
        /// </param>
        /// <param name="maxCompletionTokens"> An upper bound for the number of tokens that can be generated for a completion, including visible output tokens and reasoning tokens. </param>
        ...
        /// <param name="streamOptions"> Options for streaming response. Only set this when you set `stream: true`. </param>
        ...
        /// The available derived classes include <see cref="AzureCosmosDBChatExtensionConfiguration"/>, <see cref="AzureSearchChatExtensionConfiguration"/>, <see cref="ElasticsearchChatExtensionConfiguration"/>, <see cref="MongoDBChatExtensionConfiguration"/> and <see cref="PineconeChatExtensionConfiguration"/>.
        /// </param>
        ...
        /// The available derived classes include <see cref="ChatCompletionsJsonResponseFormat"/>, <see cref="ChatCompletionsJsonSchemaResponseFormat"/> and <see cref="ChatCompletionsTextResponseFormat"/>.
        /// </param>
        /// <param name="tools">
        ...
        /// <param name="store"> Whether or not to store the output of this chat completion request for use in our model distillation or evaluation products. </param>
        /// <param name="metadata"> Developer-defined tags and values used for filtering completions in the stored completions dashboard. </param>
        ...
        /// </param>
        /// <param name="userSecurityContext"> The security context identifies and authenticates users and applications in your multi-tenant AI system, helping security teams investigate and mitigate incidents. </param>
        ...
        /// <summary> An upper bound for the number of tokens that can be generated for a completion, including visible output tokens and reasoning tokens. </summary>
        ...
        /// <summary> Whether or not to store the output of this chat completion request for use in our model distillation or evaluation products. </summary>
        public bool? Store { get; set; }
        /// <summary> Developer-defined tags and values used for filtering completions in the stored completions dashboard. </summary>
        ...
        /// Currently supported values are `low`, `medium`, and `high`. Reducing reasoning effort can result in faster responses and fewer tokens used on reasoning in a response.
        /// </summary>
        public ReasoningEffortValue? ReasoningEffort { get; set; }
        /// <summary> The security context identifies and authenticates users and applications in your multi-tenant AI system, helping security teams investigate and mitigate incidents. </summary>
        public UserSecurityContext UserSecurityContext { get; set; }
        /// <summary>
        /// Output types that you would like the model to generate for this request.
        /// Most models are capable of generating text, which is the default: `["text"]`
        /// The `gpt-4o-audio-preview` model can also be used to generate audio. To
        ...
        /// use: `["text", "audio"]`
        /// </summary>
        public IList<ChatCompletionModality> Modalities { get; }
        /// <summary>
        /// Configuration for a Predicted Output, which can greatly improve response times
        /// when large parts of the model response are known ahead of time. This is most
        /// common when you are regenerating a file with only minor changes to most of the content.
        ...
        /// with `modalities: ["audio"]`
        /// </summary>
        public AudioOutputParameters Audio { get; set; }
    }
}
