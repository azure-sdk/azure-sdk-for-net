...
{
    /// <summary> This format will return an JSON structure containing an enriched structure with the translation. </summary>
    internal partial class AudioTranslationOptionsVerboseJson
    {
        /// <summary> Initializes a new instance of AudioTranslationOptionsVerboseJson. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranslationOptionsVerboseJson(BinaryData file)
        {
        ...
        internal AudioTranslationOptionsVerboseJson(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
