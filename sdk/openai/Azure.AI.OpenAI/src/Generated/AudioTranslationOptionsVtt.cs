...
{
    /// <summary> The translation will be provided in VTT format (Web Video Text Tracks) in the form of plain/text. </summary>
    internal partial class AudioTranslationOptionsVtt
    {
        /// <summary> Initializes a new instance of AudioTranslationOptionsVtt. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranslationOptionsVtt(BinaryData file)
        {
        ...
        internal AudioTranslationOptionsVtt(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
