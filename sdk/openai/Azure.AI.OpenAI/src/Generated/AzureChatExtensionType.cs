...
namespace Azure.AI.OpenAI
{
    ...
    internal readonly partial struct AzureChatExtensionType : IEquatable<AzureChatExtensionType>
    {
        ...
        /// <summary> Represents the use of a MongoDB chat extension. </summary>
        public static AzureChatExtensionType MongoDB { get; } = new AzureChatExtensionType(MongoDBValue);
        ...
        public static bool operator !=(AzureChatExtensionType left, AzureChatExtensionType right) => !left.Equals(right);
        /// <summary> Converts a <see cref="string"/> to a <see cref="AzureChatExtensionType"/>. </summary>
