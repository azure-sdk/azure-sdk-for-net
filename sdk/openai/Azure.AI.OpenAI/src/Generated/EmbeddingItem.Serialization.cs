...
{
    internal partial class EmbeddingItem : IUtf8JsonSerializable, IJsonModel<EmbeddingItem>
    {
        ...
        internal static EmbeddingItem DeserializeEmbeddingItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            int index = default;
            EmbeddingItemObject @object = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    @object = new EmbeddingItemObject(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new EmbeddingItem(embedding, index, @object, serializedAdditionalRawData);
        }
