...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class UploadFileRequest
    {
        ...
        internal UploadFileRequest(Stream data, FilePurpose purpose)
        {
        ...
        internal UploadFileRequest(Stream data, FilePurpose purpose, string filename, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Data = data;
            Purpose = purpose;
            Filename = filename;
