...
namespace Azure.AI.OpenAI
{
    ...
    public partial class AzureMachineLearningIndexChatExtensionParameters
    {
        ...
        internal AzureMachineLearningIndexChatExtensionParameters(OnYourDataAuthenticationOptions authentication, int? documentCount, bool? shouldRestrictResultScope, int? strictness, string roleInformation, int? maxSearchQueries, bool? allowPartialResult, IList<OnYourDataContextProperty> includeContexts, string projectResourceId, string name, string version, string filter, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
