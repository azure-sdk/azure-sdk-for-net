...
{
    public partial class ContentFilterDetectionResult : IUtf8JsonSerializable, IJsonModel<ContentFilterDetectionResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentFilterDetectionResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
