...
namespace Azure.AI.OpenAI
{
    ...
    public static partial class AIOpenAIModelFactory
    {
        ...
        public static CompletionsUsage CompletionsUsage(int completionTokens = default, int promptTokens = default, int totalTokens = default, CompletionsUsageCompletionTokensDetails completionTokensDetails = null)
        {
            return new CompletionsUsage(completionTokens, promptTokens, totalTokens, completionTokensDetails, serializedAdditionalRawData: null);
        }
        ...
        public static CompletionsUsageCompletionTokensDetails CompletionsUsageCompletionTokensDetails(int? reasoningTokens = null)
        {
            return new CompletionsUsageCompletionTokensDetails(reasoningTokens, serializedAdditionalRawData: null);
        }
