...
namespace Azure.AI.OpenAI
{
    ...
    public partial class Upload
    {
        ...
        internal Upload(string id, DateTimeOffset createdAt, string filename, long bytes, string purpose, UploadStatus status, DateTimeOffset expiresAt)
        {
        ...
        internal Upload(string id, DateTimeOffset createdAt, string filename, long bytes, string purpose, UploadStatus status, DateTimeOffset expiresAt, UploadObject? @object, OpenAIFile file, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            CreatedAt = createdAt;
            Filename = filename;
