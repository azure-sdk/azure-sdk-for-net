...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class EmbeddingItem
    {
        /// <summary>
        ...
        internal EmbeddingItem(IReadOnlyList<float> embedding, int index, EmbeddingItemObject @object, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Embedding = embedding;
            Index = index;
            Object = @object;
