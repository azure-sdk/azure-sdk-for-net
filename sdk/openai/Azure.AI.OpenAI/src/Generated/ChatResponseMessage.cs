...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatResponseMessage
    {
        ...
        internal ChatResponseMessage(ChatRole role, string refusal, string content, IReadOnlyList<ChatCompletionsToolCall> toolCalls, FunctionCall functionCall, AzureChatExtensionsMessageContext azureExtensionsContext, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Role = role;
            Refusal = refusal;
            Content = content;
