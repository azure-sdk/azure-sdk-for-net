...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatResponseMessage
    {
        ...
        internal ChatResponseMessage(ChatRole role, string refusal, string content)
        {
            Role = role;
            Refusal = refusal;
            Content = content;
        ...
        internal ChatResponseMessage(ChatRole role, string refusal, string content, IReadOnlyList<ChatCompletionsToolCall> toolCalls, FunctionCall functionCall, AudioResponseData audio, AzureChatExtensionsMessageContext azureExtensionsContext, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Role = role;
            Refusal = refusal;
            Content = content;
        ...
        /// about the audio response from the model.
        /// </summary>
        public AudioResponseData Audio { get; }
        /// <summary>
        /// If Azure OpenAI chat extensions are configured, this array represents the incremental steps performed by those
        /// extensions while processing the chat completions request.
        /// </summary>
