...
{
    /// <summary> A Datum containing information about a Batch Error. </summary>
    internal partial class BatchErrorDatum
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BatchErrorDatum"/>. </summary>
        internal BatchErrorDatum()
        {
        }
        ...
        internal BatchErrorDatum(string code, string message, string param, int? line, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Param = param;
