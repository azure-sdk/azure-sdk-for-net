...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ImageGenerationOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ImageGenerationOptions"/>. </summary>
        /// <param name="deploymentName"> The model name or Azure OpenAI model deployment name to use for image generation. </param>
        /// <param name="prompt"> A description of the desired images. </param>
        ...
        /// <summary> The model name or Azure OpenAI model deployment name to use for image generation. </summary>
