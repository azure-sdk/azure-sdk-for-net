...
namespace Azure.AI.OpenAI
{
    ...
    public partial class Completions
    {
        ...
        internal Completions(string id, DateTimeOffset created, IEnumerable<Choice> choices)
        {
        ...
        internal Completions(string id, DateTimeOffset created, IReadOnlyList<ContentFilterResultsForPrompt> promptFilterResults, IReadOnlyList<Choice> choices, CompletionsUsage usage, string systemFingerprint, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Created = created;
