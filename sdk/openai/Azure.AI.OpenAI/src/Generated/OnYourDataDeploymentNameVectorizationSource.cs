...
namespace Azure.AI.OpenAI
{
    ...
    public partial class OnYourDataDeploymentNameVectorizationSource : OnYourDataVectorizationSource
    {
        ...
        internal OnYourDataDeploymentNameVectorizationSource(OnYourDataVectorizationSourceType type, IDictionary<string, BinaryData> serializedAdditionalRawData, string deploymentName, int? dimensions) : base(type, serializedAdditionalRawData)
        {
            DeploymentName = deploymentName;
        ...
        /// <summary> The number of dimensions the embeddings should have. Only supported in `text-embedding-3` and later models. </summary>
