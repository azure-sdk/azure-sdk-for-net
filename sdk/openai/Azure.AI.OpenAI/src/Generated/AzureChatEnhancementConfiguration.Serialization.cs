...
{
    public partial class AzureChatEnhancementConfiguration : IUtf8JsonSerializable, IJsonModel<AzureChatEnhancementConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatEnhancementConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureChatEnhancementConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        AzureChatEnhancementConfiguration IJsonModel<AzureChatEnhancementConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureChatEnhancementConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AzureChatEnhancementConfiguration DeserializeAzureChatEnhancementConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        AzureChatEnhancementConfiguration IPersistableModel<AzureChatEnhancementConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureChatEnhancementConfiguration>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AzureChatEnhancementConfiguration>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static AzureChatEnhancementConfiguration FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeAzureChatEnhancementConfiguration(document.RootElement);
        }
