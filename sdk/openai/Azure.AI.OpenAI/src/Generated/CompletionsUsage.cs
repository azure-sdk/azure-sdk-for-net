...
namespace Azure.AI.OpenAI
{
    ...
    public partial class CompletionsUsage
    {
        ...
        internal CompletionsUsage(int completionTokens, int promptTokens, int totalTokens, CompletionsUsageCompletionTokensDetails completionTokensDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CompletionTokens = completionTokens;
            PromptTokens = promptTokens;
            TotalTokens = totalTokens;
