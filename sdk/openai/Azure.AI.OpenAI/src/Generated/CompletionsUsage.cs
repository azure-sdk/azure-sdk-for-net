...
namespace Azure.AI.OpenAI
{
    ...
    public partial class CompletionsUsage
    {
        ...
        internal CompletionsUsage(int completionTokens, int promptTokens, int totalTokens, CompletionsUsagePromptTokensDetails promptTokensDetails, CompletionsUsageCompletionTokensDetails completionTokensDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CompletionTokens = completionTokens;
            PromptTokens = promptTokens;
            TotalTokens = totalTokens;
        ...
        public CompletionsUsagePromptTokensDetails PromptTokensDetails { get; }
        /// <summary> Breakdown of tokens used in a completion. </summary>
        public CompletionsUsageCompletionTokensDetails CompletionTokensDetails { get; }
    }
}
