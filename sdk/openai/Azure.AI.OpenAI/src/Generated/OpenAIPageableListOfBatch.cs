...
namespace Azure.AI.OpenAI
{
    ...
    public partial class OpenAIPageableListOfBatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfBatch"/>. </summary>
        ...
        internal OpenAIPageableListOfBatch(IEnumerable<OpenAI.Batch> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal OpenAIPageableListOfBatch(OpenAIPageableListOfBatchObject @object, IReadOnlyList<OpenAI.Batch> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfBatch"/> for deserialization. </summary>
        internal OpenAIPageableListOfBatch()
        {
        }

        /// <summary> The object type, which is always list. </summary>
        public OpenAIPageableListOfBatchObject Object { get; } = OpenAIPageableListOfBatchObject.List;

        /// <summary> The requested list of items. </summary>
        public IReadOnlyList<OpenAI.Batch> Data { get; }
