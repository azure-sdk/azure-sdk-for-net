...
namespace Azure.ResourceManager.Resources.DeploymentStacks
{
    ...
    public partial class DeploymentStackResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, DeploymentStacksDeleteDetachEnum? unmanageActionResources = default, DeploymentStacksDeleteDetachEnum? unmanageActionResourceGroups = default, DeploymentStacksDeleteDetachEnum? unmanageActionManagementGroups = default, DeploymentStacksResourcesWithoutDeleteSupportEnum? unmanageActionResourcesWithoutDeleteSupport = default, bool? bypassStackOutOfSyncError = default, CancellationToken cancellationToken = default)
        {
