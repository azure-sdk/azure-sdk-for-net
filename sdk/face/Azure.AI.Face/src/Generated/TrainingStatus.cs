...
namespace Azure.AI.Face
{
    ...
    public partial class TrainingStatus
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TrainingStatus"/>. </summary>
        ...
        internal TrainingStatus(TrainingStatusType status, DateTimeOffset createdDateTime, DateTimeOffset lastActionDateTime, DateTimeOffset lastSuccessfulTrainingDateTime)
        {
            Status = status;
        ...
        internal TrainingStatus(TrainingStatusType status, DateTimeOffset createdDateTime, DateTimeOffset lastActionDateTime, DateTimeOffset lastSuccessfulTrainingDateTime, string message, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            CreatedDateTime = createdDateTime;
            LastActionDateTime = lastActionDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="TrainingStatus"/> for deserialization. </summary>
        internal TrainingStatus()
        {
        }

        /// <summary> Training status of the container. </summary>
        public TrainingStatusType Status { get; }
