...
namespace Azure.AI.Face
{
    ...
    public partial class GroupResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GroupResult"/>. </summary>
        ...
        internal GroupResult(IEnumerable<IList<string>> groups, IEnumerable<string> messyGroup)
        {
            if (groups == null)
            {
            ...
            if (messyGroup == null)
            {
                throw new ArgumentNullException(nameof(messyGroup));
            }
        ...
        internal GroupResult(IReadOnlyList<IList<string>> groups, IReadOnlyList<string> messyGroup, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Groups = groups;
        ...
        /// <summary> Initializes a new instance of <see cref="GroupResult"/> for deserialization. </summary>
