...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreatePersonResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CreatePersonResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreatePersonResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreatePersonResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreatePersonResult)} does not support '{options.Format}' format.");
            }
        }
