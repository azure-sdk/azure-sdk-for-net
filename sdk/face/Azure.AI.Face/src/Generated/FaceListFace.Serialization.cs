...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FaceListFace>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FaceListFace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FaceListFace)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FaceListFace>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FaceListFace)} does not support '{options.Format}' format.");
            }
        }
