...
namespace Azure.AI.Face
{
    ...
    public partial class FaceDetectionResult
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="faceId"/> is null. </exception>
        internal FaceDetectionResult(string faceId)
        {
            if (faceId == null)
            {
        ...
        internal FaceDetectionResult(string faceId, string recognitionModel, FaceRectangle faceRectangle, FaceLandmarks faceLandmarks, FaceAttributes faceAttributes, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceId = faceId;
        ...
        /// <summary> Unique faceId of the detected face, created by detection API and it will expire 24 hours after the detection call. </summary>
        ...
        /// <summary> Face attributes fore detected face. </summary>
