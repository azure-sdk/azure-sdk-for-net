...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LivenessSessionItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LivenessSessionItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LivenessSessionItem)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LivenessSessionItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LivenessSessionItem)} does not support '{options.Format}' format.");
            }
        }
