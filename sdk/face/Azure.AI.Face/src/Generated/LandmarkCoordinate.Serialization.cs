...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LandmarkCoordinate>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LandmarkCoordinate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LandmarkCoordinate)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LandmarkCoordinate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LandmarkCoordinate)} does not support '{options.Format}' format.");
            }
        }
