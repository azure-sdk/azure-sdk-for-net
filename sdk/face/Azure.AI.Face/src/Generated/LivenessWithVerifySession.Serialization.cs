...
namespace Azure.AI.Face
{
    public partial class LivenessWithVerifySession : IUtf8JsonSerializable, IJsonModel<LivenessWithVerifySession>
    {
        ...
        void IJsonModel<LivenessWithVerifySession>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LivenessWithVerifySession)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && SessionStartDateTime.HasValue)
            {
        ...
        internal static LivenessWithVerifySession DeserializeLivenessWithVerifySession(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            LivenessWithVerifySessionAuditEntry result = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("result"u8))
                {
                    ...
                    result = LivenessWithVerifySessionAuditEntry.DeserializeLivenessWithVerifySessionAuditEntry(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<LivenessWithVerifySession>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LivenessWithVerifySession)} does not support '{options.Format}' format.");
            }
        }
