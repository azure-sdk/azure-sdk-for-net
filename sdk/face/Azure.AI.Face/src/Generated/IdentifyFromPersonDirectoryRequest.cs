...
namespace Azure.AI.Face
{
    ...
    internal partial class IdentifyFromPersonDirectoryRequest
    {
        ...
        public IdentifyFromPersonDirectoryRequest(IEnumerable<string> faceIds, IEnumerable<string> personIds)
        {
            if (faceIds == null)
            {
        ...
        internal IdentifyFromPersonDirectoryRequest(IList<string> faceIds, IList<string> personIds, int? maxNumOfCandidatesReturned, float? confidenceThreshold, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceIds = faceIds;
            PersonIds = personIds;
        ...
        /// <summary> Array of personIds created in PersonDirectory - PersonCreate. The valid number of personIds is between [1,30]. </summary>
        public IList<string> PersonIds { get; }
