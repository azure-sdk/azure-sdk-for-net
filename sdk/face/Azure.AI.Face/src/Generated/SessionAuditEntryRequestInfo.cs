...
namespace Azure.AI.Face
{
    ...
    public partial class SessionAuditEntryRequestInfo
    {
        ...
        internal SessionAuditEntryRequestInfo(Uri url, string method, string contentType)
        {
            if (url == null)
            {
        ...
        internal SessionAuditEntryRequestInfo(Uri url, string method, long? contentLength, string contentType, string userAgent, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Url = url;
            Method = method;
