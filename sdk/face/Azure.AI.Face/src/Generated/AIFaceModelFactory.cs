...
namespace Azure.AI.Face
{
    ...
    public static partial class AIFaceModelFactory
    {
        ...
        /// <param name="faceId"> Unique faceId of the detected face, created by detection API and it will expire 24 hours after the detection call. </param>
        ...
        /// <param name="faceAttributes"> Face attributes fore detected face. </param>
        /// <returns> A new <see cref="Face.FaceDetectionResult"/> instance for mocking. </returns>
        public static FaceDetectionResult FaceDetectionResult(string faceId = null, string recognitionModel = null, FaceRectangle faceRectangle = null, FaceLandmarks faceLandmarks = null, FaceAttributes faceAttributes = null)
        {
        ...
        public static FaceAttributes FaceAttributes(int? age = null, float? smile = null, FacialHair facialHair = null, GlassesType? glasses = null, HeadPose headPose = null, HairProperties hair = null, OcclusionProperties occlusion = null, IEnumerable<AccessoryItem> accessories = null, BlurProperties blur = null, ExposureProperties exposure = null, NoiseProperties noise = null, MaskProperties mask = null, QualityForRecognition? qualityForRecognition = null)
        {
        ...
        /// <param name="type"> Mask type if any of the face. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Face.FindSimilarResult"/>. </summary>
        ...
        /// <returns> A new <see cref="Face.FindSimilarResult"/> instance for mocking. </returns>
        public static FindSimilarResult FindSimilarResult(float confidence = default, string faceId = null, string persistedFaceId = null)
        {
            return new FindSimilarResult(confidence, faceId, persistedFaceId, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Face.VerifyResult"/>. </summary>
        ...
        /// <returns> A new <see cref="Face.VerifyResult"/> instance for mocking. </returns>
        public static VerifyResult VerifyResult(bool isIdentical = default, float confidence = default)
        {
            return new VerifyResult(isIdentical, confidence, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Face.GroupResult"/>. </summary>
        ...
        /// <returns> A new <see cref="Face.GroupResult"/> instance for mocking. </returns>
        public static GroupResult GroupResult(IEnumerable<IList<string>> groups = null, IEnumerable<string> messyGroup = null)
        {
            groups ??= new List<IList<string>>();
            messyGroup ??= new List<string>();

            return new GroupResult(groups?.ToList(), messyGroup?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        public static FaceList FaceList(string name = null, string userData = null, RecognitionModel? recognitionModel = null, string faceListId = null, IEnumerable<FaceListFace> persistedFaces = null)
        {
        ...
        public static LargeFaceList LargeFaceList(string name = null, string userData = null, RecognitionModel? recognitionModel = null, string largeFaceListId = null)
        {
            return new LargeFaceList(name, userData, recognitionModel, largeFaceListId, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Face.TrainingStatus"/>. </summary>
        ...
        /// <returns> A new <see cref="Face.TrainingStatus"/> instance for mocking. </returns>
        public static TrainingStatus TrainingStatus(TrainingStatusType status = default, DateTimeOffset createdDateTime = default, DateTimeOffset lastActionDateTime = default, DateTimeOffset lastSuccessfulTrainingDateTime = default, string message = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Face.AsyncOperationStatus"/>. </summary>
        ...
        /// <returns> A new <see cref="Face.AsyncOperationStatus"/> instance for mocking. </returns>
        public static AsyncOperationStatus AsyncOperationStatus(OperationStatus status = default, DateTimeOffset createdDateTime = default, DateTimeOffset? finishedDateTime = null, string message = null)
        {
            return new AsyncOperationStatus(status, createdDateTime, finishedDateTime, message, serializedAdditionalRawData: null);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Face.IdentifyResult"/>. </summary>
        ...
        /// <returns> A new <see cref="Face.IdentifyResult"/> instance for mocking. </returns>
        public static IdentifyResult IdentifyResult(string faceId = null, IEnumerable<IdentifyCandidate> candidates = null)
        {
            candidates ??= new List<IdentifyCandidate>();

            return new IdentifyResult(faceId, candidates?.ToList(), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Face.IdentifyCandidate"/>. </summary>
        /// <param name="personId"> PersonId of the candidate. </param>
        /// <param name="confidence"> Confidence value of the candidate. The higher confidence, the more similar. Range between [0,1]. </param>
        /// <returns> A new <see cref="Face.IdentifyCandidate"/> instance for mocking. </returns>
        public static IdentifyCandidate IdentifyCandidate(string personId = null, float confidence = default)
        {
            return new IdentifyCandidate(personId, confidence, serializedAdditionalRawData: null);
        }
        ...
        public static DynamicPersonGroup DynamicPersonGroup(string dynamicPersonGroupId = null, string name = null, string userData = null, IEnumerable<string> addPersonIds = null)
        {
            addPersonIds ??= new List<string>();

            return new DynamicPersonGroup(dynamicPersonGroupId, name, userData, addPersonIds?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        public static PersonGroup PersonGroup(string name = null, string userData = null, RecognitionModel? recognitionModel = null, string personGroupId = null)
        {
        ...
        public static LargePersonGroup LargePersonGroup(string name = null, string userData = null, RecognitionModel? recognitionModel = null, string largePersonGroupId = null)
        {
        ...
        public static SessionAuditEntryRequestInfo SessionAuditEntryRequestInfo(Uri url = null, string method = null, long? contentLength = null, string contentType = null, string userAgent = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Face.LivenessWithVerifySessionAuditEntry"/>. </summary>
        /// <param name="id"> ID of this audit entry. </param>
        /// <param name="sessionId"> Session ID of this audit entry. </param>
        /// <param name="requestId"> Request ID in the request header. </param>
        /// <param name="clientRequestId"> Client request ID in the request header. </param>
