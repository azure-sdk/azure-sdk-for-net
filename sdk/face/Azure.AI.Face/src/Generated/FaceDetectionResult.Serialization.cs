...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FaceDetectionResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FaceDetectionResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FaceDetectionResult)} does not support '{format}' format.");
            }
        ...
        internal static FaceDetectionResult DeserializeFaceDetectionResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    recognitionModel = property.Value.GetString();
                    continue;
                }
        ...
        BinaryData IPersistableModel<FaceDetectionResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FaceDetectionResult)} does not support '{options.Format}' format.");
            }
        }
