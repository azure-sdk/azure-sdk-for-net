...
namespace Azure.AI.Face
{
    ...
    public partial class LargeFaceList
    {
        ...
        internal LargeFaceList(string name, string userData, RecognitionModel? recognitionModel, string largeFaceListId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
