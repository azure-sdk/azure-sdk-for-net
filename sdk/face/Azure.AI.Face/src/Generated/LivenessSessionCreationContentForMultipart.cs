...
namespace Azure.AI.Face
{
    ...
    public partial class LivenessSessionCreationContentForMultipart
    {
        /// <summary>
        ...
        internal LivenessSessionCreationContentForMultipart(string livenessOperationMode, bool? sendResultsToClient, bool? deviceCorrelationIdSetInClient, string deviceCorrelationId, int? authTokenTimeToLiveInSeconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LivenessOperationMode = livenessOperationMode;
