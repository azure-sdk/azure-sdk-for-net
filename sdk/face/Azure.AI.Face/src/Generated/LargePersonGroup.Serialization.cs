...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LargePersonGroup>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LargePersonGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LargePersonGroup)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LargePersonGroup>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LargePersonGroup)} does not support '{options.Format}' format.");
            }
        }
