...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectFromUrlRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DetectFromUrlRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DetectFromUrlRequest)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DetectFromUrlRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DetectFromUrlRequest)} does not support '{options.Format}' format.");
            }
        }
