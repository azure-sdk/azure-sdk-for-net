...
namespace Azure.AI.Face
{
    ...
    internal partial class IdentifyFromDynamicPersonGroupRequest
    {
        ...
        public IdentifyFromDynamicPersonGroupRequest(IEnumerable<string> faceIds, string dynamicPersonGroupId)
        {
            if (faceIds == null)
            {
        ...
        internal IdentifyFromDynamicPersonGroupRequest(IList<string> faceIds, string dynamicPersonGroupId, int? maxNumOfCandidatesReturned, float? confidenceThreshold, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceIds = faceIds;
            DynamicPersonGroupId = dynamicPersonGroupId;
        ...
        /// <summary> Id of the target PersonDirectory DynamicPersonGroup to match against. </summary>
