...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VerifyFromLargePersonGroupRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VerifyFromLargePersonGroupRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VerifyFromLargePersonGroupRequest)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VerifyFromLargePersonGroupRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VerifyFromLargePersonGroupRequest)} does not support '{options.Format}' format.");
            }
        }
