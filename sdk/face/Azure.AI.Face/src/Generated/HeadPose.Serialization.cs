...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HeadPose>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<HeadPose>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HeadPose)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HeadPose>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HeadPose)} does not support '{options.Format}' format.");
            }
        }
