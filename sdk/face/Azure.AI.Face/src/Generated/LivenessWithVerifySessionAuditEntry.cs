...
namespace Azure.AI.Face
{
    ...
    public partial class LivenessWithVerifySessionAuditEntry
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LivenessWithVerifySessionAuditEntry"/>. </summary>
        ...
        internal LivenessWithVerifySessionAuditEntry(string sessionId, string requestId, string clientRequestId, DateTimeOffset receivedDateTime, SessionAuditEntryRequestInfo request, SessionAuditEntryResponseInfo response, string digest)
        {
            if (sessionId == null)
            {
        ...
        internal LivenessWithVerifySessionAuditEntry(long id, string sessionId, string requestId, string clientRequestId, DateTimeOffset receivedDateTime, SessionAuditEntryRequestInfo request, SessionAuditEntryResponseInfo response, string digest, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            SessionId = sessionId;
            RequestId = requestId;
        ...
        /// <summary> Initializes a new instance of <see cref="LivenessWithVerifySessionAuditEntry"/> for deserialization. </summary>
