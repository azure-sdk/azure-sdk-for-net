...
namespace Azure.AI.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FacialHair>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FacialHair>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FacialHair)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FacialHair>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FacialHair)} does not support '{options.Format}' format.");
            }
        }
