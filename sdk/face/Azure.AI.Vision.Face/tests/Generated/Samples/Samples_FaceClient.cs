...
"73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a"
        ...
        public void Example_FaceClient_VerifyFromPersonDirectory_ShortVersion_Convenience()
        {
            ...
            Response<FaceVerificationResult> response = client.VerifyFromPersonDirectory(Guid.Parse("73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a"), "<personId>");
        }
        ...
        public async Task Example_FaceClient_VerifyFromPersonDirectory_ShortVersion_Convenience_Async()
        {
            ...
            Response<FaceVerificationResult> response = await client.VerifyFromPersonDirectoryAsync(Guid.Parse("73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a"), "<personId>");
        }
