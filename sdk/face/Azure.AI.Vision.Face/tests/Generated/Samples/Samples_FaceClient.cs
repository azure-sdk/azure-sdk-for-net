...
"c5c24a82-6845-4031-9d5d-978df9175426"
        ...
        public void Example_FaceClient_IdentifyFromPersonGroup_IdentifyFromPersonGroup_Convenience()
        {
            ...
            Response<IReadOnlyList<IdentificationResult>> response = client.IdentifyFromPersonGroup(new Guid[] { Guid.Parse("c5c24a82-6845-4031-9d5d-978df9175426") }, "your_person_group_id");
        }
        ...
        public async Task Example_FaceClient_IdentifyFromPersonGroup_IdentifyFromPersonGroup_Convenience_Async()
        {
            ...
            Response<IReadOnlyList<IdentificationResult>> response = await client.IdentifyFromPersonGroupAsync(new Guid[] { Guid.Parse("c5c24a82-6845-4031-9d5d-978df9175426") }, "your_person_group_id");
        }
...
"c5c24a82-6845-4031-9d5d-978df9175426"
        ...
        public void Example_FaceClient_IdentifyFromLargePersonGroup_IdentifyFromLargePersonGroup_Convenience()
        {
            ...
            Response<IReadOnlyList<IdentificationResult>> response = client.IdentifyFromLargePersonGroup(new Guid[] { Guid.Parse("c5c24a82-6845-4031-9d5d-978df9175426") }, "your_large_person_group_id");
        }
        ...
        public async Task Example_FaceClient_IdentifyFromLargePersonGroup_IdentifyFromLargePersonGroup_Convenience_Async()
        {
            ...
            Response<IReadOnlyList<IdentificationResult>> response = await client.IdentifyFromLargePersonGroupAsync(new Guid[] { Guid.Parse("c5c24a82-6845-4031-9d5d-978df9175426") }, "your_large_person_group_id");
        }
