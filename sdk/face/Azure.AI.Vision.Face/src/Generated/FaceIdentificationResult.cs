...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceIdentificationResult
    {
        ...
        internal FaceIdentificationResult(string faceId, IEnumerable<FaceIdentificationCandidate> candidates)
        {
        ...
        internal FaceIdentificationResult(string faceId, IReadOnlyList<FaceIdentificationCandidate> candidates, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceId = faceId;
