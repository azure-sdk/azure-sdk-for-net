...
namespace Azure.AI.Vision.Face
{
    ...
    internal partial class VerifyFromPersonDirectoryRequest
    {
        ...
        public VerifyFromPersonDirectoryRequest(Guid faceId, string personId)
        {
        ...
        internal VerifyFromPersonDirectoryRequest(Guid faceId, string personId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceId = faceId;
            PersonId = personId;
