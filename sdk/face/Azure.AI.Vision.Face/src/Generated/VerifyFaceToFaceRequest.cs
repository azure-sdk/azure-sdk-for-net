...
namespace Azure.AI.Vision.Face
{
    ...
    internal partial class VerifyFaceToFaceRequest
    {
        ...
        internal VerifyFaceToFaceRequest(string faceId1, string faceId2, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceId1 = faceId1;
            FaceId2 = faceId2;
        ...
        /// <summary> faceId of one face, comes from Face - Detect. </summary>
        public string FaceId1 { get; }
        /// <summary> faceId of another face, comes from Face - Detect. </summary>
