...
namespace Azure.AI.Vision.Face
{
    ...
    internal partial class FindSimilarFromLargeFaceListRequest
    {
        ...
        internal FindSimilarFromLargeFaceListRequest(string faceId, int? maxNumOfCandidatesReturned, FindSimilarMatchMode? mode, string largeFaceListId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceId = faceId;
        ...
        /// <summary> An existing user-specified unique candidate large face list, created in LargeFaceList - Create. Large face list contains a set of persistedFaceIds which are persisted and will never expire. </summary>
