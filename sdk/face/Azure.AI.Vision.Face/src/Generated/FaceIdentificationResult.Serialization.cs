...
namespace Azure.AI.Vision.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FaceIdentificationResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FaceIdentificationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WriteObjectValue<FaceIdentificationCandidate>(item, options);
            }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<FaceIdentificationResult>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
