...
namespace Azure.AI.Vision.Face
{
    ...
    internal partial class LivenessSessionWithVerifyCreationResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="LivenessSessionWithVerifyCreationResult"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="sessionId"/>, <paramref name="authToken"/> or <paramref name="verifyImage"/> is null. </exception>
        internal LivenessSessionWithVerifyCreationResult(string sessionId, string authToken, LivenessWithVerifyImage verifyImage)
        {
        ...
        internal LivenessSessionWithVerifyCreationResult(string sessionId, string authToken, LivenessWithVerifyImage verifyImage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SessionId = sessionId;
            AuthToken = authToken;
            VerifyImage = verifyImage;
        ...
        /// <summary> Initializes a new instance of <see cref="LivenessSessionWithVerifyCreationResult"/> for deserialization. </summary>
        internal LivenessSessionWithVerifyCreationResult()
        {
        }
