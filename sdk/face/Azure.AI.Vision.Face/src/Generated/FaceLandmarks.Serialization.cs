...
namespace Azure.AI.Vision.Face
{
    public partial class FaceLandmarks : IUtf8JsonSerializable, IJsonModel<FaceLandmarks>
    {
        ...
        void IJsonModel<FaceLandmarks>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteObjectValue<LandmarkCoordinate>(PupilLeft, options);
            writer.WritePropertyName("pupilRight"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(PupilRight, options);
            writer.WritePropertyName("noseTip"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(NoseTip, options);
            writer.WritePropertyName("mouthLeft"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(MouthLeft, options);
            writer.WritePropertyName("mouthRight"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(MouthRight, options);
            writer.WritePropertyName("eyebrowLeftOuter"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyebrowLeftOuter, options);
            writer.WritePropertyName("eyebrowLeftInner"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyebrowLeftInner, options);
            writer.WritePropertyName("eyeLeftOuter"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyeLeftOuter, options);
            writer.WritePropertyName("eyeLeftTop"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyeLeftTop, options);
            writer.WritePropertyName("eyeLeftBottom"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyeLeftBottom, options);
            writer.WritePropertyName("eyeLeftInner"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyeLeftInner, options);
            writer.WritePropertyName("eyebrowRightInner"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyebrowRightInner, options);
            writer.WritePropertyName("eyebrowRightOuter"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyebrowRightOuter, options);
            writer.WritePropertyName("eyeRightInner"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyeRightInner, options);
            writer.WritePropertyName("eyeRightTop"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyeRightTop, options);
            writer.WritePropertyName("eyeRightBottom"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyeRightBottom, options);
            writer.WritePropertyName("eyeRightOuter"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(EyeRightOuter, options);
            writer.WritePropertyName("noseRootLeft"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(NoseRootLeft, options);
            writer.WritePropertyName("noseRootRight"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(NoseRootRight, options);
            writer.WritePropertyName("noseLeftAlarTop"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(NoseLeftAlarTop, options);
            writer.WritePropertyName("noseRightAlarTop"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(NoseRightAlarTop, options);
            writer.WritePropertyName("noseLeftAlarOutTip"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(NoseLeftAlarOutTip, options);
            writer.WritePropertyName("noseRightAlarOutTip"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(NoseRightAlarOutTip, options);
            writer.WritePropertyName("upperLipTop"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(UpperLipTop, options);
            writer.WritePropertyName("upperLipBottom"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(UpperLipBottom, options);
            writer.WritePropertyName("underLipTop"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(UnderLipTop, options);
            writer.WritePropertyName("underLipBottom"u8);
            writer.WriteObjectValue<LandmarkCoordinate>(UnderLipBottom, options);
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<FaceLandmarks>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
