...
namespace Azure.AI.Vision.Face
{
    ...
    internal partial class IdentifyFromPersonGroupRequest
    {
        ...
        public IdentifyFromPersonGroupRequest(IEnumerable<string> faceIds, string personGroupId)
        {
        ...
        internal IdentifyFromPersonGroupRequest(IList<string> faceIds, string personGroupId, int? maxNumOfCandidatesReturned, float? confidenceThreshold, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceIds = faceIds;
            PersonGroupId = personGroupId;
        ...
        /// <summary> personGroupId of the target person group, created by PersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time. </summary>
