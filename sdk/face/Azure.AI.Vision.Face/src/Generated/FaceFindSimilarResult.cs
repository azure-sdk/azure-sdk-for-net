...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceFindSimilarResult
    {
        ...
        internal FaceFindSimilarResult(float confidence, string faceId, string persistedFaceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Confidence = confidence;
            FaceId = faceId;
        ...
        /// <summary> faceId of candidate face when find by faceIds. faceId is created by Face - Detect and will expire 24 hours after the detection call. </summary>
