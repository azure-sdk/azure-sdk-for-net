...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessSessionCreationContent
    {
        ...
        public LivenessSessionCreationContent(LivenessOperationMode livenessOperationMode)
        {
        ...
        internal LivenessSessionCreationContent(LivenessOperationMode livenessOperationMode, bool? sendResultsToClient, bool? deviceCorrelationIdSetInClient, string deviceCorrelationId, int? authTokenTimeToLiveInSeconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LivenessOperationMode = livenessOperationMode;
