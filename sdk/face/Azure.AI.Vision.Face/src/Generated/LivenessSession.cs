...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessSession
    {
        ...
        internal LivenessSession(string sessionId, string authToken, OperationState status, LivenessModel? modelVersion, bool? isAbuseMonitoringEnabled, LivenessSessionResults results, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SessionId = sessionId;
            AuthToken = authToken;
            Status = status;
