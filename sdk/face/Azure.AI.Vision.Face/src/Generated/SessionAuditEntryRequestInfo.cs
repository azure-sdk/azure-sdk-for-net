...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class SessionAuditEntryRequestInfo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SessionAuditEntryRequestInfo"/>. </summary>
        ...
        internal SessionAuditEntryRequestInfo(string url, string method, string contentType)
        {
        ...
        internal SessionAuditEntryRequestInfo(string url, string method, long? contentLength, string contentType, string userAgent, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Url = url;
            Method = method;
        ...
        /// <summary> Initializes a new instance of <see cref="SessionAuditEntryRequestInfo"/> for deserialization. </summary>
        internal SessionAuditEntryRequestInfo()
        {
        }

        /// <summary> The relative URL of the liveness request. </summary>
