...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessSessionAttempt
    {
        ...
        internal LivenessSessionAttempt(int attemptId, OperationState attemptStatus, LivenessResult result, LivenessError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AttemptId = attemptId;
            AttemptStatus = attemptStatus;
            Result = result;
