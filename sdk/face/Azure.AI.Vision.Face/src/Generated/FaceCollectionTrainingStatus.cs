...
{
    /// <summary> Training status of a container. </summary>
    public partial class FaceCollectionTrainingStatus
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="FaceCollectionTrainingStatus"/>. </summary>
        ...
        internal FaceCollectionTrainingStatus(OperationState status, DateTimeOffset createdDateTime, DateTimeOffset lastActionDateTime, DateTimeOffset lastSuccessfulTrainingDateTime)
        {
            Status = status;
        ...
        internal FaceCollectionTrainingStatus(OperationState status, DateTimeOffset createdDateTime, DateTimeOffset lastActionDateTime, DateTimeOffset lastSuccessfulTrainingDateTime, string message, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            CreatedDateTime = createdDateTime;
            LastActionDateTime = lastActionDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="FaceCollectionTrainingStatus"/> for deserialization. </summary>
        internal FaceCollectionTrainingStatus()
        {
        }
