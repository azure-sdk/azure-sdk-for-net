...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceGroupingResult
    {
        ...
        internal FaceGroupingResult(IEnumerable<IList<string>> groups, IEnumerable<string> messyGroup)
        {
        ...
        internal FaceGroupingResult(IReadOnlyList<IList<string>> groups, IReadOnlyList<string> messyGroup, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Groups = groups;
