...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class SessionAuditEntryResponseInfo
    {
        ...
        internal SessionAuditEntryResponseInfo(LivenessResponseBody body, int statusCode, long latencyInMilliseconds)
        {
        ...
        internal SessionAuditEntryResponseInfo(LivenessResponseBody body, int statusCode, long latencyInMilliseconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Body = body;
            StatusCode = statusCode;
            LatencyInMilliseconds = latencyInMilliseconds;
