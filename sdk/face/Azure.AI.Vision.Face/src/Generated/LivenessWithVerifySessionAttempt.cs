...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessWithVerifySessionAttempt
    {
        ...
        internal LivenessWithVerifySessionAttempt(int attemptId, OperationState attemptStatus, LivenessWithVerifyResult result, LivenessError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AttemptId = attemptId;
            AttemptStatus = attemptStatus;
            Result = result;
