...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceIdentificationCandidate
    {
        ...
        internal FaceIdentificationCandidate(string personId, float confidence)
        {
        ...
        internal FaceIdentificationCandidate(string personId, float confidence, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PersonId = personId;
            Confidence = confidence;
