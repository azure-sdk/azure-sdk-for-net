...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceDetectionResult
    {
        ...
        internal FaceDetectionResult(string faceId, FaceRecognitionModel? recognitionModel, FaceRectangle faceRectangle, FaceLandmarks faceLandmarks, FaceAttributes faceAttributes, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceId = faceId;
