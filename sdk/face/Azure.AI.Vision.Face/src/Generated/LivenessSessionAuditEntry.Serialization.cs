...
namespace Azure.AI.Vision.Face
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LivenessSessionAuditEntry>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LivenessSessionAuditEntry>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteObjectValue<SessionAuditEntryRequestInfo>(Request, options);
            writer.WritePropertyName("response"u8);
            writer.WriteObjectValue<SessionAuditEntryResponseInfo>(Response, options);
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<LivenessSessionAuditEntry>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
