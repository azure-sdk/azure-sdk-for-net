...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessWithVerifySession
    {
        ...
        internal LivenessWithVerifySession(string sessionId, string authToken, OperationState status, LivenessModel? modelVersion, bool? isAbuseMonitoringEnabled, LivenessWithVerifySessionResults results, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SessionId = sessionId;
            AuthToken = authToken;
            Status = status;
