...
namespace Azure.ResourceManager.Fileshares.Mocking
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="MockableFilesharesArmClient"/> class for mocking. </summary>
        protected MockableFilesharesArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableFilesharesArmClient"/> class. </summary>
