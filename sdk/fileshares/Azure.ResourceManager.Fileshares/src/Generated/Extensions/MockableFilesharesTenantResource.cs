...
namespace Azure.ResourceManager.Fileshares.Mocking
{
    ...
    public partial class MockableFilesharesTenantResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableFilesharesTenantResource"/> class for mocking. </summary>
        protected MockableFilesharesTenantResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableFilesharesTenantResource"/> class. </summary>
        ...
        public virtual AsyncPageable<Info> GetOperationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Info.DeserializeInfo(e), OperationsClientDiagnostics, Pipeline, "MockableFilesharesTenantResource.GetOperations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<Info> GetOperations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => OperationsRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => OperationsRestClient.CreateListNextPageRequest(nextLink);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Info.DeserializeInfo(e), OperationsClientDiagnostics, Pipeline, "MockableFilesharesTenantResource.GetOperations", "value", "nextLink", cancellationToken);
        }
    }
}
