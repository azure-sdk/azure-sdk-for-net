    ...
    public partial class PrivateEndpointConnectionProperties : IUtf8JsonSerializable, IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    privateLinkServiceConnectionState = FilesharesPrivateLinkServiceConnectionState.DeserializeFilesharesPrivateLinkServiceConnectionState(property.Value, options);
                    continue;
                }
                if (property.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new FilesharesPrivateEndpointConnectionProvisioningState(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
