...
namespace Azure.ResourceManager.Fileshares.Models
{
    ...
    public partial class FilesharesPrivateLinkServiceConnectionState
    {
        ...
        internal FilesharesPrivateLinkServiceConnectionState(FilesharesPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
