...
namespace Azure.ResourceManager.Fileshares.Models
{
    ...
    public partial class PrivateEndpointConnectionProperties
    {
        ...
        internal PrivateEndpointConnectionProperties(IReadOnlyList<string> groupIds, SubResource privateEndpoint, FilesharesPrivateLinkServiceConnectionState privateLinkServiceConnectionState, FilesharesPrivateEndpointConnectionProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupIds = groupIds;
