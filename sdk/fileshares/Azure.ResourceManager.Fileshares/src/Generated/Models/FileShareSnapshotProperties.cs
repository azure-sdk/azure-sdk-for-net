...
namespace Azure.ResourceManager.Fileshares.Models
{
    ...
    public partial class FileShareSnapshotProperties
    {
        ...
        internal FileShareSnapshotProperties(string snapshotTime, string initiatorId, IList<MetadataItem> metadata, FileShareProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
