...
{
    public partial class FileShareSnapshotData : IUtf8JsonSerializable, IJsonModel<FileShareSnapshotData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileShareSnapshotData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileShareSnapshotData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        FileShareSnapshotData IJsonModel<FileShareSnapshotData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileShareSnapshotData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<FileShareSnapshotData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileShareSnapshotData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        FileShareSnapshotData IPersistableModel<FileShareSnapshotData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileShareSnapshotData>)this).GetFormatFromOptions(options) : options.Format;
