...
namespace Azure.ResourceManager.DevOpsInfrastructure.Models
{
    ...
    public partial class DevOpsPoolVmImage
    {
        ...
        internal DevOpsPoolVmImage(string resourceId, string wellKnownImageName, IList<string> aliases, string buffer, EphemeralType? ephemeralType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
