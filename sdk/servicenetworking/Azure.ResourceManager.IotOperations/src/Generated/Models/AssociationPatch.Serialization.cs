        ...
        internal static AssociationPatch DeserializeAssociationPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = AssociationUpdateProperties.DeserializeAssociationUpdateProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new AssociationPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, serializedAdditionalRawData);
        }
