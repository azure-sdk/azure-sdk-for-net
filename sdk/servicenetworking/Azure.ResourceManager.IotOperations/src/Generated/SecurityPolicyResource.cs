...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class SecurityPolicyResource : ArmResource
    {
        ...
        {
            _securityPolicySecurityPoliciesInterfaceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.IotOperations", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IotOperationsArmOperation(_securityPolicySecurityPoliciesInterfaceClientDiagnostics, Pipeline, _securityPolicySecurityPoliciesInterfaceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
