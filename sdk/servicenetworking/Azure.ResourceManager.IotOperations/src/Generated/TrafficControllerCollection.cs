...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class TrafficControllerCollection : ArmCollection, IEnumerable<TrafficControllerResource>, IAsyncEnumerable<TrafficControllerResource>
    {
        ...
        {
            _trafficControllerTrafficControllerInterfaceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.IotOperations", TrafficControllerResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<TrafficControllerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string trafficControllerName, TrafficControllerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IotOperationsArmOperation<TrafficControllerResource>(new TrafficControllerOperationSource(Client), _trafficControllerTrafficControllerInterfaceClientDiagnostics, Pipeline, _trafficControllerTrafficControllerInterfaceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, trafficControllerName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
