...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public static partial class IotOperationsExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsArmClient.GetAssociationResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static AssociationResource GetAssociationResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableIotOperationsArmClient(client).GetAssociationResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsArmClient.GetFrontendResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static FrontendResource GetFrontendResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableIotOperationsArmClient(client).GetFrontendResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsArmClient.GetSecurityPolicyResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static SecurityPolicyResource GetSecurityPolicyResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableIotOperationsArmClient(client).GetSecurityPolicyResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsArmClient.GetTrafficControllerResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static TrafficControllerResource GetTrafficControllerResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableIotOperationsArmClient(client).GetTrafficControllerResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsResourceGroupResource.GetTrafficControllers()"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static TrafficControllerCollection GetTrafficControllers(this ResourceGroupResource resourceGroupResource)
        {
            ...
            return GetMockableIotOperationsResourceGroupResource(resourceGroupResource).GetTrafficControllers();
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsResourceGroupResource.GetTrafficControllerAsync(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        ...
        public static async Task<Response<TrafficControllerResource>> GetTrafficControllerAsync(this ResourceGroupResource resourceGroupResource, string trafficControllerName, CancellationToken cancellationToken = default)
        {
            ...
            return await GetMockableIotOperationsResourceGroupResource(resourceGroupResource).GetTrafficControllerAsync(trafficControllerName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsResourceGroupResource.GetTrafficController(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        /// <param name="trafficControllerName"> traffic controller name for path. </param>
        ...
        public static Response<TrafficControllerResource> GetTrafficController(this ResourceGroupResource resourceGroupResource, string trafficControllerName, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableIotOperationsResourceGroupResource(resourceGroupResource).GetTrafficController(trafficControllerName, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableIotOperationsSubscriptionResource.GetTrafficControllers(CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static AsyncPageable<TrafficControllerResource> GetTrafficControllersAsync(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableIotOperationsSubscriptionResource(subscriptionResource).GetTrafficControllersAsync(cancellationToken);
        }
        ...
        public static Pageable<TrafficControllerResource> GetTrafficControllers(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockableIotOperationsSubscriptionResource(subscriptionResource).GetTrafficControllers(cancellationToken);
        }
    }
}
