...
namespace Azure.ResourceManager.ServiceNetworking.Models
{
    ...
    public partial class IPAccessRule
    {
        ...
        /// <param name="priority"> The priority of the rule. The value can be between 1 and 400. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule. </param>
        ...
        /// <summary> The priority of the rule. The value can be between 1 and 400. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule. </summary>
