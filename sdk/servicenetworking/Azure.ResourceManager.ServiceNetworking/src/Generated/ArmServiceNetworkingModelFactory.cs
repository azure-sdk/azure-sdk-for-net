...
namespace Azure.ResourceManager.ServiceNetworking.Models
{
    ...
    public static partial class ArmServiceNetworkingModelFactory
    {
        ...
        /// <param name="wafPolicyId"> Web Application Firewall Policy of the Traffic Controller Security Policy. If this property is set then ipAccessRulesPolicy property cannot be set. </param>
        /// <param name="rules"> Ip Access Policy of the Traffic Controller Security Policy. If this property is set then wafPolicy property cannot be set. </param>
