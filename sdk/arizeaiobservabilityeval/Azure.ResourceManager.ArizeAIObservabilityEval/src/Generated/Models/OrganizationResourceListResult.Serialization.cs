...
namespace Azure.ResourceManager.ArizeAIObservabilityEval.Models
{
    ...
    internal partial class OrganizationResourceListResult : IJsonModel<OrganizationResourceListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (ArizeAIObservabilityEvalOrganizationData item in Value)
            {
        ...
        internal static OrganizationResourceListResult DeserializeOrganizationResourceListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<ArizeAIObservabilityEvalOrganizationData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<ArizeAIObservabilityEvalOrganizationData> array = new List<ArizeAIObservabilityEvalOrganizationData>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(ArizeAIObservabilityEvalOrganizationData.DeserializeArizeAIObservabilityEvalOrganizationData(item, options));
                    }
                    value = array;
                    continue;
                }
