...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteHostruntimeWebhookApiWorkflowRunActionRepetitionResource : ArmResource
    {
        ...
        public virtual AsyncPageable<ExpressionRoot> GetExpressionTracesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ExpressionRoot.DeserializeExpressionRoot, _siteHostruntimeWebhookApiWorkflowRunActionRepetitionWorkflowRunActionRepetitionsClientDiagnostics, Pipeline, "SiteHostruntimeWebhookApiWorkflowRunActionRepetitionResource.GetExpressionTraces", "inputs", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ExpressionRoot> GetExpressionTraces(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _siteHostruntimeWebhookApiWorkflowRunActionRepetitionWorkflowRunActionRepetitionsRestClient.CreateListExpressionTracesRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _siteHostruntimeWebhookApiWorkflowRunActionRepetitionWorkflowRunActionRepetitionsRestClient.CreateListExpressionTracesNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ExpressionRoot.DeserializeExpressionRoot, _siteHostruntimeWebhookApiWorkflowRunActionRepetitionWorkflowRunActionRepetitionsClientDiagnostics, Pipeline, "SiteHostruntimeWebhookApiWorkflowRunActionRepetitionResource.GetExpressionTraces", "inputs", "nextLink", cancellationToken);
        }
    }
}
