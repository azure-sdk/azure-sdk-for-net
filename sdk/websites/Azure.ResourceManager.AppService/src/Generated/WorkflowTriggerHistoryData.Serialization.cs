...
namespace Azure.ResourceManager.AppService
{
    public partial class WorkflowTriggerHistoryData : IUtf8JsonSerializable, IJsonModel<WorkflowTriggerHistoryData>
    {
        ...
        internal static WorkflowTriggerHistoryData DeserializeWorkflowTriggerHistoryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WorkflowTriggerHistoryData(id, name, type, systemData.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToNullable(scheduledTime), Optional.ToNullable(status), code.Value, error.Value, trackingId.Value, correlation.Value, inputsLink.Value, outputsLink.Value, Optional.ToNullable(fired), run.Value, serializedAdditionalRawData);
        }
