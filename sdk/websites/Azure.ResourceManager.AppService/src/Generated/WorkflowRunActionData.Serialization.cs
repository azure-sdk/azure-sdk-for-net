...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkflowRunActionData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkflowRunActionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkflowRunActionData)} does not support '{format}' format.");
            }
            ...
            if (!(RetryHistory is ChangeTrackingList<RetryHistory> collection && collection.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<WorkflowRunActionData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WorkflowRunActionData)} does not support '{options.Format}' format.");
            }
        }
