    ...
    public partial class WorkflowRunActionData : IUtf8JsonSerializable, IJsonModel<WorkflowRunActionData>
    {
        ...
        void IJsonModel<WorkflowRunActionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(RetryHistory))
            {
                ...
                {
                    writer.WriteObjectValue<RetryHistory>(item, options);
                }
