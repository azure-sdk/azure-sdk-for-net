...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteResource : ArmResource
    {
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<SiteCertificateResource>> GetSiteCertificateAsync(string name, CancellationToken cancellationToken = default)
        {
            return await GetSiteCertificates().GetAsync(name, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<SiteCertificateResource> GetSiteCertificate(string name, CancellationToken cancellationToken = default)
        {
            return GetSiteCertificates().Get(name, cancellationToken);
        }
