...
namespace Azure.ResourceManager.AppService
{
    public partial class StaticSiteBuildData : IUtf8JsonSerializable, IJsonModel<StaticSiteBuildData>
    {
        ...
        void IJsonModel<StaticSiteBuildData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && !(LinkedBackends is ChangeTrackingList<StaticSiteLinkedBackend> collection0 && collection0.IsUndefined))
            {
            ...
            if (options.Format != "W" && !(DatabaseConnections is ChangeTrackingList<DatabaseConnectionOverview> collection1 && collection1.IsUndefined))
            {
