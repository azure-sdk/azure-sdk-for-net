...
{
    public partial class ResourceConfig : IUtf8JsonSerializable
    {
        ...
        internal static ResourceConfig DeserializeResourceConfig(JsonElement element)
        {
            ...
            return new ResourceConfig(Optional.ToNullable(cpu), memory.Value);
        }
    }
}
