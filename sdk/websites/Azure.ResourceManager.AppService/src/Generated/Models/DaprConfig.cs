...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DaprConfig. </summary>
        public DaprConfig()
        {
        }
        ...
        internal DaprConfig(bool? enabled, string appId, int? appPort, int? httpReadBufferSize, int? httpMaxRequestSize, DaprLogLevel? logLevel, bool? enableApiLogging)
        {
            Enabled = enabled;
            AppId = appId;
            AppPort = appPort;
