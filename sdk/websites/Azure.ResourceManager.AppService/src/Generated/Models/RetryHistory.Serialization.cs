...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RetryHistory>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RetryHistory>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RetryHistory)} does not support '{format}' format.");
            }
        ...
        internal static RetryHistory DeserializeRetryHistory(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RetryHistory(Optional.ToNullable(startTime), Optional.ToNullable(endTime), code.Value, clientRequestId.Value, serviceRequestId.Value, error.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<RetryHistory>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RetryHistory)} does not support '{options.Format}' format.");
            }
        }
