...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class Ingress : IUtf8JsonSerializable, IJsonModel<Ingress>
    {
        ...
        internal static Ingress DeserializeIngress(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Ingress(fqdn.Value, Optional.ToNullable(external), Optional.ToNullable(targetPort), Optional.ToNullable(transport), Optional.ToList(traffic), Optional.ToNullable(allowInsecure), serializedAdditionalRawData);
        }
