...
namespace Azure.ResourceManager.AppService
{
    public partial class StaticSiteData : IUtf8JsonSerializable, IJsonModel<StaticSiteData>
    {
        ...
        internal static StaticSiteData DeserializeStaticSiteData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IReadOnlyList<DatabaseConnectionOverview>> databaseConnections = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("databaseConnections"u8))
                        {
                            ...
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(DatabaseConnectionOverview.DeserializeDatabaseConnectionOverview(item));
                            }
            ...
            return new StaticSiteData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, sku.Value, identity, defaultHostname.Value, repositoryUrl.Value, branch.Value, Optional.ToList(customDomains), repositoryToken.Value, buildProperties.Value, Optional.ToList(privateEndpointConnections), Optional.ToNullable(stagingEnvironmentPolicy), Optional.ToNullable(allowConfigFileUpdates), templateProperties.Value, contentDistributionEndpoint.Value, keyVaultReferenceIdentity.Value, Optional.ToList(userProvidedFunctionApps), Optional.ToList(linkedBackends), provider.Value, Optional.ToNullable(enterpriseGradeCdnStatus), publicNetworkAccess.Value, Optional.ToList(databaseConnections), kind.Value, serializedAdditionalRawData);
        }
