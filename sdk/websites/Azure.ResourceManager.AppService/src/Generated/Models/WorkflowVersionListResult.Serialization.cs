...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkflowVersionListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkflowVersionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkflowVersionListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<WorkflowVersionData> collection && collection.IsUndefined))
            {
        ...
        internal static WorkflowVersionListResult DeserializeWorkflowVersionListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WorkflowVersionListResult(value ?? new ChangeTrackingList<WorkflowVersionData>(), nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<WorkflowVersionListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WorkflowVersionListResult)} does not support '{options.Format}' format.");
            }
        }
