...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class FlowEndpoints : IUtf8JsonSerializable, IJsonModel<FlowEndpoints>
    {
        ...
        void IJsonModel<FlowEndpoints>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(OutgoingIPAddresses is ChangeTrackingList<IPAddress> collection && collection.IsUndefined))
            {
            ...
            if (!(AccessEndpointIPAddresses is ChangeTrackingList<IPAddress> collection0 && collection0.IsUndefined))
            {
        ...
        internal static FlowEndpoints DeserializeFlowEndpoints(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FlowEndpoints(outgoingIPAddresses ?? new ChangeTrackingList<IPAddress>(), accessEndpointIPAddresses ?? new ChangeTrackingList<IPAddress>(), serializedAdditionalRawData);
        }
