...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceReference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceReference)} does not support '{format}' format.");
            }
        ...
        internal static ResourceReference DeserializeResourceReference(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceReference(id.Value, name.Value, type.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ResourceReference>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceReference)} does not support '{options.Format}' format.");
            }
        }
