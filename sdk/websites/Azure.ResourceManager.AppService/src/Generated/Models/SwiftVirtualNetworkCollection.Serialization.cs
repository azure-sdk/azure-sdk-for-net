...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwiftVirtualNetworkCollection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SwiftVirtualNetworkCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SwiftVirtualNetworkCollection)} does not support '{format}' format.");
            }
        ...
        internal static SwiftVirtualNetworkCollection DeserializeSwiftVirtualNetworkCollection(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(SwiftVirtualNetwork.DeserializeSwiftVirtualNetwork(item));
                    }
                    value = array;
                    continue;
                }
            ...
            return new SwiftVirtualNetworkCollection(value, nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SwiftVirtualNetworkCollection>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SwiftVirtualNetworkCollection)} does not support '{options.Format}' format.");
            }
        }
