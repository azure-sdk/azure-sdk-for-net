...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseConnectionPatchRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DatabaseConnectionPatchRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatabaseConnectionPatchRequest)} does not support '{format}' format.");
            }
        ...
        internal static DatabaseConnectionPatchRequest DeserializeDatabaseConnectionPatchRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DatabaseConnectionPatchRequest(resourceId.Value, connectionIdentity.Value, connectionString.Value, region.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DatabaseConnectionPatchRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DatabaseConnectionPatchRequest)} does not support '{options.Format}' format.");
            }
        }
