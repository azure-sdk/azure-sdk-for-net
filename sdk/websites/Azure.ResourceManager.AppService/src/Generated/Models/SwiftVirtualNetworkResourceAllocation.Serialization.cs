...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwiftVirtualNetworkResourceAllocation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SwiftVirtualNetworkResourceAllocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SwiftVirtualNetworkResourceAllocation)} does not support '{format}' format.");
            }
        ...
        internal static SwiftVirtualNetworkResourceAllocation DeserializeSwiftVirtualNetworkResourceAllocation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SwiftVirtualNetworkResourceAllocation(Optional.ToList(connectedServerFarmsId), Optional.ToList(connectedSitesId), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SwiftVirtualNetworkResourceAllocation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SwiftVirtualNetworkResourceAllocation)} does not support '{options.Format}' format.");
            }
        }
