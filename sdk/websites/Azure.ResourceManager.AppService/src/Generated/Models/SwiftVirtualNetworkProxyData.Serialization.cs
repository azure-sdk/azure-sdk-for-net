...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwiftVirtualNetworkProxyData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SwiftVirtualNetworkProxyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SwiftVirtualNetworkProxyData)} does not support '{format}' format.");
            }
        ...
        internal static SwiftVirtualNetworkProxyData DeserializeSwiftVirtualNetworkProxyData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<SwiftVirtualNetwork> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = SwiftVirtualNetwork.DeserializeSwiftVirtualNetwork(property.Value);
                    continue;
                }
            ...
            return new SwiftVirtualNetworkProxyData(id, name, type, systemData.Value, properties.Value, kind.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SwiftVirtualNetworkProxyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SwiftVirtualNetworkProxyData)} does not support '{options.Format}' format.");
            }
        }
