...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScaleRuleAuth>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ScaleRuleAuth>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScaleRuleAuth)} does not support '{format}' format.");
            }
        ...
        internal static ScaleRuleAuth DeserializeScaleRuleAuth(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ScaleRuleAuth(secretRef.Value, triggerParameter.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ScaleRuleAuth>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScaleRuleAuth)} does not support '{options.Format}' format.");
            }
        }
