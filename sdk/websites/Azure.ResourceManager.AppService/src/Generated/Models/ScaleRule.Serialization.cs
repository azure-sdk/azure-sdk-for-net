    ...
    public partial class ScaleRule : IUtf8JsonSerializable, IJsonModel<ScaleRule>
    {
        ...
        void IJsonModel<ScaleRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AzureQueue))
            {
                ...
                writer.WriteObjectValue<QueueScaleRule>(AzureQueue, options);
            }
            if (Optional.IsDefined(Custom))
            {
                writer.WritePropertyName("custom"u8);
                writer.WriteObjectValue<CustomScaleRule>(Custom, options);
            }
            if (Optional.IsDefined(Http))
            {
                writer.WritePropertyName("http"u8);
                writer.WriteObjectValue<HttpScaleRule>(Http, options);
            }
