...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class RecurrenceSchedule
    {
        ...
        internal RecurrenceSchedule(IReadOnlyList<int> minutes, IReadOnlyList<int> hours, IReadOnlyList<DaysOfWeek> weekDays, IReadOnlyList<int> monthDays, IReadOnlyList<RecurrenceScheduleOccurrence> monthlyOccurrences, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minutes = minutes;
            Hours = hours;
            WeekDays = weekDays;
