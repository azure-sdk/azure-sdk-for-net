...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Workflow>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<Workflow>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Workflow)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Workflow>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Workflow)} does not support '{options.Format}' format.");
            }
        }
