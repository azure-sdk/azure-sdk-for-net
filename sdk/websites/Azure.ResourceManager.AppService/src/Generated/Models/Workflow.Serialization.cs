    ...
    public partial class Workflow : IUtf8JsonSerializable, IJsonModel<Workflow>
    {
        ...
        void IJsonModel<Workflow>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(Sku))
            {
                ...
                writer.WriteObjectValue<WorkflowSku>(Sku, options);
            }
            if (Optional.IsDefined(IntegrationAccount))
            {
                writer.WritePropertyName("integrationAccount"u8);
                writer.WriteObjectValue<ResourceReference>(IntegrationAccount, options);
            }
            if (Optional.IsDefined(IntegrationServiceEnvironment))
            {
                writer.WritePropertyName("integrationServiceEnvironment"u8);
                writer.WriteObjectValue<ResourceReference>(IntegrationServiceEnvironment, options);
            }
            ...
            if (Optional.IsCollectionDefined(Parameters))
            {
                ...
                {
                    writer.WritePropertyName(item.Key);
                    writer.WriteObjectValue<WorkflowParameter>(item.Value, options);
                }
                writer.WriteEndObject();
            }
