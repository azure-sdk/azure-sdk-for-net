...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkflowEnvelopeData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkflowEnvelopeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkflowEnvelopeData)} does not support '{format}' format.");
            }
        ...
        internal static WorkflowEnvelopeData DeserializeWorkflowEnvelopeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<WorkflowEnvelopeProperties> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = WorkflowEnvelopeProperties.DeserializeWorkflowEnvelopeProperties(property.Value);
                    continue;
                }
            ...
            return new WorkflowEnvelopeData(id, name, type, systemData.Value, kind.Value, Optional.ToNullable(location), properties.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<WorkflowEnvelopeData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WorkflowEnvelopeData)} does not support '{options.Format}' format.");
            }
        }
