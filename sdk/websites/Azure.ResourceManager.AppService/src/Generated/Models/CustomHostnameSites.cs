...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class CustomHostnameSites : ResourceData
    {
        ...
        internal CustomHostnameSites(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string customHostname, string region, IList<AppServiceIdentifierData> siteResourceIds, string kind) : base(id, name, resourceType, systemData)
        {
