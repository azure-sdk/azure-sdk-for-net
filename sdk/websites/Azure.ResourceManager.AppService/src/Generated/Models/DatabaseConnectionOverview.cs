...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="DatabaseConnectionOverview"/>. </summary>
        internal DatabaseConnectionOverview()
        {
        ...
        internal DatabaseConnectionOverview(string resourceId, string connectionIdentity, string region, IReadOnlyList<StaticSiteDatabaseConnectionConfigurationFileOverview> configurationFiles, string name)
        {
