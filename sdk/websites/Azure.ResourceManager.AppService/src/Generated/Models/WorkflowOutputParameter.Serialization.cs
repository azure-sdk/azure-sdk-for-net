...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkflowOutputParameter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkflowOutputParameter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkflowOutputParameter)} does not support '{format}' format.");
            }
        ...
        internal static WorkflowOutputParameter DeserializeWorkflowOutputParameter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WorkflowOutputParameter(Optional.ToNullable(type), value.Value, metadata.Value, description.Value, serializedAdditionalRawData, error.Value);
        }
        ...
        BinaryData IPersistableModel<WorkflowOutputParameter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WorkflowOutputParameter)} does not support '{options.Format}' format.");
            }
        }
