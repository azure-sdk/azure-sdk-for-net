...
namespace Azure.ResourceManager.AppService.Mocking
{
    ...
    public partial class MockableAppServiceSubscriptionResource : ArmResource
    {
        ...
        public virtual AsyncPageable<StaticSiteRegion> GetStaticSiteRegionsAsync(AppServiceSkuName? sku = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DefaultRestClient.CreateListStaticSiteRegionsRequest(Id.SubscriptionId, sku);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DefaultRestClient.CreateListStaticSiteRegionsNextPageRequest(nextLink, Id.SubscriptionId, sku);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => StaticSiteRegion.DeserializeStaticSiteRegion(e), DefaultClientDiagnostics, Pipeline, "MockableAppServiceSubscriptionResource.GetStaticSiteRegions", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<StaticSiteRegion> GetStaticSiteRegions(AppServiceSkuName? sku = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DefaultRestClient.CreateListStaticSiteRegionsRequest(Id.SubscriptionId, sku);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DefaultRestClient.CreateListStaticSiteRegionsNextPageRequest(nextLink, Id.SubscriptionId, sku);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => StaticSiteRegion.DeserializeStaticSiteRegion(e), DefaultClientDiagnostics, Pipeline, "MockableAppServiceSubscriptionResource.GetStaticSiteRegions", "value", "nextLink", cancellationToken);
        }
