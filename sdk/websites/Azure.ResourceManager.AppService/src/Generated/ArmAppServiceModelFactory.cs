...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public static partial class ArmAppServiceModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.StaticSiteRegion"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        /// <param name="displayName"> Display name for region. </param>
        /// <param name="kind"> Kind of resource. </param>
        /// <returns> A new <see cref="Models.StaticSiteRegion"/> instance for mocking. </returns>
        public static StaticSiteRegion StaticSiteRegion(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, string kind = null)
        {
