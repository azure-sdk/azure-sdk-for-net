...
namespace Azure.ResourceManager.AppService
{
    internal partial class WebSiteManagementRestOperations
    {
        ...
        internal RequestUriBuilder CreateListVirtualNetworkIntegrationsRequestUri(string subscriptionId, AzureLocation location, VirtualNetworkIntegrationRequest request)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
            ...
            uri.AppendPath("/listVirtualNetworkIntegrations", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            return uri;
        }

        internal HttpMessage CreateListVirtualNetworkIntegrationsRequest(string subscriptionId, AzureLocation location, VirtualNetworkIntegrationRequest request)
        {
            var message = _pipeline.CreateMessage();
        ...
        /// <summary> Retrieve information regarding the provided virtual network integration, such as its allocated resources and its allocated IP. </summary>
        /// <param name="subscriptionId"> Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). </param>
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<SwiftVirtualNetworkData>> ListVirtualNetworkIntegrationsAsync(string subscriptionId, AzureLocation location, VirtualNetworkIntegrationRequest request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(request, nameof(request));

            using var message = CreateListVirtualNetworkIntegrationsRequest(subscriptionId, location, request);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="request"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<SwiftVirtualNetworkData> ListVirtualNetworkIntegrations(string subscriptionId, AzureLocation location, VirtualNetworkIntegrationRequest request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(request, nameof(request));
        ...
        internal RequestUriBuilder CreatePurgeUnusedVirtualNetworkIntegrationsRequestUri(string subscriptionId, AzureLocation location, VirtualNetworkIntegrationRequest request)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
            ...
            uri.AppendPath("/providers/Microsoft.Web/locations/", false);
            uri.AppendPath(location, true);
            uri.AppendPath("/purgeUnusedVirtualNetworkIntegration", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            return uri;
        }

        internal HttpMessage CreatePurgeUnusedVirtualNetworkIntegrationsRequest(string subscriptionId, AzureLocation location, VirtualNetworkIntegrationRequest request)
        {
            var message = _pipeline.CreateMessage();
            var request0 = message.Request;
            request0.Method = RequestMethod.Post;
        ...
        /// <summary> Delete orphaned (unused) VNET integration, otherwise fail the call if there are sites that are still using the VNET integrations. </summary>
        /// <param name="subscriptionId"> Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). </param>
        /// <param name="location"> The name of the Azure region. </param>
        /// <param name="request"> Object contains the subnetResourceId. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="request"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<VirtualNetworkIntegrationResponse>> PurgeUnusedVirtualNetworkIntegrationsAsync(string subscriptionId, AzureLocation location, VirtualNetworkIntegrationRequest request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(request, nameof(request));

            using var message = CreatePurgeUnusedVirtualNetworkIntegrationsRequest(subscriptionId, location, request);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        VirtualNetworkIntegrationResponse value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = VirtualNetworkIntegrationResponse.DeserializeVirtualNetworkIntegrationResponse(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw new RequestFailedException(message.Response);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="request"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<VirtualNetworkIntegrationResponse> PurgeUnusedVirtualNetworkIntegrations(string subscriptionId, AzureLocation location, VirtualNetworkIntegrationRequest request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(request, nameof(request));
