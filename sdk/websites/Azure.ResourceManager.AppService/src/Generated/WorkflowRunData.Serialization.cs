...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkflowRunData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkflowRunData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkflowRunData)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && !(Outputs is ChangeTrackingDictionary<string, WorkflowOutputParameter> collection && collection.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<WorkflowRunData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WorkflowRunData)} does not support '{options.Format}' format.");
            }
        }
