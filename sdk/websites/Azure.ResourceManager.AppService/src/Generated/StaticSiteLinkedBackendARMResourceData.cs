...
{
    /// <summary>
    /// A class representing the StaticSiteLinkedBackendARMResource data model.
    ...
    public partial class StaticSiteLinkedBackendARMResourceData : ResourceData
    {
        ...
        internal StaticSiteLinkedBackendARMResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string backendResourceId, string region, DateTimeOffset? createdOn, string provisioningState, string kind) : base(id, name, resourceType, systemData)
        {
