...
namespace Azure.ResourceManager.AppService
{
    public partial class CsmDeploymentStatusData : IUtf8JsonSerializable, IJsonModel<CsmDeploymentStatusData>
    {
        ...
        internal static CsmDeploymentStatusData DeserializeCsmDeploymentStatusData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CsmDeploymentStatusData(id, name, type, systemData.Value, deploymentId.Value, Optional.ToNullable(status), Optional.ToNullable(numberOfInstancesInProgress), Optional.ToNullable(numberOfInstancesSuccessful), Optional.ToNullable(numberOfInstancesFailed), Optional.ToList(failedInstancesLogs), Optional.ToList(errors), kind.Value, serializedAdditionalRawData);
        }
