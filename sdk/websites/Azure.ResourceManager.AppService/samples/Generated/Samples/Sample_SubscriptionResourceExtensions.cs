...
KeyVaultSecretName = "SampleSecretName2",
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetVirtualNetworkIntegrations_ListVirtualNetworkIntegrations()
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2024-11-01/examples/ListVirtualNetworkIntegrations.json
            // this example is just showing the usage of "ListVirtualNetworkIntegrations" operation, for the dependent resources, they will have to be created separately.
            ...
            VirtualNetworkIntegrationRequest request = new VirtualNetworkIntegrationRequest(new ResourceIdentifier("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/vnet-rg/providers/Microsoft.Network/virtualNetworks/client-vnet/subnets/client-subnet"));
            SwiftVirtualNetworkData result = await subscriptionResource.GetVirtualNetworkIntegrationsAsync(location, request);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task PurgeUnusedVirtualNetworkIntegrations_PurgeUnusedVirtualNetworkIntegrations()
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2024-11-01/examples/PurgeUnusedVirtualNetworkIntegrations.json
            // this example is just showing the usage of "PurgeUnusedVirtualNetworkIntegrations" operation, for the dependent resources, they will have to be created separately.
            ...
            AzureLocation location = new AzureLocation("westus3");
            VirtualNetworkIntegrationRequest request = new VirtualNetworkIntegrationRequest(new ResourceIdentifier("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/vnet-rg/providers/Microsoft.Network/virtualNetworks/client-vnet/subnets/client-subnet"));
            VirtualNetworkIntegrationResponse result = await subscriptionResource.PurgeUnusedVirtualNetworkIntegrationsAsync(location, request);
