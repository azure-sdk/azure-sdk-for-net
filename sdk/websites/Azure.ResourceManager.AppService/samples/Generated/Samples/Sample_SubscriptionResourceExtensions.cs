...
KeyVaultSecretName = "SampleSecretName2",
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task VirtualNetworkIntegrations_GetVirtualNetworkIntegrations()
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2023-12-01/examples/GetVirtualNetworkIntegrations.json
            // this example is just showing the usage of "VirtualNetworkIntegrations" operation, for the dependent resources, they will have to be created separately.
            ...
            SwiftVirtualNetwork result = await subscriptionResource.VirtualNetworkIntegrationsAsync(location, request);
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2023-12-01/examples/PurgeUnusedVirtualNetworkIntegrations.json
            ...
            AzureLocation location = new AzureLocation("westus3");
            VirtualNetworkIntegrationRequest request = new VirtualNetworkIntegrationRequest(new ResourceIdentifier("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/vnet-rg/providers/Microsoft.Network/virtualNetworks/client-vnet/subnets/client-subnet"));
            PurgedUnusedVirtualNetworkSuccessResponse result = await subscriptionResource.PurgeUnusedVirtualNetworkIntegrationsAsync(location, request);
