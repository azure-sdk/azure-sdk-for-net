...
KeyVaultSecretName = "SampleSecretName2",
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetStaticSiteRegions_GetAListOfAvailableStaticSiteRegions()
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2024-04-01/examples/ListStaticSiteRegions.json
            // this example is just showing the usage of "ListStaticSiteRegions" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation and iterate over the result
            AppServiceSkuName? sku = AppServiceSkuName.Standard;
            await foreach (StaticSiteRegion item in subscriptionResource.GetStaticSiteRegionsAsync(sku: sku))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
