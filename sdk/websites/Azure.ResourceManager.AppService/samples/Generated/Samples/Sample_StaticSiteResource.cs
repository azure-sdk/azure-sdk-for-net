...
["setting2"] = "someval2",
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task PurgeStaticSite_PurgeAStaticSite()
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2023-01-01/examples/PurgeStaticSite.json
            // this example is just showing the usage of "StaticSites_PurgeStaticSite" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            await staticSite.PurgeStaticSiteAsync(WaitUntil.Completed);
