...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_SiteCertificateCollection
    {
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2023-12-01/examples/ListSiteCertificatesByResourceGroup.json
        ...
        public async Task Get_GetCertificate()
        {
            ...
            SiteCertificateResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_GetCertificate()
        {
            ...
            // invoke the operation
            string name = "testc6282";
            NullableResponse<SiteCertificateResource> response = await collection.GetIfExistsAsync(name);
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2023-12-01/examples/CreateOrUpdateSiteCertificate.json
...
"ServerCert"
            ...
            ArmOperation<SiteCertificateResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
