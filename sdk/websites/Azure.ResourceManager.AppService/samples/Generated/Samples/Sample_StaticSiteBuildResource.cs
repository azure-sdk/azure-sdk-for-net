...
["setting2"] = "someval2",
        ...
        // Purge a static site build
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task PurgeStaticSiteBuild_PurgeAStaticSiteBuild()
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2023-01-01/examples/PurgeStaticSiteBuild.json
            // this example is just showing the usage of "StaticSites_PurgeStaticSiteBuild" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            await staticSiteBuild.PurgeStaticSiteBuildAsync(WaitUntil.Completed);
