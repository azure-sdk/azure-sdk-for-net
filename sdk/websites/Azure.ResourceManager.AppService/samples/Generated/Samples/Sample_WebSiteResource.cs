...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_WebSiteResource
    {
        ...
        public async Task Update_UpdateWebApp()
        {
            ...
            ArmOperation<WebSiteResource> lro = await webSite.UpdateAsync(WaitUntil.Completed, info);
...
["Setting2"] = "Value2",
            ...
            ArmOperation<AppServiceConfigurationDictionary> lro = await webSite.UpdateApplicationSettingsAsync(WaitUntil.Completed, appSettings);
            AppServiceConfigurationDictionary result = lro.Value;
