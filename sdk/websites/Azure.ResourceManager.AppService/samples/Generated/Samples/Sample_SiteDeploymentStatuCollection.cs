...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_SiteDeploymentStatuCollection
    {
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2024-03-01/examples/ListSiteDeploymentStatus.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/stable/2024-03-01/examples/GetSiteDeploymentStatus.json
            ...
            ArmOperation<SiteDeploymentStatuResource> lro = await collection.GetAsync(WaitUntil.Completed, deploymentStatusId);
        ...
        public async Task GetIfExists_GetDeploymentStatus()
        {
            ...
            // invoke the operation
            string deploymentStatusId = "eacfd68b-3bbd-4ad9-99c5-98614d89c8e5";
            ArmOperation<SiteDeploymentStatuResource> lro = await collection.GetIfExistsAsync(WaitUntil.Completed, deploymentStatusId);
            SiteDeploymentStatuResource result = lro.Value;
