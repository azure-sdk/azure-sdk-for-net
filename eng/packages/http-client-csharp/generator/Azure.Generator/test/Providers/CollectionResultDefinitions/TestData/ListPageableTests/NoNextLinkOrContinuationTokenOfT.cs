...
namespace Samples
{
    internal partial class CatClientGetCatsCollectionResultOfT : global::Azure.Pageable<global::Samples.Models.Cat>
    {
        ...
        public CatClientGetCatsCollectionResultOfT(global::Samples.CatClient client, string animalKind, global::Azure.RequestContext context, string scope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
