...
namespace Samples
{
    internal partial class CatClientGetCatsCollectionResult : global::Azure.Pageable<global::System.BinaryData>
    {
        ...
        public CatClientGetCatsCollectionResult(global::Samples.CatClient client, global::Azure.RequestContext context, string scope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
            _scope = scope;
