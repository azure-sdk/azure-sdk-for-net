...
namespace Samples
{
    internal partial class CatClientGetCatsCollectionResult : global::Azure.Pageable<global::System.BinaryData>
    {
        ...
        public CatClientGetCatsCollectionResult(global::Samples.CatClient client, string animalKind, global::Azure.RequestContext context, string scope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
