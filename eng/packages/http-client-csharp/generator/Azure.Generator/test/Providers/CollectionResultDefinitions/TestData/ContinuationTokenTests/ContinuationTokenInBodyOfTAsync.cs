...
namespace Samples
{
    internal partial class CatClientGetCatsAsyncCollectionResultOfT : global::Azure.AsyncPageable<global::Samples.Models.Cat>
    {
        ...
        public CatClientGetCatsAsyncCollectionResultOfT(global::Samples.CatClient client, string myToken, global::Azure.RequestContext context, string scope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _myToken = myToken;
            _context = context;
