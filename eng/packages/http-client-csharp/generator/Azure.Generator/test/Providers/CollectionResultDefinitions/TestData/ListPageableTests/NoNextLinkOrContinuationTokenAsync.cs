...
namespace Samples
{
    internal partial class CatClientGetCatsAsyncCollectionResult : global::Azure.AsyncPageable<global::System.BinaryData>
    {
        ...
        public CatClientGetCatsAsyncCollectionResult(global::Samples.CatClient client, string animalKind, global::Azure.RequestContext context, string scope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
