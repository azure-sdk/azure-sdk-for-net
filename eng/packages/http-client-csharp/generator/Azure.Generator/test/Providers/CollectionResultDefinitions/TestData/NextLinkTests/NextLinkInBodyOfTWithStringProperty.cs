...
namespace Samples
{
    internal partial class CatClientGetCatsCollectionResultOfT : global::Azure.Pageable<global::Samples.Models.Cat>
    {
        ...
        public CatClientGetCatsCollectionResultOfT(global::Samples.CatClient client, global::Azure.RequestContext context, string scope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
            _scope = scope;
