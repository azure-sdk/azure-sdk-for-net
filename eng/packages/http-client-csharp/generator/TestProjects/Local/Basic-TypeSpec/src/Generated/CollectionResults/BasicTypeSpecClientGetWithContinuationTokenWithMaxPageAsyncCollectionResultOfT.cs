...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenWithMaxPageAsyncCollectionResultOfT : AsyncPageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenWithMaxPageAsyncCollectionResultOfT(BasicTypeSpecClient client, int numElements, string token, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
