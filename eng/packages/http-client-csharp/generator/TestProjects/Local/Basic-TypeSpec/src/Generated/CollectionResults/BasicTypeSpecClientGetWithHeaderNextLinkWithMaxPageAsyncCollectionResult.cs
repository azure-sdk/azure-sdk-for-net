...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageAsyncCollectionResult(BasicTypeSpecClient client, int numElements, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
