...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenAsyncCollectionResult(BasicTypeSpecClient client, string token, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _token = token;
            _context = context;
