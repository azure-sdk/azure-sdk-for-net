...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageCollectionResult : Pageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageCollectionResult(BasicTypeSpecClient client, int numElements, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
