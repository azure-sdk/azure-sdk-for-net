...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenWithMaxPageAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenWithMaxPageAsyncCollectionResult(BasicTypeSpecClient client, int numElements, string token, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
