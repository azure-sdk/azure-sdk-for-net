...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithStringNextLinkCollectionResult : Pageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithStringNextLinkCollectionResult(BasicTypeSpecClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
