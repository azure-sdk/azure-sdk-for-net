...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithPagingAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithPagingAsyncCollectionResult(BasicTypeSpecClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
