...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenAsyncCollectionResultOfT : AsyncPageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenAsyncCollectionResultOfT(BasicTypeSpecClient client, string token, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _token = token;
            _context = context;
