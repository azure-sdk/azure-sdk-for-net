...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithNextLinkAsyncCollectionResultOfT : AsyncPageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithNextLinkAsyncCollectionResultOfT(BasicTypeSpecClient client, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
            _scope = scope;
