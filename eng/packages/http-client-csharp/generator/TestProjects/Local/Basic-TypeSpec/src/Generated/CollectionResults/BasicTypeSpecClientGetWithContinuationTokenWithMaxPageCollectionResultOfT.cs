...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenWithMaxPageCollectionResultOfT : Pageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenWithMaxPageCollectionResultOfT(BasicTypeSpecClient client, int numElements, string token, RequestContext context, string scope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
